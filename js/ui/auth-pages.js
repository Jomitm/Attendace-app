    ...
    return `
        <div class="auth-page-shell">
            <div class="card auth-card" style="width: 100%; max-width: 400px; text-align: center;">
                ...
                <h2 class="auth-stagger" style="margin-bottom: 0.5rem;">CRWI Attendance</h2>
                ${noticeHtml}
                <p class="text-muted auth-stagger" style="margin-bottom: 2rem;">Please sign in to continue</p>
                ...
                <form id="login-form" style="display: flex; flex-direction: column; gap: 1rem; text-align: left;">
                    ...
                    <div class="auth-stagger password-field-wrap">
                        <label style="font-size: 0.9rem; font-weight: 500; margin-bottom: 0.5rem; display: block;">Password</label>
                        <input type="password" name="password" placeholder="Enter Password" autocomplete="current-password" required style="width: 100%; padding: 0.75rem; border: 1px solid #d1d5db; border-radius: 0.5rem;">
                        <button type="button" class="password-toggle" onclick="window.app_togglePasswordVisibility(this)" aria-label="Show password" title="Show password"><i class="fa-solid fa-eye"></i></button>
                    </div>
                    
                    <button type="submit" class="action-btn auth-stagger" style="margin-top: 1rem; width: 100%;">Sign In</button>
                </form>
...
export function renderOwnerLogin() {
    ...
    return `
        <div class="auth-page-shell">
            <div class="card owner-login-card auth-card" style="width: 100%; max-width: 400px; text-align: center;">
                <div class="owner-login-banner">OWNER CONSOLE</div>
                <div class="logo-circle" style="width: 60px; height: 60px; margin: 0 auto 1.5rem auto;">
                    <img src="https://ui-avatars.com/api/?name=CRWI&background=4f46e5" alt="Logo">
                </div>
                <h2 class="auth-stagger" style="margin-bottom: 0.5rem;">Owner Access</h2>
                ${noticeHtml}
                <p class="text-muted auth-stagger" style="margin-bottom: 2rem;">Restricted portal — owner credentials only</p>
                ...
                <form id="owner-login-form" style="display: flex; flex-direction: column; gap: 1rem; text-align: left;">
                    ...
                    <div class="auth-stagger password-field-wrap">
                        <label style="font-size: 0.9rem; font-weight: 500; margin-bottom: 0.5rem; display: block;">Password</label>
                        <input type="password" name="password" placeholder="Leave empty for first login" autocomplete="current-password" style="width: 100%; padding: 0.75rem; border: 1px solid #d1d5db; border-radius: 0.5rem;">
                        <button type="button" class="password-toggle" onclick="window.app_togglePasswordVisibility(this)" aria-label="Show password" title="Show password"><i class="fa-solid fa-eye"></i></button>
                    </div>

                    <button type="submit" class="action-btn owner-login-btn auth-stagger" style="margin-top: 1rem; width: 100%;">Sign In as Owner</button>
                </form>
    ...
    return `
        <div class="auth-page-shell">
            <div class="card owner-login-card auth-card" style="width: 100%; max-width: 400px; text-align: center;">
                ...
                <h2 class="auth-stagger" style="margin-bottom: 0.5rem;">Set Your Password</h2>
                ${noticeHtml}
                <p class="text-muted auth-stagger" style="margin-bottom: 2rem;">First-time login — please create a password for your account.</p>
                ...
                <form id="owner-password-setup-form" style="display: flex; flex-direction: column; gap: 1rem; text-align: left;">
                    ...
                    <button type="submit" class="action-btn owner-login-btn auth-stagger" style="margin-top: 1rem; width: 100%;">Set Password & Sign In</button>
                </form>
...
if (typeof window !== 'undefined') {
    window.app_togglePasswordVisibility = (button) => {
