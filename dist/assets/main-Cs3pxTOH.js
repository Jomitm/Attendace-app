(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))a(s);new MutationObserver(s=>{for(const i of s)if(i.type==="childList")for(const o of i.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&a(o)}).observe(document,{childList:!0,subtree:!0});function t(s){const i={};return s.integrity&&(i.integrity=s.integrity),s.referrerPolicy&&(i.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?i.credentials="include":s.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function a(s){if(s.ep)return;s.ep=!0;const i=t(s);fetch(s.href,i)}})();const _={WORK_START_TIME:"09:00",LATE_CUTOFF_TIME:"09:15",WORK_END_TIME:"17:00",LATE_CUTOFF_MINUTES:555,MINOR_LATE_END_MINUTES:615,LATE_END_MINUTES:720,POST_NOON_END_MINUTES:810,AFTERNOON_START_MINUTES:720,EARLY_DEPARTURE_MINUTES:1020,FY_START_MONTH:3,IS_SATURDAY_OFF:n=>{const t=new Date(n).getDate(),a=Math.ceil(t/7);return a===2||a===4},LATE_GRACE_COUNT:3,LATE_DEDUCTION_PER_BLOCK:.5,EXTRA_HOURS_FOR_HALF_DAY_OFFSET:4,READ_CACHE_TTLS:{users:6e4,settings:3e5,minutes:3e4,attendanceSummary:3e4,staffMessages:2e4,dailySummaryReadMs:6e4},READ_OPT_FLAGS:{FF_READ_OPT_DB_QUERIES:!0,FF_READ_OPT_TARGETED_REALTIME:!0,FF_READ_OPT_ANALYTICS_CACHE:!0,FF_SHARED_DAILY_SUMMARY:!0,FF_SUMMARY_LOCKING:!0,ENABLE_SIMULATION_MODULE:!1,ENABLE_READ_TELEMETRY:!0,ENABLE_PRESENCE_HEARTBEAT:!1},SUMMARY_POLICY:{STALENESS_MS:1440*60*1e3,TEAM_ACTIVITY_LIMIT:15,LOCK_TTL_MS:9e4,SCHEMA_VERSION:2,RECOMPUTE_CUTOFF_HOUR_IST:17,FALLBACK_TO_PREVIOUS_DAY:!0},HERO_POLICY:{SCHEMA_VERSION:2,WINDOW_DAYS:7,FALLBACK_LOOKBACK_DAYS:90,WEIGHTS:{taskExecution:.45,taskCompletionRate:.2,taskInProgressSupport:.1,taskMissPenalty:.1},ATTENDANCE_MODIFIER:{base:.9,maxBonus:.15,consistencyImpact:.65,effortImpact:.35},CAPS:{hours:40,qualityChars:500},DEFAULT_ACTIVITY_SCORE:70,MIN_EVIDENCE:{minDays:1,minDurationMs:1,minPlannedTasks:1}},SIMULATION_POLICY:{LEGACY_DUMMY_CLEANUP:{ENABLED:!0,FLAG_KEY:"legacy_dummy_cleanup_v1",TARGET_USER_IDS:["sim_punctual","sim_admin_new"],TARGET_USERNAMES:["jomit_p","maria"],AUDIT_COLLECTION:"system_audit_logs"}}},Na={apiKey:"AIzaSyC7a8AxukI0-egXimYTedwCa2RFnMTBu84",authDomain:"crwiattendance.firebaseapp.com",projectId:"crwiattendance",storageBucket:"crwiattendance.firebasestorage.app",messagingSenderId:"462155106938",appId:"1:462155106938:web:18291b04a5a3bec185c9c3",measurementId:"G-X6W45TV4QR"};typeof firebase<"u"&&!firebase.apps.length&&(firebase.initializeApp(Na),console.log("Firebase Initialized (Compat Mode)"));const Gt=typeof firebase<"u"?firebase.firestore():null;typeof window<"u"&&(window.AppFirestore=Gt);class Ba{constructor(){this.db=Gt,this.cache=new Map,this.telemetry={get:0,getAll:0,query:0,queryMany:0,listen:0,listenQuery:0,writes:0,docsRead:0,byCollection:{}}}async init(){if(!this.db){console.error("Firebase not initialized! Check config.");return}console.log("Firestore adapter ready.")}getFlags(){return _&&_.READ_OPT_FLAGS||{}}track(e,t,a=0){this.getFlags().ENABLE_READ_TELEMETRY&&(typeof this.telemetry[e]=="number"&&(this.telemetry[e]+=1),this.telemetry.docsRead+=Math.max(0,Number(a)||0),this.telemetry.byCollection[t]||(this.telemetry.byCollection[t]={ops:0,docsRead:0}),this.telemetry.byCollection[t].ops+=1,this.telemetry.byCollection[t].docsRead+=Math.max(0,Number(a)||0))}getReadTelemetry(){return JSON.parse(JSON.stringify(this.telemetry))}clearReadTelemetry(){this.telemetry={get:0,getAll:0,query:0,queryMany:0,listen:0,listenQuery:0,writes:0,docsRead:0,byCollection:{}}}getCacheKey(e,t,a={}){return`${e}:${t}:${JSON.stringify(a)}`}invalidateCollectionCache(e){const t=`:${e}:`;for(const a of this.cache.keys())a.includes(t)&&this.cache.delete(a)}async getCached(e,t,a){const s=Date.now(),i=this.cache.get(e);if(i&&i.expiresAt>s)return i.value;const o=await a();return this.cache.set(e,{value:o,expiresAt:s+Math.max(0,Number(t)||0)}),o}async getOrGenerateSummary(e,t,a){if(!e||typeof t!="function")throw new Error("getOrGenerateSummary requires a key and generator function.");const s=this.getCacheKey("summary","computed",{summaryKey:e}),i=typeof a=="number"?a:_?.READ_CACHE_TTLS?.attendanceSummary||3e4;return this.getCached(s,i,t)}async sleep(e){return new Promise(t=>setTimeout(t,Math.max(0,Number(e)||0)))}getSummarySchemaVersion(){return Number(_?.SUMMARY_POLICY?.SCHEMA_VERSION||1)}getIstNow(){const e=new Date;return new Date(e.toLocaleString("en-US",{timeZone:"Asia/Kolkata"}))}toDateKey(e){const t=e instanceof Date?e:new Date(e),a=t.getFullYear(),s=String(t.getMonth()+1).padStart(2,"0"),i=String(t.getDate()).padStart(2,"0");return`${a}-${s}-${i}`}getISTDateKeys(){const e=this.getIstNow(),t=new Date(e);return t.setDate(t.getDate()-1),{todayKey:this.toDateKey(e),yesterdayKey:this.toDateKey(t)}}shouldRecomputeNowIST(e){const t=Number.isFinite(Number(e))?Number(e):Number(_?.SUMMARY_POLICY?.RECOMPUTE_CUTOFF_HOUR_IST||17);return this.getIstNow().getHours()>=Math.max(0,Math.min(23,t))}isSummaryFresh(e,t){if(!e||typeof e!="object")return!1;const a=Number(e.generatedAt||0),s=Number(e.version||0);return!a||!s||s!==this.getSummarySchemaVersion()?!1:Date.now()-a<=Math.max(0,Number(t)||0)}async getDailySummary(e){const t=String(e||"").trim();if(!t)return null;const a=_?.READ_CACHE_TTLS?.dailySummaryReadMs||6e4,s=this.getCacheKey("dailySummary","daily_summaries",{key:t});return this.getCached(s,a,()=>this.get("daily_summaries",t))}listenDailySummary(e,t){const a=String(e||"").trim();if(!a)return null;const s=this.getCacheKey("dailySummary","daily_summaries",{key:a});return this.listenDoc("daily_summaries",a,(i,o)=>{if(i){const r=_?.READ_CACHE_TTLS?.dailySummaryReadMs||6e4;this.cache.set(s,{value:i,expiresAt:Date.now()+r})}t&&t(i,o)})}async getSummaryByDateKey(e){return this.getDailySummary(e)}async getLatestSuccessfulSummaryMeta(){const e=_?.READ_CACHE_TTLS?.dailySummaryReadMs||6e4,t=this.getCacheKey("dailySummaryMeta","daily_summaries_meta",{key:"latest_success"});return this.getCached(t,e,()=>this.get("daily_summaries_meta","latest_success"))}async setLatestSuccessfulSummaryMeta({dateKey:e,generatedAt:t,version:a}={}){const s=String(e||"").trim();if(!s)return;const i={id:"latest_success",dateKey:s,generatedAt:Number(t||Date.now()),version:Number(a||this.getSummarySchemaVersion())};await this.put("daily_summaries_meta",i)}async getDailySummaryWithFallback({todayKey:e,yesterdayKey:t,staleAfterMs:a}={}){const s=Math.max(1e3,Number(a)||Number(_?.SUMMARY_POLICY?.STALENESS_MS)||864e5),i=_?.SUMMARY_POLICY?.FALLBACK_TO_PREVIOUS_DAY!==!1,o=await this.getSummaryByDateKey(e);if(this.isSummaryFresh(o,s))return{summary:o,source:"today"};if(i){const l=await this.getSummaryByDateKey(t);if(l&&typeof l=="object")return{summary:l,source:"yesterday"}}const r=await this.getLatestSuccessfulSummaryMeta(),d=String(r?.dateKey||"").trim();if(d){const l=await this.getSummaryByDateKey(d);if(l&&typeof l=="object")return{summary:l,source:"latest_success"}}return{summary:o||null,source:"none"}}async putDailySummary(e,t={}){const a=String(e||"").trim();if(!a)throw new Error("putDailySummary requires dateKey.");const s={id:a,dateKey:a,version:this.getSummarySchemaVersion(),...t};return this.put("daily_summaries",s)}async acquireSummaryLock(e,t,a){const s=String(e||"").trim(),i=String(t||"").trim();if(!s||!i||!this.db||!this.db.runTransaction)return!1;if(_?.READ_OPT_FLAGS?.FF_SUMMARY_LOCKING===!1)return!0;const o=Math.max(1e3,Number(a)||Number(_?.SUMMARY_POLICY?.LOCK_TTL_MS)||9e4),r=this.db.collection("summary_locks").doc(s),d=Date.now();try{return await this.db.runTransaction(async c=>{const m=await c.get(r);if(m.exists){const u=m.data()||{},p=String(u.ownerId||"");if(Number(u.expiresAt||0)>d&&p&&p!==i)return!1}return c.set(r,{id:s,dateKey:s,ownerId:i,createdAt:d,expiresAt:d+o},{merge:!0}),!0})===!0}catch(l){return console.warn("Failed to acquire summary lock:",l),!1}}async releaseSummaryLock(e,t){const a=String(e||"").trim(),s=String(t||"").trim();if(!a||!s||!this.db||!this.db.runTransaction||_?.READ_OPT_FLAGS?.FF_SUMMARY_LOCKING===!1)return;const i=this.db.collection("summary_locks").doc(a);try{await this.db.runTransaction(async o=>{const r=await o.get(i);if(!r.exists)return;const d=r.data()||{};String(d.ownerId||"")===s&&o.delete(i)})}catch(o){console.warn("Failed to release summary lock:",o)}}async getOrCreateDailySummary({dateKey:e,yesterdayKey:t,generatorFn:a,staleAfterMs:s,lockTtlMs:i}={}){const o=this.getISTDateKeys(),r=String(e||o.todayKey||"").trim(),d=String(t||o.yesterdayKey||"").trim();if(!r||typeof a!="function")throw new Error("getOrCreateDailySummary requires dateKey and generatorFn.");const l=Math.max(1e3,Number(s)||Number(_?.SUMMARY_POLICY?.STALENESS_MS)||864e5),c=Math.max(1e3,Number(i)||Number(_?.SUMMARY_POLICY?.LOCK_TTL_MS)||9e4),m=String(window.AppAuth?.getUser?.()?.id||`anon_${Math.random().toString(36).slice(2,10)}`),u=await this.getDailySummaryWithFallback({todayKey:r,yesterdayKey:d,staleAfterMs:l});if(u.summary&&u.source==="today"&&this.isSummaryFresh(u.summary,l))return{...u.summary,_source:"shared_today"};if(!this.shouldRecomputeNowIST(_?.SUMMARY_POLICY?.RECOMPUTE_CUTOFF_HOUR_IST))return u.summary?{...u.summary,_source:`fallback_${u.source}`}:null;if(await this.acquireSummaryLock(r,m,c))try{const y={...await a()||{},generatedAt:Date.now(),generatedBy:m,version:this.getSummarySchemaVersion()};return await this.putDailySummary(r,y),await this.setLatestSuccessfulSummaryMeta({dateKey:r,generatedAt:y.generatedAt,version:y.version}),{dateKey:r,...y,_source:"generated"}}finally{await this.releaseSummaryLock(r,m)}const f=[350,700,1200,1800];for(const h of f){await this.sleep(h);const y=await this.getDailySummary(r);if(this.isSummaryFresh(y,l))return{...y,_source:"shared"}}return u.summary?{...u.summary,_source:`fallback_${u.source}`}:null}applyFilters(e,t=[]){let a=e;return(t||[]).forEach(s=>{!s||!s.field||!s.operator||(a=a.where(s.field,s.operator,s.value))}),a}applyOptions(e,t={}){let a=e;return t.orderBy&&(Array.isArray(t.orderBy)?t.orderBy:[t.orderBy]).forEach(i=>{i&&(typeof i=="string"?a=a.orderBy(i):i.field&&(a=a.orderBy(i.field,i.direction||"asc")))}),t.limit&&(a=a.limit(t.limit)),t.startAt!==void 0&&(a=a.startAt(t.startAt)),t.endAt!==void 0&&(a=a.endAt(t.endAt)),a}async getAll(e){try{const a=(await this.db.collection(e).get()).docs.map(s=>({...s.data(),id:s.id}));return this.track("getAll",e,a.length),a}catch(t){throw console.error(`Error getting all from ${e}:`,t),t}}async get(e,t){if(!t)return null;try{const a=String(t),i=await this.db.collection(e).doc(a).get();return i.exists?(this.track("get",e,1),{...i.data(),id:i.id}):(this.track("get",e,0),null)}catch(a){throw console.error(`Error getting ${t} from ${e}:`,a),a}}async add(e,t){if(t.id)return this.put(e,t);try{const a=await this.db.collection(e).add(t);return this.telemetry.writes+=1,this.invalidateCollectionCache(e),window.dispatchEvent&&window.dispatchEvent(new CustomEvent("app:db-write",{detail:{collection:e,op:"add"}})),a.id}catch(a){throw console.error(`Error adding to ${e}:`,a),a}}async put(e,t){if(!t.id)throw new Error("Item must have an ID for 'put' operation.");try{const a=String(t.id);return await this.db.collection(e).doc(a).set(t,{merge:!0}),this.telemetry.writes+=1,this.invalidateCollectionCache(e),window.dispatchEvent&&window.dispatchEvent(new CustomEvent("app:db-write",{detail:{collection:e,op:"put"}})),a}catch(a){throw console.error(`Error putting ${t.id} to ${e}:`,a),a}}async delete(e,t){if(t)try{const a=String(t);await this.db.collection(e).doc(a).delete(),this.telemetry.writes+=1,this.invalidateCollectionCache(e),window.dispatchEvent&&window.dispatchEvent(new CustomEvent("app:db-write",{detail:{collection:e,op:"delete"}}))}catch(a){throw console.error(`Error deleting ${t} from ${e}:`,a),a}}async query(e,t,a,s){try{const o=(await this.db.collection(e).where(t,a,s).get()).docs.map(r=>({...r.data(),id:r.id}));return this.track("query",e,o.length),o}catch(i){throw console.error(`Error querying ${e}:`,i),i}}async queryMany(e,t=[],a={}){if(!this.getFlags().FF_READ_OPT_DB_QUERIES)return this.getAll(e);try{let i=this.db.collection(e);i=this.applyFilters(i,t),i=this.applyOptions(i,a);const r=(await i.get()).docs.map(d=>({...d.data(),id:d.id}));return this.track("queryMany",e,r.length),r}catch(i){return console.warn(`queryMany failed for ${e}, falling back to getAll`,i),this.getAll(e)}}async getManyByIds(e,t=[]){const a=Array.from(new Set((t||[]).filter(Boolean).map(o=>String(o))));if(!a.length)return[];const s=[];for(let o=0;o<a.length;o+=10)s.push(a.slice(o,o+10));return(await Promise.all(s.map(async o=>{try{const r=await this.queryMany(e,[{field:"id",operator:"in",value:o}]);return r&&r.length?r:Promise.all(o.map(d=>this.get(e,d)))}catch{return Promise.all(o.map(r=>this.get(e,r)))}}))).flat().filter(Boolean)}listenDoc(e,t,a){if(!this.db||!t)return null;const s=String(t);try{return this.db.collection(e).doc(s).onSnapshot(i=>{const o=i.exists?{...i.data(),id:i.id}:null;this.track("listen",e,1),a(o,i)},i=>{console.error(`Realtime listener error in ${e}/${s}:`,i)})}catch(i){return console.error(`Error setting up listener for ${e}/${s}:`,i),null}}listenQuery(e,t=[],a={},s){if(!this.db)return null;try{let i=this.db.collection(e);return i=this.applyFilters(i,t),i=this.applyOptions(i,a),i.onSnapshot(o=>{const r=o.docs.map(d=>({...d.data(),id:d.id}));this.track("listenQuery",e,r.length),s(r,o)},o=>{console.error(`Realtime query listener error in ${e}:`,o)})}catch(i){return console.warn(`listenQuery failed for ${e}, falling back to listen`,i),this.listen(e,s)}}listen(e,t){return this.db?this.db.collection(e).onSnapshot(a=>{const s=a.docs.map(i=>({...i.data(),id:i.id}));this.track("listen",e,s.length),t(s,a)},a=>{console.error(`Realtime listener error in ${e}:`,a)}):null}}const q=new Ba;typeof window<"u"&&(window.AppDB=q);class Oa{constructor(){this.currentUser=null,this.sessionKey="crwi_session_user",this.heartbeatInterval=null,this.userDocUnsubscribe=null}async init(){await q.init();const e=localStorage.getItem(this.sessionKey);e&&(this.currentUser=await q.get("users",e),this.currentUser&&(this.startHeartbeat(),this.startCurrentUserSync()))}async refreshCurrentUserFromDB(){const e=localStorage.getItem(this.sessionKey);if(!e)return this.currentUser=null,null;if(this.userDocUnsubscribe&&this.currentUser&&this.currentUser.id===e)return this.currentUser;const t=await q.get("users",e);return this.currentUser=t||null,this.currentUser}async login(e,t){const a=q.getCached?await q.getCached(q.getCacheKey("authUsers","users",{mode:"login"}),_?.READ_CACHE_TTLS?.users||6e4,()=>q.getAll("users")):await q.getAll("users"),s=e.trim().toLowerCase(),i=t.trim(),o=a.find(r=>{const d=(r.username||"").toLowerCase().trim(),l=(r.email||"").toLowerCase().trim();return(d===s||l===s)&&r.password.trim()===i});return o?(this.currentUser=o,localStorage.setItem(this.sessionKey,o.id),this.startHeartbeat(),this.startCurrentUserSync(),!0):(console.warn("Login failed: invalid credentials."),!1)}logout(){this.stopHeartbeat(),this.stopCurrentUserSync(),this.currentUser=null,localStorage.removeItem(this.sessionKey),window.location.reload()}getUser(){return this.currentUser}async updateUser(e){const t=await q.get("users",e.id);if(!t)return!1;const a={...t,...e};return e.isAdmin===!0||e.isAdmin==="true"?a.isAdmin=!0:a.isAdmin=!1,a.role=e.role||t.role||"Employee",console.log(`Auth: User ${a.id} update - Role: ${a.role}, Admin: ${a.isAdmin}`),e.name&&e.name!==t.name&&!e.avatar&&(a.avatar=`https://ui-avatars.com/api/?name=${e.name}&background=random&color=fff`),await q.put("users",a),this.currentUser&&this.currentUser.id===a.id&&(this.currentUser=a),!0}startHeartbeat(){if(!(_&&_.READ_OPT_FLAGS||{}).ENABLE_PRESENCE_HEARTBEAT){this.stopHeartbeat();return}this.heartbeatInterval&&clearInterval(this.heartbeatInterval);const t=async()=>{if(this.currentUser&&q)try{await q.put("users",{id:this.currentUser.id,lastSeen:Date.now()})}catch(a){console.warn("Heartbeat update failed:",a)}};t(),this.heartbeatInterval=setInterval(t,12e4),console.log("Presence Heartbeat started.")}stopHeartbeat(){this.heartbeatInterval&&(clearInterval(this.heartbeatInterval),this.heartbeatInterval=null,console.log("Presence Heartbeat stopped."))}startCurrentUserSync(){this.stopCurrentUserSync();const e=localStorage.getItem(this.sessionKey);if(!(!e||!window.AppFirestore))try{this.userDocUnsubscribe=window.AppFirestore.collection("users").doc(String(e)).onSnapshot(t=>{if(!t.exists){this.currentUser=null;return}const a={...t.data(),id:t.id};this.currentUser=a,window.dispatchEvent(new CustomEvent("app:user-sync",{detail:a}))},t=>{console.warn("Current user realtime sync failed:",t)})}catch(t){console.warn("Failed to start current user sync:",t)}}stopCurrentUserSync(){typeof this.userDocUnsubscribe=="function"&&this.userDocUnsubscribe(),this.userDocUnsubscribe=null}}const Q=new Oa;typeof window<"u"&&(window.AppAuth=Q);class Ua{async getStatus(){const e=await(Q.refreshCurrentUserFromDB?Q.refreshCurrentUserFromDB():Q.getUser());if(!e)return{status:"out",lastCheckIn:null};if(e.status==="in"&&e.lastCheckIn)try{const t=new Date(e.lastCheckIn),a=new Date,s=t.toISOString().split("T")[0],i=a.toISOString().split("T")[0];if(s<i)return{status:"out",lastCheckIn:null,staleSession:!0}}catch(t){console.warn("Date parsing error in getStatus:",t)}return{status:e.status||"out",lastCheckIn:e.lastCheckIn}}async checkIn(e,t,a="Unknown Location"){const s=await(Q.refreshCurrentUserFromDB?Q.refreshCurrentUserFromDB():Q.getUser());if(!s)throw new Error("User not authenticated");let i=!1,o="",r=null,d=null;if(s.status==="in"&&s.lastCheckIn){const c=new Date(s.lastCheckIn),m=new Date,u=`${c.getFullYear()}-${String(c.getMonth()+1).padStart(2,"0")}-${String(c.getDate()).padStart(2,"0")}`,p=`${m.getFullYear()}-${String(m.getMonth()+1).padStart(2,"0")}-${String(m.getDate()).padStart(2,"0")}`;if(u<p){const h=new Date(c.getTime()+144e5),y={status:"Half Day",dayCredit:this.getDayCredit("Half Day"),lateCountable:!1},w=s.currentLocation||s.lastLocation||null,b=new Date().toISOString(),v={id:String(Date.now()),user_id:s.id,date:h.toISOString().split("T")[0],checkIn:c.toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"}),checkOut:h.toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"}),duration:this.msToTime(144e5),durationMs:144e5,type:y.status,dayCredit:y.dayCredit,lateCountable:y.lateCountable,extraWorkedMs:0,policyVersion:"v2",location:w?.address||"Missed checkout session",lat:w?.lat??null,lng:w?.lng??null,checkOutLocation:"System closure on next check-in",outLat:null,outLng:null,workDescription:"System closure: missed checkout auto-closed as half day. Reason required on next login.",locationMismatched:!1,locationExplanation:"",activityScore:0,autoCheckout:!0,autoCheckoutReason:"missed_checkout_next_login",autoCheckoutAt:b,autoCheckoutRequiresApproval:!1,autoCheckoutExtraApproved:null,missedCheckoutResolved:!0,missedCheckoutPolicy:"half_day_on_missed_checkout",missedCheckoutReasonRequired:!0,missedCheckoutReasonStatus:"pending",missedCheckoutReason:"",missedCheckoutReasonSubmittedAt:null,missedCheckoutReviewedBy:"",missedCheckoutReviewedAt:"",missedCheckoutReviewNote:"",systemClosedAt:b,synced:!1};await q.add("attendance",v),r=v.id,d=v.date,s.status="out",s.lastCheckOut=h.getTime(),s.lastLocation=w,s.lastCheckOutLocation={lat:null,lng:null,address:"System closure on next check-in"},s.locationMismatched=!1,s.lastCheckIn=null,s.currentLocation=null,i=!0,o="Previous open session was closed as half day because checkout was missed. Please submit a reason for admin verification."}else return{ok:!1,conflict:!0,message:"Status updated from another device."}}s.status="in",s.lastCheckIn=Date.now();const l=a&&a!=="Unknown Location"?a:e&&t?`Lat: ${Number(e).toFixed(4)}, Lng: ${Number(t).toFixed(4)}`:"Unknown Location";return s.currentLocation={lat:e,lng:t,address:l},await q.put("users",s),{ok:!0,resolvedMissedCheckout:i,noticeMessage:o,missedCheckoutReasonRequired:i,missedCheckoutLogId:r,missedCheckoutDate:d}}async checkOut(e="",t=null,a=null,s="Detected Location",i=!1,o="",r={}){const d=await(Q.refreshCurrentUserFromDB?Q.refreshCurrentUserFromDB():Q.getUser());if(!d||d.status!=="in")return{ok:!1,conflict:!0,message:"Status updated from another device."};const l=new Date(d.lastCheckIn),c=r.checkOutTime?new Date(r.checkOutTime):new Date,m=c-l,u=this.evaluateAttendanceStatus(l,m),p=window.AppActivity?window.AppActivity.getStats():{score:0},f={id:String(Date.now()),user_id:d.id,date:c.toISOString().split("T")[0],checkIn:l.toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"}),checkOut:c.toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"}),duration:this.msToTime(m),durationMs:m,type:u.status,dayCredit:u.dayCredit,lateCountable:u.lateCountable,extraWorkedMs:u.extraWorkedMs||0,policyVersion:"v2",location:d.currentLocation?.address||"Checked In Location",lat:d.currentLocation?.lat,lng:d.currentLocation?.lng,checkOutLocation:s||(t&&a?`Lat: ${Number(t).toFixed(4)}, Lng: ${Number(a).toFixed(4)}`:"Detected Location"),outLat:t,outLng:a,workDescription:e||"",locationMismatched:i,locationExplanation:o||"",activityScore:p.score,autoCheckout:!!r.autoCheckout,autoCheckoutReason:r.autoCheckoutReason||"",autoCheckoutAt:r.autoCheckoutAt||null,autoCheckoutRequiresApproval:!!r.autoCheckoutRequiresApproval,autoCheckoutExtraApproved:r.autoCheckoutExtraApproved??null,overtimePrompted:!!r.overtimePrompted,overtimeReasonTag:r.overtimeReasonTag||"",overtimeExplanation:r.overtimeExplanation||"",overtimeCappedToEightHours:!!r.overtimeCappedToEightHours,taskUpdates:Array.isArray(r.taskUpdates)?r.taskUpdates:[],entrySource:"checkin_checkout",attendanceEligible:!0,synced:!1};return await q.add("attendance",f),d.status="out",d.lastCheckOut=Date.now(),d.lastLocation=d.currentLocation,d.lastCheckOutLocation={lat:t,lng:a,address:s},d.locationMismatched=i,d.lastCheckIn=null,d.currentLocation=null,await q.put("users",d),window.AppActivity&&window.AppActivity.stop(),{ok:!0,conflict:!1}}async addAdminLog(e,t){const a={id:String(Date.now()),user_id:e,...t,isManualOverride:t.isManualOverride===!0,entrySource:t.entrySource||"admin_override",attendanceEligible:Object.prototype.hasOwnProperty.call(t,"attendanceEligible")?t.attendanceEligible===!0:!0,synced:!1};return await q.add("attendance",a),a}async deleteLog(e){if(e)return await q.delete("attendance",e),!0}async updateLog(e,t){if(!e)return;const a=await q.get("attendance",e);if(!a)throw new Error("Log not found");const s={...a,...t,isManualOverride:Object.prototype.hasOwnProperty.call(t,"isManualOverride")?t.isManualOverride===!0:!!a.isManualOverride,entrySource:t.entrySource||a.entrySource||"admin_override",attendanceEligible:Object.prototype.hasOwnProperty.call(t,"attendanceEligible")?t.attendanceEligible===!0:Object.prototype.hasOwnProperty.call(a,"attendanceEligible")?a.attendanceEligible===!0:!0,id:e};return await q.put("attendance",s),s}async addManualLog(e){const t=Q.getUser();if(!t)return;const a=this.buildDateTime(e.date,e.checkIn),s=this.buildDateTime(e.date,e.checkOut),i=a&&s?s-a:0,o=this.evaluateAttendanceStatus(a||new Date,i),r=String(e.type||"").trim(),d=!r||r==="Manual"?o.status:r,l=Object.prototype.hasOwnProperty.call(e,"attendanceEligible")?e.attendanceEligible===!0:d!=="Work Log",c=l?d:r||"Work Log",m={id:String(Date.now()),user_id:t.id,...e,type:c,durationMs:typeof e.durationMs=="number"?e.durationMs:i,dayCredit:l?typeof e.dayCredit=="number"?e.dayCredit:o.dayCredit:0,lateCountable:l&&(e.lateCountable===!0||c==="Late"),extraWorkedMs:l?typeof e.extraWorkedMs=="number"?e.extraWorkedMs:o.extraWorkedMs||0:0,entrySource:e.entrySource||"staff_manual_work",attendanceEligible:l,synced:!1};return await q.add("attendance",m),m}async getLogs(e=null){const t=e||Q.getUser()?.id;if(!t)return[];try{const a=window.AppFirestore;if(!a)return[];let s=a.collection("attendance");s=s.where("user_id","==",t);const r=(await s.get()).docs.map(c=>({...c.data(),id:c.id})).sort((c,m)=>m.id-c.id).map(c=>((!c.location||c.location==="Unknown Location")&&c.lat&&c.lng&&(c.location=`Lat: ${Number(c.lat).toFixed(4)}, Lng: ${Number(c.lng).toFixed(4)}`),c)),d=new Set,l=r.filter(c=>{const m=`${c.date}|${c.checkIn}`;return d.has(m)?!1:(d.add(m),!0)});try{const c=await q.get("users",t);if(c&&c.status==="in"&&c.lastCheckIn){const m=new Date(c.lastCheckIn),u={id:"active_now",date:m.toLocaleDateString(),checkIn:m.toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"}),checkOut:"Active Now",duration:"Working...",type:"Office",location:c.currentLocation?.address&&c.currentLocation.address!=="Unknown Location"?c.currentLocation.address:c.currentLocation?.lat&&c.currentLocation?.lng?`Lat: ${Number(c.currentLocation.lat).toFixed(4)}, Lng: ${Number(c.currentLocation.lng).toFixed(4)}`:"Current Session"};l.unshift(u)}}catch(c){console.warn("Could not fetch active status for logs",c)}return l.slice(0,50)}catch(a){return console.warn("Optimized log fetch failed, falling back to simple filter",a),[]}}async getAllLogs(){return await q.getAll("attendance")}msToTime(e){let t=Math.floor(e/6e4%60);return`${Math.floor(e/(1e3*60*60)%24)}h ${t}m`}buildDateTime(e,t){if(!e||!t)return null;const a=`${e}T${t}:00`,s=new Date(a);return Number.isNaN(s.getTime())?null:s}normalizeType(e){const t=String(e||"").trim();return!t||t==="Manual"?"Present":t==="Manual/WFH"?"Work - Home":t}getDayCredit(e){const t=this.normalizeType(e);return t==="Half Day"?.5:t==="Absent"?0:t==="Present"||t==="Present (Late Waived)"||t==="Late"||t==="Work - Home"||t==="On Duty"?1:0}evaluateAttendanceStatus(e,t=0){if(!e||Number.isNaN(e.getTime()))return{status:"Absent",dayCredit:0,lateCountable:!1,extraWorkedMs:0};if(e.getDay()===0)return{status:"Present",dayCredit:1,lateCountable:!1,extraWorkedMs:0};const s=e.getHours()*60+e.getMinutes(),i=Math.max(0,t)/(1e3*60*60),o=(typeof _<"u"&&_?_.LATE_CUTOFF_MINUTES:555)||555,r=(typeof _<"u"&&_?_.MINOR_LATE_END_MINUTES:615)||615,d=(typeof _<"u"&&_?_.LATE_END_MINUTES:720)||720,l=(typeof _<"u"&&_?_.POST_NOON_END_MINUTES:810)||810,c=(typeof _<"u"&&_?_.AFTERNOON_START_MINUTES:720)||720;let m="Present",u=!1,p=0;return s>=c?(i>=8?m="Present":i>=4?m="Half Day":m="Absent",i>4&&(p=Math.max(0,t-14400*1e3)),{status:m,dayCredit:this.getDayCredit(m),lateCountable:!1,extraWorkedMs:p}):(s>l?m="Absent":s>d||s>r?m=i>=4?"Half Day":"Absent":s>o?i>=8?m="Present (Late Waived)":(m="Late",u=!0):i>=8?m="Present":i>=4?m="Half Day":m="Absent",{status:m,dayCredit:this.getDayCredit(m),lateCountable:u,extraWorkedMs:p})}calculateStatus(e){return this.evaluateAttendanceStatus(e,480*60*1e3).status}}const Xt=new Ua;typeof window<"u"&&(window.AppAttendance=Xt);function x(n){return n==null?"":String(n).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function et(n){return x(n)}function Ra(n){return String(n??"").replace(/\\/g,"\\\\").replace(/'/g,"\\'").replace(/"/g,'\\"').replace(/\n/g,"\\n").replace(/\r/g,"\\r")}function Fe(n,e="https://via.placeholder.com/24"){return!n||typeof n!="string"?e:n.startsWith("http")||n.startsWith("data:")||n.startsWith("/")||n.startsWith("./")?n:e}function rt(n){if(!n)return"Never";const e=new Date(n);if(isNaN(e.getTime()))return"Unknown";const t=Math.floor((new Date-e)/1e3);if(t<60)return"just now";let a=t/31536e3;return a>1?Math.floor(a)+" years ago":(a=t/2592e3,a>1?Math.floor(a)+" months ago":(a=t/86400,a>1?Math.floor(a)+" days ago":(a=t/3600,a>1?Math.floor(a)+" hours ago":(a=t/60,a>1?Math.floor(a)+" mins ago":Math.floor(t)+" seconds ago"))))}typeof window<"u"&&(window.safeHtml=x,window.safeAttr=et,window.safeJsStr=Ra,window.safeUrl=Fe,window.timeAgo=rt);function Ha(n,e=!0){const t=Math.max(0,Math.min(5,Number(n)||0)),a=Math.floor(t),s=t-a>=.5,i=5-a-(s?1:0);let o='<div class="star-rating-display">';for(let r=0;r<a;r++)o+='<i class="fa-solid fa-star star-filled"></i>';s&&(o+='<i class="fa-solid fa-star-half-stroke star-filled"></i>');for(let r=0;r<i;r++)o+='<i class="fa-regular fa-star star-empty"></i>';return e&&(o+=`<span class="star-rating-number">${t.toFixed(1)}</span>`),o+="</div>",o}function Jt(n,e=!0){const t=String(n||"to-be-started").toLowerCase();let a="To Be Started",s="fa-circle-dot",i="status-badge-to-be-started";return t==="in-process"||t==="in-progress"?(a="In Progress",s="fa-spinner fa-spin",i="status-badge-in-process"):t==="completed"?(a="Completed",s="fa-circle-check",i="status-badge-completed"):t==="overdue"?(a="Overdue",s="fa-circle-exclamation",i="status-badge-overdue"):(t==="not-completed"||t==="cancelled")&&(a="Not Completed",s="fa-circle-xmark",i="status-badge-not-completed"),`
    ...
    `},_e={controllers:new WeakMap,elements:new Set};function ct(){return window.app_staffActivityState||(window.app_staffActivityState={selectedMonth:new Date().toISOString().slice(0,7),sortKey:"date-desc",logs:[]}),window.app_staffActivityState}let Nt=!1;function Fa(){Nt||typeof document>"u"||(Nt=!0,document.addEventListener("click",async n=>{const e=n.target&&n.target.closest?n.target.closest(".dashboard-leave-btn[data-action][data-leave-id]"):null;if(!e)return;n.preventDefault();const t=String(e.dataset.action||""),a=String(e.dataset.leaveId||"");if(a)try{if(t==="export"){window.AppLeaves?.exportLeave&&await window.AppLeaves.exportLeave(a);return}if(t==="comment"){window.AppLeaves?.commentLeave&&await window.AppLeaves.commentLeave(a);return}if(t==="approve"||t==="reject"){const s=t==="approve"?"Approved":"Rejected";window.AppLeaves?.updateLeaveStatus&&await window.AppLeaves.updateLeaveStatus(a,s),window.app_refreshCurrentPage&&await window.app_refreshCurrentPage()}}catch(s){console.error("Dashboard leave action failed:",s)}}))}function me(n,e={}){const t=n?.state||(n?.user?"winner":"no_eligible_data");if(!n||t!=="winner"){const h=n?.reason||(t==="fetch_error"?"Hero stats are temporarily unavailable.":"No eligible hero data available."),y=t==="fetch_error"?"Fetch Error":"No Eligible Data";return`
            <div class="card dashboard-hero-stats-card hero-slot">
                <div class="dashboard-hero-stats-head">
                    ...
                    ${e.generatedAt?`<span class="hero-sync-time" title="Source: ${e.source||n?.source||"unknown"}">Synced ${rt(e.generatedAt)}</span>`:""}
                </div>
            ...
            </div>`}const{user:a,stats:s}=n,i=Number(s?.taskPlanned??0),o=Number(s?.taskCompleted??0),r=Number(s?.taskInProgress??0),d=Number(s?.taskMissed??0),l=Number(s?.days??0),c=Number(s?.hours??0),m=Number(s?.attendanceFactor??1),u=e.source==="generated",p=Number.isFinite(Number(n?.confidence))?Math.round(Number(n.confidence)*100):0,f=n?.period==="latest_active_window"?"Latest Active Window":"Weekly";return`
        <div class="card dashboard-hero-stats-card hero-slot ${u?"is-new-summary":""}">
            ...
            <div class="dashboard-hero-stats-body">
                <div class="hero-profile">
                    <img src="${Fe(a.avatar)}" alt="${x(a.name)}" class="hero-avatar">
                    <div class="hero-info">
                        <div class="hero-name">${x(a.name)}</div>
                        <div class="hero-role">${x(a.role||"Staff")}</div>
                    </div>
                </div>
                ...
                <div class="hero-attendance-modifier-row">
                    ...
                    <span class="hero-attendance-pill">Factor <strong>x${m.toFixed(2)}</strong></span>
                </div>
            </div>
            <div class="dashboard-hero-stats-foot">
                <span class="dashboard-kpi-tag">${x(f)}</span>
                <span class="dashboard-kpi-tag">Confidence ${p}%</span>
            </div>
        </div>`}function Zt(n,e=[],t=null,a=[]){const s=new Date,i=new Date(s);i.setDate(i.getDate()-180);const o=i.toISOString().split("T")[0],r=s.toISOString().split("T")[0],d=t?t.id:window.AppAuth.getUser().id,l=t&&t.name||window.AppAuth.getUser().name;return`
    ...
    `}function Qt(n,e,t,a,s=[],i=[]){const o=new Date(e),r=new Date(t);r.setHours(23,59,59,999);const d=n.filter(y=>{const w=new Date(y.date),b=y.workDescription||(y.location&&!y.location.startsWith("Lat:")?y.location:"Standard Activity");return y._displayDesc=b,y._isCollab=!1,y._sortTime=y.checkOut||"00:00",w>=o&&w<=r}),l=[];s.forEach(y=>{const w=new Date(y.date);if(w<o||w>r)return;y.plans.filter(v=>v.tags&&v.tags.some(k=>k.id===a&&k.status==="accepted")).forEach(v=>{l.push({date:y.date,workDescription:`🤝 Collaborated with ${y.userName}: ${v.task}${v.subPlans&&v.subPlans.length>0?` (Sub-tasks: ${v.subPlans.join(", ")})`:""}`,checkOut:"Planned / Accepted",_displayDesc:`🤝 Collaborated with ${y.userName}: ${v.task}${v.subPlans&&v.subPlans.length>0?` (Sub-tasks: ${v.subPlans.join(", ")})`:""}`,_isCollab:!0,_sortTime:"23:59"})})});const c=[];i.forEach(y=>{(y.actionItems||[]).forEach(w=>{if(w.assignedTo!==a)return;const b=w.dueDate||y.date,v=new Date(b);v<o||v>r||c.push({date:b,workDescription:`📋 Meeting Task: ${w.task} (from ${y.title})`,status:w.status||"pending",checkOut:"Action Item",_displayDesc:`📋 Meeting Task: ${w.task} (from ${y.title})`,_isCollab:!1,_isMinute:!0,_meetingId:y.id,_sortTime:"09:00"})})});const m=[...d,...l,...c].sort((y,w)=>{const b=new Date(w.date)-new Date(y.date);return b!==0?b:w._sortTime.localeCompare(y._sortTime)});if(m.length===0)return'<div class="dashboard-activity-empty">No activity descriptions found.</div>';let u="",p="";const f=window.AppAuth.getUser(),h=window.app_hasPerm("dashboard","admin",f);return m.forEach(y=>{y.date!==p&&(u+=`<div class="dashboard-activity-date">${y.date}</div>`,p=y.date);const b=y._isCollab?"#10b981":y._isMinute?"#6366f1":"#e5e7eb",v=y._isCollab?"dashboard-activity-item-collab":y._isMinute?"dashboard-activity-item-minute":"",k=ta(y);let g="";if(y._isCollab||y.status||y._isMinute){const A=window.AppCalendar?window.AppCalendar.getSmartTaskStatus(y.date,y.status):y.status||"to-be-started";g=`
                ...
                </div>`}u+=`<div class="dashboard-activity-item ${v}" style="border-left-color:${b};"><div class="dashboard-activity-desc">${x(y._displayDesc)}</div>${k}${g}<div class="dashboard-activity-meta">${x(y.checkOut||(y.status==="completed"?"Completed":"Planned Activity"))}</div></div>`}),u}function ea(n){const e=ct();e.logs=Array.isArray(n)?n:[],setTimeout(()=>{const s=document.getElementById("staff-activity-list");s&&la(s)},0);const t=Wa(8),a=ut(e.selectedMonth);return`
        ...
        </div>`}function pt(n,e){const t=Ya(n);if(t.length===0)return'<div class="dashboard-activity-empty">No team activities found for the selected month.</div>';const a=Va(t,e),s=a.filter(o=>o._taskStatus==="completed"),i=a.filter(o=>o._taskStatus!=="completed");return`
        <div class="dashboard-team-activity-split-grid">
            ${kt("Completed",s,"No completed tasks in this month.")}
            ${kt("In Progress / Incomplete",i,"No in-progress or incomplete tasks in this month.")}
        </div>
    `}function kt(n,e,t){const a=window.AppAuth.getUser(),s=window.app_hasPerm("dashboard","admin",a),i=e.length===0?`<div class="dashboard-activity-empty">${t}</div>`:e.map(o=>{const r=a&&o.userId===a.id,d=s||r,l=ta(o),c=`
                <div class="dashboard-activity-status-row">
                    ${Jt(o._taskStatus)}
    ...
    `}function ta(n){if(!n)return"";const e=Number.isFinite(Number(n.progressPercent)),t=n.progressStatus?String(n.progressStatus).replace(/_/g," "):"",a=String(n.progressNote||"").trim();if(!e&&!t&&!a&&Array.isArray(n.taskUpdates)&&n.taskUpdates.length>0){const r=n.taskUpdates[0]||{},d=Number.isFinite(Number(r.progressPercent))?`${Number(r.progressPercent)}%`:"",l=r.progressStatus?String(r.progressStatus).replace(/_/g," "):"",c=String(r.progressNote||"").trim();if(!d&&!l&&!c)return"";const m=c?` title="${x(c)}"`:"",u=`${d}${d&&l?" • ":""}${x(l)}`;return`<div class="dashboard-progress-chip"${m}>${u}</div>`}if(!e&&!t&&!a)return"";const s=e?`${Number(n.progressPercent)}%`:"",i=a?` title="${x(a)}"`:"",o=`${s}${s&&t?" • ":""}${x(t)}`;return`<div class="dashboard-progress-chip"${i}>${o}</div>`}function Ce(n,e,t,a=""){const i=Number(t.penalty??t.penaltyLeaves??0)>0?'<span class="dashboard-penalty-badge">Penalty Applies</span>':"";return`
        <div class="card dashboard-stats-card" ${a?` data-stats-type="${x(a)}"`:""} role="button" tabindex="0" aria-label="Open ${x(n)} details">
    ...
    `}function aa(n){const e=Object.entries(n),t={Present:{color:"#166534",bg:"#f0fdf4",label:"Office"},"Work - Home":{color:"#0369a1",bg:"#e0f2fe",label:"WFH"},Training:{color:"#4338ca",bg:"#eef2ff",label:"Training"},Late:{color:"#c2410c",bg:"#fff7ed",label:"Late"},"Sick Leave":{color:"#991b1b",bg:"#fef2f2",label:"Sick"},"Casual Leave":{color:"#9d174d",bg:"#fce7f3",label:"Casual"},"Earned Leave":{color:"#be185d",bg:"#fdf2f8",label:"Earned"},"Paid Leave":{color:"#be123c",bg:"#ffe4e6",label:"Paid"},"Maternity Leave":{color:"#a21caf",bg:"#fae8ff",label:"Maternity"},Absent:{color:"#7f1d1d",bg:"#fee2e2",label:"Absent"},"Early Departure":{color:"#991b1b",bg:"#fff1f2",label:"Early Exit"},Holiday:{color:"#1e293b",bg:"#f1f5f9",label:"Holiday"},"National Holiday":{color:"#334155",bg:"#f8fafc",label:"Nat. Hol"},"Regional Holidays":{color:"#475569",bg:"#f8fafc",label:"Reg. Hol"}};return e.map(([a,s])=>{const i=t[a]||{color:"#374151",bg:"#f3f4f6",label:a};return s===0&&!["Present","Late","Absent","Early Departure"].includes(a)?"":`
         ...
         `}).join("")}function qa(){document.querySelectorAll(".dashboard-stats-card[data-stats-type]").forEach(n=>{if(n.dataset.bound==="1")return;n.dataset.bound="1";const e=n.getAttribute("data-stats-type")||"";n.addEventListener("click",()=>{window.app_openStatsDetailModal&&window.app_openStatsDetailModal(e)}),n.addEventListener("keydown",t=>{(t.key==="Enter"||t.key===" ")&&(t.preventDefault(),window.app_openStatsDetailModal&&window.app_openStatsDetailModal(e))})})}function Bt(n){const e=String(n||"").trim();if(!e||e.toLowerCase().includes("active"))return null;const t=e.match(/(\d{1,2}):(\d{2})\s*(AM|PM)?/i);if(!t)return null;let a=Number(t[1]);const s=Number(t[2]),i=t[3]?t[3].toUpperCase():"";return i==="PM"&&a<12&&(a+=12),i==="AM"&&a===12&&(a=0),a*60+s}function za(n,e){const t={late:new Set,early:new Set,extra:new Set,breakdown:{Present:new Set,"Work - Home":new Set,Training:new Set,"Sick Leave":new Set,"Casual Leave":new Set,"Earned Leave":new Set,"Paid Leave":new Set,"Maternity Leave":new Set,Absent:new Set,Holiday:new Set,"National Holiday":new Set,"Regional Holidays":new Set,Late:new Set,"Early Departure":new Set}},a=e?.start?new Date(e.start):new Date("1970-01-01"),s=e?.end?new Date(e.end):new Date;a.setHours(0,0,0,0),s.setHours(23,59,59,999);let i=Array.isArray(n)?n:[];if(window.AppAnalytics&&window.AppAnalytics.pickBestAttendanceLogPerDay)try{i=window.AppAnalytics.pickBestAttendanceLogPerDay(i,a,s)}catch(l){console.warn("pickBestAttendanceLogPerDay failed",l)}else{const l=new Map;i.forEach(c=>{const m=c.date||"";m&&(l.has(m)||l.set(m,c))}),i=Array.from(l.values())}const o=(typeof _<"u"&&_?_.LATE_CUTOFF_MINUTES:555)||555,r=(typeof _<"u"&&_?_.EARLY_DEPARTURE_MINUTES:1020)||1020;i.forEach(l=>{const c=l.date?new Date(l.date):null;if(!c||Number.isNaN(c.getTime())||c<a||c>s)return;const m=l.date,u=String(l.type||""),p=Bt(l.checkIn),f=Bt(l.checkOut),h=l.isManualOverride===!0;(l.lateCountable===!0||!Object.prototype.hasOwnProperty.call(l,"lateCountable")&&p!==null&&p>o)&&(t.late.add(m),t.breakdown.Late.add(m)),h?u==="Early Departure"&&(t.early.add(m),t.breakdown["Early Departure"].add(m)):f!==null&&f<r&&!String(u).includes("Leave")&&u!=="Absent"&&(t.early.add(m),t.breakdown["Early Departure"].add(m));const w=typeof l.extraWorkedMs=="number"?Math.max(0,Math.round(l.extraWorkedMs/(1e3*60))):0,b=!(l.autoCheckout&&!l.autoCheckoutExtraApproved);(w>0||b&&(p!==null&&p<o||f!==null&&f>r))&&t.extra.add(m),u==="Work - Home"?t.breakdown["Work - Home"].add(m):u==="Training"?t.breakdown.Training.add(m):u==="Sick Leave"?t.breakdown["Sick Leave"].add(m):u==="Casual Leave"?t.breakdown["Casual Leave"].add(m):u==="Earned Leave"?t.breakdown["Earned Leave"].add(m):u==="Paid Leave"?t.breakdown["Paid Leave"].add(m):u==="Maternity Leave"?t.breakdown["Maternity Leave"].add(m):u==="Absent"?t.breakdown.Absent.add(m):u==="National Holiday"?t.breakdown["National Holiday"].add(m):u==="Regional Holidays"?t.breakdown["Regional Holidays"].add(m):String(u).includes("Holiday")?t.breakdown.Holiday.add(m):l.checkIn&&t.breakdown.Present.add(m)});const d=l=>Array.from(l||[]).sort((c,m)=>new Date(c)-new Date(m));return{late:d(t.late),early:d(t.early),extra:d(t.extra),breakdown:Object.fromEntries(Object.entries(t.breakdown).map(([l,c])=>[l,d(c)]))}}function na(n){return!n||n.length===0?`
        ...
        </div>`}function sa(n,e={}){const t=e.title||"Leave History",a=e.subtitle||"Past records";if(!n||n.length===0)return`
        ...
        </div>`}function ia(n,e){return""}function oa(n){const e=(n||[]).filter(t=>!(t.type==="tag"||t.type==="task"||t.type==="mention")||t.dismissedAt||t.read?!1:String(t.status||"pending").toLowerCase()==="pending");return e.length===0?"":`
    ...
    `}function ja(n,e,t){if(!n||n.length===0)return`
        ...
        <div class="card dashboard-staff-directory-card">
                ...
                <div class="dashboard-staff-row ${r&&a-r<12e4?"dashboard-staff-row-new":""}">
                    <div class="dashboard-staff-meta">
                        <div class="dashboard-staff-avatar">
                            <img src="${Fe(o.avatar)}" alt="${x(o.name)}">
                        </div>
        ...
        </div>`}async function ra(){const n=window.AppAuth.getUser(),e=window.app_hasPerm("dashboard","view",n),t=window.app_hasPerm("dashboard","admin",n),s=ct().selectedMonth,i=window.AppDB?.getISTDateKeys?window.AppDB.getISTDateKeys():{todayKey:new Date().toISOString().split("T")[0],yesterdayKey:new Date(Date.now()-1440*60*1e3).toISOString().split("T")[0]},o=i.todayKey,r=i.yesterdayKey,d=!!_?.READ_OPT_FLAGS?.FF_SHARED_DAILY_SUMMARY,l=`hero_stats_${o}`,c=1440*60*1e3,m=e&&window.app_selectedSummaryStaffId?window.app_selectedSummaryStaffId:n.id;console.time("DashboardFetch");const u=async()=>{try{return await window.AppDB.getOrGenerateSummary(l,async()=>{const Y=await window.AppAnalytics.getHeroOfTheWeek({source:"direct_cache"});if(!Y||Y.state==="fetch_error")throw new Error("direct hero unavailable");return Y},c)}catch(Y){return console.warn("Direct hero cache read failed:",Y),null}},p=d?Promise.resolve(null):u(),f=d?Promise.resolve([]):window.AppDB.getOrGenerateSummary(`team_activity_${s}_${o}`,()=>window.AppAnalytics.getAllStaffActivities({mode:"month",month:s,scope:"work"})),h=d&&window.AppDB.getOrCreateDailySummary?window.AppDB.getOrCreateDailySummary({dateKey:o,yesterdayKey:r,staleAfterMs:_?.SUMMARY_POLICY?.STALENESS_MS,lockTtlMs:_?.SUMMARY_POLICY?.LOCK_TTL_MS,generatorFn:()=>window.AppAnalytics.buildDailyDashboardSummary({dateKey:o,selectedMonth:s})}).catch(Y=>(console.warn("Daily summary fetch/generation failed:",Y),null)):null,y=h?Promise.race([h,new Promise(Y=>setTimeout(()=>Y(null),1500))]):Promise.resolve(null);if(!window._dashboardRefreshScheduled){window._dashboardRefreshScheduled=!0;try{const Y=window.AppDB.getIstNow(),ie=new Date(Y);ie.setDate(ie.getDate()+1),ie.setHours(0,0,5,0);const be=ie.getTime()-Y.getTime();setTimeout(()=>{ra().then(oe=>{const ne=document.getElementById("page-content");ne&&(ne.innerHTML=oe)}),window._dashboardRefreshScheduled=!1},Math.max(0,be))}catch(Y){console.warn("failed to schedule dashboard refresh",Y)}}const[w,b,v,k,g,A,S,$,L,I,B,E,D]=await Promise.all([window.AppAttendance.getStatus(),window.AppAttendance.getLogs(m),window.AppAnalytics.getUserMonthlyStats(m),window.AppAnalytics.getUserYearlyStats(m),p,window.AppCalendar?window.AppCalendar.getPlans():{leaves:[],events:[]},f,window.app_hasPerm("leaves","view")?window.AppLeaves.getPendingLeaves():Promise.resolve([]),window.AppDB.getCached?window.AppDB.getCached(window.AppDB.getCacheKey("dashboardUsers","users",{}),_?.READ_CACHE_TTLS?.users||6e4,()=>window.AppDB.getAll("users")):window.AppDB.getAll("users"),window.AppCalendar?window.AppCalendar.getCollaborations(m):Promise.resolve([]),window.app_hasPerm("leaves","view")?window.AppDB.queryMany?window.AppDB.queryMany("leaves",[{field:"status",operator:"==",value:"Pending"}]).catch(()=>window.AppDB.getAll("leaves")):window.AppDB.getAll("leaves"):Promise.resolve([]),y,window.AppMinutes?window.AppMinutes.getMinutes():Promise.resolve([])]);console.timeEnd("DashboardFetch");const M=d?{lowRead:!1,generatedAt:E?.generatedAt||E?.meta?.generatedAt||0,source:E?._source||""}:{};let U=d?E?.hero||null:g,P=d?Array.isArray(E?.teamActivityPreview)?E.teamActivityPreview:[]:S;d&&(!E||!Array.isArray(E.teamActivityPreview))&&setTimeout(()=>Ga(!0),0);const C=me(U,M);if(d&&U==null&&h){const Y="app_hero_fallback_attempted_date",ie=()=>{try{return localStorage.getItem(Y)===o}catch{return!1}},be=()=>{try{localStorage.setItem(Y,o)}catch{}},oe=ne=>{const Se=document.querySelector(".hero-slot");Se&&(Se.outerHTML=ne)};h.then(async ne=>{const Se=ne&&ne.hero?ne.hero:null;if(Se){const he={...M,generatedAt:ne.generatedAt||M.generatedAt,source:ne._source||M.source};oe(me(Se,he));return}const Pt=await u();if(Pt){oe(me(Pt,{...M,generatedAt:Date.now(),source:"direct_cache"}));return}if(oe(me({state:"no_eligible_data",reason:"No eligible hero data available.",source:"shared_summary"},{...M,generatedAt:ne?.generatedAt||M.generatedAt,source:ne?._source||"shared_missing"})),!ie()){be();try{const he=await window.AppAnalytics.getHeroOfTheWeek({source:"direct_fallback"});if(!he||he.state==="fetch_error"){oe(me({state:"fetch_error",reason:"Hero stats are temporarily unavailable.",source:"direct_fallback"},{...M,lowRead:!1,generatedAt:Date.now(),source:"direct_fallback"}));return}await window.AppDB.getOrGenerateSummary(l,async()=>he,c);const Pa={...M,lowRead:!1,generatedAt:Date.now(),source:"direct_fallback"};oe(me(he,Pa))}catch(he){console.warn("Hero fallback direct fetch failed:",he),oe(me({state:"fetch_error",reason:"Hero stats are temporarily unavailable.",source:"direct_fallback"},{...M,generatedAt:Date.now(),source:"direct_fallback"}))}}}).catch(()=>{oe(me({state:"fetch_error",reason:"Hero stats are temporarily unavailable.",source:"shared_error"},{...M,source:"shared_error"}))})}window.AppRating&&n.rating===void 0&&window.AppRating.updateUserRating(n.id).then(Y=>{Object.assign(n,Y)}).catch(()=>{});const O=(L||[]).find(Y=>Y.id===m),H=m===n.id,z=!H&&O?O:n,G=e&&!H&&!t,T=new Date,N=new Date(T.getFullYear(),T.getMonth(),1),W=new Date(T.getFullYear(),T.getMonth()+1,0),V=window.AppAnalytics&&window.AppAnalytics.getFinancialYearDates?window.AppAnalytics.getFinancialYearDates():{start:new Date(T.getFullYear(),0,1),end:new Date(T.getFullYear(),11,31)};window.app_dashboardStatsStore={monthly:v||{},yearly:k||{},monthlyTitle:H?v.label:`${v.label} - ${O?.name||"Staff"}`,monthlySubtitle:H?"Monthly Stats":"Viewing Staff Monthly Stats",yearlyTitle:"Yearly Summary",yearlySubtitle:H?k.label:`${k.label} for ${O?.name||"Staff"}`,logs:Array.isArray(b)?b:[],ranges:{monthly:{start:N.toISOString().split("T")[0],end:W.toISOString().split("T")[0]},yearly:{start:V.start.toISOString().split("T")[0],end:V.end.toISOString().split("T")[0]}}};const J=G?{status:z.status||"out",lastCheckIn:z.lastCheckIn||null}:w,X=J.status==="in",ee=n.notifications||[];n.tagHistory;let ye="00 : 00 : 00",se="Check-in",Ke="action-btn";X&&(se="Check-out",Ke="action-btn checkout");const yt=Y=>{const ie=Math.max(0,Y||0);let be=Math.floor(ie/(1e3*60*60)),oe=Math.floor(ie/(1e3*60)%60),ne=Math.floor(ie/1e3%60);return`${String(be).padStart(2,"0")} : ${String(oe).padStart(2,"0")} : ${String(ne).padStart(2,"0")}`};if(X&&J.lastCheckIn){const Y=new Date(J.lastCheckIn).getTime();ye=yt(Date.now()-Y)}const Ge=ia(),ht=oa(ee);let Xe="";e&&!H&&O&&(Xe=`
                ...
                <div class="dashboard-staff-view-banner-inner">
                    <div class="dashboard-staff-view-banner-profile">
                        <div class="dashboard-staff-view-avatar-wrap">
                            <img src="${Fe(O.avatar)}" alt="${x(O.name)}" class="dashboard-staff-view-avatar">
                        ...
                        <div class="dashboard-staff-view-copy">
                            ...
                            <h3 class="dashboard-staff-view-title">${x(O.name)}'s Dashboard</h3>
                            <div class="dashboard-staff-view-meta">${x(O.role)} • ${x(O.dept||"General")}</div>
                        </div>
                    </div>
            ...
            </div>`);let Ie="";const Le=It(A);if(e){const Y=!!window.app_selectedSummaryStaffId&&window.app_selectedSummaryStaffId!==n.id,ie=(B||[]).slice().sort((ne,Se)=>new Date(Se.appliedOn||0)-new Date(ne.appliedOn||0)),be=Y?ie.filter(ne=>(ne.userId||ne.user_id)===m).slice(0,8):ie.slice(0,8),oe=sa(be,{title:Y?`${O?.name||"Staff"} Leave History`:"Leave Request History",subtitle:Y?"Based on selected staff summary":"Latest requests (all staff)"});Ie=`
            <div class="dashboard-summary-row">
                <div style="flex: 2; min-width: 350px; display: flex; flex-direction: column;">${na($)}${oe}</div>
                <div style="flex: 1; min-width: 300px; display: flex; flex-direction: column; gap: 1rem;">${Le}${C}</div>
            </div>
            <div class="dashboard-stats-row">
                ${Ce(H?v.label:`${v.label} - ${O?.name||"Staff"}`,H?"Monthly Stats":"Viewing Staff Monthly Stats",v,"monthly")}
                ${Ce("Yearly Summary",H?k.label:`${k.label} for ${O?.name||"Staff"}`,k,"yearly")}
            </div>`}else Ie=`
            <div class="dashboard-summary-row">
                <div class="dashboard-summary-col dashboard-summary-col-wide">${Le}</div>
                <div class="dashboard-summary-col dashboard-summary-col-narrow">${C}</div>
            </div>
            <div class="dashboard-stats-row">
                ${Ce(v.label,"Monthly Stats",v,"monthly")}
                ${Ce("Yearly Summary",k.label,k,"yearly")}
            </div>`;const Me=window.app_getReleaseUpdateState&&window.app_getReleaseUpdateState()||{active:!1,countdownLabel:"00:00"};return setTimeout(()=>Fa(),0),`
            ...
            <div class="card full-width dashboard-hero-card">
                ...
                <div class="dashboard-hero-content">
                    <div class="dashboard-hero-row">
                        ...
                        ${e?`<div class="dashboard-viewing-box"><div class="dashboard-viewing-inner"><i class="fa-solid fa-users-viewfinder dashboard-viewing-icon"></i><div class="dashboard-viewing-meta"><div class="dashboard-viewing-head"><div class="dashboard-viewing-label">Viewing Summary For</div>${m!==n.id?'<span class="dashboard-viewing-state">STAFF VIEW ACTIVE</span>':""}</div><select onchange="window.app_changeSummaryStaff(this.value)" class="dashboard-viewing-select"><option value="${n.id}">My Own Summary</option><optgroup label="Staff Members">${(L||[]).filter(Y=>Y.id!==n.id).sort((Y,ie)=>Y.name.localeCompare(ie.name)).map(Y=>`<option value="${Y.id}" ${Y.id===m?"selected":""}>${Y.name}</option>`).join("")}</optgroup></select></div></div></div>`:""}
                        <div class="welcome-icon dashboard-hero-weather"><i class="fa-solid fa-cloud-sun dashboard-hero-weather-icon"></i></div>
                    </div>
                </div>
                <button class="${Me.active?"dashboard-refresh-link is-update-pending":"dashboard-refresh-link"}" onclick="window.app_showSystemUpdatePopup()" title="${Me.active?`Update available. Auto-refresh in ${Me.countdownLabel}`:"Check for System Update"}">
                    ${Me.active?`System update available <span class="dashboard-refresh-countdown">(${Me.countdownLabel})</span>`:"Check for System Update"}
                </button>
            </div>
                ...
                <div class="card check-in-widget dashboard-primary-card dashboard-checkin-card">
                    <div class="dashboard-checkin-head">
                        <div class="dashboard-checkin-avatar-wrap">
                            <img src="${Fe(z.avatar)}" alt="Profile" class="dashboard-checkin-avatar">
                            <div class="dashboard-checkin-status-dot" style="background: ${X?"#10b981":"#94a3b8"};"></div>
                        </div>
                        <div class="dashboard-checkin-identity">
                            <h4 class="dashboard-checkin-name">${x(z.name)}</h4>
                            <p class="text-muted dashboard-checkin-role">${x(z.role)}</p>
                        </div>
                    </div>
                    <div class="dashboard-checkin-timer-wrap">
                        <div class="timer-display dashboard-checkin-timer" id="timer-display">${ye}</div>
                    ...
                    <button class="${Ke} dashboard-checkin-btn" id="attendance-btn" ${G?"disabled":""} title="${G?"View only":""}">${se} <i class="fa-solid fa-fingerprint"></i></button>
                    <div class="location-text dashboard-checkin-location" id="location-text"><i class="fa-solid fa-location-dot"></i><span>${X&&z.currentLocation?`Lat: ${Number(z.currentLocation.lat).toFixed(4)}, Lng: ${Number(z.currentLocation.lng).toFixed(4)}`:"Waiting for location..."}</span></div>
                </div>
                <div class="dashboard-primary-col ${H?"":"dashboard-primary-col-highlight"}">${Zt(b,I,O,D)}</div>
                <div class="dashboard-primary-col">${ea(P)}</div>
            </div>
            ${Ie}
        </div>`}function ut(n){const[e,t]=String(n||"").split("-"),a=Number(e),s=Number(t)-1;return!Number.isInteger(a)||!Number.isInteger(s)||s<0||s>11?n||"Current Month":new Date(a,s,1).toLocaleDateString("en-US",{month:"long",year:"numeric"})}function Wa(n=8){const e=[],t=new Date;t.setDate(1);for(let a=0;a<n;a++){const s=new Date(t);s.setMonth(t.getMonth()-a);const i=s.toISOString().slice(0,7);e.push({key:i,label:ut(i)})}return e}function Ya(n){const e=[],t=new Map;return(n||[]).forEach(a=>{const s=(a._displayDesc||"").trim(),i=`${a.staffName||""}|${a.date||""}|${s}`;t.has(i)||(t.set(i,a),e.push(a))}),e.map(a=>{const s=window.AppCalendar?window.AppCalendar.getSmartTaskStatus(a.date,a.status||""):a.status||"to-be-started";return{...a,_taskStatus:s,_taskGroup:s==="completed"?"completed":"incomplete"}})}function Va(n,e){const t=[...n],a={completed:0,"in-process":1,overdue:2,"not-completed":3,"to-be-started":4};return t.sort((s,i)=>{const o=new Date(i.date)-new Date(s.date),r=String(s.staffName||"").toLowerCase().localeCompare(String(i.staffName||"").toLowerCase());return e==="date-asc"?new Date(s.date)-new Date(i.date)||r:e==="staff-asc"?r||o:e==="staff-desc"?-r||o:e==="completed-first"?s._taskGroup.localeCompare(i._taskGroup)||o:e==="incomplete-first"?i._taskGroup.localeCompare(s._taskGroup)||o:e==="status-priority"?(a[s._taskStatus]??99)-(a[i._taskStatus]??99)||o||r:o||r}),t}function Ka(n){if(!n)return;const e=_e.controllers.get(n);e&&(e.intervalId&&clearInterval(e.intervalId),e.pauseTimeoutId&&clearTimeout(e.pauseTimeoutId),e.resumeTimeoutId&&clearTimeout(e.resumeTimeoutId),n.removeEventListener("mouseenter",e.onMouseEnter),n.removeEventListener("mouseleave",e.onMouseLeave),n.removeEventListener("touchstart",e.onTouchStart),n.removeEventListener("touchend",e.onTouchEnd),n.removeEventListener("touchcancel",e.onTouchCancel),_e.controllers.delete(n),_e.elements.delete(n))}function da(){Array.from(_e.elements).forEach(n=>Ka(n))}function la(n){if(!n)return;da(),n.querySelectorAll(".dashboard-team-activity-col-list").forEach(t=>{const a={intervalId:null,pauseTimeoutId:null,resumeTimeoutId:null,direction:1,isPausedByUser:!1,isWaitingAtEdge:!1},s=(o,r)=>{a.isWaitingAtEdge=!0,a.pauseTimeoutId&&clearTimeout(a.pauseTimeoutId),a.pauseTimeoutId=setTimeout(()=>{a.direction=o,a.isWaitingAtEdge=!1},r)},i=()=>{if(a.isPausedByUser||a.isWaitingAtEdge||!t.isConnected)return;const o=Math.max(0,t.scrollHeight-t.clientHeight);o<=0||(t.scrollTop+=a.direction,a.direction===1&&t.scrollTop>=o?(t.scrollTop=o,s(-1,1500)):a.direction===-1&&t.scrollTop<=0&&(t.scrollTop=0,s(1,1e3)))};a.onMouseEnter=()=>{a.isPausedByUser=!0},a.onMouseLeave=()=>{a.isPausedByUser=!1},a.onTouchStart=()=>{a.isPausedByUser=!0,a.resumeTimeoutId&&clearTimeout(a.resumeTimeoutId)},a.onTouchEnd=()=>{a.resumeTimeoutId&&clearTimeout(a.resumeTimeoutId),a.resumeTimeoutId=setTimeout(()=>{a.isPausedByUser=!1},400)},t.addEventListener("mouseenter",a.onMouseEnter),t.addEventListener("mouseleave",a.onMouseLeave),t.addEventListener("touchstart",a.onTouchStart,{passive:!0}),t.addEventListener("touchend",a.onTouchEnd,{passive:!0}),a.intervalId=setInterval(i,50),_e.controllers.set(t,a),_e.elements.add(t)})}const Ga=async(n=!0)=>{const e=ct(),t=document.getElementById("staff-activity-list"),a=document.getElementById("staff-activity-list-modal");if(!t&&!a)return;da(),n&&window.AppAnalytics&&(e.logs=await window.AppAnalytics.getAllStaffActivities({mode:"month",month:e.selectedMonth,scope:"work"}));const s=pt(e.logs,e.sortKey);t&&(t.innerHTML=s,la(t)),a&&(a.innerHTML=s);const i=document.getElementById("staff-activity-range-label");i&&(i.textContent=ut(e.selectedMonth))};typeof window<"u"&&(window.app_expandTeamActivity=function(){window.app_closeTeamActivityExpanded&&window.app_closeTeamActivityExpanded(),window.location&&(window.location.hash="#team-activities")},window.app_openStatsDetailModal=function(n){const e=window.app_dashboardStatsStore||{},t=n==="yearly"?e.yearly:e.monthly;if(!t)return;const a=n==="yearly"?e.yearlyTitle:e.monthlyTitle,s=n==="yearly"?e.yearlySubtitle:e.monthlySubtitle,i=t.breakdown||{},o=e.ranges?n==="yearly"?e.ranges.yearly:e.ranges.monthly:null,r=za(e.logs||[],o),d=Object.entries(i).filter(([,u])=>Number(u||0)>0),l=document.getElementById("dashboard-stats-modal");l&&l.remove();const c=document.createElement("div");c.id="dashboard-stats-modal",c.className="modal-overlay dashboard-stats-modal",c.innerHTML=`
            <div class="modal-content dashboard-stats-modal-content">
                <div class="dashboard-stats-modal-head">
                    <div>
                        <div class="dashboard-stats-modal-title">${x(a||"Attendance Summary")}</div>
                        <div class="dashboard-stats-modal-sub">${x(s||"")}</div>
                    </div>
        ...
        `,document.body.appendChild(c),document.body.style.overflow="hidden",window._dashboardStatsDetailData={type:n,buckets:r};const m=r.late.length?"late":r.early.length?"early":r.extra.length?"extra":"Present";window.app_updateStatsDetailView(m),c.addEventListener("click",u=>{const p=u.target.closest("[data-stat-detail]");if(p){window.app_updateStatsDetailView(p.getAttribute("data-stat-detail"));return}const f=u.target.closest("[data-breakdown-key]");f&&window.app_updateStatsDetailView(f.getAttribute("data-breakdown-key"))}),c.addEventListener("keydown",u=>{if(u.key!=="Enter"&&u.key!==" ")return;const p=u.target.closest("[data-stat-detail]"),f=u.target.closest("[data-breakdown-key]");(p||f)&&(u.preventDefault(),window.app_updateStatsDetailView(p?p.getAttribute("data-stat-detail"):f.getAttribute("data-breakdown-key")))}),c.addEventListener("click",u=>{u.target===c&&window.app_closeStatsDetailModal()}),window._dashboardStatsEscHandler=u=>{u.key==="Escape"&&window.app_closeStatsDetailModal()},window.addEventListener("keydown",window._dashboardStatsEscHandler)},window.app_closeStatsDetailModal=function(){const n=document.getElementById("dashboard-stats-modal");n&&n.remove(),document.body.style.overflow="",window._dashboardStatsDetailData=null,window._dashboardStatsEscHandler&&(window.removeEventListener("keydown",window._dashboardStatsEscHandler),window._dashboardStatsEscHandler=null)},window.app_updateStatsDetailView=function(n){const t=(window._dashboardStatsDetailData||{}).buckets||{};let a="",s=[];n==="late"?(a="Late Dates",s=t.late||[]):n==="early"?(a="Early Departure Dates",s=t.early||[]):n==="extra"?(a="Extra Hours Dates",s=t.extra||[]):t.breakdown&&Object.prototype.hasOwnProperty.call(t.breakdown,n)?(a=`${n} Dates`,s=t.breakdown[n]||[]):(a="Details",s=[]);const i=document.getElementById("dashboard-stats-detail-title"),o=document.getElementById("dashboard-stats-date-list");i&&(i.textContent=a),o&&(o.innerHTML=s.length?s.map(r=>`<div class="dashboard-stats-date-item">${x(r)}</div>`).join(""):'<div class="dashboard-stats-date-empty">No dates available.</div>'),document.querySelectorAll(".dashboard-stats-modal-tile, .dashboard-stats-modal-row").forEach(r=>{const d=r.getAttribute("data-stat-detail"),l=r.getAttribute("data-breakdown-key");r.classList.toggle("is-active",d&&d===n||l&&l===n)})},window.app_attachStatsCardHandlers=function(){qa()},window.app_expandTeamActivityRefresh=function(){const n=ct(),e=document.getElementById("staff-activity-list-modal"),t=document.getElementById("staff-activity-range-label-modal");e&&(e.innerHTML=pt(n.logs,n.sortKey)),t&&(t.textContent=ut(n.selectedMonth))},window.app_closeTeamActivityExpanded=function(){const n=document.getElementById("team-activity-modal-overlay");n&&(n.remove(),document.body.style.overflow="",window.removeEventListener("keydown",window._teamActivityEscHandler))});async function Xa(){const n=window.AppAuth.getUser(),e=window.AppDB.getCached?await window.AppDB.getCached(window.AppDB.getCacheKey("staffUsers","users",{}),_?.READ_CACHE_TTLS?.users||6e4,()=>window.AppDB.getAll("users")):await window.AppDB.getAll("users"),t=window.app_getMyMessages?await window.app_getMyMessages():await window.AppDB.getAll("staff_messages"),a=e.filter(p=>p.id!==n.id).sort((p,f)=>p.name.localeCompare(f.name));!window.app_staffThreadId&&a.length>0&&(window.app_staffThreadId=a[0].id);const s=e.find(p=>p.id===window.app_staffThreadId),i=p=>x(p).replace(/(https?:\/\/[^\s]+)/g,'<a href="$1" target="_blank" rel="noopener noreferrer">$1</a>'),o=t.filter(p=>p.fromId===n.id&&p.toId===window.app_staffThreadId||p.fromId===window.app_staffThreadId&&p.toId===n.id).sort((p,f)=>new Date(p.createdAt||0)-new Date(f.createdAt||0)),r=o.filter(p=>p.type==="text"),d=o.filter(p=>p.type==="task"),l={};t.forEach(p=>{p.toId===n.id&&!p.read&&(l[p.fromId]=(l[p.fromId]||0)+1)});const c=a.map(p=>{const f=l[p.id]||0;return`
    ...
    `}let Ot=!1;function Ja(){Ot||typeof document>"u"||(Ot=!0,document.addEventListener("click",n=>{const e=n.target.closest("[data-annual-open-day]");if(e){window.app_openAnnualDayPlan?.(e.dataset.annualOpenDay);return}const t=n.target.closest("[data-annual-view]");if(t){window.app_toggleAnnualView?.(t.dataset.annualView);return}if(n.target.closest("[data-annual-jump-today]")){window.app_jumpToAnnualToday?.();return}const s=n.target.closest("[data-annual-year-delta]");if(s){window.app_changeAnnualYear?.(Number(s.dataset.annualYearDelta||0));return}const i=n.target.closest("[data-annual-legend]");if(i){window.app_toggleAnnualLegendFilter?.(i.dataset.annualLegend);return}n.target.closest("[data-annual-export]")&&window.AppReports?.exportAnnualListViewCSV?.(window._annualListItems||[])}),document.addEventListener("input",n=>{const e=n.target.closest("[data-annual-staff-filter]");e&&window.app_setAnnualStaffFilter?.(e.value)}),document.addEventListener("change",n=>{const e=n.target.closest("[data-annual-list-sort]");e&&window.app_setAnnualListSort?.(e.value)}),document.addEventListener("keydown",n=>{const e=n.target.closest("[data-annual-list-search]");e&&n.key==="Enter"&&window.app_setAnnualListSearch?.(e.value)}),document.addEventListener("mouseover",n=>{const e=n.target.closest("[data-annual-preview-date]");!e||e.contains(n.relatedTarget)||window.app_showAnnualHoverPreview?.(n,e.dataset.annualPreviewDate)}),document.addEventListener("mouseout",n=>{const e=n.target.closest("[data-annual-preview-date]");!e||e.contains(n.relatedTarget)||window.app_hideAnnualHoverPreview?.()}))}async function Pe(){typeof window.app_setAnnualStaffFilter!="function"&&(window.app_setAnnualStaffFilter=async D=>{window.app_annualStaffFilter=String(D||"").trim();const M=document.getElementById("page-content");M&&(M.innerHTML=await Pe())}),typeof window.app_toggleAnnualView!="function"&&(window.app_toggleAnnualView=async D=>{window.app_annualViewMode=D;const M=document.getElementById("page-content");M&&(M.innerHTML=await Pe())}),typeof window.app_setAnnualListSearch!="function"&&(window.app_setAnnualListSearch=async D=>{window.app_annualListSearch=String(D||"").trim();const M=document.getElementById("page-content");M&&(M.innerHTML=await Pe())}),typeof window.app_setAnnualListSort!="function"&&(window.app_setAnnualListSort=async D=>{window.app_annualListSort=String(D||"date-asc").trim();const M=document.getElementById("page-content");M&&(M.innerHTML=await Pe())});const n=new Date,e=`${n.getFullYear()}-${String(n.getMonth()+1).padStart(2,"0")}-${String(n.getDate()).padStart(2,"0")}`,t=window.app_annualYear||n.getFullYear(),a=await window.AppCalendar.getPlans(),s=await window.AppDB.getAll("users").catch(()=>[]),i=await window.AppDB.getAll("attendance").catch(()=>[]);window._currentPlans=a;const o=["January","February","March","April","May","June","July","August","September","October","November","December"],r={};(s||[]).forEach(D=>{r[D.id]=D.name}),window._annualUserMap=r;const d=(D,M)=>r[D]||M||"Staff",l=window.app_annualLegendFilters||{leave:!0,event:!0,work:!0,overdue:!0,completed:!0};window.app_annualLegendFilters=l;let c=window.app_selectedAnnualDate||(t===n.getFullYear()?e:null);c&&!c.startsWith(`${t}-`)&&(c=null),window.app_selectedAnnualDate=c;const m=String(window.app_annualStaffFilter||"").trim(),u=m.toLowerCase(),p=String(window.app_annualListSearch||"").trim(),f=p.toLowerCase(),h=String(window.app_annualListSort||"date-asc"),y=(s||[]).map(D=>`<option value="${x(D.name)}"></option>`).join(""),w=D=>u?String(D||"").toLowerCase().includes(u):!0,b={january:0,february:1,march:2,april:3,may:4,june:5,july:6,august:7,september:8,october:9,november:10,december:11},v=(D="")=>{const M=String(D||"").trim();if(!M)return null;const U=M.match(/(\d{1,2})\s*-\s*(\d{1,2})\s+([A-Za-z]+)\s+(\d{4})/);if(!U)return null;const P=Number(U[1]),C=Number(U[2]),O=String(U[3]||"").toLowerCase(),H=Number(U[4]),z=b[O];if(!Number.isInteger(P)||!Number.isInteger(C)||!Number.isInteger(z)||!Number.isInteger(H))return null;const G=new Date(H,z,P),T=new Date(H,z,C);if(Number.isNaN(G.getTime())||Number.isNaN(T.getTime()))return null;const N=`${G.getFullYear()}-${String(G.getMonth()+1).padStart(2,"0")}-${String(G.getDate()).padStart(2,"0")}`,W=`${T.getFullYear()}-${String(T.getMonth()+1).padStart(2,"0")}-${String(T.getDate()).padStart(2,"0")}`;return W<N?null:{startDate:N,endDate:W}},k=(D,M)=>{const U=!D?.startDate&&!D?.endDate?v(D?.task||""):null,P=D?.startDate||U?.startDate||M,C=D?.endDate||U?.endDate||D?.startDate||M;return{startDate:P,endDate:C}},g=(D,M,U)=>{const{startDate:P,endDate:C}=k(D,M);return!P||!C?M===U:!(U<P||U>C||D?.completedDate&&D.completedDate<U)},A=(a.workPlans||[]).filter(D=>{if((D.planScope||"personal")==="annual"){if(!u)return!0;const P=d(D.userId,D.userName);return w(P)?!0:(D.plans||[]).some(C=>{const O=d(C.assignedTo||D.userId,P),H=(C.tags||[]).map(z=>z.name||z).join(" ");return w(O)||w(H)})}if(!u)return!0;const U=d(D.userId,D.userName);return w(U)?!0:(D.plans||[]).some(P=>{const C=d(P.assignedTo||D.userId,U),O=(P.tags||[]).map(H=>H.name||H).join(" ");return w(C)||w(O)})}),S=(a.leaves||[]).filter(D=>w(d(D.userId,D.userName))),$=(i||[]).filter(D=>{if(!String(D.date||"").startsWith(String(t)))return!1;const U=D.user_id||D.userId,P=d(U,"");return u?w(P):!0}),L=(D,M,U)=>{const P=`${U}-${String(M+1).padStart(2,"0")}-${String(D).padStart(2,"0")}`,C=S.some(N=>P>=N.startDate&&P<=N.endDate),O=!u&&(a.events||[]).some(N=>N.date===P),H=$.some(N=>N.date===P),z=A.some(N=>!Array.isArray(N.plans)||!N.plans.length?N.date===P:N.plans.some(W=>g(W,N.date,P)))||H;let G="",T=!1;if(z){const N=A.filter(V=>!Array.isArray(V.plans)||!V.plans.length?V.date===P:V.plans.some(J=>g(J,V.date,P)));let W="to-be-started";N.forEach(V=>{(V.plans||[]).forEach(J=>{if(!g(J,V.date,P))return;const{startDate:X,endDate:ee}=k(J,V.date);X&&ee&&X!==ee&&ee===P&&(T=!0);const ye=J.completedDate||ee||V.date||P,se=window.AppCalendar?window.AppCalendar.getSmartTaskStatus(ye,J.status):J.status||"pending";se==="overdue"?W="overdue":se==="in-process"&&W!=="overdue"?W="in-process":se==="completed"&&W!=="overdue"&&W!=="in-process"&&(W="completed")})}),H&&W==="to-be-started"&&(W="completed"),G=W}return{hasLeave:C,hasEvent:O,hasWork:z,workStatus:G,hasRangeEnd:T}};let I="";for(let D=0;D<12;D++){const M=new Date(t,D,1).getDay(),U=new Date(t,D+1,0).getDate();let P="";for(let C=0;C<M;C++)P+='<div class="annual-day empty"></div>';for(let C=1;C<=U;C++){const O=L(C,D,t),H=C===n.getDate()&&D===n.getMonth()&&t===n.getFullYear(),z=`${t}-${String(D+1).padStart(2,"0")}-${String(C).padStart(2,"0")}`,G=O.hasLeave&&l.leave,T=O.hasEvent&&l.event,N=O.hasWork&&l.work&&(O.workStatus==="overdue"?l.overdue:O.workStatus==="completed"?l.completed:!0),W=G||T||N,V=N?`has-work work-${O.workStatus}`:"";P+=`
                <div class="annual-day ${H?"today":""} ${V} ${c===z?"selected":""} ${W?"":"annual-day-muted"}" data-annual-open-day="${z}" data-annual-preview-date="${z}">
                    ${C}
                    <div class="dot-container">
                        ${G?'<span class="status-dot dot-leave"></span>':""}
                        ${T?'<span class="status-dot dot-event"></span>':""}
                        ${N?'<span class="status-dot dot-work"></span>':""}
                        ${O.hasRangeEnd?'<span class="status-dot" title="Task ends today" style="background:#f97316;"></span>':""}
                    </div>
                </div>`}I+=`
            ...
            </div>`}const B=window.app_annualViewMode||"grid",E=(()=>{const D=[],M=new Set,U=T=>{if(!T)return"";const N=String(T).replace(/_/g,"-").toLowerCase();return{"in-process":"In Process","to-be-started":"To Be Started","not-completed":"Not Completed",completed:"Completed",overdue:"Overdue",pending:"Pending",approved:"Approved",holiday:"Holiday",event:"Event"}[N]||N.replace(/\b\w/g,V=>V.toUpperCase())},P=(T,N)=>N||(window.AppCalendar&&T?window.AppCalendar.getSmartTaskStatus(T,N):"pending");if(!u&&window.AppAnalytics){const T=new Date(t,0,1),N=new Date(t,11,31);for(let W=new Date(T);W<=N;W.setDate(W.getDate()+1)){const V=W.toISOString().split("T")[0],J=window.AppAnalytics.getDayType(W);J==="Holiday"?D.push({date:V,type:"holiday",title:"Company Holiday (Weekend)",staffName:"All Staff",assignedBy:"System",assignedTo:"All Staff",selfAssigned:!1,dueDate:V,status:"holiday",comments:"",scope:"Shared"}):J==="Half Day"&&D.push({date:V,type:"event",title:"Half Working Day (Sat)",staffName:"All Staff",assignedBy:"System",assignedTo:"All Staff",selfAssigned:!1,dueDate:V,status:"event",comments:"",scope:"Shared"})}}S.forEach(T=>{const N=new Date(T.startDate),W=new Date(T.endDate||T.startDate),V=d(T.userId,T.userName);for(let J=new Date(N);J<=W;J.setDate(J.getDate()+1)){const X=J.toISOString().split("T")[0];X.startsWith(String(t))&&D.push({date:X,type:"leave",title:`${V} (${T.type||"Leave"})`,staffName:V,assignedBy:V,assignedTo:V,selfAssigned:!0,dueDate:T.endDate||T.startDate||X,status:(T.status||"approved").toLowerCase(),comments:T.reason||"",scope:"Personal"})}}),(a.events||[]).forEach(T=>{if(!u&&String(T.date||"").startsWith(String(t))){const N=[String(T.date||"").trim(),String(T.title||"").trim().toLowerCase(),String(T.type||"event").trim().toLowerCase(),String(T.createdById||T.createdByName||"").trim().toLowerCase()].join("|");if(M.has(N))return;M.add(N),D.push({date:T.date,type:T.type||"event",title:T.title||"Company Event",staffName:"All Staff",assignedBy:T.createdByName||"Admin",assignedTo:"All Staff",selfAssigned:!1,dueDate:T.date,status:"event",comments:T.description||"",scope:"Shared"})}}),A.forEach(T=>{if(String(T.date||"").startsWith(String(t))){const N=(T.planScope||"personal")==="annual",W=d(T.userId,T.userName)||(N?"All Staff":"Staff"),V=N?"Annual":"Personal",J=T.date;T.plans&&T.plans.length>0&&T.plans.forEach(X=>{const ee=N?T.createdByName||X.taggedByName||"Admin":X.taggedByName||W,ye=X.assignedTo||T.userId,se=N?ee:d(ye,W),Ke=(X.tags||[]).map(Le=>Le.name||Le).filter(Boolean),{startDate:yt,endDate:Ge}=k(X,J),ht=X.completedDate||Ge||J,Xe=P(ht,X.status),Ie=X.subPlans&&X.subPlans.length?X.subPlans.join("; "):X.comment||X.notes||"";D.push({date:yt||J,type:"work",title:X.task||"Work Plan Task",staffName:N?ee:se,assignedBy:ee,assignedTo:N?ee:se,selfAssigned:ee===se,dueDate:X.dueDate||Ge||J,status:Xe,comments:Ie,tags:Ke,scope:V})})}}),$.forEach(T=>{const N=T.user_id||T.userId,W=d(N,"Staff"),V=(T.workDescription||T.location||"").trim()||"Manual log entry";D.push({date:T.date,type:"work",title:V,staffName:W,assignedBy:W,assignedTo:W,selfAssigned:!0,dueDate:T.date,status:"completed",comments:V,tags:["Manual Log"],scope:"Personal"})});const C=[],O=new Set;D.forEach(T=>{const N=`${T.date||""}|${T.type||""}|${T.title||""}|${T.staffName||""}|${T.status||""}`.toLowerCase();O.has(N)||(O.add(N),C.push(T))}),C.sort((T,N)=>T.date.localeCompare(N.date)||T.type.localeCompare(N.type)),C.forEach(T=>{T.statusLabel=U(T.status),T.statusClass=String(T.status||"pending").replace(/[^a-z0-9]+/gi,"-").toLowerCase()});let H=f?C.filter(T=>[T.date,T.staffName,T.title,T.statusLabel,T.comments].join(" ").toLowerCase().includes(f)):C;const z={"date-asc":(T,N)=>String(T.date||"").localeCompare(String(N.date||"")),"date-desc":(T,N)=>String(N.date||"").localeCompare(String(T.date||"")),"staff-asc":(T,N)=>String(T.staffName||"").localeCompare(String(N.staffName||"")),"staff-desc":(T,N)=>String(N.staffName||"").localeCompare(String(T.staffName||"")),"status-asc":(T,N)=>String(T.statusLabel||"").localeCompare(String(N.statusLabel||"")),"status-desc":(T,N)=>String(N.statusLabel||"").localeCompare(String(T.statusLabel||""))},G=z[h]||z["date-asc"];return H.slice().sort(G)})();return window._annualListItems=E,setTimeout(()=>Ja(),0),`
        <div class="annual-plan-shell annual-v2-shell">
            <div class="card annual-plan-header annual-v2-header">
                ...
                <div class="annual-plan-controls annual-v2-controls">
                    ...
                    <div class="annual-view-toggle annual-v2-view-toggle">
                        <button data-annual-view="grid" class="annual-toggle-btn annual-v2-toggle-btn ${B==="grid"?"active":""}">
                            <i class="fa-solid fa-calendar-days"></i> Grid
                        </button>
                        <button data-annual-view="list" class="annual-toggle-btn annual-v2-toggle-btn ${B==="list"?"active":""}">
                            ...
                            <div class="annual-list-table">
                                ...
                                ${E.map(D=>`
                                    <div class="annual-list-row">
                                        ...
                                        <div class="annual-list-cell">${x(D.staffName)}</div>
                                        <div class="annual-list-cell annual-list-task">${x(D.title)}</div>
                                        <div class="annual-list-cell">${x(D.assignedBy)}</div>
                                        <div class="annual-list-cell"><span class="annual-list-status status-${D.statusClass}">${D.statusLabel}</span></div>
                                        <div class="annual-list-cell annual-list-comments">${x(D.comments||"--")}</div>
        ...
        </div>`}let Ut=!1;function Za(){Ut||typeof document>"u"||(Ut=!0,document.addEventListener("click",n=>{const e=n.target.closest("[data-timesheet-open-day]");if(e){window.app_openTimesheetDayDetail?.(e.dataset.timesheetOpenDay);return}if(n.target.closest("[data-timesheet-request-leave]")){const c=document.getElementById("leave-modal");c&&(c.style.display="flex");return}if(n.target.closest("[data-timesheet-manual-log]")){document.dispatchEvent(new CustomEvent("open-log-modal"));return}const s=n.target.closest("[data-timesheet-month-delta]");if(s){window.app_changeTimesheetMonth?.(Number(s.dataset.timesheetMonthDelta||0));return}if(n.target.closest("[data-timesheet-today]")){window.app_jumpTimesheetToday?.();return}const o=n.target.closest("[data-timesheet-export]");if(o){window.AppReports?.exportUserLogs?.(o.dataset.timesheetExportUser||"");return}const r=n.target.closest("[data-timesheet-edit-log]");if(r){window.app_editWorkSummary?.(r.dataset.timesheetEditLog);return}const d=n.target.closest("[data-timesheet-detail-log]");if(d){const c=d.dataset.timesheetDetailLog;alert("Detailed analysis for log "+c+" coming soon!");return}const l=n.target.closest("[data-timesheet-close-modal]");l&&l.closest(".modal-overlay")?.remove()}),document.addEventListener("change",n=>{const e=n.target.closest("[data-timesheet-view-select]");e&&window.app_toggleTimesheetViewSelect?.(e.value)}))}async function Ne(){setTimeout(()=>Za(),0),typeof window.app_setTimesheetView!="function"&&(window.app_setTimesheetView=async g=>{window.app_timesheetViewMode=g==="calendar"?"calendar":"list";const A=document.getElementById("page-content");A&&(A.innerHTML=await Ne())}),typeof window.app_changeTimesheetMonth!="function"&&(window.app_changeTimesheetMonth=async g=>{const A=new Date,S=Number.isInteger(window.app_timesheetMonth)?window.app_timesheetMonth:A.getMonth(),$=Number.isInteger(window.app_timesheetYear)?window.app_timesheetYear:A.getFullYear(),L=new Date($,S,1);L.setMonth(L.getMonth()+g),window.app_timesheetMonth=L.getMonth(),window.app_timesheetYear=L.getFullYear();const I=document.getElementById("page-content");I&&(I.innerHTML=await Ne())}),typeof window.app_jumpTimesheetToday!="function"&&(window.app_jumpTimesheetToday=async()=>{const g=new Date;window.app_timesheetMonth=g.getMonth(),window.app_timesheetYear=g.getFullYear();const A=document.getElementById("page-content");A&&(A.innerHTML=await Ne())});const n=window.AppAuth.getUser(),e=await window.AppAttendance.getLogs(),t=await window.AppCalendar.getPlans().catch(()=>({workPlans:[]})),a=new Date,s=window.app_timesheetViewMode||"list",i=Number.isInteger(window.app_timesheetMonth)?window.app_timesheetMonth:a.getMonth(),o=Number.isInteger(window.app_timesheetYear)?window.app_timesheetYear:a.getFullYear(),r=new Date(o,i,1).toLocaleString("en-US",{month:"long",year:"numeric"}),d=`${o}-${String(i+1).padStart(2,"0")}-01`,l=`${o}-${String(i+1).padStart(2,"0")}-31`,c=e.filter(g=>g.date&&g.date>=d&&g.date<=l),m=(t.workPlans||[]).filter(g=>g.userId===n.id&&g.date&&g.date>=d&&g.date<=l),u={};c.forEach(g=>{u[g.date]||(u[g.date]=[]),u[g.date].push(g)});const p={};m.forEach(g=>{p[g.date]||(p[g.date]=[]),(Array.isArray(g.plans)?g.plans:[]).forEach(S=>{p[g.date].push(S.task||"Planned task")})}),window._timesheetLogsByDate=u,window._timesheetPlansByDate=p;let f=0,h=0;const y=new Set;c.forEach(g=>{g.durationMs&&(f+=g.durationMs/(1e3*60)),(g.lateCountable||window.AppAttendance&&window.AppAttendance.normalizeType(g.type)==="Late")&&h++,g.date&&y.add(g.date)});const w=`${Math.floor(f/60)}h ${Math.round(f%60)}m`,b=Math.floor(h/(_?.LATE_GRACE_COUNT||3))*(_?.LATE_DEDUCTION_PER_BLOCK||.5),v=g=>window.AppAttendance&&window.AppAttendance.normalizeType?window.AppAttendance.normalizeType(g):g;window.app_editWorkSummary=async g=>{const S=(await window.AppAttendance.getLogs()).find(I=>I.id===g),$=S?S.workDescription:"",L=await window.appPrompt("Update Work Summary:",$||"",{title:"Update Work Summary",confirmText:"Save"});if(L!==null){await window.AppAttendance.updateLog(g,{workDescription:L});const I=document.getElementById("page-content");I&&(I.innerHTML=await Ne())}},window.app_switchTimesheetPanel=(g,A)=>{const S=g==="calendar"?"calendar":"list";window.app_timesheetViewMode=S;const $=document.getElementById("timesheet-list-panel"),L=document.getElementById("timesheet-calendar-panel"),I=document.getElementById("timesheet-view-select");$&&($.style.display=S==="list"?"block":"none"),L&&(L.style.display=S==="calendar"?"block":"none"),I&&(I.value=S);const B=A&&A.closest?A.closest(".timesheet-view-toggle"):null;(B?B.querySelectorAll(".annual-toggle-btn"):[]).forEach(D=>D.classList.remove("active")),A&&A.classList&&A.classList.add("active")},window.app_openTimesheetDayDetail=g=>{const A=window._timesheetLogsByDate&&window._timesheetLogsByDate[g]||[],S=window._timesheetPlansByDate&&window._timesheetPlansByDate[g]||[],$=A.length?A.map(E=>`
                <div class="timesheet-day-detail-item">
                    <div class="timesheet-day-detail-head">
                        <span>${x(E.checkIn||"--")} - ${x(E.checkOut||"--")}</span>
                        <span class="timesheet-day-status-chip">${x(v(E.type))}</span>
                    </div>
            ...
            `).join(""):'<div class="timesheet-day-detail-empty">No attendance logs for this date.</div>',L=S.length?S.map(E=>`<div class="timesheet-day-plan-item">${x(E)}</div>`).join(""):'<div class="timesheet-day-detail-empty">No planned tasks for this date.</div>',I=`timesheet-day-detail-${Date.now()}`,B=`
            <div class="modal-overlay" id="${I}" style="display:flex;">
                <div class="modal-content" style="max-width:560px;">
                    <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:0.75rem;">
                        <h3 style="margin:0;">${x(g)} Details</h3>
            ...
            </div>`;typeof window.app_showModal=="function"?window.app_showModal(B,I):(document.getElementById("modal-container")||document.body).insertAdjacentHTML("beforeend",B)};const k=()=>{const g=new Date(o,i,1).getDay(),A=new Date(o,i+1,0).getDate();let S="";for(let $=0;$<g;$++)S+='<div class="timesheet-cal-day empty"></div>';for(let $=1;$<=A;$++){const L=`${o}-${String(i+1).padStart(2,"0")}-${String($).padStart(2,"0")}`,I=u[L]||[],B=I.length?I.slice().sort((H,z)=>{const G=T=>{const N=v(T.type);return N==="Absent"?4:N==="Half Day"?3:N==="Late"?2:N==="Present (Late Waived)"?1:0};return G(z)-G(H)})[0]:null,E=p[L]||[],D=L===new Date().toISOString().split("T")[0],M=B?v(B.type):"",U=B?M==="Absent"?"absent":M==="Half Day"||M==="Late"?"late":"present":"none",P=B?M:"No log",C=I.map(H=>(H.workDescription||H.location||"").trim()).filter(Boolean),O=C.length?C.slice(0,2).map(H=>`<div class="timesheet-cal-plan">${x(H)}</div>`).join("")+(C.length>2?`<div class="timesheet-cal-more">+${C.length-2} more logs</div>`:""):E.length?E.slice(0,2).map(H=>`<div class="timesheet-cal-plan">${x(H)}</div>`).join("")+(E.length>2?`<div class="timesheet-cal-more">+${E.length-2} more</div>`:""):'<div class="timesheet-cal-empty">No plans</div>';S+=`
                <div class="timesheet-cal-day ${D?"today":""}" data-timesheet-open-day="${L}" style="cursor:pointer;">
                    <div class="timesheet-cal-day-head">
                        ...
                        <span class="timesheet-cal-attendance ${U}">${P}</span>
                    </div>
                    <div class="timesheet-cal-plans">${O}</div>
                </div>`}return`
                                ...
                                <td data-label="Work Summary" class="timesheet-summary-cell">
                                    <div class="timesheet-summary-wrap">
                                        <div class="dashboard-viewing-meta">
                                            <div class="timesheet-summary-text">${x(g.workDescription)||'<span class="timesheet-empty-summary">No summary provided</span>'}</div>
                                            ${g.location?`<div class="timesheet-location"><i class="fa-solid fa-location-dot"></i> ${x(g.location)}</div>`:""}
                                        </div>
            ...
            <div class="pro-profile-root">
                    ...
                    <div class="pro-profile-hero-inner">
                        ...
                        <div class="pro-profile-header-actions">
                            ...
                            <select class="pro-profile-staff-picker" onchange="window.app_changeProfileStaff(this.value)">
                                ...
                                ${t.map(b=>`<option value="${b.id}" ${b.id===a?"selected":""}>${x(b.name)}</option>`).join("")}
                            </select>`:""}
                            ${m?`
                ...
                <div class="pro-profile-stats-strip">
                    ...
                    <div class="pro-stat-tile">
                        ...
                        <div class="pro-stat-value">${f}${typeof f=="number"?"h":""}</div>
                        ...
                        <div class="pro-card" style="margin-top:1rem;">
                            ...
                            <div class="pro-breakdown-grid">
                                ...
                                <div class="pro-breakdown-chip">
                                    ...
                                    <span class="pro-breakdown-key">${x(b)}</span>
                                </div>`).join("")}
                            </div>
                        </div>`:""}
                    </div>
                                ...
                                <tr>
                                    ...
                                    <td style="border-right: 2px solid #ddd; position: sticky; left: 35px; background: #fff; z-index: 5; font-weight: 500; padding:4px;">
                                        <div style="display:flex; flex-direction:column;">
                                            <span style="font-size:0.75rem; white-space:nowrap; overflow:hidden; text-overflow:ellipsis; max-width:110px;">${x(g.name)}</span>
                                            <span style="font-size:0.65rem; color:#666; font-weight:400;">${x(g.dept||"General")}</span>
                                        </div>
                                    </td>
                                    ${u.map(S=>{const $=`${r}-${String(o+1).padStart(2,"0")}-${String(S).padStart(2,"0")}`,I=c.filter(P=>(P.userId===g.id||P.user_id===g.id)&&P.date===$).filter(b),B=f($);let E="-",D="",M="No log";if(I.length>0){const P=I.slice().sort((O,H)=>w(H)-w(O))[0],C=window.AppAttendance&&window.AppAttendance.normalizeType?window.AppAttendance.normalizeType(P.type):P.type;E=C.charAt(0).toUpperCase(),M=`${P.checkIn} - ${P.checkOut||"Active"}
${C}`,C==="Present"?D="color: #10b981; font-weight: bold; font-size: 0.9rem;":C==="Late"?(D="color: #f59e0b; font-weight: bold;",E="L"):C==="Half Day"?(D="color: #c2410c; font-weight: bold;",E="HD"):C==="Absent"?(D="color: #ef4444; font-weight: bold;",E="A"):C.includes("Leave")?(D="color: #8b5cf6; font-weight: bold;",E="C"):C==="Work - Home"?(D="color: #0ea5e9; font-weight: bold;",E="W"):C==="On Duty"&&(D="color: #0369a1; font-weight: bold;",E="D"),P.isManualOverride&&(D="color: #be185d; font-weight: bold; background: #fdf2f8;")}else{const P=$===v&&g.status==="in"&&g.lastCheckIn&&k(g.lastCheckIn)===$,C=typeof g.joinDate=="string"&&/^\d{4}-\d{2}-\d{2}$/.test(g.joinDate)?$<g.joinDate:!1,O=$>v;P?(E="P",D="color: #10b981; font-weight: bold; font-size: 0.9rem;",M="Checked in (pending checkout)"):O||C?(E="-",D="color: #94a3b8; font-weight: 600;",M=O?"Future date":`Before joining date (${g.joinDate})`):B==="holiday"?(E="H",D="color: #64748b; font-weight: 700;",M="Holiday"):(E="A",D="color: #ef4444; font-weight: bold;",M="Absent")}return a||t&&(g.id===t.id||g.user_id===t.id||g.username&&t.username&&g.username===t.username||g.email&&t.email&&g.email===t.email)||(M=""),`<td style="text-align:center; ${a?"cursor:pointer;":""} border-right: 1px solid #eee; padding:2px; font-size:0.75rem; ${D}" ${M?`title="${M}"`:""} ${a?`onclick="window.app_openCellOverride('${g.id}', '${$}')"`:""}>${E}</td>`}).join("")}
                                </tr>`).join("")}
                        </tbody>
                    </table>
                </div>
            </div>
        </div>`}async function ua(n=null,e=null){let t=[],a=[],s={avgScore:0,trendData:[0,0,0,0,0,0,0],labels:[]},i=[],o=[];try{const p=new Date().toISOString().split("T")[0];n=n||p,e=e||p;const f=await Promise.allSettled([window.AppDB.getCached?window.AppDB.getCached(window.AppDB.getCacheKey("adminUsers","users",{}),_?.READ_CACHE_TTLS?.users||6e4,()=>window.AppDB.getAll("users")):window.AppDB.getAll("users"),window.AppAnalytics.getSystemPerformance(),window.AppDB.queryMany?window.AppDB.queryMany("location_audits",[],{orderBy:[{field:"timestamp",direction:"desc"}],limit:300}).catch(()=>window.AppDB.getAll("location_audits")):window.AppDB.getAll("location_audits"),window.AppLeaves.getPendingLeaves(),window.AppDB.queryMany?window.AppDB.queryMany("system_audit_logs",[],{orderBy:[{field:"createdAt",direction:"desc"}],limit:80}).catch(()=>window.AppDB.getAll("system_audit_logs")):window.AppDB.getAll("system_audit_logs")]),h=(y,w,b)=>{const v=f[y];return v&&v.status==="fulfilled"?v.value:(v&&v.status==="rejected"&&console.warn(`Admin data fetch failed for ${b}:`,v.reason),w)};t=h(0,[],"users"),s=h(1,{avgScore:0,trendData:[0,0,0,0,0,0,0],labels:[]},"performance"),i=h(2,[],"location_audits"),a=h(3,[],"pending_leaves"),o=h(4,[],"system_audit_logs"),i=i.filter(y=>{const w=new Date(y.timestamp).toISOString().split("T")[0];return w>=n&&w<=e}).sort((y,w)=>w.timestamp-y.timestamp),o=(o||[]).filter(y=>y&&y.module==="simulation"&&String(y.type||"").startsWith("legacy_dummy_cleanup_")).sort((y,w)=>Number(w.createdAt||0)-Number(y.createdAt||0)).slice(0,25)}catch(p){console.error("Failed to fetch admin data",p)}const r=t.filter(p=>p.status==="in").length,d=t.filter(p=>p.role==="Administrator"||p.isAdmin===!0).length,l=s.avgScore>70?"Optimal":s.avgScore>40?"Good":"Low",c=s.avgScore>70?"#166534":s.avgScore>40?"#854d0e":"#991b1b",m=s.avgScore>70?"#f0fdf4":s.avgScore>40?"#fefce8":"#fef2f2",u=p=>{const f=p&&p.payload?p.payload:{},h=f.deleted||{},y=f.configuredTargets||{};if(p.type==="legacy_dummy_cleanup_completed")return[`users=${Number(h.users||0)}`,`attendance=${Number(h.attendance||0)}`,`leaves=${Number(h.leaves||0)}`,`workPlans=${Number(h.workPlans||0)}`].join(", ");if(p.type==="legacy_dummy_cleanup_skipped"){const w=f.reason||"unknown",b=Array.isArray(y.ids)?y.ids.length:0,v=Array.isArray(y.usernames)?y.usernames.length:0;return`reason=${w}, targetIds=${b}, targetUsernames=${v}`}return p.type==="legacy_dummy_cleanup_failed"?String(f.message||"Unknown error"):"-"};return window.app_applyAuditFilter=async()=>{const p=document.getElementById("audit-start")?.value,f=document.getElementById("audit-end")?.value,h=document.getElementById("page-content");h&&(h.innerHTML=await ua(p,f))},`
        <div class="dashboard-grid dashboard-modern dashboard-admin-view">
            ...
            <div class="card admin-performance-card">
                <div class="admin-performance-head">
                    ...
                    <div class="admin-performance-status" style="background:${m}; color:${c};">${l}</div>
                </div>
                ...
                <div class="admin-staff-head">
                 ...
                 <div class="table-container mobile-table-card">
                    <table>
                        ...
                        <tbody>
                            ${t.map(p=>{const f=p.lastSeen&&Date.now()-p.lastSeen<12e4;return`
                                <tr>
                                    <td>
                                        <div class="admin-user-cell">
                                            <img src="${p.avatar}" class="admin-user-avatar">
                                            <div>
                                                <div class="admin-user-name-row">${x(p.name)} ${f?'<span class="admin-user-live-tag">LIVE</span>':""}</div>
        ...
        </div>`}async function Qa(){const n=await window.AppAnalytics.getSystemMonthlySummary(),e=new Date,t=window.AppAuth.getUser(),a=window.app_hasPerm("reports","admin",t);return`
        <div class="card full-width">
            ...
            <div class="table-container salary-processing-table-wrap">
                <table class="salary-processing-table">
                    ...
                    <tbody>
                        ${n.map(i=>{const{user:o,stats:r}=i,d=Number(o.baseSalary||0),l=Number(r.unpaidLeaves||0),c=Number(r.late||0),m=Number(r.extraWorkedHours||0),u=window.AppConfig?.LATE_GRACE_COUNT||3,p=window.AppConfig?.LATE_DEDUCTION_PER_BLOCK||.5,f=window.AppConfig?.EXTRA_HOURS_FOR_HALF_DAY_OFFSET||4,h=Math.floor(c/u)*p,y=Math.floor(m/f)*p,w=Math.min(h,y),b=Math.max(0,h-w),v=l+b,k=Math.round(d/22*v),g=Math.round(Math.max(0,d-k)),A=o.employeeId||"",S=o.designation||o.role||"",$=o.dept||o.department||"",L=o.joinDate||"",I=o.bankName||"",B=o.bankAccount||o.accountNumber||"",E=o.pan||o.PAN||"",D=o.uan||o.UAN||"",M=Number(o.otherAllowances||0),U=Number(o.providentFund||0),P=Number(o.professionalTax||0),C=Number(o.loanAdvance||0);return`
                                <tr data-user-id="${o.id}">
                                    ...
                                    <td><span class="extra-work-hours">${m.toFixed(2)}</span></td>
                                    ...
                                    <td style="display:none;"><input class="employee-id-input" type="text" value="${x(A)}"></td>
                                    <td style="display:none;"><input class="designation-input" type="text" value="${x(S)}"></td>
                                    <td style="display:none;"><input class="department-input" type="text" value="${x($)}"></td>
                                    <td style="display:none;"><input class="join-date-input" type="date" value="${x(L)}"></td>
                                    <td style="display:none;"><input class="bank-name-input" type="text" value="${x(I)}"></td>
                                    <td style="display:none;"><input class="bank-account-input" type="text" value="${x(B)}"></td>
                                    <td style="display:none;"><input class="pan-input" type="text" value="${x(E)}"></td>
                                    <td style="display:none;"><input class="uan-input" type="text" value="${x(D)}"></td>
                                    <td style="display:none;"><input class="other-allowances-input" type="number" value="${M}"></td>
                                    <td style="display:none;"><input class="pf-input" type="number" value="${U}"></td>
    ...
    `}async function en(){const n=new Date().toISOString().split("T")[0];return window.app_runPolicyTest=()=>{const e=document.getElementById("policy-test-checkin")?.value,t=document.getElementById("policy-test-checkout")?.value,a=document.getElementById("policy-test-output");if(!e||!t||!a)return;const s=document.getElementById("policy-test-date")?.value,i=new Date(`${s}T${e}`),r=(new Date(`${s}T${t}`)-i)/(1e3*60*60);let d="Absent";r>=8?d="Present":r>=4&&(d="Half Day"),a.innerHTML=`
    ...
    `}async function ma(){const n=await window.AppMinutes.getMinutes(),e=window.AppDB?.getAll?await window.AppDB.getAll("users"):[],t=window.AppAuth.getUser(),a=window.AppCalendar?await window.AppCalendar.getPlans():{leaves:[],events:[],work:[]},s=(u,p=t)=>!u||!p?!1:!!(window.app_hasPerm("minutes","view",p)||u.createdBy===p.id||(u.attendeeIds||[]).includes(p.id)||(u.allowedViewers||[]).includes(p.id)||(u.actionItems||[]).some(f=>f.assignedTo===p.id)),i=(u,p=t.id)=>{const f=(u.accessRequests||[]).find(h=>h.userId===p);return f?f.status:""},o=(u="")=>{const h=new DOMParser().parseFromString(`<div>${u||""}</div>`,"text/html").body.firstElementChild;if(!h)return"";const y=new Set(["P","BR","B","STRONG","I","EM","U","H2","H3","UL","OL","LI","A"]),w={A:new Set(["href","target","rel"])},b=v=>{!v||!v.childNodes||Array.from(v.childNodes).forEach(k=>{if(k.nodeType===Node.ELEMENT_NODE){const g=k;if(!y.has(g.tagName)){for(;g.firstChild;)v.insertBefore(g.firstChild,g);v.removeChild(g);return}if(Array.from(g.attributes).forEach(A=>{const S=w[g.tagName];(!S||!S.has(A.name.toLowerCase()))&&g.removeAttribute(A.name)}),g.tagName==="A"){const A=(g.getAttribute("href")||"").trim();/^(https?:|mailto:|#)/i.test(A)?(g.setAttribute("target","_blank"),g.setAttribute("rel","noopener noreferrer")):g.removeAttribute("href")}}b(k)})};return b(h),h.innerHTML.trim()},r=(u="")=>{const p=document.createElement("div");return p.innerHTML=u||"",(p.innerText||p.textContent||"").replace(/\r/g,"").trim()},d=(u="")=>x(u||"").replace(/\n/g,"<br>"),l=(u,p="")=>{const f=document.getElementById(u),h=f?f.innerHTML:"",y=o(h);let w=r(y);return!w&&p&&(w=(document.getElementById(p)?.value||"").trim()),{html:y,text:w}},c=(u="",p="")=>{const f=o(u||"");return f||x(p||"").replace(/\n/g,"<br>")};let m=new Set;return window.app_toggleNewMinuteForm=()=>{const u=document.getElementById("new-minute-form");if(u&&(u.style.display=u.style.display==="none"?"block":"none",u.style.display==="block")){m=new Set,window.app_refreshAttendeeChips(),document.querySelectorAll('.attendee-grid input[type="checkbox"]').forEach(h=>h.checked=!1);const p=document.getElementById("action-items-container");p&&(p.innerHTML="",window.app_addActionItemRow());const f=document.getElementById("new-minute-content-editor");f&&(f.innerHTML="")}},window.app_refreshMinutesView=async()=>{const u=document.getElementById("page-content");u&&(u.innerHTML=await ma())},window.app_minutesExec=(u,p,f=null)=>{const h=document.getElementById(u);h&&(h.focus(),document.execCommand(p,!1,f))},window.app_minutesFormatBlock=(u,p)=>{window.app_minutesExec(u,"formatBlock",p)},window.app_filterAttendees=u=>{const p=u.toLowerCase();document.querySelectorAll(".attendee-item-modern").forEach(f=>{const h=(f.dataset.name||"").toLowerCase();f.style.display=h.includes(p)?"flex":"none"})},window.app_filterMinutes=u=>{const p=u.toLowerCase();document.querySelectorAll(".minute-card-modern").forEach(f=>{const h=f.querySelector(".card-title-modern")?.textContent.toLowerCase()||"",y=f.querySelector(".card-date-badge")?.textContent.toLowerCase()||"";f.style.display=h.includes(p)||y.includes(p)?"flex":"none"})},window.app_toggleAttendeePick=u=>{u.checked?m.add(u.value):m.delete(u.value),window.app_refreshAttendeeChips()},window.app_refreshAttendeeChips=()=>{const u=document.getElementById("minutes-attendee-chips");u&&(u.innerHTML=Array.from(m).map(p=>{const f=e.find(h=>h.id===p);return`
                <div class="chip-modern">
                    <span>${x(f?.name||f?.username||"Unknown")}</span>
                    <i class="fa-solid fa-circle-xmark" onclick="window.app_removeAttendee('${p}')"></i>
                </div>
            `}).join(""))},window.app_removeAttendee=u=>{m.delete(u);const p=document.querySelector(`.attendee-item-modern input[value="${u}"]`);p&&(p.checked=!1),window.app_refreshAttendeeChips()},window.app_addActionItemRow=()=>{const u=document.getElementById("action-items-container");if(!u)return;const p=document.createElement("div");p.className="action-item-row-card",p.innerHTML=`
            ...
            <div class="field-group">
                <select class="input-premium action-assignee">
                    ...
                    ${e.map(f=>`<option value="${f.id}">${x(f.name||f.username)}</option>`).join("")}
                </select>
            </div>
            <div class="field-group">
        ...
        `,u.appendChild(p)},window.app_submitNewMinutes=async()=>{const u=document.getElementById("new-minute-title").value.trim(),p=document.getElementById("new-minute-date").value,f=l("new-minute-content-editor","new-minute-content"),h=f.text,y=Array.from(m),w=Array.from(document.querySelectorAll(".action-item-row-card")).map(b=>({task:b.querySelector(".action-task").value.trim(),assignedTo:b.querySelector(".action-assignee").value,dueDate:b.querySelector(".action-due").value,status:"pending"})).filter(b=>b.task);if(!u||!h)return alert("Title and content are required.");try{await window.AppMinutes.addMinute({title:u,date:p,content:h,contentHtml:f.html,attendeeIds:y,actionItems:w}),alert("Meeting minutes recorded!"),window.app_refreshMinutesView()}catch(b){alert("Error saving: "+b.message)}},window.app_requestMinuteAccess=async u=>{try{await window.AppMinutes.requestAccess(u),alert("Access requested!"),window.app_refreshMinutesView()}catch(p){alert("Error: "+p.message)}},window.app_handleMinuteApproval=async u=>{if(confirm("Are you sure you want to approve these minutes? This will lock the record if you are the last attendee to sign."))try{await window.AppMinutes.approveMinute(u),alert("Minutes approved!"),window.app_openMinuteDetails(u),window.app_refreshMinutesView()}catch(p){alert("Error: "+p.message)}},window.app_handleActionItemStatus=async(u,p,f)=>{try{await window.AppMinutes.updateActionItemStatus(u,p,f),alert(`Task marked as ${f}!`),window.app_openMinuteDetails(u)}catch(h){alert("Error: "+h.message)}},window.app_handleAccessDecision=async(u,p,f)=>{try{await window.AppMinutes.handleAccessRequest(u,p,f),alert(`Request ${f}!`),window.app_openMinuteDetails(u)}catch(h){alert("Error: "+h.message)}},window.app_saveMinuteEdits=async u=>{try{const f=(await window.AppMinutes.getMinutes()).find($=>$.id===u);if(!f)return alert("Minute not found.");const h=window.AppAuth.getUser(),y=f.createdBy===h.id,w=window.app_hasPerm("minutes","admin",h);if(!y&&!w)return alert("Only owner or admin can edit these minutes.");if(f.locked)return alert("This record is locked after final approvals.");const b=document.getElementById("minute-edit-title"),v=document.getElementById("minute-edit-date"),k=l("minute-edit-content-editor","minute-edit-content"),g=(b?.value||"").trim(),A=(v?.value||"").trim(),S=k.text;if(!g||!S)return alert("Title and content are required.");await window.AppMinutes.updateMinute(u,{title:g,date:A||f.date,content:S,contentHtml:k.html},"Edited meeting details"),alert("Minutes updated successfully."),window.app_openMinuteDetails(u),window.app_refreshMinutesView()}catch(p){alert("Error updating minutes: "+p.message)}},window.app_openMinuteDetails=async u=>{const f=(await window.AppMinutes.getMinutes()).find(D=>D.id===u);if(!f)return;if(!s(f))return alert("Access Restricted. Please request access from the list view.");const h=(f.attendeeIds||[]).includes(t.id),y=f.approvals&&f.approvals[t.id],w=f.createdBy===t.id,b=window.app_hasPerm("minutes","admin",t),v=(w||b)&&!f.locked,k=f.createdByName||e.find(D=>D.id===f.createdBy)?.name||"Unknown",g=f.lastEditedByName||k,A=f.lastEditedAt||f.createdAt,S=o(f.contentHtml||d(f.content||"")),$=(f.attendeeIds||[]).map(D=>{const M=e.find(P=>P.id===D),U=f.approvals&&f.approvals[D];return`
                <div class="approval-chip ${U?"approved":"pending"}">
                    <i class="fa-solid fa-${U?"check-circle":"clock"}"></i>
                    ${x(M?.name||"Unknown")}
                </div>
            `}).join(""),L=(f.actionItems||[]).map((D,M)=>{const U=e.find(C=>C.id===D.assignedTo),P=D.assignedTo===t.id;return`
                <div class="detail-action-item">
                    <div class="action-status-dot ${D.status||"pending"}"></div>
                    <div class="action-main">
                        <strong>${x(D.task)}</strong>
                        <span class="action-meta">Assigned: ${x(U?.name||"Unassigned")} | Due: ${D.dueDate||"N/A"}</span>
                    </div>
                    ${P&&D.status!=="completed"?`
                        <div class="action-btns">
                            ${D.status==="pending"?`<button class="mini-btn" onclick="window.app_handleActionItemStatus('${f.id}', ${M}, 'accepted')">Accept</button>`:""}
                            <button class="mini-btn success" onclick="window.app_handleActionItemStatus('${f.id}', ${M}, 'completed')">Complete</button>
                        </div>
                    `:""}
                </div>
            `}).join(""),I=(f.accessRequests||[]).filter(D=>D.status==="pending").map(D=>`
            <div class="access-request-row">
                <span>${x(D.userName)}</span>
                <div class="req-btns">
                    <button class="mini-btn success" onclick="window.app_handleAccessDecision('${f.id}', '${D.userId}', 'approved')">Approve</button>
                    <button class="mini-btn danger" onclick="window.app_handleAccessDecision('${f.id}', '${D.userId}', 'rejected')">Deny</button>
                </div>
            </div>
        `).join(""),B=(f.auditLog||[]).slice().reverse().map(D=>`
            <div class="access-request-row" style="justify-content:space-between; align-items:flex-start;">
                <div style="display:flex; flex-direction:column; gap:0.2rem;">
                    <strong style="font-size:0.82rem;">${x(D.userName||"Unknown")}</strong>
                    <span style="font-size:0.75rem; color:#64748b;">${x(D.action||"Updated")}</span>
                </div>
            ...
            <div class="modal-overlay" id="minute-detail-modal" style="display:flex;">
                <div class="modal-content minutes-detail-wide">
                    <div class="modal-header">
                        <div>
                            <span class="detail-date">${new Date(f.date).toLocaleDateString()}</span>
                            <h2 style="margin:0; color:#1e1b4b;">${x(f.title)}</h2>
                            <div style="font-size:0.78rem; color:#64748b; margin-top:0.35rem;">
                                Created by ${x(k)} on ${f.createdAt?new Date(f.createdAt).toLocaleString():"-"}
                            </div>
                            <div style="font-size:0.78rem; color:#64748b;">
                                Last edited by ${x(g)} on ${A?new Date(A).toLocaleString():"-"}
                            </div>
                        </div>
                        ...
                        <div class="detail-grid">
                            <div class="main-column">
                                <section>
                                    ...
                                    ${v?`
                                        <div style="display:grid; gap:0.6rem; margin-top:0.55rem;">
                                            <input id="minute-edit-title" class="input-premium" value="${et(f.title||"")}" />
                                            <input id="minute-edit-date" class="input-premium" type="date" value="${et(f.date||"")}" />
                                            <textarea id="minute-edit-content" class="textarea-premium" style="display:none;">${x(f.content||"")}</textarea>
                                    ...
                                    `:`<div class="content-text rich-minutes-content">${c(f.contentHtml,f.content)}</div>`}
                                </section>
                                ${L?`
                                <section>
                                ...
                                <section>
                                    ...
                                    <div class="access-requests-list" style="max-height:230px;">${B||'<p class="empty">No edit history yet.</p>'}</div>
                                </section>
                            </div>
                            <div class="side-column">
                                <section>
                                    <label><i class="fa-solid fa-users-check"></i> Approvals</label>
                                    <div class="approvals-stack">${$||'<p class="empty">No attendees defined</p>'}</div>
                                    ${h&&!y&&!f.locked?`<button class="action-btn wide" onclick="window.app_handleMinuteApproval('${f.id}')" style="margin-top:1rem;">Approve Minutes</button>`:""}
                                </section>
                                ${(w||b)&&I?`
                    ...
                    <div class="modal-footer">
                        ${f.locked?'<span class="status-locked-msg"><i class="fa-solid fa-lock"></i> Record Locked (All approved)</span>':""}
                        <div style="flex:1"></div>
                        <button class="action-btn secondary" onclick="document.getElementById('minute-detail-modal').remove()">Close</button>
                        ${v?`<button class="action-btn" onclick="window.app_saveMinuteEdits('${f.id}')">Save Changes</button>`:""}
                        ${w||b?`<button class="action-btn danger" onclick="window.app_deleteMinute('${f.id}')">Delete</button>`:""}
                    </div>
                </div>
            </div>
        ...
        <div class="minutes-container">
                ...
                <div class="field-group" style="margin-bottom: 2rem;">
                    ...
                    <div class="attendee-picker-container">
                        ...
                        <div class="attendee-grid">
                            ${e.map(u=>`
                                <label class="attendee-item-modern" data-name="${et(u.name||u.username)}">
                                    <input type="checkbox" value="${u.id}" onchange="window.app_toggleAttendeePick(this)">
                                    <span>${x(u.name||u.username)}</span>
                                </label>
                            `).join("")}
                        </div>
                    </div>
            ...
            <div class="minutes-list-container">
                ${n.length?n.sort((u,p)=>new Date(p.date)-new Date(u.date)).map(u=>{const p=s(u),f=i(u);return`
                        <div class="minute-card-modern ${p?"clickable":""}" ${p?`onclick="window.app_openMinuteDetails('${u.id}')"`:""}>
                            ...
                            <h4 class="card-title-modern">${x(u.title)}</h4>
                            ...
                            ${p?"":`
                                <div class="restricted-tag">
                                    ...
                                    Access Restricted
                                    ${f==="pending"?'<div style="margin-top:0.5rem; font-size:0.7rem; color:#f59e0b;">Request Pending Review</div>':f==="rejected"?'<div style="margin-top:0.5rem; font-size:0.7rem; color:#ef4444;">Access Denied</div>':`<button class="mini-btn" style="margin-top:0.75rem; width:100%; border-color:#991b1b; color:#991b1b;" onclick="window.app_requestMinuteAccess('${u.id}')">Request View Access</button>`}
                                </div>
                            `}
                        </div>
                    `}).join(""):`
    ...
    `}function tn(n=[]){let e="";n&&n.length>0&&(e=`
    ...
    <div class="modal-overlay" id="checkin-modal" style="display:flex;">
    ...
    </div>`}function an(){if(typeof window>"u")return;const n=new MutationObserver(t=>{t.forEach(()=>{const a=document.getElementById("checkout-modal"),s=document.getElementById("checkout-intro-panel");a&&s&&a.style.display!=="none"&&(localStorage.getItem("checkoutIntroSeen")||(s.style.display="block"))})}),e=()=>{const t=document.body;t&&n.observe(t,{attributes:!0,subtree:!0,attributeFilter:["style"]})};document.readyState==="loading"?document.addEventListener("DOMContentLoaded",e):e()}typeof window<"u"&&an();function nn(){return`
     ...
     `}function sn(){return window.AppAuth?.getUser()?`
        <!-- Check-Out Modal -->
    ...
    `:""}const dt=50,on=250;function fa(){const n=new Date,e=new Date;return e.setDate(n.getDate()-30),{startIso:e.toISOString().split("T")[0],endIso:n.toISOString().split("T")[0]}}function fe(){if(!window.app_teamActivitiesState){const n=fa();window.app_teamActivitiesState={startIso:n.startIso,endIso:n.endIso,staffIds:[],status:"all",type:"all",search:"",sortKey:"date-desc",page:1,pageSize:dt,columnVisibility:{type:!0,status:!0,sourceTime:!0},users:[],data:[],filtered:[],lastRefreshed:null}}return window.app_teamActivitiesState}function rn(n){return(n||[]).map(e=>{const t=e.type||(e.workDescription?"attendance":"work"),a=e._displayDesc||e.workDescription||e.task||"Activity",s=e.checkOut||e._sortTime||"00:00",i=e.status||(t==="attendance"?"completed":""),o=window.AppCalendar?window.AppCalendar.getSmartTaskStatus(e.date,i):i||"to-be-started";return{date:e.date||"",staffName:e.staffName||e.userName||"Unknown Staff",type:t,description:a,status:o,sourceTime:s,userId:e.userId||e.user_id||"",planId:e.planId||e.id||"",taskIndex:Number.isInteger(e.taskIndex)?e.taskIndex:null,planScope:e.planScope||"personal",progressPercent:Number.isFinite(Number(e.progressPercent))?Number(e.progressPercent):null,progressStatus:e.progressStatus||"",progressNote:e.progressNote||""}})}function dn(n){const e=String(n||"").toLowerCase();return["overdue","not-completed","to-be-started","in-process"].includes(e)}function ln(n){const e=new Date(n);return Number.isNaN(e.getTime())?new Date().toISOString().split("T")[0]:(e.setDate(e.getDate()+1),e.toISOString().split("T")[0])}function cn(n){if(!n||!/^\d{4}-\d{2}-\d{2}$/.test(n))return!1;const e=new Date(n);return!Number.isNaN(e.getTime())&&e.toISOString().startsWith(n)}function pn(n,e){return new Promise(t=>{if(!n){t(null);return}const a=document.getElementById("team-activities-postpone-popover");a&&a.remove();const s=document.createElement("div");s.id="team-activities-postpone-popover",s.className="team-activities-postpone-popover",s.innerHTML=`
        ...
        `,document.body.appendChild(s);const i=n.getBoundingClientRect(),o=i.bottom+window.scrollY+8,r=Math.min(i.left+window.scrollX,window.innerWidth-260);s.style.top=`${o}px`,s.style.left=`${r}px`;const d=s.querySelector(".team-activities-postpone-input");d&&d.focus();const l=m=>{document.removeEventListener("click",c,!0),s.remove(),t(m)},c=m=>{!s.contains(m.target)&&m.target!==n&&l(null)};document.addEventListener("click",c,!0),s.addEventListener("click",m=>{const u=m.target;if(u.closest("[data-postpone-cancel]")&&l(null),u.closest("[data-postpone-confirm]")){const p=d?d.value:"";l(p||null)}})})}function un(n){const e=n.search.trim().toLowerCase(),t=new Set(n.staffIds||[]),a=n.status,s=n.type;let i=n.data.filter(o=>!(t.size&&!t.has(o.userId)||s!=="all"&&o.type!==s||a!=="all"&&String(o.status||"").toLowerCase()!==a||e&&!`${o.date} ${o.staffName} ${o.description} ${o.status} ${o.type}`.toLowerCase().includes(e)));return i=mn(i,n.sortKey),n.filtered=i,i}function mn(n,e){const t=[...n];return t.sort((a,s)=>{const i=new Date(s.date)-new Date(a.date),o=String(s.sourceTime||"").localeCompare(String(a.sourceTime||"")),r=String(a.staffName||"").localeCompare(String(s.staffName||""));return e==="date-asc"?new Date(a.date)-new Date(s.date)||o:e==="staff-asc"?r||i:e==="staff-desc"?-r||i:e==="status"?String(a.status||"").localeCompare(String(s.status||""))||i:e==="type"?String(a.type||"").localeCompare(String(s.type||""))||i:e==="time"?String(a.sourceTime||"").localeCompare(String(s.sourceTime||""))||i:i||o}),t}function fn(n,e,t){const s=(Math.max(1,e)-1)*t;return n.slice(s,s+t)}function ya(n){const e=n.filtered.length,t=new Set(n.filtered.map(i=>i.userId).filter(Boolean)),a=n.filtered.filter(i=>String(i.status).toLowerCase()==="completed").length,s=e-a;return`
    ...
    `}function ha(n){const e=n.users||[],t=new Set(n.staffIds||[]),a=t.size?`${t.size} selected`:"All staff",s=e.map(i=>`
    ...
    `}function ga(n){const e=n.columnVisibility;return`
    ...
    `}function yn(n){const e=n.columnVisibility,t=fn(n.filtered,n.page,n.pageSize);if(!t.length)return'<div class="team-activities-empty">No activities found for the selected filters.</div>';const a=`
        ...
        <th>Actions</th>
    `,s=window.AppAuth?.getUser?window.AppAuth.getUser()?.id:null,i=t.map(o=>{const r=String(o.status||"").toLowerCase().replace(/\s+/g,"-"),d=s&&o.userId&&s===o.userId,l=o.type==="work"&&(o.progressPercent!==null||o.progressStatus||o.progressNote),c=o.progressStatus?String(o.progressStatus).replace(/_/g," "):"",m=o.progressPercent!==null?`${o.progressPercent}%`:"",u=String(o.progressNote||"").trim(),p=u?` title="${x(u)}"`:"",f=l?`<div class="team-activities-progress"${p}>${x(m)}${m&&c?" • ":""}${x(c)}</div>`:"";return`
        <tr>
            <td>${x(o.date)}</td>
            <td>${x(o.staffName)}</td>
            ${e.type?`<td class="team-activities-type">${x(o.type)}</td>`:""}
            ${e.status?`<td><span class="team-activities-status status-${x(r)}">${x(o.status)}</span></td>`:""}
            <td class="team-activities-desc">${x(o.description)}${f}</td>
            ${e.sourceTime?`<td>${x(o.sourceTime||"--")}</td>`:""}
            <td>
                <div class="team-activities-row-actions">
                    <button class="team-activities-row-btn" data-view-date="${x(o.date)}" data-view-user="${x(o.userId)}">
                        <i class="fa-solid fa-eye"></i> View
                    </button>
                    ${o.type==="work"&&d&&dn(o.status)&&o.planId&&Number.isInteger(o.taskIndex)?`
                        <button class="team-activities-row-btn warn" data-action="postpone" data-plan-id="${x(o.planId)}" data-task-index="${o.taskIndex}" data-plan-scope="${x(o.planScope)}" data-user-id="${x(o.userId)}" data-date="${x(o.date)}">
                            <i class="fa-solid fa-clock"></i> Postpone
                        </button>
                        <button class="team-activities-row-btn success" data-action="complete" data-plan-id="${x(o.planId)}" data-task-index="${o.taskIndex}" data-user-id="${x(o.userId)}">
    ...
    `}function hn(n){const e=n.filtered.length,t=Math.max(1,Math.ceil(e/n.pageSize)),a=Math.min(n.page,t);return`
    ...
    `}function le(){const n=fe();un(n);const e=Math.max(1,Math.ceil(n.filtered.length/n.pageSize));n.page>e&&(n.page=e);const t=document.getElementById("team-activities-summary"),a=document.getElementById("team-activities-table-wrap"),s=document.getElementById("team-activities-pagination-wrap"),i=document.getElementById("team-activities-last-updated"),o=document.getElementById("team-activities-columns-wrap"),r=document.getElementById("team-activities-staff-wrap");t&&(t.innerHTML=ya(n)),a&&(a.innerHTML=yn(n)),s&&(s.innerHTML=hn(n)),o&&(o.innerHTML=ga(n)),r&&(r.innerHTML=ha(n)),i&&n.lastRefreshed&&(i.textContent=new Date(n.lastRefreshed).toLocaleString())}async function xe(){const n=fe(),e=document.getElementById("team-activities-loading");e&&(e.style.display="block");try{const t=await window.AppAnalytics.getAllStaffActivities({mode:"range",startIso:n.startIso,endIso:n.endIso,scope:"all"});n.data=rn(t),n.lastRefreshed=Date.now(),n.page=1}catch(t){console.error("Team Activities fetch failed",t)}finally{e&&(e.style.display="none")}le()}function tt(){const n=fe(),e=document.getElementById("team-activities-start"),t=document.getElementById("team-activities-end"),a=document.getElementById("team-activities-type"),s=document.getElementById("team-activities-status"),i=document.getElementById("team-activities-search"),o=document.getElementById("team-activities-page-size");e&&(n.startIso=e.value||n.startIso),t&&(n.endIso=t.value||n.endIso),a&&(n.type=a.value||"all"),s&&(n.status=s.value||"all"),i&&(n.search=i.value||""),o&&(n.pageSize=Number(o.value)||dt),n.page=1,le()}function gn(){const n=fe();if(n.bound)return;n.bound=!0;let e=null;document.addEventListener("click",async t=>{const a=t.target,s=a.closest("[data-team-activities-staff-toggle]"),i=document.getElementById("team-activities-staff-panel"),o=a.closest("[data-team-activities-columns-toggle]"),r=document.getElementById("team-activities-columns-popover");s&&i?i.classList.toggle("open"):i&&!i.contains(a)&&i.classList.remove("open"),o&&r?r.classList.toggle("open"):r&&!r.contains(a)&&r.classList.remove("open");const d=a.closest(".team-activities-page-btn");if(d){const f=d.dataset.page,h=Math.max(1,Math.ceil(n.filtered.length/n.pageSize));f==="prev"&&(n.page=Math.max(1,n.page-1)),f==="next"&&(n.page=Math.min(h,n.page+1)),le()}const l=a.closest("[data-view-date]");if(l){const f=l.getAttribute("data-view-date"),h=l.getAttribute("data-view-user");window.app_openDayPlan&&window.app_openDayPlan(f,h||"")}const c=a.closest("[data-action]");if(c){const f=c.getAttribute("data-action");f==="complete"&&window.app_teamActivitiesCompleteTask&&await window.app_teamActivitiesCompleteTask(c),f==="postpone"&&window.app_teamActivitiesPostponeTask&&await window.app_teamActivitiesPostponeTask(c)}const m=a.closest("th[data-sort]");if(m){const f=m.dataset.sort;f&&(n.sortKey=f,le())}a.closest("[data-staff-select-all]")&&(n.staffIds=(n.users||[]).map(f=>f.id),le()),a.closest("[data-staff-clear]")&&(n.staffIds=[],le())}),document.addEventListener("change",t=>{const a=t.target;if(a.matches("#team-activities-start, #team-activities-end")?(tt(),xe()):a.matches("#team-activities-type, #team-activities-status, #team-activities-page-size")&&tt(),a.matches('#team-activities-columns-popover input[type="checkbox"]')){const s=a.getAttribute("data-column");s&&(n.columnVisibility[s]=a.checked),le()}if(a.matches('#team-activities-staff-panel input[type="checkbox"]')){const s=a.getAttribute("data-staff-id");if(!s)return;a.checked?n.staffIds.includes(s)||n.staffIds.push(s):n.staffIds=n.staffIds.filter(i=>i!==s),le()}}),document.addEventListener("input",t=>{t.target.matches("#team-activities-search")&&(e&&clearTimeout(e),e=setTimeout(()=>tt(),on))})}function wn(n){const e=["Date","Staff","Type","Status","Description","Time"],t=n.map(a=>[a.date,a.staffName,a.type,a.status,a.description,a.sourceTime].map(s=>`"${String(s||"").replace(/\"/g,'""')}"`).join(","));return[e.join(","),...t].join(`
`)}typeof window<"u"&&(window.app_initTeamActivities=async function(){const n=fe(),e=await window.AppAnalytics.getUsersCached();n.users=e||[],gn(),le(),await xe()},window.app_teamActivitiesRefresh=async function(){tt(),await xe()},window.app_teamActivitiesResetFilters=function(){const n=fe(),e=fa();n.startIso=e.startIso,n.endIso=e.endIso,n.staffIds=[],n.status="all",n.type="all",n.search="",n.sortKey="date-desc",n.page=1,n.pageSize=dt;const t=document.getElementById("team-activities-start"),a=document.getElementById("team-activities-end"),s=document.getElementById("team-activities-type"),i=document.getElementById("team-activities-status"),o=document.getElementById("team-activities-search"),r=document.getElementById("team-activities-page-size");t&&(t.value=n.startIso),a&&(a.value=n.endIso),s&&(s.value="all"),i&&(i.value="all"),o&&(o.value=""),r&&(r.value=String(dt)),le(),xe()},window.app_teamActivitiesCopyCSV=async function(){const n=fe(),e=wn(n.filtered);try{await navigator.clipboard.writeText(e),alert("Table copied to clipboard.")}catch(t){console.warn("Clipboard copy failed",t),alert("Copy failed. Please use Export Excel instead.")}},window.app_teamActivitiesExportXLSX=function(){const n=fe();window.AppReports?.exportTeamActivitiesXLSX?window.AppReports.exportTeamActivitiesXLSX(n.filtered,{start:n.startIso,end:n.endIso}):alert("Export module not available.")},window.app_teamActivitiesCompleteTask=async function(n){try{const e=window.AppAuth?.getUser?window.AppAuth.getUser()?.id:null,t=n.getAttribute("data-plan-id"),a=Number(n.getAttribute("data-task-index")),s=n.getAttribute("data-user-id")||"";if(!e||e!==s){alert("Only the assigned staff member can complete this task.");return}if(!t||!Number.isInteger(a)||!window.AppCalendar?.updateTaskStatus)return;n.disabled=!0,await window.AppCalendar.updateTaskStatus(t,a,"completed"),await xe(),window.app_showSyncToast&&window.app_showSyncToast("Task marked as completed.")}catch(e){console.error("Complete task failed",e),alert("Failed to complete task.")}},window.app_teamActivitiesPostponeTask=async function(n){try{const e=window.AppAuth?.getUser?window.AppAuth.getUser()?.id:null,t=n.getAttribute("data-plan-id"),a=Number(n.getAttribute("data-task-index")),s=n.getAttribute("data-plan-scope")||"personal",i=n.getAttribute("data-user-id")||"",o=n.getAttribute("data-date")||"";if(!e||e!==i){alert("Only the assigned staff member can postpone this task.");return}if(!t||!Number.isInteger(a)||!window.AppDB||!window.AppCalendar)return;n.disabled=!0;const r=await window.AppDB.get("work_plans",t);if(!r||!Array.isArray(r.plans)||!r.plans[a])throw new Error("Plan or task not found");const d=ln(o),l=await pn(n,d);if(!l){n.disabled=!1;return}const c=String(l).trim();if(!cn(c)){alert("Invalid date. Please use YYYY-MM-DD."),n.disabled=!1;return}const[m]=r.plans.splice(a,1);r.updatedAt=new Date().toISOString(),await window.AppDB.put("work_plans",r);const u=c,p=s||r.planScope||"personal",f=p==="annual"?"annual_shared":r.userId||i,h=window.AppCalendar.getWorkPlanId(u,f,p),y={...m,status:"",startDate:u,endDate:u};delete y.completedDate;const w=await window.AppDB.get("work_plans",h);if(w)w.plans=Array.isArray(w.plans)?w.plans:[],w.plans.push(y),w.updatedAt=new Date().toISOString(),await window.AppDB.put("work_plans",w);else{const b=p==="annual"?null:f;await window.AppCalendar.setWorkPlan(u,[y],b,{planScope:p})}await xe(),window.app_showSyncToast&&window.app_showSyncToast(`Task postponed to ${u}.`)}catch(e){console.error("Postpone task failed",e),alert("Failed to postpone task.")}});async function vn(){const n=fe();return`
            ...
            <div class="team-activities-header">
                ...
                <div class="team-activities-actions">
                    ...
                    <div class="team-activities-columns">
                        ...
                        <div id="team-activities-columns-wrap">${ga(n)}</div>
                    </div>
                </div>
            </div>
            <div class="team-activities-summary" id="team-activities-summary">${ya(n)}</div>
...
`),c=`Attendance_Sheet_${new Date(t,e).toLocaleString("default",{month:"long"})}_${t}.csv`;return this.downloadFile(d,c,"text/csv"),!0}catch(i){console.error("Export Failed:",i),alert("Export Failed: "+i.message)}}async exportLeavesCSV(e){try{const t=["Applied On","Staff Name","FY","Type","From","To","Days/Hrs","Reason","Status","Admin Comment"],a=["appliedOn","userName","financialYear","type","startDate","endDate","daysCount","reason","status","adminComment"],s=e.map(r=>({...r,daysCount:r.type==="Short Leave"?`${r.durationHours||0}h`:r.daysCount})),i=this.convertToCSV(s,t,a),o=`Leave_Requests_${new Date().toISOString().split("T")[0]}.csv`;return this.downloadFile(i,o,"text/csv"),!0}catch(t){console.error("Leave Export Failed:",t),alert("Export Failed: "+t.message)}}async exportCalendarPlansCSV(e,t,a){try{const s=[],i=new Date(a,t+1,0).getDate(),o=new Date(a,t).toLocaleString("default",{month:"long"});for(let m=1;m<=i;m++){const u=`${a}-${String(t+1).padStart(2,"0")}-${String(m).padStart(2,"0")}`;e.leaves.forEach(p=>{u>=p.startDate&&u<=p.endDate&&s.push({date:u,category:"Leave",subject:`${p.userName||"Staff"} - ${p.type}`,details:p.reason||"No reason provided",staff:p.userName||"Staff"})}),e.events.forEach(p=>{p.date===u&&s.push({date:u,category:"Event",subject:p.title,details:p.type||"General Event",staff:"Organization"})}),e.workPlans.forEach(p=>{if(p.date===u){const f=Array.isArray(p.plans)?p.plans:[],h=f.length>0?f.map((y,w)=>{let b=`${w+1}. ${y.task}`;return y.subPlans&&y.subPlans.length>0&&(b+=` (Steps: ${y.subPlans.join(", ")})`),y.tags&&y.tags.length>0&&(b+=` [With: ${y.tags.map(v=>`@${v.name} (${v.status||"pending"})`).join(", ")}]`),b}).join(" | "):"Work Plan";s.push({date:u,category:"Work Plan",subject:"Daily Goals",details:h,staff:p.userName||"Staff"})}})}if(s.length===0)return alert("No plans found for the selected month."),!1;const r=["Date","Category","Subject","Details","Staff Member"],d=["date","category","subject","details","staff"],l=this.convertToCSV(s,r,d),c=`Team_Schedule_${o}_${a}.csv`;return this.downloadFile(l,c,"text/csv"),!0}catch(s){console.error("Calendar Export Failed:",s),alert("Failed to export calendar: "+s.message)}}async exportAnnualListViewCSV(e){try{const t=(e||[]).map(r=>({date:r.date||"",staffName:r.staffName||r.staff||"",assignedBy:r.assignedBy||"",assignedTo:r.assignedTo||"",selfAssigned:r.selfAssigned?"Yes":"No",dueDate:r.dueDate||"",status:r.statusLabel||r.status||"",comments:r.comments||"",tags:Array.isArray(r.tags)?r.tags.join(", "):r.tags||""})),a=["Date","Staff Name","Assigned By","Assigned To","Self Assigned","Due Date","Completion Status","Comments","Tags"],s=["date","staffName","assignedBy","assignedTo","selfAssigned","dueDate","status","comments","tags"],i=this.convertToCSV(t,a,s),o=`Annual_Plan_List_${new Date().toISOString().split("T")[0]}.csv`;return this.downloadFile(i,o,"text/csv"),!0}catch(t){throw console.error("List Export Failed:",t),new Error("Failed to export list: "+t.message)}}exportTeamActivitiesXLSX(e,t={}){try{if(typeof window>"u"||!window.XLSX)return alert("Excel export library not loaded."),!1;const a=(e||[]).map(m=>[m.date||"",m.staffName||"",m.type||"",m.status||"",m.description||"",m.sourceTime||""]),s=["Date","Staff","Type","Status","Description","Time"],i=window.XLSX.utils.aoa_to_sheet([s,...a]),o=window.XLSX.utils.book_new();window.XLSX.utils.book_append_sheet(o,i,"Team Activities");const r=(t.start||"").replace(/[^a-zA-Z0-9_-]/g,"_"),d=(t.end||"").replace(/[^a-zA-Z0-9_-]/g,"_"),c=`Team_Activities_${r&&d?`${r}_to_${d}`:r||d||"export"}.xlsx`;return window.XLSX.writeFile(o,c),!0}catch(a){return console.error("Team Activities Export Failed:",a),alert("Export Failed: "+a.message),!1}}}const In=new Tn;typeof window<"u"&&(window.AppReports=In);class Ln{constructor(){this.db=q,this.cache={},this.defaultPolicy={"Annual Leave":{total:10,minDays:3,accrual:"annual"},"Casual Leave":{total:6,maxDays:2,accrual:"monthly"},"Medical Leave":{total:6,certificateThreshold:2,accrual:"annual"},"Maternity Leave":{total:180,paid:!0,gender:"female"},"Paternity Leave":{total:10,paid:!0,gender:"male",minServiceYears:0},"Study Leave":{total:5,paid:!1,requireApproval:!0},"Compassionate Leave":{total:3,paid:!0}}}async getPolicy(){if(this.cache.policy)return this.cache.policy;try{if(window.AppFirestore){const e=await window.AppFirestore.collection("settings").doc("policies").get();e.exists?this.cache.policy={...this.defaultPolicy,...e.data()}:this.cache.policy=this.defaultPolicy}else this.cache.policy=this.defaultPolicy}catch(e){console.warn("Failed to fetch dynamic policy, using default.",e),this.cache.policy=this.defaultPolicy}return this.cache.policy}async updatePolicy(e){try{if(window.AppFirestore)return await window.AppFirestore.collection("settings").doc("policies").set(e,{merge:!0}),this.cache.policy=null,!0;throw new Error("Database not connected")}catch(t){throw console.error("Failed to update policy:",t),t}}async getFinancialYear(e=new Date){const t=e.getMonth(),a=e.getFullYear();return t<3?{label:`${a-1}-${a}`,start:new Date(a-1,3,1),end:new Date(a,2,31)}:{label:`${a}-${a+1}`,start:new Date(a,3,1),end:new Date(a+1,2,31)}}async getUserLeaves(e,t=null){t||(t=(await this.getFinancialYear()).label);try{if(this.db.queryMany&&_?.READ_OPT_FLAGS?.FF_READ_OPT_DB_QUERIES)return(await this.db.queryMany("leaves",[{field:"userId",operator:"==",value:e},{field:"financialYear",operator:"==",value:t}])).sort((i,o)=>new Date(o.startDate)-new Date(i.startDate))}catch(s){console.warn("Scoped getUserLeaves query failed, using fallback",s)}return(await this.db.getAll("leaves")).filter(s=>s.userId===e&&s.financialYear===t).sort((s,i)=>new Date(i.startDate)-new Date(s.startDate))}async getLeaveUsage(e,t,a){return(await this.getUserLeaves(e,a.label)).filter(o=>o.type===t&&(o.status==="Approved"||o.status==="Pending")).reduce((o,r)=>o+(parseFloat(r.daysCount)||0),0)}async getMonthlyShortLeaveUsage(e,t){const a=`${t.getFullYear()}-${String(t.getMonth()+1).padStart(2,"0")}`;let s=[];try{this.db.queryMany&&_?.READ_OPT_FLAGS?.FF_READ_OPT_DB_QUERIES&&(s=(await this.db.queryMany("leaves",[{field:"userId",operator:"==",value:e},{field:"type",operator:"==",value:"Short Leave"},{field:"startDate",operator:">=",value:`${a}-01`},{field:"startDate",operator:"<=",value:`${a}-31`}])).filter(o=>o.status==="Approved"||o.status==="Pending"))}catch(i){console.warn("Scoped short leave query failed, using fallback",i)}return s.length||(s=(await this.db.getAll("leaves")).filter(o=>o.userId===e&&o.type==="Short Leave"&&o.startDate.startsWith(a)&&(o.status==="Approved"||o.status==="Pending"))),s.reduce((i,o)=>i+(parseFloat(o.daysCount||o.durationHours)||0),0)}async getPendingLeaves(){try{let e=[];if(this.db.queryMany&&_?.READ_OPT_FLAGS?.FF_READ_OPT_DB_QUERIES?e=(await this.db.queryMany("leaves",[{field:"status",operator:"==",value:"Pending"}],{orderBy:[{field:"appliedOn",direction:"desc"}]})).sort((a,s)=>new Date(s.appliedOn)-new Date(a.appliedOn)):e=(await this.db.getAll("leaves")).filter(a=>a.status==="Pending").sort((a,s)=>new Date(s.appliedOn)-new Date(a.appliedOn)),e.length>0){const t=await this.db.getAll("users"),a={};t.forEach(s=>{a[s.id]=s.name}),e.forEach(s=>{!s.userName&&a[s.userId]&&(s.userName=a[s.userId])})}return e}catch(e){return console.warn("getPendingLeaves failed, using fallback",e),(await this.db.getAll("leaves").catch(()=>[])).filter(a=>a.status==="Pending").sort((a,s)=>new Date(s.appliedOn)-new Date(a.appliedOn))}}async requestLeave(e){const{userId:t,startDate:a,endDate:s,type:i,durationHours:o}=e,r=new Date(a),d=new Date(s);let l=Math.ceil((d-r)/(1e3*60*60*24))+1;if(l<=0&&i!=="Short Leave")throw new Error("Invalid date range");const c=await this.getFinancialYear(r),m=await this.getLeaveUsage(t,i,c),p=(await this.getPolicy())[i],f=[];if(i==="Half Day")l=.5,e.daysCount=.5;else if(i==="Short Leave"){const y=await this.getMonthlyShortLeaveUsage(t,r);let w=parseFloat(o||0);w>2&&f.push("Short Leave exceeds 2 hours (standard)."),y+w>4&&f.push(`Monthly Short Leave limit exceeded (${y+w}/4 hours).`),e.daysCount=w}else if(i==="Annual Leave")l<(p.minDays||1)&&f.push(`Annual Leave requested is less than required minimum (${p.minDays||1} days).`),m+l>p.total&&f.push(`Annual Leave balance exceeded (${m+l}/${p.total}).`);else if(i==="Casual Leave")l>p.maxDays&&f.push(`Casual Leave exceeds maximum allowed per request (${p.maxDays} days).`),m+l>p.total&&f.push(`Casual Leave balance exceeded (${m+l}/${p.total}).`);else if(i==="Medical Leave")m+l>p.total&&f.push(`Medical Leave balance exceeded (${m+l}/${p.total}).`),l>p.certificateThreshold&&(e.requireCertificate=!0);else if(i==="Paternity Leave"){const y=await this.db.get("users",t),w=new Date(y.joinDate),b=(r-w)/(1e3*60*60*24*365.25);p.minServiceYears&&b<p.minServiceYears&&f.push(`User has not completed ${p.minServiceYears} year(s) of service (required for Paternity Leave).`),l>p.total&&f.push(`Paternity Leave exceeds limit of ${p.total} days.`)}else["Study Leave","Compassionate Leave"].includes(i)&&p&&l>p.total&&f.push(`${i} exceeds limit of ${p.total} days.`);const h={id:"l"+Date.now(),...e,status:"Pending",appliedOn:new Date().toISOString(),financialYear:c.label,daysCount:l,policyWarnings:f};return await this.db.add("leaves",h),h}async updateLeaveStatus(e,t,a,s=""){const i=await this.db.get("leaves",e);if(!i)throw new Error("Leave not found");if(i.status=t,i.actionBy=a,i.actionDate=new Date().toISOString(),i.adminComment=s,await this.db.put("leaves",i),t==="Approved"){const o=new Date(i.startDate),r=new Date(i.endDate);let d=new Date(o);for(;d<=r;){const l=d.toISOString().split("T")[0],c={id:"att_"+i.userId+"_"+l,user_id:i.userId,date:l,checkIn:"09:00",checkOut:"17:00",duration:"8h 0m",location:"On Leave",type:i.type,status:"in",synced:!1};await this.db.put("attendance",c),d.setDate(d.getDate()+1)}}return i}}const we=new Ln;typeof window<"u"&&(window.AppLeaves=we);class Mn{constructor(){this.db=q,this.cleanupFlag=_?.SIMULATION_POLICY?.LEGACY_DUMMY_CLEANUP?.FLAG_KEY||"legacy_dummy_cleanup_v1",this.simulationFlag="simulation_run_v2"}getCleanupPolicy(){const e=_?.SIMULATION_POLICY?.LEGACY_DUMMY_CLEANUP||{},t=new Set((e.TARGET_USER_IDS||[]).map(s=>String(s||"").trim()).filter(Boolean)),a=new Set((e.TARGET_USERNAMES||[]).map(s=>String(s||"").trim().toLowerCase()).filter(Boolean));return{enabled:e.ENABLED!==!1,targetIds:t,targetUsernames:a,auditCollection:String(e.AUDIT_COLLECTION||"system_audit_logs")}}async writeCleanupAudit(e,t={}){const a=this.getCleanupPolicy();try{await this.db.add(a.auditCollection,{type:e,module:"simulation",payload:t,createdAt:Date.now()})}catch(s){console.warn("Simulation audit log write failed:",s)}}async run(){const e=_&&_.READ_OPT_FLAGS||{},t=typeof window<"u"&&window.location&&window.location.hostname?window.location.hostname:"",a=t==="localhost"||t==="127.0.0.1";if(!(!e.ENABLE_SIMULATION_MODULE&&!a)){if(localStorage.getItem(this.cleanupFlag)||(await this.cleanupLegacyDummyData(),localStorage.setItem(this.cleanupFlag,"true")),localStorage.getItem(this.simulationFlag)){console.log("Simulation already ran. Use window.AppSimulation.forceRun() to force.");return}await this.forceRun(),localStorage.setItem(this.simulationFlag,"true")}}async cleanupLegacyDummyData(){const e=this.getCleanupPolicy();if(e.enabled){if(e.targetIds.size===0&&e.targetUsernames.size===0){await this.writeCleanupAudit("legacy_dummy_cleanup_skipped",{reason:"no_targets"});return}try{const a=(await this.db.getAll("users")).filter(u=>e.targetIds.has(u.id)||e.targetUsernames.has((u.username||"").trim().toLowerCase())),s=new Set(a.map(u=>u.id));if(s.size===0){await this.writeCleanupAudit("legacy_dummy_cleanup_skipped",{reason:"no_matches",configuredTargets:{ids:Array.from(e.targetIds),usernames:Array.from(e.targetUsernames)}});return}let i=0,o=0,r=0,d=0;const l=await this.db.getAll("attendance");for(const u of l){const p=u.user_id||u.userId;s.has(p)&&(await this.db.delete("attendance",u.id),i+=1)}const c=await this.db.getAll("leaves");for(const u of c){const p=u.userId||u.user_id;s.has(p)&&(await this.db.delete("leaves",u.id),o+=1)}const m=await this.db.getAll("work_plans");for(const u of m){const p=u.userId||u.user_id;s.has(p)&&(await this.db.delete("work_plans",u.id),r+=1)}for(const u of a)await this.db.delete("users",u.id),d+=1;await this.writeCleanupAudit("legacy_dummy_cleanup_completed",{matchedUserIds:Array.from(s),deleted:{attendance:i,leaves:o,workPlans:r,users:d}}),console.log("Legacy dummy users and linked records removed.",{users:d,attendance:i,leaves:o,workPlans:r})}catch(t){await this.writeCleanupAudit("legacy_dummy_cleanup_failed",{message:t?.message||String(t)}),console.warn("Legacy dummy cleanup failed:",t)}}}async forceRun(){console.log("Starting Office Scenario Simulation (V2)...");const e=new Date;if(window.AppCalendar){const t=new Date(e);t.setDate(t.getDate()+1),await window.AppCalendar.addEvent({title:"Office Picnic/Holiday",date:t.toISOString().split("T")[0],type:"holiday"})}console.log("Simulation Complete.")}}const Rt=new Mn;typeof window<"u"&&(window.AppSimulation=Rt,setTimeout(()=>Rt.run(),2e3));const ae="minutes";function De(){const n=window.AppAuth.getUser();if(!n||!n.id)throw new Error("User not authenticated");return n}function Ye(n){return!!(window.app_hasPerm&&window.app_hasPerm("minutes","admin",n))}function En(n,e,t,a={}){const s=n&&n.createdBy===e.id,i=Ye(e),o=a&&a.allowNonOwner===!0;if(!s&&!i&&!o)throw new Error("You do not have permission to edit these minutes.");if(n&&n.locked&&!(a&&a.allowOnLocked===!0))throw new Error("This record is locked.");return!t||!String(t).trim()?"Updated minutes":String(t).trim()}async function Cn(n={}){try{const e=n.limit||150;return window.AppDB?await window.AppDB.getAll(ae):(await window.AppFirestore.collection(ae).orderBy("date","desc").limit(e).get()).docs.map(a=>({id:a.id,...a.data()}))}catch(e){throw console.error("Error fetching minutes:",e),e}}async function Pn(n){try{const e=De(),t=new Date().toISOString(),a=e.name||e.username||"Unknown",s={...n,createdBy:e.id,createdByName:a,createdAt:t,lastEditedBy:e.id,lastEditedByName:a,lastEditedAt:t,auditLog:[{userId:e.id,userName:a,timestamp:t,action:"Created meeting minutes"}],approvals:{},locked:!1,restrictedFrom:[],allowedViewers:[],accessRequests:[]};return window.AppDB?await window.AppDB.add(ae,s):(await window.AppFirestore.collection(ae).add(s)).id}catch(e){throw console.error("Error adding minute:",e),e}}async function Ve(n,e,t,a={}){try{const s=De(),i=await(window.AppDB?window.AppDB.get(ae,n):window.AppFirestore.collection(ae).doc(n).get().then(m=>m.data()));if(!i)throw new Error("Minute not found");const o=En(i,s,t,a),r=new Date().toISOString(),d=s.name||s.username||"Unknown",l={userId:s.id,userName:d,timestamp:r,action:o},c={...i,...e,id:n,lastEditedBy:s.id,lastEditedByName:d,lastEditedAt:r,auditLog:[...i.auditLog||[],l]};return window.AppDB?await window.AppDB.put(ae,c):await window.AppFirestore.collection(ae).doc(n).update(c),!0}catch(s){throw console.error("Error updating minute:",s),s}}async function Nn(n){try{const e=De(),t=await(window.AppDB?window.AppDB.get(ae,n):window.AppFirestore.collection(ae).doc(n).get().then(s=>s.data()));if(!t)throw new Error("Minute not found");const a=t.accessRequests||[];return a.some(s=>s.userId===e.id)?!0:(a.push({userId:e.id,userName:e.name||e.username||"Unknown",status:"pending",requestedAt:new Date().toISOString()}),await Ve(n,{accessRequests:a},`Requested access for ${e.name||e.username}`,{allowNonOwner:!0,allowOnLocked:!0}))}catch(e){throw console.error("Error requesting access:",e),e}}async function Bn(n,e,t){try{const a=De(),s=await(window.AppDB?window.AppDB.get(ae,n):window.AppFirestore.collection(ae).doc(n).get().then(c=>c.data()));if(!s)throw new Error("Minute not found");const i=s.createdBy===a.id,o=Ye(a);if(!i&&!o)throw new Error("Only owner or admin can review access requests.");const r=s.accessRequests||[],d=r.find(c=>c.userId===e);if(!d)return!0;d.status=t;const l=s.allowedViewers||[];return t==="approved"&&!l.includes(e)&&l.push(e),await Ve(n,{accessRequests:r,allowedViewers:l},`${String(t||"").toUpperCase()} access request for userId: ${e}`,{allowOnLocked:!0})}catch(a){throw console.error("Error handling access request:",a),a}}async function On(n,e,t){try{const a=De(),s=await(window.AppDB?window.AppDB.get(ae,n):window.AppFirestore.collection(ae).doc(n).get().then(l=>l.data()));if(!s||!s.actionItems)throw new Error("Minute or tasks not found");const i=s.actionItems[e];if(!i)throw new Error("Task not found");const o=s.createdBy===a.id,r=Ye(a),d=i.assignedTo===a.id;if(!o&&!r&&!d)throw new Error("Only owner, admin, or assignee can update this task.");return i.status=t,t==="completed"&&(i.completedAt=new Date().toISOString()),await Ve(n,{actionItems:s.actionItems},`Updated Task: ${i.task} to ${t}`,{allowNonOwner:!0,allowOnLocked:!0})}catch(a){throw console.error("Error updating action item:",a),a}}async function Un(n){try{const e=De(),t=await(window.AppDB?window.AppDB.get(ae,n):window.AppFirestore.collection(ae).doc(n).get().then(c=>c.data()));if(!t)throw new Error("Minute not found");const a=t.attendeeIds||[],s=a.includes(e.id),i=t.createdBy===e.id,o=Ye(e);if(!s&&!i&&!o)throw new Error("Only attendees, owner, or admin can approve minutes.");const r=t.approvals||{};r[e.id]=new Date().toISOString();const d=a.length>0&&a.every(c=>r[c]),l={approvals:r};return d&&(l.locked=!0),await Ve(n,l,`${d?"FINAL APPROVAL & LOCK":"Signed"} by ${e.name||e.username}`,{allowNonOwner:!0,allowOnLocked:!0})}catch(e){throw console.error("Error approving minute:",e),e}}async function Rn(n){try{const e=De(),t=await(window.AppDB?window.AppDB.get(ae,n):window.AppFirestore.collection(ae).doc(n).get().then(i=>i.data()));if(!t)throw new Error("Minute not found");const a=t.createdBy===e.id,s=Ye(e);if(!a&&!s)throw new Error("Only owner or admin can delete minutes.");return window.AppDB?await window.AppDB.delete(ae,n):(await window.AppFirestore.collection(ae).doc(n).delete(),!0)}catch(e){throw console.error("Error deleting minute:",e),e}}const Hn={getMinutes:Cn,addMinute:Pn,updateMinute:Ve,approveMinute:Un,deleteMinute:Rn,requestAccess:Nn,handleAccessRequest:Bn,updateActionItemStatus:On};typeof window<"u"&&(window.AppMinutes=Hn);const Lt={async renderPolicyEditor(){const n=await we.getPolicy();return`
        ...
        `},setupGlobalHandlers(){window.app_savePolicyChanges=async n=>{n.preventDefault();const e=new FormData(n.target),t=await we.getPolicy(),a={};Object.keys(t).forEach(s=>{a[s]={...t[s]};const i=l=>{const c=e.get(l);return c!==""&&c!==null?parseInt(c):void 0},o=i(`${s}_total`);o!==void 0&&(a[s].total=o);const r=i(`${s}_min`);r!==void 0?a[s].minDays=r:delete a[s].minDays;const d=i(`${s}_max`);d!==void 0?a[s].maxDays=d:delete a[s].maxDays});try{await we.updatePolicy(a);const s=n.target.querySelector("button"),i=s.innerHTML;s.innerHTML='<i class="fa-solid fa-check"></i> Saved!',s.style.background="#166534",setTimeout(()=>{s.innerHTML=i,s.style.background="",window.location.reload()},1e3)}catch(s){alert("Failed to update policy: "+s.message)}},window.app_approveLeaveWithWarning=async n=>{const e=await window.appPrompt("Reason for override:","",{title:"Leave Override",confirmText:"Approve With Reason",placeholder:"Enter reason"});if(e)try{await we.updateLeaveStatus(n,"Approved",Q.getUser().id,`[Overridden] ${e}`),window.location.reload()}catch(t){alert(t.message)}}}};Lt.setupGlobalHandlers();typeof window<"u"&&(window.AppAdminPolicies=Lt);const Fn={currentYear:new Date().getFullYear(),holidayCache:null,baseline2025:[{name:"Republic Day",date:"2025-01-26",type:"National"},{name:"Maha Shivaratri",date:"2025-02-26",type:"Regional"},{name:"Holi",date:"2025-03-14",type:"Regional"},{name:"Id-ul-Fitr",date:"2025-03-31",type:"Regional"},{name:"Good Friday",date:"2025-04-18",type:"Regional"},{name:"Independence Day",date:"2025-08-15",type:"National"},{name:"Dussehra",date:"2025-10-02",type:"Regional"},{name:"Gandhi Jayanti",date:"2025-10-02",type:"National"},{name:"Diwali",date:"2025-10-20",type:"Regional"},{name:"Christmas",date:"2025-12-25",type:"Regional"}],async render(){const n=await we.getPolicy(),e=Q.getUser(),t=await we.getFinancialYear(),a=window.app_hasPerm("policies","admin",e);let s=0;try{const d=new Date,l=d.getDay(),c=d.getDate()-l+(l===0?-6:1),m=new Date(d.setDate(c));m.setHours(0,0,0,0);const u=m.toISOString().split("T")[0];s=(await q.getAll("attendance")).filter(h=>h.user_id===e.id&&h.date>=u).filter(h=>h.checkIn?h.lateCountable===!0?!0:Xt.normalizeType(h.type)==="Late":!1).length}catch(d){console.warn("Error calc lates",d)}const i=Object.keys(n).map(async d=>{const l=await we.getLeaveUsage(e.id,d,t);return{type:d,usage:l,total:n[d].total,icon:this.getIconForType(d),color:this.getColorForType(d)}}),o=await Promise.all(i),r=await this.renderHolidayTable(this.currentYear,a);return`
            ...
            `}};typeof window<"u"&&(window.AppPolicies=Fn);function F(n,e={}){const t=document.createElement(n);if(e.id&&(t.id=e.id),e.className&&(t.className=e.className),e.textContent&&(t.textContent=e.textContent),e.innerHTML&&(t.innerHTML=e.innerHTML),e.attributes)for(const[a,s]of Object.entries(e.attributes))t.setAttribute(a,s);if(e.children)for(const a of e.children)t.appendChild(a);return t}function pe(n={}){const e=F("button",{className:n.className,textContent:n.textContent,innerHTML:n.innerHTML,attributes:{type:"button",...n.attributes}});return n.onClick&&e.addEventListener("click",n.onClick),e}const ke=n=>String(n??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;");function qn(n,e){const t=document.createElement("div"),a=window.getComputedStyle(n);for(const l of a)t.style[l]=a[l];t.style.position="absolute",t.style.visibility="hidden",t.style.whiteSpace="pre-wrap",t.style.width=a.width,t.style.height="auto";const s=n.value.substring(0,e);t.textContent=s;const i=document.createElement("span");i.textContent=n.value.substring(e)||".",t.appendChild(i),document.body.appendChild(t);const{offsetLeft:o,offsetTop:r}=i,d=n.getBoundingClientRect();return document.body.removeChild(t),{top:d.top+r-n.scrollTop,left:d.left+o-n.scrollLeft}}function zn(n,e,t){let a=document.getElementById("mention-dropdown");a?a.parentElement!==document.body&&document.body.appendChild(a):(a=F("div",{id:"mention-dropdown",className:"mention-dropdown"}),document.body.appendChild(a));let s=0,i=[],o=-1;const r=()=>{a.style.display="none",o=-1},d=()=>{if(i.length===0)return r();a.innerHTML="",i.forEach((m,u)=>{const p=F("div",{className:`mention-item ${u===s?"active":""}`,innerHTML:`
                    <img src="${m.avatar||"https://via.placeholder.com/32"}" class="mention-item-avatar">
                    <span class="mention-item-name">${m.name}</span>
                    <span class="mention-item-role">${m.role||"Staff"}</span>
                `});p.addEventListener("click",()=>l(m)),a.appendChild(p)});const c=qn(n,o);a.style.top=`${c.top+24}px`,a.style.left=`${c.left}px`,a.style.display="block"},l=c=>{const m=n.value,u=m.substring(0,o),p=m.substring(n.selectionStart);n.value=`${u}@${c.name} ${p}`,n.focus(),r(),t&&t()};n.addEventListener("input",()=>{const c=n.value,m=n.selectionStart,u=c.lastIndexOf("@",m-1);if(u!==-1&&(u===0||/\s/.test(c[u-1]))){const p=c.substring(u+1,m).toLowerCase();if(!/\s/.test(p)){o=u,i=e.filter(f=>f.name.toLowerCase().includes(p)).slice(0,8),s=0,d();return}}r(),t&&t()}),n.addEventListener("keydown",c=>{a.style.display==="block"&&(c.key==="ArrowDown"?(c.preventDefault(),s=(s+1)%i.length,d()):c.key==="ArrowUp"?(c.preventDefault(),s=(s-1+i.length)%i.length,d()):c.key==="Enter"||c.key==="Tab"?(c.preventDefault(),l(i[s])):c.key==="Escape"&&r())}),document.addEventListener("click",c=>{!a.contains(c.target)&&c.target!==n&&r()})}function jn(n,e,t,a,s){const i=F("h3",{textContent:"Plan Your Day"}),o=F("p",{className:"day-plan-subline",textContent:`${n}${e?` - Editing for ${t}`:""}`}),r=a?pe({className:"day-plan-delete-btn",attributes:{title:"Delete plan"},innerHTML:'<i class="fa-solid fa-trash"></i>',onClick:()=>window.app_deleteDayPlan(n,s)}):null,d=pe({className:"day-plan-close-btn",attributes:{title:"Close"},innerHTML:'<i class="fa-solid fa-xmark"></i>',onClick:c=>c.currentTarget.closest(".day-plan-modal-overlay").remove()}),l=F("div",{className:"day-plan-header-actions",children:[r,d].filter(Boolean)});return F("div",{className:"day-plan-header",children:[F("div",{className:"day-plan-headline",children:[i,o]}),l]})}function Wn(n,e,t,a,s,i,o,r,d,l){const c=F("div",{className:"day-plan-scroll-area personal-plans-container",attributes:{"data-scope":"personal"}}),m=F("div",{className:"day-plan-scroll-area others-plans-container",attributes:{"data-scope":"annual"}});s.forEach((w,b)=>{const v=ze({plan:w,idx:b,allUsers:i,targetId:e,defaultScope:o,selectableCollaborators:r,isAdmin:d,currentUserId:l.id,isReference:w.isReference});(w.planScope||w._planScope||o)==="annual"||w.isReference?m.appendChild(v):c.appendChild(v)});const u=F("div",{className:"day-plan-columns",children:[F("div",{className:"day-plan-column",children:[F("div",{className:"day-plan-column-head",children:[F("h4",{className:"day-plan-column-title",textContent:"Self Plan"}),pe({className:"btn-premium-add",innerHTML:'<i class="fa-solid fa-plus-circle"></i> <span>Add Personal Plan (@)</span>',onClick:()=>qe({date:n,targetId:e,scope:"personal",allUsers:i,selectableCollaborators:r,isAdmin:d,container:c})})]}),c]}),F("div",{className:"day-plan-column",children:[F("div",{className:"day-plan-column-head",children:[F("h4",{className:"day-plan-column-title",textContent:"Others' & Annual Plans"}),pe({className:"btn-premium-add",innerHTML:'<i class="fa-solid fa-plus-circle"></i> <span>Add Annual Plan (@)</span>',onClick:()=>qe({date:n,targetId:e,scope:"annual",allUsers:i,selectableCollaborators:r,isAdmin:d,container:m})})]}),m]})]}),p=pe({className:"day-plan-discard-btn",textContent:"Discard",onClick:w=>w.currentTarget.closest(".day-plan-modal-overlay").remove()}),f=pe({className:"day-plan-save-btn",innerHTML:'<i class="fa-solid fa-check-circle"></i> <span>Save Plan</span>',attributes:{type:"submit"}}),h=F("div",{className:"day-plan-footer",children:[F("div",{className:"day-plan-actions",children:[p,f]})]}),y=F("form",{className:"day-plan-form",attributes:{"data-had-personal":t?"1":"0","data-had-annual":a?"1":"0"},children:[u,h]});return y.addEventListener("submit",w=>window.app_saveDayPlan(w,n,e)),y}function qe(n){const{date:e,targetId:t,scope:a,allUsers:s,selectableCollaborators:i,isAdmin:o,container:r,existingBlock:d=null}=n,l=Q.getUser(),c=d?window.app_extractBlockData(d):{task:"",subPlans:[],tags:[],status:null,assignedTo:t,startDate:e,endDate:e,planScope:a},m=F("div",{className:"plan-editor-overlay"}),u=F("div",{className:"plan-editor-modal"}),p=F("div",{className:"plan-editor-head",innerHTML:`<h4>${d?"Edit":"Add"} ${a==="annual"?"Annual":"Personal"} Plan <small style="font-weight:400; opacity:0.7; font-size:0.8em; margin-left:5px;">(Use @ to tag)</small></h4>`}),f=F("div",{className:"plan-editor-body"}),h=F("textarea",{className:"plan-editor-textarea",textContent:c.task,attributes:{placeholder:"What is the objective or task for today? Use @ to tag colleagues.",required:!0}}),y=F("div",{className:"plan-editor-tags-container",attributes:{style:"display: none;"}}),w=()=>{const L=h.value,I=[];if(s.forEach(B=>{const E=`@${B.name}`;L.includes(E)&&!I.find(D=>D.id===B.id)&&I.push(B)}),I.length>0){y.style.display="block",y.innerHTML='<label class="plan-editor-tags-label">Tagged Collaborators:</label>';const B=F("div",{className:"plan-editor-tags-wrapper"});I.forEach(E=>{const D=F("span",{className:"day-plan-tag-pill",textContent:`@${E.name}`});B.appendChild(D)}),y.appendChild(B)}else y.style.display="none",y.innerHTML=""},b=F("div",{className:"plan-editor-grid"}),v=F("div",{className:"plan-editor-field"});v.innerHTML="<label>Status</label>";const k=F("select",{className:"plan-editor-select"});k.innerHTML=`
    ...
    `,v.appendChild(k);let g=null;if(o){const L=F("div",{className:"plan-editor-field"});L.innerHTML="<label>Assign To</label>",g=F("select",{className:"plan-editor-select"}),s.forEach(I=>{const B=F("option",{textContent:I.name,attributes:{value:I.id,selected:I.id===c.assignedTo}});g.appendChild(B)}),L.appendChild(g),b.appendChild(L)}f.appendChild(h),f.appendChild(y),f.appendChild(b);const A=F("div",{className:"plan-editor-footer"}),S=pe({className:"day-plan-discard-btn",textContent:"Cancel",onClick:()=>m.remove()}),$=pe({className:"day-plan-save-btn",textContent:d?"Update":"Add to List",onClick:()=>{const L=h.value.trim();if(!L)return alert("Please enter a task description");const I=[];s.forEach(D=>{L.includes(`@${D.name}`)&&!I.find(M=>M.id===D.id)&&I.push({id:D.id,name:D.name,status:"pending"})});const E={plan:{...c,task:L,status:k.value,assignedTo:g?g.value:c.assignedTo||t,tags:I.length>0?I:c.tags||[]},allUsers:s,targetId:t,selectableCollaborators:i,isAdmin:o,currentUserId:l.id};if(d){const D=ze({...E,idx:Number.parseInt(d.getAttribute("data-index"))});d.replaceWith(D)}else{const D=ze({...E,idx:r.querySelectorAll(".plan-block").length});r.appendChild(D)}m.remove()}});A.appendChild(S),A.appendChild($),u.appendChild(p),u.appendChild(f),u.appendChild(A),m.appendChild(u),document.getElementById("modal-container").appendChild(m),h.focus(),zn(h,s,w),w()}function ze(n){const{plan:e={},idx:t=0,allUsers:a=[],targetId:s,defaultScope:i="personal",selectableCollaborators:o=[],isAdmin:r=!1,currentUserId:d="",isReference:l=!1}=n||{},c=String(e.task||""),m=e.assignedTo||s||d,u=e.startDate||"",p=e.endDate||"",f=String(e.planScope||e._planScope||i)==="annual"?"annual":"personal",h=l?e.userName?`${e.userName}'s Plan`:"Others Plan":f==="annual"?"Annual Plan":"Personal Plan",y=c.trim()?c.trim().length>120?`${c.trim().slice(0,120)}...`:c.trim():"New task",w=F("div",{className:(l?"plan-block-ref":"plan-block")+(l?" is-reference-only":""),attributes:{"data-index":t}}),b=F("div",{className:"dp-hidden-data",attributes:{style:"display:none;"}});b.innerHTML=`
        <textarea class="plan-task">${ke(c)}</textarea>
        <select class="plan-status"><option value="${ke(e.status||"")}" selected></option></select>
        <select class="plan-scope"><option value="${ke(f)}" selected></option></select>
        <select class="plan-assignee"><option value="${ke(m)}" selected></option></select>
        <input class="plan-start-date" value="${ke(u)}">
        <input class="plan-end-date" value="${ke(p)}">
    `,e.subPlans&&e.subPlans.forEach(A=>{const S=F("input",{className:"sub-plan-input",attributes:{value:ke(A)}});b.appendChild(S)}),e.tags&&e.tags.forEach(A=>{const S=F("div",{className:"tag-chip",attributes:{"data-id":A.id,"data-name":A.name,"data-status":A.status||"pending"}});b.appendChild(S)}),w.appendChild(b);const v=F("div",{className:"plan-block-header"}),k=F("div",{className:"plan-block-title-group"});k.appendChild(F("span",{className:"day-plan-index-badge",textContent:t+1})),k.appendChild(F("span",{className:"plan-block-summary",textContent:y}));const g=F("div",{className:"plan-block-actions"});if(g.appendChild(F("span",{className:"day-plan-scope-pill",textContent:h})),l||(g.appendChild(pe({className:"day-plan-edit-btn",attributes:{title:"Edit plan"},innerHTML:'<i class="fa-solid fa-pen-to-square"></i>',onClick:()=>qe({date:u,targetId:s,scope:f,allUsers:a,selectableCollaborators:o,isAdmin:r,container:w.parentElement,existingBlock:w})})),t>0&&g.appendChild(pe({className:"day-plan-remove-btn",attributes:{title:"Remove task"},innerHTML:'<i class="fa-solid fa-trash-can"></i>',onClick:()=>w.remove()}))),v.appendChild(k),v.appendChild(g),w.appendChild(v),e.tags&&e.tags.length>0){const A=F("div",{className:"plan-block-body"});e.tags.forEach(S=>{const $=F("span",{className:"day-plan-tag-pill",textContent:`@${S.name}`});A.appendChild($)}),w.appendChild(A)}return w}function wa(n){if(!n)return null;const e=n.querySelector(".plan-task")?.value||"",t=n.querySelector(".plan-status")?.value||"",a=n.querySelector(".plan-scope")?.value||"personal",s=n.querySelector(".plan-assignee")?.value||"",i=n.querySelector(".plan-start-date")?.value||"",o=n.querySelector(".plan-end-date")?.value||"",r=Array.from(n.querySelectorAll(".sub-plan-input")).map(l=>l.value),d=Array.from(n.querySelectorAll(".tag-chip")).map(l=>({id:l.dataset.id,name:l.dataset.name,status:l.dataset.status}));return{task:e,status:t,planScope:a,assignedTo:s,startDate:i,endDate:o,subPlans:r,tags:d}}async function va(n,e=null,t=null){const a=Q.getUser(),s=String(e??"").trim(),i=!s||s==="undefined"||s==="null"?a.id:s,o=await q.getAll("users"),r=a.role==="Administrator"||a.isAdmin,d=i!==a.id,l=t==="annual"?"annual":"personal";window.app_currentDayPlanTargetId=i;const[c,m,u]=await Promise.all([Oe.getWorkPlan(i,n,{planScope:"personal"}),Oe.getWorkPlan(i,n,{planScope:"annual"}),q.queryMany("work_plans",[{field:"date",operator:"==",value:n}])]),p=!!(c||m),f=o.find(I=>I.id===i),h=f?f.name:"Staff",y=o.filter(I=>I.id!==i),w=(I,B,E=null)=>I?Array.isArray(I.plans)&&I.plans.length>0?I.plans.map(D=>({...D,planScope:B,userName:E||I.userName,isReference:!!E})):[]:[],b=(u||[]).filter(I=>I.id!==Oe.getWorkPlanId(n,i,"personal")&&I.id!==Oe.getWorkPlanId(n,i,"annual")),v=[];b.forEach(I=>{v.push(...w(I,I.planScope,I.userName))});const k=[...w(c,"personal"),...w(m,"annual"),...v];k.length===0&&k.push({task:"",subPlans:[],tags:[],status:null,assignedTo:i,startDate:n,endDate:n,planScope:l});const g=F("div",{id:"day-plan-modal",className:"day-plan-modal-overlay"}),A=F("div",{className:"day-plan-content"});A.appendChild(jn(n,d,h,p,i)),A.appendChild(Wn(n,i,c,m,k,o,l,y,r,a)),g.appendChild(A);const S=document.getElementById("modal-container");if(!S)return;const $=document.getElementById("day-plan-modal");$&&$.remove(),S.appendChild(g);const L=document.getElementById("day-plan-modal");if(L){const B=Array.from(document.querySelectorAll(".modal-overlay, .modal")).filter(E=>E!==L).reduce((E,D)=>{const M=Number.parseInt(window.getComputedStyle(D).zIndex,10);return Number.isFinite(M)?Math.max(E,M):E},1e3);L.style.zIndex=String(B+2)}}async function ba(n=null){const e=document.getElementById("day-plan-modal");if(!e)return;const t=n||"personal",a=t==="annual"?e.querySelector(".others-plans-container"):e.querySelector(".personal-plans-container"),s=e.querySelector(".day-plan-headline p")?.textContent?.match(/\d{4}-\d{2}-\d{2}/),i=s?s[0]:new Date().toISOString().split("T")[0],o=await q.getAll("users"),r=Q.getUser(),d=window.app_currentDayPlanTargetId||r.id,l=r.role==="Administrator"||r.isAdmin,c=o.filter(m=>m.id!==d);qe({date:i,targetId:d,scope:t,allUsers:o,selectableCollaborators:c,isAdmin:l,container:a})}const Yn={openDayPlan:va,dayPlanRenderBlockV3:ze,addPlanBlockUI:ba,openPlanEditor:qe,app_extractBlockData:wa};window.AppDayPlan=Yn;window.app_openDayPlan=va;window.app_dayPlanRenderBlockV3=ze;window.app_addPlanBlockUI=ba;window.app_extractBlockData=wa;const Ht={isWidgetMode:!1,syncInterval:null,init(){console.log("Widget Module Initialized"),new URLSearchParams(window.location.search).get("mode")==="widget"&&(this.isWidgetMode=!0),this.isWidgetMode&&this.enableWidgetMode()},toggle(){if(this.isWidgetMode)this.isWidgetMode=!1,window.opener||window.name==="CRWIWidget"?window.close():this.disableWidgetMode();else{const t=window.screen.width-320-20;window.open(window.location.origin+window.location.pathname+"?mode=widget#dashboard","CRWIWidget",`width=320,height=420,left=${t},top=40,menubar=no,toolbar=no,location=no,status=no,resizable=yes`)}},enableWidgetMode(){document.body.classList.add("widget-mode"),this.renderWidgetView(),this.startSync(),window.resizeTo&&window.resizeTo(320,420)},disableWidgetMode(){document.body.classList.remove("widget-mode");const n=document.getElementById("widget-view");n&&n.remove(),this.stopSync()},startSync(){this.syncInterval&&clearInterval(this.syncInterval),this.syncInterval=setInterval(()=>this.sync(),500)},stopSync(){this.syncInterval&&clearInterval(this.syncInterval)},sync(){if(!this.isWidgetMode)return;const n=document.getElementById("timer-display"),e=document.getElementById("timer-label"),t=document.querySelector(".check-in-widget .status-dot")||document.querySelector('.check-in-widget [style*="background: #10b981"]')||document.querySelector('.check-in-widget [style*="background: #94a3b8"]'),a=document.getElementById("attendance-btn"),s=document.getElementById("location-text"),i=document.getElementById("countdown-container"),o=document.getElementById("countdown-label"),r=document.getElementById("countdown-value"),d=document.getElementById("countdown-progress"),l=document.getElementById("overtime-container"),c=document.getElementById("overtime-value"),m=document.getElementById("widget-view");if(!m)return;const u=m.querySelector("#timer-display"),p=m.querySelector("#timer-label"),f=m.querySelector(".status-dot-indicator"),h=m.querySelector("#attendance-btn"),y=m.querySelector("#location-text"),w=m.querySelector("#countdown-container"),b=m.querySelector("#countdown-label"),v=m.querySelector("#countdown-value"),k=m.querySelector("#countdown-progress"),g=m.querySelector("#overtime-container"),A=m.querySelector("#overtime-value");n&&u&&(u.innerHTML=n.innerHTML,u.style.color=n.style.color),e&&p&&(p.innerHTML=e.innerHTML),t&&f&&(f.style.background=t.style.background||(t.classList.contains("online")?"#10b981":"#94a3b8")),i&&w&&(w.style.display=i.style.display,o&&b&&(b.innerHTML=o.innerHTML),r&&v&&(v.innerHTML=r.innerHTML),d&&k&&(k.style.width=d.style.width)),l&&g&&(g.style.display=l.style.display,c&&A&&(A.innerHTML=c.innerHTML)),a&&h&&(h.innerHTML=a.innerHTML,h.className=a.className,h.disabled=a.disabled),s&&y&&(y.innerHTML=s.innerHTML)},handleWidgetAction(){if(window.opener&&!window.opener.closed)try{if(window.opener.focus(),window.opener.location.hash!=="#dashboard"&&(window.opener.location.hash="#dashboard"),window.opener.app_handleAttendance){window.opener.app_handleAttendance();return}}catch(t){console.warn("Could not communicate with main window:",t)}console.log("Opener lost or closed. Reopening main app...");const n=window.location.origin+window.location.pathname+"#dashboard",e=window.open(n,"CRWIMainApp");if(e){e.focus();const t=document.getElementById("attendance-btn");if(t){const a=t.innerHTML;t.innerHTML='<i class="fa-solid fa-arrow-up-right-from-square"></i> Opening App...',setTimeout(()=>{t.innerHTML=a},3e3)}}else alert("Please allow popups or open the main application window manually.")},renderWidgetView(){let n=document.getElementById("widget-view");n||(n=document.createElement("div"),n.id="widget-view",document.body.appendChild(n));const e=window.AppAuth&&window.AppAuth.getUser()||{name:"User",role:"Staff",avatar:"https://via.placeholder.com/48"};n.innerHTML=`
        ...
        `}};typeof window<"u"&&(window.Widget=Ht,Ht.init());let gt=null,ce=[],ge=null,$e=null,Ue=0,je=!1,Re=null,wt=!1,Sa=0,at=null,nt=null,At=!1,st=null;const Dt="release_signal",Ft="app_meta",ka="app_last_seen_release_id",j={active:!1,releaseId:"",commitSha:"",deployedAt:"",notes:"",forceAfterMs:9e4,snoozeMs:3e5,maxSnoozeCount:1,deadlineTs:0,snoozeCount:0},Aa=3e4;window.app_annualYear=new Date().getFullYear();const Vn=n=>{const e=Math.max(0,Number(n)||0),t=Math.floor(e/1e3),a=Math.floor(t/60),s=t%60;return`${String(a).padStart(2,"0")}:${String(s).padStart(2,"0")}`},Kn=()=>{try{return localStorage.getItem(ka)||""}catch{return""}},Gn=n=>{try{localStorage.setItem(ka,String(n||""))}catch{}},it=()=>{st&&(clearInterval(st),st=null)},Te=()=>{const n=j.active?Math.max(0,j.deadlineTs-Date.now()):0;return{active:!!j.active,releaseId:j.releaseId||"",commitSha:j.commitSha||"",deployedAt:j.deployedAt||"",notes:j.notes||"",forceAfterMs:Number(j.forceAfterMs)||9e4,snoozeMs:Number(j.snoozeMs)||3e5,maxSnoozeCount:Number(j.maxSnoozeCount)||1,snoozeCount:Number(j.snoozeCount)||0,canSnooze:(Number(j.snoozeCount)||0)<(Number(j.maxSnoozeCount)||1),deadlineTs:Number(j.deadlineTs)||0,remainingMs:n,countdownLabel:Vn(n)}};window.app_getReleaseUpdateState=()=>Te();const We=()=>{const n=Te(),e=document.querySelector(".dashboard-refresh-link");e&&(n.active?(e.classList.add("is-update-pending"),e.setAttribute("title",`Update available. Auto-refresh in ${n.countdownLabel}`),e.innerHTML=`System update available <span class="dashboard-refresh-countdown">(${n.countdownLabel})</span>`):(e.classList.remove("is-update-pending"),e.setAttribute("title","Check for System Update (Ctrl+Shift+R)"),e.textContent="Check for System Update"))};window.app_applyUpdateCtaState=We;const xt=()=>{We(),window.dispatchEvent&&window.dispatchEvent(new CustomEvent("app:update-countdown",{detail:Te()}))},Da=(n=!0)=>{const e=j.releaseId;it(),j.active=!1,j.deadlineTs=0,j.snoozeCount=0,n&&e&&Gn(e),xt()},xa=()=>{it(),st=setInterval(()=>{if(!j.active){it();return}if(j.deadlineTs-Date.now()<=0){it(),window.app_forceRefresh();return}xt()},1e3),xt()};window.app_snoozeReleaseUpdate=()=>{j.active&&(j.snoozeCount>=j.maxSnoozeCount||(j.snoozeCount+=1,j.deadlineTs=Date.now()+j.snoozeMs,window.app_showSyncToast(`Update snoozed for ${Math.round(j.snoozeMs/6e4)} minutes.`),xa()))};const Xn=n=>{const e=String(n.releaseId||n.commitSha||"");if(!e)return;const t=Kn();e===j.releaseId&&j.active||e!==t&&(j.active=!0,j.releaseId=e,j.commitSha=String(n.commitSha||""),j.deployedAt=String(n.deployedAt||""),j.notes=String(n.notes||""),j.forceAfterMs=Number(n.forceAfterMs)||9e4,j.snoozeMs=Number(n.snoozeMs)||3e5,j.maxSnoozeCount=Number(n.maxSnoozeCount)||1,j.snoozeCount=0,j.deadlineTs=Date.now()+j.forceAfterMs,window.app_showSyncToast("New system update available."),xa(),window.dispatchEvent&&window.dispatchEvent(new CustomEvent("app:update-available",{detail:Te()})))},qt=n=>{!n||n.id!==Dt||n.active!==!1&&Xn(n)},$a=()=>{if(!At){if(At=!0,window.AppDB&&typeof window.AppDB.listen=="function"){at=window.AppDB.listen(Ft,n=>{const e=(n||[]).find(t=>t.id===Dt);e&&qt(e)});return}nt=setInterval(async()=>{try{const n=await window.AppDB.get(Ft,Dt);n&&qt(n)}catch{}},3e4)}},Jn=()=>{typeof at=="function"&&(at(),at=null),nt&&(clearInterval(nt),nt=null),At=!1,Da(!1)};window.app_isAdminUser=(n=window.AppAuth?.getUser())=>n?n.isAdmin===!0:!1;window.app_canSeeAdminPanel=(n=window.AppAuth?.getUser())=>n?window.app_isAdminUser(n)?!0:n.permissions?Object.values(n.permissions).some(e=>e==="admin"):!1:!1;window.app_hasPerm=(n,e="view",t=window.AppAuth?.getUser())=>{if(!t)return!1;if(t.isAdmin===!0)return!0;if(!t.permissions||!t.permissions[n])return!1;const a=t.permissions[n];return e==="view"?a==="view"||a==="admin":e==="admin"?a==="admin":!1};window.app_canManageAttendanceSheet=(n=window.AppAuth?.getUser())=>n?window.app_hasPerm("attendance","admin",n)||!!n.canManageAttendanceSheet:!1;window.app_getReadTelemetry=()=>!window.AppDB||!window.AppDB.getReadTelemetry?{}:window.AppDB.getReadTelemetry();window.app_resetReadTelemetry=()=>{!window.AppDB||!window.AppDB.clearReadTelemetry||window.AppDB.clearReadTelemetry()};window.app_getMyMessages=async()=>{const n=window.AppAuth.getUser();if(!n)return[];try{const[e,t]=await Promise.all([window.AppDB.query("staff_messages","toId","==",n.id),window.AppDB.query("staff_messages","fromId","==",n.id)]),a=new Map;return(e||[]).forEach(s=>a.set(s.id,s)),(t||[]).forEach(s=>a.set(s.id,s)),Array.from(a.values())}catch(e){return console.warn("Message fetch failed, falling back to getAll",e),window.AppDB.getAll("staff_messages")}};const Z=document.getElementById("page-content"),Je=document.querySelector(".sidebar"),Ze=document.querySelector(".mobile-header"),Qe=document.querySelector(".mobile-nav");window.app_initTheme=()=>{const n=localStorage.getItem("theme")||"light";document.documentElement.setAttribute("data-theme",n),_a(n)};window.app_toggleTheme=()=>{const e=document.documentElement.getAttribute("data-theme")==="dark"?"light":"dark";document.documentElement.setAttribute("data-theme",e),localStorage.setItem("theme",e),_a(e)};function _a(n){document.querySelectorAll(".theme-toggle i").forEach(e=>{n==="dark"?(e.classList.remove("fa-moon"),e.classList.add("fa-sun")):(e.classList.remove("fa-sun"),e.classList.add("fa-moon"))})}function Zn(){"serviceWorker"in navigator&&window.addEventListener("load",()=>{navigator.serviceWorker.register("./sw.js").then(()=>console.log("ServiceWorker registered")).catch(n=>console.log("ServiceWorker registration failed: ",n))})}const zt=(n=new Date)=>`${n.getFullYear()}-${String(n.getMonth()+1).padStart(2,"0")}-${String(n.getDate()).padStart(2,"0")}`;window.app_showAttendanceNotice=n=>{if(!n)return;const e=document.getElementById("page-content");if(!e)return;const t=document.getElementById("attendance-policy-notice");t&&t.remove();const a=document.createElement("div");a.id="attendance-policy-notice",a.style.background="#fff7ed",a.style.border="1px solid #fdba74",a.style.color="#9a3412",a.style.padding="0.85rem 1rem",a.style.borderRadius="10px",a.style.marginBottom="0.9rem",a.style.fontSize="0.9rem",a.style.fontWeight="600",a.innerHTML=`<i class="fa-solid fa-circle-info" style="margin-right:0.45rem;"></i>${n}`,e.prepend(a),setTimeout(()=>{const s=document.getElementById("attendance-policy-notice");s&&s.remove()},1e4)};window.app_promptMissedCheckoutReason=(n={})=>{const{logId:e,date:t}=n||{};if(!e||document.getElementById("missed-checkout-reason-modal"))return;const a=t?new Date(`${t}T00:00:00`).toLocaleDateString():"previous day",s=`
                ...
                <div style="display:flex; justify-content:space-between; align-items:flex-start; gap:1rem; margin-bottom:0.75rem;">
                    <div>
                        ...
                        <p style="margin:0.35rem 0 0 0; font-size:0.85rem; color:#6b7280;">
                            Your session on ${te(a)} was auto-checked out and counted as a half day.
                        </p>
                    </div>
    ...
    `;(document.body||document.getElementById("modal-container")).insertAdjacentHTML("beforeend",s);const i=document.getElementById("missed-checkout-reason-modal");i?.addEventListener("click",o=>{o.target===i&&i.remove()})};window.app_submitMissedCheckoutReason=async(n,e)=>{n.preventDefault();const t=n.target,a=String(new FormData(t).get("reason")||"").trim();if(!a){alert("Please enter a reason.");return}try{const s=window.AppAuth.getUser();if(!s)throw new Error("User not authenticated");const i=await window.AppDB.get("attendance",e);if(!i)throw new Error("Attendance record not found.");const o=new Date().toISOString(),r={...i,missedCheckoutReason:a,missedCheckoutReasonSubmittedAt:o,missedCheckoutReasonStatus:"pending"};await window.AppDB.put("attendance",r);const d=await window.AppDB.get("users",s.id);d&&(d.notifications||(d.notifications=[]),d.notifications.unshift({id:`mcr_sub_${Date.now()}`,type:"missed-checkout-reason-submitted",title:"Missed checkout reason submitted",message:`Reason sent for ${i.date}. Awaiting admin verification.`,status:"submitted",date:o,read:!0}),await window.AppDB.put("users",d),window.AppAuth?.getUser&&Object.assign(window.AppAuth.getUser(),{notifications:d.notifications}));const l=(await window.AppDB.getAll("users")).filter(c=>c.isAdmin||c.role==="Administrator");await Promise.all(l.map(async c=>{c.notifications||(c.notifications=[]),c.notifications.unshift({id:`mcr_${Date.now()}_${Math.random().toString(36).slice(2,6)}`,type:"missed-checkout-reason",title:"Missed checkout reason submitted",message:`${s.name} submitted a reason for missed checkout on ${i.date}.`,description:a,staffId:s.id,staffName:s.name,missedCheckoutDate:i.date,logId:String(i.id||""),taggedById:s.id,taggedByName:s.name,taggedAt:o,status:"pending",date:o,read:!1}),await window.AppDB.put("users",c)})),document.getElementById("missed-checkout-reason-modal")?.remove(),window.app_refreshNotificationBell&&await window.app_refreshNotificationBell(),window.app_showSyncToast("Reason submitted for admin verification.")}catch(s){console.error("Missed checkout reason submit failed:",s),alert("Failed to submit reason: "+s.message)}};window.app_showSyncToast=(n="Status updated from another device.")=>{const e="app-sync-toast",t=document.getElementById(e);t&&t.remove();const a=document.createElement("div");a.id=e,a.style.position="fixed",a.style.top="14px",a.style.right="14px",a.style.zIndex="10020",a.style.background="#0f172a",a.style.color="#f8fafc",a.style.padding="0.7rem 0.9rem",a.style.borderRadius="10px",a.style.fontSize="0.82rem",a.style.fontWeight="600",a.style.boxShadow="0 8px 25px rgba(15, 23, 42, 0.3)",a.textContent=n,document.body.appendChild(a),setTimeout(()=>{const s=document.getElementById(e);s&&s.remove()},2800)};const jt=()=>!je&&Date.now()>Sa,$t=()=>{Sa=Date.now()+3500},Qn=n=>{const e=n.detail;if(!e)return;window.app_refreshNotificationBell&&window.app_refreshNotificationBell().catch(()=>{});const t=e.status||"out",a=Re!==null&&t!==Re,s=Re===null&&t==="in";if(Re=t,!(a||s)||wt)return;const i=!window.location.hash||window.location.hash==="#dashboard",o=document.getElementById("checkout-modal"),r=!!(o&&o.style.display==="flex");if(t==="out"&&r&&(o.style.display="none"),!i){jt()&&window.app_showSyncToast("Status updated from another device.");return}wt=!0,(async()=>{try{const d=document.getElementById("page-content");d&&(d.innerHTML=await R.renderDashboard(),window.setupDashboardEvents&&window.setupDashboardEvents()),jt()&&window.app_showSyncToast("Status updated from another device.")}catch(d){console.warn("Realtime dashboard sync failed:",d)}finally{wt=!1}})()};function _t(n){const e=document.querySelector(".sidebar"),t=document.getElementById("sidebar-overlay");e&&t&&(n?(e.classList.add("open"),t.classList.add("active")):(e.classList.remove("open"),t.classList.remove("active")))}function es(){if(window.location.search){const n=window.location.protocol+"//"+window.location.host+window.location.pathname+window.location.hash;window.history.replaceState({path:n},"",n),console.log("Address bar cleaned of query parameters.")}}window.app_toggleSidebar=(n=null)=>{const e=document.querySelector(".sidebar"),t=document.querySelector("#desktop-sidebar-toggle i");if(!e)return;(n!==null?n:!e.classList.contains("collapsed"))?(e.classList.add("collapsed"),t&&(t.classList.remove("fa-angles-left"),t.classList.add("fa-angles-right"))):(e.classList.remove("collapsed"),t&&(t.classList.remove("fa-angles-right"),t.classList.add("fa-angles-left")))};window.app_showModal=(n,e)=>{const t=document.getElementById("modal-container");if(!t)return;const a=document.getElementById(e);a&&a.remove(),t.insertAdjacentHTML("beforeend",n);const s=document.getElementById(e);if(s&&(s.classList.contains("modal-overlay")||s.classList.contains("modal"))){const o=Array.from(document.querySelectorAll(".modal-overlay, .modal")).filter(r=>r!==s).reduce((r,d)=>{const l=Number.parseInt(window.getComputedStyle(d).zIndex,10);return Number.isFinite(l)?Math.max(r,l):r},1e3);s.style.zIndex=String(o+2)}};const te=n=>String(n??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;"),ts=n=>te(n).replace(/\n/g,"<br>"),Tt=n=>String(n?.status||"pending").toLowerCase(),He=n=>Tt(n)==="pending",vt=n=>n?.type==="minute-access-request"?"Minutes":String(n?.type||"").includes("missed-checkout")?"Attendance":n?.type==="task"?"Task":n?.type==="tag"||n?.type==="mention"?"Tag":n?.type==="reminder"?"Reminder":"Notification",Wt=n=>String(n?.description||n?.message||n?.title||"").trim(),as=n=>{const e=n?.respondedAt||n?.taggedAt||n?.date,t=new Date(e).getTime();if(!t)return"Unknown time";const a=Math.max(0,Math.floor((Date.now()-t)/6e4)),s=a<1?"just now":a<60?`${a} mins ago`:a<1440?`${Math.floor(a/60)} hrs ago`:`${Math.floor(a/1440)} days ago`;return`${new Date(t).toLocaleString()} (${s})`};window.app_refreshNotificationBell=async()=>{const n=document.querySelectorAll(".top-notification-btn");if(!n.length)return;const e=window.AppAuth.getUser(),a=(Array.isArray(e?.notifications)?e.notifications:[]).filter(He).length;n.forEach(s=>{const i=s.querySelector(".top-notification-badge");if(!e){s.classList.remove("has-pending"),i&&(i.style.display="none");return}s.classList.toggle("has-pending",a>0),s.setAttribute("title",a>0?`${a} pending notification${a>1?"s":""}`:"Notification history"),i&&(a>0?(i.textContent=a>99?"99+":String(a),i.style.display=""):i.style.display="none")})};window.app_closeNotificationHistory=()=>{const n=document.getElementById("notification-history-modal"),e=document.getElementById("notif-drawer-backdrop");n&&n.classList.remove("notif-drawer-open"),e&&e.classList.remove("notif-drawer-backdrop-visible"),setTimeout(()=>document.getElementById("notif-drawer-root")?.remove(),320)};window.app_respondNotificationFromHistory=async(n,e,t)=>{const a=window.AppAuth.getUser();if(!a)return;const s=t==="approve"?"approve":"reject",i=await window.AppDB.get("users",a.id);if(!i||!Array.isArray(i.notifications)){alert("Notification not found.");return}let o=null,r=-1;if(Number.isInteger(n)&&n>=0&&i.notifications[n]&&(o=i.notifications[n],r=n),!o&&e&&(r=i.notifications.findIndex(d=>String(d.id)===String(e)),r>=0&&(o=i.notifications[r])),!o){alert("This notification is no longer available.");return}if(!He(o)){alert("This notification has already been responded."),await window.app_refreshNotificationBell();return}window.app_closeNotificationHistory();try{if(o.type==="minute-access-request"&&window.app_hasPerm("minutes","admin",a)){await window.app_reviewMinuteAccessFromNotification(r,o.id,s==="approve"?"approved":"rejected");return}if(o.type==="missed-checkout-reason"&&(a.isAdmin||a.role==="Administrator")){await window.app_reviewMissedCheckoutReasonFromNotification(r,o.id,s==="approve"?"approved":"rejected");return}const d=Number(o.taskIndex);if(o.planId&&Number.isInteger(d)&&d>=0){await window.app_handleTagResponse(o.planId,d,s==="approve"?"accepted":"rejected",r);return}if(o.id){await window.app_handleTagDecision(o.id,s==="approve"?"accepted":"rejected");return}alert("This notification cannot be approved or rejected from history.")}catch(d){console.error("Notification response error:",d),alert("Failed to process notification: "+d.message)}};window.app_openNotificationHistory=async()=>{const n=window.AppAuth.getUser();if(!n)return;const e=await window.AppDB.get("users",n.id).catch(()=>n),t=Array.isArray(e?.notifications)?e.notifications:[],a=Array.isArray(e?.tagHistory)?e.tagHistory:[],s=n.isAdmin||n.role==="Administrator",i=[...t.map((S,$)=>({...S,_source:"live",_index:$})),...a.map(S=>({...S,_source:"history",_index:-1}))],o=S=>new Date(S.respondedAt||S.taggedAt||S.date||0).getTime()||0,r=S=>String(S||"").trim().toLowerCase(),l=['<option value="all">All Sources</option>',...Array.from(new Set(i.map(S=>vt(S)))).filter(Boolean).sort((S,$)=>S.localeCompare($)).map(S=>`<option value="${te(S.toLowerCase())}">${te(S)}</option>`)].join(""),c={search:"",status:"all",source:"all",sort:"newest"},m=S=>{const $=Tt(S),L=$==="pending"&&S._source==="live",I=vt(S),B=S.taggedByName||"System",E=S.title||`${I} from ${B}`,D=Wt(S),M=JSON.stringify(String(S.id||"")),U={pending:{bg:"#fff7ed",border:"#fdba74",badge:"#f97316"},accepted:{bg:"#f0fdf4",border:"#86efac",badge:"#16a34a"},rejected:{bg:"#fef2f2",border:"#fca5a5",badge:"#dc2626"},default:{bg:"#f8fafc",border:"#e2e8f0",badge:"#6b7280"}},P=U[$]||U.default,C=L||s&&S.type==="minute-access-request"?`
            ...
            <div class="notif-drawer-item ${L?"is-pending":""}" style="border-color:${P.border}; background:${P.bg};" data-notif-id="${te(String(S.id||""))}">
                <div class="notif-drawer-item-head">
                    <div class="notif-drawer-item-left">
                        ...
                        <div>
                            <div class="notif-drawer-title">${te(E)}</div>
                            <div class="notif-drawer-meta">${te(I)} • ${te(B)} • ${te(as(S))}</div>
                        </div>
                    </div>
                    <div class="notif-drawer-item-right">
                        <span class="notif-drawer-badge" style="background:${P.badge}">${te($)}</span>
                    </div>
                </div>
                ${D?`<div class="notif-drawer-text">${te(D)}</div>`:""}
                ${C}
            </div>`},u=()=>{const S=i.filter($=>{const L=Tt($),I=vt($),B=$.taggedByName||"System",E=$.title||`${I} from ${B}`,D=Wt($),M=`${E} ${D} ${I} ${B} ${L}`;return!(c.status!=="all"&&L!==c.status||c.source!=="all"&&r(I)!==c.source||c.search&&!r(M).includes(c.search))});return c.sort==="oldest"?S.sort(($,L)=>o($)-o(L)):c.sort==="pending"?S.sort(($,L)=>{const I=He($)?1:0,B=He(L)?1:0;return I!==B?B-I:o(L)-o($)}):S.sort(($,L)=>o(L)-o($)),S},p=t.filter(He).length,f=`
        ...
        </div>`,h=document.createElement("div");h.id="notif-drawer-root",h.innerHTML=f,document.body.appendChild(h),requestAnimationFrame(()=>{const S=document.getElementById("notification-history-modal");S&&S.classList.add("notif-drawer-open");const $=document.getElementById("notif-drawer-backdrop");$&&$.classList.add("notif-drawer-backdrop-visible")});const y=document.getElementById("notif-drawer-list"),w=document.getElementById("notif-drawer-results"),b=document.getElementById("notif-drawer-search"),v=document.getElementById("notif-drawer-source"),k=document.getElementById("notif-drawer-sort"),g=document.getElementById("notif-drawer-status-tabs"),A=()=>{if(!y)return;const S=u();y.innerHTML=S.length?S.map(m).join(""):'<div class="notif-drawer-empty"><i class="fa-regular fa-bell-slash"></i><p>No notifications match your search/filter.</p></div>',w&&(w.textContent=`Showing ${S.length} of ${i.length}`)};b?.addEventListener("input",S=>{c.search=r(S.target.value),A()}),v?.addEventListener("change",S=>{c.source=r(S.target.value)||"all",A()}),k?.addEventListener("change",S=>{c.sort=r(S.target.value)||"newest",A()}),g?.addEventListener("click",S=>{const $=S.target.closest("[data-notif-status]");$&&(c.status=r($.getAttribute("data-notif-status"))||"all",g.querySelectorAll(".notif-drawer-status-tab").forEach(L=>L.classList.remove("is-active")),$.classList.add("is-active"),A())}),A(),await window.app_refreshNotificationBell()};window.app_systemDialog=function({title:n="Notice",message:e="",mode:t="alert",defaultValue:a="",confirmText:s="OK",cancelText:i="Cancel",placeholder:o=""}={}){return new Promise(r=>{const d=`system-dialog-${Date.now()}-${Math.random().toString(36).slice(2,6)}`,l=`${d}-input`,c=t==="prompt",m=t==="confirm"||t==="prompt",u=`
                <div class="modal-overlay app-system-dialog-overlay" id="${d}" style="display:flex;">
                    <div class="modal-content app-system-dialog">
                        ...
                        <div class="app-system-dialog-body">
                            <p>${ts(e)}</p>
                            ${c?`<input id="${l}" class="app-system-dialog-input" type="text" value="${te(a)}" placeholder="${te(o)}" autocomplete="off">`:""}
                        </div>
                        <div class="app-system-dialog-actions">
                            ${m?`<button type="button" class="action-btn secondary app-system-dialog-cancel">${te(i)}</button>`:""}
                            <button type="button" class="action-btn app-system-dialog-confirm">${te(s)}</button>
                        </div>
                    </div>
                </div>
            `;(document.body||document.getElementById("modal-container")).insertAdjacentHTML("beforeend",u);const p=document.getElementById(d);if(!p){r(c?null:!1);return}p.style.zIndex="20000";const f=p.querySelector(".app-system-dialog-confirm"),h=p.querySelector(".app-system-dialog-cancel"),y=p.querySelector(".app-system-dialog-close"),w=c?p.querySelector(`#${l}`):null,b=v=>{p.remove(),r(v)};f?.addEventListener("click",()=>{b(c?w?w.value:"":!0)}),h?.addEventListener("click",()=>b(c?null:!1)),y?.addEventListener("click",()=>b(c?null:!1)),p.addEventListener("click",v=>{v.target===p&&b(c?null:!1)}),p.addEventListener("keydown",v=>{v.key==="Escape"&&b(c?null:!1),v.key==="Enter"&&(v.preventDefault(),b(c?w?w.value:"":!0))}),w?(w.focus(),w.select()):f?.focus()})};window.appAlert=(n,e="Notice")=>window.app_systemDialog({title:e,message:n,mode:"alert",confirmText:"OK"});window.appConfirm=(n,e="Please Confirm")=>window.app_systemDialog({title:e,message:n,mode:"confirm",confirmText:"Confirm",cancelText:"Cancel"});window.appPrompt=(n,e="",t={})=>window.app_systemDialog({title:t.title||"Enter Details",message:n,mode:"prompt",defaultValue:e,confirmText:t.confirmText||"Save",cancelText:t.cancelText||"Cancel",placeholder:t.placeholder||""});window.alert=n=>{window.appAlert(n)};window.app_openEventModal=()=>{window.app_showModal(`
        ...
        `,"event-modal")};window.app_submitEvent=async n=>{n.preventDefault();const e=document.getElementById("event-title").value,t=document.getElementById("event-date").value,a=document.getElementById("event-type").value;try{await window.AppCalendar.addEvent({title:e,date:t,type:a}),alert("Event added successfully!"),document.getElementById("event-modal")?.remove();const s=document.getElementById("page-content");s.innerHTML=await R.renderDashboard(),ue()}catch(s){alert("Error: "+s.message)}};const Yt="work_plan_schema_v2_migrated",ns=async()=>{try{if(!window.AppDB||typeof window.AppDB.getAll!="function"||typeof window.AppDB.put!="function"||localStorage.getItem(Yt)==="true")return;const n=await window.AppDB.getAll("work_plans");let e=0;for(const t of n){if(!t||Array.isArray(t.plans))continue;const a=typeof t.plan=="string"?t.plan.trim():"";if(!a)continue;const s={...t,plans:[{task:a,subPlans:Array.isArray(t.subPlans)?t.subPlans:[],tags:Array.isArray(t.tags)?t.tags:[],status:t.status||null,completedDate:t.completedDate||null,startDate:t.startDate||t.date,endDate:t.endDate||t.startDate||t.date}]};delete s.plan,delete s.subPlans,delete s.tags,delete s.status,delete s.completedDate,delete s.startDate,delete s.endDate,await window.AppDB.put("work_plans",s),e+=1}localStorage.setItem(Yt,"true"),e>0&&console.log(`Work plan schema migration complete. Updated: ${e}`)}catch(n){console.warn("Work plan schema migration failed:",n)}};async function ss(){window.app_initTheme(),es(),window.addEventListener("app:user-sync",Qn),window.addEventListener("app:update-available",We),window.addEventListener("app:update-countdown",We);try{await window.AppAuth.init();const e=window.AppAuth.getUser();e&&(Re=e.status||"out",$a()),Zn(),await ns(),window.AppActivity&&window.AppActivity.initCommandListener()}catch(e){console.error("Initialization Failed:",e),Z&&(Z.innerHTML=`<div style="text-align:center; padding:2rem; color:red;">Failed to load application.<br><small>${e.message}</small></div>`)}document.addEventListener("click",e=>{e.target.id==="sidebar-toggle"||e.target.closest("#sidebar-toggle")?_t(!0):e.target.id==="sidebar-overlay"&&_t(!1)}),window.addEventListener("hashchange",Vt),Vt();const n=window.AppAuth.getUser();n&&window.AppTour&&window.AppTour.init(n)}async function Vt(){const n=window.AppAuth.getUser(),e=window.location.hash.slice(1)||"dashboard";if(e!=="admin"&&ce&&ce.length>0&&(console.log("Cleaning up Admin Realtime Listener."),ce.forEach(d=>typeof d=="function"&&d()),ce=[]),e!=="minutes"&&typeof ge=="function"&&(console.log("Cleaning up Minutes Realtime Listener."),ge(),ge=null),!n){Jn(),Je&&(Je.style.display="none"),Ze&&(Ze.style.display="none"),Qe&&(Qe.style.display="none"),document.body.style.background="#f3f4f6",Z&&(Z.innerHTML=R.renderLogin()),window.app_refreshNotificationBell&&await window.app_refreshNotificationBell();return}$a(),_t(!1),Je&&(Je.style.display=""),Ze&&(Ze.style.display=""),Qe&&(Qe.style.display="");const t=document.querySelector(".sidebar-footer .user-mini-profile");t&&(t.innerHTML=`
            ...
            `);const a=window.app_hasPerm("attendance","view",n),s=window.app_hasPerm("reports","view",n),i=window.app_hasPerm("policies","view",n),o=window.app_canSeeAdminPanel(n);document.querySelectorAll('a[data-page="admin"]').forEach(d=>{d.style.display=o?"flex":"none",o||d.style.setProperty("display","none","important")}),document.querySelectorAll('a[data-page="master-sheet"]').forEach(d=>{d.style.display=a?"flex":"none",a||d.style.setProperty("display","none","important")}),document.querySelectorAll('a[data-page="salary"]').forEach(d=>{d.style.display=s?"flex":"none",s||d.style.setProperty("display","none","important")}),document.querySelectorAll('a[data-page="policy-test"]').forEach(d=>{d.style.display=i?"flex":"none",i||d.style.setProperty("display","none","important")}),document.querySelectorAll(".nav-item, .mobile-nav-item").forEach(d=>{d.dataset.page===e?d.classList.add("active"):d.classList.remove("active")});try{const d=document.getElementById("modal-container");if(d&&!document.getElementById("checkout-modal")&&d.insertAdjacentHTML("beforeend",R.renderModals()),Z&&(Z.innerHTML='<div class="loading-spinner"></div>'),e==="dashboard")Z.innerHTML=await R.renderDashboard(),ue();else if(e==="team-activities")Z.innerHTML=await R.renderTeamActivitiesPage(),window.app_initTeamActivities&&await window.app_initTeamActivities();else if(e==="staff-directory")Z.innerHTML=await R.renderStaffDirectoryPage();else if(e==="policies")window.AppPolicies&&typeof window.AppPolicies.render=="function"?Z.innerHTML=await window.AppPolicies.render():Z.innerHTML='<div style="padding:1rem; color:#b91c1c;">Policies module failed to load.</div>';else if(e==="annual-plan")Z.innerHTML=await R.renderAnnualPlan();else if(e==="timesheet")Z.innerHTML=await R.renderTimesheet();else if(e==="profile")Z.innerHTML=await R.renderProfile();else if(e==="salary"){if(!window.app_hasPerm("reports","view",n)){window.location.hash="dashboard";return}Z.innerHTML=await R.renderSalaryProcessing?await R.renderSalaryProcessing():await R.renderSalary()}else if(e==="policy-test"){if(!window.app_hasPerm("policies","view",n)){window.location.hash="dashboard";return}Z.innerHTML=await R.renderPolicyTest()}else if(e==="master-sheet"){if(!(window.app_hasPerm("attendance","view",n)||window.app_canManageAttendanceSheet(n))){window.location.hash="dashboard";return}Z.innerHTML=await R.renderMasterSheet()}else if(e==="minutes")Z.innerHTML=await R.renderMinutes(),os();else if(e==="admin"){if(!window.app_canSeeAdminPanel(n)){window.location.hash="dashboard";return}Z.innerHTML=await R.renderAdmin(),window.AppAnalytics.initAdminCharts(),is()}window.app_updateStaffNavIndicator&&await window.app_updateStaffNavIndicator(),window.app_refreshNotificationBell&&await window.app_refreshNotificationBell()}catch(d){console.error("Render Error:",d),Z.innerHTML=`<div style="text-align:center; color:red; padding:2rem;">Error loading page: ${d.message}</div>`}}function is(){ce.forEach(s=>typeof s=="function"&&s()),ce=[],console.log("Starting Admin Realtime Listeners (Users & Audits)...");let n=null;const e=()=>{n&&clearTimeout(n),n=setTimeout(async()=>{n=null,await t()},600)},t=async()=>{if(window.location.hash.slice(1)!=="admin")return;if(document.querySelector('.modal-overlay[style*="display: flex"], .modal[style*="display: flex"]'))console.log("Admin Update received but skipped because a modal is open.");else{console.log("Admin Data Update Received (Realtime) - Refreshing UI");const o=document.getElementById("page-content");if(o){const r=document.getElementById("audit-start")?.value,d=document.getElementById("audit-end")?.value;o.innerHTML=await R.renderAdmin(r,d),window.AppAnalytics&&window.AppAnalytics.initAdminCharts()}}};if((_&&_.READ_OPT_FLAGS||{}).FF_READ_OPT_TARGETED_REALTIME&&window.AppDB.listenQuery){ce.push(window.AppDB.listenQuery("users",[{field:"status",operator:"in",value:["in","out"]}],{limit:300},e));const s=new Date;s.setDate(s.getDate()-2),ce.push(window.AppDB.listenQuery("location_audits",[{field:"timestamp",operator:">=",value:s.getTime()}],{orderBy:[{field:"timestamp",direction:"desc"}],limit:300},e))}else ce.push(window.AppDB.listen("users",e)),ce.push(window.AppDB.listen("location_audits",e))}function os(){if(!window.AppDB||!window.AppDB.listen)return;typeof ge=="function"&&(ge(),ge=null);const n=async()=>{if((window.location.hash.slice(1)||"dashboard")!=="minutes"||document.getElementById("minute-detail-modal"))return;const a=document.getElementById("page-content");a&&(a.innerHTML=await R.renderMinutes())};(_&&_.READ_OPT_FLAGS||{}).FF_READ_OPT_TARGETED_REALTIME&&window.AppDB.listenQuery?ge=window.AppDB.listenQuery("minutes",[],{orderBy:[{field:"date",direction:"desc"}],limit:150},n):ge=window.AppDB.listen("minutes",n)}function rs(n=null,e=!1){gt&&clearInterval(gt),(async()=>{let a="out",s=null;if(n)a=n.status||"out",s=n.lastCheckIn||null;else{const u=await window.AppAttendance.getStatus();a=u.status,s=u.lastCheckIn}const i=document.getElementById("timer-display"),o=document.getElementById("countdown-container"),r=document.getElementById("overtime-container"),d=document.getElementById("countdown-value"),l=document.getElementById("countdown-progress"),c=document.getElementById("overtime-value"),m=document.getElementById("timer-label");if(a==="in"&&s){const u=new Date(s),p=new Date,f=`${u.getFullYear()}-${String(u.getMonth()+1).padStart(2,"0")}-${String(u.getDate()).padStart(2,"0")}`,h=`${p.getFullYear()}-${String(p.getMonth()+1).padStart(2,"0")}-${String(p.getDate()).padStart(2,"0")}`,y=f!==h,w=new Date(u);w.setHours(17,0,0,0);const b=u.getDay();b===6&&w.setHours(13,0,0,0),b===0&&w.setHours(17,0,0,0),gt=setInterval(()=>{const v=Date.now(),k=v-s;if(i){let A=Math.floor(k/36e5),S=Math.floor(k/(1e3*60)%60),$=Math.floor(k/1e3%60);A=A<10?"0"+A:A,S=S<10?"0"+S:S,$=$<10?"0"+$:$,i.textContent=`${A} : ${S} : ${$}`}if(y){o&&(o.style.display="none"),r&&(r.style.display="none"),i&&(i.style.color="#b45309"),m&&(m.textContent="Session Carryover (Please Check Out)",m.style.color="#b45309");return}const g=w.getTime()-v;if(g>0){o&&(o.style.display="block"),r&&(r.style.display="none"),m&&(m.textContent="Elapsed Time",m.style.color="#6b7280"),i&&(i.style.color="#1f2937");let A=Math.floor(g/(1e3*60*60)%24),S=Math.floor(g/(1e3*60)%60),$=Math.floor(g/1e3%60);A=A<10?"0"+A:A,S=S<10?"0"+S:S,$=$<10?"0"+$:$;const L=w.getTime()-s,I=L>0?Math.min(100,k/L*100):100;d&&(d.textContent=`${A}:${S}:${$}`),l&&(l.style.width=`${I}%`),l&&(l.style.background="var(--primary)")}else{o&&(o.style.display="none"),r&&(r.style.display="block");const A=Math.abs(v-w.getTime());let S=Math.floor(A/(1e3*60*60)),$=Math.floor(A/(1e3*60)%60),L=Math.floor(A/1e3%60);S=S<10?"0"+S:S,$=$<10?"0"+$:$,L=L<10?"0"+L:L,c&&(c.textContent=`+ ${S}:${$}:${L}`),i&&(i.style.color="#c2410c"),m&&(m.textContent="Total Elapsed (Overtime)",m.style.color="#c2410c")}},1e3),!e&&window.AppActivity&&window.AppActivity.start&&window.AppActivity.start()}else i&&(i.textContent="00 : 00 : 00",i.style.color=""),m&&(m.textContent="Elapsed Time",m.style.color=""),o&&(o.style.display="none"),r&&(r.style.display="none")})()}window.getLocation=function(){return new Promise((e,t)=>{(async()=>{const a=window.location&&window.location.hostname?window.location.hostname:"",s=a==="localhost"||a==="127.0.0.1"||a==="::1";if(!window.isSecureContext&&!s){t("Location requires HTTPS on mobile. Open this app using an HTTPS URL and allow location access.");return}const i=Date.now();if($e&&i-Ue<Aa){console.log("Using cached location (freshness: "+(i-Ue)+"ms)"),e($e);return}if(!navigator.geolocation){t("Geolocation is not supported by your browser.");return}try{if(navigator.permissions&&navigator.permissions.query){const r=await navigator.permissions.query({name:"geolocation"});if(r&&r.state==="denied"){t("Location permission is blocked. Enable location for this site in browser settings and try again.");return}}}catch{}const o=r=>new Promise((d,l)=>{navigator.geolocation.getCurrentPosition(d,l,r)});try{console.log("Requesting Location: High Accuracy (GPS)...");const r=await o({enableHighAccuracy:!0,timeout:1e4,maximumAge:5e3}),d={lat:r.coords.latitude,lng:r.coords.longitude};$e=d,Ue=Date.now(),e(d)}catch(r){console.warn("High Accuracy Failed:",r.message);try{console.log("Requesting Location: Low Accuracy (Fallback)...");const d=await o({enableHighAccuracy:!1,timeout:15e3,maximumAge:1e4}),l={lat:d.coords.latitude,lng:d.coords.longitude};$e=l,Ue=Date.now(),e(l)}catch(d){console.error("Low Accuracy Failed:",d.message);let l="Unable to retrieve location.";d.code===1?l="Location permission denied.":d.code===2?l="Location unavailable. Ensure GPS/Location Services are turned on.":d.code===3&&(l="Location request timed out. Move to open sky or better network and try again."),t(l)}}})().catch(a=>{t(a&&a.message?a.message:"Unable to retrieve location.")})})};const re=n=>/^\d{4}-\d{2}-\d{2}$/.test(String(n||"")),ds={january:0,february:1,march:2,april:3,may:4,june:5,july:6,august:7,september:8,october:9,november:10,december:11},ls=(n="")=>{const e=String(n||"").trim();if(!e)return null;const t=e.match(/(\d{1,2})\s*-\s*(\d{1,2})\s+([A-Za-z]+)\s+(\d{4})/);if(!t)return null;const a=Number(t[1]),s=Number(t[2]),i=String(t[3]||"").toLowerCase(),o=Number(t[4]),r=ds[i];if(!Number.isInteger(a)||!Number.isInteger(s)||!Number.isInteger(r)||!Number.isInteger(o))return null;const d=new Date(o,r,a),l=new Date(o,r,s);if(Number.isNaN(d.getTime())||Number.isNaN(l.getTime()))return null;const c=`${d.getFullYear()}-${String(d.getMonth()+1).padStart(2,"0")}-${String(d.getDate()).padStart(2,"0")}`,m=`${l.getFullYear()}-${String(l.getMonth()+1).padStart(2,"0")}-${String(l.getDate()).padStart(2,"0")}`;return m<c?null:{startDate:c,endDate:m}},Ta=(n,e,t=null)=>{const a=re(e)?String(e):null,s=n?.startDate,i=n?.endDate,o=!re(s)&&!re(i)?ls(n?.task||""):null;let r=re(s)?String(s):o?.startDate||a,d=re(i)?String(i):o?.endDate||r||a;if((!re(s)||!re(i))&&n?.sourcePlanId&&t?.workPlans){const l=(t.workPlans||[]).find(u=>u.id===n.sourcePlanId),c=Number.isInteger(n.sourceTaskIndex)?n.sourceTaskIndex:Number(n.sourceTaskIndex),m=l&&Array.isArray(l.plans)&&Number.isInteger(c)?l.plans[c]:null;if(m){const u=re(m.startDate)?m.startDate:l.date||r,p=re(m.endDate)?m.endDate:m.startDate||l.date||d;re(s)||(r=u),re(i)||(d=p)}}return r&&d&&d<r?{startDate:r,endDate:r}:{startDate:r,endDate:d}},Ia=(n,e,t,a=null)=>{const{startDate:s,endDate:i}=Ta(n,e,a);return!s||!i?e===t:!(t<s||t>i||n?.completedDate&&n.completedDate<t)};window.app_getDayEvents=(n,e,t={})=>{const a=t.includeAuto!==!1,s=t.dedupe!==!1,i=t.userId||null;if(!e)return[];if(Array.isArray(e))return e.filter(l=>l.date===n);const o=new Date(n),r=[];if(a&&window.AppAnalytics){const l=window.AppAnalytics.getDayType(o);l==="Holiday"?r.push({title:"Company Holiday (Weekend)",type:"holiday",date:n}):l==="Half Day"&&r.push({title:"Half Working Day (Sat)",type:"event",date:n})}if((e.leaves||[]).forEach(l=>{n>=l.startDate&&n<=l.endDate&&r.push({title:`${l.userName||"Staff"} (Leave)`,type:"leave",userId:l.userId,date:n})}),(e.events||[]).forEach(l=>{l.date===n&&r.push({title:l.title,type:l.type||"event",date:n})}),(e.workPlans||[]).forEach(l=>{if(l.date>n)return;const m=(Array.isArray(l.plans)?l.plans:[]).filter(h=>Ia(h,l.date,n,e));if(!m.length)return;const f=`${(l.planScope||"personal")==="annual"?"All Staff (Annual)":l.userName||"Staff"}: ${m.map(h=>h.task).join("; ")}`;r.push({title:f,type:"work",userId:l.userId,plans:m,date:n,planScope:l.planScope||"personal"})}),i){const l=[];r.forEach(c=>{if(c.type!=="work"){l.push(c);return}if((c.planScope||"").toLowerCase()==="annual"){l.push(c);return}if(c.userId===i){l.push(c);return}if(Array.isArray(c.plans)&&c.plans.some(u=>Array.isArray(u.tags)&&u.tags.some(p=>p.id===i&&p.status==="accepted"))){l.push(c);return}}),r.length=0,r.push(...l)}if(!s)return r;const d=new Set;return r.filter(l=>{const c=l.type||"event";if(c!=="holiday"&&c!=="event")return!0;const m=`${c}|${l.title||""}|${l.userId||""}|${l.date||n}`;return d.has(m)?!1:(d.add(m),!0)})};const Mt=(n,e)=>{const t=String(n??"").trim();return!t||t==="undefined"||t==="null"?e:t},K=n=>String(n??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;"),de=n=>String(n??"").replace(/\\/g,"\\\\").replace(/'/g,"\\'"),mt=n=>{const e=String(n||"").trim();if(!e)return"";if(/^\d{4}-\d{2}-\d{2}$/.test(e))return e;const t=new Date(e);return Number.isNaN(t.getTime())?"":`${t.getFullYear()}-${String(t.getMonth()+1).padStart(2,"0")}-${String(t.getDate()).padStart(2,"0")}`},ft=(n,e)=>{const t=mt(n);if(!t)return"NA";const a=t.replace(/-/g,""),s=String(e||"").replace(/[^a-zA-Z0-9]/g,"").toUpperCase().slice(-3)||"USR";return`EMP-${a}-${s}`},Ee=(n,e="NA")=>{if(n==null||n==="")return e;const t=n instanceof Date?n:new Date(n);return Number.isNaN(t.getTime())?e:t.toLocaleDateString("en-GB")},cs=(n,e="NA")=>{if(n==null||n==="")return e;const t=n instanceof Date?n:new Date(n);return Number.isNaN(t.getTime())?e:t.toLocaleString("en-GB")},ps=n=>`Rs ${Number(n||0).toLocaleString("en-IN")}`,us=(n="")=>{const e=String(n||"").replace(/\s+/g," ").trim();return e?e.length>72?`${e.slice(0,72)}...`:e:"New task"},Et=()=>`
        <div class="no-tags-placeholder day-plan-no-tags-placeholder">
            <p class="day-plan-no-tags-text">No collaborators yet</p>
        </div>
    `,La=(n,e,t="pending")=>`
        <div class="tag-chip day-plan-tag-chip" data-id="${K(n)}" data-name="${K(e)}" data-status="${K(t)}">
            <span class="day-plan-tag-main">@${K(e)} <span class="day-plan-tag-pending">(${K(t)})</span></span>
            <i class="fa-solid fa-times day-plan-remove-collab-btn" onclick="window.app_removeTagHint(this)"></i>
        </div>
    `;window.app_refreshPlanBlockSummary=n=>{if(!n)return;const e=n.querySelector(".plan-task"),t=n.querySelector(".day-plan-task-summary"),a=n.querySelector(".plan-scope"),s=n.querySelector(".day-plan-scope-pill"),i=us(e?e.value:"");t&&(t.textContent=i),s&&a&&(s.textContent=a.value==="annual"?"Annual Plan":"Personal Plan")};window.app_togglePlanBlockCollapse=n=>{const e=n.closest(".plan-block");if(!e)return;e.classList.toggle("is-collapsed");const t=e.classList.contains("is-collapsed"),a=n.querySelector("i");a&&(a.classList.toggle("fa-chevron-down",!t),a.classList.toggle("fa-chevron-up",t));const s=n.querySelector(".day-plan-collapse-label");s&&(s.textContent=t?"Expand":"Minimize"),window.app_refreshPlanBlockSummary(e)};window.app_toggleTaskCollaborator=(n,e,t)=>{const a=n.closest(".plan-block");if(!a)return;const s=a.querySelector(".tags-container");if(!s)return;const i=typeof CSS<"u"&&CSS.escape?CSS.escape(e):e.replace(/"/g,'\\"'),o=s.querySelector(`[data-id="${i}"]`);if(o)o.remove(),n.classList.remove("selected");else{const r=s.querySelector(".no-tags-placeholder");r&&r.remove(),s.insertAdjacentHTML("beforeend",La(e,t,"pending")),n.classList.add("selected")}s.querySelectorAll(".tag-chip").length===0&&(s.innerHTML=Et())};window.app_getAnnualDayStaffPlans=n=>{const e=window._currentPlans||{},t=window._annualUserMap||{},s=(e.workPlans||[]).filter(r=>r.date<=n).map(r=>{const d=t[r.userId]||r.userName||"Staff",l=new Map,c=f=>String(f||"").toLowerCase().replace(/\d{1,2}\s*-\s*\d{1,2}\s+[a-z]+\s+\d{4}/g," ").replace(/\([^)]*\)/g," ").replace(/[^a-z\s]/g," ").split(/\s+/).filter(Boolean).slice(0,8).join(" "),m=(f,h="")=>{const y=String(f).trim();if(!y)return;const w=c(y)||y.toLowerCase().replace(/\s+/g," "),b=`${y}${h||""}`;if(!l.has(w)){l.set(w,b);return}(l.get(w)||"")===y&&b!==y&&l.set(w,b)},u=(Array.isArray(r.plans)?r.plans:[]).filter(f=>Ia(f,r.date,n,e)).map(f=>{const{startDate:h,endDate:y}=Ta(f,r.date,e),w=!!(h&&y&&h!==y),b=y===n,v=h===n,g=f.completedDate&&f.completedDate<y&&f.completedDate===n?" (Completed Early)":w&&b?" (Ends Today)":w&&v?" (Starts Today)":"";return m(f.task||"Planned task",g),""}).filter(Boolean),p=Array.from(l.values());return!p.length&&u.length?{name:d,tasks:u}:p.length?{name:d,tasks:p}:null}).filter(Boolean),i=r=>String(r||"").toLowerCase().replace(/\d{1,2}\s*-\s*\d{1,2}\s+[a-z]+\s+\d{4}/g," ").replace(/\([^)]*\)/g," ").replace(/[^a-z\s]/g," ").split(/\s+/).filter(Boolean).slice(0,8).join(" "),o=new Map;return s.forEach(r=>{const d=r.name||"Staff";o.has(d)||o.set(d,new Map);const l=o.get(d);(r.tasks||[]).forEach(c=>{const m=i(c)||String(c||"").toLowerCase();if(!l.has(m))l.set(m,c);else{const u=l.get(m)||"",p=String(c||"");u.length<p.length&&l.set(m,p)}})}),Array.from(o.entries()).map(([r,d])=>({name:r,tasks:Array.from(d.values())}))};window.app_showAnnualHoverPreview=(n,e)=>{const t="annual-hover-preview";document.getElementById(t)?.remove();const a=window.app_getAnnualDayStaffPlans(e),s=a.length?a.map(o=>`
            ...
            </div>`;window.app_showModal(s,e)};window.app_addPlanBlockUI=async()=>{const n=document.getElementById("plans-container");if(!n)return;const e=await window.AppDB.getAll("users"),t=window.AppAuth.getUser(),a=t.role==="Administrator"||t.isAdmin,s=Mt(window.app_currentDayPlanTargetId,t.id),i=n.dataset.defaultScope==="annual"?"annual":"personal",r=e.filter(f=>f.id!==s).map(f=>`
            <button
                type="button"
                class="day-plan-collab-option"
                data-id="${K(f.id)}"
                onclick="window.app_toggleTaskCollaborator(this, '${de(f.id)}', '${de(f.name)}')"
                title="Add or remove ${K(f.name)}"
            >${K(f.name)}</button>
        ...
        <div class="modal-content checkout-action-detail-content">
            ...
            <div class="checkout-task-panel-body">
                ...
                <div class="checkout-task-field">
                    ...
                    <input type="range" min="0" max="100" value="${e.progressPercent}" data-progress-input oninput="window.app_updateCheckoutTaskProgress('${de(n)}', this.value)">
                </div>
                <div class="checkout-task-field">
                    <label>Status</label>
                ...
                <div class="checkout-task-field">
                    <label>Note</label>
                    <textarea rows="2" data-progress-note placeholder="What changed? (optional)" oninput="window.app_updateCheckoutTaskNote('${de(n)}', this.value)">${p}</textarea>
                </div>
                <div class="checkout-task-action-extra" data-action-panel-section="complete" style="display:${e.action==="complete"?"block":"none"};">
                    ...
                    <textarea rows="2" data-action-field="completionNote" placeholder="Optional details for completion." oninput="window.app_updateCheckoutTaskActionMeta('${de(n)}','completionNote', this.value)">${c}</textarea>
                </div>
                <div class="checkout-task-action-extra" data-action-panel-section="postpone" style="display:${e.action==="postpone"?"block":"none"};">
                    <label>New Date</label>
                    <input type="date" data-action-field="postponeDate" value="${d}" onchange="window.app_updateCheckoutTaskActionMeta('${de(n)}','postponeDate', this.value)">
                    <label>Reason</label>
                    <textarea rows="2" data-action-field="postponeReason" placeholder="Why postponed?" oninput="window.app_updateCheckoutTaskActionMeta('${de(n)}','postponeReason', this.value)">${l}</textarea>
                </div>
                <div class="checkout-task-action-extra" data-action-panel-section="delegate" style="display:${e.action==="delegate"?"block":"none"};">
                    <label>Assign To</label>
                    <select data-action-field="delegateUserId" onchange="window.app_updateCheckoutTaskActionMeta('${de(n)}','delegateUserId', this.value)">
                        <option value="">Select staff</option>
                        ${f}
                    </select>
                    <label>Handoff Note</label>
                    <textarea rows="2" data-action-field="delegateNote" placeholder="Handoff context (optional)." oninput="window.app_updateCheckoutTaskActionMeta('${de(n)}','delegateNote', this.value)">${m}</textarea>
                </div>
    ...
    `,document.body.appendChild(h),window.app_syncCheckoutTaskPanel(n)};window.app_renderCheckoutActionPreview=()=>{const n=document.getElementById("checkout-action-preview"),e=document.getElementById("checkout-action-preview-list");if(!n||!e)return;const t=window.app_checkoutTaskDetails||{},a=window.app_checkoutTaskMeta||{},s=window.app_checkoutUserMap||{},i=Object.keys(t).map(o=>{const r=t[o];if(!r||!r.action)return null;const l=(a[o]||{}).text||"Task",c=r.action==="complete"?"Complete":r.action==="postpone"?"Postpone":r.action==="delegate"?"Delegate":r.action,m=ot[r.progressStatus]||"Waiting",u=String(r.progressNote||"").trim();let p="";if(r.action==="postpone"){const f=mt(r.actionMeta?.postponeDate)||"—",h=String(r.actionMeta?.postponeReason||"").trim();p=`New date: ${K(f)}${h?` • Reason: ${K(h)}`:""}`}if(r.action==="delegate"){const f=String(r.actionMeta?.delegateUserId||""),h=s[f]||"—",y=String(r.actionMeta?.delegateNote||"").trim();p=`Assigned to: ${K(h)}${y?` • Note: ${K(y)}`:""}`}if(r.action==="complete"){const f=String(r.actionMeta?.completionNote||"").trim();p=f?`Completion note: ${K(f)}`:""}return`
            <div class="checkout-action-preview-item">
                <div class="checkout-action-preview-title">${K(l)}</div>
                <div class="checkout-action-preview-meta">
                    <span class="checkout-action-preview-chip">${K(c)}</span>
                    <span>${r.progressPercent}% • ${K(m)}</span>
                </div>
                ${u?`<div class="checkout-action-preview-note">${K(u)}</div>`:""}
                ${p?`<div class="checkout-action-preview-extra">${p}</div>`:""}
            </div>
        `}).filter(Boolean);if(i.length===0){n.style.display="none",e.innerHTML="";return}n.style.display="block",e.innerHTML=i.join("")};window.app_applyCheckoutTaskUpdates=async(n=[])=>{if(!Array.isArray(n)||n.length===0)return;const e=window.AppAuth.getUser(),t=e?.id||e?.name||"staff",a=new Date().toISOString().split("T")[0];for(const s of n){const i=await window.AppDB.get("work_plans",s.planId).catch(()=>null);if(!i||!Array.isArray(i.plans))continue;const o=i.plans[s.taskIndex];if(o){if(o.progressPercent=s.progressPercent,o.progressStatus=s.progressStatus,o.progressNote=s.progressNote,o.lastProgressUpdateAt=s.timestamp,o.lastProgressUpdateBy=t,o.lastCheckoutAction=s.action,s.action==="complete"&&(o.status="completed",o.completedDate||(o.completedDate=a)),s.action==="postpone"&&(o.status="postponed"),i.updatedAt=new Date().toISOString(),await window.AppDB.put("work_plans",i),s.action==="postpone"){const r=mt(s.actionMeta?.postponeDate);if(r){const d=o.subPlans&&o.subPlans.length?` - ${o.subPlans.join(", ")}`:"",l=`${o.task}${d}`,c=i.date||a,u=`${l.replace(/\s*\(Postponed from [^)]+\)\s*$/i,"")} (Postponed from ${c})`;await window.AppCalendar.addWorkPlanTask(r,e.id,u,[],{addedFrom:"postponed",sourcePlanId:s.planId,sourceTaskIndex:s.taskIndex,postponedFromDate:c})}}if(s.action==="delegate"){const r=String(s.actionMeta?.delegateUserId||"").trim();r&&await window.app_delegateTo(s.planId,s.taskIndex,r)}}}window.AppStore&&window.AppStore.invalidatePlans&&window.AppStore.invalidatePlans()};window.app_deleteDayPlan=async(n,e=null,t=null)=>{if(!await window.appConfirm("Are you sure you want to delete this work plan?"))return;const a=window.AppAuth.getUser(),s=Mt(e,a.id);try{t==="personal"||t==="annual"?await window.AppCalendar.deleteWorkPlan(n,s,{planScope:t}):await Promise.all([window.AppCalendar.deleteWorkPlan(n,s,{planScope:"personal"}),window.AppCalendar.deleteWorkPlan(n,s,{planScope:"annual"})]),window.AppStore&&window.AppStore.invalidatePlans&&window.AppStore.invalidatePlans(),alert("Plan deleted!"),document.getElementById("day-plan-modal")?.remove();const o=await R.renderDashboard(),r=document.getElementById("page-content");r&&(r.innerHTML=o,window.setupDashboardEvents&&window.setupDashboardEvents())}catch(i){alert(i.message)}};window.app_saveDayPlan=async(n,e,t=null)=>{n.preventDefault();const a=window.AppAuth.getUser(),s=Mt(t,a.id),i=n.target,o=i?.dataset?.hadPersonal==="1",r=i?.dataset?.hadAnnual==="1",d=document.querySelectorAll(".plan-block"),l=[],c=[],m=[],u={};let p="";if(d.forEach(f=>{const h=f.querySelector(".plan-task").value.trim(),y=f.querySelectorAll(".sub-plan-input"),w=Array.from(y).map(D=>D.value.trim()).filter(D=>D!==""),b=f.querySelectorAll(".tag-chip"),v=Array.from(b).map(D=>({id:D.dataset.id,name:D.dataset.name,status:D.dataset.status||"pending"})),k=f.querySelector(".plan-status").value,g=f.querySelector(".plan-assignee"),A=g?g.value:s,S=f.querySelector(".plan-start-date"),$=f.querySelector(".plan-end-date"),L=S?String(S.value||"").trim():"",I=$?String($.value||"").trim():"",B=f.querySelector(".plan-scope"),E=B&&B.value==="annual"?"annual":"personal";if(h){if(L&&!I||!L&&I){p="Please select both From Date and To Date for ranged tasks.";return}if(L&&I&&I<L){p="To Date cannot be earlier than From Date.";return}const U={task:h,subPlans:w,tags:v,status:k||null,assignedTo:A||null,startDate:L||e,endDate:I||e,planScope:E,completedDate:k==="completed"?new Date().toISOString().split("T")[0]:null};l.push(U),E==="annual"?m.push(U):c.push(U)}}),l.length===0){alert(p||"Please add at least one task.");return}if(p){alert(p);return}try{c.length>0?(await window.AppCalendar.setWorkPlan(e,c,s,{planScope:"personal"}),u.personal=window.AppCalendar.getWorkPlanId(e,s,"personal")):o&&await window.AppCalendar.deleteWorkPlan(e,s,{planScope:"personal"}),m.length>0?(await window.AppCalendar.setWorkPlan(e,m,s,{planScope:"annual"}),u.annual=window.AppCalendar.getWorkPlanId(e,s,"annual")):r&&await window.AppCalendar.deleteWorkPlan(e,s,{planScope:"annual"}),window.AppStore&&window.AppStore.invalidatePlans&&window.AppStore.invalidatePlans();const f=await window.AppDB.getAll("users");if(s!==a.id&&(a.role==="Administrator"||a.isAdmin)){const b=f.find(v=>v.id===s);if(b){b.notifications||(b.notifications=[]);const v=b.notifications[b.notifications.length-1];(!v||v.message!==`Admin ${a.name} has edited your Work Plan for ${e}`)&&(b.notifications.push({type:"admin_edit",message:`Admin ${a.name} has edited your Work Plan for ${e}`,date:new Date().toLocaleString(),read:!1}),await window.AppDB.put("users",b))}}const h=new Set;if(l.forEach(b=>{b.tags&&b.tags.forEach(v=>h.add(v.id))}),h.size>0){for(const b of h){const v=f.find(k=>k.id===b);v&&b!==a.id&&(v.notifications||(v.notifications=[]),l.forEach((k,g)=>{if(k.tags&&k.tags.some(A=>A.id===b)){const A=k.planScope==="annual"?"annual":"personal",S=u[A]||window.AppCalendar.getWorkPlanId(e,s,A);v.notifications.some(L=>L.type==="mention"&&L.planId===S&&L.taskIndex===g)||v.notifications.push({id:`tag_${Date.now()}_${b}_${g}`,type:"tag",title:k.task||"Tagged task",description:k.subPlans&&k.subPlans.length>0?k.subPlans.join(", "):"",taggedById:a.id,taggedByName:a.name,taggedAt:new Date().toISOString(),status:"pending",source:"plan",planId:S,taskIndex:g,message:`${a.name} tagged you in: "${k.task}" for ${e}`,date:new Date().toLocaleString(),read:!1})}}),await window.AppDB.put("users",v))}for(let b=0;b<l.length;b++){const v=l[b];if(v.tags)for(const k of v.tags){if(k.id===s)continue;const g=f.find(I=>I.id===k.id);if(!g||!window.AppCalendar)continue;const A=v.planScope==="annual"?"annual":"personal",S=u[A]||window.AppCalendar.getWorkPlanId(e,s,A),$=v.subPlans&&v.subPlans.length>0?` - ${v.subPlans.join(", ")}`:"",L=`${v.task}${$} (Responsible: ${g.name})`;await window.AppCalendar.addWorkPlanTask(e,g.id,L,[{id:a.id,name:a.name,status:"pending"}],{addedFrom:"tag",sourcePlanId:S,sourceTaskIndex:b,taggedById:a.id,taggedByName:a.name,status:"pending",subPlans:v.subPlans||[],startDate:v.startDate||e,endDate:v.endDate||v.startDate||e})}}}alert("Plans saved successfully!"),document.getElementById("day-plan-modal")?.remove();const y=await R.renderDashboard(),w=document.getElementById("page-content");w&&(w.innerHTML=y,window.setupDashboardEvents&&window.setupDashboardEvents())}catch(f){alert(f.message)}};window.app_handleTagResponse=async(n,e,t,a)=>{const s=window.AppAuth.getUser();try{const i=n?await window.AppDB.get("work_plans",n).catch(()=>null):null;if(!i||!i.plans||!i.plans[e]){console.warn(`app_handleTagResponse: plan/task not found for planId=${n}, taskIdx=${e}. Falling back to notification-only update.`);const c=await window.AppDB.get("users",s.id).catch(()=>null),m=c?.notifications?.[a]?.id||null;if(m||a>=0)await window.app_handleTagDecision(m||String(a),t);else{if(c?.notifications?.[a]){const p=new Date().toISOString();c.notifications[a].status=t,c.notifications[a].respondedAt=p,c.notifications[a].read=!0,c.notifications[a].dismissedAt=p,await window.AppDB.put("users",c)}const u=document.getElementById("page-content");u&&(u.innerHTML=await R.renderDashboard(),window.setupDashboardEvents&&window.setupDashboardEvents()),alert(`You have ${t} the request.`)}return}const o=i.plans[e];if(o.tags){const c=o.tags.find(m=>m.id===s.id);c&&(c.status=t)}await window.AppDB.put("work_plans",i);const r=await window.AppDB.get("users",s.id);let d="";if(t==="rejected"&&(d=await window.appPrompt("Optional: add a rejection reason","",{title:"Reject Task",confirmText:"Submit Reason"})||""),r&&r.notifications){const c=r.notifications[a];if(c){const m=new Date().toISOString();c.status=t,c.respondedAt=m,c.read=!0,c.dismissedAt=m,d&&(c.rejectReason=d)}r.tagHistory||(r.tagHistory=[]),r.tagHistory.unshift({id:`taghist_${Date.now()}`,type:"tag_response",title:c?.title||i.plans[e].task||"Tagged task",taggedByName:c?.taggedByName||i.userName||"Staff",status:t,reason:d,date:new Date().toISOString()}),await window.AppDB.put("users",r)}if(i.userId){const c=await window.AppDB.get("users",i.userId);c&&(c.notifications||(c.notifications=[]),c.notifications.unshift({id:`tagresp_${Date.now()}`,type:"tag_response",message:`${s.name} ${t} your tag request.`,title:i.plans[e].task,taggedByName:s.name,status:t,reason:d,date:new Date().toISOString(),read:!1}),await window.AppDB.put("users",c))}window.AppStore&&window.AppStore.invalidatePlans&&window.AppStore.invalidatePlans();const l=document.getElementById("page-content");l&&(l.innerHTML=await R.renderDashboard(),window.setupDashboardEvents&&window.setupDashboardEvents()),alert(`You have ${t} the collaboration request.`)}catch(i){console.error("app_handleTagResponse error:",i),alert("Error processing your response. Please try again.")}};window.app_changeCalMonth=n=>{let e=window.app_calMonth+n;e<0&&(window.app_calYear--,e=11),e>11&&(window.app_calYear++,e=0),window.app_calMonth=e,R.renderDashboard().then(async t=>{const a=document.getElementById("page-content");a.innerHTML=t,ue()})};window.app_exportCalendar=async()=>{const n=window._currentPlans,e=window.app_calMonth,t=window.app_calYear;if(!n){alert("Calendar data not loaded yet.");return}try{await window.AppReports.exportCalendarPlansCSV(n,e,t)}catch(a){alert("Export failed: "+a.message)}};window.app_newMeeting=async()=>{const n=window.AppAuth.getUser(),e={id:"meeting_"+Date.now(),title:"",date:new Date().toISOString().split("T")[0],minutes:"",author:n.name,timestamp:new Date().toISOString()};await window.AppDB.put("meetings",e),window._selectedMeetingId=e.id;const t=document.getElementById("page-content");t.innerHTML=await R.renderMinutes()};window.app_selectMeeting=async n=>{window._selectedMeetingId=n;const e=document.getElementById("page-content");e.innerHTML=await R.renderMinutes()};window.app_saveMeeting=async()=>{const n=document.getElementById("meeting-title")?.value,e=document.getElementById("meeting-date")?.value,t=document.getElementById("meeting-minutes")?.value;if(!window._selectedMeetingId){alert("No meeting selected");return}const a=await window.AppDB.get("meetings",window._selectedMeetingId);if(!a){alert("Meeting not found");return}a.title=n,a.date=e,a.minutes=t,a.timestamp=new Date().toISOString(),await window.AppDB.put("meetings",a);const s=document.getElementById("page-content");s.innerHTML=await R.renderMinutes(),alert("Meeting minutes saved successfully!")};window.app_deleteMeeting=async n=>{if(!await window.appConfirm("Are you sure you want to delete this meeting?"))return;await window.AppDB.delete("meetings",n),window._selectedMeetingId=null;const e=document.getElementById("page-content");e.innerHTML=await R.renderMinutes()};window.app_postponeTask=async(n,e,t)=>{if(t)try{const a=window.AppAuth.getUser();await window.AppCalendar.updateTaskStatus(n,e,"postponed");const s=await window.AppDB.get("work_plans",n),i=s?.plans?.[e],o=i&&i.subPlans&&i.subPlans.length?` - ${i.subPlans.join(", ")}`:"",r=i?`${i.task}${o}`:"",d=s?.date||new Date().toISOString().split("T")[0],c=`${r.replace(/\s*\(Postponed from [^)]+\)\s*$/i,"")} (Postponed from ${d})`;await window.AppCalendar.addWorkPlanTask(t,a.id,c,[],{addedFrom:"postponed",sourcePlanId:n,sourceTaskIndex:e,postponedFromDate:d}),window.AppStore&&window.AppStore.invalidatePlans&&window.AppStore.invalidatePlans(),alert(`Task postponed to ${t}`),typeof Ae=="function"&&await Ae()}catch(a){alert("Failed to postpone task: "+a.message)}};window.app_openPostponeModal=function(n,e){const t="postpone-task-modal";document.getElementById(t)?.remove();const a=new Date(Date.now()+864e5).toISOString().split("T")[0],s=`
...
Available: ${a}`,"",{title:"Delegate Task",placeholder:"Type staff name"});if(!s)return;const i=t.find(o=>o.name.toLowerCase()===s.toLowerCase());if(!i){alert("Staff not found.");return}await window.app_delegateTo(n,e,i.id)}catch(t){alert("Failed to delegate task: "+t.message)}};window.app_delegateTo=async function(n,e,t){try{const a=await window.AppDB.get("work_plans",n);if(!a||!a.plans||!a.plans[e]){alert("Task not found.");return}const s=window.AppAuth.getUser(),i=a.plans[e],o=i.subPlans&&i.subPlans.length?` — ${i.subPlans.join(", ")}`:"",r=`${i.task}${o}`;i.tags||(i.tags=[]);const l=(await window.AppDB.getAll("users")).find(m=>m.id===t);if(!l){alert("Staff not found.");return}i.tags.some(m=>m.id===l.id)||i.tags.push({id:l.id,name:l.name,status:"pending"}),i.status=i.status||"pending",a.updatedAt=new Date().toISOString(),await window.AppDB.put("work_plans",a),await window.AppCalendar.addWorkPlanTask(a.date,l.id,r,[{id:s.id,name:s.name,status:"pending"}],{addedFrom:"delegated",sourcePlanId:n,sourceTaskIndex:e,taggedById:s.id,taggedByName:s.name,status:"pending",subPlans:i.subPlans||[]});const c=await window.AppDB.get("users",l.id);c&&(c.notifications||(c.notifications=[]),c.notifications.unshift({id:`task_${Date.now()}`,type:"task",title:i.task||"Delegated task",description:i.subPlans&&i.subPlans.length>0?i.subPlans.join(", "):"",taggedById:s.id,taggedByName:s.name,taggedAt:new Date().toISOString(),status:"pending",source:"delegation",date:new Date().toLocaleString(),read:!1}),await window.AppDB.put("users",c)),window.AppStore&&window.AppStore.invalidatePlans&&window.AppStore.invalidatePlans(),alert(`Task delegated to ${l.name}.`),typeof Ae=="function"&&await Ae()}catch(a){alert("Failed to delegate task: "+a.message)}};function Ma(n,e,t,a){if(!n||!e||!t||!a)return 0;const s=6371e3,i=n*Math.PI/180,o=t*Math.PI/180,r=(t-n)*Math.PI/180,d=(a-e)*Math.PI/180,l=Math.sin(r/2)*Math.sin(r/2)+Math.cos(i)*Math.cos(o)*Math.sin(d/2)*Math.sin(d/2),c=2*Math.atan2(Math.sqrt(l),Math.sqrt(1-l));return s*c}const Ea=480*60*1e3,ms=540*60*1e3,Kt=(n,e)=>{if(!n||!e)return null;const t=String(n).trim(),a=String(e).trim();if(!t||!a||a.toLowerCase().includes("active now"))return null;const s=new Date(`${t}T${a}`);if(!Number.isNaN(s.getTime()))return s;const i=new Date(`${t} ${a}`);return Number.isNaN(i.getTime())?null:i},fs=async(n,e,t)=>{if(!n||!window.AppDB||t<=e)return!1;const a=await window.AppDB.getAll("attendance"),s=String(n);return(a||[]).some(i=>{if(!i||String(i.user_id||"")!==s||!i.isManualOverride)return!1;const o=Kt(i.date,i.checkIn),r=Kt(i.date,i.checkOut);if(!o||!r)return!1;let d=o.getTime(),l=r.getTime();l<=d&&(l+=1440*60*1e3);const c=Math.max(e,d);return Math.min(t,l)>c})},ys=async n=>{const e={showPrompt:!1,hasManualLog:!1,overtimeStartMs:null,overtimeEndMs:null};if(!n||!n.lastCheckIn)return e;const t=Number(n.lastCheckIn);if(!Number.isFinite(t))return e;const a=Date.now();if(a-t<=ms)return e;const i=t+Ea;return await fs(n.id,i,a)?{showPrompt:!1,hasManualLog:!0,overtimeStartMs:i,overtimeEndMs:a}:{showPrompt:!0,hasManualLog:!1,overtimeStartMs:i,overtimeEndMs:a}};window.app_prepareCheckoutOvertimeSection=async n=>{const e=document.getElementById("checkout-overtime-section"),t=document.getElementById("checkout-overtime-explanation"),a=document.getElementById("checkout-overtime-mode"),s=document.getElementById("checkout-overtime-hint");if(window.app_checkoutOvertimeState={showPrompt:!1,hasManualLog:!1},!(!e||!t||!a)){e.style.display="none",t.required=!1,t.value="",a.value="overtime_work",document.querySelectorAll(".overtime-reason-btn").forEach(i=>{i.style.background="#fef3c7",i.style.borderColor="#fcd34d",i.style.color="#92400e"});try{const i=await ys(n);if(window.app_checkoutOvertimeState=i,!i.showPrompt)return;s&&(s.textContent="You worked over 1 hour extra. Please capture what was done during overtime."),e.style.display="block",t.required=!0}catch(i){console.warn("Overtime prompt check failed:",i)}}};async function Ae(){const n=document.getElementById("attendance-btn"),e=document.getElementById("location-text"),{status:t}=await window.AppAttendance.getStatus();n&&(n.disabled=!0),je=!0;try{if(t==="out"){n&&(n.innerHTML='<i class="fa-solid fa-spinner fa-spin"></i> Locating...');const a=await window.getLocation(),s=`Lat: ${a.lat.toFixed(4)}, Lng: ${a.lng.toFixed(4)}`;e&&(e.innerHTML=`<i class="fa-solid fa-location-dot"></i> ${s}`);const i=await window.AppAttendance.checkIn(a.lat,a.lng,s);if(i&&i.conflict){window.app_showSyncToast(i.message||"Status updated from another device."),window.app_refreshDashboard&&await window.app_refreshDashboard();return}$t(),window.app_refreshDashboard&&await window.app_refreshDashboard(),i&&i.resolvedMissedCheckout&&i.noticeMessage&&window.app_showAttendanceNotice(i.noticeMessage),i&&i.missedCheckoutReasonRequired&&i.missedCheckoutLogId&&window.app_promptMissedCheckoutReason({logId:i.missedCheckoutLogId,date:i.missedCheckoutDate}),window.AppDayPlan&&typeof window.AppDayPlan.openDayPlan=="function"&&await window.AppDayPlan.openDayPlan(zt())}else{const a=window.AppAuth.getUser(),s=zt(),i=await window.AppCalendar.getWorkPlan(a.id,s,{includeAnnual:!0,mergeAnnual:!0}),o=await window.AppCalendar.getCollaborations(a.id,s);window.app_checkoutSummaryDate!==s&&(window.app_checkoutSummaryDate=s,window.app_checkoutSummaryDraft=""),window.app_checkoutActionDate!==s&&(window.app_checkoutActionDate=s,window.app_checkoutTaskActions={},window.app_checkoutTaskDetails={},window.app_checkoutTaskMeta={},window.app_checkoutUserMap={});const r=document.getElementById("modal-container");r&&!document.getElementById("checkout-modal")&&r.insertAdjacentHTML("beforeend",R.renderModals());const d=document.getElementById("checkout-modal");if(d){const l=document.getElementById("checkout-plan-text"),c=d.querySelector('textarea[name="description"]');if(i&&(i.plans||i.plan)){let p="",f="";if(i.plans&&i.plans.length>0?(p=i.plans.map((k,g)=>`<div style="display:flex; justify-content:space-between; align-items:flex-start; margin-bottom:12px; padding-bottom:12px; border-bottom:1px dashed #e9d5ff;">
                                ...
                                </div>`).join(""),f=i.plans.filter(k=>window.AppCalendar.getSmartTaskStatus(i.date,k.status)==="completed").map(k=>{let g=`• ${k.task}`;return k.subPlans&&k.subPlans.length>0&&(g+=` (${k.subPlans.join(", ")})`),g}).join(`
`)):i.plan&&(p=`<div style="font-weight:600; color:#4c1d95;">${i.plan}</div>`,f=`• ${i.plan}`,i.subPlans&&i.subPlans.length>0&&(p+=`<div style="font-size:0.75rem; color:#7c3aed; margin-top:2px;">👣 ${i.subPlans.join(", ")}</div>`,f+=` (${i.subPlans.join(", ")})`)),o&&o.length>0){const v=o.map(k=>k.plans.filter(g=>g.tags&&g.tags.some(A=>A.id===a.id&&A.status==="accepted")).map(g=>{let A=`🤝 [Collaborated with ${k.userName}] ${g.task}`;return g.subPlans&&g.subPlans.length>0&&(A+=`
👣 Steps: `+g.subPlans.join(", ")),A}).join(`
`)).join(`

`);p?p+=`

`+v:p=v}l&&(l.innerHTML=p),l&&(l.dataset.rawText=f),c&&!c.value.trim()&&window.app_checkoutSummaryDraft&&(c.value=window.app_checkoutSummaryDraft,window.app_updateCharCounter&&window.app_updateCharCounter(c));const h=document.getElementById("checkout-task-list"),y=document.getElementById("delegate-panel"),w=document.getElementById("delegate-list"),b=document.getElementById("delegate-selected-task");if(h)if(i&&Array.isArray(i.plans)&&i.plans.length>0){const v=await window.AppDB.getAll("users").catch(()=>[]);window.app_checkoutUserMap={},(v||[]).forEach(S=>{window.app_checkoutUserMap[String(S.id)]=S.name});const k=window.AppAuth.getUser(),g=(v||[]).filter(S=>S.id!==k.id),A=i.plans.map((S,$)=>{const L=S.subPlans&&S.subPlans.length?` — ${S.subPlans.join(", ")}`:"",I=`${S.task}${L}`,B=S._planId||i.id,E=typeof S._taskIndex=="number"?S._taskIndex:$,D=window.AppCalendar.getSmartTaskStatus(S._planDate||i.date,S.status),M=`${B}:${E}`;window.app_checkoutTaskMeta=window.app_checkoutTaskMeta||{},window.app_checkoutTaskMeta[M]={text:I,planId:B,taskIndex:E};const P=(window.app_checkoutTaskActions&&window.app_checkoutTaskActions[M]?window.app_checkoutTaskActions[M]:"")||(S.status==="completed"||D==="completed"?"complete":S.status==="postponed"?"postpone":""),C=window.app_initCheckoutTaskDetails(B,E,S),O=C.action||P||"";O&&C.action!==O&&(C.action=O,O==="complete"&&(C.progressPercent=100,C.progressStatus="done")),window.app_checkoutTaskActions&&O&&(window.app_checkoutTaskActions[M]=O);const H=D==="completed"?"Completed":D==="in-process"?"In Process":D==="overdue"?"Overdue":D==="to-be-started"?"To Be Started":S.status||"Pending",z=K(C.actionMeta?.postponeDate||new Date(Date.now()+864e5).toISOString().split("T")[0]),G=K(C.actionMeta?.postponeReason||""),T=K(C.actionMeta?.delegateUserId||""),N=K(C.actionMeta?.delegateNote||""),W=K(C.actionMeta?.completionNote||""),V=K(C.progressNote||"");return`
                                        <div class="checkout-task-row">
                                            ...
                                            <div class="checkout-task-controls">
                                                <select onchange="window.app_handleChecklistAction('${B}', ${E}, this.value)" class="checkout-task-action-select">
                                                    <option value="" ${O?"":"selected"}>Choose Action</option>
                                                    <option value="complete" ${O==="complete"?"selected":""}>Complete</option>
                                                    <option value="postpone" ${O==="postpone"?"selected":""}>Postpone</option>
                                                    <option value="delegate" ${O==="delegate"?"selected":""}>Delegate</option>
                                                </select>
                                                <button type="button" class="checkout-task-detail-btn" data-checkout-detail-key="${K(M)}" onclick="window.app_openCheckoutActionModal('${de(M)}')" ${O?"":"disabled"}>Action Details</button>
                                            </div>
                                        </div>`}).join("");if(h.innerHTML=A,window.app_renderCheckoutActionPreview(),y&&w&&b){y.style.display="none";const S=document.getElementById("checkout-task-checklist");S&&S.classList.remove("delegate-open"),w.innerHTML=g.map($=>`
                                        <button type="button" data-user-id="${$.id}" class="delegate-user-btn">
                                            <img src="${$.avatar}" alt="${$.name}" class="delegate-user-avatar">
                                            <span style="flex:1;">${$.name}</span>
                                        </button>
                                    `).join("")}}else h.innerHTML='<div style="font-size:0.8rem; color:#6b7280;">No tasks planned for today.</div>',window.app_renderCheckoutActionPreview()}await window.app_prepareCheckoutOvertimeSection(a),d.style.display="flex",n&&(n.disabled=!1);const m=document.getElementById("checkout-location-mismatch"),u=document.getElementById("checkout-location-loading");u&&(u.style.display="block"),m&&(m.style.display="none"),(async()=>{try{const p=await window.getLocation(),f=a.currentLocation||a.lastLocation;u&&(u.style.display="none"),f&&f.lat&&f.lng&&(Ma(p.lat,p.lng,f.lat,f.lng)>500?m&&(m.style.display="block"):m&&(m.style.display="none"))}catch(p){console.warn("Background location check failed:",p),u&&(u.style.display="none")}})()}else{const l=await window.AppAttendance.checkOut();l&&!l.conflict&&$t(),l&&l.conflict&&window.app_showSyncToast(l.message||"Status updated from another device.");const c=document.getElementById("page-content");c.innerHTML=await R.renderDashboard(),ue()}}}catch(a){alert(a.message||a),n&&(n.disabled=!1,n.innerHTML=t==="out"?'Check-in <i class="fa-solid fa-fingerprint"></i>':'Check-out <i class="fa-solid fa-fingerprint"></i>')}finally{je=!1}}window.app_submitCheckOut=async function(n){n.preventDefault();const e=n.target,t=e.description.value,a=e.querySelector('button[type="submit"]');je=!0;try{a.disabled=!0,a.innerHTML='<i class="fa-solid fa-spinner fa-spin"></i> Locating & Saving...',Object.keys(window.app_checkoutTaskDetails||{}).forEach(k=>window.app_clearCheckoutTaskError(k));const{updates:i,errors:o}=window.app_collectCheckoutTaskUpdates();if(o.length>0){o.forEach(g=>window.app_setCheckoutTaskError(g.key,g.message));const k=o[0]?.key;if(k){const g=document.querySelector(`.checkout-action-detail-modal[data-checkout-key="${ve(k)}"]`);g&&g.scrollIntoView({behavior:"smooth",block:"center"})}a.disabled=!1,a.textContent="Complete Check-Out";return}let r=null,d=null;try{r=await window.getLocation()}catch(k){d=k}let l=!1;const c=window.AppAuth.getUser()?.currentLocation;r&&(r=$e&&Date.now()-Ue<Aa?$e:r,c&&c.lat&&c.lng&&r.lat&&r.lng&&Ma(r.lat,r.lng,c.lat,c.lng)>500&&(l=!0));const m=e.locationExplanation?e.locationExplanation.value.trim():"",u=window.app_checkoutOvertimeState||{},p=e.overtimeExplanation?e.overtimeExplanation.value.trim():"",f=e.overtimeMode?String(e.overtimeMode.value||"overtime_work"):"overtime_work",h={};if(u.showPrompt){if(!p){alert("Please describe the overtime work before checkout."),a.disabled=!1,a.textContent="Complete Check-Out";return}if(h.overtimePrompted=!0,h.overtimeExplanation=p,h.overtimeReasonTag=f,f==="forgot_checkout"){const k=Number(window.AppAuth.getUser()?.lastCheckIn);Number.isFinite(k)&&(h.checkOutTime=new Date(k+Ea).toISOString(),h.overtimeCappedToEightHours=!0)}}if(i.length>0&&(h.taskUpdates=i.map(k=>({planId:k.planId,taskIndex:k.taskIndex,action:k.action,progressPercent:k.progressPercent,progressStatus:k.progressStatus,progressNote:k.progressNote,actionMeta:k.actionMeta||{},timestamp:k.timestamp}))),!r&&!m){const k=document.getElementById("checkout-location-mismatch");k&&(k.style.display="block"),alert("Location unavailable. Please provide a reason for checking out from a different location."),a.disabled=!1,a.textContent="Complete Check-Out";return}const y=r?`Lat: ${Number(r.lat).toFixed(4)}, Lng: ${Number(r.lng).toFixed(4)}`:"Location unavailable (reason provided)",w=e.tomorrowGoal?e.tomorrowGoal.value.trim():"";if(w){const k=new Date(Date.now()+864e5).toISOString().split("T")[0];await window.AppCalendar.addWorkPlanTask(k,window.AppAuth.getUser().id,w),console.log("Tomorrow's goal saved:",w)}const b=await window.AppAttendance.checkOut(t,r?r.lat:null,r?r.lng:null,y,l||!r,m||(d?String(d):""),h);if(b&&b.conflict){const k=document.getElementById("checkout-modal");k&&(k.style.display="none"),window.app_showSyncToast(b.message||"Status updated from another device.");const g=document.getElementById("page-content");g&&(g.innerHTML=await R.renderDashboard(),ue());return}$t(),i.length>0&&await window.app_applyCheckoutTaskUpdates(i),window.app_checkoutSummaryDraft="",window.app_checkoutTaskActions={},window.app_checkoutTaskDetails={},window.app_checkoutTaskMeta={},window.app_checkoutUserMap={},window.app_renderCheckoutActionPreview(),document.getElementById("checkout-modal").style.display="none";const v=document.getElementById("page-content");v&&(v.innerHTML=await R.renderDashboard(),ue())}catch(s){alert("Check-out failed: "+s.message),a.disabled=!1,a.textContent="Complete Check-Out"}finally{je=!1}};async function hs(n){n.preventDefault();const e=new FormData(n.target),t=Ct(e.get("checkIn"),e.get("checkOut"));if(t==="Invalid"){alert("End time must be after Start time");return}const a=e.get("date"),s=e.get("checkIn"),i=e.get("checkOut"),o=window.AppAttendance.buildDateTime(a,s),r=window.AppAttendance.buildDateTime(a,i),d=o&&r?r-o:0,l=Math.max(0,d)/(1e3*60*60),c=l>=4;let m="Work Log",u=0;l>=8?(m="Present",u=1):l>=4&&(m="Half Day",u=.5);const p={date:e.get("date"),checkIn:s,checkOut:i,duration:t,durationMs:d,location:e.get("location"),workDescription:e.get("location"),type:m,dayCredit:u,lateCountable:!1,extraWorkedMs:0,policyVersion:"v2",entrySource:"staff_manual_work",attendanceEligible:c,isManualOverride:!1};await window.AppAttendance.addManualLog(p),alert("Log added successfully!"),document.getElementById("log-modal").style.display="none",Z.innerHTML=await R.renderTimesheet()}async function gs(n){n.preventDefault();const e=new FormData(n.target),t=e.get("name").trim(),a=e.get("username").trim(),s=e.get("password").trim(),i=e.get("email").trim(),o=e.get("isAdmin")==="on"||e.get("isAdmin")==="true",r=e.get("canManageAttendanceSheet")==="on"||e.get("canManageAttendanceSheet")==="true",d={id:"u"+Date.now(),name:t,username:a,password:s,role:e.get("role"),dept:e.get("dept"),email:i,phone:e.get("phone"),joinDate:e.get("joinDate"),isAdmin:o,canManageAttendanceSheet:r,permissions:window.app_getPermissionsFromUI("add"),avatar:`https://ui-avatars.com/api/?name=${e.get("name")}&background=random&color=fff`,status:"out",lastCheckIn:null};try{d.isAdmin?(d.role="Administrator",d.canManageAttendanceSheet=!0):d.isAdmin=!1,await window.AppDB.add("users",d),alert("Success! Account created."),document.getElementById("add-user-modal").style.display="none";const l=document.getElementById("page-content");l&&(l.innerHTML=await R.renderAdmin())}catch(l){alert("Error creating user: "+l.message)}}window.app_getPermissionsFromUI=n=>{const e={};return["dashboard","leaves","users","attendance","reports","minutes","policies"].forEach(a=>{const s=document.getElementById(`${n}-perm-${a}-view`),i=document.getElementById(`${n}-perm-${a}-admin`);i&&i.checked?e[a]="admin":s&&s.checked?e[a]="view":e[a]=null}),e};window.app_submitEditUser=async n=>{n&&n.preventDefault();const e=n&&n.target&&n.target.tagName==="FORM"?n.target:document.getElementById("edit-user-form");if(!e){console.error("Critical Failure: Edit user form not found."),alert("Error: Form missing.");return}const t=new FormData(e),a=(t.get("id")||"").trim();if(!a){console.error("Data Failure: No 'id' name attribute found in form data.",{target:n.target,allData:Object.fromEntries(t.entries())}),alert("Error: User ID missing. Please refresh.");return}const s=e.querySelector('[name="isAdmin"]'),i=!!(s&&s.checked),o=e.querySelector('[name="canManageAttendanceSheet"]'),r=!!(o&&o.checked),d=String(t.get("pan")||"").trim().toUpperCase(),l=String(t.get("bankIfsc")||"").trim().toUpperCase(),c=String(t.get("joinDate")||"").trim(),m=String(t.get("employeeId")||"").trim(),u=/^[A-Z]{5}[0-9]{4}[A-Z]$/,p=/^[A-Z]{4}0[A-Z0-9]{6}$/;if(c){const y=new Date,w=`${y.getFullYear()}-${String(y.getMonth()+1).padStart(2,"0")}-${String(y.getDate()).padStart(2,"0")}`;if(c>w){alert("Join Date cannot be in the future.");return}}if(d&&!u.test(d)){alert("Invalid PAN format. Use format like ABCDE1234F");return}if(l&&!p.test(l)){alert("Invalid IFSC format. Use format like SBIN0001234");return}const f=c?m||ft(c,a):"NA",h={id:a,name:(t.get("name")||"").trim(),username:(t.get("username")||"").trim(),password:(t.get("password")||"").trim(),role:t.get("role"),dept:t.get("dept"),email:(t.get("email")||"").trim(),phone:(t.get("phone")||"").trim(),isAdmin:i,canManageAttendanceSheet:r,employeeId:f,joinDate:c||null,baseSalary:Number(t.get("baseSalary")||0),otherAllowances:Number(t.get("otherAllowances")||0),providentFund:Number(t.get("providentFund")||0),professionalTax:Number(t.get("professionalTax")||0),loanAdvance:Number(t.get("loanAdvance")||0),tdsPercent:Number(t.get("tdsPercent")||0),bankName:(t.get("bankName")||"").trim(),bankAccount:(t.get("bankAccount")||"").trim(),bankIfsc:l,pan:d,uan:(t.get("uan")||"").trim(),permissions:window.app_getPermissionsFromUI("edit")};console.log("Executing Update for User:",h),h.isAdmin&&(h.canManageAttendanceSheet=!0,h.role="Administrator");try{if(await window.AppAuth.updateUser(h)){console.log("Success: User updated in DB."),alert(`SUCCESS: Details for '${h.name}' have been saved.`),document.getElementById("edit-user-modal").style.display="none";const w=document.getElementById("page-content");w&&setTimeout(async()=>{w.innerHTML=await R.renderAdmin(),window.AppAnalytics&&await window.AppAnalytics.initAdminCharts()},50)}else alert("Update failed: User not found.")}catch(y){console.error("Update Error:",y),alert("Error: "+y.message)}};function Ct(n,e){const[t,a]=n.split(":"),[s,i]=e.split(":"),o=parseInt(s)*60+parseInt(i)-(parseInt(t)*60+parseInt(a));if(o<0)return"Invalid";const r=Math.floor(o/60),d=o%60;return`${r}h ${d}m`}function ue(){const n=document.getElementById("attendance-btn"),e=!!window.app_dashboardReadOnly,t=window.app_dashboardTargetUser||null;n&&!e&&n.addEventListener("click",Ae),rs(t,e),We(),window.app_refreshNotificationBell&&window.app_refreshNotificationBell().catch(()=>{}),window.app_attachStatsCardHandlers&&window.app_attachStatsCardHandlers()}window.setupDashboardEvents=ue;document.addEventListener("submit",n=>{n.preventDefault();const e=n.target.getAttribute("id");console.log("Submit Event Intercepted. Form ID:",e),e==="manual-log-form"?hs(n):e==="checkout-form"?window.app_submitCheckOut(n):e==="add-user-form"?gs(n):e==="login-form"?(async()=>{const t=new FormData(n.target);try{const a=await window.getLocation();if(!await window.AppAuth.login(t.get("username"),t.get("password"))){alert("Invalid Credentials");return}const i=window.AppAuth.getUser();i&&(i.lastLoginLocation={lat:a.lat,lng:a.lng,capturedAt:Date.now()},await window.AppDB.put("users",i)),window.location.reload()}catch(a){const s=String(a);s.includes("permission-denied")||s.includes("FirebaseError")?alert(`Database Error: ${s}

Access to the database was blocked. Please check your Firebase Firestore Security Rules.`):alert(`Login blocked: ${s}

Please enable location and try again.`)}})():e==="edit-user-form"?(console.log("Routing to app_submitEditUser..."),window.app_submitEditUser(n)):e==="notify-form"?vs(n):e==="leave-request-form"?ws(n):console.warn("Unhandled form submission ID:",e,"Target:",n.target)});async function ws(n){const e=new FormData(n.target),t=window.AppAuth.getUser(),a=e.get("startDate");let s=e.get("endDate");const i=e.get("type");i==="Half Day"&&(s=a),await window.AppLeaves.requestLeave({userId:t.id,userName:t.name,startDate:a,endDate:s,startTime:e.get("startTime")||"",endTime:e.get("endTime")||"",type:i,reason:e.get("reason"),durationHours:e.get("durationHours")||""}),alert("Leave requested successfully!"),document.getElementById("leave-modal").style.display="none",n.target.reset()}async function vs(n){n.preventDefault();const e=new FormData(n.target),t=e.get("toUserId"),a=e.get("reminderMessage")||"",s=e.get("reminderLink")||"",i=e.get("taskTitle")||"",o=e.get("taskDescription")||"",r=e.get("taskDueDate")||"";try{if(!a.trim()&&!i.trim()){alert("Please enter a reminder or a task.");return}const d=await window.AppDB.get("users",t);if(!d)throw new Error("User not found");const l=window.AppAuth.getUser(),c=new Date().toISOString();d.notifications||(d.notifications=[]),a.trim()&&(d.notifications.unshift({id:`rem_${Date.now()}`,type:"reminder",message:a.trim(),taggedById:l.id,taggedByName:l.name,taggedAt:c,status:"pending",date:c,read:!1}),await window.AppDB.add("staff_messages",{id:`msg_${Date.now()}_${Math.random().toString(36).slice(2,6)}`,type:"text",message:a.trim(),link:s.trim(),fromId:l.id,fromName:l.name,toId:t,toName:d.name,createdAt:c,read:!1})),i.trim()&&(d.notifications.unshift({id:`task_${Date.now()}`,type:"task",title:i.trim(),description:o.trim(),taggedById:l.id,taggedByName:l.name,taggedAt:c,status:"pending",dueDate:r||"",date:c,read:!1}),await window.AppDB.add("staff_messages",{id:`task_${Date.now()}_${Math.random().toString(36).slice(2,6)}`,type:"task",title:i.trim(),description:o.trim(),dueDate:r||"",status:"pending",fromId:l.id,fromName:l.name,toId:t,toName:d.name,createdAt:c,read:!1,history:[{action:"created",byId:l.id,byName:l.name,at:c}]})),await window.AppAuth.updateUser(d),alert("Notification sent!"),document.getElementById("notify-modal").style.display="none",window.app_updateStaffNavIndicator&&await window.app_updateStaffNavIndicator()}catch(d){alert("Failed to send: "+d.message)}}window.app_openStaffThread=async n=>{window.app_staffThreadId=n;const e=window.AppAuth.getUser();if(!e)return;const a=(await window.app_getMyMessages()).filter(i=>i.toId===e.id&&i.fromId===n&&!i.read);for(const i of a)i.read=!0,i.readAt=new Date().toISOString(),await window.AppDB.put("staff_messages",i);const s=document.getElementById("page-content");s&&(s.innerHTML=await R.renderStaffDirectoryPage()),window.app_updateStaffNavIndicator&&await window.app_updateStaffNavIndicator()};window.app_sendStaffText=async n=>{n.preventDefault();const e=window.AppAuth.getUser(),t=new FormData(n.target),a=t.get("toUserId"),s=(t.get("message")||"").trim(),i=(t.get("link")||"").trim();if(!s){alert("Please type a message.");return}const o=await window.AppDB.get("users",a);if(!o){alert("Staff member not found.");return}await window.AppDB.add("staff_messages",{id:`msg_${Date.now()}_${Math.random().toString(36).slice(2,6)}`,type:"text",message:s,link:i,fromId:e.id,fromName:e.name,toId:a,toName:o.name,createdAt:new Date().toISOString(),read:!1}),n.target.reset();const r=document.getElementById("staff-message-modal");r&&r.remove();const d=document.getElementById("page-content");d&&(d.innerHTML=await R.renderStaffDirectoryPage()),window.app_updateStaffNavIndicator&&await window.app_updateStaffNavIndicator()};window.app_sendStaffTask=async n=>{n.preventDefault();const e=window.AppAuth.getUser(),t=new FormData(n.target),a=t.get("toUserId"),s=(t.get("taskTitle")||"").trim(),i=(t.get("taskDescription")||"").trim(),o=(t.get("taskDueDate")||"").trim();if(!s){alert("Please provide a task title.");return}const r=await window.AppDB.get("users",a);if(!r){alert("Staff member not found.");return}await window.AppDB.add("staff_messages",{id:`task_${Date.now()}_${Math.random().toString(36).slice(2,6)}`,type:"task",title:s,description:i,dueDate:o,status:"pending",fromId:e.id,fromName:e.name,toId:a,toName:r.name,createdAt:new Date().toISOString(),read:!1,history:[{action:"created",byId:e.id,byName:e.name,at:new Date().toISOString()}]}),n.target.reset();const d=document.getElementById("staff-task-modal");d&&d.remove();const l=document.getElementById("page-content");l&&(l.innerHTML=await R.renderStaffDirectoryPage()),window.app_updateStaffNavIndicator&&await window.app_updateStaffNavIndicator()};window.app_openStaffMessageModal=(n,e)=>{if(!n){alert("Select a staff member first.");return}const a=`
                    ...
                    <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:1.5rem;">
                        ...
                        <form onsubmit="window.app_submitCellOverride(event, '${n}', '${e}', '${i?.id||""}')">
                            ...
                            <div style="display:grid; grid-template-columns:1fr 1fr; gap:1rem;">
                                <div>
                                    <label style="display:block; font-size:0.85rem; margin-bottom:0.25rem;">Time In</label>
                                    <input type="time" name="checkIn" required value="${i?lt(i.checkIn):"09:00"}" style="width:100%; padding:0.75rem; border:1px solid #ddd; border-radius:8px;">
                                </div>
                                <div>
                                    <label style="display:block; font-size:0.85rem; margin-bottom:0.25rem;">Time Out</label>
                                    <input type="time" name="checkOut" required value="${i?lt(i.checkOut):"17:00"}" style="width:100%; padding:0.75rem; border:1px solid #ddd; border-radius:8px;">
                                </div>
                            </div>
                            <div>
        ...
        `;window.app_showModal(o,"cell-override-modal")};window.app_submitCellOverride=async(n,e,t,a)=>{if(!window.app_canManageAttendanceSheet()){alert("You do not have permission for this action.");return}n.preventDefault();const s=new FormData(n.target),i=s.get("checkIn"),o=s.get("checkOut"),r=Ct(i,o);if(r==="Invalid"){alert("End time must be after Start time");return}const d=window.AppAttendance.buildDateTime(t,i),l=window.AppAttendance.buildDateTime(t,o),c=d&&l?l-d:0,m=window.AppAttendance.evaluateAttendanceStatus(d||new Date,c),u=s.get("isManualOverride")==="on",p=String(s.get("type")||"").trim(),f=u&&p?p:m.status,h=w=>{if(!w||w==="--")return"--";const[b,v]=w.split(":"),k=parseInt(b),g=k>=12?"PM":"AM",A=k%12||12;return`${String(A).padStart(2,"0")}:${v} ${g}`},y={date:t,checkIn:h(i),checkOut:h(o),duration:r,type:f,workDescription:s.get("description")||"Admin Override",location:"Office (Override)",durationMs:c,dayCredit:m.dayCredit,lateCountable:m.lateCountable,extraWorkedMs:m.extraWorkedMs||0,policyVersion:"v2",isManualOverride:u,entrySource:"admin_override",attendanceEligible:!0,autoCheckoutExtraApproved:s.get("autoCheckoutExtraApproved")==="on"};try{a?await window.AppAttendance.updateLog(a,y):await window.AppAttendance.addAdminLog(e,y),alert("Override successful."),document.getElementById("cell-override-modal")?.remove(),window.app_refreshMasterSheet()}catch(w){alert("Error: "+w.message)}};window.app_deleteCellLog=async(n,e)=>{if(!window.app_canManageAttendanceSheet()){alert("You do not have permission for this action.");return}if(await window.appConfirm("Delete this attendance record?"))try{await window.AppAttendance.deleteLog(n),document.getElementById("cell-override-modal")?.remove(),window.app_refreshMasterSheet()}catch(t){alert("Error: "+t.message)}};function lt(n){if(!n||n==="--"||n==="Active Now")return"09:00";const[e,t]=n.split(" ");let[a,s]=e.split(":"),i=parseInt(a);return t==="PM"&&i<12&&(i+=12),t==="AM"&&i===12&&(i=0),`${String(i).padStart(2,"0")}:${s}`}const bs=n=>{if(!n)return null;const e=String(n).trim();if(/^\d{4}-\d{2}-\d{2}$/.test(e))return e;const t=new Date(e);if(!Number.isNaN(t.getTime())){const s=t.getFullYear(),i=String(t.getMonth()+1).padStart(2,"0"),o=String(t.getDate()).padStart(2,"0");return`${s}-${i}-${o}`}const a=e.match(/^(\d{1,2})[-/](\d{1,2})[-/](\d{4})$/);if(a){const s=Number(a[1]),i=Number(a[2]),o=Number(a[3]);let r=s,d=i;return d>12&&s<=12&&(d=s,r=i),d<1||d>12||r<1||r>31?null:`${o}-${String(d).padStart(2,"0")}-${String(r).padStart(2,"0")}`}return null};window.app_runAttendancePolicyMigration=async()=>{if(!window.app_canManageAttendanceSheet()){alert("You do not have permission for this action.");return}if(await window.appConfirm("Recalculate historical attendance logs with the current policy? This updates stored status/credits for existing office logs.","Run Attendance Migration"))try{const e=await window.AppDB.getAll("attendance");let t=0,a=0,s=0;const i=new Set(["Work - Home","Training","On Duty","Holiday","National Holiday","Regional Holidays"]);let o=0,r=0;const d=new Map,l=new Map,c=h=>{const y=bs(h?.date),w=typeof h?.activityScore<"u"||typeof h?.locationMismatched<"u"||typeof h?.autoCheckout<"u"||!!h?.checkOutLocation||typeof h?.outLat<"u"||typeof h?.outLng<"u";let v=String(h?.entrySource||"").trim();v||(h?.isManualOverride||h?.location==="Office (Manual)"||h?.location==="Office (Override)"?v="admin_override":w?v="checkin_checkout":v="staff_manual_work");const k=h?.checkIn&&h?.checkOut&&h?.checkOut!=="Active Now"?lt(h.checkIn):null,g=h?.checkIn&&h?.checkOut&&h?.checkOut!=="Active Now"?lt(h.checkOut):null,A=y&&k?window.AppAttendance.buildDateTime(y,k):null,S=y&&g?window.AppAttendance.buildDateTime(y,g):null,$=!!(A&&S&&S>A),L=$?S-A:null,I=typeof h?.durationMs=="number"?h.durationMs:L,B=typeof I=="number"?Math.max(0,I)/(1e3*60*60):0;let E;return Object.prototype.hasOwnProperty.call(h||{},"attendanceEligible")?E=h.attendanceEligible===!0:v==="staff_manual_work"?E=B>=4:E=!0,{dateIso:y,inDt:A,outDt:S,validTimeRange:$,resolvedDurationMs:I,workedHours:B,inferredSource:v,inferredAttendanceEligible:E}},m=(h,y)=>{const w=window.AppAttendance.normalizeType(h?.type);let b=0;y.inferredSource==="staff_manual_work"?y.workedHours>=8?b=100:y.workedHours>=4&&(b=50):b=Number(window.AppAttendance.getDayCredit(w)||0)*100;let v=0;return v+=b,v+=Math.min(20,Math.floor(Math.max(0,y.workedHours||0))),y.inferredAttendanceEligible&&(v+=40),y.validTimeRange&&(v+=10),y.inferredSource==="checkin_checkout"?v+=8:y.inferredSource==="admin_override"?v+=6:v+=4,h?.isManualOverride&&(v+=4),(String(h?.type||"").includes("Leave")||h?.location==="On Leave")&&(v+=6),v+=Number(h?.id||0)/1e13,v};for(const h of e){if(!h||!h.id)continue;const y=c(h);d.set(h.id,y);const w=h.user_id||h.userId;if(!w||!y.dateIso)continue;const b=`${w}|${y.dateIso}`;l.has(b)||l.set(b,[]),l.get(b).push(h)}const u=new Map;for(const[h,y]of l.entries()){if(!y||y.length===0)continue;const w=y.slice().sort((b,v)=>{const k=d.get(b.id)||c(b),g=d.get(v.id)||c(v);return m(v,g)-m(b,k)});u.set(h,w[0]?.id)}for(const h of e){if(t++,!h||!h.id){s++;continue}const y=window.AppAttendance.normalizeType(h.type),w=d.get(h.id)||c(h),b=w.dateIso,v=w.inDt,k=w.outDt,g=w.resolvedDurationMs,A=w.workedHours,S=w.inferredSource;let $=w.inferredAttendanceEligible;const L=h.user_id||h.userId,I=L&&b?`${L}|${b}`:null,B=I?u.get(I):null,E=!!(B&&B!==h.id),M=!!(h.checkIn&&h.checkOut&&h.checkOut!=="Active Now")&&!!(v&&k&&k<=v);let U=h.type,P=h.dayCredit,C=h.lateCountable,O=h.extraWorkedMs||0;if(E&&($=!1,String(h.type||"").includes("Leave")||(U="Work Log"),P=0,C=!1,O=0,o++),M&&($=!1,String(h.type||"").includes("Leave")||(U="Work Log"),P=0,C=!1,O=0,r++),S==="staff_manual_work"&&!E&&!M)A>=8?(U="Present",P=1):A>=4?(U="Half Day",P=.5):(U="Work Log",P=0),C=!1,O=0;else if(!h.isManualOverride&&$&&!(i.has(y)||String(y).includes("Leave")||y==="Office")&&v&&k&&k>v){const T=window.AppAttendance.evaluateAttendanceStatus(v,k-v);U=T.status,P=T.dayCredit,C=T.lateCountable,O=T.extraWorkedMs||0}const z={...h,entrySource:S,attendanceEligible:$,type:U,dayCredit:typeof P=="number"?P:0,lateCountable:C===!0,extraWorkedMs:O||0,durationMs:typeof g=="number"?g:null,policyVersion:"v2"};if(!(h.entrySource!==z.entrySource||h.attendanceEligible!==z.attendanceEligible||h.type!==z.type||h.dayCredit!==z.dayCredit||h.lateCountable!==z.lateCountable||(h.extraWorkedMs||0)!==(z.extraWorkedMs||0)||h.durationMs!==z.durationMs||h.policyVersion!=="v2")){s++;continue}await window.AppDB.put("attendance",z),a++}alert(`Migration complete.
Scanned: ${t}
Updated: ${a}
Skipped: ${s}
Duplicates neutralized: ${o}
Invalid-time logs neutralized: ${r}`);const p=window.location.hash.slice(1),f=document.getElementById("page-content");if(!f)return;p==="policy-test"?f.innerHTML=await R.renderPolicyTest():p==="dashboard"?(f.innerHTML=await R.renderDashboard(),window.setupDashboardEvents&&window.setupDashboardEvents()):p==="salary"?(f.innerHTML=await R.renderSalaryProcessing(),window.app_recalculateAllSalaries&&window.app_recalculateAllSalaries()):p==="timesheet"&&(f.innerHTML=await R.renderTimesheet())}catch(e){console.error("Attendance migration failed:",e),alert("Migration failed: "+e.message)}};window.app_deleteUser=async n=>{if(await window.appConfirm("Are you sure you want to delete this user? This action cannot be undone."))try{await window.AppDB.delete("users",n),alert("User deleted successfully.");const e=document.getElementById("page-content");e&&(e.innerHTML=await R.renderAdmin())}catch(e){alert("Failed to delete user: "+e.message)}};window.app_recalculateRow=n=>{const e=parseFloat(n.querySelector(".base-salary-input").value)||0,t=e/22,a=parseFloat(n.querySelector(".unpaid-leaves-count").innerText)||0,s=parseFloat(n.querySelector(".late-count")?.innerText||"0")||0,i=Math.floor(s/(_.LATE_GRACE_COUNT||3))*(_.LATE_DEDUCTION_PER_BLOCK||.5),o=parseFloat(n.querySelector(".extra-work-hours")?.innerText||"0")||0,r=Math.floor(o/(_.EXTRA_HOURS_FOR_HALF_DAY_OFFSET||4))*(_.LATE_DEDUCTION_PER_BLOCK||.5),d=Math.max(0,i-r),l=a+d,c=parseFloat(document.getElementById("global-tds-percent").value)||0,m=n.querySelector(".tds-input");m&&!m.dataset.manual&&(m.value=c);const u=m?parseFloat(m.value)||0:c,p=Math.round(t*l),f=n.querySelector(".late-deduction-days"),h=n.querySelector(".late-deduction-raw"),y=n.querySelector(".penalty-offset-days"),w=n.querySelector(".deduction-days"),b=n.querySelector(".attendance-deduction-amount");h&&(h.innerText=i.toFixed(1)),y&&(y.innerText=r.toFixed(1)),f&&(f.innerText=d.toFixed(1)),w&&(w.innerText=l.toFixed(1)),b&&(b.innerText="-Rs "+p.toLocaleString()),n.querySelector(".deduction-amount").innerText="-Rs "+p.toLocaleString();const v=n.querySelector(".salary-input");v.dataset.manual||(v.value=Math.max(0,e-p));const k=parseFloat(v.value)||0,g=Math.round(k*(u/100)),A=Math.max(0,k-g);n.querySelector(".tds-amount").innerText="Rs "+g.toLocaleString(),n.querySelector(".tds-amount").dataset.value=g,n.querySelector(".final-net-salary").innerText="Rs "+A.toLocaleString(),n.querySelector(".final-net-salary").dataset.value=A};const Ca=n=>{const e=parseFloat(n.querySelector(".unpaid-leaves-count")?.innerText||"0")||0,t=parseFloat(n.querySelector(".late-count")?.innerText||"0")||0,a=parseFloat(n.querySelector(".extra-work-hours")?.innerText||"0")||0,s=Math.floor(t/(_.LATE_GRACE_COUNT||3))*(_.LATE_DEDUCTION_PER_BLOCK||.5),i=Math.floor(a/(_.EXTRA_HOURS_FOR_HALF_DAY_OFFSET||4))*(_.LATE_DEDUCTION_PER_BLOCK||.5),o=Math.max(0,s-i),r=e+o;return{unpaidLeaves:e,lateCount:t,extraWorkedHours:a,rawLateDeductionDays:s,penaltyOffsetDays:i,lateDeductionDays:o,deductionDays:r}};window.app_recalculateAllSalaries=()=>{document.querySelectorAll("tr[data-user-id]").forEach(n=>{window.app_recalculateRow(n)})};const bt=(n,e=new Date)=>{if(/^\d{4}-\d{2}$/.test(String(n||"").trim())){const[t,a]=String(n).split("-").map(Number);if(Number.isFinite(t)&&Number.isFinite(a)&&a>=1&&a<=12)return{year:t,monthIndex:a-1}}return{year:e.getFullYear(),monthIndex:e.getMonth()}};window.app_toggleSalaryPeriodMode=function(){const n=document.getElementById("salary-period-mode")?.value||"single",e=document.getElementById("salary-period-single-wrap"),t=document.getElementById("salary-period-range-wrap");e&&(e.style.display=n==="range"?"none":"block"),t&&(t.style.display=n==="range"?"flex":"none")};window.app_getSalaryPayPeriodInfo=function(){const n=new Date;if((document.getElementById("salary-period-mode")?.value||"single")==="range"){const r=document.getElementById("salary-pay-period-from")?.value||"",d=document.getElementById("salary-pay-period-to")?.value||"";let l=bt(r,n),c=bt(d,n);const m=l.year*100+(l.monthIndex+1);if(c.year*100+(c.monthIndex+1)<m){const w=l;l=c,c=w}const p=new Date(l.year,l.monthIndex,1),f=new Date(c.year,c.monthIndex+1,0),h=`${l.year}-${String(l.monthIndex+1).padStart(2,"0")}`,y=`${c.year}-${String(c.monthIndex+1).padStart(2,"0")}`;return{mode:"range",startDate:p,endDate:f,startKey:h,endKey:y,key:`${h}_to_${y}`,label:`${p.toLocaleDateString("en-GB",{month:"long",year:"numeric"})} to ${f.toLocaleDateString("en-GB",{month:"long",year:"numeric"})}`}}const t=document.getElementById("salary-pay-period")?.value||"",a=bt(t,n),s=new Date(a.year,a.monthIndex,1),i=new Date(a.year,a.monthIndex+1,0),o=`${a.year}-${String(a.monthIndex+1).padStart(2,"0")}`;return{mode:"single",startDate:s,endDate:i,startKey:o,endKey:o,key:o,label:s.toLocaleDateString("en-GB",{month:"long",year:"numeric"})}};window.app_saveAllSalaries=async()=>{const n=document.querySelectorAll("tr[data-user-id]"),e=[],t=[],a=window.app_getSalaryPayPeriodInfo(),s=a.key,i=document.getElementById("salary-pay-date")?.value||"",o=i?new Date(i).getTime():Date.now(),r=parseFloat(document.getElementById("global-tds-percent").value)||0;for(const d of n){const l=d.dataset.userId,c=d.querySelector(".base-salary-input").value,m=d.querySelector(".salary-input").value,u=d.querySelector(".comment-input").value,p=d.querySelector(".tds-input"),f=p?parseFloat(p.value)||0:r,h=d.querySelector(".tds-amount").dataset.value||0,y=d.querySelector(".final-net-salary").dataset.value||0,w=Ca(d),b=w.unpaidLeaves,v=w.lateCount,k=w.extraWorkedHours,g=w.rawLateDeductionDays,A=w.penaltyOffsetDays,S=w.lateDeductionDays,$=w.deductionDays,L=Number(String(d.querySelector(".attendance-deduction-amount")?.innerText||"0").replace(/[^0-9.-]+/g,"")),I=String(d.querySelector(".employee-id-input")?.value||"").trim(),B=String(d.querySelector(".designation-input")?.value||"").trim(),E=String(d.querySelector(".department-input")?.value||"").trim(),D=String(d.querySelector(".join-date-input")?.value||"").trim(),M=D?I||ft(D,l):"NA",U=String(d.querySelector(".bank-name-input")?.value||"").trim(),P=String(d.querySelector(".bank-account-input")?.value||"").trim(),C=String(d.querySelector(".pan-input")?.value||"").trim(),O=String(d.querySelector(".uan-input")?.value||"").trim(),H=Number(d.querySelector(".other-allowances-input")?.value||0),z=Number(d.querySelector(".pf-input")?.value||0),G=Number(d.querySelector(".professional-tax-input")?.value||0),T=Number(d.querySelector(".loan-advance-input")?.value||0);if(d.querySelector(".comment-input").required&&!u){alert(`Please provide a comment for user ID: ${l} as the salary was adjusted.`);return}e.push({id:`salary_${l}_${s}`,userId:l,month:s,periodMode:a.mode,periodStart:a.startKey,periodEnd:a.endKey,periodLabel:a.label,payDate:o,baseAmount:Number(c),otherAllowances:H,providentFund:z,professionalTax:G,loanAdvance:T,employeeId:M,designation:B,department:E,joinDate:D||null,bankName:U,bankAccount:P,pan:C,uan:O,attendanceDeduction:L,deductions:Number(d.querySelector(".deduction-amount").innerText.replace(/[^0-9.-]+/g,"")),unpaidLeaves:b,lateCount:v,extraWorkedHours:k,lateDeductionRawDays:g,penaltyOffsetDays:A,lateDeductionDays:S,deductionDays:$,adjustedAmount:Number(m),tdsPercent:f,tdsAmount:Number(h),finalNet:Number(y),comment:u||"",processedAt:Date.now()}),t.push({id:l,baseSalary:Number(c),tdsPercent:f,employeeId:M,designation:B,dept:E,joinDate:D||null,bankName:U,bankAccount:P,pan:C,uan:O,otherAllowances:H,providentFund:z,professionalTax:G,loanAdvance:T})}try{for(const l of e)await window.AppDB.put("salaries",l);for(const l of t){const c=await window.AppDB.get("users",l.id);c&&(Object.assign(c,l),await window.AppDB.put("users",c))}alert("All records and TDS details saved successfully!");const d=document.getElementById("page-content");d.innerHTML=await R.renderSalaryProcessing()}catch(d){console.error("Salary Save Error:",d),alert("Failed to save records: "+d.message)}};window.app_exportSalaryCSV=()=>{const n=document.querySelectorAll("tr[data-user-id]");let e=`Staff Name,Emp ID,Designation,Department,Join Date,Bank Name,Bank Account,PAN,UAN,Base Salary,Other Allowances,PF,Professional Tax,Loan Advance,Present,Late,Unpaid Leaves,Extra Work Hours,Late Deduction Raw,Penalty Offset Days,Late Deduction Days,Total Deduction Days,Attendance Deduction,Total Deductions,Adjusted Salary,TDS (%),TDS Amount,Final Net,Comment
`;n.forEach(o=>{const r=o.querySelector('div[style*="font-weight: 600"]').innerText,d=o.querySelector(".base-salary-input").value,l=o.querySelector(".employee-id-input")?.value||"",c=o.querySelector(".designation-input")?.value||"",m=o.querySelector(".department-input")?.value||"",u=o.querySelector(".join-date-input")?.value||"",p=o.querySelector(".bank-name-input")?.value||"",f=o.querySelector(".bank-account-input")?.value||"",h=o.querySelector(".pan-input")?.value||"",y=o.querySelector(".uan-input")?.value||"",w=o.querySelector(".other-allowances-input")?.value||"0",b=o.querySelector(".pf-input")?.value||"0",v=o.querySelector(".professional-tax-input")?.value||"0",k=o.querySelector(".loan-advance-input")?.value||"0",g=o.querySelector(".present-count")?.innerText||"0",A=o.querySelector(".late-count")?.innerText||"0",S=o.querySelector(".unpaid-leaves-count")?.innerText||"0",$=o.querySelector(".extra-work-hours")?.innerText||"0",L=o.querySelector(".late-deduction-raw")?.innerText||"0",I=o.querySelector(".penalty-offset-days")?.innerText||"0",B=o.querySelector(".late-deduction-days")?.innerText||"0",E=o.querySelector(".deduction-days")?.innerText||"0",D=(o.querySelector(".attendance-deduction-amount")?.innerText||"").replace(/[^0-9.-]+/g,"")||"0",M=(o.querySelector(".deduction-amount").innerText||"").replace(/[^0-9.-]+/g,""),U=o.querySelector(".salary-input").value,P=parseFloat(document.getElementById("global-tds-percent").value)||0,C=o.querySelector(".tds-input"),O=C&&C.value!==""?C.value:P,H=(o.querySelector(".tds-amount").innerText||"").replace(/[^0-9.-]+/g,""),z=(o.querySelector(".final-net-salary").innerText||"").replace(/[^0-9.-]+/g,""),G=o.querySelector(".comment-input").value;e+=`"${r}","${l}","${c}","${m}","${u}","${p}","${f}","${h}","${y}",${d},${w},${b},${v},${k},${g},${A},${S},${$},${L},${I},${B},${E},${D},${M},${U},${O},${H},${z},"${G}"
`});const t=new Blob([e],{type:"text/csv"}),a=window.URL.createObjectURL(t),s=document.createElement("a"),i=window.app_getSalaryPayPeriodInfo();s.setAttribute("href",a),s.setAttribute("download",`Salaries_${i.key.replace(/[^a-zA-Z0-9_-]/g,"_")}.csv`),s.click()};const St=(n,e=4)=>{const t=String(n||"").trim();return t?t.length<=e?t:`${"*".repeat(Math.max(0,t.length-e))}${t.slice(-e)}`:"NA"},Ss=n=>{const e=Math.floor(Number(n)||0);if(e===0)return"Zero";const t=["","One","Two","Three","Four","Five","Six","Seven","Eight","Nine","Ten","Eleven","Twelve","Thirteen","Fourteen","Fifteen","Sixteen","Seventeen","Eighteen","Nineteen"],a=["","","Twenty","Thirty","Forty","Fifty","Sixty","Seventy","Eighty","Ninety"],s=u=>{if(u<20)return t[u];const p=Math.floor(u/10),f=u%10;return`${a[p]}${f?` ${t[f]}`:""}`.trim()},i=u=>{const p=Math.floor(u/100),f=u%100;return p?`${t[p]} Hundred${f?` ${s(f)}`:""}`.trim():s(f)};let o=e;const r=Math.floor(o/1e7);o%=1e7;const d=Math.floor(o/1e5);o%=1e5;const l=Math.floor(o/1e3);o%=1e3;const c=o,m=[];return r&&m.push(`${s(r)} Crore`),d&&m.push(`${s(d)} Lakh`),l&&m.push(`${s(l)} Thousand`),c&&m.push(i(c)),m.join(" ").trim()};window.app_printSalarySlip=function(){const n=document.getElementById("salary-slip-modal");if(!n)return;const e=n.querySelector(".salary-slip-print-root");e&&(document.body.classList.add("salary-slip-print-mode"),e.classList.add("print-active"),setTimeout(()=>{window.print(),setTimeout(()=>{e.classList.remove("print-active"),document.body.classList.remove("salary-slip-print-mode")},150)},60))};window.app_generateSalarySlip=async function(n){try{const e=document.querySelector(`tr[data-user-id="${n}"]`);if(!e){alert("Unable to locate salary row for this user.");return}const t=await window.AppDB.get("users",n);if(!t){alert("User details not found.");return}const a=new Date,s=window.app_getSalaryPayPeriodInfo(),i=s.label,o=Ee(s.startDate),r=Ee(s.endDate),d=document.getElementById("salary-pay-date")?.value||"",l=Ee(d||a),c=cs(a),m=`CRWI-${s.key.replace(/[^a-zA-Z0-9]/g,"")}-${n}-${String(a.getTime()).slice(-5)}`,u=Number(e.querySelector(".base-salary-input")?.value||0),p=Number(e.querySelector(".salary-input")?.value||0),f=Number(e.querySelector(".tds-input")?.value||0),h=Number(e.querySelector(".tds-amount")?.dataset?.value||"0"),y=Number(e.querySelector(".final-net-salary")?.dataset?.value||"0"),w=Number(String(e.querySelector(".attendance-deduction-amount")?.innerText||"0").replace(/[^0-9.-]+/g,""))||0,b=Ca(e),v=b.rawLateDeductionDays,k=b.penaltyOffsetDays,g=b.lateDeductionDays,A=b.deductionDays,S=b.unpaidLeaves,$=b.lateCount,L=String(e.querySelector(".comment-input")?.value||"").trim(),I=Number(e.querySelector(".other-allowances-input")?.value||t.otherAllowances||0),B=u+I,E=Number(e.querySelector(".loan-advance-input")?.value||t.loanAdvance||0),D=Number(e.querySelector(".pf-input")?.value||t.providentFund||0),M=Number(e.querySelector(".professional-tax-input")?.value||t.professionalTax||0),U=String(e.querySelector(".join-date-input")?.value||t.joinDate||"").trim(),P=String(e.querySelector(".employee-id-input")?.value||t.employeeId||"").trim(),C=U?P||ft(U,t.id):"NA",O=String(e.querySelector(".designation-input")?.value||t.designation||t.role||"").trim(),H=String(e.querySelector(".department-input")?.value||t.dept||t.department||"").trim(),z=String(e.querySelector(".join-date-input")?.value||t.joinDate||"").trim(),G=String(e.querySelector(".bank-name-input")?.value||t.bankName||"").trim(),T=String(e.querySelector(".bank-account-input")?.value||t.bankAccount||t.accountNumber||"").trim(),N=String(e.querySelector(".pan-input")?.value||t.pan||t.PAN||"").trim(),W=String(e.querySelector(".uan-input")?.value||t.uan||t.UAN||"").trim(),V=w+h+E+D+M,J=`${Ss(y)} Rupees Only`,X=[{label:"Attendance Deduction",amount:w,remarks:`Unpaid Leaves: ${S}, Late Count: ${$}, Late Raw: ${v.toFixed(1)}, Offset: ${k.toFixed(1)}, Late Deduction: ${g.toFixed(1)}, Total Deduction Days: ${A.toFixed(1)}`},{label:"TDS",amount:h,remarks:`Applied at ${f.toFixed(2)}%`},{label:"Provident Fund",amount:D,remarks:D?"Configured as per employee profile":"NA"},{label:"Professional Tax",amount:M,remarks:M?"Configured as per employee profile":"NA"},{label:"Loan / Advance",amount:E,remarks:E?"Recovered in this cycle":"Nil"}],ee=se=>ps(se),ye=`
                        ...
                        <div class="salary-slip-paper">
                            ...
                            <div class="salary-slip-section">
                                ...
                                <div class="salary-slip-grid">
                                    ...
                                    <div><b>Designation:</b> ${O||"NA"}</div>
                                    <div><b>Department:</b> ${H||"NA"}</div>
                                    <div><b>Date of Joining:</b> ${Ee(z)}</div>
                                    <div><b>Bank Name:</b> ${G||"NA"}</div>
                                    <div><b>UAN:</b> ${St(W)}</div>
                                    <div><b>PAN:</b> ${St(N)}</div>
                                    <div><b>Bank A/C:</b> ${St(T)}</div>
                                </div>
                            </div>
                            ...
                            <div class="salary-slip-split">
                                <div class="salary-slip-section">
                                    ...
                                    <table class="salary-slip-table">
                                        <tr><td>Basic Salary</td><td>${ee(u)}</td></tr>
                                        ...
                                        <tr class="total"><td>Gross Earnings</td><td>${ee(B)}</td></tr>
                                    </table>
                                </div>
                                <div class="salary-slip-section">
                                    <h4>Deductions (Breakdown)</h4>
                                    <table class="salary-slip-table">
                                        ${X.map(se=>`<tr><td>${se.label}<div class="remark">${se.remarks}</div></td><td>${se.amount?ee(se.amount):"NA"}</td></tr>`).join("")}
                                        <tr class="total"><td>Total Deductions</td><td>${ee(V)}</td></tr>
                                    </table>
                                </div>
                            </div>
...
`),o=new Blob([i],{type:"text/csv;charset=utf-8;"}),r=document.createElement("a"),d=URL.createObjectURL(o);r.setAttribute("href",d),r.setAttribute("download",`security_audits_${n||"export"}.csv`),r.style.visibility="hidden",document.body.appendChild(r),r.click(),document.body.removeChild(r)}catch(t){console.error("Export failed:",t),alert("Export failed: "+t.message)}};window.app_changeAnnualYear=n=>{window.app_annualYear=(window.app_annualYear||new Date().getFullYear())+n,window.app_renderAnnualPlanPage()};window.app_toggleAnnualLegendFilter=n=>{const e=window.app_annualLegendFilters||{leave:!0,event:!0,work:!0,overdue:!0,completed:!0};Object.prototype.hasOwnProperty.call(e,n)&&(e[n]=!e[n],window.app_annualLegendFilters=e,window.app_renderAnnualPlanPage())};window.app_showAnnualDayDetails=async n=>{if(!n)return;const e=window._currentPlans||await window.AppCalendar.getPlans(),t=window.app_annualLegendFilters||{leave:!0,event:!0,work:!0},a=window.AppAuth.getUser()||{},s=a.role==="Administrator"||a.isAdmin,i=(window.app_getDayEvents(n,e,{includeAuto:!1,userId:s?null:a.id})||[]).filter(d=>d.type==="leave"?!!t.leave:d.type==="work"?!!t.work:(d.type==="holiday",!!t.event)),o=i.length?i.map(d=>{const l=d.type||"event",c=l==="leave"?"background:#fee2e2;color:#991b1b;":l==="work"?"background:#e0e7ff;color:#3730a3;":l==="holiday"?"background:#f1f5f9;color:#334155;":"background:#dcfce7;color:#166534;",m=l==="work"&&Array.isArray(d.plans)&&d.plans.length?`<ul style="margin:0.5rem 0 0 1rem; padding:0; color:#475569; font-size:0.8rem;">
            ...
            </div>`;window.app_showModal(r,"annual-day-detail-modal")};window.app_toggleAnnualView=n=>{window.app_annualViewMode=n,window.app_renderAnnualPlanPage()};window.app_jumpToAnnualToday=()=>{const n=new Date;window.app_annualYear=n.getFullYear(),window.app_selectedAnnualDate=n.toISOString().split("T")[0],window.app_renderAnnualPlanPage().then(()=>{window.app_showAnnualDayDetails(window.app_selectedAnnualDate)})};window.app_renderAnnualPlanPage=async()=>{const n=document.getElementById("page-content");n&&(n.innerHTML=await R.renderAnnualPlan())};window.app_setAnnualStaffFilter=n=>{window.app_annualStaffFilter=String(n||"").trim(),window.app_renderAnnualPlanPage()};window.app_setAnnualListSearch=n=>{window.app_annualListSearch=String(n||"").trim(),window.app_renderAnnualPlanPage()};window.app_setAnnualListSort=n=>{window.app_annualListSort=String(n||"date-asc").trim(),window.app_renderAnnualPlanPage()};window.app_renderTimesheetPage=async()=>{const n=document.getElementById("page-content");n&&(n.innerHTML=await R.renderTimesheet())};window.app_setTimesheetView=n=>{window.app_timesheetViewMode=n==="calendar"?"calendar":"list",window.app_renderTimesheetPage()};window.app_changeTimesheetMonth=n=>{const e=new Date,t=Number.isInteger(window.app_timesheetMonth)?window.app_timesheetMonth:e.getMonth(),a=Number.isInteger(window.app_timesheetYear)?window.app_timesheetYear:e.getFullYear(),s=new Date(a,t,1);s.setMonth(s.getMonth()+n),window.app_timesheetMonth=s.getMonth(),window.app_timesheetYear=s.getFullYear(),window.app_renderTimesheetPage()};window.app_jumpTimesheetToday=()=>{const n=new Date;window.app_timesheetMonth=n.getMonth(),window.app_timesheetYear=n.getFullYear(),window.app_renderTimesheetPage()};window.app_closeModal=n=>{const e=n&&n.closest?n.closest(".modal-overlay"):null;e&&e.remove()};window.app_getSystemUpdateNotes=()=>[{date:"2026-02-21",summary:"Check for System Update now shows this quick update popup before refreshing."},{date:"2026-02-21",summary:"The update action shortcut was changed from Ctrl+F5 to Ctrl+Shift+R."}];window.app_showSystemUpdatePopup=()=>{const n="system-update-modal",e=Te(),t=(window.app_getSystemUpdateNotes()||[]).slice(0,5),a=t.length?t.map(d=>`
                <li style="margin:0 0 0.7rem 0; color:#334155; line-height:1.45;">
                    <span style="display:block; font-size:0.72rem; color:#64748b; font-weight:700;">${te(d.date||"")}</span>
                    <span>${te(d.summary||"")}</span>
                </li>
            `).join(""):'<li style="color:#64748b;">No update notes available.</li>',s=e.active?`
                <div style="background:#f8fafc; border:1px solid #e2e8f0; border-radius:10px; padding:0.6rem 0.75rem; margin-bottom:0.8rem;">
                    ...
                    <div style="font-size:0.74rem; color:#475569; margin-top:0.15rem;">
                        Commit: ${te((e.commitSha||"").slice(0,7)||e.releaseId)}
                        ${e.deployedAt?` • Deployed: ${te(e.deployedAt)}`:""}
                    </div>
        ...
        `;window.app_showModal(i,n);const o=()=>{const d=document.getElementById("system-update-countdown");if(!d)return;const l=Te();d.textContent=l.countdownLabel};o();const r=setInterval(()=>{if(!document.getElementById(n)){clearInterval(r);return}o()},1e3)};window.app_forceRefresh=async()=>{Da(!0);try{if(navigator.serviceWorker){const n=await navigator.serviceWorker.getRegistrations();await Promise.all(n.map(e=>e.unregister()))}if(window.caches){const n=await caches.keys();await Promise.all(n.map(e=>caches.delete(e)))}}catch(n){console.warn("Force refresh cleanup failed:",n)}window.location.reload(!0)};ss();console.log("App.js Loaded & Globals Ready");
