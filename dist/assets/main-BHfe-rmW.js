(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))a(s);new MutationObserver(s=>{for(const i of s)if(i.type==="childList")for(const o of i.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&a(o)}).observe(document,{childList:!0,subtree:!0});function t(s){const i={};return s.integrity&&(i.integrity=s.integrity),s.referrerPolicy&&(i.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?i.credentials="include":s.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function a(s){if(s.ep)return;s.ep=!0;const i=t(s);fetch(s.href,i)}})();const x={WORK_START_TIME:"09:00",LATE_CUTOFF_TIME:"09:15",WORK_END_TIME:"17:00",LATE_CUTOFF_MINUTES:555,MINOR_LATE_END_MINUTES:615,LATE_END_MINUTES:720,POST_NOON_END_MINUTES:810,AFTERNOON_START_MINUTES:720,EARLY_DEPARTURE_MINUTES:1020,FY_START_MONTH:3,IS_SATURDAY_OFF:n=>{const t=new Date(n).getDate(),a=Math.ceil(t/7);return a===2||a===4},LATE_GRACE_COUNT:3,LATE_DEDUCTION_PER_BLOCK:.5,EXTRA_HOURS_FOR_HALF_DAY_OFFSET:4,READ_CACHE_TTLS:{users:6e4,settings:3e5,minutes:3e4,attendanceSummary:3e4,staffMessages:2e4,dailySummaryReadMs:6e4},READ_OPT_FLAGS:{FF_READ_OPT_DB_QUERIES:!0,FF_READ_OPT_TARGETED_REALTIME:!0,FF_READ_OPT_ANALYTICS_CACHE:!0,FF_SHARED_DAILY_SUMMARY:!0,FF_SUMMARY_LOCKING:!0,ENABLE_SIMULATION_MODULE:!1,ENABLE_READ_TELEMETRY:!0,ENABLE_PRESENCE_HEARTBEAT:!1},SUMMARY_POLICY:{STALENESS_MS:1440*60*1e3,TEAM_ACTIVITY_LIMIT:15,LOCK_TTL_MS:9e4,SCHEMA_VERSION:2,RECOMPUTE_CUTOFF_HOUR_IST:17,FALLBACK_TO_PREVIOUS_DAY:!0},HERO_POLICY:{SCHEMA_VERSION:2,WINDOW_DAYS:7,FALLBACK_LOOKBACK_DAYS:90,WEIGHTS:{taskExecution:.45,taskCompletionRate:.2,taskInProgressSupport:.1,taskMissPenalty:.1},ATTENDANCE_MODIFIER:{base:.9,maxBonus:.15,consistencyImpact:.65,effortImpact:.35},CAPS:{hours:40,qualityChars:500},DEFAULT_ACTIVITY_SCORE:70,MIN_EVIDENCE:{minDays:1,minDurationMs:1,minPlannedTasks:1}},SIMULATION_POLICY:{LEGACY_DUMMY_CLEANUP:{ENABLED:!0,FLAG_KEY:"legacy_dummy_cleanup_v1",TARGET_USER_IDS:["sim_punctual","sim_admin_new"],TARGET_USERNAMES:["jomit_p","maria"],AUDIT_COLLECTION:"system_audit_logs"}}},za={apiKey:"AIzaSyC7a8AxukI0-egXimYTedwCa2RFnMTBu84",authDomain:"crwiattendance.firebaseapp.com",projectId:"crwiattendance",storageBucket:"crwiattendance.firebasestorage.app",messagingSenderId:"462155106938",appId:"1:462155106938:web:18291b04a5a3bec185c9c3",measurementId:"G-X6W45TV4QR"};typeof firebase<"u"&&!firebase.apps.length&&(firebase.initializeApp(za),console.log("Firebase Initialized (Compat Mode)"));const ta=typeof firebase<"u"?firebase.firestore():null;typeof window<"u"&&(window.AppFirestore=ta);class ja{constructor(){this.db=ta,this.cache=new Map,this.telemetry={get:0,getAll:0,query:0,queryMany:0,listen:0,listenQuery:0,writes:0,docsRead:0,byCollection:{}}}async init(){if(!this.db){console.error("Firebase not initialized! Check config.");return}console.log("Firestore adapter ready.")}getFlags(){return x&&x.READ_OPT_FLAGS||{}}track(e,t,a=0){this.getFlags().ENABLE_READ_TELEMETRY&&(typeof this.telemetry[e]=="number"&&(this.telemetry[e]+=1),this.telemetry.docsRead+=Math.max(0,Number(a)||0),this.telemetry.byCollection[t]||(this.telemetry.byCollection[t]={ops:0,docsRead:0}),this.telemetry.byCollection[t].ops+=1,this.telemetry.byCollection[t].docsRead+=Math.max(0,Number(a)||0))}getReadTelemetry(){return JSON.parse(JSON.stringify(this.telemetry))}clearReadTelemetry(){this.telemetry={get:0,getAll:0,query:0,queryMany:0,listen:0,listenQuery:0,writes:0,docsRead:0,byCollection:{}}}getCacheKey(e,t,a={}){return`${e}:${t}:${JSON.stringify(a)}`}invalidateCollectionCache(e){const t=`:${e}:`;for(const a of this.cache.keys())a.includes(t)&&this.cache.delete(a)}async getCached(e,t,a){const s=Date.now(),i=this.cache.get(e);if(i&&i.expiresAt>s)return i.value;const o=await a();return this.cache.set(e,{value:o,expiresAt:s+Math.max(0,Number(t)||0)}),o}async getOrGenerateSummary(e,t,a){if(!e||typeof t!="function")throw new Error("getOrGenerateSummary requires a key and generator function.");const s=this.getCacheKey("summary","computed",{summaryKey:e}),i=typeof a=="number"?a:x?.READ_CACHE_TTLS?.attendanceSummary||3e4;return this.getCached(s,i,t)}async sleep(e){return new Promise(t=>setTimeout(t,Math.max(0,Number(e)||0)))}getSummarySchemaVersion(){return Number(x?.SUMMARY_POLICY?.SCHEMA_VERSION||1)}getIstNow(){const e=new Date;return new Date(e.toLocaleString("en-US",{timeZone:"Asia/Kolkata"}))}toDateKey(e){const t=e instanceof Date?e:new Date(e),a=t.getFullYear(),s=String(t.getMonth()+1).padStart(2,"0"),i=String(t.getDate()).padStart(2,"0");return`${a}-${s}-${i}`}getISTDateKeys(){const e=this.getIstNow(),t=new Date(e);return t.setDate(t.getDate()-1),{todayKey:this.toDateKey(e),yesterdayKey:this.toDateKey(t)}}shouldRecomputeNowIST(e){const t=Number.isFinite(Number(e))?Number(e):Number(x?.SUMMARY_POLICY?.RECOMPUTE_CUTOFF_HOUR_IST||17);return this.getIstNow().getHours()>=Math.max(0,Math.min(23,t))}isSummaryFresh(e,t){if(!e||typeof e!="object")return!1;const a=Number(e.generatedAt||0),s=Number(e.version||0);return!a||!s||s!==this.getSummarySchemaVersion()?!1:Date.now()-a<=Math.max(0,Number(t)||0)}async getDailySummary(e){const t=String(e||"").trim();if(!t)return null;const a=x?.READ_CACHE_TTLS?.dailySummaryReadMs||6e4,s=this.getCacheKey("dailySummary","daily_summaries",{key:t});return this.getCached(s,a,()=>this.get("daily_summaries",t))}listenDailySummary(e,t){const a=String(e||"").trim();if(!a)return null;const s=this.getCacheKey("dailySummary","daily_summaries",{key:a});return this.listenDoc("daily_summaries",a,(i,o)=>{if(i){const r=x?.READ_CACHE_TTLS?.dailySummaryReadMs||6e4;this.cache.set(s,{value:i,expiresAt:Date.now()+r})}t&&t(i,o)})}async getSummaryByDateKey(e){return this.getDailySummary(e)}async getLatestSuccessfulSummaryMeta(){const e=x?.READ_CACHE_TTLS?.dailySummaryReadMs||6e4,t=this.getCacheKey("dailySummaryMeta","daily_summaries_meta",{key:"latest_success"});return this.getCached(t,e,()=>this.get("daily_summaries_meta","latest_success"))}async setLatestSuccessfulSummaryMeta({dateKey:e,generatedAt:t,version:a}={}){const s=String(e||"").trim();if(!s)return;const i={id:"latest_success",dateKey:s,generatedAt:Number(t||Date.now()),version:Number(a||this.getSummarySchemaVersion())};await this.put("daily_summaries_meta",i)}async getDailySummaryWithFallback({todayKey:e,yesterdayKey:t,staleAfterMs:a}={}){const s=Math.max(1e3,Number(a)||Number(x?.SUMMARY_POLICY?.STALENESS_MS)||864e5),i=x?.SUMMARY_POLICY?.FALLBACK_TO_PREVIOUS_DAY!==!1,o=await this.getSummaryByDateKey(e);if(this.isSummaryFresh(o,s))return{summary:o,source:"today"};if(i){const l=await this.getSummaryByDateKey(t);if(l&&typeof l=="object")return{summary:l,source:"yesterday"}}const r=await this.getLatestSuccessfulSummaryMeta(),d=String(r?.dateKey||"").trim();if(d){const l=await this.getSummaryByDateKey(d);if(l&&typeof l=="object")return{summary:l,source:"latest_success"}}return{summary:o||null,source:"none"}}async putDailySummary(e,t={}){const a=String(e||"").trim();if(!a)throw new Error("putDailySummary requires dateKey.");const s={id:a,dateKey:a,version:this.getSummarySchemaVersion(),...t};return this.put("daily_summaries",s)}async acquireSummaryLock(e,t,a){const s=String(e||"").trim(),i=String(t||"").trim();if(!s||!i||!this.db||!this.db.runTransaction)return!1;if(x?.READ_OPT_FLAGS?.FF_SUMMARY_LOCKING===!1)return!0;const o=Math.max(1e3,Number(a)||Number(x?.SUMMARY_POLICY?.LOCK_TTL_MS)||9e4),r=this.db.collection("summary_locks").doc(s),d=Date.now();try{return await this.db.runTransaction(async c=>{const m=await c.get(r);if(m.exists){const u=m.data()||{},p=String(u.ownerId||"");if(Number(u.expiresAt||0)>d&&p&&p!==i)return!1}return c.set(r,{id:s,dateKey:s,ownerId:i,createdAt:d,expiresAt:d+o},{merge:!0}),!0})===!0}catch(l){return console.warn("Failed to acquire summary lock:",l),!1}}async releaseSummaryLock(e,t){const a=String(e||"").trim(),s=String(t||"").trim();if(!a||!s||!this.db||!this.db.runTransaction||x?.READ_OPT_FLAGS?.FF_SUMMARY_LOCKING===!1)return;const i=this.db.collection("summary_locks").doc(a);try{await this.db.runTransaction(async o=>{const r=await o.get(i);if(!r.exists)return;const d=r.data()||{};String(d.ownerId||"")===s&&o.delete(i)})}catch(o){console.warn("Failed to release summary lock:",o)}}async getOrCreateDailySummary({dateKey:e,yesterdayKey:t,generatorFn:a,staleAfterMs:s,lockTtlMs:i}={}){const o=this.getISTDateKeys(),r=String(e||o.todayKey||"").trim(),d=String(t||o.yesterdayKey||"").trim();if(!r||typeof a!="function")throw new Error("getOrCreateDailySummary requires dateKey and generatorFn.");const l=Math.max(1e3,Number(s)||Number(x?.SUMMARY_POLICY?.STALENESS_MS)||864e5),c=Math.max(1e3,Number(i)||Number(x?.SUMMARY_POLICY?.LOCK_TTL_MS)||9e4),m=String(window.AppAuth?.getUser?.()?.id||`anon_${Math.random().toString(36).slice(2,10)}`),u=await this.getDailySummaryWithFallback({todayKey:r,yesterdayKey:d,staleAfterMs:l});if(u.summary&&u.source==="today"&&this.isSummaryFresh(u.summary,l))return{...u.summary,_source:"shared_today"};if(!this.shouldRecomputeNowIST(x?.SUMMARY_POLICY?.RECOMPUTE_CUTOFF_HOUR_IST))return u.summary?{...u.summary,_source:`fallback_${u.source}`}:null;if(await this.acquireSummaryLock(r,m,c))try{const y={...await a()||{},generatedAt:Date.now(),generatedBy:m,version:this.getSummarySchemaVersion()};return await this.putDailySummary(r,y),await this.setLatestSuccessfulSummaryMeta({dateKey:r,generatedAt:y.generatedAt,version:y.version}),{dateKey:r,...y,_source:"generated"}}finally{await this.releaseSummaryLock(r,m)}const f=[350,700,1200,1800];for(const h of f){await this.sleep(h);const y=await this.getDailySummary(r);if(this.isSummaryFresh(y,l))return{...y,_source:"shared"}}return u.summary?{...u.summary,_source:`fallback_${u.source}`}:null}applyFilters(e,t=[]){let a=e;return(t||[]).forEach(s=>{!s||!s.field||!s.operator||(a=a.where(s.field,s.operator,s.value))}),a}applyOptions(e,t={}){let a=e;return t.orderBy&&(Array.isArray(t.orderBy)?t.orderBy:[t.orderBy]).forEach(i=>{i&&(typeof i=="string"?a=a.orderBy(i):i.field&&(a=a.orderBy(i.field,i.direction||"asc")))}),t.limit&&(a=a.limit(t.limit)),t.startAt!==void 0&&(a=a.startAt(t.startAt)),t.endAt!==void 0&&(a=a.endAt(t.endAt)),a}async getAll(e){try{const a=(await this.db.collection(e).get()).docs.map(s=>({...s.data(),id:s.id}));return this.track("getAll",e,a.length),a}catch(t){throw console.error(`Error getting all from ${e}:`,t),t}}async get(e,t){if(!t)return null;try{const a=String(t),i=await this.db.collection(e).doc(a).get();return i.exists?(this.track("get",e,1),{...i.data(),id:i.id}):(this.track("get",e,0),null)}catch(a){throw console.error(`Error getting ${t} from ${e}:`,a),a}}async add(e,t){if(t.id)return this.put(e,t);try{const a=await this.db.collection(e).add(t);return this.telemetry.writes+=1,this.invalidateCollectionCache(e),window.dispatchEvent&&window.dispatchEvent(new CustomEvent("app:db-write",{detail:{collection:e,op:"add"}})),a.id}catch(a){throw console.error(`Error adding to ${e}:`,a),a}}async put(e,t){if(!t.id)throw new Error("Item must have an ID for 'put' operation.");try{const a=String(t.id);return await this.db.collection(e).doc(a).set(t,{merge:!0}),this.telemetry.writes+=1,this.invalidateCollectionCache(e),window.dispatchEvent&&window.dispatchEvent(new CustomEvent("app:db-write",{detail:{collection:e,op:"put"}})),a}catch(a){throw console.error(`Error putting ${t.id} to ${e}:`,a),a}}async delete(e,t){if(t)try{const a=String(t);await this.db.collection(e).doc(a).delete(),this.telemetry.writes+=1,this.invalidateCollectionCache(e),window.dispatchEvent&&window.dispatchEvent(new CustomEvent("app:db-write",{detail:{collection:e,op:"delete"}}))}catch(a){throw console.error(`Error deleting ${t} from ${e}:`,a),a}}async query(e,t,a,s){try{const o=(await this.db.collection(e).where(t,a,s).get()).docs.map(r=>({...r.data(),id:r.id}));return this.track("query",e,o.length),o}catch(i){throw console.error(`Error querying ${e}:`,i),i}}async queryMany(e,t=[],a={}){if(!this.getFlags().FF_READ_OPT_DB_QUERIES)return this.getAll(e);try{let i=this.db.collection(e);i=this.applyFilters(i,t),i=this.applyOptions(i,a);const r=(await i.get()).docs.map(d=>({...d.data(),id:d.id}));return this.track("queryMany",e,r.length),r}catch(i){return console.warn(`queryMany failed for ${e}, falling back to getAll`,i),this.getAll(e)}}async getManyByIds(e,t=[]){const a=Array.from(new Set((t||[]).filter(Boolean).map(o=>String(o))));if(!a.length)return[];const s=[];for(let o=0;o<a.length;o+=10)s.push(a.slice(o,o+10));return(await Promise.all(s.map(async o=>{try{const r=await this.queryMany(e,[{field:"id",operator:"in",value:o}]);return r&&r.length?r:Promise.all(o.map(d=>this.get(e,d)))}catch{return Promise.all(o.map(r=>this.get(e,r)))}}))).flat().filter(Boolean)}listenDoc(e,t,a){if(!this.db||!t)return null;const s=String(t);try{return this.db.collection(e).doc(s).onSnapshot(i=>{const o=i.exists?{...i.data(),id:i.id}:null;this.track("listen",e,1),a(o,i)},i=>{console.error(`Realtime listener error in ${e}/${s}:`,i)})}catch(i){return console.error(`Error setting up listener for ${e}/${s}:`,i),null}}listenQuery(e,t=[],a={},s){if(!this.db)return null;try{let i=this.db.collection(e);return i=this.applyFilters(i,t),i=this.applyOptions(i,a),i.onSnapshot(o=>{const r=o.docs.map(d=>({...d.data(),id:d.id}));this.track("listenQuery",e,r.length),s(r,o)},o=>{console.error(`Realtime query listener error in ${e}:`,o)})}catch(i){return console.warn(`listenQuery failed for ${e}, falling back to listen`,i),this.listen(e,s)}}listen(e,t){return this.db?this.db.collection(e).onSnapshot(a=>{const s=a.docs.map(i=>({...i.data(),id:i.id}));this.track("listen",e,s.length),t(s,a)},a=>{console.error(`Realtime listener error in ${e}:`,a)}):null}}const q=new ja;typeof window<"u"&&(window.AppDB=q);class Wa{constructor(){this.currentUser=null,this.sessionKey="crwi_session_user",this.heartbeatInterval=null,this.userDocUnsubscribe=null}async init(){await q.init();const e=localStorage.getItem(this.sessionKey);e&&(this.currentUser=await q.get("users",e),this.currentUser&&(this.startHeartbeat(),this.startCurrentUserSync()))}async refreshCurrentUserFromDB(){const e=localStorage.getItem(this.sessionKey);if(!e)return this.currentUser=null,null;if(this.userDocUnsubscribe&&this.currentUser&&this.currentUser.id===e)return this.currentUser;const t=await q.get("users",e);return this.currentUser=t||null,this.currentUser}async login(e,t){const a=q.getCached?await q.getCached(q.getCacheKey("authUsers","users",{mode:"login"}),x?.READ_CACHE_TTLS?.users||6e4,()=>q.getAll("users")):await q.getAll("users"),s=e.trim().toLowerCase(),i=t.trim(),o=a.find(r=>{const d=(r.username||"").toLowerCase().trim(),l=(r.email||"").toLowerCase().trim();return(d===s||l===s)&&r.password.trim()===i});return o?(this.currentUser=o,localStorage.setItem(this.sessionKey,o.id),this.startHeartbeat(),this.startCurrentUserSync(),!0):(console.warn("Login failed: invalid credentials."),!1)}logout(){this.stopHeartbeat(),this.stopCurrentUserSync(),this.currentUser=null,localStorage.removeItem(this.sessionKey),window.location.reload()}getUser(){return this.currentUser}async updateUser(e){const t=await q.get("users",e.id);if(!t)return!1;const a={...t,...e};return e.isAdmin===!0||e.isAdmin==="true"?a.isAdmin=!0:a.isAdmin=!1,a.role=e.role||t.role||"Employee",console.log(`Auth: User ${a.id} update - Role: ${a.role}, Admin: ${a.isAdmin}`),e.name&&e.name!==t.name&&!e.avatar&&(a.avatar=`https://ui-avatars.com/api/?name=${e.name}&background=random&color=fff`),await q.put("users",a),this.currentUser&&this.currentUser.id===a.id&&(this.currentUser=a),!0}startHeartbeat(){if(!(x&&x.READ_OPT_FLAGS||{}).ENABLE_PRESENCE_HEARTBEAT){this.stopHeartbeat();return}this.heartbeatInterval&&clearInterval(this.heartbeatInterval);const t=async()=>{if(this.currentUser&&q)try{await q.put("users",{id:this.currentUser.id,lastSeen:Date.now()})}catch(a){console.warn("Heartbeat update failed:",a)}};t(),this.heartbeatInterval=setInterval(t,12e4),console.log("Presence Heartbeat started.")}stopHeartbeat(){this.heartbeatInterval&&(clearInterval(this.heartbeatInterval),this.heartbeatInterval=null,console.log("Presence Heartbeat stopped."))}startCurrentUserSync(){this.stopCurrentUserSync();const e=localStorage.getItem(this.sessionKey);if(!(!e||!window.AppFirestore))try{this.userDocUnsubscribe=window.AppFirestore.collection("users").doc(String(e)).onSnapshot(t=>{if(!t.exists){this.currentUser=null;return}const a={...t.data(),id:t.id};this.currentUser=a,window.dispatchEvent(new CustomEvent("app:user-sync",{detail:a}))},t=>{console.warn("Current user realtime sync failed:",t)})}catch(t){console.warn("Failed to start current user sync:",t)}}stopCurrentUserSync(){typeof this.userDocUnsubscribe=="function"&&this.userDocUnsubscribe(),this.userDocUnsubscribe=null}}const Q=new Wa;typeof window<"u"&&(window.AppAuth=Q);class Ya{async getStatus(){const e=await(Q.refreshCurrentUserFromDB?Q.refreshCurrentUserFromDB():Q.getUser());if(!e)return{status:"out",lastCheckIn:null};if(e.status==="in"&&e.lastCheckIn)try{const t=new Date(e.lastCheckIn),a=new Date,s=t.toISOString().split("T")[0],i=a.toISOString().split("T")[0];if(s<i)return{status:"out",lastCheckIn:null,staleSession:!0}}catch(t){console.warn("Date parsing error in getStatus:",t)}return{status:e.status||"out",lastCheckIn:e.lastCheckIn}}async checkIn(e,t,a="Unknown Location"){const s=await(Q.refreshCurrentUserFromDB?Q.refreshCurrentUserFromDB():Q.getUser());if(!s)throw new Error("User not authenticated");let i=!1,o="",r=null,d=null;if(s.status==="in"&&s.lastCheckIn){const c=new Date(s.lastCheckIn),m=new Date,u=`${c.getFullYear()}-${String(c.getMonth()+1).padStart(2,"0")}-${String(c.getDate()).padStart(2,"0")}`,p=`${m.getFullYear()}-${String(m.getMonth()+1).padStart(2,"0")}-${String(m.getDate()).padStart(2,"0")}`;if(u<p){const h=new Date(c.getTime()+144e5),y={status:"Half Day",dayCredit:this.getDayCredit("Half Day"),lateCountable:!1},w=s.currentLocation||s.lastLocation||null,b=new Date().toISOString(),v={id:String(Date.now()),user_id:s.id,date:h.toISOString().split("T")[0],checkIn:c.toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"}),checkOut:h.toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"}),duration:this.msToTime(144e5),durationMs:144e5,type:y.status,dayCredit:y.dayCredit,lateCountable:y.lateCountable,extraWorkedMs:0,policyVersion:"v2",location:w?.address||"Missed checkout session",lat:w?.lat??null,lng:w?.lng??null,checkOutLocation:"System closure on next check-in",outLat:null,outLng:null,workDescription:"System closure: missed checkout auto-closed as half day. Reason required on next login.",locationMismatched:!1,locationExplanation:"",activityScore:0,autoCheckout:!0,autoCheckoutReason:"missed_checkout_next_login",autoCheckoutAt:b,autoCheckoutRequiresApproval:!1,autoCheckoutExtraApproved:null,missedCheckoutResolved:!0,missedCheckoutPolicy:"half_day_on_missed_checkout",missedCheckoutReasonRequired:!0,missedCheckoutReasonStatus:"pending",missedCheckoutReason:"",missedCheckoutReasonSubmittedAt:null,missedCheckoutReviewedBy:"",missedCheckoutReviewedAt:"",missedCheckoutReviewNote:"",systemClosedAt:b,synced:!1};await q.add("attendance",v),r=v.id,d=v.date,s.status="out",s.lastCheckOut=h.getTime(),s.lastLocation=w,s.lastCheckOutLocation={lat:null,lng:null,address:"System closure on next check-in"},s.locationMismatched=!1,s.lastCheckIn=null,s.currentLocation=null,i=!0,o="Previous open session was closed as half day because checkout was missed. Please submit a reason for admin verification."}else return{ok:!1,conflict:!0,message:"Status updated from another device."}}s.status="in",s.lastCheckIn=Date.now();const l=a&&a!=="Unknown Location"?a:e&&t?`Lat: ${Number(e).toFixed(4)}, Lng: ${Number(t).toFixed(4)}`:"Unknown Location";return s.currentLocation={lat:e,lng:t,address:l},await q.put("users",s),{ok:!0,resolvedMissedCheckout:i,noticeMessage:o,missedCheckoutReasonRequired:i,missedCheckoutLogId:r,missedCheckoutDate:d}}async checkOut(e="",t=null,a=null,s="Detected Location",i=!1,o="",r={}){const d=await(Q.refreshCurrentUserFromDB?Q.refreshCurrentUserFromDB():Q.getUser());if(!d||d.status!=="in")return{ok:!1,conflict:!0,message:"Status updated from another device."};const l=new Date(d.lastCheckIn),c=r.checkOutTime?new Date(r.checkOutTime):new Date,m=c-l,u=this.evaluateAttendanceStatus(l,m),p=window.AppActivity?window.AppActivity.getStats():{score:0},f={id:String(Date.now()),user_id:d.id,date:c.toISOString().split("T")[0],checkIn:l.toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"}),checkOut:c.toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"}),duration:this.msToTime(m),durationMs:m,type:u.status,dayCredit:u.dayCredit,lateCountable:u.lateCountable,extraWorkedMs:u.extraWorkedMs||0,policyVersion:"v2",location:d.currentLocation?.address||"Checked In Location",lat:d.currentLocation?.lat,lng:d.currentLocation?.lng,checkOutLocation:s||(t&&a?`Lat: ${Number(t).toFixed(4)}, Lng: ${Number(a).toFixed(4)}`:"Detected Location"),outLat:t,outLng:a,workDescription:e||"",locationMismatched:i,locationExplanation:o||"",activityScore:p.score,autoCheckout:!!r.autoCheckout,autoCheckoutReason:r.autoCheckoutReason||"",autoCheckoutAt:r.autoCheckoutAt||null,autoCheckoutRequiresApproval:!!r.autoCheckoutRequiresApproval,autoCheckoutExtraApproved:r.autoCheckoutExtraApproved??null,overtimePrompted:!!r.overtimePrompted,overtimeReasonTag:r.overtimeReasonTag||"",overtimeExplanation:r.overtimeExplanation||"",overtimeCappedToEightHours:!!r.overtimeCappedToEightHours,taskUpdates:Array.isArray(r.taskUpdates)?r.taskUpdates:[],entrySource:"checkin_checkout",attendanceEligible:!0,synced:!1};return await q.add("attendance",f),d.status="out",d.lastCheckOut=Date.now(),d.lastLocation=d.currentLocation,d.lastCheckOutLocation={lat:t,lng:a,address:s},d.locationMismatched=i,d.lastCheckIn=null,d.currentLocation=null,await q.put("users",d),window.AppActivity&&window.AppActivity.stop(),{ok:!0,conflict:!1}}async addAdminLog(e,t){const a={id:String(Date.now()),user_id:e,...t,isManualOverride:t.isManualOverride===!0,entrySource:t.entrySource||"admin_override",attendanceEligible:Object.prototype.hasOwnProperty.call(t,"attendanceEligible")?t.attendanceEligible===!0:!0,synced:!1};return await q.add("attendance",a),a}async deleteLog(e){if(e)return await q.delete("attendance",e),!0}async updateLog(e,t){if(!e)return;const a=await q.get("attendance",e);if(!a)throw new Error("Log not found");const s={...a,...t,isManualOverride:Object.prototype.hasOwnProperty.call(t,"isManualOverride")?t.isManualOverride===!0:!!a.isManualOverride,entrySource:t.entrySource||a.entrySource||"admin_override",attendanceEligible:Object.prototype.hasOwnProperty.call(t,"attendanceEligible")?t.attendanceEligible===!0:Object.prototype.hasOwnProperty.call(a,"attendanceEligible")?a.attendanceEligible===!0:!0,id:e};return await q.put("attendance",s),s}async addManualLog(e){const t=Q.getUser();if(!t)return;const a=this.buildDateTime(e.date,e.checkIn),s=this.buildDateTime(e.date,e.checkOut),i=a&&s?s-a:0,o=this.evaluateAttendanceStatus(a||new Date,i),r=String(e.type||"").trim(),d=!r||r==="Manual"?o.status:r,l=Object.prototype.hasOwnProperty.call(e,"attendanceEligible")?e.attendanceEligible===!0:d!=="Work Log",c=l?d:r||"Work Log",m={id:String(Date.now()),user_id:t.id,...e,type:c,durationMs:typeof e.durationMs=="number"?e.durationMs:i,dayCredit:l?typeof e.dayCredit=="number"?e.dayCredit:o.dayCredit:0,lateCountable:l&&(e.lateCountable===!0||c==="Late"),extraWorkedMs:l?typeof e.extraWorkedMs=="number"?e.extraWorkedMs:o.extraWorkedMs||0:0,entrySource:e.entrySource||"staff_manual_work",attendanceEligible:l,synced:!1};return await q.add("attendance",m),m}async getLogs(e=null){const t=e||Q.getUser()?.id;if(!t)return[];try{const a=window.AppFirestore;if(!a)return[];let s=a.collection("attendance");s=s.where("user_id","==",t);const r=(await s.get()).docs.map(c=>({...c.data(),id:c.id})).sort((c,m)=>m.id-c.id).map(c=>((!c.location||c.location==="Unknown Location")&&c.lat&&c.lng&&(c.location=`Lat: ${Number(c.lat).toFixed(4)}, Lng: ${Number(c.lng).toFixed(4)}`),c)),d=new Set,l=r.filter(c=>{const m=`${c.date}|${c.checkIn}`;return d.has(m)?!1:(d.add(m),!0)});try{const c=await q.get("users",t);if(c&&c.status==="in"&&c.lastCheckIn){const m=new Date(c.lastCheckIn),u={id:"active_now",date:m.toLocaleDateString(),checkIn:m.toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"}),checkOut:"Active Now",duration:"Working...",type:"Office",location:c.currentLocation?.address&&c.currentLocation.address!=="Unknown Location"?c.currentLocation.address:c.currentLocation?.lat&&c.currentLocation?.lng?`Lat: ${Number(c.currentLocation.lat).toFixed(4)}, Lng: ${Number(c.currentLocation.lng).toFixed(4)}`:"Current Session"};l.unshift(u)}}catch(c){console.warn("Could not fetch active status for logs",c)}return l.slice(0,50)}catch(a){return console.warn("Optimized log fetch failed, falling back to simple filter",a),[]}}async getAllLogs(){return await q.getAll("attendance")}msToTime(e){let t=Math.floor(e/6e4%60);return`${Math.floor(e/(1e3*60*60)%24)}h ${t}m`}buildDateTime(e,t){if(!e||!t)return null;const a=`${e}T${t}:00`,s=new Date(a);return Number.isNaN(s.getTime())?null:s}normalizeType(e){const t=String(e||"").trim();return!t||t==="Manual"?"Present":t==="Manual/WFH"?"Work - Home":t}getDayCredit(e){const t=this.normalizeType(e);return t==="Half Day"?.5:t==="Absent"?0:t==="Present"||t==="Present (Late Waived)"||t==="Late"||t==="Work - Home"||t==="On Duty"?1:0}evaluateAttendanceStatus(e,t=0){if(!e||Number.isNaN(e.getTime()))return{status:"Absent",dayCredit:0,lateCountable:!1,extraWorkedMs:0};if(e.getDay()===0)return{status:"Present",dayCredit:1,lateCountable:!1,extraWorkedMs:0};const s=e.getHours()*60+e.getMinutes(),i=Math.max(0,t)/(1e3*60*60),o=(typeof x<"u"&&x?x.LATE_CUTOFF_MINUTES:555)||555,r=(typeof x<"u"&&x?x.MINOR_LATE_END_MINUTES:615)||615,d=(typeof x<"u"&&x?x.LATE_END_MINUTES:720)||720,l=(typeof x<"u"&&x?x.POST_NOON_END_MINUTES:810)||810,c=(typeof x<"u"&&x?x.AFTERNOON_START_MINUTES:720)||720;let m="Present",u=!1,p=0;return s>=c?(i>=8?m="Present":i>=4?m="Half Day":m="Absent",i>4&&(p=Math.max(0,t-14400*1e3)),{status:m,dayCredit:this.getDayCredit(m),lateCountable:!1,extraWorkedMs:p}):(s>l?m="Absent":s>d||s>r?m=i>=4?"Half Day":"Absent":s>o?i>=8?m="Present (Late Waived)":(m="Late",u=!0):i>=8?m="Present":i>=4?m="Half Day":m="Absent",{status:m,dayCredit:this.getDayCredit(m),lateCountable:u,extraWorkedMs:p})}calculateStatus(e){return this.evaluateAttendanceStatus(e,480*60*1e3).status}}const aa=new Ya;typeof window<"u"&&(window.AppAttendance=aa);function _(n){return n==null?"":String(n).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function at(n){return _(n)}function Va(n){return String(n??"").replace(/\\/g,"\\\\").replace(/'/g,"\\'").replace(/"/g,'\\"').replace(/\n/g,"\\n").replace(/\r/g,"\\r")}function Fe(n,e="https://via.placeholder.com/24"){return!n||typeof n!="string"?e:n.startsWith("http")||n.startsWith("data:")||n.startsWith("/")||n.startsWith("./")?n:e}function dt(n){if(!n)return"Never";const e=new Date(n);if(isNaN(e.getTime()))return"Unknown";const t=Math.floor((new Date-e)/1e3);if(t<60)return"just now";let a=t/31536e3;return a>1?Math.floor(a)+" years ago":(a=t/2592e3,a>1?Math.floor(a)+" months ago":(a=t/86400,a>1?Math.floor(a)+" days ago":(a=t/3600,a>1?Math.floor(a)+" hours ago":(a=t/60,a>1?Math.floor(a)+" mins ago":Math.floor(t)+" seconds ago"))))}typeof window<"u"&&(window.safeHtml=_,window.safeAttr=at,window.safeJsStr=Va,window.safeUrl=Fe,window.timeAgo=dt);function Ka(n,e=!0){const t=Math.max(0,Math.min(5,Number(n)||0)),a=Math.floor(t),s=t-a>=.5,i=5-a-(s?1:0);let o='<div class="star-rating-display">';for(let r=0;r<a;r++)o+='<i class="fa-solid fa-star star-filled"></i>';s&&(o+='<i class="fa-solid fa-star-half-stroke star-filled"></i>');for(let r=0;r<i;r++)o+='<i class="fa-regular fa-star star-empty"></i>';return e&&(o+=`<span class="star-rating-number">${t.toFixed(1)}</span>`),o+="</div>",o}function na(n,e=!0){const t=String(n||"to-be-started").toLowerCase();let a="To Be Started",s="fa-circle-dot",i="status-badge-to-be-started";return t==="in-process"||t==="in-progress"?(a="In Progress",s="fa-spinner fa-spin",i="status-badge-in-process"):t==="completed"?(a="Completed",s="fa-circle-check",i="status-badge-completed"):t==="overdue"?(a="Overdue",s="fa-circle-exclamation",i="status-badge-overdue"):(t==="not-completed"||t==="cancelled")&&(a="Not Completed",s="fa-circle-xmark",i="status-badge-not-completed"),`
    ...
    `},xe={controllers:new WeakMap,elements:new Set};function pt(){return window.app_staffActivityState||(window.app_staffActivityState={selectedMonth:new Date().toISOString().slice(0,7),sortKey:"date-desc",logs:[]}),window.app_staffActivityState}let Ht=!1;function Ga(){Ht||typeof document>"u"||(Ht=!0,document.addEventListener("click",async n=>{const e=n.target&&n.target.closest?n.target.closest(".dashboard-leave-btn[data-action][data-leave-id]"):null;if(!e)return;n.preventDefault();const t=String(e.dataset.action||""),a=String(e.dataset.leaveId||"");if(a)try{if(t==="export"){window.AppLeaves?.exportLeave&&await window.AppLeaves.exportLeave(a);return}if(t==="comment"){window.AppLeaves?.commentLeave&&await window.AppLeaves.commentLeave(a);return}if(t==="approve"||t==="reject"){const s=t==="approve"?"Approved":"Rejected",i=window.AppAuth?.getUser?.()?.id;window.AppLeaves?.updateLeaveStatus&&await window.AppLeaves.updateLeaveStatus(a,s,i),window.app_refreshCurrentPage&&await window.app_refreshCurrentPage()}}catch(s){console.error("Dashboard leave action failed:",s)}}))}function me(n,e={}){const t=n?.state||(n?.user?"winner":"no_eligible_data");if(!n||t!=="winner"){const h=n?.reason||(t==="fetch_error"?"Hero stats are temporarily unavailable.":"No eligible hero data available."),y=t==="fetch_error"?"Fetch Error":"No Eligible Data";return`
            <div class="card dashboard-hero-stats-card hero-slot">
                <div class="dashboard-hero-stats-head">
                    ...
                    ${e.generatedAt?`<span class="hero-sync-time" title="Source: ${e.source||n?.source||"unknown"}">Synced ${dt(e.generatedAt)}</span>`:""}
                </div>
        ...
        <div class="card dashboard-hero-stats-card hero-slot ${u?"is-new-summary":""}">
            ...
            <div class="dashboard-hero-stats-body">
                <div class="hero-profile">
                    <img src="${Fe(a.avatar)}" alt="${_(a.name)}" class="hero-avatar">
                    <div class="hero-info">
                        <div class="hero-name">${_(a.name)}</div>
                        <div class="hero-role">${_(a.role||"Staff")}</div>
                    </div>
                </div>
            ...
            <div class="dashboard-hero-stats-foot">
                <span class="dashboard-kpi-tag">${_(f)}</span>
                <span class="dashboard-kpi-tag">Confidence ${p}%</span>
            </div>
        </div>`}function sa(n,e=[],t=null,a=[]){const s=new Date,i=new Date(s);i.setDate(i.getDate()-180);const o=i.toISOString().split("T")[0],r=s.toISOString().split("T")[0],d=t?t.id:window.AppAuth.getUser().id,l=t&&t.name||window.AppAuth.getUser().name;return`
        <div class="card dashboard-worklog-card">
            <div class="dashboard-worklog-head">
                 <h4>Work Log <span class="dashboard-worklog-staff">(${_(l)})</span></h4>
    ...
    `}function ia(n,e,t,a,s=[],i=[]){const o=new Date(e),r=new Date(t);r.setHours(23,59,59,999);const d=n.filter(y=>{const w=new Date(y.date),b=y.workDescription||(y.location&&!y.location.startsWith("Lat:")?y.location:"Standard Activity");return y._displayDesc=b,y._isCollab=!1,y._sortTime=y.checkOut||"00:00",w>=o&&w<=r}),l=[];s.forEach(y=>{const w=new Date(y.date);if(w<o||w>r)return;y.plans.filter(v=>v.tags&&v.tags.some(k=>k.id===a&&k.status==="accepted")).forEach(v=>{l.push({date:y.date,workDescription:`🤝 Collaborated with ${y.userName}: ${v.task}${v.subPlans&&v.subPlans.length>0?` (Sub-tasks: ${v.subPlans.join(", ")})`:""}`,checkOut:"Planned / Accepted",_displayDesc:`🤝 Collaborated with ${y.userName}: ${v.task}${v.subPlans&&v.subPlans.length>0?` (Sub-tasks: ${v.subPlans.join(", ")})`:""}`,_isCollab:!0,_sortTime:"23:59"})})});const c=[];i.forEach(y=>{(y.actionItems||[]).forEach(w=>{if(w.assignedTo!==a)return;const b=w.dueDate||y.date,v=new Date(b);v<o||v>r||c.push({date:b,workDescription:`📋 Meeting Task: ${w.task} (from ${y.title})`,status:w.status||"pending",checkOut:"Action Item",_displayDesc:`📋 Meeting Task: ${w.task} (from ${y.title})`,_isCollab:!1,_isMinute:!0,_meetingId:y.id,_sortTime:"09:00"})})});const m=[...d,...l,...c].sort((y,w)=>{const b=new Date(w.date)-new Date(y.date);return b!==0?b:w._sortTime.localeCompare(y._sortTime)});if(m.length===0)return'<div class="dashboard-activity-empty">No activity descriptions found.</div>';let u="",p="";const f=window.AppAuth.getUser(),h=window.app_hasPerm("dashboard","admin",f);return m.forEach(y=>{y.date!==p&&(u+=`<div class="dashboard-activity-date">${y.date}</div>`,p=y.date);const b=y._isCollab?"#10b981":y._isMinute?"#6366f1":"#e5e7eb",v=y._isCollab?"dashboard-activity-item-collab":y._isMinute?"dashboard-activity-item-minute":"",k=ra(y);let g="";if(y._isCollab||y.status||y._isMinute){const A=window.AppCalendar?window.AppCalendar.getSmartTaskStatus(y.date,y.status):y.status||"to-be-started";g=`
                ...
                </div>`}u+=`<div class="dashboard-activity-item ${v}" style="border-left-color:${b};"><div class="dashboard-activity-desc">${_(y._displayDesc)}</div>${k}${g}<div class="dashboard-activity-meta">${_(y.checkOut||(y.status==="completed"?"Completed":"Planned Activity"))}</div></div>`}),u}function oa(n){const e=pt();e.logs=Array.isArray(n)?n:[],setTimeout(()=>{const s=document.getElementById("staff-activity-list");s&&ya(s)},0);const t=Qa(8),a=mt(e.selectedMonth);return`
        <div class="card dashboard-team-activity-card">
            <div class="dashboard-team-activity-head">
                ...
                <span id="staff-activity-range-label">${_(a)}</span>
            </div>
            <div class="dashboard-team-activity-filters dashboard-team-activity-filters-compact">
                <select class="dashboard-team-select" onchange="window.app_setStaffActivityMonth(this.value)">
                    ${t.map(s=>`<option value="${s.key}" ${s.key===e.selectedMonth?"selected":""}>${_(s.label)}</option>`).join("")}
                </select>
        ...
        </div>`}function ut(n,e){const t=en(n);if(t.length===0)return'<div class="dashboard-activity-empty">No team activities found for the selected month.</div>';const a=tn(t,e),s=a.filter(o=>o._taskStatus==="completed"),i=a.filter(o=>o._taskStatus!=="completed");return`
        <div class="dashboard-team-activity-split-grid">
            ${_t("Completed",s,"No completed tasks in this month.")}
            ${_t("In Progress / Incomplete",i,"No in-progress or incomplete tasks in this month.")}
        </div>
    `}function _t(n,e,t){const a=window.AppAuth.getUser(),s=window.app_hasPerm("dashboard","admin",a),i=e.length===0?`<div class="dashboard-activity-empty">${t}</div>`:e.map(o=>{const r=a&&o.userId===a.id,d=s||r,l=ra(o),c=`
                <div class="dashboard-activity-status-row">
                    ${na(o._taskStatus)}
                ...
                <div class="dashboard-staff-activity-item dashboard-staff-activity-item-compact">
                    <div class="dashboard-staff-name">${_(o.staffName||"Unknown Staff")}<span class="dashboard-team-activity-item-date">${o.date||""}</span></div>
                    <div class="dashboard-activity-desc dashboard-staff-activity-desc">${_(o._displayDesc||"Work Plan Task")}</div>
                    ${l}
                    ${c}
    ...
    `}function ra(n){if(!n)return"";const e=Number.isFinite(Number(n.progressPercent)),t=n.progressStatus?String(n.progressStatus).replace(/_/g," "):"",a=String(n.progressNote||"").trim();if(!e&&!t&&!a&&Array.isArray(n.taskUpdates)&&n.taskUpdates.length>0){const r=n.taskUpdates[0]||{},d=Number.isFinite(Number(r.progressPercent))?`${Number(r.progressPercent)}%`:"",l=r.progressStatus?String(r.progressStatus).replace(/_/g," "):"",c=String(r.progressNote||"").trim();if(!d&&!l&&!c)return"";const m=c?` title="${_(c)}"`:"",u=`${d}${d&&l?" • ":""}${_(l)}`;return`<div class="dashboard-progress-chip"${m}>${u}</div>`}if(!e&&!t&&!a)return"";const s=e?`${Number(n.progressPercent)}%`:"",i=a?` title="${_(a)}"`:"",o=`${s}${s&&t?" • ":""}${_(t)}`;return`<div class="dashboard-progress-chip"${i}>${o}</div>`}function Me(n,e,t,a=""){const i=Number(t.penalty??t.penaltyLeaves??0)>0?'<span class="dashboard-penalty-badge">Penalty Applies</span>':"";return`
        <div class="card dashboard-stats-card" ${a?` data-stats-type="${_(a)}"`:""} role="button" tabindex="0" aria-label="Open ${_(n)} details">
            <div class="dashboard-stats-card-head">
                <div>
                    <h4 class="dashboard-stats-card-title">${_(n)}</h4>
                    <span class="dashboard-stats-card-subtitle">${_(e)}</span>
                </div>
                ${i}
            </div>
            ...
            <div class="dashboard-stats-metric-grid">
                 <div class="dashboard-stats-metric dashboard-stats-metric-late">
                    <div class="dashboard-stats-metric-value">${_(t.totalLateDuration)}</div>
                    <div class="dashboard-stats-metric-label">Late</div>
                 </div>
                 <div class="dashboard-stats-metric dashboard-stats-metric-extra">
                    <div class="dashboard-stats-metric-value">${_(t.totalExtraDuration)}</div>
    ...
    `}function da(n){const e=Object.entries(n),t={Present:{color:"#166534",bg:"#f0fdf4",label:"Office"},"Work - Home":{color:"#0369a1",bg:"#e0f2fe",label:"WFH"},Training:{color:"#4338ca",bg:"#eef2ff",label:"Training"},Late:{color:"#c2410c",bg:"#fff7ed",label:"Late"},"Sick Leave":{color:"#991b1b",bg:"#fef2f2",label:"Sick"},"Casual Leave":{color:"#9d174d",bg:"#fce7f3",label:"Casual"},"Earned Leave":{color:"#be185d",bg:"#fdf2f8",label:"Earned"},"Paid Leave":{color:"#be123c",bg:"#ffe4e6",label:"Paid"},"Maternity Leave":{color:"#a21caf",bg:"#fae8ff",label:"Maternity"},Absent:{color:"#7f1d1d",bg:"#fee2e2",label:"Absent"},"Early Departure":{color:"#991b1b",bg:"#fff1f2",label:"Early Exit"},Holiday:{color:"#1e293b",bg:"#f1f5f9",label:"Holiday"},"National Holiday":{color:"#334155",bg:"#f8fafc",label:"Nat. Hol"},"Regional Holidays":{color:"#475569",bg:"#f8fafc",label:"Reg. Hol"}};return e.map(([a,s])=>{const i=t[a]||{color:"#374151",bg:"#f3f4f6",label:a};return s===0&&!["Present","Late","Absent","Early Departure"].includes(a)?"":`
                ...
                ${n.slice(0,5).map(e=>`
                    <div class="dashboard-leave-row">
                        <div class="dashboard-leave-info">
                            <div class="dashboard-leave-name">${_(e.userName||"Staff")}</div>
                            <div class="dashboard-leave-type">${_(e.type)} • ${e.daysCount} days</div>
        ...
        </div>`}function ca(n,e={}){const t=e.title||"Leave History",a=e.subtitle||"Past records";if(!n||n.length===0)return`
            <div class="card dashboard-leave-history-card">
                <div class="dashboard-leave-history-head"><h4>${_(t)}</h4><span>${_(a)}</span></div>
                ...
                ${n.map(i=>`
                    <div class="dashboard-leave-history-row">
                        <div class="dashboard-leave-history-main">
                            <div class="dashboard-leave-history-user">${_(i.userName||"Staff")}</div>
                            <div class="dashboard-leave-history-type">${_(i.type)} • ${i.daysCount} days</div>
                            <div class="dashboard-leave-history-date">${i.startDate} to ${i.endDate}</div>
                        </div>
                        <div class="dashboard-leave-history-status">
                            <span class="status-pill" style="background: ${s(i.status)}15; color: ${s(i.status)}">${_(i.status)}</span>
                        </div>
                    </div>
                `).join("")}
            </div>
        </div>`}function pa(n,e){return""}function ua(n){const e=(n||[]).filter(t=>!(t.type==="tag"||t.type==="task"||t.type==="mention")||t.dismissedAt||t.read?!1:String(t.status||"pending").toLowerCase()==="pending");return e.length===0?"":`
                ...
                ${e.map(t=>`
                    <div class="dashboard-tagged-item">
                        <div class="dashboard-tagged-main">
                            <div class="dashboard-tagged-title">${_(t.title||"Tagged item")}</div>
                            <div class="dashboard-tagged-desc">${_(t.description||t.message||"")}</div>
                            <div class="dashboard-tagged-meta">Tagged by ${_(t.taggedByName||"Staff")} • ${dt(t.taggedAt||t.date)}</div>
                        </div>
    ...
    `}function Za(n,e,t){if(!n||n.length===0)return`
        ...
        <div class="card dashboard-staff-directory-card">
                ...
                <div class="dashboard-staff-row ${r&&a-r<12e4?"dashboard-staff-row-new":""}">
                    <div class="dashboard-staff-meta">
                        <div class="dashboard-staff-avatar">
                            <img src="${Fe(o.avatar)}" alt="${_(o.name)}">
                        </div>
                        <div class="dashboard-staff-text">
                            <div class="dashboard-staff-name">${_(o.name)}</div>
                            <div class="dashboard-staff-role">${_(o.role||"Staff")}</div>
                        </div>
                    </div>
        ...
        </div>`}async function ma(){const n=window.AppAuth.getUser(),e=window.app_hasPerm("dashboard","view",n),t=window.app_hasPerm("dashboard","admin",n),s=pt().selectedMonth,i=window.AppDB?.getISTDateKeys?window.AppDB.getISTDateKeys():{todayKey:new Date().toISOString().split("T")[0],yesterdayKey:new Date(Date.now()-1440*60*1e3).toISOString().split("T")[0]},o=i.todayKey,r=i.yesterdayKey,d=!!x?.READ_OPT_FLAGS?.FF_SHARED_DAILY_SUMMARY,l=`hero_stats_${o}`,c=1440*60*1e3,m=e&&window.app_selectedSummaryStaffId?window.app_selectedSummaryStaffId:n.id;console.time("DashboardFetch");const u=async()=>{try{return await window.AppDB.getOrGenerateSummary(l,async()=>{const W=await window.AppAnalytics.getHeroOfTheWeek({source:"direct_cache"});if(!W||W.state==="fetch_error")throw new Error("direct hero unavailable");return W},c)}catch(W){return console.warn("Direct hero cache read failed:",W),null}},p=d?Promise.resolve(null):u(),f=d?Promise.resolve([]):window.AppDB.getOrGenerateSummary(`team_activity_${s}_${o}`,()=>window.AppAnalytics.getAllStaffActivities({mode:"month",month:s,scope:"work"})),h=d&&window.AppDB.getOrCreateDailySummary?window.AppDB.getOrCreateDailySummary({dateKey:o,yesterdayKey:r,staleAfterMs:x?.SUMMARY_POLICY?.STALENESS_MS,lockTtlMs:x?.SUMMARY_POLICY?.LOCK_TTL_MS,generatorFn:()=>window.AppAnalytics.buildDailyDashboardSummary({dateKey:o,selectedMonth:s})}).catch(W=>(console.warn("Daily summary fetch/generation failed:",W),null)):null,y=h?Promise.race([h,new Promise(W=>setTimeout(()=>W(null),1500))]):Promise.resolve(null);if(!window._dashboardRefreshScheduled){window._dashboardRefreshScheduled=!0;try{const W=window.AppDB.getIstNow(),ie=new Date(W);ie.setDate(ie.getDate()+1),ie.setHours(0,0,5,0);const be=ie.getTime()-W.getTime();setTimeout(()=>{ma().then(oe=>{const ne=document.getElementById("page-content");ne&&(ne.innerHTML=oe)}),window._dashboardRefreshScheduled=!1},Math.max(0,be))}catch(W){console.warn("failed to schedule dashboard refresh",W)}}const[w,b,v,k,g,A,S,$,L,I,B,M,D]=await Promise.all([window.AppAttendance.getStatus(),window.AppAttendance.getLogs(m),window.AppAnalytics.getUserMonthlyStats(m),window.AppAnalytics.getUserYearlyStats(m),p,window.AppCalendar?window.AppCalendar.getPlans():{leaves:[],events:[]},f,window.app_hasPerm("leaves","view")?window.AppLeaves.getPendingLeaves():Promise.resolve([]),window.AppDB.getCached?window.AppDB.getCached(window.AppDB.getCacheKey("dashboardUsers","users",{}),x?.READ_CACHE_TTLS?.users||6e4,()=>window.AppDB.getAll("users")):window.AppDB.getAll("users"),window.AppCalendar?window.AppCalendar.getCollaborations(m):Promise.resolve([]),window.app_hasPerm("leaves","view")?window.AppDB.queryMany?window.AppDB.queryMany("leaves",[{field:"status",operator:"==",value:"Pending"}]).catch(()=>window.AppDB.getAll("leaves")):window.AppDB.getAll("leaves"):Promise.resolve([]),y,window.AppMinutes?window.AppMinutes.getMinutes():Promise.resolve([])]);console.timeEnd("DashboardFetch");const E=d?{lowRead:!1,generatedAt:M?.generatedAt||M?.meta?.generatedAt||0,source:M?._source||""}:{};let U=d?M?.hero||null:g,P=d?Array.isArray(M?.teamActivityPreview)?M.teamActivityPreview:[]:S;d&&(!M||!Array.isArray(M.teamActivityPreview))&&setTimeout(()=>nn(!0),0);const C=me(U,E);if(d&&U==null&&h){const W="app_hero_fallback_attempted_date",ie=()=>{try{return localStorage.getItem(W)===o}catch{return!1}},be=()=>{try{localStorage.setItem(W,o)}catch{}},oe=ne=>{const Se=document.querySelector(".hero-slot");Se&&(Se.outerHTML=ne)};h.then(async ne=>{const Se=ne&&ne.hero?ne.hero:null;if(Se){const he={...E,generatedAt:ne.generatedAt||E.generatedAt,source:ne._source||E.source};oe(me(Se,he));return}const Rt=await u();if(Rt){oe(me(Rt,{...E,generatedAt:Date.now(),source:"direct_cache"}));return}if(oe(me({state:"no_eligible_data",reason:"No eligible hero data available.",source:"shared_summary"},{...E,generatedAt:ne?.generatedAt||E.generatedAt,source:ne?._source||"shared_missing"})),!ie()){be();try{const he=await window.AppAnalytics.getHeroOfTheWeek({source:"direct_fallback"});if(!he||he.state==="fetch_error"){oe(me({state:"fetch_error",reason:"Hero stats are temporarily unavailable.",source:"direct_fallback"},{...E,lowRead:!1,generatedAt:Date.now(),source:"direct_fallback"}));return}await window.AppDB.getOrGenerateSummary(l,async()=>he,c);const qa={...E,lowRead:!1,generatedAt:Date.now(),source:"direct_fallback"};oe(me(he,qa))}catch(he){console.warn("Hero fallback direct fetch failed:",he),oe(me({state:"fetch_error",reason:"Hero stats are temporarily unavailable.",source:"direct_fallback"},{...E,generatedAt:Date.now(),source:"direct_fallback"}))}}}).catch(()=>{oe(me({state:"fetch_error",reason:"Hero stats are temporarily unavailable.",source:"shared_error"},{...E,source:"shared_error"}))})}window.AppRating&&n.rating===void 0&&window.AppRating.updateUserRating(n.id).then(W=>{Object.assign(n,W)}).catch(()=>{});const O=(L||[]).find(W=>W.id===m),H=m===n.id,z=!H&&O?O:n,G=e&&!H&&!t,T=new Date,N=new Date(T.getFullYear(),T.getMonth(),1),j=new Date(T.getFullYear(),T.getMonth()+1,0),Y=window.AppAnalytics&&window.AppAnalytics.getFinancialYearDates?window.AppAnalytics.getFinancialYearDates():{start:new Date(T.getFullYear(),0,1),end:new Date(T.getFullYear(),11,31)};window.app_dashboardStatsStore={monthly:v||{},yearly:k||{},monthlyTitle:H?v.label:`${v.label} - ${O?.name||"Staff"}`,monthlySubtitle:H?"Monthly Stats":"Viewing Staff Monthly Stats",yearlyTitle:"Yearly Summary",yearlySubtitle:H?k.label:`${k.label} for ${O?.name||"Staff"}`,logs:Array.isArray(b)?b:[],ranges:{monthly:{start:N.toISOString().split("T")[0],end:j.toISOString().split("T")[0]},yearly:{start:Y.start.toISOString().split("T")[0],end:Y.end.toISOString().split("T")[0]}}};const J=G?{status:z.status||"out",lastCheckIn:z.lastCheckIn||null}:w,X=J.status==="in",te=n.notifications||[];n.tagHistory;let ye="00 : 00 : 00",se="Check-in",Xe="action-btn";X&&(se="Check-out",Xe="action-btn checkout");const ht=W=>{const ie=Math.max(0,W||0);let be=Math.floor(ie/(1e3*60*60)),oe=Math.floor(ie/(1e3*60)%60),ne=Math.floor(ie/1e3%60);return`${String(be).padStart(2,"0")} : ${String(oe).padStart(2,"0")} : ${String(ne).padStart(2,"0")}`};if(X&&J.lastCheckIn){const W=new Date(J.lastCheckIn).getTime();ye=ht(Date.now()-W)}const Je=pa(),gt=ua(te);let Ze="";e&&!H&&O&&(Ze=`
                ...
                <div class="dashboard-staff-view-banner-inner">
                    <div class="dashboard-staff-view-banner-profile">
                        <div class="dashboard-staff-view-avatar-wrap">
                            <img src="${Fe(O.avatar)}" alt="${_(O.name)}" class="dashboard-staff-view-avatar">
                        ...
                        <div class="dashboard-staff-view-copy">
                            ...
                            <h3 class="dashboard-staff-view-title">${_(O.name)}'s Dashboard</h3>
                            <div class="dashboard-staff-view-meta">${_(O.role)} • ${_(O.dept||"General")}</div>
                        </div>
                    </div>
            ...
            </div>`);let Te="";const Ie=Mt(A);if(e){const W=!!window.app_selectedSummaryStaffId&&window.app_selectedSummaryStaffId!==n.id,ie=(B||[]).slice().sort((ne,Se)=>new Date(Se.appliedOn||0)-new Date(ne.appliedOn||0)),be=W?ie.filter(ne=>(ne.userId||ne.user_id)===m).slice(0,8):ie.slice(0,8),oe=ca(be,{title:W?`${O?.name||"Staff"} Leave History`:"Leave Request History",subtitle:W?"Based on selected staff summary":"Latest requests (all staff)"});Te=`
            <div class="dashboard-summary-row">
                <div style="flex: 2; min-width: 350px; display: flex; flex-direction: column;">${la($)}${oe}</div>
                <div style="flex: 1; min-width: 300px; display: flex; flex-direction: column; gap: 1rem;">${Ie}${C}</div>
            </div>
            <div class="dashboard-stats-row">
                ${Me(H?v.label:`${v.label} - ${O?.name||"Staff"}`,H?"Monthly Stats":"Viewing Staff Monthly Stats",v,"monthly")}
                ${Me("Yearly Summary",H?k.label:`${k.label} for ${O?.name||"Staff"}`,k,"yearly")}
            </div>`}else Te=`
            <div class="dashboard-summary-row">
                <div class="dashboard-summary-col dashboard-summary-col-wide">${Ie}</div>
                <div class="dashboard-summary-col dashboard-summary-col-narrow">${C}</div>
            </div>
            <div class="dashboard-stats-row">
                ${Me(v.label,"Monthly Stats",v,"monthly")}
                ${Me("Yearly Summary",k.label,k,"yearly")}
            </div>`;const wt=window.app_getReleaseUpdateState&&window.app_getReleaseUpdateState()||{active:!1};return setTimeout(()=>Ga(),0),`
        <div class="dashboard-grid dashboard-modern dashboard-staff-view">
            ...
            <div class="card full-width dashboard-hero-card">
                ...
                <button class="${wt.active?"dashboard-refresh-link is-update-pending":"dashboard-refresh-link"}" onclick="window.app_checkForSystemUpdate()" title="${wt.active?"Update available. Click to refresh into the new version.":"Check for System Update"}">
                    ${wt.active?"System update available":"Check for System Update"}
                </button>
            </div>
            <div class="dashboard-primary-row">
                <div class="card check-in-widget dashboard-primary-card dashboard-checkin-card">
                    <div class="dashboard-checkin-head">
                        ...
                        <div class="dashboard-checkin-identity">
                            <h4 class="dashboard-checkin-name">${_(z.name)}</h4>
                            <p class="text-muted dashboard-checkin-role">${_(z.role)}</p>
                        </div>
                    </div>
                    ...
                    <button class="${Xe} dashboard-checkin-btn" id="attendance-btn" ${G?"disabled":""} title="${G?"View only":""}">${se} <i class="fa-solid fa-fingerprint"></i></button>
                ...
                <div class="dashboard-primary-col ${H?"":"dashboard-primary-col-highlight"}">${sa(b,I,O,D)}</div>
                <div class="dashboard-primary-col">${oa(P)}</div>
            </div>
            ${Te}
        </div>`}function mt(n){const[e,t]=String(n||"").split("-"),a=Number(e),s=Number(t)-1;return!Number.isInteger(a)||!Number.isInteger(s)||s<0||s>11?n||"Current Month":new Date(a,s,1).toLocaleDateString("en-US",{month:"long",year:"numeric"})}function Qa(n=8){const e=[],t=new Date;t.setDate(1);for(let a=0;a<n;a++){const s=new Date(t);s.setMonth(t.getMonth()-a);const i=s.toISOString().slice(0,7);e.push({key:i,label:mt(i)})}return e}function en(n){const e=[],t=new Map;return(n||[]).forEach(a=>{const s=(a._displayDesc||"").trim(),i=`${a.staffName||""}|${a.date||""}|${s}`;t.has(i)||(t.set(i,a),e.push(a))}),e.map(a=>{const s=window.AppCalendar?window.AppCalendar.getSmartTaskStatus(a.date,a.status||""):a.status||"to-be-started";return{...a,_taskStatus:s,_taskGroup:s==="completed"?"completed":"incomplete"}})}function tn(n,e){const t=[...n],a={completed:0,"in-process":1,overdue:2,"not-completed":3,"to-be-started":4};return t.sort((s,i)=>{const o=new Date(i.date)-new Date(s.date),r=String(s.staffName||"").toLowerCase().localeCompare(String(i.staffName||"").toLowerCase());return e==="date-asc"?new Date(s.date)-new Date(i.date)||r:e==="staff-asc"?r||o:e==="staff-desc"?-r||o:e==="completed-first"?s._taskGroup.localeCompare(i._taskGroup)||o:e==="incomplete-first"?i._taskGroup.localeCompare(s._taskGroup)||o:e==="status-priority"?(a[s._taskStatus]??99)-(a[i._taskStatus]??99)||o||r:o||r}),t}function an(n){if(!n)return;const e=xe.controllers.get(n);e&&(e.intervalId&&clearInterval(e.intervalId),e.pauseTimeoutId&&clearTimeout(e.pauseTimeoutId),e.resumeTimeoutId&&clearTimeout(e.resumeTimeoutId),n.removeEventListener("mouseenter",e.onMouseEnter),n.removeEventListener("mouseleave",e.onMouseLeave),n.removeEventListener("touchstart",e.onTouchStart),n.removeEventListener("touchend",e.onTouchEnd),n.removeEventListener("touchcancel",e.onTouchCancel),xe.controllers.delete(n),xe.elements.delete(n))}function fa(){Array.from(xe.elements).forEach(n=>an(n))}function ya(n){if(!n)return;fa(),n.querySelectorAll(".dashboard-team-activity-col-list").forEach(t=>{const a={intervalId:null,pauseTimeoutId:null,resumeTimeoutId:null,direction:1,isPausedByUser:!1,isWaitingAtEdge:!1},s=(o,r)=>{a.isWaitingAtEdge=!0,a.pauseTimeoutId&&clearTimeout(a.pauseTimeoutId),a.pauseTimeoutId=setTimeout(()=>{a.direction=o,a.isWaitingAtEdge=!1},r)},i=()=>{if(a.isPausedByUser||a.isWaitingAtEdge||!t.isConnected)return;const o=Math.max(0,t.scrollHeight-t.clientHeight);o<=0||(t.scrollTop+=a.direction,a.direction===1&&t.scrollTop>=o?(t.scrollTop=o,s(-1,1500)):a.direction===-1&&t.scrollTop<=0&&(t.scrollTop=0,s(1,1e3)))};a.onMouseEnter=()=>{a.isPausedByUser=!0},a.onMouseLeave=()=>{a.isPausedByUser=!1},a.onTouchStart=()=>{a.isPausedByUser=!0,a.resumeTimeoutId&&clearTimeout(a.resumeTimeoutId)},a.onTouchEnd=()=>{a.resumeTimeoutId&&clearTimeout(a.resumeTimeoutId),a.resumeTimeoutId=setTimeout(()=>{a.isPausedByUser=!1},400)},t.addEventListener("mouseenter",a.onMouseEnter),t.addEventListener("mouseleave",a.onMouseLeave),t.addEventListener("touchstart",a.onTouchStart,{passive:!0}),t.addEventListener("touchend",a.onTouchEnd,{passive:!0}),a.intervalId=setInterval(i,50),xe.controllers.set(t,a),xe.elements.add(t)})}const nn=async(n=!0)=>{const e=pt(),t=document.getElementById("staff-activity-list"),a=document.getElementById("staff-activity-list-modal");if(!t&&!a)return;fa(),n&&window.AppAnalytics&&(e.logs=await window.AppAnalytics.getAllStaffActivities({mode:"month",month:e.selectedMonth,scope:"work"}));const s=ut(e.logs,e.sortKey);t&&(t.innerHTML=s,ya(t)),a&&(a.innerHTML=s);const i=document.getElementById("staff-activity-range-label");i&&(i.textContent=mt(e.selectedMonth))};typeof window<"u"&&(window.app_expandTeamActivity=function(){window.app_closeTeamActivityExpanded&&window.app_closeTeamActivityExpanded(),window.location&&(window.location.hash="#team-activities")},window.app_openStatsDetailModal=function(n){const e=window.app_dashboardStatsStore||{},t=n==="yearly"?e.yearly:e.monthly;if(!t)return;const a=n==="yearly"?e.yearlyTitle:e.monthlyTitle,s=n==="yearly"?e.yearlySubtitle:e.monthlySubtitle,i=t.breakdown||{},o=e.ranges?n==="yearly"?e.ranges.yearly:e.ranges.monthly:null,r=Ja(e.logs||[],o),d=Object.entries(i).filter(([,u])=>Number(u||0)>0),l=document.getElementById("dashboard-stats-modal");l&&l.remove();const c=document.createElement("div");c.id="dashboard-stats-modal",c.className="modal-overlay dashboard-stats-modal",c.innerHTML=`
            <div class="modal-content dashboard-stats-modal-content">
                <div class="dashboard-stats-modal-head">
                    <div>
                        <div class="dashboard-stats-modal-title">${_(a||"Attendance Summary")}</div>
                        <div class="dashboard-stats-modal-sub">${_(s||"")}</div>
                    </div>
                ...
                <div class="dashboard-stats-modal-grid">
                    <div class="dashboard-stats-modal-tile" data-stat-detail="late" role="button" tabindex="0">
                        ...
                        <span class="value">${_(t.late??0)}</span>
                        <span class="hint">Total late entries</span>
                    </div>
                    <div class="dashboard-stats-modal-tile" data-stat-detail="late" role="button" tabindex="0">
                        <span class="label">Late Duration</span>
                        <span class="value">${_(t.totalLateDuration||"0h 0m")}</span>
                    ...
                    <div class="dashboard-stats-modal-tile" data-stat-detail="early" role="button" tabindex="0">
                        ...
                        <span class="value">${_(t.earlyDepartures??0)}</span>
                    ...
                    <div class="dashboard-stats-modal-tile highlight" data-stat-detail="late" role="button" tabindex="0">
                        ...
                        <span class="value">${_(t.effectivePenalty??0)}</span>
                ...
                <div class="dashboard-stats-modal-section">
                    ...
                    <div class="dashboard-stats-modal-breakdown">
                        ${(d.length?d:[["No data",0]]).map(([u,p])=>`
                            <div class="dashboard-stats-modal-row" data-breakdown-key="${_(u)}" role="button" tabindex="0">
                                <span>${_(u)}</span>
                                <strong>${_(p)}</strong>
                            </div>
                        `).join("")}
        ...
        `,document.body.appendChild(c),document.body.style.overflow="hidden",window._dashboardStatsDetailData={type:n,buckets:r};const m=r.late.length?"late":r.early.length?"early":r.extra.length?"extra":"Present";window.app_updateStatsDetailView(m),c.addEventListener("click",u=>{const p=u.target.closest("[data-stat-detail]");if(p){window.app_updateStatsDetailView(p.getAttribute("data-stat-detail"));return}const f=u.target.closest("[data-breakdown-key]");f&&window.app_updateStatsDetailView(f.getAttribute("data-breakdown-key"))}),c.addEventListener("keydown",u=>{if(u.key!=="Enter"&&u.key!==" ")return;const p=u.target.closest("[data-stat-detail]"),f=u.target.closest("[data-breakdown-key]");(p||f)&&(u.preventDefault(),window.app_updateStatsDetailView(p?p.getAttribute("data-stat-detail"):f.getAttribute("data-breakdown-key")))}),c.addEventListener("click",u=>{u.target===c&&window.app_closeStatsDetailModal()}),window._dashboardStatsEscHandler=u=>{u.key==="Escape"&&window.app_closeStatsDetailModal()},window.addEventListener("keydown",window._dashboardStatsEscHandler)},window.app_closeStatsDetailModal=function(){const n=document.getElementById("dashboard-stats-modal");n&&n.remove(),document.body.style.overflow="",window._dashboardStatsDetailData=null,window._dashboardStatsEscHandler&&(window.removeEventListener("keydown",window._dashboardStatsEscHandler),window._dashboardStatsEscHandler=null)},window.app_updateStatsDetailView=function(n){const t=(window._dashboardStatsDetailData||{}).buckets||{};let a="",s=[];n==="late"?(a="Late Dates",s=t.late||[]):n==="early"?(a="Early Departure Dates",s=t.early||[]):n==="extra"?(a="Extra Hours Dates",s=t.extra||[]):t.breakdown&&Object.prototype.hasOwnProperty.call(t.breakdown,n)?(a=`${n} Dates`,s=t.breakdown[n]||[]):(a="Details",s=[]);const i=document.getElementById("dashboard-stats-detail-title"),o=document.getElementById("dashboard-stats-date-list");i&&(i.textContent=a),o&&(o.innerHTML=s.length?s.map(r=>`<div class="dashboard-stats-date-item">${_(r)}</div>`).join(""):'<div class="dashboard-stats-date-empty">No dates available.</div>'),document.querySelectorAll(".dashboard-stats-modal-tile, .dashboard-stats-modal-row").forEach(r=>{const d=r.getAttribute("data-stat-detail"),l=r.getAttribute("data-breakdown-key");r.classList.toggle("is-active",d&&d===n||l&&l===n)})},window.app_attachStatsCardHandlers=function(){Xa()},window.app_expandTeamActivityRefresh=function(){const n=pt(),e=document.getElementById("staff-activity-list-modal"),t=document.getElementById("staff-activity-range-label-modal");e&&(e.innerHTML=ut(n.logs,n.sortKey)),t&&(t.textContent=mt(n.selectedMonth))},window.app_closeTeamActivityExpanded=function(){const n=document.getElementById("team-activity-modal-overlay");n&&(n.remove(),document.body.style.overflow="",window.removeEventListener("keydown",window._teamActivityEscHandler))});async function sn(){const n=window.AppAuth.getUser(),e=window.AppDB.getCached?await window.AppDB.getCached(window.AppDB.getCacheKey("staffUsers","users",{}),x?.READ_CACHE_TTLS?.users||6e4,()=>window.AppDB.getAll("users")):await window.AppDB.getAll("users"),t=window.app_getMyMessages?await window.app_getMyMessages():await window.AppDB.getAll("staff_messages"),a=e.filter(p=>p.id!==n.id).sort((p,f)=>p.name.localeCompare(f.name));!window.app_staffThreadId&&a.length>0&&(window.app_staffThreadId=a[0].id);const s=e.find(p=>p.id===window.app_staffThreadId),i=p=>_(p).replace(/(https?:\/\/[^\s]+)/g,'<a href="$1" target="_blank" rel="noopener noreferrer">$1</a>'),o=t.filter(p=>p.fromId===n.id&&p.toId===window.app_staffThreadId||p.fromId===window.app_staffThreadId&&p.toId===n.id).sort((p,f)=>new Date(p.createdAt||0)-new Date(f.createdAt||0)),r=o.filter(p=>p.type==="text"),d=o.filter(p=>p.type==="task"),l={};t.forEach(p=>{p.toId===n.id&&!p.read&&(l[p.fromId]=(l[p.fromId]||0)+1)});const c=a.map(p=>{const f=l[p.id]||0;return`
            <button class="staff-directory-item ${p.id===window.app_staffThreadId?"active":""}" onclick="window.app_openStaffThread('${p.id}')">
                <div class="staff-directory-avatar">
                    <img src="${p.avatar}" alt="${_(p.name)}">
                </div>
                <div class="staff-directory-info">
                    <div class="staff-directory-name">${_(p.name)}</div>
                    <div class="staff-directory-role">${_(p.role||"Staff")}</div>
                </div>
        ...
        <div class="staff-message ${p.fromId===n.id?"outgoing":"incoming"}">
            <div class="staff-message-meta">${_(p.fromName)} • ${new Date(p.createdAt).toLocaleString()}</div>
    ...
    `).join(""):'<div class="staff-message-empty">No messages yet.</div>':'<div class="staff-message-empty">Select a staff member to view messages.</div>',u=s?d.length?d.map(p=>`
        <div class="staff-task-card">
            <div class="staff-task-head">
                <div>
                    <div class="staff-task-title">${_(p.title||"Task")}</div>
                    <div class="staff-task-meta">From ${_(p.fromName)} • Due ${p.dueDate||"No date"}</div>
                </div>
                <span class="staff-task-status ${p.status||"pending"}">${(p.status||"pending").toUpperCase()}</span>
            </div>
            <div class="staff-task-desc">${_(p.description||"")}</div>
            ...
            `:""}
            ${p.rejectReason?`<div class="staff-task-reason">Reason: ${_(p.rejectReason)}</div>`:""}
        </div>
        ...
        <div class="staff-directory-page">
            ...
            <section class="staff-thread-panel">
                <div class="staff-thread-head">
                    <div>
                        <h3>${s?_(s.name):"Select a staff member"}</h3>
                        <span>${s?_(s.role||"Staff"):""}</span>
                    </div>
                    <div class="staff-thread-actions">
                        <button class="staff-thread-action-btn" ${s?"":"disabled"} onclick="window.app_openStaffMessageModal('${s?s.id:""}', '${s?_(s.name):""}')">
                            <i class="fa-solid fa-message"></i> Send Message
                        </button>
                        <button class="staff-thread-action-btn secondary" ${s?"":"disabled"} onclick="window.app_openStaffTaskModal('${s?s.id:""}', '${s?_(s.name):""}')">
    ...
    `}let qt=!1;function on(){qt||typeof document>"u"||(qt=!0,document.addEventListener("click",n=>{const e=n.target.closest("[data-annual-open-day]");if(e){window.app_openAnnualDayPlan?.(e.dataset.annualOpenDay);return}const t=n.target.closest("[data-annual-view]");if(t){window.app_toggleAnnualView?.(t.dataset.annualView);return}if(n.target.closest("[data-annual-jump-today]")){window.app_jumpToAnnualToday?.();return}const s=n.target.closest("[data-annual-year-delta]");if(s){window.app_changeAnnualYear?.(Number(s.dataset.annualYearDelta||0));return}const i=n.target.closest("[data-annual-legend]");if(i){window.app_toggleAnnualLegendFilter?.(i.dataset.annualLegend);return}n.target.closest("[data-annual-export]")&&window.AppReports?.exportAnnualListViewCSV?.(window._annualListItems||[])}),document.addEventListener("input",n=>{const e=n.target.closest("[data-annual-staff-filter]");e&&window.app_setAnnualStaffFilter?.(e.value)}),document.addEventListener("change",n=>{const e=n.target.closest("[data-annual-list-sort]");e&&window.app_setAnnualListSort?.(e.value)}),document.addEventListener("keydown",n=>{const e=n.target.closest("[data-annual-list-search]");e&&n.key==="Enter"&&window.app_setAnnualListSearch?.(e.value)}),document.addEventListener("mouseover",n=>{const e=n.target.closest("[data-annual-preview-date]");!e||e.contains(n.relatedTarget)||window.app_showAnnualHoverPreview?.(n,e.dataset.annualPreviewDate)}),document.addEventListener("mouseout",n=>{const e=n.target.closest("[data-annual-preview-date]");!e||e.contains(n.relatedTarget)||window.app_hideAnnualHoverPreview?.()}))}async function Ce(){typeof window.app_setAnnualStaffFilter!="function"&&(window.app_setAnnualStaffFilter=async D=>{window.app_annualStaffFilter=String(D||"").trim();const E=document.getElementById("page-content");E&&(E.innerHTML=await Ce())}),typeof window.app_toggleAnnualView!="function"&&(window.app_toggleAnnualView=async D=>{window.app_annualViewMode=D;const E=document.getElementById("page-content");E&&(E.innerHTML=await Ce())}),typeof window.app_setAnnualListSearch!="function"&&(window.app_setAnnualListSearch=async D=>{window.app_annualListSearch=String(D||"").trim();const E=document.getElementById("page-content");E&&(E.innerHTML=await Ce())}),typeof window.app_setAnnualListSort!="function"&&(window.app_setAnnualListSort=async D=>{window.app_annualListSort=String(D||"date-asc").trim();const E=document.getElementById("page-content");E&&(E.innerHTML=await Ce())});const n=new Date,e=`${n.getFullYear()}-${String(n.getMonth()+1).padStart(2,"0")}-${String(n.getDate()).padStart(2,"0")}`,t=window.app_annualYear||n.getFullYear(),a=await window.AppCalendar.getPlans(),s=await window.AppDB.getAll("users").catch(()=>[]),i=await window.AppDB.getAll("attendance").catch(()=>[]);window._currentPlans=a;const o=["January","February","March","April","May","June","July","August","September","October","November","December"],r={};(s||[]).forEach(D=>{r[D.id]=D.name}),window._annualUserMap=r;const d=(D,E)=>r[D]||E||"Staff",l=window.app_annualLegendFilters||{leave:!0,event:!0,work:!0,overdue:!0,completed:!0};window.app_annualLegendFilters=l;let c=window.app_selectedAnnualDate||(t===n.getFullYear()?e:null);c&&!c.startsWith(`${t}-`)&&(c=null),window.app_selectedAnnualDate=c;const m=String(window.app_annualStaffFilter||"").trim(),u=m.toLowerCase(),p=String(window.app_annualListSearch||"").trim(),f=p.toLowerCase(),h=String(window.app_annualListSort||"date-asc"),y=(s||[]).map(D=>`<option value="${_(D.name)}"></option>`).join(""),w=D=>u?String(D||"").toLowerCase().includes(u):!0,b={january:0,february:1,march:2,april:3,may:4,june:5,july:6,august:7,september:8,october:9,november:10,december:11},v=(D="")=>{const E=String(D||"").trim();if(!E)return null;const U=E.match(/(\d{1,2})\s*-\s*(\d{1,2})\s+([A-Za-z]+)\s+(\d{4})/);if(!U)return null;const P=Number(U[1]),C=Number(U[2]),O=String(U[3]||"").toLowerCase(),H=Number(U[4]),z=b[O];if(!Number.isInteger(P)||!Number.isInteger(C)||!Number.isInteger(z)||!Number.isInteger(H))return null;const G=new Date(H,z,P),T=new Date(H,z,C);if(Number.isNaN(G.getTime())||Number.isNaN(T.getTime()))return null;const N=`${G.getFullYear()}-${String(G.getMonth()+1).padStart(2,"0")}-${String(G.getDate()).padStart(2,"0")}`,j=`${T.getFullYear()}-${String(T.getMonth()+1).padStart(2,"0")}-${String(T.getDate()).padStart(2,"0")}`;return j<N?null:{startDate:N,endDate:j}},k=(D,E)=>{const U=!D?.startDate&&!D?.endDate?v(D?.task||""):null,P=D?.startDate||U?.startDate||E,C=D?.endDate||U?.endDate||D?.startDate||E;return{startDate:P,endDate:C}},g=(D,E,U)=>{const{startDate:P,endDate:C}=k(D,E);return!P||!C?E===U:!(U<P||U>C||D?.completedDate&&D.completedDate<U)},A=(a.workPlans||[]).filter(D=>{if((D.planScope||"personal")==="annual"){if(!u)return!0;const P=d(D.userId,D.userName);return w(P)?!0:(D.plans||[]).some(C=>{const O=d(C.assignedTo||D.userId,P),H=(C.tags||[]).map(z=>z.name||z).join(" ");return w(O)||w(H)})}if(!u)return!0;const U=d(D.userId,D.userName);return w(U)?!0:(D.plans||[]).some(P=>{const C=d(P.assignedTo||D.userId,U),O=(P.tags||[]).map(H=>H.name||H).join(" ");return w(C)||w(O)})}),S=(a.leaves||[]).filter(D=>w(d(D.userId,D.userName))),$=(i||[]).filter(D=>{if(!String(D.date||"").startsWith(String(t)))return!1;const U=D.user_id||D.userId,P=d(U,"");return u?w(P):!0}),L=(D,E,U)=>{const P=`${U}-${String(E+1).padStart(2,"0")}-${String(D).padStart(2,"0")}`,C=S.some(N=>P>=N.startDate&&P<=N.endDate),O=!u&&(a.events||[]).some(N=>N.date===P),H=$.some(N=>N.date===P),z=A.some(N=>!Array.isArray(N.plans)||!N.plans.length?N.date===P:N.plans.some(j=>g(j,N.date,P)))||H;let G="",T=!1;if(z){const N=A.filter(Y=>!Array.isArray(Y.plans)||!Y.plans.length?Y.date===P:Y.plans.some(J=>g(J,Y.date,P)));let j="to-be-started";N.forEach(Y=>{(Y.plans||[]).forEach(J=>{if(!g(J,Y.date,P))return;const{startDate:X,endDate:te}=k(J,Y.date);X&&te&&X!==te&&te===P&&(T=!0);const ye=J.completedDate||te||Y.date||P,se=window.AppCalendar?window.AppCalendar.getSmartTaskStatus(ye,J.status):J.status||"pending";se==="overdue"?j="overdue":se==="in-process"&&j!=="overdue"?j="in-process":se==="completed"&&j!=="overdue"&&j!=="in-process"&&(j="completed")})}),H&&j==="to-be-started"&&(j="completed"),G=j}return{hasLeave:C,hasEvent:O,hasWork:z,workStatus:G,hasRangeEnd:T}};let I="";for(let D=0;D<12;D++){const E=new Date(t,D,1).getDay(),U=new Date(t,D+1,0).getDate();let P="";for(let C=0;C<E;C++)P+='<div class="annual-day empty"></div>';for(let C=1;C<=U;C++){const O=L(C,D,t),H=C===n.getDate()&&D===n.getMonth()&&t===n.getFullYear(),z=`${t}-${String(D+1).padStart(2,"0")}-${String(C).padStart(2,"0")}`,G=O.hasLeave&&l.leave,T=O.hasEvent&&l.event,N=O.hasWork&&l.work&&(O.workStatus==="overdue"?l.overdue:O.workStatus==="completed"?l.completed:!0),j=G||T||N,Y=N?`has-work work-${O.workStatus}`:"";P+=`
                <div class="annual-day ${H?"today":""} ${Y} ${c===z?"selected":""} ${j?"":"annual-day-muted"}" data-annual-open-day="${z}" data-annual-preview-date="${z}">
                    ${C}
            ...
            </div>`}const B=window.app_annualViewMode||"grid",M=(()=>{const D=[],E=new Set,U=T=>{if(!T)return"";const N=String(T).replace(/_/g,"-").toLowerCase();return{"in-process":"In Process","to-be-started":"To Be Started","not-completed":"Not Completed",completed:"Completed",overdue:"Overdue",pending:"Pending",approved:"Approved",holiday:"Holiday",event:"Event"}[N]||N.replace(/\b\w/g,Y=>Y.toUpperCase())},P=(T,N)=>N||(window.AppCalendar&&T?window.AppCalendar.getSmartTaskStatus(T,N):"pending");if(!u&&window.AppAnalytics){const T=new Date(t,0,1),N=new Date(t,11,31);for(let j=new Date(T);j<=N;j.setDate(j.getDate()+1)){const Y=j.toISOString().split("T")[0],J=window.AppAnalytics.getDayType(j);J==="Holiday"?D.push({date:Y,type:"holiday",title:"Company Holiday (Weekend)",staffName:"All Staff",assignedBy:"System",assignedTo:"All Staff",selfAssigned:!1,dueDate:Y,status:"holiday",comments:"",scope:"Shared"}):J==="Half Day"&&D.push({date:Y,type:"event",title:"Half Working Day (Sat)",staffName:"All Staff",assignedBy:"System",assignedTo:"All Staff",selfAssigned:!1,dueDate:Y,status:"event",comments:"",scope:"Shared"})}}S.forEach(T=>{const N=new Date(T.startDate),j=new Date(T.endDate||T.startDate),Y=d(T.userId,T.userName);for(let J=new Date(N);J<=j;J.setDate(J.getDate()+1)){const X=J.toISOString().split("T")[0];X.startsWith(String(t))&&D.push({date:X,type:"leave",title:`${Y} (${T.type||"Leave"})`,staffName:Y,assignedBy:Y,assignedTo:Y,selfAssigned:!0,dueDate:T.endDate||T.startDate||X,status:(T.status||"approved").toLowerCase(),comments:T.reason||"",scope:"Personal"})}}),(a.events||[]).forEach(T=>{if(!u&&String(T.date||"").startsWith(String(t))){const N=[String(T.date||"").trim(),String(T.title||"").trim().toLowerCase(),String(T.type||"event").trim().toLowerCase(),String(T.createdById||T.createdByName||"").trim().toLowerCase()].join("|");if(E.has(N))return;E.add(N),D.push({date:T.date,type:T.type||"event",title:T.title||"Company Event",staffName:"All Staff",assignedBy:T.createdByName||"Admin",assignedTo:"All Staff",selfAssigned:!1,dueDate:T.date,status:"event",comments:T.description||"",scope:"Shared"})}}),A.forEach(T=>{if(String(T.date||"").startsWith(String(t))){const N=(T.planScope||"personal")==="annual",j=d(T.userId,T.userName)||(N?"All Staff":"Staff"),Y=N?"Annual":"Personal",J=T.date;T.plans&&T.plans.length>0&&T.plans.forEach(X=>{const te=N?T.createdByName||X.taggedByName||"Admin":X.taggedByName||j,ye=X.assignedTo||T.userId,se=N?te:d(ye,j),Xe=(X.tags||[]).map(Ie=>Ie.name||Ie).filter(Boolean),{startDate:ht,endDate:Je}=k(X,J),gt=X.completedDate||Je||J,Ze=P(gt,X.status),Te=X.subPlans&&X.subPlans.length?X.subPlans.join("; "):X.comment||X.notes||"";D.push({date:ht||J,type:"work",title:X.task||"Work Plan Task",staffName:N?te:se,assignedBy:te,assignedTo:N?te:se,selfAssigned:te===se,dueDate:X.dueDate||Je||J,status:Ze,comments:Te,tags:Xe,scope:Y})})}}),$.forEach(T=>{const N=T.user_id||T.userId,j=d(N,"Staff"),Y=(T.workDescription||T.location||"").trim()||"Manual log entry";D.push({date:T.date,type:"work",title:Y,staffName:j,assignedBy:j,assignedTo:j,selfAssigned:!0,dueDate:T.date,status:"completed",comments:Y,tags:["Manual Log"],scope:"Personal"})});const C=[],O=new Set;D.forEach(T=>{const N=`${T.date||""}|${T.type||""}|${T.title||""}|${T.staffName||""}|${T.status||""}`.toLowerCase();O.has(N)||(O.add(N),C.push(T))}),C.sort((T,N)=>T.date.localeCompare(N.date)||T.type.localeCompare(N.type)),C.forEach(T=>{T.statusLabel=U(T.status),T.statusClass=String(T.status||"pending").replace(/[^a-z0-9]+/gi,"-").toLowerCase()});let H=f?C.filter(T=>[T.date,T.staffName,T.title,T.statusLabel,T.comments].join(" ").toLowerCase().includes(f)):C;const z={"date-asc":(T,N)=>String(T.date||"").localeCompare(String(N.date||"")),"date-desc":(T,N)=>String(N.date||"").localeCompare(String(T.date||"")),"staff-asc":(T,N)=>String(T.staffName||"").localeCompare(String(N.staffName||"")),"staff-desc":(T,N)=>String(N.staffName||"").localeCompare(String(T.staffName||"")),"status-asc":(T,N)=>String(T.statusLabel||"").localeCompare(String(N.statusLabel||"")),"status-desc":(T,N)=>String(N.statusLabel||"").localeCompare(String(T.statusLabel||""))},G=z[h]||z["date-asc"];return H.slice().sort(G)})();return window._annualListItems=M,setTimeout(()=>on(),0),`
        <div class="annual-plan-shell annual-v2-shell">
            <div class="card annual-plan-header annual-v2-header">
                ...
                <div class="annual-plan-controls annual-v2-controls">
                    <div class="annual-staff-filter annual-v2-staff-filter">
                        ...
                        <input type="text" list="annual-staff-names" value="${_(m)}" placeholder="Filter by staff name" data-annual-staff-filter="1">
                    ...
                    <div class="annual-list-head annual-v2-list-head">
                        ...
                        <div class="annual-list-actions annual-v2-list-actions">
                            <div class="annual-list-search-wrap annual-v2-search-wrap">
                                ...
                                <input type="text" value="${_(p)}" placeholder="Search list..." data-annual-list-search="1">
                            </div>
                            ...
                            <div class="annual-list-table">
                                ...
                                ${M.map(D=>`
                                    <div class="annual-list-row">
                                        ...
                                        <div class="annual-list-cell">${_(D.staffName)}</div>
                                        <div class="annual-list-cell annual-list-task">${_(D.title)}</div>
                                        <div class="annual-list-cell">${_(D.assignedBy)}</div>
                                        <div class="annual-list-cell"><span class="annual-list-status status-${D.statusClass}">${D.statusLabel}</span></div>
                                        <div class="annual-list-cell annual-list-comments">${_(D.comments||"--")}</div>
            ...
            </div>`;typeof window.app_showModal=="function"?window.app_showModal(B,I):(document.getElementById("modal-container")||document.body).insertAdjacentHTML("beforeend",B)};const k=()=>{const g=new Date(o,i,1).getDay(),A=new Date(o,i+1,0).getDate();let S="";for(let $=0;$<g;$++)S+='<div class="timesheet-cal-day empty"></div>';for(let $=1;$<=A;$++){const L=`${o}-${String(i+1).padStart(2,"0")}-${String($).padStart(2,"0")}`,I=u[L]||[],B=I.length?I.slice().sort((H,z)=>{const G=T=>{const N=v(T.type);return N==="Absent"?4:N==="Half Day"?3:N==="Late"?2:N==="Present (Late Waived)"?1:0};return G(z)-G(H)})[0]:null,M=p[L]||[],D=L===new Date().toISOString().split("T")[0],E=B?v(B.type):"",U=B?E==="Absent"?"absent":E==="Half Day"||E==="Late"?"late":"present":"none",P=B?E:"No log",C=I.map(H=>(H.workDescription||H.location||"").trim()).filter(Boolean),O=C.length?C.slice(0,2).map(H=>`<div class="timesheet-cal-plan">${_(H)}</div>`).join("")+(C.length>2?`<div class="timesheet-cal-more">+${C.length-2} more logs</div>`:""):M.length?M.slice(0,2).map(H=>`<div class="timesheet-cal-plan">${_(H)}</div>`).join("")+(M.length>2?`<div class="timesheet-cal-more">+${M.length-2} more</div>`:""):'<div class="timesheet-cal-empty">No plans</div>';S+=`
                                ...
                                <td data-label="Work Summary" class="timesheet-summary-cell">
                                    <div class="timesheet-summary-wrap">
                                        <div class="dashboard-viewing-meta">
                                            <div class="timesheet-summary-text">${_(g.workDescription)||'<span class="timesheet-empty-summary">No summary provided</span>'}</div>
                                            ${g.location?`<div class="timesheet-location"><i class="fa-solid fa-location-dot"></i> ${_(g.location)}</div>`:""}
                                        </div>
                ...
                <div class="pro-profile-hero">
                    ...
                    <div class="pro-profile-hero-inner">
                        ...
                        <div class="pro-profile-avatar-ring">
                            ${s.avatar?`<img src="${_(s.avatar)}" alt="${_(s.name)}" class="pro-profile-avatar-img">`:`<div class="pro-profile-avatar-initials">${w}</div>`}
                        ...
                        <div class="pro-profile-identity">
                            <div class="pro-profile-name-row">
                                <h1 class="pro-profile-name">${_(s.name)}</h1>
                                <span class="pro-profile-role-badge">${_(s.role||"Staff")}</span>
                            </div>
                        ...
                        <div class="pro-profile-header-actions">
                            ...
                            <select class="pro-profile-staff-picker" onchange="window.app_changeProfileStaff(this.value)">
                                ...
                                ${t.map(b=>`<option value="${b.id}" ${b.id===a?"selected":""}>${_(b.name)}</option>`).join("")}
                            </select>`:""}
                            ${m?`
                        ...
                        <div class="pro-card" style="margin-top:1rem;">
                            ...
                            <div class="pro-breakdown-grid">
                                ...
                                <div class="pro-breakdown-chip">
                                    ...
                                    <span class="pro-breakdown-key">${_(b)}</span>
                                </div>`).join("")}
                            </div>
                        </div>`:""}
                    </div>
                        ...
                        <div class="pro-card">
                            ...
                            <div class="pro-detail-list">
                                ...
                                <div class="pro-detail-row">
                                    ...
                                    <div class="pro-detail-value">${_(String(v))}</div>
                                </div>`).join("")}
                            </div>
                        </div>
...
${C}`,C==="Present"?D="color: #10b981; font-weight: bold; font-size: 0.9rem;":C==="Late"?(D="color: #f59e0b; font-weight: bold;",M="L"):C==="Half Day"?(D="color: #c2410c; font-weight: bold;",M="HD"):C==="Absent"?(D="color: #ef4444; font-weight: bold;",M="A"):C.includes("Leave")?(D="color: #8b5cf6; font-weight: bold;",M="C"):C==="Work - Home"?(D="color: #0ea5e9; font-weight: bold;",M="W"):C==="On Duty"&&(D="color: #0369a1; font-weight: bold;",M="D"),P.isManualOverride&&(D="color: #be185d; font-weight: bold; background: #fdf2f8;")}else{const P=$===v&&g.status==="in"&&g.lastCheckIn&&k(g.lastCheckIn)===$,C=typeof g.joinDate=="string"&&/^\d{4}-\d{2}-\d{2}$/.test(g.joinDate)?$<g.joinDate:!1,O=$>v;P?(M="P",D="color: #10b981; font-weight: bold; font-size: 0.9rem;",E="Checked in (pending checkout)"):O||C?(M="-",D="color: #94a3b8; font-weight: 600;",E=O?"Future date":`Before joining date (${g.joinDate})`):B==="holiday"?(M="H",D="color: #64748b; font-weight: 700;",E="Holiday"):(M="A",D="color: #ef4444; font-weight: bold;",E="Absent")}return a||t&&(g.id===t.id||g.user_id===t.id||g.username&&t.username&&g.username===t.username||g.email&&t.email&&g.email===t.email)||(E=""),`<td style="text-align:center; ${a?"cursor:pointer;":""} border-right: 1px solid #eee; padding:2px; font-size:0.75rem; ${D}" ${E?`title="${E}"`:""} ${a?`onclick="window.app_openCellOverride('${g.id}', '${$}')"`:""}>${M}</td>`}).join("")}
                            ...
                            <tbody>
                                ${a.map(p=>`
                                    <tr>
                                        ...
                                        <td>${_(p.userName)}</td>
                                        <td><span class="admin-leave-type-badge">${_(p.type)}</span></td>
                                        <td>${p.daysCount}</td>
                                        <td>
                                            <div class="admin-leave-actions">
                                                ${window.app_hasPerm("leaves","admin")?`
                                                    <button onclick="window.AppLeaves.updateLeaveStatus('${p.id}', 'Approved', window.AppAuth?.getUser?.()?.id).then(() => window.app_refreshCurrentPage())" class="admin-btn admin-btn-success">Approve</button>
                                                    <button onclick="window.AppLeaves.updateLeaveStatus('${p.id}', 'Rejected', window.AppAuth?.getUser?.()?.id).then(() => window.app_refreshCurrentPage())" class="admin-btn admin-btn-danger">Reject</button>
                                ...
                                <tr>
                                    <td>
                                        <div class="admin-user-cell">
                                            ...
                                            <div>
                                                <div class="admin-user-name-row">${_(p.name)} ${f?'<span class="admin-user-live-tag">LIVE</span>':""}</div>
                                                <div class="admin-user-id">${_(p.username)}</div>
                                            </div>
                                        </div>
                                    </td>
        ...
        </div>`}async function dn(){const n=await window.AppAnalytics.getSystemMonthlySummary(),e=new Date,t=window.AppAuth.getUser(),a=window.app_hasPerm("reports","admin",t);return`
        <div class="card full-width">
                    ...
                    <tbody>
                        ${n.map(i=>{const{user:o,stats:r}=i,d=Number(o.baseSalary||0),l=Number(r.unpaidLeaves||0),c=Number(r.late||0),m=Number(r.extraWorkedHours||0),u=window.AppConfig?.LATE_GRACE_COUNT||3,p=window.AppConfig?.LATE_DEDUCTION_PER_BLOCK||.5,f=window.AppConfig?.EXTRA_HOURS_FOR_HALF_DAY_OFFSET||4,h=Math.floor(c/u)*p,y=Math.floor(m/f)*p,w=Math.min(h,y),b=Math.max(0,h-w),v=l+b,k=Math.round(d/22*v),g=Math.round(Math.max(0,d-k)),A=o.employeeId||"",S=o.designation||o.role||"",$=o.dept||o.department||"",L=o.joinDate||"",I=o.bankName||"",B=o.bankAccount||o.accountNumber||"",M=o.pan||o.PAN||"",D=o.uan||o.UAN||"",E=Number(o.otherAllowances||0),U=Number(o.providentFund||0),P=Number(o.professionalTax||0),C=Number(o.loanAdvance||0);return`
                                <tr data-user-id="${o.id}">
                                    ...
                                    <td style="display:none;"><input class="employee-id-input" type="text" value="${_(A)}"></td>
                                    <td style="display:none;"><input class="designation-input" type="text" value="${_(S)}"></td>
                                    <td style="display:none;"><input class="department-input" type="text" value="${_($)}"></td>
                                    <td style="display:none;"><input class="join-date-input" type="date" value="${_(L)}"></td>
                                    <td style="display:none;"><input class="bank-name-input" type="text" value="${_(I)}"></td>
                                    <td style="display:none;"><input class="bank-account-input" type="text" value="${_(B)}"></td>
                                    <td style="display:none;"><input class="pan-input" type="text" value="${_(M)}"></td>
                                    <td style="display:none;"><input class="uan-input" type="text" value="${_(D)}"></td>
                                    <td style="display:none;"><input class="other-allowances-input" type="number" value="${E}"></td>
    ...
    `}async function ln(){const n=new Date().toISOString().split("T")[0];return window.app_runPolicyTest=()=>{const e=document.getElementById("policy-test-checkin")?.value,t=document.getElementById("policy-test-checkout")?.value,a=document.getElementById("policy-test-output");if(!e||!t||!a)return;const s=document.getElementById("policy-test-date")?.value,i=new Date(`${s}T${e}`),r=(new Date(`${s}T${t}`)-i)/(1e3*60*60);let d="Absent";r>=8?d="Present":r>=4&&(d="Half Day"),a.innerHTML=`
    ...
    `}async function va(){const n=await window.AppMinutes.getMinutes(),e=window.AppDB?.getAll?await window.AppDB.getAll("users"):[],t=window.AppAuth.getUser(),a=window.AppCalendar?await window.AppCalendar.getPlans():{leaves:[],events:[],work:[]},s=(u,p=t)=>!u||!p?!1:!!(window.app_hasPerm("minutes","view",p)||u.createdBy===p.id||(u.attendeeIds||[]).includes(p.id)||(u.allowedViewers||[]).includes(p.id)||(u.actionItems||[]).some(f=>f.assignedTo===p.id)),i=(u,p=t.id)=>{const f=(u.accessRequests||[]).find(h=>h.userId===p);return f?f.status:""},o=(u="")=>{const h=new DOMParser().parseFromString(`<div>${u||""}</div>`,"text/html").body.firstElementChild;if(!h)return"";const y=new Set(["P","BR","B","STRONG","I","EM","U","H2","H3","UL","OL","LI","A"]),w={A:new Set(["href","target","rel"])},b=v=>{!v||!v.childNodes||Array.from(v.childNodes).forEach(k=>{if(k.nodeType===Node.ELEMENT_NODE){const g=k;if(!y.has(g.tagName)){for(;g.firstChild;)v.insertBefore(g.firstChild,g);v.removeChild(g);return}if(Array.from(g.attributes).forEach(A=>{const S=w[g.tagName];(!S||!S.has(A.name.toLowerCase()))&&g.removeAttribute(A.name)}),g.tagName==="A"){const A=(g.getAttribute("href")||"").trim();/^(https?:|mailto:|#)/i.test(A)?(g.setAttribute("target","_blank"),g.setAttribute("rel","noopener noreferrer")):g.removeAttribute("href")}}b(k)})};return b(h),h.innerHTML.trim()},r=(u="")=>{const p=document.createElement("div");return p.innerHTML=u||"",(p.innerText||p.textContent||"").replace(/\r/g,"").trim()},d=(u="")=>_(u||"").replace(/\n/g,"<br>"),l=(u,p="")=>{const f=document.getElementById(u),h=f?f.innerHTML:"",y=o(h);let w=r(y);return!w&&p&&(w=(document.getElementById(p)?.value||"").trim()),{html:y,text:w}},c=(u="",p="")=>{const f=o(u||"");return f||_(p||"").replace(/\n/g,"<br>")};let m=new Set;return window.app_toggleNewMinuteForm=()=>{const u=document.getElementById("new-minute-form");if(u&&(u.style.display=u.style.display==="none"?"block":"none",u.style.display==="block")){m=new Set,window.app_refreshAttendeeChips(),document.querySelectorAll('.attendee-grid input[type="checkbox"]').forEach(h=>h.checked=!1);const p=document.getElementById("action-items-container");p&&(p.innerHTML="",window.app_addActionItemRow());const f=document.getElementById("new-minute-content-editor");f&&(f.innerHTML="")}},window.app_refreshMinutesView=async()=>{const u=document.getElementById("page-content");u&&(u.innerHTML=await va())},window.app_minutesExec=(u,p,f=null)=>{const h=document.getElementById(u);h&&(h.focus(),document.execCommand(p,!1,f))},window.app_minutesFormatBlock=(u,p)=>{window.app_minutesExec(u,"formatBlock",p)},window.app_filterAttendees=u=>{const p=u.toLowerCase();document.querySelectorAll(".attendee-item-modern").forEach(f=>{const h=(f.dataset.name||"").toLowerCase();f.style.display=h.includes(p)?"flex":"none"})},window.app_filterMinutes=u=>{const p=u.toLowerCase();document.querySelectorAll(".minute-card-modern").forEach(f=>{const h=f.querySelector(".card-title-modern")?.textContent.toLowerCase()||"",y=f.querySelector(".card-date-badge")?.textContent.toLowerCase()||"";f.style.display=h.includes(p)||y.includes(p)?"flex":"none"})},window.app_toggleAttendeePick=u=>{u.checked?m.add(u.value):m.delete(u.value),window.app_refreshAttendeeChips()},window.app_refreshAttendeeChips=()=>{const u=document.getElementById("minutes-attendee-chips");u&&(u.innerHTML=Array.from(m).map(p=>{const f=e.find(h=>h.id===p);return`
            ...
            <div class="field-group">
                <select class="input-premium action-assignee">
                    ...
                    ${e.map(f=>`<option value="${f.id}">${_(f.name||f.username)}</option>`).join("")}
                </select>
            </div>
            <div class="field-group">
        ...
        `).join(""),B=(f.auditLog||[]).slice().reverse().map(D=>`
            <div class="access-request-row" style="justify-content:space-between; align-items:flex-start;">
                <div style="display:flex; flex-direction:column; gap:0.2rem;">
                    <strong style="font-size:0.82rem;">${_(D.userName||"Unknown")}</strong>
                    <span style="font-size:0.75rem; color:#64748b;">${_(D.action||"Updated")}</span>
                </div>
                ...
                <div class="modal-content minutes-detail-wide">
                    <div class="modal-header">
                        <div>
                            ...
                            <h2 style="margin:0; color:#1e1b4b;">${_(f.title)}</h2>
                            <div style="font-size:0.78rem; color:#64748b; margin-top:0.35rem;">
                                Created by ${_(k)} on ${f.createdAt?new Date(f.createdAt).toLocaleString():"-"}
                            </div>
                            <div style="font-size:0.78rem; color:#64748b;">
                                Last edited by ${_(g)} on ${A?new Date(A).toLocaleString():"-"}
                            </div>
                        </div>
                                ...
                                <section>
                                    ...
                                    ${v?`
                                        <div style="display:grid; gap:0.6rem; margin-top:0.55rem;">
                                            <input id="minute-edit-title" class="input-premium" value="${at(f.title||"")}" />
                                            <input id="minute-edit-date" class="input-premium" type="date" value="${at(f.date||"")}" />
                                            <textarea id="minute-edit-content" class="textarea-premium" style="display:none;">${_(f.content||"")}</textarea>
        ...
        `;if(!document.getElementById("modal-container")){const D=document.createElement("div");D.id="modal-container",document.body.appendChild(D)}document.getElementById("modal-container").innerHTML=M},window.app_deleteMinute=async u=>{if(confirm("Are you sure?"))try{await window.AppMinutes.deleteMinute(u),document.getElementById("minute-detail-modal")?.remove(),window.app_refreshMinutesView()}catch(p){alert("Error: "+p.message)}},`
                ...
                <div class="field-group" style="margin-bottom: 2rem;">
                    ...
                    <div class="attendee-picker-container">
                        ...
                        <div class="attendee-grid">
                            ${e.map(u=>`
                                <label class="attendee-item-modern" data-name="${at(u.name||u.username)}">
                                    <input type="checkbox" value="${u.id}" onchange="window.app_toggleAttendeePick(this)">
                                    <span>${_(u.name||u.username)}</span>
                                </label>
                            `).join("")}
                        </div>
                    </div>
            ...
            <div class="minutes-list-container">
                ${n.length?n.sort((u,p)=>new Date(p.date)-new Date(u.date)).map(u=>{const p=s(u),f=i(u);return`
                        <div class="minute-card-modern ${p?"clickable":""}" ${p?`onclick="window.app_openMinuteDetails('${u.id}')"`:""}>
                            ...
                            <h4 class="card-title-modern">${_(u.title)}</h4>
    ...
    `}function cn(n=[]){let e="";n&&n.length>0&&(e=`
            <div style="margin-bottom:1.5rem; padding-bottom:1.5rem; border-bottom:1px dashed #cbd5e1;">
                ...
                <span style="font-weight:600;">•</span> ${_(i.task)}
    ...
    <div class="modal-overlay" id="checkin-modal" style="display:flex;">
    ...
    </div>`}function pn(){if(typeof window>"u")return;const n=new MutationObserver(t=>{t.forEach(()=>{const a=document.getElementById("checkout-modal"),s=document.getElementById("checkout-intro-panel");a&&s&&a.style.display!=="none"&&(localStorage.getItem("checkoutIntroSeen")||(s.style.display="block"))})}),e=()=>{const t=document.body;t&&n.observe(t,{attributes:!0,subtree:!0,attributeFilter:["style"]})};document.readyState==="loading"?document.addEventListener("DOMContentLoaded",e):e()}typeof window<"u"&&pn();function un(){return`
     ...
     `}function mn(){return window.AppAuth?.getUser()?`
        <!-- Check-Out Modal -->
    ...
    `}function ka(n){const e=n.users||[],t=new Set(n.staffIds||[]),a=t.size?`${t.size} selected`:"All staff",s=e.map(i=>`
        <label class="team-activities-checkbox">
            <input type="checkbox" data-staff-id="${i.id}" ${t.has(i.id)?"checked":""}>
            <span>${_(i.name||"Staff")}</span>
        </label>
    `).join("");return`
    ...
    `}function Aa(n){const e=n.columnVisibility;return`
    ...
    `}function An(n){const e=n.columnVisibility,t=kn(n.filtered,n.page,n.pageSize);if(!t.length)return'<div class="team-activities-empty">No activities found for the selected filters.</div>';const a=`
        ...
        <th>Actions</th>
    `,s=window.AppAuth?.getUser?window.AppAuth.getUser()?.id:null,i=t.map(o=>{const r=String(o.status||"").toLowerCase().replace(/\s+/g,"-"),d=s&&o.userId&&s===o.userId,l=o.type==="work"&&(o.progressPercent!==null||o.progressStatus||o.progressNote),c=o.progressStatus?String(o.progressStatus).replace(/_/g," "):"",m=o.progressPercent!==null?`${o.progressPercent}%`:"",u=String(o.progressNote||"").trim(),p=u?` title="${_(u)}"`:"",f=l?`<div class="team-activities-progress"${p}>${_(m)}${m&&c?" • ":""}${_(c)}</div>`:"";return`
        <tr>
            <td>${_(o.date)}</td>
            <td>${_(o.staffName)}</td>
            ${e.type?`<td class="team-activities-type">${_(o.type)}</td>`:""}
            ${e.status?`<td><span class="team-activities-status status-${_(r)}">${_(o.status)}</span></td>`:""}
            <td class="team-activities-desc">${_(o.description)}${f}</td>
            ${e.sourceTime?`<td>${_(o.sourceTime||"--")}</td>`:""}
            <td>
                <div class="team-activities-row-actions">
                    <button class="team-activities-row-btn" data-view-date="${_(o.date)}" data-view-user="${_(o.userId)}">
                        <i class="fa-solid fa-eye"></i> View
                    </button>
                    ${o.type==="work"&&d&&hn(o.status)&&o.planId&&Number.isInteger(o.taskIndex)?`
                        <button class="team-activities-row-btn warn" data-action="postpone" data-plan-id="${_(o.planId)}" data-task-index="${o.taskIndex}" data-plan-scope="${_(o.planScope)}" data-user-id="${_(o.userId)}" data-date="${_(o.date)}">
                            <i class="fa-solid fa-clock"></i> Postpone
                        </button>
                        <button class="team-activities-row-btn success" data-action="complete" data-plan-id="${_(o.planId)}" data-task-index="${o.taskIndex}" data-user-id="${_(o.userId)}">
    ...
    `}function Dn(n){const e=n.filtered.length,t=Math.max(1,Math.ceil(e/n.pageSize)),a=Math.min(n.page,t);return`
    ...
    `}function le(){const n=fe();bn(n);const e=Math.max(1,Math.ceil(n.filtered.length/n.pageSize));n.page>e&&(n.page=e);const t=document.getElementById("team-activities-summary"),a=document.getElementById("team-activities-table-wrap"),s=document.getElementById("team-activities-pagination-wrap"),i=document.getElementById("team-activities-last-updated"),o=document.getElementById("team-activities-columns-wrap"),r=document.getElementById("team-activities-staff-wrap");t&&(t.innerHTML=Sa(n)),a&&(a.innerHTML=An(n)),s&&(s.innerHTML=Dn(n)),o&&(o.innerHTML=Aa(n)),r&&(r.innerHTML=ka(n)),i&&n.lastRefreshed&&(i.textContent=new Date(n.lastRefreshed).toLocaleString())}async function _e(){const n=fe(),e=document.getElementById("team-activities-loading");e&&(e.style.display="block");try{const t=await window.AppAnalytics.getAllStaffActivities({mode:"range",startIso:n.startIso,endIso:n.endIso,scope:"all"});n.data=yn(t),n.lastRefreshed=Date.now(),n.page=1}catch(t){console.error("Team Activities fetch failed",t)}finally{e&&(e.style.display="none")}le()}function nt(){const n=fe(),e=document.getElementById("team-activities-start"),t=document.getElementById("team-activities-end"),a=document.getElementById("team-activities-type"),s=document.getElementById("team-activities-status"),i=document.getElementById("team-activities-search"),o=document.getElementById("team-activities-page-size");e&&(n.startIso=e.value||n.startIso),t&&(n.endIso=t.value||n.endIso),a&&(n.type=a.value||"all"),s&&(n.status=s.value||"all"),i&&(n.search=i.value||""),o&&(n.pageSize=Number(o.value)||lt),n.page=1,le()}function _n(){const n=fe();if(n.bound)return;n.bound=!0;let e=null;document.addEventListener("click",async t=>{const a=t.target,s=a.closest("[data-team-activities-staff-toggle]"),i=document.getElementById("team-activities-staff-panel"),o=a.closest("[data-team-activities-columns-toggle]"),r=document.getElementById("team-activities-columns-popover");s&&i?i.classList.toggle("open"):i&&!i.contains(a)&&i.classList.remove("open"),o&&r?r.classList.toggle("open"):r&&!r.contains(a)&&r.classList.remove("open");const d=a.closest(".team-activities-page-btn");if(d){const f=d.dataset.page,h=Math.max(1,Math.ceil(n.filtered.length/n.pageSize));f==="prev"&&(n.page=Math.max(1,n.page-1)),f==="next"&&(n.page=Math.min(h,n.page+1)),le()}const l=a.closest("[data-view-date]");if(l){const f=l.getAttribute("data-view-date"),h=l.getAttribute("data-view-user");window.app_openDayPlan&&window.app_openDayPlan(f,h||"")}const c=a.closest("[data-action]");if(c){const f=c.getAttribute("data-action");f==="complete"&&window.app_teamActivitiesCompleteTask&&await window.app_teamActivitiesCompleteTask(c),f==="postpone"&&window.app_teamActivitiesPostponeTask&&await window.app_teamActivitiesPostponeTask(c)}const m=a.closest("th[data-sort]");if(m){const f=m.dataset.sort;f&&(n.sortKey=f,le())}a.closest("[data-staff-select-all]")&&(n.staffIds=(n.users||[]).map(f=>f.id),le()),a.closest("[data-staff-clear]")&&(n.staffIds=[],le())}),document.addEventListener("change",t=>{const a=t.target;if(a.matches("#team-activities-start, #team-activities-end")?(nt(),_e()):a.matches("#team-activities-type, #team-activities-status, #team-activities-page-size")&&nt(),a.matches('#team-activities-columns-popover input[type="checkbox"]')){const s=a.getAttribute("data-column");s&&(n.columnVisibility[s]=a.checked),le()}if(a.matches('#team-activities-staff-panel input[type="checkbox"]')){const s=a.getAttribute("data-staff-id");if(!s)return;a.checked?n.staffIds.includes(s)||n.staffIds.push(s):n.staffIds=n.staffIds.filter(i=>i!==s),le()}}),document.addEventListener("input",t=>{t.target.matches("#team-activities-search")&&(e&&clearTimeout(e),e=setTimeout(()=>nt(),fn))})}function $n(n){const e=["Date","Staff","Type","Status","Description","Time"],t=n.map(a=>[a.date,a.staffName,a.type,a.status,a.description,a.sourceTime].map(s=>`"${String(s||"").replace(/\"/g,'""')}"`).join(","));return[e.join(","),...t].join(`
`)}typeof window<"u"&&(window.app_initTeamActivities=async function(){const n=fe(),e=await window.AppAnalytics.getUsersCached();n.users=e||[],_n(),le(),await _e()},window.app_teamActivitiesRefresh=async function(){nt(),await _e()},window.app_teamActivitiesResetFilters=function(){const n=fe(),e=ba();n.startIso=e.startIso,n.endIso=e.endIso,n.staffIds=[],n.status="all",n.type="all",n.search="",n.sortKey="date-desc",n.page=1,n.pageSize=lt;const t=document.getElementById("team-activities-start"),a=document.getElementById("team-activities-end"),s=document.getElementById("team-activities-type"),i=document.getElementById("team-activities-status"),o=document.getElementById("team-activities-search"),r=document.getElementById("team-activities-page-size");t&&(t.value=n.startIso),a&&(a.value=n.endIso),s&&(s.value="all"),i&&(i.value="all"),o&&(o.value=""),r&&(r.value=String(lt)),le(),_e()},window.app_teamActivitiesCopyCSV=async function(){const n=fe(),e=$n(n.filtered);try{await navigator.clipboard.writeText(e),alert("Table copied to clipboard.")}catch(t){console.warn("Clipboard copy failed",t),alert("Copy failed. Please use Export Excel instead.")}},window.app_teamActivitiesExportXLSX=function(){const n=fe();window.AppReports?.exportTeamActivitiesXLSX?window.AppReports.exportTeamActivitiesXLSX(n.filtered,{start:n.startIso,end:n.endIso}):alert("Export module not available.")},window.app_teamActivitiesCompleteTask=async function(n){try{const e=window.AppAuth?.getUser?window.AppAuth.getUser()?.id:null,t=n.getAttribute("data-plan-id"),a=Number(n.getAttribute("data-task-index")),s=n.getAttribute("data-user-id")||"";if(!e||e!==s){alert("Only the assigned staff member can complete this task.");return}if(!t||!Number.isInteger(a)||!window.AppCalendar?.updateTaskStatus)return;n.disabled=!0,await window.AppCalendar.updateTaskStatus(t,a,"completed"),await _e(),window.app_showSyncToast&&window.app_showSyncToast("Task marked as completed.")}catch(e){console.error("Complete task failed",e),alert("Failed to complete task.")}},window.app_teamActivitiesPostponeTask=async function(n){try{const e=window.AppAuth?.getUser?window.AppAuth.getUser()?.id:null,t=n.getAttribute("data-plan-id"),a=Number(n.getAttribute("data-task-index")),s=n.getAttribute("data-plan-scope")||"personal",i=n.getAttribute("data-user-id")||"",o=n.getAttribute("data-date")||"";if(!e||e!==i){alert("Only the assigned staff member can postpone this task.");return}if(!t||!Number.isInteger(a)||!window.AppDB||!window.AppCalendar)return;n.disabled=!0;const r=await window.AppDB.get("work_plans",t);if(!r||!Array.isArray(r.plans)||!r.plans[a])throw new Error("Plan or task not found");const d=gn(o),l=await vn(n,d);if(!l){n.disabled=!1;return}const c=String(l).trim();if(!wn(c)){alert("Invalid date. Please use YYYY-MM-DD."),n.disabled=!1;return}const[m]=r.plans.splice(a,1);r.updatedAt=new Date().toISOString(),await window.AppDB.put("work_plans",r);const u=c,p=s||r.planScope||"personal",f=p==="annual"?"annual_shared":r.userId||i,h=window.AppCalendar.getWorkPlanId(u,f,p),y={...m,status:"",startDate:u,endDate:u};delete y.completedDate;const w=await window.AppDB.get("work_plans",h);if(w)w.plans=Array.isArray(w.plans)?w.plans:[],w.plans.push(y),w.updatedAt=new Date().toISOString(),await window.AppDB.put("work_plans",w);else{const b=p==="annual"?null:f;await window.AppCalendar.setWorkPlan(u,[y],b,{planScope:p})}await _e(),window.app_showSyncToast&&window.app_showSyncToast(`Task postponed to ${u}.`)}catch(e){console.error("Postpone task failed",e),alert("Failed to postpone task.")}});async function xn(){const n=fe();return`
            ...
            <div class="team-activities-header">
                ...
                <div class="team-activities-actions">
                    ...
                    <div class="team-activities-columns">
                        ...
                        <div id="team-activities-columns-wrap">${Aa(n)}</div>
                    </div>
                </div>
            </div>
            <div class="team-activities-summary" id="team-activities-summary">${Sa(n)}</div>
...
`),c=`Attendance_Sheet_${new Date(t,e).toLocaleString("default",{month:"long"})}_${t}.csv`;return this.downloadFile(d,c,"text/csv"),!0}catch(i){console.error("Export Failed:",i),alert("Export Failed: "+i.message)}}async exportLeavesCSV(e){try{const t=["Applied On","Staff Name","FY","Type","From","To","Days/Hrs","Reason","Status","Admin Comment"],a=["appliedOn","userName","financialYear","type","startDate","endDate","daysCount","reason","status","adminComment"],s=e.map(r=>({...r,daysCount:r.type==="Short Leave"?`${r.durationHours||0}h`:r.daysCount})),i=this.convertToCSV(s,t,a),o=`Leave_Requests_${new Date().toISOString().split("T")[0]}.csv`;return this.downloadFile(i,o,"text/csv"),!0}catch(t){console.error("Leave Export Failed:",t),alert("Export Failed: "+t.message)}}async exportCalendarPlansCSV(e,t,a){try{const s=[],i=new Date(a,t+1,0).getDate(),o=new Date(a,t).toLocaleString("default",{month:"long"});for(let m=1;m<=i;m++){const u=`${a}-${String(t+1).padStart(2,"0")}-${String(m).padStart(2,"0")}`;e.leaves.forEach(p=>{u>=p.startDate&&u<=p.endDate&&s.push({date:u,category:"Leave",subject:`${p.userName||"Staff"} - ${p.type}`,details:p.reason||"No reason provided",staff:p.userName||"Staff"})}),e.events.forEach(p=>{p.date===u&&s.push({date:u,category:"Event",subject:p.title,details:p.type||"General Event",staff:"Organization"})}),e.workPlans.forEach(p=>{if(p.date===u){const f=Array.isArray(p.plans)?p.plans:[],h=f.length>0?f.map((y,w)=>{let b=`${w+1}. ${y.task}`;return y.subPlans&&y.subPlans.length>0&&(b+=` (Steps: ${y.subPlans.join(", ")})`),y.tags&&y.tags.length>0&&(b+=` [With: ${y.tags.map(v=>`@${v.name} (${v.status||"pending"})`).join(", ")}]`),b}).join(" | "):"Work Plan";s.push({date:u,category:"Work Plan",subject:"Daily Goals",details:h,staff:p.userName||"Staff"})}})}if(s.length===0)return alert("No plans found for the selected month."),!1;const r=["Date","Category","Subject","Details","Staff Member"],d=["date","category","subject","details","staff"],l=this.convertToCSV(s,r,d),c=`Team_Schedule_${o}_${a}.csv`;return this.downloadFile(l,c,"text/csv"),!0}catch(s){console.error("Calendar Export Failed:",s),alert("Failed to export calendar: "+s.message)}}async exportAnnualListViewCSV(e){try{const t=(e||[]).map(r=>({date:r.date||"",staffName:r.staffName||r.staff||"",assignedBy:r.assignedBy||"",assignedTo:r.assignedTo||"",selfAssigned:r.selfAssigned?"Yes":"No",dueDate:r.dueDate||"",status:r.statusLabel||r.status||"",comments:r.comments||"",tags:Array.isArray(r.tags)?r.tags.join(", "):r.tags||""})),a=["Date","Staff Name","Assigned By","Assigned To","Self Assigned","Due Date","Completion Status","Comments","Tags"],s=["date","staffName","assignedBy","assignedTo","selfAssigned","dueDate","status","comments","tags"],i=this.convertToCSV(t,a,s),o=`Annual_Plan_List_${new Date().toISOString().split("T")[0]}.csv`;return this.downloadFile(i,o,"text/csv"),!0}catch(t){throw console.error("List Export Failed:",t),new Error("Failed to export list: "+t.message)}}exportTeamActivitiesXLSX(e,t={}){try{if(typeof window>"u"||!window.XLSX)return alert("Excel export library not loaded."),!1;const a=(e||[]).map(m=>[m.date||"",m.staffName||"",m.type||"",m.status||"",m.description||"",m.sourceTime||""]),s=["Date","Staff","Type","Status","Description","Time"],i=window.XLSX.utils.aoa_to_sheet([s,...a]),o=window.XLSX.utils.book_new();window.XLSX.utils.book_append_sheet(o,i,"Team Activities");const r=(t.start||"").replace(/[^a-zA-Z0-9_-]/g,"_"),d=(t.end||"").replace(/[^a-zA-Z0-9_-]/g,"_"),c=`Team_Activities_${r&&d?`${r}_to_${d}`:r||d||"export"}.xlsx`;return window.XLSX.writeFile(o,c),!0}catch(a){return console.error("Team Activities Export Failed:",a),alert("Export Failed: "+a.message),!1}}}const On=new Bn;typeof window<"u"&&(window.AppReports=On);class Un{constructor(){this.db=q,this.cache={},this.defaultPolicy={"Annual Leave":{total:10,minDays:3,accrual:"annual"},"Casual Leave":{total:6,maxDays:2,accrual:"monthly"},"Medical Leave":{total:6,certificateThreshold:2,accrual:"annual"},"Maternity Leave":{total:180,paid:!0,gender:"female"},"Paternity Leave":{total:10,paid:!0,gender:"male",minServiceYears:0},"Study Leave":{total:5,paid:!1,requireApproval:!0},"Compassionate Leave":{total:3,paid:!0}}}async getPolicy(){if(this.cache.policy)return this.cache.policy;try{if(window.AppFirestore){const e=await window.AppFirestore.collection("settings").doc("policies").get();e.exists?this.cache.policy={...this.defaultPolicy,...e.data()}:this.cache.policy=this.defaultPolicy}else this.cache.policy=this.defaultPolicy}catch(e){console.warn("Failed to fetch dynamic policy, using default.",e),this.cache.policy=this.defaultPolicy}return this.cache.policy}async updatePolicy(e){try{if(window.AppFirestore)return await window.AppFirestore.collection("settings").doc("policies").set(e,{merge:!0}),this.cache.policy=null,!0;throw new Error("Database not connected")}catch(t){throw console.error("Failed to update policy:",t),t}}async getFinancialYear(e=new Date){const t=e.getMonth(),a=e.getFullYear();return t<3?{label:`${a-1}-${a}`,start:new Date(a-1,3,1),end:new Date(a,2,31)}:{label:`${a}-${a+1}`,start:new Date(a,3,1),end:new Date(a+1,2,31)}}async getUserLeaves(e,t=null){t||(t=(await this.getFinancialYear()).label);try{if(this.db.queryMany&&x?.READ_OPT_FLAGS?.FF_READ_OPT_DB_QUERIES)return(await this.db.queryMany("leaves",[{field:"userId",operator:"==",value:e},{field:"financialYear",operator:"==",value:t}])).sort((i,o)=>new Date(o.startDate)-new Date(i.startDate))}catch(s){console.warn("Scoped getUserLeaves query failed, using fallback",s)}return(await this.db.getAll("leaves")).filter(s=>s.userId===e&&s.financialYear===t).sort((s,i)=>new Date(i.startDate)-new Date(s.startDate))}async getLeaveUsage(e,t,a){return(await this.getUserLeaves(e,a.label)).filter(o=>o.type===t&&(o.status==="Approved"||o.status==="Pending")).reduce((o,r)=>o+(parseFloat(r.daysCount)||0),0)}async getMonthlyShortLeaveUsage(e,t){const a=`${t.getFullYear()}-${String(t.getMonth()+1).padStart(2,"0")}`;let s=[];try{this.db.queryMany&&x?.READ_OPT_FLAGS?.FF_READ_OPT_DB_QUERIES&&(s=(await this.db.queryMany("leaves",[{field:"userId",operator:"==",value:e},{field:"type",operator:"==",value:"Short Leave"},{field:"startDate",operator:">=",value:`${a}-01`},{field:"startDate",operator:"<=",value:`${a}-31`}])).filter(o=>o.status==="Approved"||o.status==="Pending"))}catch(i){console.warn("Scoped short leave query failed, using fallback",i)}return s.length||(s=(await this.db.getAll("leaves")).filter(o=>o.userId===e&&o.type==="Short Leave"&&o.startDate.startsWith(a)&&(o.status==="Approved"||o.status==="Pending"))),s.reduce((i,o)=>i+(parseFloat(o.daysCount||o.durationHours)||0),0)}async getPendingLeaves(){try{let e=[];if(this.db.queryMany&&x?.READ_OPT_FLAGS?.FF_READ_OPT_DB_QUERIES?e=(await this.db.queryMany("leaves",[{field:"status",operator:"==",value:"Pending"}],{orderBy:[{field:"appliedOn",direction:"desc"}]})).sort((a,s)=>new Date(s.appliedOn)-new Date(a.appliedOn)):e=(await this.db.getAll("leaves")).filter(a=>a.status==="Pending").sort((a,s)=>new Date(s.appliedOn)-new Date(a.appliedOn)),e.length>0){const t=await this.db.getAll("users"),a={};t.forEach(s=>{a[s.id]=s.name}),e.forEach(s=>{!s.userName&&a[s.userId]&&(s.userName=a[s.userId])})}return e}catch(e){return console.warn("getPendingLeaves failed, using fallback",e),(await this.db.getAll("leaves").catch(()=>[])).filter(a=>a.status==="Pending").sort((a,s)=>new Date(s.appliedOn)-new Date(a.appliedOn))}}async requestLeave(e){const{userId:t,startDate:a,endDate:s,type:i,durationHours:o}=e,r=new Date(a),d=new Date(s);let l=Math.ceil((d-r)/(1e3*60*60*24))+1;if(l<=0&&i!=="Short Leave")throw new Error("Invalid date range");const c=await this.getFinancialYear(r),m=await this.getLeaveUsage(t,i,c),p=(await this.getPolicy())[i],f=[];if(i==="Half Day")l=.5,e.daysCount=.5;else if(i==="Short Leave"){const y=await this.getMonthlyShortLeaveUsage(t,r);let w=parseFloat(o||0);w>2&&f.push("Short Leave exceeds 2 hours (standard)."),y+w>4&&f.push(`Monthly Short Leave limit exceeded (${y+w}/4 hours).`),e.daysCount=w}else if(i==="Annual Leave")l<(p.minDays||1)&&f.push(`Annual Leave requested is less than required minimum (${p.minDays||1} days).`),m+l>p.total&&f.push(`Annual Leave balance exceeded (${m+l}/${p.total}).`);else if(i==="Casual Leave")l>p.maxDays&&f.push(`Casual Leave exceeds maximum allowed per request (${p.maxDays} days).`),m+l>p.total&&f.push(`Casual Leave balance exceeded (${m+l}/${p.total}).`);else if(i==="Medical Leave")m+l>p.total&&f.push(`Medical Leave balance exceeded (${m+l}/${p.total}).`),l>p.certificateThreshold&&(e.requireCertificate=!0);else if(i==="Paternity Leave"){const y=await this.db.get("users",t),w=new Date(y.joinDate),b=(r-w)/(1e3*60*60*24*365.25);p.minServiceYears&&b<p.minServiceYears&&f.push(`User has not completed ${p.minServiceYears} year(s) of service (required for Paternity Leave).`),l>p.total&&f.push(`Paternity Leave exceeds limit of ${p.total} days.`)}else["Study Leave","Compassionate Leave"].includes(i)&&p&&l>p.total&&f.push(`${i} exceeds limit of ${p.total} days.`);const h={id:"l"+Date.now(),...e,status:"Pending",appliedOn:new Date().toISOString(),financialYear:c.label,daysCount:l,policyWarnings:f};return await this.db.add("leaves",h),h}async updateLeaveStatus(e,t,a,s=""){const i=await this.db.get("leaves",e);if(!i)throw new Error("Leave not found");const o=a||window.AppAuth?.getUser?.()?.id||null;if(i.status=t,i.actionDate=new Date().toISOString(),i.adminComment=s,o?i.actionBy=o:delete i.actionBy,await this.db.put("leaves",i),t==="Approved"){const r=new Date(i.startDate),d=new Date(i.endDate);let l=new Date(r);for(;l<=d;){const c=l.toISOString().split("T")[0],m={id:"att_"+i.userId+"_"+c,user_id:i.userId,date:c,checkIn:"09:00",checkOut:"17:00",duration:"8h 0m",location:"On Leave",type:i.type,status:"in",synced:!1};await this.db.put("attendance",m),l.setDate(l.getDate()+1)}}return i}}const we=new Un;typeof window<"u"&&(window.AppLeaves=we);class Rn{constructor(){this.db=q,this.cleanupFlag=x?.SIMULATION_POLICY?.LEGACY_DUMMY_CLEANUP?.FLAG_KEY||"legacy_dummy_cleanup_v1",this.simulationFlag="simulation_run_v2"}getCleanupPolicy(){const e=x?.SIMULATION_POLICY?.LEGACY_DUMMY_CLEANUP||{},t=new Set((e.TARGET_USER_IDS||[]).map(s=>String(s||"").trim()).filter(Boolean)),a=new Set((e.TARGET_USERNAMES||[]).map(s=>String(s||"").trim().toLowerCase()).filter(Boolean));return{enabled:e.ENABLED!==!1,targetIds:t,targetUsernames:a,auditCollection:String(e.AUDIT_COLLECTION||"system_audit_logs")}}async writeCleanupAudit(e,t={}){const a=this.getCleanupPolicy();try{await this.db.add(a.auditCollection,{type:e,module:"simulation",payload:t,createdAt:Date.now()})}catch(s){console.warn("Simulation audit log write failed:",s)}}async run(){const e=x&&x.READ_OPT_FLAGS||{},t=typeof window<"u"&&window.location&&window.location.hostname?window.location.hostname:"",a=t==="localhost"||t==="127.0.0.1";if(!(!e.ENABLE_SIMULATION_MODULE&&!a)){if(localStorage.getItem(this.cleanupFlag)||(await this.cleanupLegacyDummyData(),localStorage.setItem(this.cleanupFlag,"true")),localStorage.getItem(this.simulationFlag)){console.log("Simulation already ran. Use window.AppSimulation.forceRun() to force.");return}await this.forceRun(),localStorage.setItem(this.simulationFlag,"true")}}async cleanupLegacyDummyData(){const e=this.getCleanupPolicy();if(e.enabled){if(e.targetIds.size===0&&e.targetUsernames.size===0){await this.writeCleanupAudit("legacy_dummy_cleanup_skipped",{reason:"no_targets"});return}try{const a=(await this.db.getAll("users")).filter(u=>e.targetIds.has(u.id)||e.targetUsernames.has((u.username||"").trim().toLowerCase())),s=new Set(a.map(u=>u.id));if(s.size===0){await this.writeCleanupAudit("legacy_dummy_cleanup_skipped",{reason:"no_matches",configuredTargets:{ids:Array.from(e.targetIds),usernames:Array.from(e.targetUsernames)}});return}let i=0,o=0,r=0,d=0;const l=await this.db.getAll("attendance");for(const u of l){const p=u.user_id||u.userId;s.has(p)&&(await this.db.delete("attendance",u.id),i+=1)}const c=await this.db.getAll("leaves");for(const u of c){const p=u.userId||u.user_id;s.has(p)&&(await this.db.delete("leaves",u.id),o+=1)}const m=await this.db.getAll("work_plans");for(const u of m){const p=u.userId||u.user_id;s.has(p)&&(await this.db.delete("work_plans",u.id),r+=1)}for(const u of a)await this.db.delete("users",u.id),d+=1;await this.writeCleanupAudit("legacy_dummy_cleanup_completed",{matchedUserIds:Array.from(s),deleted:{attendance:i,leaves:o,workPlans:r,users:d}}),console.log("Legacy dummy users and linked records removed.",{users:d,attendance:i,leaves:o,workPlans:r})}catch(t){await this.writeCleanupAudit("legacy_dummy_cleanup_failed",{message:t?.message||String(t)}),console.warn("Legacy dummy cleanup failed:",t)}}}async forceRun(){console.log("Starting Office Scenario Simulation (V2)...");const e=new Date;if(window.AppCalendar){const t=new Date(e);t.setDate(t.getDate()+1),await window.AppCalendar.addEvent({title:"Office Picnic/Holiday",date:t.toISOString().split("T")[0],type:"holiday"})}console.log("Simulation Complete.")}}const jt=new Rn;typeof window<"u"&&(window.AppSimulation=jt,setTimeout(()=>jt.run(),2e3));const ae="minutes";function De(){const n=window.AppAuth.getUser();if(!n||!n.id)throw new Error("User not authenticated");return n}function Ve(n){return!!(window.app_hasPerm&&window.app_hasPerm("minutes","admin",n))}function Hn(n,e,t,a={}){const s=n&&n.createdBy===e.id,i=Ve(e),o=a&&a.allowNonOwner===!0;if(!s&&!i&&!o)throw new Error("You do not have permission to edit these minutes.");if(n&&n.locked&&!(a&&a.allowOnLocked===!0))throw new Error("This record is locked.");return!t||!String(t).trim()?"Updated minutes":String(t).trim()}async function Fn(n={}){try{const e=n.limit||150;return window.AppDB?await window.AppDB.getAll(ae):(await window.AppFirestore.collection(ae).orderBy("date","desc").limit(e).get()).docs.map(a=>({id:a.id,...a.data()}))}catch(e){throw console.error("Error fetching minutes:",e),e}}async function qn(n){try{const e=De(),t=new Date().toISOString(),a=e.name||e.username||"Unknown",s={...n,createdBy:e.id,createdByName:a,createdAt:t,lastEditedBy:e.id,lastEditedByName:a,lastEditedAt:t,auditLog:[{userId:e.id,userName:a,timestamp:t,action:"Created meeting minutes"}],approvals:{},locked:!1,restrictedFrom:[],allowedViewers:[],accessRequests:[]};return window.AppDB?await window.AppDB.add(ae,s):(await window.AppFirestore.collection(ae).add(s)).id}catch(e){throw console.error("Error adding minute:",e),e}}async function Ke(n,e,t,a={}){try{const s=De(),i=await(window.AppDB?window.AppDB.get(ae,n):window.AppFirestore.collection(ae).doc(n).get().then(m=>m.data()));if(!i)throw new Error("Minute not found");const o=Hn(i,s,t,a),r=new Date().toISOString(),d=s.name||s.username||"Unknown",l={userId:s.id,userName:d,timestamp:r,action:o},c={...i,...e,id:n,lastEditedBy:s.id,lastEditedByName:d,lastEditedAt:r,auditLog:[...i.auditLog||[],l]};return window.AppDB?await window.AppDB.put(ae,c):await window.AppFirestore.collection(ae).doc(n).update(c),!0}catch(s){throw console.error("Error updating minute:",s),s}}async function zn(n){try{const e=De(),t=await(window.AppDB?window.AppDB.get(ae,n):window.AppFirestore.collection(ae).doc(n).get().then(s=>s.data()));if(!t)throw new Error("Minute not found");const a=t.accessRequests||[];return a.some(s=>s.userId===e.id)?!0:(a.push({userId:e.id,userName:e.name||e.username||"Unknown",status:"pending",requestedAt:new Date().toISOString()}),await Ke(n,{accessRequests:a},`Requested access for ${e.name||e.username}`,{allowNonOwner:!0,allowOnLocked:!0}))}catch(e){throw console.error("Error requesting access:",e),e}}async function jn(n,e,t){try{const a=De(),s=await(window.AppDB?window.AppDB.get(ae,n):window.AppFirestore.collection(ae).doc(n).get().then(c=>c.data()));if(!s)throw new Error("Minute not found");const i=s.createdBy===a.id,o=Ve(a);if(!i&&!o)throw new Error("Only owner or admin can review access requests.");const r=s.accessRequests||[],d=r.find(c=>c.userId===e);if(!d)return!0;d.status=t;const l=s.allowedViewers||[];return t==="approved"&&!l.includes(e)&&l.push(e),await Ke(n,{accessRequests:r,allowedViewers:l},`${String(t||"").toUpperCase()} access request for userId: ${e}`,{allowOnLocked:!0})}catch(a){throw console.error("Error handling access request:",a),a}}async function Wn(n,e,t){try{const a=De(),s=await(window.AppDB?window.AppDB.get(ae,n):window.AppFirestore.collection(ae).doc(n).get().then(l=>l.data()));if(!s||!s.actionItems)throw new Error("Minute or tasks not found");const i=s.actionItems[e];if(!i)throw new Error("Task not found");const o=s.createdBy===a.id,r=Ve(a),d=i.assignedTo===a.id;if(!o&&!r&&!d)throw new Error("Only owner, admin, or assignee can update this task.");return i.status=t,t==="completed"&&(i.completedAt=new Date().toISOString()),await Ke(n,{actionItems:s.actionItems},`Updated Task: ${i.task} to ${t}`,{allowNonOwner:!0,allowOnLocked:!0})}catch(a){throw console.error("Error updating action item:",a),a}}async function Yn(n){try{const e=De(),t=await(window.AppDB?window.AppDB.get(ae,n):window.AppFirestore.collection(ae).doc(n).get().then(c=>c.data()));if(!t)throw new Error("Minute not found");const a=t.attendeeIds||[],s=a.includes(e.id),i=t.createdBy===e.id,o=Ve(e);if(!s&&!i&&!o)throw new Error("Only attendees, owner, or admin can approve minutes.");const r=t.approvals||{};r[e.id]=new Date().toISOString();const d=a.length>0&&a.every(c=>r[c]),l={approvals:r};return d&&(l.locked=!0),await Ke(n,l,`${d?"FINAL APPROVAL & LOCK":"Signed"} by ${e.name||e.username}`,{allowNonOwner:!0,allowOnLocked:!0})}catch(e){throw console.error("Error approving minute:",e),e}}async function Vn(n){try{const e=De(),t=await(window.AppDB?window.AppDB.get(ae,n):window.AppFirestore.collection(ae).doc(n).get().then(i=>i.data()));if(!t)throw new Error("Minute not found");const a=t.createdBy===e.id,s=Ve(e);if(!a&&!s)throw new Error("Only owner or admin can delete minutes.");return window.AppDB?await window.AppDB.delete(ae,n):(await window.AppFirestore.collection(ae).doc(n).delete(),!0)}catch(e){throw console.error("Error deleting minute:",e),e}}const Kn={getMinutes:Fn,addMinute:qn,updateMinute:Ke,approveMinute:Yn,deleteMinute:Vn,requestAccess:zn,handleAccessRequest:jn,updateActionItemStatus:Wn};typeof window<"u"&&(window.AppMinutes=Kn);const Ct={async renderPolicyEditor(){const n=await we.getPolicy();return`
    ...
    `,e.subPlans&&e.subPlans.forEach(A=>{const S=F("input",{className:"sub-plan-input",attributes:{value:ke(A)}});b.appendChild(S)}),e.tags&&e.tags.forEach(A=>{const S=F("div",{className:"tag-chip",attributes:{"data-id":A.id,"data-name":A.name,"data-status":A.status||"pending"}});b.appendChild(S)}),w.appendChild(b);const v=F("div",{className:"plan-block-header"}),k=F("div",{className:"plan-block-title-group"});k.appendChild(F("span",{className:"day-plan-index-badge",textContent:t+1})),k.appendChild(F("span",{className:"plan-block-summary",textContent:y}));const g=F("div",{className:"plan-block-actions"});if(g.appendChild(F("span",{className:"day-plan-scope-pill",textContent:h})),l||(g.appendChild(pe({className:"day-plan-edit-btn",attributes:{title:"Edit plan"},innerHTML:'<i class="fa-solid fa-pen-to-square"></i>',onClick:()=>qe({date:u,targetId:s,scope:f,allUsers:a,selectableCollaborators:o,isAdmin:r,container:w.parentElement,existingBlock:w})})),t>0&&g.appendChild(pe({className:"day-plan-remove-btn",attributes:{title:"Remove task"},innerHTML:'<i class="fa-solid fa-trash-can"></i>',onClick:()=>w.remove()}))),v.appendChild(k),v.appendChild(g),w.appendChild(v),e.tags&&e.tags.length>0){const A=F("div",{className:"plan-block-body"});e.tags.forEach(S=>{const $=F("span",{className:"day-plan-tag-pill",textContent:`@${S.name}`});A.appendChild($)}),w.appendChild(A)}return w}function Da(n){if(!n)return null;const e=n.querySelector(".plan-task")?.value||"",t=n.querySelector(".plan-status")?.value||"",a=n.querySelector(".plan-scope")?.value||"personal",s=n.querySelector(".plan-assignee")?.value||"",i=n.querySelector(".plan-start-date")?.value||"",o=n.querySelector(".plan-end-date")?.value||"",r=Array.from(n.querySelectorAll(".sub-plan-input")).map(l=>l.value),d=Array.from(n.querySelectorAll(".tag-chip")).map(l=>({id:l.dataset.id,name:l.dataset.name,status:l.dataset.status}));return{task:e,status:t,planScope:a,assignedTo:s,startDate:i,endDate:o,subPlans:r,tags:d}}async function _a(n,e=null,t=null){const a=Q.getUser(),s=String(e??"").trim(),i=!s||s==="undefined"||s==="null"?a.id:s,o=await q.getAll("users"),r=a.role==="Administrator"||a.isAdmin,d=i!==a.id,l=t==="annual"?"annual":"personal";window.app_currentDayPlanTargetId=i;const[c,m,u]=await Promise.all([Be.getWorkPlan(i,n,{planScope:"personal"}),Be.getWorkPlan(i,n,{planScope:"annual"}),q.queryMany("work_plans",[{field:"date",operator:"==",value:n}])]),p=!!(c||m),f=o.find(I=>I.id===i),h=f?f.name:"Staff",y=o.filter(I=>I.id!==i),w=(I,B,M=null)=>I?Array.isArray(I.plans)&&I.plans.length>0?I.plans.map(D=>({...D,planScope:B,userName:M||I.userName,isReference:!!M})):[]:[],b=(u||[]).filter(I=>I.id!==Be.getWorkPlanId(n,i,"personal")&&I.id!==Be.getWorkPlanId(n,i,"annual")),v=[];b.forEach(I=>{v.push(...w(I,I.planScope,I.userName))});const k=[...w(c,"personal"),...w(m,"annual"),...v];k.length===0&&k.push({task:"",subPlans:[],tags:[],status:null,assignedTo:i,startDate:n,endDate:n,planScope:l});const g=F("div",{id:"day-plan-modal",className:"day-plan-modal-overlay"}),A=F("div",{className:"day-plan-content"});A.appendChild(Zn(n,d,h,p,i)),A.appendChild(Qn(n,i,c,m,k,o,l,y,r,a)),g.appendChild(A);const S=document.getElementById("modal-container");if(!S)return;const $=document.getElementById("day-plan-modal");$&&$.remove(),S.appendChild(g);const L=document.getElementById("day-plan-modal");if(L){const B=Array.from(document.querySelectorAll(".modal-overlay, .modal")).filter(M=>M!==L).reduce((M,D)=>{const E=Number.parseInt(window.getComputedStyle(D).zIndex,10);return Number.isFinite(E)?Math.max(M,E):M},1e3);L.style.zIndex=String(B+2)}}async function $a(n=null){const e=document.getElementById("day-plan-modal");if(!e)return;const t=n||"personal",a=t==="annual"?e.querySelector(".others-plans-container"):e.querySelector(".personal-plans-container"),s=e.querySelector(".day-plan-headline p")?.textContent?.match(/\d{4}-\d{2}-\d{2}/),i=s?s[0]:new Date().toISOString().split("T")[0],o=await q.getAll("users"),r=Q.getUser(),d=window.app_currentDayPlanTargetId||r.id,l=r.role==="Administrator"||r.isAdmin,c=o.filter(m=>m.id!==d);qe({date:i,targetId:d,scope:t,allUsers:o,selectableCollaborators:c,isAdmin:l,container:a})}const es={openDayPlan:_a,dayPlanRenderBlockV3:ze,addPlanBlockUI:$a,openPlanEditor:qe,app_extractBlockData:Da};window.AppDayPlan=es;window.app_openDayPlan=_a;window.app_dayPlanRenderBlockV3=ze;window.app_addPlanBlockUI=$a;window.app_extractBlockData=Da;const Wt={isWidgetMode:!1,syncInterval:null,init(){console.log("Widget Module Initialized"),new URLSearchParams(window.location.search).get("mode")==="widget"&&(this.isWidgetMode=!0),this.isWidgetMode&&this.enableWidgetMode()},toggle(){if(this.isWidgetMode)this.isWidgetMode=!1,window.opener||window.name==="CRWIWidget"?window.close():this.disableWidgetMode();else{const t=window.screen.width-320-20;window.open(window.location.origin+window.location.pathname+"?mode=widget#dashboard","CRWIWidget",`width=320,height=420,left=${t},top=40,menubar=no,toolbar=no,location=no,status=no,resizable=yes`)}},enableWidgetMode(){document.body.classList.add("widget-mode"),this.renderWidgetView(),this.startSync(),window.resizeTo&&window.resizeTo(320,420)},disableWidgetMode(){document.body.classList.remove("widget-mode");const n=document.getElementById("widget-view");n&&n.remove(),this.stopSync()},startSync(){this.syncInterval&&clearInterval(this.syncInterval),this.syncInterval=setInterval(()=>this.sync(),500)},stopSync(){this.syncInterval&&clearInterval(this.syncInterval)},sync(){if(!this.isWidgetMode)return;const n=document.getElementById("timer-display"),e=document.getElementById("timer-label"),t=document.querySelector(".check-in-widget .status-dot")||document.querySelector('.check-in-widget [style*="background: #10b981"]')||document.querySelector('.check-in-widget [style*="background: #94a3b8"]'),a=document.getElementById("attendance-btn"),s=document.getElementById("location-text"),i=document.getElementById("countdown-container"),o=document.getElementById("countdown-label"),r=document.getElementById("countdown-value"),d=document.getElementById("countdown-progress"),l=document.getElementById("overtime-container"),c=document.getElementById("overtime-value"),m=document.getElementById("widget-view");if(!m)return;const u=m.querySelector("#timer-display"),p=m.querySelector("#timer-label"),f=m.querySelector(".status-dot-indicator"),h=m.querySelector("#attendance-btn"),y=m.querySelector("#location-text"),w=m.querySelector("#countdown-container"),b=m.querySelector("#countdown-label"),v=m.querySelector("#countdown-value"),k=m.querySelector("#countdown-progress"),g=m.querySelector("#overtime-container"),A=m.querySelector("#overtime-value");n&&u&&(u.innerHTML=n.innerHTML,u.style.color=n.style.color),e&&p&&(p.innerHTML=e.innerHTML),t&&f&&(f.style.background=t.style.background||(t.classList.contains("online")?"#10b981":"#94a3b8")),i&&w&&(w.style.display=i.style.display,o&&b&&(b.innerHTML=o.innerHTML),r&&v&&(v.innerHTML=r.innerHTML),d&&k&&(k.style.width=d.style.width)),l&&g&&(g.style.display=l.style.display,c&&A&&(A.innerHTML=c.innerHTML)),a&&h&&(h.innerHTML=a.innerHTML,h.className=a.className,h.disabled=a.disabled),s&&y&&(y.innerHTML=s.innerHTML)},handleWidgetAction(){if(window.opener&&!window.opener.closed)try{if(window.opener.focus(),window.opener.location.hash!=="#dashboard"&&(window.opener.location.hash="#dashboard"),window.opener.app_handleAttendance){window.opener.app_handleAttendance();return}}catch(t){console.warn("Could not communicate with main window:",t)}console.log("Opener lost or closed. Reopening main app...");const n=window.location.origin+window.location.pathname+"#dashboard",e=window.open(n,"CRWIMainApp");if(e){e.focus();const t=document.getElementById("attendance-btn");if(t){const a=t.innerHTML;t.innerHTML='<i class="fa-solid fa-arrow-up-right-from-square"></i> Opening App...',setTimeout(()=>{t.innerHTML=a},3e3)}}else alert("Please allow popups or open the main application window manually.")},renderWidgetView(){let n=document.getElementById("widget-view");n||(n=document.createElement("div"),n.id="widget-view",document.body.appendChild(n));const e=window.AppAuth&&window.AppAuth.getUser()||{name:"User",role:"Staff",avatar:"https://via.placeholder.com/48"};n.innerHTML=`
        ...
        `}};typeof window<"u"&&(window.Widget=Wt,Wt.init());var vt={buildId:"6521b63-1774247935038",commitSha:"6521b63467943c10c791d31549250c164312a5c9",builtAt:"2026-03-23T06:38:55.036Z"};let bt=null,ce=[],ge=null,$e=null,Oe=0,je=!1,Ue=null,St=!1,xa=0,$t=null,st=null,it=null,xt=!1,Re=null,Le=null;const ot=Object.freeze(typeof vt=="object"&&vt?vt:{buildId:"local",commitSha:"",builtAt:""}),ts="/version.json",as=6e4,Tt="release_signal",Yt="app_meta",Ta="app_last_seen_release_id",K={active:!1,releaseId:"",buildId:"",commitSha:"",deployedAt:"",notes:"",source:"",popupDismissed:!1},Ia=3e4;window.app_annualYear=new Date().getFullYear();const ns=()=>{try{return localStorage.getItem(Ta)||""}catch{return""}},La=n=>{try{localStorage.setItem(Ta,String(n||""))}catch{}},Ea=(n={},e="version")=>{const t=String(n.buildId||n.releaseId||n.commitSha||"").trim();return t?{releaseId:t,buildId:t,commitSha:String(n.commitSha||"").trim(),deployedAt:String(n.deployedAt||n.builtAt||"").trim(),notes:String(n.notes||"").trim(),source:String(e||n.source||"version").trim()}:null},Ge=()=>({active:!!K.active,releaseId:K.releaseId||"",buildId:K.buildId||"",commitSha:K.commitSha||"",deployedAt:K.deployedAt||"",notes:K.notes||"",source:K.source||"",popupDismissed:!!K.popupDismissed,currentBuildId:ot.buildId||"",currentCommitSha:ot.commitSha||"",currentBuiltAt:ot.builtAt||""});window.app_getReleaseUpdateState=()=>Ge();const We=()=>{const n=Ge(),e=document.querySelector(".dashboard-refresh-link");e&&(n.active?(e.classList.add("is-update-pending"),e.setAttribute("title","Update available. Click to refresh into the new version."),e.textContent="System update available"):(e.classList.remove("is-update-pending"),e.setAttribute("title","Check for System Update (Ctrl+Shift+R)"),e.textContent="Check for System Update"))};window.app_applyUpdateCtaState=We;const Pt=()=>{We(),window.dispatchEvent&&window.dispatchEvent(new CustomEvent("app:update-state",{detail:Ge()}))},Nt=(n=!1)=>{const e=K.releaseId;K.active=!1,K.releaseId="",K.buildId="",K.commitSha="",K.deployedAt="",K.notes="",K.source="",K.popupDismissed=!1,n&&e&&La(e),Pt()};window.app_dismissReleaseUpdatePrompt=()=>{K.active&&(K.releaseId&&La(K.releaseId),K.popupDismissed=!0,document.getElementById("system-update-modal")?.remove(),Pt())};const Ma=(n,e={})=>{const t=Ea(n,n?.source||"version");if(!t)return!1;if(t.buildId===ot.buildId)return Nt(!1),!1;const a=e.forcePopup===!0,s=ns(),i=K.active&&K.releaseId===t.releaseId;return K.active=!0,K.releaseId=t.releaseId,K.buildId=t.buildId,K.commitSha=t.commitSha,K.deployedAt=t.deployedAt,K.notes=t.notes,K.source=t.source,K.popupDismissed=t.releaseId===s,i||window.app_showSyncToast("New version available."),window.dispatchEvent&&window.dispatchEvent(new CustomEvent("app:update-available",{detail:Ge()})),Pt(),(a||!K.popupDismissed)&&(K.popupDismissed=!1,window.app_showSystemUpdatePopup()),!0},ss=async({manual:n=!1}={})=>{try{const e=await fetch(`${ts}?t=${Date.now()}`,{cache:"no-store",headers:{"cache-control":"no-cache"}});if(!e.ok)throw new Error(`Version check failed with ${e.status}`);const t=await e.json();return Ea(t,"version")}catch(e){return console.warn("Unable to fetch deployed version manifest:",e),n&&window.app_showSyncToast("Could not check for updates right now."),null}},Ye=async(n={})=>{if(Le)return Le;Le=(async()=>{const e=await ss({manual:n.manual===!0});return e?Ma(e,{forcePopup:n.forcePopup===!0}):!1})();try{return await Le}finally{Le=null}},Ca=()=>{Re||(Re=setInterval(()=>{document.visibilityState==="visible"&&window.AppAuth?.getUser()&&Ye()},as),Ye())},is=()=>{Re&&(clearInterval(Re),Re=null)},os=()=>{document.visibilityState==="visible"&&window.AppAuth?.getUser()&&Ye()},Vt=()=>{window.AppAuth?.getUser()&&Ye()},Kt=n=>{!n||n.id!==Tt||n.active!==!1&&Ma({...n,source:"release-signal"},{forcePopup:!0})},Pa=()=>{if(!xt){if(xt=!0,window.AppDB&&typeof window.AppDB.listen=="function"){st=window.AppDB.listen(Yt,n=>{const e=(n||[]).find(t=>t.id===Tt);e&&Kt(e)});return}it=setInterval(async()=>{try{const n=await window.AppDB.get(Yt,Tt);n&&Kt(n)}catch{}},3e4)}},rs=()=>{typeof st=="function"&&(st(),st=null),it&&(clearInterval(it),it=null),xt=!1};window.app_checkForSystemUpdate=async()=>{if(K.active)return window.app_showSystemUpdatePopup(),!0;const n=await Ye({manual:!0,forcePopup:!0});return n||window.app_showSyncToast("You are already using the latest version."),n};window.app_isAdminUser=(n=window.AppAuth?.getUser())=>n?n.isAdmin===!0:!1;window.app_canSeeAdminPanel=(n=window.AppAuth?.getUser())=>n?window.app_isAdminUser(n)?!0:n.permissions?Object.values(n.permissions).some(e=>e==="admin"):!1:!1;window.app_hasPerm=(n,e="view",t=window.AppAuth?.getUser())=>{if(!t)return!1;if(t.isAdmin===!0)return!0;if(!t.permissions||!t.permissions[n])return!1;const a=t.permissions[n];return e==="view"?a==="view"||a==="admin":e==="admin"?a==="admin":!1};window.app_canManageAttendanceSheet=(n=window.AppAuth?.getUser())=>n?window.app_hasPerm("attendance","admin",n)||!!n.canManageAttendanceSheet:!1;window.app_getReadTelemetry=()=>!window.AppDB||!window.AppDB.getReadTelemetry?{}:window.AppDB.getReadTelemetry();window.app_resetReadTelemetry=()=>{!window.AppDB||!window.AppDB.clearReadTelemetry||window.AppDB.clearReadTelemetry()};window.app_getMyMessages=async()=>{const n=window.AppAuth.getUser();if(!n)return[];try{const[e,t]=await Promise.all([window.AppDB.query("staff_messages","toId","==",n.id),window.AppDB.query("staff_messages","fromId","==",n.id)]),a=new Map;return(e||[]).forEach(s=>a.set(s.id,s)),(t||[]).forEach(s=>a.set(s.id,s)),Array.from(a.values())}catch(e){return console.warn("Message fetch failed, falling back to getAll",e),window.AppDB.getAll("staff_messages")}};const Z=document.getElementById("page-content"),Qe=document.querySelector(".sidebar"),et=document.querySelector(".mobile-header"),tt=document.querySelector(".mobile-nav");window.app_initTheme=()=>{const n=localStorage.getItem("theme")||"light";document.documentElement.setAttribute("data-theme",n),Na(n)};window.app_toggleTheme=()=>{const e=document.documentElement.getAttribute("data-theme")==="dark"?"light":"dark";document.documentElement.setAttribute("data-theme",e),localStorage.setItem("theme",e),Na(e)};function Na(n){document.querySelectorAll(".theme-toggle i").forEach(e=>{n==="dark"?(e.classList.remove("fa-moon"),e.classList.add("fa-sun")):(e.classList.remove("fa-sun"),e.classList.add("fa-moon"))})}function ds(){if(!("serviceWorker"in navigator))return;const n=async()=>{try{$t=await navigator.serviceWorker.register("/sw.js"),console.log("ServiceWorker registered")}catch(e){console.log("ServiceWorker registration failed: ",e)}};if(document.readyState==="complete"){n();return}window.addEventListener("load",()=>{n()},{once:!0})}const Gt=(n=new Date)=>`${n.getFullYear()}-${String(n.getMonth()+1).padStart(2,"0")}-${String(n.getDate()).padStart(2,"0")}`;window.app_showAttendanceNotice=n=>{if(!n)return;const e=document.getElementById("page-content");if(!e)return;const t=document.getElementById("attendance-policy-notice");t&&t.remove();const a=document.createElement("div");a.id="attendance-policy-notice",a.style.background="#fff7ed",a.style.border="1px solid #fdba74",a.style.color="#9a3412",a.style.padding="0.85rem 1rem",a.style.borderRadius="10px",a.style.marginBottom="0.9rem",a.style.fontSize="0.9rem",a.style.fontWeight="600",a.innerHTML=`<i class="fa-solid fa-circle-info" style="margin-right:0.45rem;"></i>${n}`,e.prepend(a),setTimeout(()=>{const s=document.getElementById("attendance-policy-notice");s&&s.remove()},1e4)};window.app_promptMissedCheckoutReason=(n={})=>{const{logId:e,date:t}=n||{};if(!e||document.getElementById("missed-checkout-reason-modal"))return;const a=t?new Date(`${t}T00:00:00`).toLocaleDateString():"previous day",s=`
    ...
    `;(document.body||document.getElementById("modal-container")).insertAdjacentHTML("beforeend",s);const i=document.getElementById("missed-checkout-reason-modal");i?.addEventListener("click",o=>{o.target===i&&i.remove()})};window.app_submitMissedCheckoutReason=async(n,e)=>{n.preventDefault();const t=n.target,a=String(new FormData(t).get("reason")||"").trim();if(!a){alert("Please enter a reason.");return}try{const s=window.AppAuth.getUser();if(!s)throw new Error("User not authenticated");const i=await window.AppDB.get("attendance",e);if(!i)throw new Error("Attendance record not found.");const o=new Date().toISOString(),r={...i,missedCheckoutReason:a,missedCheckoutReasonSubmittedAt:o,missedCheckoutReasonStatus:"pending"};await window.AppDB.put("attendance",r);const d=await window.AppDB.get("users",s.id);d&&(d.notifications||(d.notifications=[]),d.notifications.unshift({id:`mcr_sub_${Date.now()}`,type:"missed-checkout-reason-submitted",title:"Missed checkout reason submitted",message:`Reason sent for ${i.date}. Awaiting admin verification.`,status:"submitted",date:o,read:!0}),await window.AppDB.put("users",d),window.AppAuth?.getUser&&Object.assign(window.AppAuth.getUser(),{notifications:d.notifications}));const l=(await window.AppDB.getAll("users")).filter(c=>c.isAdmin||c.role==="Administrator");await Promise.all(l.map(async c=>{c.notifications||(c.notifications=[]),c.notifications.unshift({id:`mcr_${Date.now()}_${Math.random().toString(36).slice(2,6)}`,type:"missed-checkout-reason",title:"Missed checkout reason submitted",message:`${s.name} submitted a reason for missed checkout on ${i.date}.`,description:a,staffId:s.id,staffName:s.name,missedCheckoutDate:i.date,logId:String(i.id||""),taggedById:s.id,taggedByName:s.name,taggedAt:o,status:"pending",date:o,read:!1}),await window.AppDB.put("users",c)})),document.getElementById("missed-checkout-reason-modal")?.remove(),window.app_refreshNotificationBell&&await window.app_refreshNotificationBell(),window.app_showSyncToast("Reason submitted for admin verification.")}catch(s){console.error("Missed checkout reason submit failed:",s),alert("Failed to submit reason: "+s.message)}};window.app_showSyncToast=(n="Status updated from another device.")=>{const e="app-sync-toast",t=document.getElementById(e);t&&t.remove();const a=document.createElement("div");a.id=e,a.style.position="fixed",a.style.top="14px",a.style.right="14px",a.style.zIndex="10020",a.style.background="#0f172a",a.style.color="#f8fafc",a.style.padding="0.7rem 0.9rem",a.style.borderRadius="10px",a.style.fontSize="0.82rem",a.style.fontWeight="600",a.style.boxShadow="0 8px 25px rgba(15, 23, 42, 0.3)",a.textContent=n,document.body.appendChild(a),setTimeout(()=>{const s=document.getElementById(e);s&&s.remove()},2800)};const Xt=()=>!je&&Date.now()>xa,It=()=>{xa=Date.now()+3500},ls=n=>{const e=n.detail;if(!e)return;window.app_refreshNotificationBell&&window.app_refreshNotificationBell().catch(()=>{});const t=e.status||"out",a=Ue!==null&&t!==Ue,s=Ue===null&&t==="in";if(Ue=t,!(a||s)||St)return;const i=!window.location.hash||window.location.hash==="#dashboard",o=document.getElementById("checkout-modal"),r=!!(o&&o.style.display==="flex");if(t==="out"&&r&&(o.style.display="none"),!i){Xt()&&window.app_showSyncToast("Status updated from another device.");return}St=!0,(async()=>{try{const d=document.getElementById("page-content");d&&(d.innerHTML=await R.renderDashboard(),window.setupDashboardEvents&&window.setupDashboardEvents()),Xt()&&window.app_showSyncToast("Status updated from another device.")}catch(d){console.warn("Realtime dashboard sync failed:",d)}finally{St=!1}})()};function Lt(n){const e=document.querySelector(".sidebar"),t=document.getElementById("sidebar-overlay");e&&t&&(n?(e.classList.add("open"),t.classList.add("active")):(e.classList.remove("open"),t.classList.remove("active")))}function cs(){if(window.location.search){const n=window.location.protocol+"//"+window.location.host+window.location.pathname+window.location.hash;window.history.replaceState({path:n},"",n),console.log("Address bar cleaned of query parameters.")}}window.app_toggleSidebar=(n=null)=>{const e=document.querySelector(".sidebar"),t=document.querySelector("#desktop-sidebar-toggle i");if(!e)return;(n!==null?n:!e.classList.contains("collapsed"))?(e.classList.add("collapsed"),t&&(t.classList.remove("fa-angles-left"),t.classList.add("fa-angles-right"))):(e.classList.remove("collapsed"),t&&(t.classList.remove("fa-angles-right"),t.classList.add("fa-angles-left")))};window.app_showModal=(n,e)=>{const t=document.getElementById("modal-container");if(!t)return;const a=document.getElementById(e);a&&a.remove(),t.insertAdjacentHTML("beforeend",n);const s=document.getElementById(e);if(s&&(s.classList.contains("modal-overlay")||s.classList.contains("modal"))){const o=Array.from(document.querySelectorAll(".modal-overlay, .modal")).filter(r=>r!==s).reduce((r,d)=>{const l=Number.parseInt(window.getComputedStyle(d).zIndex,10);return Number.isFinite(l)?Math.max(r,l):r},1e3);s.style.zIndex=String(o+2)}};const ee=n=>String(n??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;"),ps=n=>ee(n).replace(/\n/g,"<br>"),Et=n=>String(n?.status||"pending").toLowerCase(),He=n=>Et(n)==="pending",kt=n=>n?.type==="minute-access-request"?"Minutes":String(n?.type||"").includes("missed-checkout")?"Attendance":n?.type==="task"?"Task":n?.type==="tag"||n?.type==="mention"?"Tag":n?.type==="reminder"?"Reminder":"Notification",Jt=n=>String(n?.description||n?.message||n?.title||"").trim(),us=n=>{const e=n?.respondedAt||n?.taggedAt||n?.date,t=new Date(e).getTime();if(!t)return"Unknown time";const a=Math.max(0,Math.floor((Date.now()-t)/6e4)),s=a<1?"just now":a<60?`${a} mins ago`:a<1440?`${Math.floor(a/60)} hrs ago`:`${Math.floor(a/1440)} days ago`;return`${new Date(t).toLocaleString()} (${s})`};window.app_refreshNotificationBell=async()=>{const n=document.querySelectorAll(".top-notification-btn");if(!n.length)return;const e=window.AppAuth.getUser(),a=(Array.isArray(e?.notifications)?e.notifications:[]).filter(He).length;n.forEach(s=>{const i=s.querySelector(".top-notification-badge");if(!e){s.classList.remove("has-pending"),i&&(i.style.display="none");return}s.classList.toggle("has-pending",a>0),s.setAttribute("title",a>0?`${a} pending notification${a>1?"s":""}`:"Notification history"),i&&(a>0?(i.textContent=a>99?"99+":String(a),i.style.display=""):i.style.display="none")})};window.app_closeNotificationHistory=()=>{const n=document.getElementById("notification-history-modal"),e=document.getElementById("notif-drawer-backdrop");n&&n.classList.remove("notif-drawer-open"),e&&e.classList.remove("notif-drawer-backdrop-visible"),setTimeout(()=>document.getElementById("notif-drawer-root")?.remove(),320)};window.app_respondNotificationFromHistory=async(n,e,t)=>{const a=window.AppAuth.getUser();if(!a)return;const s=t==="approve"?"approve":"reject",i=await window.AppDB.get("users",a.id);if(!i||!Array.isArray(i.notifications)){alert("Notification not found.");return}let o=null,r=-1;if(Number.isInteger(n)&&n>=0&&i.notifications[n]&&(o=i.notifications[n],r=n),!o&&e&&(r=i.notifications.findIndex(d=>String(d.id)===String(e)),r>=0&&(o=i.notifications[r])),!o){alert("This notification is no longer available.");return}if(!He(o)){alert("This notification has already been responded."),await window.app_refreshNotificationBell();return}window.app_closeNotificationHistory();try{if(o.type==="minute-access-request"&&window.app_hasPerm("minutes","admin",a)){await window.app_reviewMinuteAccessFromNotification(r,o.id,s==="approve"?"approved":"rejected");return}if(o.type==="missed-checkout-reason"&&(a.isAdmin||a.role==="Administrator")){await window.app_reviewMissedCheckoutReasonFromNotification(r,o.id,s==="approve"?"approved":"rejected");return}const d=Number(o.taskIndex);if(o.planId&&Number.isInteger(d)&&d>=0){await window.app_handleTagResponse(o.planId,d,s==="approve"?"accepted":"rejected",r);return}if(o.id){await window.app_handleTagDecision(o.id,s==="approve"?"accepted":"rejected");return}alert("This notification cannot be approved or rejected from history.")}catch(d){console.error("Notification response error:",d),alert("Failed to process notification: "+d.message)}};window.app_openNotificationHistory=async()=>{const n=window.AppAuth.getUser();if(!n)return;const e=await window.AppDB.get("users",n.id).catch(()=>n),t=Array.isArray(e?.notifications)?e.notifications:[],a=Array.isArray(e?.tagHistory)?e.tagHistory:[],s=n.isAdmin||n.role==="Administrator",i=[...t.map((S,$)=>({...S,_source:"live",_index:$})),...a.map(S=>({...S,_source:"history",_index:-1}))],o=S=>new Date(S.respondedAt||S.taggedAt||S.date||0).getTime()||0,r=S=>String(S||"").trim().toLowerCase(),l=['<option value="all">All Sources</option>',...Array.from(new Set(i.map(S=>kt(S)))).filter(Boolean).sort((S,$)=>S.localeCompare($)).map(S=>`<option value="${ee(S.toLowerCase())}">${ee(S)}</option>`)].join(""),c={search:"",status:"all",source:"all",sort:"newest"},m=S=>{const $=Et(S),L=$==="pending"&&S._source==="live",I=kt(S),B=S.taggedByName||"System",M=S.title||`${I} from ${B}`,D=Jt(S),E=JSON.stringify(String(S.id||"")),U={pending:{bg:"#fff7ed",border:"#fdba74",badge:"#f97316"},accepted:{bg:"#f0fdf4",border:"#86efac",badge:"#16a34a"},rejected:{bg:"#fef2f2",border:"#fca5a5",badge:"#dc2626"},default:{bg:"#f8fafc",border:"#e2e8f0",badge:"#6b7280"}},P=U[$]||U.default,C=L||s&&S.type==="minute-access-request"?`
            ...
            <div class="notif-drawer-item ${L?"is-pending":""}" style="border-color:${P.border}; background:${P.bg};" data-notif-id="${ee(String(S.id||""))}">
                <div class="notif-drawer-item-head">
                    <div class="notif-drawer-item-left">
                        ...
                        <div>
                            <div class="notif-drawer-title">${ee(M)}</div>
                            <div class="notif-drawer-meta">${ee(I)} • ${ee(B)} • ${ee(us(S))}</div>
                        </div>
                    </div>
                    <div class="notif-drawer-item-right">
                        <span class="notif-drawer-badge" style="background:${P.badge}">${ee($)}</span>
                    </div>
                </div>
                ${D?`<div class="notif-drawer-text">${ee(D)}</div>`:""}
                ${C}
            </div>`},u=()=>{const S=i.filter($=>{const L=Et($),I=kt($),B=$.taggedByName||"System",M=$.title||`${I} from ${B}`,D=Jt($),E=`${M} ${D} ${I} ${B} ${L}`;return!(c.status!=="all"&&L!==c.status||c.source!=="all"&&r(I)!==c.source||c.search&&!r(E).includes(c.search))});return c.sort==="oldest"?S.sort(($,L)=>o($)-o(L)):c.sort==="pending"?S.sort(($,L)=>{const I=He($)?1:0,B=He(L)?1:0;return I!==B?B-I:o(L)-o($)}):S.sort(($,L)=>o(L)-o($)),S},p=t.filter(He).length,f=`
                ...
                <div class="modal-overlay app-system-dialog-overlay" id="${d}" style="display:flex;">
                    <div class="modal-content app-system-dialog">
                        ...
                        <div class="app-system-dialog-actions">
                            ${m?`<button type="button" class="action-btn secondary app-system-dialog-cancel">${ee(i)}</button>`:""}
        ...
        `,"event-modal")};window.app_submitEvent=async n=>{n.preventDefault();const e=document.getElementById("event-title").value,t=document.getElementById("event-date").value,a=document.getElementById("event-type").value;try{await window.AppCalendar.addEvent({title:e,date:t,type:a}),alert("Event added successfully!"),document.getElementById("event-modal")?.remove();const s=document.getElementById("page-content");s.innerHTML=await R.renderDashboard(),ue()}catch(s){alert("Error: "+s.message)}};const Zt="work_plan_schema_v2_migrated",ms=async()=>{try{if(!window.AppDB||typeof window.AppDB.getAll!="function"||typeof window.AppDB.put!="function"||localStorage.getItem(Zt)==="true")return;const n=await window.AppDB.getAll("work_plans");let e=0;for(const t of n){if(!t||Array.isArray(t.plans))continue;const a=typeof t.plan=="string"?t.plan.trim():"";if(!a)continue;const s={...t,plans:[{task:a,subPlans:Array.isArray(t.subPlans)?t.subPlans:[],tags:Array.isArray(t.tags)?t.tags:[],status:t.status||null,completedDate:t.completedDate||null,startDate:t.startDate||t.date,endDate:t.endDate||t.startDate||t.date}]};delete s.plan,delete s.subPlans,delete s.tags,delete s.status,delete s.completedDate,delete s.startDate,delete s.endDate,await window.AppDB.put("work_plans",s),e+=1}localStorage.setItem(Zt,"true"),e>0&&console.log(`Work plan schema migration complete. Updated: ${e}`)}catch(n){console.warn("Work plan schema migration failed:",n)}};async function fs(){window.app_initTheme(),cs(),window.addEventListener("app:user-sync",ls),window.addEventListener("app:update-available",We),window.addEventListener("app:update-state",We),document.addEventListener("visibilitychange",os),window.addEventListener("focus",Vt),window.addEventListener("online",Vt);try{await window.AppAuth.init();const e=window.AppAuth.getUser();e&&(Ue=e.status||"out",Pa(),Ca()),ds(),await ms(),window.AppActivity&&window.AppActivity.initCommandListener()}catch(e){console.error("Initialization Failed:",e),Z&&(Z.innerHTML=`<div style="text-align:center; padding:2rem; color:red;">Failed to load application.<br><small>${e.message}</small></div>`)}document.addEventListener("click",e=>{e.target.id==="sidebar-toggle"||e.target.closest("#sidebar-toggle")?Lt(!0):e.target.id==="sidebar-overlay"&&Lt(!1)}),window.addEventListener("hashchange",Qt),Qt();const n=window.AppAuth.getUser();n&&window.AppTour&&window.AppTour.init(n)}async function Qt(){const n=window.AppAuth.getUser(),e=window.location.hash.slice(1)||"dashboard";if(e!=="admin"&&ce&&ce.length>0&&(console.log("Cleaning up Admin Realtime Listener."),ce.forEach(d=>typeof d=="function"&&d()),ce=[]),e!=="minutes"&&typeof ge=="function"&&(console.log("Cleaning up Minutes Realtime Listener."),ge(),ge=null),!n){rs(),is(),Nt(!1),Qe&&(Qe.style.display="none"),et&&(et.style.display="none"),tt&&(tt.style.display="none"),document.body.style.background="#f3f4f6",Z&&(Z.innerHTML=R.renderLogin()),window.app_refreshNotificationBell&&await window.app_refreshNotificationBell();return}Pa(),Ca(),Lt(!1),Qe&&(Qe.style.display=""),et&&(et.style.display=""),tt&&(tt.style.display="");const t=document.querySelector(".sidebar-footer .user-mini-profile");t&&(t.innerHTML=`
        ...
        <div class="modal-content checkout-action-detail-content">
            <div class="checkout-action-detail-header">
                <div>
                    ...
                    <div class="checkout-action-detail-sub">${V(o)} • ${e.progressPercent}% • ${V(rt[e.progressStatus]||"")}</div>
                </div>
    ...
    `,document.body.appendChild(h),window.app_syncCheckoutTaskPanel(n)};window.app_renderCheckoutActionPreview=()=>{const n=document.getElementById("checkout-action-preview"),e=document.getElementById("checkout-action-preview-list");if(!n||!e)return;const t=window.app_checkoutTaskDetails||{},a=window.app_checkoutTaskMeta||{},s=window.app_checkoutUserMap||{},i=Object.keys(t).map(o=>{const r=t[o];if(!r||!r.action)return null;const l=(a[o]||{}).text||"Task",c=r.action==="complete"?"Complete":r.action==="postpone"?"Postpone":r.action==="delegate"?"Delegate":r.action,m=rt[r.progressStatus]||"Waiting",u=String(r.progressNote||"").trim();let p="";if(r.action==="postpone"){const f=ft(r.actionMeta?.postponeDate)||"—",h=String(r.actionMeta?.postponeReason||"").trim();p=`New date: ${V(f)}${h?` • Reason: ${V(h)}`:""}`}if(r.action==="delegate"){const f=String(r.actionMeta?.delegateUserId||""),h=s[f]||"—",y=String(r.actionMeta?.delegateNote||"").trim();p=`Assigned to: ${V(h)}${y?` • Note: ${V(y)}`:""}`}if(r.action==="complete"){const f=String(r.actionMeta?.completionNote||"").trim();p=f?`Completion note: ${V(f)}`:""}return`
...
`+v:p=v}l&&(l.innerHTML=p),l&&(l.dataset.rawText=f),c&&!c.value.trim()&&window.app_checkoutSummaryDraft&&(c.value=window.app_checkoutSummaryDraft,window.app_updateCharCounter&&window.app_updateCharCounter(c));const h=document.getElementById("checkout-task-list"),y=document.getElementById("delegate-panel"),w=document.getElementById("delegate-list"),b=document.getElementById("delegate-selected-task");if(h)if(i&&Array.isArray(i.plans)&&i.plans.length>0){const v=await window.AppDB.getAll("users").catch(()=>[]);window.app_checkoutUserMap={},(v||[]).forEach(S=>{window.app_checkoutUserMap[String(S.id)]=S.name});const k=window.AppAuth.getUser(),g=(v||[]).filter(S=>S.id!==k.id),A=i.plans.map((S,$)=>{const L=S.subPlans&&S.subPlans.length?` — ${S.subPlans.join(", ")}`:"",I=`${S.task}${L}`,B=S._planId||i.id,M=typeof S._taskIndex=="number"?S._taskIndex:$,D=window.AppCalendar.getSmartTaskStatus(S._planDate||i.date,S.status),E=`${B}:${M}`;window.app_checkoutTaskMeta=window.app_checkoutTaskMeta||{},window.app_checkoutTaskMeta[E]={text:I,planId:B,taskIndex:M};const P=(window.app_checkoutTaskActions&&window.app_checkoutTaskActions[E]?window.app_checkoutTaskActions[E]:"")||(S.status==="completed"||D==="completed"?"complete":S.status==="postponed"?"postpone":""),C=window.app_initCheckoutTaskDetails(B,M,S),O=C.action||P||"";O&&C.action!==O&&(C.action=O,O==="complete"&&(C.progressPercent=100,C.progressStatus="done")),window.app_checkoutTaskActions&&O&&(window.app_checkoutTaskActions[E]=O);const H=D==="completed"?"Completed":D==="in-process"?"In Process":D==="overdue"?"Overdue":D==="to-be-started"?"To Be Started":S.status||"Pending",z=V(C.actionMeta?.postponeDate||new Date(Date.now()+864e5).toISOString().split("T")[0]),G=V(C.actionMeta?.postponeReason||""),T=V(C.actionMeta?.delegateUserId||""),N=V(C.actionMeta?.delegateNote||""),j=V(C.actionMeta?.completionNote||""),Y=V(C.progressNote||"");return`
                                        <div class="checkout-task-row">
                                            ...
                                            <div class="checkout-task-controls">
                                                <select onchange="window.app_handleChecklistAction('${B}', ${M}, this.value)" class="checkout-task-action-select">
                                                ...
                                                <button type="button" class="checkout-task-detail-btn" data-checkout-detail-key="${V(E)}" onclick="window.app_openCheckoutActionModal('${de(E)}')" ${O?"":"disabled"}>Action Details</button>
                                            </div>
                    ...
                    <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:1.5rem;">
                        ...
                        <form onsubmit="window.app_submitCellOverride(event, '${n}', '${e}', '${i?.id||""}')">
                            ...
                            <div style="display:grid; grid-template-columns:1fr 1fr; gap:1rem;">
                                <div>
                                    <label style="display:block; font-size:0.85rem; margin-bottom:0.25rem;">Time In</label>
                                    <input type="time" name="checkIn" required value="${i?ct(i.checkIn):"09:00"}" style="width:100%; padding:0.75rem; border:1px solid #ddd; border-radius:8px;">
                                </div>
                                <div>
                                    <label style="display:block; font-size:0.85rem; margin-bottom:0.25rem;">Time Out</label>
                                    <input type="time" name="checkOut" required value="${i?ct(i.checkOut):"17:00"}" style="width:100%; padding:0.75rem; border:1px solid #ddd; border-radius:8px;">
                                </div>
                            </div>
                            <div>
                        ...
                        <div class="salary-slip-paper">
                            ...
                            <div class="salary-slip-section">
                                ...
                                <div class="salary-slip-grid">
                                    ...
                                    <div><b>UAN:</b> ${Dt(j)}</div>
                                    <div><b>PAN:</b> ${Dt(N)}</div>
                                    <div><b>Bank A/C:</b> ${Dt(T)}</div>
                                </div>
                            </div>
                            ...
                            <div class="salary-slip-split">
                                <div class="salary-slip-section">
                                    ...
                                    <table class="salary-slip-table">
                                        ...
                                        <tr class="total"><td>Gross Earnings</td><td>${te(B)}</td></tr>
                                    </table>
                                </div>
                                <div class="salary-slip-section">
                                    <h4>Deductions (Breakdown)</h4>
                                    <table class="salary-slip-table">
                                        ${X.map(se=>`<tr><td>${se.label}<div class="remark">${se.remarks}</div></td><td>${se.amount?te(se.amount):"NA"}</td></tr>`).join("")}
                                        <tr class="total"><td>Total Deductions</td><td>${te(Y)}</td></tr>
                                    </table>
                                </div>
                            </div>
...
`),o=new Blob([i],{type:"text/csv;charset=utf-8;"}),r=document.createElement("a"),d=URL.createObjectURL(o);r.setAttribute("href",d),r.setAttribute("download",`security_audits_${n||"export"}.csv`),r.style.visibility="hidden",document.body.appendChild(r),r.click(),document.body.removeChild(r)}catch(t){console.error("Export failed:",t),alert("Export failed: "+t.message)}};window.app_changeAnnualYear=n=>{window.app_annualYear=(window.app_annualYear||new Date().getFullYear())+n,window.app_renderAnnualPlanPage()};window.app_toggleAnnualLegendFilter=n=>{const e=window.app_annualLegendFilters||{leave:!0,event:!0,work:!0,overdue:!0,completed:!0};Object.prototype.hasOwnProperty.call(e,n)&&(e[n]=!e[n],window.app_annualLegendFilters=e,window.app_renderAnnualPlanPage())};window.app_showAnnualDayDetails=async n=>{if(!n)return;const e=window._currentPlans||await window.AppCalendar.getPlans(),t=window.app_annualLegendFilters||{leave:!0,event:!0,work:!0},a=window.AppAuth.getUser()||{},s=a.role==="Administrator"||a.isAdmin,i=(window.app_getDayEvents(n,e,{includeAuto:!1,userId:s?null:a.id})||[]).filter(d=>d.type==="leave"?!!t.leave:d.type==="work"?!!t.work:(d.type==="holiday",!!t.event)),o=i.length?i.map(d=>{const l=d.type||"event",c=l==="leave"?"background:#fee2e2;color:#991b1b;":l==="work"?"background:#e0e7ff;color:#3730a3;":l==="holiday"?"background:#f1f5f9;color:#334155;":"background:#dcfce7;color:#166534;",m=l==="work"&&Array.isArray(d.plans)&&d.plans.length?`<ul style="margin:0.5rem 0 0 1rem; padding:0; color:#475569; font-size:0.8rem;">
        ...
        `;window.app_showModal(d,n)};const Ms=async n=>{if(!n?.waiting||!navigator.serviceWorker)return!1;const e=n.waiting;return new Promise(t=>{let a=!1;const s=r=>{a||(a=!0,navigator.serviceWorker.removeEventListener("controllerchange",i),clearTimeout(o),t(r))},i=()=>s(!0),o=setTimeout(()=>s(!1),3e3);navigator.serviceWorker.addEventListener("controllerchange",i,{once:!0}),e.postMessage({type:"SKIP_WAITING"})})};window.app_forceRefresh=async()=>{try{if(navigator.serviceWorker){const n=await navigator.serviceWorker.getRegistrations();$t?.update&&await $t.update();for(const e of n)await Ms(e)}if(window.caches){const n=await caches.keys();await Promise.all(n.map(e=>caches.delete(e)))}}catch(n){console.warn("Force refresh cleanup failed:",n)}Nt(!0),window.location.reload()};fs();console.log("App.js Loaded & Globals Ready");
