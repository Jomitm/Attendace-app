(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))n(i);new MutationObserver(i=>{for(const s of i)if(s.type==="childList")for(const o of s.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&n(o)}).observe(document,{childList:!0,subtree:!0});function t(i){const s={};return i.integrity&&(s.integrity=i.integrity),i.referrerPolicy&&(s.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?s.credentials="include":i.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function n(i){if(i.ep)return;i.ep=!0;const s=t(i);fetch(i.href,s)}})();const L={WORK_START_TIME:"09:00",LATE_CUTOFF_TIME:"09:15",WORK_END_TIME:"17:00",LATE_CUTOFF_MINUTES:555,MINOR_LATE_END_MINUTES:615,LATE_END_MINUTES:720,POST_NOON_END_MINUTES:810,AFTERNOON_START_MINUTES:720,EARLY_DEPARTURE_MINUTES:1020,FY_START_MONTH:3,IS_SATURDAY_OFF:a=>{const t=new Date(a).getDate(),n=Math.ceil(t/7);return n===2||n===4},LATE_GRACE_COUNT:3,LATE_DEDUCTION_PER_BLOCK:.5,EXTRA_HOURS_FOR_HALF_DAY_OFFSET:4,READ_CACHE_TTLS:{users:6e4,settings:3e5,minutes:3e4,attendanceSummary:3e4,staffMessages:2e4,dailySummaryReadMs:6e4},READ_OPT_FLAGS:{FF_READ_OPT_DB_QUERIES:!0,FF_READ_OPT_TARGETED_REALTIME:!0,FF_READ_OPT_ANALYTICS_CACHE:!0,FF_SHARED_DAILY_SUMMARY:!0,FF_SUMMARY_LOCKING:!0,ENABLE_SIMULATION_MODULE:!1,ENABLE_READ_TELEMETRY:!0,ENABLE_PRESENCE_HEARTBEAT:!1},SUMMARY_POLICY:{STALENESS_MS:1440*60*1e3,TEAM_ACTIVITY_LIMIT:15,LOCK_TTL_MS:9e4,SCHEMA_VERSION:2,RECOMPUTE_CUTOFF_HOUR_IST:17,FALLBACK_TO_PREVIOUS_DAY:!0},HERO_POLICY:{SCHEMA_VERSION:2,WINDOW_DAYS:7,FALLBACK_LOOKBACK_DAYS:90,WEIGHTS:{taskExecution:.45,taskCompletionRate:.2,taskInProgressSupport:.1,taskMissPenalty:.1},ATTENDANCE_MODIFIER:{base:.9,maxBonus:.15,consistencyImpact:.65,effortImpact:.35},CAPS:{hours:40,qualityChars:500},DEFAULT_ACTIVITY_SCORE:70,MIN_EVIDENCE:{minDays:1,minDurationMs:1,minPlannedTasks:1}},SIMULATION_POLICY:{LEGACY_DUMMY_CLEANUP:{ENABLED:!0,FLAG_KEY:"legacy_dummy_cleanup_v1",TARGET_USER_IDS:["sim_punctual","sim_admin_new"],TARGET_USERNAMES:["jomit_p","maria"],AUDIT_COLLECTION:"system_audit_logs"}}},yn={apiKey:"AIzaSyC7a8AxukI0-egXimYTedwCa2RFnMTBu84",authDomain:"crwiattendance.firebaseapp.com",projectId:"crwiattendance",storageBucket:"crwiattendance.firebasestorage.app",messagingSenderId:"462155106938",appId:"1:462155106938:web:18291b04a5a3bec185c9c3",measurementId:"G-X6W45TV4QR"};typeof firebase<"u"&&!firebase.apps.length&&(firebase.initializeApp(yn),console.log("Firebase Initialized (Compat Mode)"));const va=typeof firebase<"u"?firebase.firestore():null;typeof window<"u"&&(window.AppFirestore=va);class gn{constructor(){this.db=va,this.cache=new Map,this.telemetry={get:0,getAll:0,query:0,queryMany:0,listen:0,listenQuery:0,writes:0,docsRead:0,byCollection:{}}}async init(){if(!this.db){console.error("Firebase not initialized! Check config.");return}console.log("Firestore adapter ready.")}getFlags(){return L&&L.READ_OPT_FLAGS||{}}track(e,t,n=0){this.getFlags().ENABLE_READ_TELEMETRY&&(typeof this.telemetry[e]=="number"&&(this.telemetry[e]+=1),this.telemetry.docsRead+=Math.max(0,Number(n)||0),this.telemetry.byCollection[t]||(this.telemetry.byCollection[t]={ops:0,docsRead:0}),this.telemetry.byCollection[t].ops+=1,this.telemetry.byCollection[t].docsRead+=Math.max(0,Number(n)||0))}getReadTelemetry(){return JSON.parse(JSON.stringify(this.telemetry))}clearReadTelemetry(){this.telemetry={get:0,getAll:0,query:0,queryMany:0,listen:0,listenQuery:0,writes:0,docsRead:0,byCollection:{}}}getCacheKey(e,t,n={}){return`${e}:${t}:${JSON.stringify(n)}`}invalidateCollectionCache(e){const t=`:${e}:`;for(const n of this.cache.keys())n.includes(t)&&this.cache.delete(n)}async getCached(e,t,n){const i=Date.now(),s=this.cache.get(e);if(s&&s.expiresAt>i)return s.value;const o=await n();return this.cache.set(e,{value:o,expiresAt:i+Math.max(0,Number(t)||0)}),o}async getOrGenerateSummary(e,t,n){if(!e||typeof t!="function")throw new Error("getOrGenerateSummary requires a key and generator function.");const i=this.getCacheKey("summary","computed",{summaryKey:e}),s=typeof n=="number"?n:L?.READ_CACHE_TTLS?.attendanceSummary||3e4;return this.getCached(i,s,t)}async sleep(e){return new Promise(t=>setTimeout(t,Math.max(0,Number(e)||0)))}getSummarySchemaVersion(){return Number(L?.SUMMARY_POLICY?.SCHEMA_VERSION||1)}getIstNow(){const e=new Date;return new Date(e.toLocaleString("en-US",{timeZone:"Asia/Kolkata"}))}toDateKey(e){const t=e instanceof Date?e:new Date(e),n=t.getFullYear(),i=String(t.getMonth()+1).padStart(2,"0"),s=String(t.getDate()).padStart(2,"0");return`${n}-${i}-${s}`}getISTDateKeys(){const e=this.getIstNow(),t=new Date(e);return t.setDate(t.getDate()-1),{todayKey:this.toDateKey(e),yesterdayKey:this.toDateKey(t)}}shouldRecomputeNowIST(e){const t=Number.isFinite(Number(e))?Number(e):Number(L?.SUMMARY_POLICY?.RECOMPUTE_CUTOFF_HOUR_IST||17);return this.getIstNow().getHours()>=Math.max(0,Math.min(23,t))}isSummaryFresh(e,t){if(!e||typeof e!="object")return!1;const n=Number(e.generatedAt||0),i=Number(e.version||0);return!n||!i||i!==this.getSummarySchemaVersion()?!1:Date.now()-n<=Math.max(0,Number(t)||0)}async getDailySummary(e){const t=String(e||"").trim();if(!t)return null;const n=L?.READ_CACHE_TTLS?.dailySummaryReadMs||6e4,i=this.getCacheKey("dailySummary","daily_summaries",{key:t});return this.getCached(i,n,()=>this.get("daily_summaries",t))}listenDailySummary(e,t){const n=String(e||"").trim();if(!n)return null;const i=this.getCacheKey("dailySummary","daily_summaries",{key:n});return this.listenDoc("daily_summaries",n,(s,o)=>{if(s){const r=L?.READ_CACHE_TTLS?.dailySummaryReadMs||6e4;this.cache.set(i,{value:s,expiresAt:Date.now()+r})}t&&t(s,o)})}async getSummaryByDateKey(e){return this.getDailySummary(e)}async getLatestSuccessfulSummaryMeta(){const e=L?.READ_CACHE_TTLS?.dailySummaryReadMs||6e4,t=this.getCacheKey("dailySummaryMeta","daily_summaries_meta",{key:"latest_success"});return this.getCached(t,e,()=>this.get("daily_summaries_meta","latest_success"))}async setLatestSuccessfulSummaryMeta({dateKey:e,generatedAt:t,version:n}={}){const i=String(e||"").trim();if(!i)return;const s={id:"latest_success",dateKey:i,generatedAt:Number(t||Date.now()),version:Number(n||this.getSummarySchemaVersion())};await this.put("daily_summaries_meta",s)}async getDailySummaryWithFallback({todayKey:e,yesterdayKey:t,staleAfterMs:n}={}){const i=Math.max(1e3,Number(n)||Number(L?.SUMMARY_POLICY?.STALENESS_MS)||864e5),s=L?.SUMMARY_POLICY?.FALLBACK_TO_PREVIOUS_DAY!==!1,o=await this.getSummaryByDateKey(e);if(this.isSummaryFresh(o,i))return{summary:o,source:"today"};if(s){const l=await this.getSummaryByDateKey(t);if(l&&typeof l=="object")return{summary:l,source:"yesterday"}}const r=await this.getLatestSuccessfulSummaryMeta(),d=String(r?.dateKey||"").trim();if(d){const l=await this.getSummaryByDateKey(d);if(l&&typeof l=="object")return{summary:l,source:"latest_success"}}return{summary:o||null,source:"none"}}async putDailySummary(e,t={}){const n=String(e||"").trim();if(!n)throw new Error("putDailySummary requires dateKey.");const i={id:n,dateKey:n,version:this.getSummarySchemaVersion(),...t};return this.put("daily_summaries",i)}async acquireSummaryLock(e,t,n){const i=String(e||"").trim(),s=String(t||"").trim();if(!i||!s||!this.db||!this.db.runTransaction)return!1;if(L?.READ_OPT_FLAGS?.FF_SUMMARY_LOCKING===!1)return!0;const o=Math.max(1e3,Number(n)||Number(L?.SUMMARY_POLICY?.LOCK_TTL_MS)||9e4),r=this.db.collection("summary_locks").doc(i),d=Date.now();try{return await this.db.runTransaction(async c=>{const p=await c.get(r);if(p.exists){const m=p.data()||{},u=String(m.ownerId||"");if(Number(m.expiresAt||0)>d&&u&&u!==s)return!1}return c.set(r,{id:i,dateKey:i,ownerId:s,createdAt:d,expiresAt:d+o},{merge:!0}),!0})===!0}catch(l){return console.warn("Failed to acquire summary lock:",l),!1}}async releaseSummaryLock(e,t){const n=String(e||"").trim(),i=String(t||"").trim();if(!n||!i||!this.db||!this.db.runTransaction||L?.READ_OPT_FLAGS?.FF_SUMMARY_LOCKING===!1)return;const s=this.db.collection("summary_locks").doc(n);try{await this.db.runTransaction(async o=>{const r=await o.get(s);if(!r.exists)return;const d=r.data()||{};String(d.ownerId||"")===i&&o.delete(s)})}catch(o){console.warn("Failed to release summary lock:",o)}}async getOrCreateDailySummary({dateKey:e,yesterdayKey:t,generatorFn:n,staleAfterMs:i,lockTtlMs:s}={}){const o=this.getISTDateKeys(),r=String(e||o.todayKey||"").trim(),d=String(t||o.yesterdayKey||"").trim();if(!r||typeof n!="function")throw new Error("getOrCreateDailySummary requires dateKey and generatorFn.");const l=Math.max(1e3,Number(i)||Number(L?.SUMMARY_POLICY?.STALENESS_MS)||864e5),c=Math.max(1e3,Number(s)||Number(L?.SUMMARY_POLICY?.LOCK_TTL_MS)||9e4),p=String(window.AppAuth?.getUser?.()?.id||`anon_${Math.random().toString(36).slice(2,10)}`),m=await this.getDailySummaryWithFallback({todayKey:r,yesterdayKey:d,staleAfterMs:l});if(m.summary&&m.source==="today"&&this.isSummaryFresh(m.summary,l))return{...m.summary,_source:"shared_today"};if(!this.shouldRecomputeNowIST(L?.SUMMARY_POLICY?.RECOMPUTE_CUTOFF_HOUR_IST))return m.summary?{...m.summary,_source:`fallback_${m.source}`}:null;if(await this.acquireSummaryLock(r,p,c))try{const f={...await n()||{},generatedAt:Date.now(),generatedBy:p,version:this.getSummarySchemaVersion()};return await this.putDailySummary(r,f),await this.setLatestSuccessfulSummaryMeta({dateKey:r,generatedAt:f.generatedAt,version:f.version}),{dateKey:r,...f,_source:"generated"}}finally{await this.releaseSummaryLock(r,p)}const y=[350,700,1200,1800];for(const h of y){await this.sleep(h);const f=await this.getDailySummary(r);if(this.isSummaryFresh(f,l))return{...f,_source:"shared"}}return m.summary?{...m.summary,_source:`fallback_${m.source}`}:null}applyFilters(e,t=[]){let n=e;return(t||[]).forEach(i=>{!i||!i.field||!i.operator||(n=n.where(i.field,i.operator,i.value))}),n}applyOptions(e,t={}){let n=e;return t.orderBy&&(Array.isArray(t.orderBy)?t.orderBy:[t.orderBy]).forEach(s=>{s&&(typeof s=="string"?n=n.orderBy(s):s.field&&(n=n.orderBy(s.field,s.direction||"asc")))}),t.limit&&(n=n.limit(t.limit)),t.startAt!==void 0&&(n=n.startAt(t.startAt)),t.endAt!==void 0&&(n=n.endAt(t.endAt)),n}isPermissionDenied(e){const t=String(e?.code||"").toLowerCase(),n=String(e?.message||"").toLowerCase();return t.includes("permission-denied")||n.includes("missing or insufficient permissions")}async getAll(e,t={}){try{const i=(await this.db.collection(e).get()).docs.map(s=>({...s.data(),id:s.id}));return this.track("getAll",e,i.length),i}catch(n){if(t?.silentPermissionDenied&&this.isPermissionDenied(n))return[];throw console.error(`Error getting all from ${e}:`,n),n}}async get(e,t){if(!t)return null;try{const n=String(t),s=await this.db.collection(e).doc(n).get();return s.exists?(this.track("get",e,1),{...s.data(),id:s.id}):(this.track("get",e,0),null)}catch(n){throw console.error(`Error getting ${t} from ${e}:`,n),n}}async add(e,t){if(t.id)return this.put(e,t);try{const n=await this.db.collection(e).add(t);return this.telemetry.writes+=1,this.invalidateCollectionCache(e),window.dispatchEvent&&window.dispatchEvent(new CustomEvent("app:db-write",{detail:{collection:e,op:"add"}})),n.id}catch(n){throw console.error(`Error adding to ${e}:`,n),n}}async put(e,t){if(!t.id)throw new Error("Item must have an ID for 'put' operation.");try{const n=String(t.id);return await this.db.collection(e).doc(n).set(t,{merge:!0}),this.telemetry.writes+=1,this.invalidateCollectionCache(e),window.dispatchEvent&&window.dispatchEvent(new CustomEvent("app:db-write",{detail:{collection:e,op:"put"}})),n}catch(n){throw console.error(`Error putting ${t.id} to ${e}:`,n),n}}async delete(e,t){if(t)try{const n=String(t);await this.db.collection(e).doc(n).delete(),this.telemetry.writes+=1,this.invalidateCollectionCache(e),window.dispatchEvent&&window.dispatchEvent(new CustomEvent("app:db-write",{detail:{collection:e,op:"delete"}}))}catch(n){throw console.error(`Error deleting ${t} from ${e}:`,n),n}}async query(e,t,n,i){try{const o=(await this.db.collection(e).where(t,n,i).get()).docs.map(r=>({...r.data(),id:r.id}));return this.track("query",e,o.length),o}catch(s){throw console.error(`Error querying ${e}:`,s),s}}async queryMany(e,t=[],n={}){if(!this.getFlags().FF_READ_OPT_DB_QUERIES)return this.getAll(e);try{let s=this.db.collection(e);s=this.applyFilters(s,t),s=this.applyOptions(s,n);const r=(await s.get()).docs.map(d=>({...d.data(),id:d.id}));return this.track("queryMany",e,r.length),r}catch(s){return console.warn(`queryMany failed for ${e}, falling back to getAll`,s),this.getAll(e)}}async getManyByIds(e,t=[]){const n=Array.from(new Set((t||[]).filter(Boolean).map(o=>String(o))));if(!n.length)return[];const i=[];for(let o=0;o<n.length;o+=10)i.push(n.slice(o,o+10));return(await Promise.all(i.map(async o=>{try{const r=await this.queryMany(e,[{field:"id",operator:"in",value:o}]);return r&&r.length?r:Promise.all(o.map(d=>this.get(e,d)))}catch{return Promise.all(o.map(r=>this.get(e,r)))}}))).flat().filter(Boolean)}listenDoc(e,t,n){if(!this.db||!t)return null;const i=String(t);try{return this.db.collection(e).doc(i).onSnapshot(s=>{const o=s.exists?{...s.data(),id:s.id}:null;this.track("listen",e,1),n(o,s)},s=>{console.error(`Realtime listener error in ${e}/${i}:`,s)})}catch(s){return console.error(`Error setting up listener for ${e}/${i}:`,s),null}}listenQuery(e,t=[],n={},i){if(!this.db)return null;try{let s=this.db.collection(e);return s=this.applyFilters(s,t),s=this.applyOptions(s,n),s.onSnapshot(o=>{const r=o.docs.map(d=>({...d.data(),id:d.id}));this.track("listenQuery",e,r.length),i(r,o)},o=>{console.error(`Realtime query listener error in ${e}:`,o)})}catch(s){return console.warn(`listenQuery failed for ${e}, falling back to listen`,s),this.listen(e,i)}}listen(e,t){return this.db?this.db.collection(e).onSnapshot(n=>{const i=n.docs.map(s=>({...s.data(),id:s.id}));this.track("listen",e,i.length),t(i,n)},n=>{console.error(`Realtime listener error in ${e}:`,n)}):null}}const K=new gn;typeof window<"u"&&(window.AppDB=K);class wn{constructor(){this.currentUser=null,this.sessionKey="crwi_session_user",this.heartbeatInterval=null,this.userDocUnsubscribe=null}async init(){await K.init();const e=localStorage.getItem(this.sessionKey);e&&(this.currentUser=await K.get("users",e),this.currentUser&&(this.startHeartbeat(),this.startCurrentUserSync()))}async refreshCurrentUserFromDB(){const e=localStorage.getItem(this.sessionKey);if(!e)return this.currentUser=null,null;if(this.userDocUnsubscribe&&this.currentUser&&this.currentUser.id===e)return this.currentUser;const t=await K.get("users",e);return this.currentUser=t||null,this.currentUser}async login(e,t){const n=K.getCached?await K.getCached(K.getCacheKey("authUsers","users",{mode:"login"}),L?.READ_CACHE_TTLS?.users||6e4,()=>K.getAll("users")):await K.getAll("users"),i=e.trim().toLowerCase(),s=t.trim(),o=n.find(r=>{const d=(r.username||"").toLowerCase().trim(),l=(r.email||"").toLowerCase().trim();return(d===i||l===i)&&r.password.trim()===s});return o?(this.currentUser=o,localStorage.setItem(this.sessionKey,o.id),this.startHeartbeat(),this.startCurrentUserSync(),!0):(console.warn("Login failed: invalid credentials."),!1)}logout(){this.stopHeartbeat(),this.stopCurrentUserSync(),this.currentUser=null,localStorage.removeItem(this.sessionKey),window.location.reload()}getUser(){return this.currentUser}async updateUser(e){const t=await K.get("users",e.id);if(!t)return!1;const n={...t,...e};return e.isAdmin===!0||e.isAdmin==="true"?n.isAdmin=!0:n.isAdmin=!1,n.role=e.role||t.role||"Employee",console.log(`Auth: User ${n.id} update - Role: ${n.role}, Admin: ${n.isAdmin}`),e.name&&e.name!==t.name&&!e.avatar&&(n.avatar=`https://ui-avatars.com/api/?name=${e.name}&background=random&color=fff`),await K.put("users",n),this.currentUser&&this.currentUser.id===n.id&&(this.currentUser=n),!0}startHeartbeat(){if(!(L&&L.READ_OPT_FLAGS||{}).ENABLE_PRESENCE_HEARTBEAT){this.stopHeartbeat();return}this.heartbeatInterval&&clearInterval(this.heartbeatInterval);const t=async()=>{if(this.currentUser&&K)try{await K.put("users",{id:this.currentUser.id,lastSeen:Date.now()})}catch(n){console.warn("Heartbeat update failed:",n)}};t(),this.heartbeatInterval=setInterval(t,12e4),console.log("Presence Heartbeat started.")}stopHeartbeat(){this.heartbeatInterval&&(clearInterval(this.heartbeatInterval),this.heartbeatInterval=null,console.log("Presence Heartbeat stopped."))}startCurrentUserSync(){this.stopCurrentUserSync();const e=localStorage.getItem(this.sessionKey);if(!(!e||!window.AppFirestore))try{this.userDocUnsubscribe=window.AppFirestore.collection("users").doc(String(e)).onSnapshot(t=>{if(!t.exists){this.currentUser=null;return}const n={...t.data(),id:t.id};this.currentUser=n,window.dispatchEvent(new CustomEvent("app:user-sync",{detail:n}))},t=>{console.warn("Current user realtime sync failed:",t)})}catch(t){console.warn("Failed to start current user sync:",t)}}stopCurrentUserSync(){typeof this.userDocUnsubscribe=="function"&&this.userDocUnsubscribe(),this.userDocUnsubscribe=null}}const ae=new wn;typeof window<"u"&&(window.AppAuth=ae);class vn{async getStatus(){const e=await(ae.refreshCurrentUserFromDB?ae.refreshCurrentUserFromDB():ae.getUser());if(!e)return{status:"out",lastCheckIn:null};if(e.status==="in"&&e.lastCheckIn)try{const t=new Date(e.lastCheckIn),n=new Date,i=t.toISOString().split("T")[0],s=n.toISOString().split("T")[0];if(i<s)return{status:"out",lastCheckIn:null,staleSession:!0}}catch(t){console.warn("Date parsing error in getStatus:",t)}return{status:e.status||"out",lastCheckIn:e.lastCheckIn}}async checkIn(e,t,n="Unknown Location"){const i=await(ae.refreshCurrentUserFromDB?ae.refreshCurrentUserFromDB():ae.getUser());if(!i)throw new Error("User not authenticated");let s=!1,o="",r=null,d=null;if(i.status==="in"&&i.lastCheckIn){const c=new Date(i.lastCheckIn),p=new Date,m=`${c.getFullYear()}-${String(c.getMonth()+1).padStart(2,"0")}-${String(c.getDate()).padStart(2,"0")}`,u=`${p.getFullYear()}-${String(p.getMonth()+1).padStart(2,"0")}-${String(p.getDate()).padStart(2,"0")}`;if(m<u){const h=new Date(c.getTime()+144e5),f={status:"Half Day",dayCredit:this.getDayCredit("Half Day"),lateCountable:!1},S=i.currentLocation||i.lastLocation||null,_=new Date().toISOString(),b={id:String(Date.now()),user_id:i.id,date:h.toISOString().split("T")[0],checkIn:c.toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"}),checkOut:h.toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"}),duration:this.msToTime(144e5),durationMs:144e5,type:f.status,dayCredit:f.dayCredit,lateCountable:f.lateCountable,extraWorkedMs:0,policyVersion:"v2",location:S?.address||"Missed checkout session",lat:S?.lat??null,lng:S?.lng??null,checkOutLocation:"System closure on next check-in",outLat:null,outLng:null,workDescription:"System closure: missed checkout auto-closed as half day. Reason required on next login.",locationMismatched:!1,locationExplanation:"",activityScore:0,autoCheckout:!0,autoCheckoutReason:"missed_checkout_next_login",autoCheckoutAt:_,autoCheckoutRequiresApproval:!1,autoCheckoutExtraApproved:null,missedCheckoutResolved:!0,missedCheckoutPolicy:"half_day_on_missed_checkout",missedCheckoutReasonRequired:!0,missedCheckoutReasonStatus:"pending",missedCheckoutReason:"",missedCheckoutReasonSubmittedAt:null,missedCheckoutReviewedBy:"",missedCheckoutReviewedAt:"",missedCheckoutReviewNote:"",systemClosedAt:_,synced:!1};await K.add("attendance",b),r=b.id,d=b.date,i.status="out",i.lastCheckOut=h.getTime(),i.lastLocation=S,i.lastCheckOutLocation={lat:null,lng:null,address:"System closure on next check-in"},i.locationMismatched=!1,i.lastCheckIn=null,i.currentLocation=null,s=!0,o="Previous open session was closed as half day because checkout was missed. Please submit a reason for admin verification."}else return{ok:!1,conflict:!0,message:"Status updated from another device."}}i.status="in",i.lastCheckIn=Date.now();const l=n&&n!=="Unknown Location"?n:e&&t?`Lat: ${Number(e).toFixed(4)}, Lng: ${Number(t).toFixed(4)}`:"Unknown Location";return i.currentLocation={lat:e,lng:t,address:l},await K.put("users",i),{ok:!0,resolvedMissedCheckout:s,noticeMessage:o,missedCheckoutReasonRequired:s,missedCheckoutLogId:r,missedCheckoutDate:d}}async checkOut(e="",t=null,n=null,i="Detected Location",s=!1,o="",r={}){const d=await(ae.refreshCurrentUserFromDB?ae.refreshCurrentUserFromDB():ae.getUser());if(!d||d.status!=="in")return{ok:!1,conflict:!0,message:"Status updated from another device."};const l=new Date(d.lastCheckIn),c=r.checkOutTime?new Date(r.checkOutTime):new Date,p=c-l,m=this.evaluateAttendanceStatus(l,p),u=window.AppActivity?window.AppActivity.getStats():{score:0},y={id:String(Date.now()),user_id:d.id,date:c.toISOString().split("T")[0],checkIn:l.toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"}),checkOut:c.toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"}),duration:this.msToTime(p),durationMs:p,type:m.status,dayCredit:m.dayCredit,lateCountable:m.lateCountable,extraWorkedMs:m.extraWorkedMs||0,policyVersion:"v2",location:d.currentLocation?.address||"Checked In Location",lat:d.currentLocation?.lat,lng:d.currentLocation?.lng,checkOutLocation:i||(t&&n?`Lat: ${Number(t).toFixed(4)}, Lng: ${Number(n).toFixed(4)}`:"Detected Location"),outLat:t,outLng:n,workDescription:e||"",locationMismatched:s,locationExplanation:o||"",activityScore:u.score,autoCheckout:!!r.autoCheckout,autoCheckoutReason:r.autoCheckoutReason||"",autoCheckoutAt:r.autoCheckoutAt||null,autoCheckoutRequiresApproval:!!r.autoCheckoutRequiresApproval,autoCheckoutExtraApproved:r.autoCheckoutExtraApproved??null,overtimePrompted:!!r.overtimePrompted,overtimeReasonTag:r.overtimeReasonTag||"",overtimeExplanation:r.overtimeExplanation||"",overtimeCappedToEightHours:!!r.overtimeCappedToEightHours,taskUpdates:Array.isArray(r.taskUpdates)?r.taskUpdates:[],entrySource:"checkin_checkout",attendanceEligible:!0,synced:!1};return await K.add("attendance",y),d.status="out",d.lastCheckOut=Date.now(),d.lastLocation=d.currentLocation,d.lastCheckOutLocation={lat:t,lng:n,address:i},d.locationMismatched=s,d.lastCheckIn=null,d.currentLocation=null,await K.put("users",d),window.AppActivity&&window.AppActivity.stop(),{ok:!0,conflict:!1}}async addAdminLog(e,t){const n={id:String(Date.now()),user_id:e,...t,isManualOverride:t.isManualOverride===!0,entrySource:t.entrySource||"admin_override",attendanceEligible:Object.prototype.hasOwnProperty.call(t,"attendanceEligible")?t.attendanceEligible===!0:!0,synced:!1};return await K.add("attendance",n),n}async deleteLog(e){if(e)return await K.delete("attendance",e),!0}async updateLog(e,t){if(!e)return;const n=await K.get("attendance",e);if(!n)throw new Error("Log not found");const i={...n,...t,isManualOverride:Object.prototype.hasOwnProperty.call(t,"isManualOverride")?t.isManualOverride===!0:!!n.isManualOverride,entrySource:t.entrySource||n.entrySource||"admin_override",attendanceEligible:Object.prototype.hasOwnProperty.call(t,"attendanceEligible")?t.attendanceEligible===!0:Object.prototype.hasOwnProperty.call(n,"attendanceEligible")?n.attendanceEligible===!0:!0,id:e};return await K.put("attendance",i),i}async addManualLog(e){const t=ae.getUser();if(!t)return;const n=this.buildDateTime(e.date,e.checkIn),i=this.buildDateTime(e.date,e.checkOut),s=n&&i?i-n:0,o=this.evaluateAttendanceStatus(n||new Date,s),r=String(e.type||"").trim(),d=!r||r==="Manual"?o.status:r,l=Object.prototype.hasOwnProperty.call(e,"attendanceEligible")?e.attendanceEligible===!0:d!=="Work Log",c=l?d:r||"Work Log",p={id:String(Date.now()),user_id:t.id,...e,type:c,durationMs:typeof e.durationMs=="number"?e.durationMs:s,dayCredit:l?typeof e.dayCredit=="number"?e.dayCredit:o.dayCredit:0,lateCountable:l&&(e.lateCountable===!0||c==="Late"),extraWorkedMs:l?typeof e.extraWorkedMs=="number"?e.extraWorkedMs:o.extraWorkedMs||0:0,entrySource:e.entrySource||"staff_manual_work",attendanceEligible:l,synced:!1};return await K.add("attendance",p),p}async getLogs(e=null){const t=e||ae.getUser()?.id;if(!t)return[];try{const n=window.AppFirestore;if(!n)return[];let i=n.collection("attendance");i=i.where("user_id","==",t);const r=(await i.get()).docs.map(c=>({...c.data(),id:c.id})).sort((c,p)=>p.id-c.id).map(c=>((!c.location||c.location==="Unknown Location")&&c.lat&&c.lng&&(c.location=`Lat: ${Number(c.lat).toFixed(4)}, Lng: ${Number(c.lng).toFixed(4)}`),c)),d=new Set,l=r.filter(c=>{const p=`${c.date}|${c.checkIn}`;return d.has(p)?!1:(d.add(p),!0)});try{const c=await K.get("users",t);if(c&&c.status==="in"&&c.lastCheckIn){const p=new Date(c.lastCheckIn),m={id:"active_now",date:p.toLocaleDateString(),checkIn:p.toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"}),checkOut:"Active Now",duration:"Working...",type:"Office",location:c.currentLocation?.address&&c.currentLocation.address!=="Unknown Location"?c.currentLocation.address:c.currentLocation?.lat&&c.currentLocation?.lng?`Lat: ${Number(c.currentLocation.lat).toFixed(4)}, Lng: ${Number(c.currentLocation.lng).toFixed(4)}`:"Current Session"};l.unshift(m)}}catch(c){console.warn("Could not fetch active status for logs",c)}return l.slice(0,50)}catch(n){return console.warn("Optimized log fetch failed, falling back to simple filter",n),[]}}async getAllLogs(){return await K.getAll("attendance")}msToTime(e){let t=Math.floor(e/6e4%60);return`${Math.floor(e/(1e3*60*60)%24)}h ${t}m`}buildDateTime(e,t){if(!e||!t)return null;const n=`${e}T${t}:00`,i=new Date(n);return Number.isNaN(i.getTime())?null:i}normalizeType(e){const t=String(e||"").trim();return!t||t==="Manual"?"Present":t==="Manual/WFH"?"Work - Home":t}getDayCredit(e){const t=this.normalizeType(e);return t==="Half Day"?.5:t==="Absent"?0:t==="Present"||t==="Present (Late Waived)"||t==="Late"||t==="Work - Home"||t==="On Duty"?1:0}evaluateAttendanceStatus(e,t=0){if(!e||Number.isNaN(e.getTime()))return{status:"Absent",dayCredit:0,lateCountable:!1,extraWorkedMs:0};if(e.getDay()===0)return{status:"Present",dayCredit:1,lateCountable:!1,extraWorkedMs:0};const i=e.getHours()*60+e.getMinutes(),s=Math.max(0,t)/(1e3*60*60),o=(typeof L<"u"&&L?L.LATE_CUTOFF_MINUTES:555)||555,r=(typeof L<"u"&&L?L.MINOR_LATE_END_MINUTES:615)||615,d=(typeof L<"u"&&L?L.LATE_END_MINUTES:720)||720,l=(typeof L<"u"&&L?L.POST_NOON_END_MINUTES:810)||810,c=(typeof L<"u"&&L?L.AFTERNOON_START_MINUTES:720)||720;let p="Present",m=!1,u=0;return i>=c?(s>=8?p="Present":s>=4?p="Half Day":p="Absent",s>4&&(u=Math.max(0,t-14400*1e3)),{status:p,dayCredit:this.getDayCredit(p),lateCountable:!1,extraWorkedMs:u}):(i>l?p="Absent":i>d||i>r?p=s>=4?"Half Day":"Absent":i>o?s>=8?p="Present (Late Waived)":(p="Late",m=!0):s>=8?p="Present":s>=4?p="Half Day":p="Absent",{status:p,dayCredit:this.getDayCredit(p),lateCountable:m,extraWorkedMs:u})}calculateStatus(e){return this.evaluateAttendanceStatus(e,480*60*1e3).status}}const ba=new vn;typeof window<"u"&&(window.AppAttendance=ba);function D(a){return a==null?"":String(a).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function Ie(a){return D(a)}function bn(a){return String(a??"").replace(/\\/g,"\\\\").replace(/'/g,"\\'").replace(/"/g,'\\"').replace(/\n/g,"\\n").replace(/\r/g,"\\r")}function Ke(a,e="https://via.placeholder.com/24"){return!a||typeof a!="string"?e:a.startsWith("http")||a.startsWith("data:")||a.startsWith("/")||a.startsWith("./")?a:e}function yt(a){if(!a)return"Never";const e=new Date(a);if(isNaN(e.getTime()))return"Unknown";const t=Math.floor((new Date-e)/1e3);if(t<60)return"just now";let n=t/31536e3;return n>1?Math.floor(n)+" years ago":(n=t/2592e3,n>1?Math.floor(n)+" months ago":(n=t/86400,n>1?Math.floor(n)+" days ago":(n=t/3600,n>1?Math.floor(n)+" hours ago":(n=t/60,n>1?Math.floor(n)+" mins ago":Math.floor(t)+" seconds ago"))))}typeof window<"u"&&(window.safeHtml=D,window.safeAttr=Ie,window.safeJsStr=bn,window.safeUrl=Ke,window.timeAgo=yt);function Sn(a,e=!0){const t=Math.max(0,Math.min(5,Number(a)||0)),n=Math.floor(t),i=t-n>=.5,s=5-n-(i?1:0);let o='<div class="star-rating-display">';for(let r=0;r<n;r++)o+='<i class="fa-solid fa-star star-filled"></i>';i&&(o+='<i class="fa-solid fa-star-half-stroke star-filled"></i>');for(let r=0;r<s;r++)o+='<i class="fa-regular fa-star star-empty"></i>';return e&&(o+=`<span class="star-rating-number">${t.toFixed(1)}</span>`),o+="</div>",o}function Sa(a,e=!0){const t=String(a||"to-be-started").toLowerCase();let n="To Be Started",i="fa-circle-dot",s="status-badge-to-be-started";return t==="in-process"||t==="in-progress"?(n="In Progress",i="fa-spinner fa-spin",s="status-badge-in-process"):t==="completed"?(n="Completed",i="fa-circle-check",s="status-badge-completed"):t==="overdue"?(n="Overdue",i="fa-circle-exclamation",s="status-badge-overdue"):(t==="not-completed"||t==="cancelled")&&(n="Not Completed",i="fa-circle-xmark",s="status-badge-not-completed"),`
    ...
    `},Ne={controllers:new WeakMap,elements:new Set};function Ge(){return window.app_staffActivityState||(window.app_staffActivityState={selectedMonth:new Date().toISOString().slice(0,7),sortKey:"date-desc",logs:[],leaveHistoryDate:new Date().toISOString().slice(0,10)}),window.app_staffActivityState.leaveHistoryDate||(window.app_staffActivityState.leaveHistoryDate=new Date().toISOString().slice(0,10)),window.app_staffActivityState}function ka(a){const e=a?new Date(`${a}T00:00:00`):new Date;if(Number.isNaN(e.getTime()))return ka(new Date().toISOString().slice(0,10));const t=e.getDay(),n=t===0?-6:1-t,i=new Date(e);i.setDate(e.getDate()+n),i.setHours(0,0,0,0);const s=new Date(i);s.setDate(i.getDate()+6),s.setHours(23,59,59,999);const o=r=>{const d=r.getFullYear(),l=String(r.getMonth()+1).padStart(2,"0"),c=String(r.getDate()).padStart(2,"0");return`${d}-${l}-${c}`};return{start:i,end:s,startKey:o(i),endKey:o(s),label:`${i.toLocaleDateString("en-US",{month:"short",day:"numeric"})} - ${s.toLocaleDateString("en-US",{month:"short",day:"numeric",year:"numeric"})}`}}let ia=!1;function kn(){ia||typeof document>"u"||(ia=!0,document.addEventListener("click",async a=>{const e=a.target&&a.target.closest?a.target.closest(".dashboard-leave-btn[data-action][data-leave-id]"):null;if(!e)return;a.preventDefault();const t=String(e.dataset.action||""),n=String(e.dataset.leaveId||"");if(n)try{if(t==="export"){window.AppLeaves?.exportLeave&&await window.AppLeaves.exportLeave(n);return}if(t==="comment"){window.AppLeaves?.commentLeave&&await window.AppLeaves.commentLeave(n);return}if(t==="approve"||t==="reject"){const i=t==="approve"?"Approved":"Rejected",s=window.AppAuth?.getUser?.()?.id;if(window.AppLeaves?.updateLeaveStatus&&await window.AppLeaves.updateLeaveStatus(n,i,s),typeof window.app_refreshCurrentPage=="function")await window.app_refreshCurrentPage();else{const o=document.getElementById("page-content");o&&(o.innerHTML=await kt())}}}catch(i){console.error("Dashboard leave action failed:",i)}}))}function ve(a,e={}){const t=a?.state||(a?.user?"winner":"no_eligible_data");if(!a||t!=="winner"){const h=a?.reason||(t==="fetch_error"?"Hero stats are temporarily unavailable.":"No eligible hero data available."),f=t==="fetch_error"?"Fetch Error":"No Eligible Data";return`
            <div class="card dashboard-hero-stats-card hero-slot">
                <div class="dashboard-hero-stats-head">
                    ...
                    ${e.generatedAt?`<span class="hero-sync-time" title="Source: ${e.source||a?.source||"unknown"}">Synced ${yt(e.generatedAt)}</span>`:""}
                </div>
        ...
        <div class="card dashboard-hero-stats-card hero-slot ${m?"is-new-summary":""}">
            ...
            <div class="dashboard-hero-stats-body">
                <div class="hero-profile">
                    <img src="${Ke(n.avatar)}" alt="${D(n.name)}" class="hero-avatar">
                    <div class="hero-info">
            ...
            <div class="dashboard-hero-stats-foot">
                <span class="dashboard-kpi-tag">${D(y)}</span>
                <span class="dashboard-kpi-tag">Confidence ${u}%</span>
            </div>
        </div>`}function Aa(a,e=[],t=null,n=[]){const i=new Date,s=new Date(i);s.setDate(s.getDate()-180);const o=s.toISOString().split("T")[0],r=i.toISOString().split("T")[0],d=t?t.id:window.AppAuth.getUser().id,l=t&&t.name||window.AppAuth.getUser().name;return`
    ...
    `}function Da(a,e,t,n,i=[],s=[]){const o=new Date(e),r=new Date(t);r.setHours(23,59,59,999);const d=a.filter(f=>{const S=new Date(f.date),_=f.workDescription||(f.location&&!f.location.startsWith("Lat:")?f.location:"Standard Activity");return f._displayDesc=_,f._isCollab=!1,f._sortTime=f.checkOut||"00:00",S>=o&&S<=r}),l=[];i.forEach(f=>{const S=new Date(f.date);if(S<o||S>r)return;f.plans.filter(b=>b.tags&&b.tags.some($=>$.id===n&&$.status==="accepted")).forEach(b=>{l.push({date:f.date,workDescription:`🤝 Collaborated with ${f.userName}: ${b.task}${b.subPlans&&b.subPlans.length>0?` (Sub-tasks: ${b.subPlans.join(", ")})`:""}`,checkOut:"Planned / Accepted",_displayDesc:`🤝 Collaborated with ${f.userName}: ${b.task}${b.subPlans&&b.subPlans.length>0?` (Sub-tasks: ${b.subPlans.join(", ")})`:""}`,_isCollab:!0,_sortTime:"23:59"})})});const c=[];s.forEach(f=>{(f.actionItems||[]).forEach(S=>{if(S.assignedTo!==n)return;const _=S.dueDate||f.date,b=new Date(_);b<o||b>r||c.push({date:_,workDescription:`📋 Meeting Task: ${S.task} (from ${f.title})`,status:S.status||"pending",checkOut:"Action Item",_displayDesc:`📋 Meeting Task: ${S.task} (from ${f.title})`,_isCollab:!1,_isMinute:!0,_meetingId:f.id,_sortTime:"09:00"})})});const p=[...d,...l,...c].sort((f,S)=>{const _=new Date(S.date)-new Date(f.date);return _!==0?_:S._sortTime.localeCompare(f._sortTime)});if(p.length===0)return'<div class="dashboard-activity-empty">No activity descriptions found.</div>';let m="",u="";const y=window.AppAuth.getUser(),h=window.app_hasPerm("dashboard","admin",y);return p.forEach(f=>{f.date!==u&&(m+=`<div class="dashboard-activity-date">${f.date}</div>`,u=f.date);const _=f._isCollab?"#10b981":f._isMinute?"#6366f1":"#e5e7eb",b=f._isCollab?"dashboard-activity-item-collab":f._isMinute?"dashboard-activity-item-minute":"",$=$a(f);let g="";if(f._isCollab||f.status||f._isMinute){const w=window.AppCalendar?window.AppCalendar.getSmartTaskStatus(f.date,f.status):f.status||"to-be-started";g=`
                <div class="dashboard-activity-status-row">
                    ${Sa(w)}
                    ${h||f._isMinute?`<div class="dashboard-activity-edit-wrap"><button onclick="${f._isMinute?`window.app_openMinuteDetails('${f._meetingId}')`:`window.app_openDayPlan('${f.date}', '${n}')`}" class="dashboard-activity-edit-btn" title="View/Edit"><i class="fa-solid fa-${f._isMinute?"eye":"pen-to-square"}"></i></button></div>`:""}
                </div>`}m+=`<div class="dashboard-activity-item ${b}" style="border-left-color:${_};"><div class="dashboard-activity-desc">${D(f._displayDesc)}</div>${$}${g}<div class="dashboard-activity-meta">${D(f.checkOut||(f.status==="completed"?"Completed":"Planned Activity"))}</div></div>`}),m}function xa(a){const e=Ge();e.logs=Array.isArray(a)?a:[],setTimeout(()=>{const i=document.getElementById("staff-activity-list");i&&Ca(i)},0);const t=_n(8),n=At(e.selectedMonth);return`
        <div class="card dashboard-team-activity-card">
            ...
            <div class="dashboard-team-activity-filters dashboard-team-activity-filters-compact">
                <select class="dashboard-team-select" onchange="window.app_setStaffActivityMonth(this.value)">
                    ${t.map(i=>`<option value="${i.key}" ${i.key===e.selectedMonth?"selected":""}>${D(i.label)}</option>`).join("")}
                </select>
        ...
        </div>`}function St(a,e){const t=Tn(a);if(t.length===0)return'<div class="dashboard-activity-empty">No team activities found for the selected month.</div>';const n=In(t,e),i=n.filter(o=>o._taskStatus==="completed"),s=n.filter(o=>o._taskStatus!=="completed");return`
        <div class="dashboard-team-activity-split-grid">
            ${Ft("Completed",i,"No completed tasks in this month.")}
            ${Ft("In Progress / Incomplete",s,"No in-progress or incomplete tasks in this month.")}
        </div>
    `}function Ft(a,e,t){const n=window.AppAuth.getUser(),i=window.app_hasPerm("dashboard","admin",n),s=e.length===0?`<div class="dashboard-activity-empty">${t}</div>`:e.map(o=>{const r=n&&o.userId===n.id,d=i||r,l=$a(o),c=`
                <div class="dashboard-activity-status-row">
                    ${Sa(o._taskStatus)}
    ...
    `}function $a(a){if(!a)return"";const e=Number.isFinite(Number(a.progressPercent)),t=a.progressStatus?String(a.progressStatus).replace(/_/g," "):"",n=String(a.progressNote||"").trim();if(!e&&!t&&!n&&Array.isArray(a.taskUpdates)&&a.taskUpdates.length>0){const r=a.taskUpdates[0]||{},d=Number.isFinite(Number(r.progressPercent))?`${Number(r.progressPercent)}%`:"",l=r.progressStatus?String(r.progressStatus).replace(/_/g," "):"",c=String(r.progressNote||"").trim();if(!d&&!l&&!c)return"";const p=c?` title="${D(c)}"`:"",m=`${d}${d&&l?" • ":""}${D(l)}`;return`<div class="dashboard-progress-chip"${p}>${m}</div>`}if(!e&&!t&&!n)return"";const i=e?`${Number(a.progressPercent)}%`:"",s=n?` title="${D(n)}"`:"",o=`${i}${i&&t?" • ":""}${D(t)}`;return`<div class="dashboard-progress-chip"${s}>${o}</div>`}function Fe(a,e,t,n=""){const s=Number(t.penalty??t.penaltyLeaves??0)>0?'<span class="dashboard-penalty-badge">Penalty Applies</span>':"";return`
    ...
    `}function _a(a){const e=Object.entries(a),t={Present:{color:"#166534",bg:"#f0fdf4",label:"Office"},"Work - Home":{color:"#0369a1",bg:"#e0f2fe",label:"WFH"},Training:{color:"#4338ca",bg:"#eef2ff",label:"Training"},Late:{color:"#c2410c",bg:"#fff7ed",label:"Late"},"Sick Leave":{color:"#991b1b",bg:"#fef2f2",label:"Sick"},"Casual Leave":{color:"#9d174d",bg:"#fce7f3",label:"Casual"},"Earned Leave":{color:"#be185d",bg:"#fdf2f8",label:"Earned"},"Paid Leave":{color:"#be123c",bg:"#ffe4e6",label:"Paid"},"Maternity Leave":{color:"#a21caf",bg:"#fae8ff",label:"Maternity"},Absent:{color:"#7f1d1d",bg:"#fee2e2",label:"Absent"},"Early Departure":{color:"#991b1b",bg:"#fff1f2",label:"Early Exit"},Holiday:{color:"#1e293b",bg:"#f1f5f9",label:"Holiday"},"National Holiday":{color:"#334155",bg:"#f8fafc",label:"Nat. Hol"},"Regional Holidays":{color:"#475569",bg:"#f8fafc",label:"Reg. Hol"}};return e.map(([n,i])=>{const s=t[n]||{color:"#374151",bg:"#f3f4f6",label:n};return i===0&&!["Present","Late","Absent","Early Departure"].includes(n)?"":`
        ...
        </div>`}function xn(a){return!a||a.length===0?`
        ...
        <div class="card full-width dashboard-tagged-card">
        ...
        </div>`}function Ia(a,e={}){const t=e.title||"Leave History",n=e.subtitle||"Past records",i=e.selectedDate||new Date().toISOString().slice(0,10);if(!a||a.length===0)return`
            <div class="card dashboard-leave-history-card">
                <div class="dashboard-leave-history-head">
                    ...
                    <input type="date" class="dashboard-team-select" value="${D(i)}" onchange="window.app_setDashboardLeaveHistoryDate(this.value)">
                </div>
                ...
                ${a.map(o=>`
                    <div class="dashboard-leave-history-row">
                        ...
                        <div class="dashboard-leave-history-status">
                            <span class="status-pill" style="background: ${s(o.status)}15; color: ${s(o.status)}">${D(o.status)}</span>
                        </div>
                    </div>
                `).join("")}
            </div>
        </div>`}function Ma(a,e){return""}function La(a){const e=(a||[]).filter(t=>!(t.type==="tag"||t.type==="task"||t.type==="mention")||t.dismissedAt||t.read?!1:String(t.status||"pending").toLowerCase()==="pending");return e.length===0?"":`
        <div class="card full-width dashboard-tagged-card">
            ...
            <div class="dashboard-tagged-list">
                ${e.map(t=>`
                    <div class="dashboard-tagged-item">
                        <div class="dashboard-tagged-main">
                            <div class="dashboard-tagged-title">${D(t.title||"Tagged item")}</div>
                            <div class="dashboard-tagged-desc">${D(t.description||t.message||"")}</div>
                            <div class="dashboard-tagged-meta">Tagged by ${D(t.taggedByName||"Staff")} • ${yt(t.taggedAt||t.date)}</div>
                        </div>
                        <div class="dashboard-tagged-status">
                            ...
                            ${t.status==="pending"?`
                                <div class="dashboard-tagged-actions">
                                    ${t.planId?`
                                        <button class="dashboard-tagged-btn accept" onclick="window.app_handleTagResponse('${t.planId}', ${t.taskIndex}, 'accepted', ${a.indexOf(t)})">Approve</button>
                                        <button class="dashboard-tagged-btn reject" onclick="window.app_handleTagResponse('${t.planId}', ${t.taskIndex}, 'rejected', ${a.indexOf(t)})">Reject</button>
                                    `:`
    ...
    `}function $n(a,e,t){if(!a||a.length===0)return`
        ...
        <div class="card dashboard-staff-directory-card">
                ...
                <div class="dashboard-staff-row ${r&&n-r<12e4?"dashboard-staff-row-new":""}">
                    <div class="dashboard-staff-meta">
                        <div class="dashboard-staff-avatar">
                            <img src="${Ke(o.avatar)}" alt="${D(o.name)}">
                        </div>
        ...
        </div>`}async function kt(){const a=window.AppAuth.getUser(),e=window.app_hasPerm("dashboard","view",a),t=window.app_hasPerm("dashboard","admin",a),n=Ge(),i=n.selectedMonth,s=n.leaveHistoryDate||new Date().toISOString().slice(0,10),o=window.AppDB?.getISTDateKeys?window.AppDB.getISTDateKeys():{todayKey:new Date().toISOString().split("T")[0],yesterdayKey:new Date(Date.now()-1440*60*1e3).toISOString().split("T")[0]},r=o.todayKey,d=o.yesterdayKey,l=!!L?.READ_OPT_FLAGS?.FF_SHARED_DAILY_SUMMARY,c=`hero_stats_${r}`,p=1440*60*1e3,m=e&&window.app_selectedSummaryStaffId?window.app_selectedSummaryStaffId:a.id;console.time("DashboardFetch");const u=async()=>{try{return await window.AppDB.getOrGenerateSummary(c,async()=>{const H=await window.AppAnalytics.getHeroOfTheWeek({source:"direct_cache"});if(!H||H.state==="fetch_error")throw new Error("direct hero unavailable");return H},p)}catch(H){return console.warn("Direct hero cache read failed:",H),null}},y=l?Promise.resolve(null):u(),h=l?Promise.resolve([]):window.AppDB.getOrGenerateSummary(`team_activity_${i}_${r}`,()=>window.AppAnalytics.getAllStaffActivities({mode:"month",month:i,scope:"work"})),f=l&&window.AppDB.getOrCreateDailySummary?window.AppDB.getOrCreateDailySummary({dateKey:r,yesterdayKey:d,staleAfterMs:L?.SUMMARY_POLICY?.STALENESS_MS,lockTtlMs:L?.SUMMARY_POLICY?.LOCK_TTL_MS,generatorFn:()=>window.AppAnalytics.buildDailyDashboardSummary({dateKey:r,selectedMonth:i})}).catch(H=>(console.warn("Daily summary fetch/generation failed:",H),null)):null,S=f?Promise.race([f,new Promise(H=>setTimeout(()=>H(null),1500))]):Promise.resolve(null);if(!window._dashboardRefreshScheduled){window._dashboardRefreshScheduled=!0;try{const H=window.AppDB.getIstNow(),ie=new Date(H);ie.setDate(ie.getDate()+1),ie.setHours(0,0,5,0);const we=ie.getTime()-H.getTime();setTimeout(()=>{kt().then(oe=>{const re=document.getElementById("page-content");re&&(re.innerHTML=oe)}),window._dashboardRefreshScheduled=!1},Math.max(0,we))}catch(H){console.warn("failed to schedule dashboard refresh",H)}}const _=e?(Array.isArray(a.notifications)?a.notifications:[]).filter(H=>H&&H.type==="missed-checkout-reason"&&String(H.status||"pending").toLowerCase()==="pending"&&H.logId):[],b=Array.from(new Set(_.map(H=>String(H.logId||"")).filter(Boolean))),[$,g,w,k,T,E,v,x,A,M,O,I,N,P]=await Promise.all([window.AppAttendance.getStatus(),window.AppAttendance.getLogs(m),window.AppAnalytics.getUserMonthlyStats(m),window.AppAnalytics.getUserYearlyStats(m),y,window.AppCalendar?window.AppCalendar.getPlans():{leaves:[],events:[]},h,window.app_hasPerm("leaves","view")?window.AppLeaves.getPendingLeaves():Promise.resolve([]),window.AppDB.getCached?window.AppDB.getCached(window.AppDB.getCacheKey("dashboardUsers","users",{}),L?.READ_CACHE_TTLS?.users||6e4,()=>window.AppDB.getAll("users")):window.AppDB.getAll("users"),window.AppCalendar?window.AppCalendar.getCollaborations(m):Promise.resolve([]),window.app_hasPerm("leaves","view")?window.AppDB.getAll("leaves"):Promise.resolve([]),S,window.AppMinutes?window.AppMinutes.getMinutes():Promise.resolve([]),e&&b.length?window.AppDB.getManyByIds?window.AppDB.getManyByIds("attendance",b):Promise.all(b.map(H=>window.AppDB.get("attendance",H))).then(H=>H.filter(Boolean)):Promise.resolve([])]);console.timeEnd("DashboardFetch");const B=l?{lowRead:!1,generatedAt:I?.generatedAt||I?.meta?.generatedAt||0,source:I?._source||""}:{};let U=l?I?.hero||null:T,V=l?Array.isArray(I?.teamActivityPreview)?I.teamActivityPreview:[]:v;l&&(!I||!Array.isArray(I.teamActivityPreview))&&setTimeout(()=>Ln(!0),0);const j=ve(U,B);if(l&&U==null&&f){const H="app_hero_fallback_attempted_date",ie=()=>{try{return localStorage.getItem(H)===r}catch{return!1}},we=()=>{try{localStorage.setItem(H,r)}catch{}},oe=re=>{const de=document.querySelector(".hero-slot");de&&(de.outerHTML=re)};f.then(async re=>{const de=re&&re.hero?re.hero:null;if(de){const ke={...B,generatedAt:re.generatedAt||B.generatedAt,source:re._source||B.source};oe(ve(de,ke));return}const fe=await u();if(fe){oe(ve(fe,{...B,generatedAt:Date.now(),source:"direct_cache"}));return}if(oe(ve({state:"no_eligible_data",reason:"No eligible hero data available.",source:"shared_summary"},{...B,generatedAt:re?.generatedAt||B.generatedAt,source:re?._source||"shared_missing"})),!ie()){we();try{const ke=await window.AppAnalytics.getHeroOfTheWeek({source:"direct_fallback"});if(!ke||ke.state==="fetch_error"){oe(ve({state:"fetch_error",reason:"Hero stats are temporarily unavailable.",source:"direct_fallback"},{...B,lowRead:!1,generatedAt:Date.now(),source:"direct_fallback"}));return}await window.AppDB.getOrGenerateSummary(c,async()=>ke,p);const hn={...B,lowRead:!1,generatedAt:Date.now(),source:"direct_fallback"};oe(ve(ke,hn))}catch(ke){console.warn("Hero fallback direct fetch failed:",ke),oe(ve({state:"fetch_error",reason:"Hero stats are temporarily unavailable.",source:"direct_fallback"},{...B,generatedAt:Date.now(),source:"direct_fallback"}))}}}).catch(()=>{oe(ve({state:"fetch_error",reason:"Hero stats are temporarily unavailable.",source:"shared_error"},{...B,source:"shared_error"}))})}window.AppRating&&a.rating===void 0&&window.AppRating.updateUserRating(a.id).then(H=>{Object.assign(a,H)}).catch(()=>{});const W=(A||[]).find(H=>H.id===m),J=m===a.id,C=!J&&W?W:a,R=e&&!J&&!t,G=new Date,q=new Date(G.getFullYear(),G.getMonth(),1),X=new Date(G.getFullYear(),G.getMonth()+1,0),ee=window.AppAnalytics&&window.AppAnalytics.getFinancialYearDates?window.AppAnalytics.getFinancialYearDates():{start:new Date(G.getFullYear(),0,1),end:new Date(G.getFullYear(),11,31)};window.app_dashboardStatsStore={monthly:w||{},yearly:k||{},monthlyTitle:J?w.label:`${w.label} - ${W?.name||"Staff"}`,monthlySubtitle:J?"Monthly Stats":"Viewing Staff Monthly Stats",yearlyTitle:"Yearly Summary",yearlySubtitle:J?k.label:`${k.label} for ${W?.name||"Staff"}`,logs:Array.isArray(g)?g:[],ranges:{monthly:{start:q.toISOString().split("T")[0],end:X.toISOString().split("T")[0]},yearly:{start:ee.start.toISOString().split("T")[0],end:ee.end.toISOString().split("T")[0]}}};const ne=R?{status:C.status||"out",lastCheckIn:C.lastCheckIn||null}:$,ue=ne.status==="in",me=a.notifications||[];a.tagHistory;const _t=new Map((A||[]).map(H=>[String(H.id),H])),Tt=e?(P||[]).filter(H=>H&&H.missedCheckoutReasonRequired&&H.missedCheckoutReasonSubmittedAt&&String(H.missedCheckoutReasonStatus||"").toLowerCase()==="pending").map(H=>{const ie=_t.get(String(H.user_id));return{notificationId:me.find(oe=>oe&&oe.type==="missed-checkout-reason"&&String(oe.logId||"")===String(H.id||"")&&String(oe.status||"pending").toLowerCase()==="pending")?.id||"",staffName:ie?.name||"Staff",staffRole:ie?.role||"Employee",reason:H.missedCheckoutReason||"",date:H.date||"",submittedAt:H.missedCheckoutReasonSubmittedAt||""}}).sort((H,ie)=>new Date(ie.submittedAt||ie.date||0)-new Date(H.submittedAt||H.date||0)):[];let Ue="00 : 00 : 00",st="Check-in",ot="action-btn";ue&&(st="Check-out",ot="action-btn checkout");const It=H=>{const ie=Math.max(0,H||0);let we=Math.floor(ie/(1e3*60*60)),oe=Math.floor(ie/(1e3*60)%60),re=Math.floor(ie/1e3%60);return`${String(we).padStart(2,"0")} : ${String(oe).padStart(2,"0")} : ${String(re).padStart(2,"0")}`};if(ue&&ne.lastCheckIn){const H=new Date(ne.lastCheckIn).getTime();Ue=It(Date.now()-H)}const rt=Ma(),fn=La(me);let aa="";e&&!J&&W&&(aa=`
                ...
                <div class="dashboard-staff-view-banner-inner">
                    <div class="dashboard-staff-view-banner-profile">
                        <div class="dashboard-staff-view-avatar-wrap">
                            <img src="${Ke(W.avatar)}" alt="${D(W.name)}" class="dashboard-staff-view-avatar">
            ...
            </div>`);let Mt="";const na=Kt(E);if(e){const H=!!window.app_selectedSummaryStaffId&&window.app_selectedSummaryStaffId!==a.id,ie=ka(s),we=(O||[]).filter(de=>{const fe=String(de.appliedOn||de.actionDate||de.startDate||"").slice(0,10);return fe&&fe>=ie.startKey&&fe<=ie.endKey}).sort((de,fe)=>new Date(fe.appliedOn||fe.actionDate||fe.startDate||0)-new Date(de.appliedOn||de.actionDate||de.startDate||0)),oe=H?we.filter(de=>(de.userId||de.user_id)===m).slice(0,8):we.slice(0,8),re=Ia(oe,{title:H?`${W?.name||"Staff"} Leave History`:"Leave Request History",subtitle:H?`Current week (${ie.label}) for selected staff`:`Current week (${ie.label}) across all staff`,selectedDate:s});Mt=`
            <div class="dashboard-summary-row">
                <div style="flex: 2; min-width: 350px; display: flex; flex-direction: column;">${Ta(x)}${xn(Tt)}${re}</div>
                <div style="flex: 1; min-width: 300px; display: flex; flex-direction: column; gap: 1rem;">${na}${j}</div>
            </div>
            <div class="dashboard-stats-row">
                ${Fe(J?w.label:`${w.label} - ${W?.name||"Staff"}`,J?"Monthly Stats":"Viewing Staff Monthly Stats",w,"monthly")}
                ${Fe("Yearly Summary",J?k.label:`${k.label} for ${W?.name||"Staff"}`,k,"yearly")}
            </div>`}else Mt=`
            <div class="dashboard-summary-row">
                <div class="dashboard-summary-col dashboard-summary-col-wide">${na}</div>
                <div class="dashboard-summary-col dashboard-summary-col-narrow">${j}</div>
            </div>
            <div class="dashboard-stats-row">
                ${Fe(w.label,"Monthly Stats",w,"monthly")}
                ${Fe("Yearly Summary",k.label,k,"yearly")}
            </div>`;const Lt=window.app_getReleaseUpdateState&&window.app_getReleaseUpdateState()||{active:!1};return setTimeout(()=>kn(),0),`
        <div class="dashboard-grid dashboard-modern dashboard-staff-view">
            ...
            <div class="card full-width dashboard-hero-card">
                ...
                <button class="${Lt.active?"dashboard-refresh-link is-update-pending":"dashboard-refresh-link"}" onclick="window.app_checkForSystemUpdate()" title="${Lt.active?"Update available. Click to refresh into the new version.":"Check for System Update"}">
                    ${Lt.active?"System update available":"Check for System Update"}
                </button>
            </div>
                ...
                <div class="card check-in-widget dashboard-primary-card dashboard-checkin-card">
                    <div class="dashboard-checkin-head">
                        <div class="dashboard-checkin-avatar-wrap">
                            <img src="${Ke(C.avatar)}" alt="Profile" class="dashboard-checkin-avatar">
                            <div class="dashboard-checkin-status-dot" style="background: ${ue?"#10b981":"#94a3b8"};"></div>
                        </div>
                        <div class="dashboard-checkin-identity">
                            <h4 class="dashboard-checkin-name">${D(C.name)}</h4>
                            <p class="text-muted dashboard-checkin-role">${D(C.role)}</p>
                        </div>
                    </div>
                    ...
                    <button class="${ot} dashboard-checkin-btn" id="attendance-btn" ${R?"disabled":""} title="${R?"View only":""}">${st} <i class="fa-solid fa-fingerprint"></i></button>
                    <div class="location-text dashboard-checkin-location" id="location-text"><i class="fa-solid fa-location-dot"></i><span>${ue&&C.currentLocation?`Lat: ${Number(C.currentLocation.lat).toFixed(4)}, Lng: ${Number(C.currentLocation.lng).toFixed(4)}`:"Waiting for location..."}</span></div>
                </div>
                <div class="dashboard-primary-col ${J?"":"dashboard-primary-col-highlight"}">${Aa(g,M,W,N)}</div>
                <div class="dashboard-primary-col">${xa(V)}</div>
            </div>
            ${Mt}
        </div>`}function At(a){const[e,t]=String(a||"").split("-"),n=Number(e),i=Number(t)-1;return!Number.isInteger(n)||!Number.isInteger(i)||i<0||i>11?a||"Current Month":new Date(n,i,1).toLocaleDateString("en-US",{month:"long",year:"numeric"})}function _n(a=8){const e=[],t=new Date;t.setDate(1);for(let n=0;n<a;n++){const i=new Date(t);i.setMonth(t.getMonth()-n);const s=i.toISOString().slice(0,7);e.push({key:s,label:At(s)})}return e}function Tn(a){const e=[],t=new Map;return(a||[]).forEach(n=>{const i=(n._displayDesc||"").trim(),s=`${n.staffName||""}|${n.date||""}|${i}`;t.has(s)||(t.set(s,n),e.push(n))}),e.map(n=>{const i=window.AppCalendar?window.AppCalendar.getSmartTaskStatus(n.date,n.status||""):n.status||"to-be-started";return{...n,_taskStatus:i,_taskGroup:i==="completed"?"completed":"incomplete"}})}function In(a,e){const t=[...a],n={completed:0,"in-process":1,overdue:2,"not-completed":3,"to-be-started":4};return t.sort((i,s)=>{const o=new Date(s.date)-new Date(i.date),r=String(i.staffName||"").toLowerCase().localeCompare(String(s.staffName||"").toLowerCase());return e==="date-asc"?new Date(i.date)-new Date(s.date)||r:e==="staff-asc"?r||o:e==="staff-desc"?-r||o:e==="completed-first"?i._taskGroup.localeCompare(s._taskGroup)||o:e==="incomplete-first"?s._taskGroup.localeCompare(i._taskGroup)||o:e==="status-priority"?(n[i._taskStatus]??99)-(n[s._taskStatus]??99)||o||r:o||r}),t}function Mn(a){if(!a)return;const e=Ne.controllers.get(a);e&&(e.intervalId&&clearInterval(e.intervalId),e.pauseTimeoutId&&clearTimeout(e.pauseTimeoutId),e.resumeTimeoutId&&clearTimeout(e.resumeTimeoutId),a.removeEventListener("mouseenter",e.onMouseEnter),a.removeEventListener("mouseleave",e.onMouseLeave),a.removeEventListener("touchstart",e.onTouchStart),a.removeEventListener("touchend",e.onTouchEnd),a.removeEventListener("touchcancel",e.onTouchCancel),Ne.controllers.delete(a),Ne.elements.delete(a))}function Ea(){Array.from(Ne.elements).forEach(a=>Mn(a))}function Ca(a){if(!a)return;Ea(),a.querySelectorAll(".dashboard-team-activity-col-list").forEach(t=>{const n={intervalId:null,pauseTimeoutId:null,resumeTimeoutId:null,direction:1,isPausedByUser:!1,isWaitingAtEdge:!1},i=(o,r)=>{n.isWaitingAtEdge=!0,n.pauseTimeoutId&&clearTimeout(n.pauseTimeoutId),n.pauseTimeoutId=setTimeout(()=>{n.direction=o,n.isWaitingAtEdge=!1},r)},s=()=>{if(n.isPausedByUser||n.isWaitingAtEdge||!t.isConnected)return;const o=Math.max(0,t.scrollHeight-t.clientHeight);o<=0||(t.scrollTop+=n.direction,n.direction===1&&t.scrollTop>=o?(t.scrollTop=o,i(-1,1500)):n.direction===-1&&t.scrollTop<=0&&(t.scrollTop=0,i(1,1e3)))};n.onMouseEnter=()=>{n.isPausedByUser=!0},n.onMouseLeave=()=>{n.isPausedByUser=!1},n.onTouchStart=()=>{n.isPausedByUser=!0,n.resumeTimeoutId&&clearTimeout(n.resumeTimeoutId)},n.onTouchEnd=()=>{n.resumeTimeoutId&&clearTimeout(n.resumeTimeoutId),n.resumeTimeoutId=setTimeout(()=>{n.isPausedByUser=!1},400)},t.addEventListener("mouseenter",n.onMouseEnter),t.addEventListener("mouseleave",n.onMouseLeave),t.addEventListener("touchstart",n.onTouchStart,{passive:!0}),t.addEventListener("touchend",n.onTouchEnd,{passive:!0}),n.intervalId=setInterval(s,50),Ne.controllers.set(t,n),Ne.elements.add(t)})}const Ln=async(a=!0)=>{const e=Ge(),t=document.getElementById("staff-activity-list"),n=document.getElementById("staff-activity-list-modal");if(!t&&!n)return;Ea(),a&&window.AppAnalytics&&(e.logs=await window.AppAnalytics.getAllStaffActivities({mode:"month",month:e.selectedMonth,scope:"work"}));const i=St(e.logs,e.sortKey);t&&(t.innerHTML=i,Ca(t)),n&&(n.innerHTML=i);const s=document.getElementById("staff-activity-range-label");s&&(s.textContent=At(e.selectedMonth))};typeof window<"u"&&(window.app_setDashboardLeaveHistoryDate=async function(a){const e=Ge();e.leaveHistoryDate=a||new Date().toISOString().slice(0,10);const t=document.getElementById("page-content");t&&(t.innerHTML=await kt())},window.app_expandTeamActivity=function(){window.app_closeTeamActivityExpanded&&window.app_closeTeamActivityExpanded(),window.location&&(window.location.hash="#team-activities")},window.app_openStatsDetailModal=function(a){const e=window.app_dashboardStatsStore||{},t=a==="yearly"?e.yearly:e.monthly;if(!t)return;const n=a==="yearly"?e.yearlyTitle:e.monthlyTitle,i=a==="yearly"?e.yearlySubtitle:e.monthlySubtitle,s=t.breakdown||{},o=e.ranges?a==="yearly"?e.ranges.yearly:e.ranges.monthly:null,r=Dn(e.logs||[],o),d=Object.entries(s).filter(([,m])=>Number(m||0)>0),l=document.getElementById("dashboard-stats-modal");l&&l.remove();const c=document.createElement("div");c.id="dashboard-stats-modal",c.className="modal-overlay dashboard-stats-modal",c.innerHTML=`
            <div class="modal-content dashboard-stats-modal-content">
                <div class="dashboard-stats-modal-head">
                    <div>
                        <div class="dashboard-stats-modal-title">${D(n||"Attendance Summary")}</div>
                        <div class="dashboard-stats-modal-sub">${D(i||"")}</div>
                    </div>
                ...
                <div class="dashboard-stats-modal-grid">
                    <div class="dashboard-stats-modal-tile" data-stat-detail="late" role="button" tabindex="0">
                        ...
                        <span class="value">${D(t.late??0)}</span>
                        <span class="hint">Total late entries</span>
                    </div>
                    <div class="dashboard-stats-modal-tile" data-stat-detail="late" role="button" tabindex="0">
                        <span class="label">Late Duration</span>
                        <span class="value">${D(t.totalLateDuration||"0h 0m")}</span>
                    ...
                    <div class="dashboard-stats-modal-tile" data-stat-detail="early" role="button" tabindex="0">
                        ...
                        <span class="value">${D(t.earlyDepartures??0)}</span>
                    ...
                    <div class="dashboard-stats-modal-tile highlight" data-stat-detail="late" role="button" tabindex="0">
                        ...
                        <span class="value">${D(t.effectivePenalty??0)}</span>
                ...
                <div class="dashboard-stats-modal-section">
                    ...
                    <div class="dashboard-stats-modal-breakdown">
                        ${(d.length?d:[["No data",0]]).map(([m,u])=>`
                            <div class="dashboard-stats-modal-row" data-breakdown-key="${D(m)}" role="button" tabindex="0">
                                <span>${D(m)}</span>
                                <strong>${D(u)}</strong>
                            </div>
                        `).join("")}
        ...
        `,document.body.appendChild(c),document.body.style.overflow="hidden",window._dashboardStatsDetailData={type:a,buckets:r};const p=r.late.length?"late":r.early.length?"early":r.extra.length?"extra":"Present";window.app_updateStatsDetailView(p),c.addEventListener("click",m=>{const u=m.target.closest("[data-stat-detail]");if(u){window.app_updateStatsDetailView(u.getAttribute("data-stat-detail"));return}const y=m.target.closest("[data-breakdown-key]");y&&window.app_updateStatsDetailView(y.getAttribute("data-breakdown-key"))}),c.addEventListener("keydown",m=>{if(m.key!=="Enter"&&m.key!==" ")return;const u=m.target.closest("[data-stat-detail]"),y=m.target.closest("[data-breakdown-key]");(u||y)&&(m.preventDefault(),window.app_updateStatsDetailView(u?u.getAttribute("data-stat-detail"):y.getAttribute("data-breakdown-key")))}),c.addEventListener("click",m=>{m.target===c&&window.app_closeStatsDetailModal()}),window._dashboardStatsEscHandler=m=>{m.key==="Escape"&&window.app_closeStatsDetailModal()},window.addEventListener("keydown",window._dashboardStatsEscHandler)},window.app_closeStatsDetailModal=function(){const a=document.getElementById("dashboard-stats-modal");a&&a.remove(),document.body.style.overflow="",window._dashboardStatsDetailData=null,window._dashboardStatsEscHandler&&(window.removeEventListener("keydown",window._dashboardStatsEscHandler),window._dashboardStatsEscHandler=null)},window.app_updateStatsDetailView=function(a){const t=(window._dashboardStatsDetailData||{}).buckets||{};let n="",i=[];a==="late"?(n="Late Dates",i=t.late||[]):a==="early"?(n="Early Departure Dates",i=t.early||[]):a==="extra"?(n="Extra Hours Dates",i=t.extra||[]):t.breakdown&&Object.prototype.hasOwnProperty.call(t.breakdown,a)?(n=`${a} Dates`,i=t.breakdown[a]||[]):(n="Details",i=[]);const s=document.getElementById("dashboard-stats-detail-title"),o=document.getElementById("dashboard-stats-date-list");s&&(s.textContent=n),o&&(o.innerHTML=i.length?i.map(r=>`<div class="dashboard-stats-date-item">${D(r)}</div>`).join(""):'<div class="dashboard-stats-date-empty">No dates available.</div>'),document.querySelectorAll(".dashboard-stats-modal-tile, .dashboard-stats-modal-row").forEach(r=>{const d=r.getAttribute("data-stat-detail"),l=r.getAttribute("data-breakdown-key");r.classList.toggle("is-active",d&&d===a||l&&l===a)})},window.app_attachStatsCardHandlers=function(){An()},window.app_expandTeamActivityRefresh=function(){const a=Ge(),e=document.getElementById("staff-activity-list-modal"),t=document.getElementById("staff-activity-range-label-modal");e&&(e.innerHTML=St(a.logs,a.sortKey)),t&&(t.textContent=At(a.selectedMonth))},window.app_closeTeamActivityExpanded=function(){const a=document.getElementById("team-activity-modal-overlay");a&&(a.remove(),document.body.style.overflow="",window.removeEventListener("keydown",window._teamActivityEscHandler))});async function En(){const a=window.AppAuth.getUser(),e=window.AppDB.getCached?await window.AppDB.getCached(window.AppDB.getCacheKey("staffUsers","users",{}),L?.READ_CACHE_TTLS?.users||6e4,()=>window.AppDB.getAll("users")):await window.AppDB.getAll("users"),t=window.app_getMyMessages?await window.app_getMyMessages():await window.AppDB.getAll("staff_messages"),n=e.filter(u=>u.id!==a.id).sort((u,y)=>u.name.localeCompare(y.name));!window.app_staffThreadId&&n.length>0&&(window.app_staffThreadId=n[0].id);const i=e.find(u=>u.id===window.app_staffThreadId),s=u=>D(u).replace(/(https?:\/\/[^\s]+)/g,'<a href="$1" target="_blank" rel="noopener noreferrer">$1</a>'),o=t.filter(u=>u.fromId===a.id&&u.toId===window.app_staffThreadId||u.fromId===window.app_staffThreadId&&u.toId===a.id).sort((u,y)=>new Date(u.createdAt||0)-new Date(y.createdAt||0)),r=o.filter(u=>u.type==="text"),d=o.filter(u=>u.type==="task"),l={};t.forEach(u=>{u.toId===a.id&&!u.read&&(l[u.fromId]=(l[u.fromId]||0)+1)});const c=n.map(u=>{const y=l[u.id]||0;return`
            <button class="staff-directory-item ${u.id===window.app_staffThreadId?"active":""}" onclick="window.app_openStaffThread('${u.id}')">
                <div class="staff-directory-avatar">
                    <img src="${u.avatar}" alt="${D(u.name)}">
                </div>
                <div class="staff-directory-info">
                    <div class="staff-directory-name">${D(u.name)}</div>
                    <div class="staff-directory-role">${D(u.role||"Staff")}</div>
                </div>
        ...
        <div class="staff-message ${u.fromId===a.id?"outgoing":"incoming"}">
            <div class="staff-message-meta">${D(u.fromName)} • ${new Date(u.createdAt).toLocaleString()}</div>
    ...
    `).join(""):'<div class="staff-message-empty">No messages yet.</div>':'<div class="staff-message-empty">Select a staff member to view messages.</div>',m=i?d.length?d.map(u=>`
        <div class="staff-task-card">
            <div class="staff-task-head">
                <div>
                    <div class="staff-task-title">${D(u.title||"Task")}</div>
                    <div class="staff-task-meta">From ${D(u.fromName)} • Due ${u.dueDate||"No date"}</div>
                </div>
                <span class="staff-task-status ${u.status||"pending"}">${(u.status||"pending").toUpperCase()}</span>
            </div>
            <div class="staff-task-desc">${D(u.description||"")}</div>
            ...
            `:""}
            ${u.rejectReason?`<div class="staff-task-reason">Reason: ${D(u.rejectReason)}</div>`:""}
        </div>
        ...
        <div class="staff-directory-page">
            ...
            <section class="staff-thread-panel">
                <div class="staff-thread-head">
                    <div>
                        <h3>${i?D(i.name):"Select a staff member"}</h3>
                        <span>${i?D(i.role||"Staff"):""}</span>
                    </div>
                    <div class="staff-thread-actions">
                        <button class="staff-thread-action-btn" ${i?"":"disabled"} onclick="window.app_openStaffMessageModal('${i?i.id:""}', '${i?D(i.name):""}')">
                            <i class="fa-solid fa-message"></i> Send Message
                        </button>
                        <button class="staff-thread-action-btn secondary" ${i?"":"disabled"} onclick="window.app_openStaffTaskModal('${i?i.id:""}', '${i?D(i.name):""}')">
    ...
    `}let oa=!1;function Cn(){oa||typeof document>"u"||(oa=!0,document.addEventListener("click",a=>{const e=a.target.closest("[data-annual-open-day]");if(e){window.app_openAnnualDayPlan?.(e.dataset.annualOpenDay);return}const t=a.target.closest("[data-annual-view]");if(t){window.app_toggleAnnualView?.(t.dataset.annualView);return}if(a.target.closest("[data-annual-jump-today]")){window.app_jumpToAnnualToday?.();return}const i=a.target.closest("[data-annual-year-delta]");if(i){window.app_changeAnnualYear?.(Number(i.dataset.annualYearDelta||0));return}const s=a.target.closest("[data-annual-legend]");if(s){window.app_toggleAnnualLegendFilter?.(s.dataset.annualLegend);return}a.target.closest("[data-annual-export]")&&window.AppReports?.exportAnnualListViewCSV?.(window._annualListItems||[])}),document.addEventListener("input",a=>{const e=a.target.closest("[data-annual-staff-filter]");e&&window.app_setAnnualStaffFilter?.(e.value)}),document.addEventListener("change",a=>{const e=a.target.closest("[data-annual-list-sort]");e&&window.app_setAnnualListSort?.(e.value)}),document.addEventListener("keydown",a=>{const e=a.target.closest("[data-annual-list-search]");e&&a.key==="Enter"&&window.app_setAnnualListSearch?.(e.value)}),document.addEventListener("mouseover",a=>{const e=a.target.closest("[data-annual-preview-date]");!e||e.contains(a.relatedTarget)||window.app_showAnnualHoverPreview?.(a,e.dataset.annualPreviewDate)}),document.addEventListener("mouseout",a=>{const e=a.target.closest("[data-annual-preview-date]");!e||e.contains(a.relatedTarget)||window.app_hideAnnualHoverPreview?.()}))}async function He(){typeof window.app_setAnnualStaffFilter!="function"&&(window.app_setAnnualStaffFilter=async I=>{window.app_annualStaffFilter=String(I||"").trim();const N=document.getElementById("page-content");N&&(N.innerHTML=await He())}),typeof window.app_toggleAnnualView!="function"&&(window.app_toggleAnnualView=async I=>{window.app_annualViewMode=I;const N=document.getElementById("page-content");N&&(N.innerHTML=await He())}),typeof window.app_setAnnualListSearch!="function"&&(window.app_setAnnualListSearch=async I=>{window.app_annualListSearch=String(I||"").trim();const N=document.getElementById("page-content");N&&(N.innerHTML=await He())}),typeof window.app_setAnnualListSort!="function"&&(window.app_setAnnualListSort=async I=>{window.app_annualListSort=String(I||"date-asc").trim();const N=document.getElementById("page-content");N&&(N.innerHTML=await He())});const a=new Date,e=`${a.getFullYear()}-${String(a.getMonth()+1).padStart(2,"0")}-${String(a.getDate()).padStart(2,"0")}`,t=window.app_annualYear||a.getFullYear(),n=await window.AppCalendar.getPlans(),i=await window.AppDB.getAll("users").catch(()=>[]),s=`${t}-01-01`,o=`${t}-12-31`,r=await(window.AppDB.queryMany?window.AppDB.queryMany("attendance",[{field:"date",operator:">=",value:s},{field:"date",operator:"<=",value:o}]).catch(()=>window.AppDB.getAll("attendance")):window.AppDB.getAll("attendance")).catch(()=>[]);window._currentPlans=n;const d=["January","February","March","April","May","June","July","August","September","October","November","December"],l={};(i||[]).forEach(I=>{l[I.id]=I.name}),window._annualUserMap=l;const c=(I,N)=>l[I]||N||"Staff",p=window.app_annualLegendFilters||{leave:!0,event:!0,work:!0,overdue:!0,completed:!0};window.app_annualLegendFilters=p;let m=window.app_selectedAnnualDate||(t===a.getFullYear()?e:null);m=m?String(m):null,m&&!m.startsWith(`${t}-`)&&(m=null),window.app_selectedAnnualDate=m;const u=String(window.app_annualStaffFilter||"").trim(),y=u.toLowerCase(),h=String(window.app_annualListSearch||"").trim(),f=h.toLowerCase(),S=String(window.app_annualListSort||"date-asc"),_=(i||[]).map(I=>`<option value="${D(I.name)}"></option>`).join(""),b=I=>y?String(I||"").toLowerCase().includes(y):!0,$={january:0,february:1,march:2,april:3,may:4,june:5,july:6,august:7,september:8,october:9,november:10,december:11},g=(I="")=>{const N=String(I||"").trim();if(!N)return null;const P=N.match(/(\d{1,2})\s*-\s*(\d{1,2})\s+([A-Za-z]+)\s+(\d{4})/);if(!P)return null;const B=Number(P[1]),U=Number(P[2]),V=String(P[3]||"").toLowerCase(),j=Number(P[4]),W=$[V];if(!Number.isInteger(B)||!Number.isInteger(U)||!Number.isInteger(W)||!Number.isInteger(j))return null;const J=new Date(j,W,B),C=new Date(j,W,U);if(Number.isNaN(J.getTime())||Number.isNaN(C.getTime()))return null;const R=`${J.getFullYear()}-${String(J.getMonth()+1).padStart(2,"0")}-${String(J.getDate()).padStart(2,"0")}`,G=`${C.getFullYear()}-${String(C.getMonth()+1).padStart(2,"0")}-${String(C.getDate()).padStart(2,"0")}`;return G<R?null:{startDate:R,endDate:G}},w=(I,N)=>{const P=!I?.startDate&&!I?.endDate?g(I?.task||""):null,B=I?.startDate||P?.startDate||N,U=I?.endDate||P?.endDate||I?.startDate||N;return{startDate:B,endDate:U}},k=(I,N,P)=>{const{startDate:B,endDate:U}=w(I,N);return!B||!U?N===P:!(P<B||P>U||I?.completedDate&&I.completedDate<P)},T=(n.workPlans||[]).filter(I=>{if((I.planScope||"personal")==="annual"){if(!y)return!0;const B=c(I.userId,I.userName);return b(B)?!0:(I.plans||[]).some(U=>{const V=c(U.assignedTo||I.userId,B),j=(U.tags||[]).map(W=>W.name||W).join(" ");return b(V)||b(j)})}if(!y)return!0;const P=c(I.userId,I.userName);return b(P)?!0:(I.plans||[]).some(B=>{const U=c(B.assignedTo||I.userId,P),V=(B.tags||[]).map(j=>j.name||j).join(" ");return b(U)||b(V)})}),E=(n.leaves||[]).filter(I=>b(c(I.userId,I.userName))),v=(r||[]).filter(I=>{if(!String(I.date||"").startsWith(String(t)))return!1;const P=I.user_id||I.userId,B=c(P,"");return y?b(B):!0}),x=(I,N,P)=>{const B=`${P}-${String(N+1).padStart(2,"0")}-${String(I).padStart(2,"0")}`,U=E.some(R=>B>=R.startDate&&B<=R.endDate),V=!y&&(n.events||[]).some(R=>R.date===B),j=v.some(R=>R.date===B),W=T.some(R=>!Array.isArray(R.plans)||!R.plans.length?R.date===B:R.plans.some(G=>k(G,R.date,B)))||j;let J="",C=!1;if(W){const R=T.filter(q=>!Array.isArray(q.plans)||!q.plans.length?q.date===B:q.plans.some(X=>k(X,q.date,B)));let G="to-be-started";R.forEach(q=>{(q.plans||[]).forEach(X=>{if(!k(X,q.date,B))return;const{startDate:ee,endDate:ne}=w(X,q.date);ee&&ne&&ee!==ne&&ne===B&&(C=!0);const ue=X.completedDate||ne||q.date||B,me=window.AppCalendar?window.AppCalendar.getSmartTaskStatus(ue,X.status):X.status||"pending";me==="overdue"?G="overdue":me==="in-process"&&G!=="overdue"?G="in-process":me==="completed"&&G!=="overdue"&&G!=="in-process"&&(G="completed")})}),j&&G==="to-be-started"&&(G="completed"),J=G}return{hasLeave:U,hasEvent:V,hasWork:W,workStatus:J,hasRangeEnd:C}};let A="";for(let I=0;I<12;I++){const N=new Date(t,I,1).getDay(),P=new Date(t,I+1,0).getDate();let B="";for(let U=0;U<N;U++)B+='<div class="annual-day empty"></div>';for(let U=1;U<=P;U++){const V=x(U,I,t),j=U===a.getDate()&&I===a.getMonth()&&t===a.getFullYear(),W=`${t}-${String(I+1).padStart(2,"0")}-${String(U).padStart(2,"0")}`,J=V.hasLeave&&p.leave,C=V.hasEvent&&p.event,R=V.hasWork&&p.work&&(V.workStatus==="overdue"?p.overdue:V.workStatus==="completed"?p.completed:!0),G=J||C||R,q=R?`has-work work-${V.workStatus}`:"";B+=`
                <div class="annual-day ${j?"today":""} ${q} ${m===W?"selected":""} ${G?"":"annual-day-muted"}" data-annual-open-day="${W}" data-annual-preview-date="${W}">
                    ...
                    <div class="dot-container">
                        ...
                        ${C?'<span class="status-dot dot-event"></span>':""}
                        ${R?'<span class="status-dot dot-work"></span>':""}
            ...
            </div>`}const M=window.app_annualViewMode||"grid",O=(()=>{const I=[],N=new Set,P=C=>{if(!C)return"";const R=String(C).replace(/_/g,"-").toLowerCase();return{"in-process":"In Process","to-be-started":"To Be Started","not-completed":"Not Completed",completed:"Completed",overdue:"Overdue",pending:"Pending",approved:"Approved",holiday:"Holiday",event:"Event"}[R]||R.replace(/\b\w/g,q=>q.toUpperCase())},B=(C,R)=>R||(window.AppCalendar&&C?window.AppCalendar.getSmartTaskStatus(C,R):"pending");if(!y&&window.AppAnalytics){const C=new Date(t,0,1),R=new Date(t,11,31);for(let G=new Date(C);G<=R;G.setDate(G.getDate()+1)){const q=G.toISOString().split("T")[0],X=window.AppAnalytics.getDayType(G);X==="Holiday"?I.push({date:q,type:"holiday",title:"Company Holiday (Weekend)",staffName:"All Staff",assignedBy:"System",assignedTo:"All Staff",selfAssigned:!1,dueDate:q,status:"holiday",comments:"",scope:"Shared"}):X==="Half Day"&&I.push({date:q,type:"event",title:"Half Working Day (Sat)",staffName:"All Staff",assignedBy:"System",assignedTo:"All Staff",selfAssigned:!1,dueDate:q,status:"event",comments:"",scope:"Shared"})}}E.forEach(C=>{const R=new Date(C.startDate),G=new Date(C.endDate||C.startDate),q=c(C.userId,C.userName);for(let X=new Date(R);X<=G;X.setDate(X.getDate()+1)){const ee=X.toISOString().split("T")[0];ee.startsWith(String(t))&&I.push({date:ee,type:"leave",title:`${q} (${C.type||"Leave"})`,staffName:q,assignedBy:q,assignedTo:q,selfAssigned:!0,dueDate:C.endDate||C.startDate||ee,status:(C.status||"approved").toLowerCase(),comments:C.reason||"",scope:"Personal"})}}),(n.events||[]).forEach(C=>{if(!y&&String(C.date||"").startsWith(String(t))){const R=[String(C.date||"").trim(),String(C.title||"").trim().toLowerCase(),String(C.type||"event").trim().toLowerCase(),String(C.createdById||C.createdByName||"").trim().toLowerCase()].join("|");if(N.has(R))return;N.add(R),I.push({date:C.date,type:C.type||"event",title:C.title||"Company Event",staffName:"All Staff",assignedBy:C.createdByName||"Admin",assignedTo:"All Staff",selfAssigned:!1,dueDate:C.date,status:"event",comments:C.description||"",scope:"Shared"})}}),T.forEach(C=>{if(String(C.date||"").startsWith(String(t))){const R=(C.planScope||"personal")==="annual",G=c(C.userId,C.userName)||(R?"All Staff":"Staff"),q=R?"Annual":"Personal",X=C.date;C.plans&&C.plans.length>0&&C.plans.forEach(ee=>{const ne=R?C.createdByName||ee.taggedByName||"Admin":ee.taggedByName||G,ue=ee.assignedTo||C.userId,me=R?ne:c(ue,G),_t=(ee.tags||[]).map(rt=>rt.name||rt).filter(Boolean),{startDate:Tt,endDate:Ue}=w(ee,X),st=ee.completedDate||Ue||X,ot=B(st,ee.status),It=ee.subPlans&&ee.subPlans.length?ee.subPlans.join("; "):ee.comment||ee.notes||"";I.push({date:Tt||X,type:"work",title:ee.task||"Work Plan Task",staffName:R?ne:me,assignedBy:ne,assignedTo:R?ne:me,selfAssigned:ne===me,dueDate:ee.dueDate||Ue||X,status:ot,comments:It,tags:_t,scope:q})})}}),v.forEach(C=>{const R=C.user_id||C.userId,G=c(R,"Staff"),q=(C.workDescription||C.location||"").trim()||"Manual log entry";I.push({date:C.date,type:"work",title:q,staffName:G,assignedBy:G,assignedTo:G,selfAssigned:!0,dueDate:C.date,status:"completed",comments:q,tags:["Manual Log"],scope:"Personal"})});const U=[],V=new Set;I.forEach(C=>{const R=`${C.date||""}|${C.type||""}|${C.title||""}|${C.staffName||""}|${C.status||""}`.toLowerCase();V.has(R)||(V.add(R),U.push(C))}),U.sort((C,R)=>C.date.localeCompare(R.date)||C.type.localeCompare(R.type)),U.forEach(C=>{C.statusLabel=P(C.status),C.statusClass=String(C.status||"pending").replace(/[^a-z0-9]+/gi,"-").toLowerCase()});let j=f?U.filter(C=>[C.date,C.staffName,C.title,C.statusLabel,C.comments].join(" ").toLowerCase().includes(f)):U;const W={"date-asc":(C,R)=>String(C.date||"").localeCompare(String(R.date||"")),"date-desc":(C,R)=>String(R.date||"").localeCompare(String(C.date||"")),"staff-asc":(C,R)=>String(C.staffName||"").localeCompare(String(R.staffName||"")),"staff-desc":(C,R)=>String(R.staffName||"").localeCompare(String(C.staffName||"")),"status-asc":(C,R)=>String(C.statusLabel||"").localeCompare(String(R.statusLabel||"")),"status-desc":(C,R)=>String(R.statusLabel||"").localeCompare(String(C.statusLabel||""))},J=W[S]||W["date-asc"];return j.slice().sort(J)})();return window._annualListItems=O,setTimeout(()=>Cn(),0),`
        <div class="annual-plan-shell annual-v2-shell">
            <div class="card annual-plan-header annual-v2-header">
                ...
                <div class="annual-plan-controls annual-v2-controls">
                    <div class="annual-staff-filter annual-v2-staff-filter">
                        ...
                        <input type="text" list="annual-staff-names" value="${D(u)}" placeholder="Filter by staff name" data-annual-staff-filter="1">
                    ...
                    <div class="annual-list-head annual-v2-list-head">
                        ...
                        <div class="annual-list-actions annual-v2-list-actions">
                            <div class="annual-list-search-wrap annual-v2-search-wrap">
                                ...
                                <input type="text" value="${D(h)}" placeholder="Search list..." data-annual-list-search="1">
                            </div>
                            ...
                            <div class="annual-list-table">
                                ...
                                ${O.map(I=>`
                                    <div class="annual-list-row">
                                        ...
                                        <div class="annual-list-cell">${D(I.staffName)}</div>
                                        <div class="annual-list-cell annual-list-task">${D(I.title)}</div>
                                        <div class="annual-list-cell">${D(I.assignedBy)}</div>
                                        <div class="annual-list-cell"><span class="annual-list-status status-${I.statusClass}">${I.statusLabel}</span></div>
                                        <div class="annual-list-cell annual-list-comments">${D(I.comments||"--")}</div>
        ...
        </div>`}let ra=!1;function Pn(){ra||typeof document>"u"||(ra=!0,document.addEventListener("click",a=>{const e=a.target.closest("[data-timesheet-open-day]");if(e){window.app_openTimesheetDayDetail?.(e.dataset.timesheetOpenDay);return}if(a.target.closest("[data-timesheet-request-leave]")){const c=document.getElementById("leave-modal");c&&(c.style.display="flex");return}if(a.target.closest("[data-timesheet-manual-log]")){document.dispatchEvent(new CustomEvent("open-log-modal"));return}const i=a.target.closest("[data-timesheet-month-delta]");if(i){window.app_changeTimesheetMonth?.(Number(i.dataset.timesheetMonthDelta||0));return}if(a.target.closest("[data-timesheet-today]")){window.app_jumpTimesheetToday?.();return}const o=a.target.closest("[data-timesheet-export]");if(o){window.AppReports?.exportUserLogs?.(o.dataset.timesheetExportUser||"");return}const r=a.target.closest("[data-timesheet-edit-log]");if(r){window.app_editWorkSummary?.(r.dataset.timesheetEditLog);return}const d=a.target.closest("[data-timesheet-detail-log]");if(d){const c=d.dataset.timesheetDetailLog;alert("Detailed analysis for log "+c+" coming soon!");return}const l=a.target.closest("[data-timesheet-close-modal]");l&&l.closest(".modal-overlay")?.remove()}),document.addEventListener("change",a=>{const e=a.target.closest("[data-timesheet-view-select]");e&&window.app_toggleTimesheetViewSelect?.(e.value)}))}async function qe(){setTimeout(()=>Pn(),0),typeof window.app_setTimesheetView!="function"&&(window.app_setTimesheetView=async g=>{window.app_timesheetViewMode=g==="calendar"?"calendar":"list";const w=document.getElementById("page-content");w&&(w.innerHTML=await qe())}),typeof window.app_changeTimesheetMonth!="function"&&(window.app_changeTimesheetMonth=async g=>{const w=new Date,k=Number.isInteger(window.app_timesheetMonth)?window.app_timesheetMonth:w.getMonth(),T=Number.isInteger(window.app_timesheetYear)?window.app_timesheetYear:w.getFullYear(),E=new Date(T,k,1);E.setMonth(E.getMonth()+g),window.app_timesheetMonth=E.getMonth(),window.app_timesheetYear=E.getFullYear();const v=document.getElementById("page-content");v&&(v.innerHTML=await qe())}),typeof window.app_jumpTimesheetToday!="function"&&(window.app_jumpTimesheetToday=async()=>{const g=new Date;window.app_timesheetMonth=g.getMonth(),window.app_timesheetYear=g.getFullYear();const w=document.getElementById("page-content");w&&(w.innerHTML=await qe())});const a=window.AppAuth.getUser(),e=await window.AppAttendance.getLogs(),t=await window.AppCalendar.getPlans().catch(()=>({workPlans:[]})),n=new Date,i=window.app_timesheetViewMode||"list",s=Number.isInteger(window.app_timesheetMonth)?window.app_timesheetMonth:n.getMonth(),o=Number.isInteger(window.app_timesheetYear)?window.app_timesheetYear:n.getFullYear(),r=new Date(o,s,1).toLocaleString("en-US",{month:"long",year:"numeric"}),d=`${o}-${String(s+1).padStart(2,"0")}-01`,l=`${o}-${String(s+1).padStart(2,"0")}-31`,c=e.filter(g=>g.date&&g.date>=d&&g.date<=l),p=(t.workPlans||[]).filter(g=>g.userId===a.id&&g.date&&g.date>=d&&g.date<=l),m={};c.forEach(g=>{m[g.date]||(m[g.date]=[]),m[g.date].push(g)});const u={};p.forEach(g=>{u[g.date]||(u[g.date]=[]),(Array.isArray(g.plans)?g.plans:[]).forEach(k=>{u[g.date].push(k.task||"Planned task")})}),window._timesheetLogsByDate=m,window._timesheetPlansByDate=u;let y=0,h=0;const f=new Set;c.forEach(g=>{g.durationMs&&(y+=g.durationMs/(1e3*60)),(g.lateCountable||window.AppAttendance&&window.AppAttendance.normalizeType(g.type)==="Late")&&h++,g.date&&f.add(g.date)});const S=`${Math.floor(y/60)}h ${Math.round(y%60)}m`,_=Math.floor(h/(L?.LATE_GRACE_COUNT||3))*(L?.LATE_DEDUCTION_PER_BLOCK||.5),b=g=>window.AppAttendance&&window.AppAttendance.normalizeType?window.AppAttendance.normalizeType(g):g;window.app_editWorkSummary=async g=>{const k=(await window.AppAttendance.getLogs()).find(v=>v.id===g),T=k?k.workDescription:"",E=await window.appPrompt("Update Work Summary:",T||"",{title:"Update Work Summary",confirmText:"Save"});if(E!==null){await window.AppAttendance.updateLog(g,{workDescription:E});const v=document.getElementById("page-content");v&&(v.innerHTML=await qe())}},window.app_switchTimesheetPanel=(g,w)=>{const k=g==="calendar"?"calendar":"list";window.app_timesheetViewMode=k;const T=document.getElementById("timesheet-list-panel"),E=document.getElementById("timesheet-calendar-panel"),v=document.getElementById("timesheet-view-select");T&&(T.style.display=k==="list"?"block":"none"),E&&(E.style.display=k==="calendar"?"block":"none"),v&&(v.value=k);const x=w&&w.closest?w.closest(".timesheet-view-toggle"):null;(x?x.querySelectorAll(".annual-toggle-btn"):[]).forEach(M=>M.classList.remove("active")),w&&w.classList&&w.classList.add("active")},window.app_openTimesheetDayDetail=g=>{const w=window._timesheetLogsByDate&&window._timesheetLogsByDate[g]||[],k=window._timesheetPlansByDate&&window._timesheetPlansByDate[g]||[],T=w.length?w.map(A=>`
                <div class="timesheet-day-detail-item">
                    <div class="timesheet-day-detail-head">
                        <span>${D(A.checkIn||"--")} - ${D(A.checkOut||"--")}</span>
                        <span class="timesheet-day-status-chip">${D(b(A.type))}</span>
                    </div>
                    <div class="timesheet-day-detail-text">${D(A.workDescription||A.location||"No summary")}</div>
                    ${A.id&&A.id!=="active_now"?`<button type="button" class="action-btn secondary" data-timesheet-edit-log="${A.id}">Edit</button>`:""}
                </div>
            `).join(""):'<div class="timesheet-day-detail-empty">No attendance logs for this date.</div>',E=k.length?k.map(A=>`<div class="timesheet-day-plan-item">${D(A)}</div>`).join(""):'<div class="timesheet-day-detail-empty">No planned tasks for this date.</div>',v=`timesheet-day-detail-${Date.now()}`,x=`
            <div class="modal-overlay" id="${v}" style="display:flex;">
                <div class="modal-content" style="max-width:560px;">
                    <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:0.75rem;">
                        <h3 style="margin:0;">${D(g)} Details</h3>
            ...
            </div>`;typeof window.app_showModal=="function"?window.app_showModal(x,v):(document.getElementById("modal-container")||document.body).insertAdjacentHTML("beforeend",x)};const $=()=>{const g=new Date(o,s,1).getDay(),w=new Date(o,s+1,0).getDate();let k="";for(let T=0;T<g;T++)k+='<div class="timesheet-cal-day empty"></div>';for(let T=1;T<=w;T++){const E=`${o}-${String(s+1).padStart(2,"0")}-${String(T).padStart(2,"0")}`,v=m[E]||[],x=v.length?v.slice().sort((U,V)=>{const j=W=>{const J=b(W.type);return J==="Absent"?4:J==="Half Day"?3:J==="Late"?2:J==="Present (Late Waived)"?1:0};return j(V)-j(U)})[0]:null,A=u[E]||[],M=E===new Date().toISOString().split("T")[0],O=x?b(x.type):"",I=x?O==="Absent"?"absent":O==="Half Day"||O==="Late"?"late":"present":"none",N=x?O:"No log",P=v.map(U=>(U.workDescription||U.location||"").trim()).filter(Boolean),B=P.length?P.slice(0,2).map(U=>`<div class="timesheet-cal-plan">${D(U)}</div>`).join("")+(P.length>2?`<div class="timesheet-cal-more">+${P.length-2} more logs</div>`:""):A.length?A.slice(0,2).map(U=>`<div class="timesheet-cal-plan">${D(U)}</div>`).join("")+(A.length>2?`<div class="timesheet-cal-more">+${A.length-2} more</div>`:""):'<div class="timesheet-cal-empty">No plans</div>';k+=`
                <div class="timesheet-cal-day ${M?"today":""}" data-timesheet-open-day="${E}" style="cursor:pointer;">
            ...
            <div class="timesheet-calendar-wrap">
                ...
                <div class="timesheet-calendar-grid">${k}</div>
            </div>`};return`
                            ...
                            <tr>
                                ...
                                <td data-label="Status">
                                    <div class="timesheet-status-col">
                                        <span class="badge" style="background:${b(g.type)==="Absent"?"#fef2f2":b(g.type)==="Half Day"||b(g.type)==="Late"?"#fff7ed":"#f0fdf4"}; color:${b(g.type)==="Absent"?"#991b1b":b(g.type)==="Half Day"||b(g.type)==="Late"?"#c2410c":"#15803d"}; border:1px solid ${b(g.type)==="Absent"?"#fecaca":b(g.type)==="Half Day"||b(g.type)==="Late"?"#fed7aa":"#dcfce7"};">${b(g.type)}</span>
                                ...
                                <td data-label="Work Summary" class="timesheet-summary-cell">
                                    <div class="timesheet-summary-wrap">
                                        <div class="dashboard-viewing-meta">
                                            <div class="timesheet-summary-text">${D(g.workDescription)||'<span class="timesheet-empty-summary">No summary provided</span>'}</div>
                                            ${g.location?`<div class="timesheet-location"><i class="fa-solid fa-location-dot"></i> ${D(g.location)}</div>`:""}
                                        </div>
    ...
    `}async function Pa(){try{const a=window.AppAuth.getUser();if(!a)return'<div class="card">User state lost. Please <a href="#" onclick="window.AppAuth.logout()">Login Again</a></div>';const e=a.role==="Administrator"||a.isAdmin,t=e?await window.AppDB.getAll("users"):[],n=e&&window.app_profileTargetUserId?window.app_profileTargetUserId:a.id,i=e&&t.find(w=>w.id===n)||a,s=(w,k)=>{const T=String(w||"").trim();if(!/^\d{4}-\d{2}-\d{2}$/.test(T))return"NA";const E=T.replace(/-/g,""),v=String(k||"").replace(/[^a-zA-Z0-9]/g,"").toUpperCase().slice(-3)||"USR";return`EMP-${E}-${v}`},o=typeof i.joinDate=="string"&&/^\d{4}-\d{2}-\d{2}$/.test(i.joinDate)?i.joinDate:"",r=o?i.employeeId||s(o,i.id):"NA",d=Number(i.birthDay||0),l=Number(i.birthMonth||0),c=Number(i.birthYear||0),p=[d?String(d).padStart(2,"0"):"--",l>=1&&l<=12?new Date(2026,l-1,1).toLocaleString("en-US",{month:"long"}):"--",c?String(c):""].filter(Boolean).join(" ").trim(),[m,u,y]=await Promise.all([window.AppAnalytics?window.AppAnalytics.getUserMonthlyStats(i.id):null,window.AppAnalytics?window.AppAnalytics.getUserYearlyStats(i.id):null,window.AppLeaves?window.AppLeaves.getUserLeaves(i.id):[]]);window.app_changeProfileStaff=async w=>{window.app_profileTargetUserId=w||a.id;const k=document.getElementById("page-content");k&&(k.innerHTML=await Pa())},window.app_confirmSignOut=()=>{confirm("Are you sure you want to sign out?")&&window.AppAuth.logout()};const h=i.id===a.id,f=m?.attendanceRate??"—",S=m?.punctualityRate??"—",_=m?.totalHours??"—",b=u?.totalDays??"—",$=w=>w==="Approved"?"#16a34a":w==="Rejected"?"#dc2626":"#d97706",g=(i.name||"U").split(" ").map(w=>w[0]).join("").slice(0,2).toUpperCase();return`
            <div class="pro-profile-root">
                ...
                <div class="pro-profile-hero">
                    ...
                    <div class="pro-profile-hero-inner">
                        ...
                        <div class="pro-profile-avatar-ring">
                            ${i.avatar?`<img src="${D(i.avatar)}" alt="${D(i.name)}" class="pro-profile-avatar-img">`:`<div class="pro-profile-avatar-initials">${g}</div>`}
                        ...
                        <div class="pro-profile-identity">
                            <div class="pro-profile-name-row">
                                <h1 class="pro-profile-name">${D(i.name)}</h1>
                                <span class="pro-profile-role-badge">${D(i.role||"Staff")}</span>
                            </div>
                            ...
                            <div class="pro-profile-meta-row">
                                ...
                                ${i.department?`<span class="pro-profile-chip">
                                    <i class="fa-solid fa-building"></i>${D(i.department)}
                                </span>`:""}
                            </div>
                        </div>
                        ...
                        <div class="pro-profile-header-actions">
                            ...
                            <select class="pro-profile-staff-picker" onchange="window.app_changeProfileStaff(this.value)">
                                ...
                                ${t.map(w=>`<option value="${w.id}" ${w.id===n?"selected":""}>${D(w.name)}</option>`).join("")}
                            </select>`:""}
                            ${h?`
                ...
                <div class="pro-profile-stats-strip">
                    <div class="pro-stat-tile">
                        ...
                        <div class="pro-stat-value">${f}${typeof f=="number"?"%":""}</div>
                    ...
                    <div class="pro-profile-main">
                        <div class="pro-card">
                            <div class="pro-card-head">
                                ...
                                <span class="pro-card-sub">${y.length} record${y.length!==1?"s":""}</span>
                            </div>
                            ${y.length?`
                            <table class="pro-leave-table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>${w.daysCount??"—"}</td>
                                        <td>
                                            <span class="pro-status-pill" style="background:${$(w.status)}18;color:${$(w.status)};">
                                                ${D(w.status||"Pending")}
                                            </span>
                                        </td>
                                    </tr>`).join("")}
                            ...
                            ${y.length>8?`<div class="pro-table-footer">Showing 8 of ${y.length} records</div>`:""}
                        ...
                        <div class="pro-card" style="margin-top:1rem;">
                            ...
                            <div class="pro-breakdown-grid">
                                ${Object.entries(u.breakdown||{}).filter(([,w])=>w>0).map(([w,k])=>`
                                <div class="pro-breakdown-chip">
                                    <span class="pro-breakdown-count">${k}</span>
                                    <span class="pro-breakdown-key">${D(w)}</span>
                                </div>`).join("")}
                            </div>
                        </div>`:""}
                    </div>
                    ...
                    <aside class="pro-profile-side">
                        ...
                        <div class="pro-card">
                            ...
                            <div class="pro-detail-list">
                                ${[["Department",i.department||"Operations"],["Role",i.role||"Staff"],["Level",i.level||"—"],["Reports To",i.reportsTo||"Admin"],["Employee ID",r],["Join Date",o||"N/A"],["Birthday",p||"N/A"],["Payroll Cycle","Monthly (25th)"]].map(([w,k])=>`
                                <div class="pro-detail-row">
                                    <div class="pro-detail-label">${w}</div>
                                    <div class="pro-detail-value">${D(String(k))}</div>
                                </div>`).join("")}
                            </div>
                        </div>
        ...
        `}catch(a){return console.error("Profile Render Error:",a),`<div class="card error-card">Failed to load profile: ${D(a.message)}</div>`}}async function Na(a=null,e=null){const t=window.AppAuth.getUser(),n=window.app_hasPerm("attendance","admin",t),i=await window.AppDB.getAll("users"),s=new Date,o=a!==null?parseInt(a):s.getMonth(),r=e!==null?parseInt(e):s.getFullYear(),d=`${r}-${String(o+1).padStart(2,"0")}-01`,l=`${r}-${String(o+1).padStart(2,"0")}-31`;let c=[];try{c=(await window.AppDB.query("attendance","date",">=",d)).filter(k=>k.date<=l)}catch(w){console.warn("MasterSheet: query failed, fetching all attendance logs",w),c=(await window.AppDB.getAll("attendance")).filter(T=>T.date>=d&&T.date<=l)}const p=new Date(r,o+1,0).getDate(),m=Array.from({length:p},(w,k)=>k+1),u=["January","February","March","April","May","June","July","August","September","October","November","December"],y=w=>{const k=new Date(`${w}T00:00:00`),T=k.getDay();if(T===0)return"holiday";if(T===6){const E=Math.floor((k.getDate()-1)/7)+1;if(E===2||E===4)return"holiday";if(E===1||E===3||E===5)return"halfday"}return"working"},h=w=>String(w?.type||"").includes("Leave")||w?.location==="On Leave",f=w=>!w||!w.checkOut||w.checkOut==="Active Now"?!1:typeof w.activityScore<"u"||typeof w.locationMismatched<"u"||!!w.checkOutLocation||typeof w.outLat<"u"||typeof w.outLng<"u",S=w=>!w||!w.autoCheckout?"":String(w.missedCheckoutReasonStatus||"").toLowerCase()==="approved"||w.missedCheckoutApprovedAsFullDay?"Auto-closed due to missed checkout. Admin approved and converted this entry to full day.":String(w.missedCheckoutReasonStatus||"").toLowerCase()==="rejected"?"Auto-closed due to missed checkout. Admin rejected the submitted reason.":String(w.missedCheckoutReasonStatus||"").toLowerCase()==="approved"?"Auto-closed due to missed checkout. Admin approved the submitted reason.":"Auto-closed due to missed checkout.",_=w=>w?.isManualOverride?4:h(w)?3:f(w)?2:1,b=w=>{if(Object.prototype.hasOwnProperty.call(w||{},"attendanceEligible"))return w.attendanceEligible===!0;const k=String(w?.entrySource||"");return k==="staff_manual_work"?!1:k==="admin_override"||k==="checkin_checkout"||w?.isManualOverride||w?.location==="Office (Manual)"||w?.location==="Office (Override)"||typeof w?.activityScore<"u"||typeof w?.locationMismatched<"u"||typeof w?.autoCheckout<"u"||!!w?.checkOutLocation||typeof w?.outLat<"u"||typeof w?.outLng<"u"?!0:String(w?.type||"").includes("Leave")||w?.location==="On Leave"},$=new Date().toISOString().split("T")[0],g=w=>{const k=new Date(w);return`${k.getFullYear()}-${String(k.getMonth()+1).padStart(2,"0")}-${String(k.getDate()).padStart(2,"0")}`};return window.app_refreshMasterSheet=async()=>{const w=document.getElementById("sheet-month")?.value,k=document.getElementById("sheet-year")?.value,T=document.getElementById("page-content");T&&(T.innerHTML=await Na(w,k))},`
            ...
            <div class="card full-width">
                <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:0.75rem;">
                    ...
                    <div style="display:flex; gap:0.5rem; align-items:center;">
                        <select onchange="window.app_refreshMasterSheet()" id="sheet-month" style="padding:0.4rem; border-radius:6px; border:1px solid #ddd; font-size:0.8rem;">
                            ${u.map((w,k)=>`<option value="${k}" ${k===o?"selected":""}>${w}</option>`).join("")}
                        </select>
                ...
                <div class="table-container" style="max-height: 70vh; overflow: auto; border: 1px solid #eee; border-radius: 8px;">
                    <table style="font-size:0.85rem; border-collapse: separate; border-spacing: 0;">
                        ...
                        <tbody>
                            ${i.sort((w,k)=>w.name.localeCompare(k.name)).map((w,k)=>`
                                <tr>
                                    ...
                                    <td style="border-right: 2px solid #ddd; position: sticky; left: 35px; background: #fff; z-index: 5; font-weight: 500; padding:4px;">
                                        <div style="display:flex; flex-direction:column;">
                                            <span style="font-size:0.75rem; white-space:nowrap; overflow:hidden; text-overflow:ellipsis; max-width:110px;">${D(w.name)}</span>
                                            <span style="font-size:0.65rem; color:#666; font-weight:400;">${D(w.dept||"General")}</span>
                                        </div>
                                    </td>
                                    ${m.map(T=>{const E=`${r}-${String(o+1).padStart(2,"0")}-${String(T).padStart(2,"0")}`,x=c.filter(P=>(P.userId===w.id||P.user_id===w.id)&&P.date===E).filter(b),A=y(E);let M="-",O="",I="No log";if(x.length>0){const P=x.slice().sort((j,W)=>_(W)-_(j))[0],B=P.autoCheckout&&String(P.missedCheckoutReasonStatus||"").toLowerCase()==="approved"?"Present":P.type,U=window.AppAttendance&&window.AppAttendance.normalizeType?window.AppAttendance.normalizeType(B):B,V=S(P);M=U.charAt(0).toUpperCase(),I=`${P.checkIn} - ${P.checkOut||"Active"}
${U}`,V&&(I+=`
${V}`),U==="Present"?O="color: #10b981; font-weight: bold; font-size: 0.9rem;":U==="Late"?(O="color: #f59e0b; font-weight: bold;",M="L"):U==="Half Day"?(O="color: #c2410c; font-weight: bold;",M="HD"):U==="Absent"?(O="color: #ef4444; font-weight: bold;",M="A"):U.includes("Leave")?(O="color: #8b5cf6; font-weight: bold;",M="C"):U==="Work - Home"?(O="color: #0ea5e9; font-weight: bold;",M="W"):U==="On Duty"&&(O="color: #0369a1; font-weight: bold;",M="D"),P.isManualOverride&&(O="color: #be185d; font-weight: bold; background: #fdf2f8;"),V&&(M=`<span style="display:inline-flex; align-items:flex-start; gap:2px;"><span>${M}</span><span style="color:#4338ca; font-size:0.7rem; line-height:1;">•</span></span>`)}else{const P=E===$&&w.status==="in"&&w.lastCheckIn&&g(w.lastCheckIn)===E,B=typeof w.joinDate=="string"&&/^\d{4}-\d{2}-\d{2}$/.test(w.joinDate)?E<w.joinDate:!1,U=E>$;P?(M="P",O="color: #10b981; font-weight: bold; font-size: 0.9rem;",I="Checked in (pending checkout)"):U||B?(M="-",O="color: #94a3b8; font-weight: 600;",I=U?"Future date":`Before joining date (${w.joinDate})`):A==="holiday"?(M="H",O="color: #64748b; font-weight: 700;",I="Holiday"):(M="A",O="color: #ef4444; font-weight: bold;",I="Absent")}return n||t&&(w.id===t.id||w.user_id===t.id||w.username&&t.username&&w.username===t.username||w.email&&t.email&&w.email===t.email)||(I=""),`<td style="text-align:center; ${n?"cursor:pointer;":""} border-right: 1px solid #eee; padding:2px; font-size:0.75rem; ${O}" ${I?`title="${I}"`:""} ${n?`onclick="window.app_openCellOverride('${w.id}', '${E}')"`:""}>${M}</td>`}).join("")}
                                </tr>`).join("")}
                        </tbody>
                    </table>
                </div>
            </div>
        </div>`}async function Ht(a=null,e=null){let t=[],n=[],i=[],s={avgScore:0,trendData:[0,0,0,0,0,0,0],labels:[]},o=[],r=[];try{const g=new Date().toISOString().split("T")[0];a=a||g,e=e||g;const w=await Promise.allSettled([window.AppDB.getCached?window.AppDB.getCached(window.AppDB.getCacheKey("adminUsers","users",{}),L?.READ_CACHE_TTLS?.users||6e4,()=>window.AppDB.getAll("users")):window.AppDB.getAll("users"),window.AppAnalytics.getSystemPerformance(),window.AppDB.queryMany?window.AppDB.queryMany("location_audits",[],{orderBy:[{field:"timestamp",direction:"desc"}],limit:300}).catch(()=>window.AppDB.getAll("location_audits")):window.AppDB.getAll("location_audits"),window.AppLeaves.getPendingLeaves(),window.AppDB.queryMany?window.AppDB.queryMany("system_audit_logs",[],{orderBy:[{field:"createdAt",direction:"desc"}],limit:80}).catch(()=>window.AppDB.getAll("system_audit_logs")):window.AppDB.getAll("system_audit_logs")]),k=(A,M,O)=>{const I=w[A];return I&&I.status==="fulfilled"?I.value:(I&&I.status==="rejected"&&console.warn(`Admin data fetch failed for ${O}:`,I.reason),M)};t=k(0,[],"users"),s=k(1,{avgScore:0,trendData:[0,0,0,0,0,0,0],labels:[]},"performance"),o=k(2,[],"location_audits"),n=k(3,[],"pending_leaves"),r=k(4,[],"system_audit_logs"),o=o.filter(A=>{const M=new Date(A.timestamp).toISOString().split("T")[0];return M>=a&&M<=e}).sort((A,M)=>M.timestamp-A.timestamp),r=(r||[]).filter(A=>A&&A.module==="simulation"&&String(A.type||"").startsWith("legacy_dummy_cleanup_")).sort((A,M)=>Number(M.createdAt||0)-Number(A.createdAt||0)).slice(0,25);const T=window.AppAuth?.getUser?.(),E=T?t.find(A=>String(A.id)===String(T.id))||T:null,v=(Array.isArray(E?.notifications)?E.notifications:[]).filter(A=>A&&A.type==="missed-checkout-reason"&&String(A.status||"pending").toLowerCase()==="pending"&&A.logId),x=Array.from(new Set(v.map(A=>String(A.logId||"")).filter(Boolean)));i=x.length?window.AppDB.getManyByIds?await window.AppDB.getManyByIds("attendance",x):(await Promise.all(x.map(A=>window.AppDB.get("attendance",A)))).filter(Boolean):[]}catch(g){console.error("Failed to fetch admin data",g)}const d=t.filter(g=>g.status==="in").length,l=t.filter(g=>g.role==="Administrator"||g.isAdmin===!0).length,c=t.filter(g=>Number(g.birthMonth||0)>=1&&Number(g.birthDay||0)>=1).length,p=[...t].filter(g=>Number(g.birthMonth||0)>=1).sort((g,w)=>{const k=`${String(Number(g.birthMonth||99)).padStart(2,"0")}-${String(Number(g.birthDay||99)).padStart(2,"0")}-${String(g.name||"").toLowerCase()}`,T=`${String(Number(w.birthMonth||99)).padStart(2,"0")}-${String(Number(w.birthDay||99)).padStart(2,"0")}-${String(w.name||"").toLowerCase()}`;return k.localeCompare(T)}).slice(0,5),m=s.avgScore>70?"Optimal":s.avgScore>40?"Good":"Low",u=s.avgScore>70?"#166534":s.avgScore>40?"#854d0e":"#991b1b",y=s.avgScore>70?"#f0fdf4":s.avgScore>40?"#fefce8":"#fef2f2",h=window.AppAuth?.getUser?.(),f=h?t.find(g=>String(g.id)===String(h.id))||h:null,S=Array.isArray(f?.notifications)?f.notifications:[],_=new Map(t.map(g=>[String(g.id),g])),b=(i||[]).filter(g=>g&&g.missedCheckoutReasonRequired&&g.missedCheckoutReasonSubmittedAt&&String(g.missedCheckoutReasonStatus||"").toLowerCase()==="pending").map(g=>{const w=_.get(String(g.user_id)),k=S.find(T=>T&&T.type==="missed-checkout-reason"&&String(T.logId||"")===String(g.id||"")&&String(T.status||"pending").toLowerCase()==="pending");return{...g,staffName:w?.name||"Staff",staffRole:w?.role||"Employee",notificationId:k?.id||""}}).sort((g,w)=>new Date(w.missedCheckoutReasonSubmittedAt||w.systemClosedAt||w.date||0)-new Date(g.missedCheckoutReasonSubmittedAt||g.systemClosedAt||g.date||0)),$=g=>{const w=g&&g.payload?g.payload:{},k=w.deleted||{},T=w.configuredTargets||{};if(g.type==="legacy_dummy_cleanup_completed")return[`users=${Number(k.users||0)}`,`attendance=${Number(k.attendance||0)}`,`leaves=${Number(k.leaves||0)}`,`workPlans=${Number(k.workPlans||0)}`].join(", ");if(g.type==="legacy_dummy_cleanup_skipped"){const E=w.reason||"unknown",v=Array.isArray(T.ids)?T.ids.length:0,x=Array.isArray(T.usernames)?T.usernames.length:0;return`reason=${E}, targetIds=${v}, targetUsernames=${x}`}return g.type==="legacy_dummy_cleanup_failed"?String(w.message||"Unknown error"):"-"};return window.app_applyAuditFilter=async()=>{const g=document.getElementById("audit-start")?.value,w=document.getElementById("audit-end")?.value,k=document.getElementById("page-content");k&&(k.innerHTML=await Ht(g,w))},window.app_refreshAdminPage=async()=>{const g=document.getElementById("audit-start")?.value||a,w=document.getElementById("audit-end")?.value||e,k=document.getElementById("page-content");k&&(k.innerHTML=await Ht(g,w))},`
        <div class="dashboard-grid dashboard-modern dashboard-admin-view">
                            ...
                            <tbody>
                                ${n.map(g=>`
                                    <tr>
                                        ...
                                        <td>${D(g.userName)}</td>
                                        <td><span class="admin-leave-type-badge">${D(g.type)}</span></td>
                                        <td>${g.daysCount}</td>
                                        <td>
                                                <div class="admin-leave-actions">
                                                ${window.app_hasPerm("leaves","admin")?`
                                                    <button onclick="window.AppLeaves.updateLeaveStatus('${g.id}', 'Approved', window.AppAuth?.getUser?.()?.id).then(() => window.app_refreshAdminPage())" class="admin-btn admin-btn-success">Approve</button>
                                                    <button onclick="window.AppLeaves.updateLeaveStatus('${g.id}', 'Rejected', window.AppAuth?.getUser?.()?.id).then(() => window.app_refreshAdminPage())" class="admin-btn admin-btn-danger">Reject</button>
            ...
            <div class="card full-width dashboard-tagged-card">
                <div class="dashboard-tagged-head">
                    <h4>Missed Checkout Requests (${b.length})</h4>
                    <span>Pending admin review</span>
                </div>
                ${b.length===0?'<p class="text-muted">No missed checkout reasons waiting for review.</p>':`
                    <div class="dashboard-tagged-list">
                        ${b.map(g=>`
                            <div class="dashboard-tagged-item">
                                <div>
                                    <div class="dashboard-tagged-title">${D(g.staffName)}</div>
                                    <div class="dashboard-tagged-desc">${D(g.missedCheckoutReason||"Reason not submitted yet.")}</div>
                                    <div class="dashboard-tagged-meta">
                                        ${D(g.date||"--")} | ${D(g.staffRole||"Employee")}
                                        ${g.missedCheckoutReasonSubmittedAt?` | Submitted ${D(new Date(g.missedCheckoutReasonSubmittedAt).toLocaleString())}`:""}
                                    </div>
                                </div>
                                <div class="dashboard-tagged-status">
                                    <span class="dashboard-tagged-pill pending">Pending</span>
                                    ${g.notificationId?`
                                        <div class="dashboard-tagged-actions">
                                            <button class="dashboard-tagged-btn accept" onclick='window.app_reviewMissedCheckoutReasonFromNotification(-1, ${JSON.stringify(String(g.notificationId))}, "approved")'>Approve</button>
                                            <button class="dashboard-tagged-btn reject" onclick='window.app_reviewMissedCheckoutReasonFromNotification(-1, ${JSON.stringify(String(g.notificationId))}, "rejected")'>Reject</button>
                                        </div>
                                    `:'<span class="text-muted" style="font-size:0.7rem;">Notification sync pending</span>'}
                                </div>
                            </div>
            ...
            <div class="card admin-performance-card">
                <div class="admin-performance-head">
                    ...
                    <div class="admin-performance-status" style="background:${y}; color:${u};">${m}</div>
                </div>
                <div class="admin-performance-bars">
                    ${s.trendData.map(g=>`<div class="admin-performance-bar-item"><div class="admin-performance-bar-fill" style="height:${Math.max(g,5)}%;"></div></div>`).join("")}
                </div>
            </div>
                ...
                <div style="display:flex; flex-direction:column; gap:0.55rem;">
                    ${p.length?p.map(g=>`
                            <div style="display:flex; justify-content:space-between; gap:0.75rem; border:1px solid #fdba74; border-radius:12px; padding:0.7rem 0.8rem; background:rgba(255,255,255,0.72);">
                                <div>
                                    <div style="font-weight:700; color:#7c2d12;">${D(g.name||"Staff")}</div>
                                    <div style="font-size:0.8rem; color:#9a3412;">${D(g.role||"Employee")} / ${D(g.dept||"General")}</div>
                                </div>
                                <div style="text-align:right; color:#9a3412; font-weight:700;">${D(String(g.birthDay||"--"))}/${D(String(g.birthMonth||"--"))}${g.birthYear?`/${D(String(g.birthYear))}`:""}</div>
                            </div>
                ...
                <div class="admin-staff-head">
                 ...
                 <div class="table-container mobile-table-card">
                    <table>
                        ...
                        <tbody>
                            ${t.map(g=>{const w=g.lastSeen&&Date.now()-g.lastSeen<12e4;return`
                                <tr>
                                    <td>
                                        <div class="admin-user-cell">
                                            <img src="${g.avatar}" class="admin-user-avatar">
                                            <div>
                                                <div class="admin-user-name-row">${D(g.name)} ${w?'<span class="admin-user-live-tag">LIVE</span>':""}</div>
                                                <div class="admin-user-id">${D(g.username)}</div>
                                            </div>
                                        </div>
                                    </td>
                                    <td><span class="status-badge ${g.status==="in"?"in":"out"}">${g.status?.toUpperCase()}</span></td>
                                    <td>${g.lastCheckIn?new Date(g.lastCheckIn).toLocaleTimeString():"--"} / ${g.lastCheckOut?new Date(g.lastCheckOut).toLocaleTimeString():"--"}</td>
                                    <td>${D(g.role)} / ${D(g.dept||"--")}</td>
                                    <td>
                                        <div class="admin-row-actions">
                                            <button onclick="window.app_viewLogs('${g.id}')" class="admin-icon-btn"><i class="fa-solid fa-list-check"></i></button>
                                            ${window.app_hasPerm("users","admin")?`<button onclick="window.app_editUser('${g.id}')" class="admin-icon-btn"><i class="fa-solid fa-pen"></i></button>`:""}
                                        </div>
                                    </td>
                                </tr>`}).join("")}
                        </tbody>
                        ...
                        <tbody>
                            ${o.length?o.map(g=>`
                                <tr>
                                    <td>${D(g.userName)}</td>
                                    <td>${D(g.slot)}</td>
                                    <td>${new Date(g.timestamp).toLocaleTimeString()}</td>
                                    <td style="color:${g.status==="Success"?"green":"red"}">${g.status}</td>
                                </tr>
                ...
                <div class="table-container">
                    <table>
                        ...
                        <tbody>
                            ${r.length?r.map(g=>`
                                <tr>
                                    <td>${new Date(Number(g.createdAt||0)).toLocaleString()}</td>
                                    <td>${D(g.type||"-")}</td>
                                    <td>${D($(g))}</td>
                                </tr>
        ...
        </div>`}const be=["January","February","March","April","May","June","July","August","September","October","November","December"],Nn=["Sun","Mon","Tue","Wed","Thu","Fri","Sat"],Bn=a=>String(a).padStart(2,"0"),Ba=()=>window.AppDB?.getIstNow?new Date(window.AppDB.getIstNow()):new Date,Un=()=>{const a=Ba(),e=window.app_birthdayCalendarState||{},t=Number(e.selectedMonth||a.getMonth()+1),n=Number(e.selectedYear||a.getFullYear()),i=e.view==="year"?"year":"month";return window.app_birthdayCalendarState={view:i,selectedMonth:t,selectedYear:n},window.app_birthdayCalendarState},Ua=a=>{const e=Number(a?.birthDay||0),t=Number(a?.birthMonth||0),n=Number(a?.birthYear||0),i=e?Bn(e):"--",s=t?be[t-1]:"--";return`${i} ${s}${n?` ${n}`:""}`.trim()},Ce=a=>{const e=Number(a?.birthMonth||99),t=Number(a?.birthDay||99),n=String(a?.name||"").toLowerCase();return`${String(e).padStart(2,"0")}-${String(t).padStart(2,"0")}-${n}`},On=a=>{const e=a?.role||"Employee",t=a?.dept||a?.department||"General";return`${a?.name||"Staff"} - ${e} / ${t}`},Oa=a=>a?.source==="external"?'<span class="birthday-source-pill external">External</span>':'<span class="birthday-source-pill staff">Staff</span>',Ra=a=>a?.source==="external"?`${a?.position||"Position not set"} • ${a?.location||"Location not set"}`:`${a?.role||"Employee"} • ${a?.dept||"General"}`,Rn=a=>Number(a?.birthDay||0)>0?'<span class="birthday-status ok">Reminder eligible</span>':'<span class="birthday-status warn">Add day to enable reminder</span>',Fa=(a,e)=>e?`<button type="button" class="action-btn secondary" style="margin-top:0.55rem; padding:0.42rem 0.72rem;" onclick="window.app_openBirthdayEditor('${D(a?.source||"user")}', '${D(a?.id||"")}')">Edit</button>`:"",Fn=a=>{const e=new Map;for(let t=1;t<=12;t+=1)e.set(t,[]);a.forEach(t=>{const n=Number(t?.birthMonth||0);n>=1&&n<=12&&e.get(n).push(t)});for(let t=1;t<=12;t+=1)e.get(t).sort((n,i)=>Ce(n).localeCompare(Ce(i)));return e},Hn=(a,e)=>{const n=new Date(e,a-1,1).getDay(),i=new Date(e,a,0).getDate(),s=[];for(let o=0;o<n;o+=1)s.push({type:"empty",key:`e-${a}-${o}`});for(let o=1;o<=i;o+=1)s.push({type:"day",day:o,key:`d-${a}-${o}`});for(;s.length%7!==0;)s.push({type:"empty",key:`tail-${a}-${s.length}`});return s},qn=(a,e)=>`
    <article class="birthday-agenda-card">
        <div class="birthday-agenda-head">
            <div>
                <div class="birthday-agenda-name">${D(a.name||"Staff")}</div>
                <div class="birthday-agenda-meta">${D(Ra(a))}</div>
            </div>
            ${Oa(a)}
        </div>
        <div class="birthday-agenda-date">${D(Ua(a))}</div>
        <div class="birthday-agenda-foot">
            ${Rn(a)}
            ${Fa(a,e)}
        </div>
    </article>
`,zn=(a,e,t)=>{const n=e.slice(0,3).map(i=>`
        <div class="birthday-mini-chip">
            <span>${D(String(i.birthDay||"--"))}</span>
    ...
    `};async function jn(){const a=window.AppAuth?.getUser?.(),e=window.app_canManageBirthdays?.(a),t=window.app_canAdminBirthdays?.(a),n=window.app_canSeeAdminPanel?.(a);if(!a||!e)return`
        ...
        `;const[i,s]=await Promise.all([window.AppDB.getAll("users").catch(()=>[]),window.AppDB.getAll("birthday_people",{silentPermissionDenied:!0}).catch(()=>[])]),o=[...i].sort((v,x)=>Ce(v).localeCompare(Ce(x))),r=[...o.map(v=>({...v,source:"user"})),...s.map(v=>({...v,source:"external"}))].sort((v,x)=>Ce(v).localeCompare(Ce(x))),d=r.filter(v=>Number(v?.birthMonth||0)>=1&&Number(v?.birthMonth||0)<=12),l=r.filter(v=>!(Number(v?.birthMonth||0)>=1&&Number(v?.birthMonth||0)<=12)),c=Fn(d),p=Un(),m=p.selectedMonth,u=p.selectedYear,y=Ba(),h=m===y.getMonth()+1&&u===y.getFullYear(),f=c.get(m)||[],S=o.map(v=>`
        <option value="${D(v.id)}">${D(On(v))}</option>
    `).join(""),_=Hn(m,u),b=new Map;f.forEach(v=>{const x=Number(v?.birthDay||0);if(!x)return;const A=b.get(x)||[];A.push(v),b.set(x,A)});const $=_.map(v=>{if(v.type==="empty")return'<div class="birthday-day-cell empty"></div>';const x=b.get(v.day)||[],A=h&&v.day===y.getDate(),M=x.slice(0,2).map(O=>`
            <div class="birthday-day-chip ${O.source==="external"?"external":"staff"}">
                <span>${D(O.name||"Staff")}</span>
            </div>
        `).join("");return`
            <div class="birthday-day-cell ${x.length?"has-birthday":""} ${A?"is-today":""}">
                <div class="birthday-day-number">${v.day}</div>
        ...
        `}).join(""),g=be.map((v,x)=>`
        <button type="button" class="birthday-month-tab ${m===x+1?"is-active":""}" onclick="window.app_goToBirthdayCalendarMonth(${x+1})">${D(v.slice(0,3))}</button>
    `).join(""),w=f.length?f.map(v=>qn(v,t)).join(""):'<div class="birthday-empty-panel">No birthdays have been assigned to this month yet.</div>',k=be.map((v,x)=>zn(x+1,c.get(x+1)||[],m)).join(""),T=l.length?l.map(v=>`
            <article class="birthday-incomplete-row">
                <div>
                    <div class="birthday-incomplete-name-wrap">
                        <strong>${D(v.name||"Staff")}</strong>
                        ${Oa(v)}
                    </div>
                    <div class="birthday-incomplete-meta">${D(Ra(v))}</div>
                </div>
                <div style="text-align:right;">
                    <div class="birthday-incomplete-date">${D(Ua(v))}</div>
                    <div class="birthday-status warn">Month missing or incomplete</div>
                    ${Fa(v,t)}
                </div>
            </article>
        `).join(""):'<div class="birthday-empty-panel">All saved birthday records already have a month assigned.</div>',E=t?`
        <section class="birthday-side-card birthday-actions-card">
            <div class="birthday-section-kicker">Manage This Month</div>
            <h3>${D(be[m-1])} Actions</h3>
            <form id="birthday-month-form-${m}" onsubmit="window.app_submitBirthdayMonthForm(event, ${m})" class="birthday-add-form">
                <label>
                    <span>Add staff to ${D(be[m-1])}</span>
        ...
        <div class="birthday-modern">
            <section class="birthday-shell">
                <div class="birthday-hero">
                    ...
                    <div class="birthday-toolbar">
                        <div class="birthday-period-nav">
                            ...
                            <div class="birthday-period-label">
                                <span class="birthday-period-title">${D(be[m-1])} ${u}</span>
                                <span class="birthday-period-sub">${f.length} birthdays this month</span>
                            </div>
                    ...
                    <div class="birthday-month-tabs">${g}</div>
                </div>
                <div class="birthday-body">
                    ...
                    `:`
                        <section class="birthday-year-panel">
                            ...
                            <div class="birthday-year-grid">${k}</div>
                        </section>
                    `}
                </div>
            </section>
    ...
    `}async function Yn(){const a=await window.AppAnalytics.getSystemMonthlySummary(),e=new Date,t=window.AppAuth.getUser(),n=window.app_hasPerm("reports","admin",t);return`
        <div class="card full-width">
            ...
            <div class="table-container salary-processing-table-wrap">
                <table class="salary-processing-table">
                    ...
                    <tbody>
                        ${a.map(s=>{const{user:o,stats:r}=s,d=Number(o.baseSalary||0),l=Number(r.unpaidLeaves||0),c=Number(r.late||0),p=Number(r.extraWorkedHours||0),m=window.AppConfig?.LATE_GRACE_COUNT||3,u=window.AppConfig?.LATE_DEDUCTION_PER_BLOCK||.5,y=window.AppConfig?.EXTRA_HOURS_FOR_HALF_DAY_OFFSET||4,h=Math.floor(c/m)*u,f=Math.floor(p/y)*u,S=Math.min(h,f),_=Math.max(0,h-S),b=l+_,$=Math.round(d/22*b),g=Math.round(Math.max(0,d-$)),w=o.employeeId||"",k=o.designation||o.role||"",T=o.dept||o.department||"",E=o.joinDate||"",v=o.bankName||"",x=o.bankAccount||o.accountNumber||"",A=o.pan||o.PAN||"",M=o.uan||o.UAN||"",O=Number(o.otherAllowances||0),I=Number(o.providentFund||0),N=Number(o.professionalTax||0),P=Number(o.loanAdvance||0);return`
                                <tr data-user-id="${o.id}">
                                    ...
                                    <td class="attendance-deduction-amount" style="color:#ef4444;">-Rs ${$.toLocaleString()}</td>
                                    <td class="deduction-amount" style="display:none;">-Rs ${$.toLocaleString()}</td>
                                    ...
                                    <td style="display:none;"><input class="employee-id-input" type="text" value="${D(w)}"></td>
                                    <td style="display:none;"><input class="designation-input" type="text" value="${D(k)}"></td>
                                    <td style="display:none;"><input class="department-input" type="text" value="${D(T)}"></td>
                                    <td style="display:none;"><input class="join-date-input" type="date" value="${D(E)}"></td>
                                    <td style="display:none;"><input class="bank-name-input" type="text" value="${D(v)}"></td>
                                    <td style="display:none;"><input class="bank-account-input" type="text" value="${D(x)}"></td>
                                    <td style="display:none;"><input class="pan-input" type="text" value="${D(A)}"></td>
                                    <td style="display:none;"><input class="uan-input" type="text" value="${D(M)}"></td>
    ...
    `}async function Wn(){const a=new Date().toISOString().split("T")[0];return window.app_runPolicyTest=()=>{const e=document.getElementById("policy-test-checkin")?.value,t=document.getElementById("policy-test-checkout")?.value,n=document.getElementById("policy-test-output");if(!e||!t||!n)return;const i=document.getElementById("policy-test-date")?.value,s=new Date(`${i}T${e}`),r=(new Date(`${i}T${t}`)-s)/(1e3*60*60);let d="Absent";r>=8?d="Present":r>=4&&(d="Half Day"),n.innerHTML=`
    ...
    `}async function Ha(){const a=await window.AppMinutes.getMinutes(),e=window.AppDB?.getAll?await window.AppDB.getAll("users"):[],t=window.AppAuth.getUser(),n=window.AppCalendar?await window.AppCalendar.getPlans():{leaves:[],events:[],work:[]},i=new Date,s=`${i.getFullYear()}-${String(i.getMonth()+1).padStart(2,"0")}`;window._minutesUiState?(window._minutesUiState.viewMode=window._minutesUiState.viewMode||"list",window._minutesUiState.searchQuery=window._minutesUiState.searchQuery||"",window._minutesUiState.monthKey=window._minutesUiState.monthKey||s):window._minutesUiState={viewMode:"list",searchQuery:"",monthKey:s};const o=window._minutesUiState,r=(v,x=t)=>!v||!x?!1:!!(window.app_hasPerm("minutes","view",x)||v.createdBy===x.id||(v.attendeeIds||[]).includes(x.id)||(v.allowedViewers||[]).includes(x.id)||(v.actionItems||[]).some(A=>A.assignedTo===x.id)),d=(v,x=t.id)=>{const A=(v.accessRequests||[]).find(M=>M.userId===x);return A?A.status:""},l=(v="")=>{const M=new DOMParser().parseFromString(`<div>${v||""}</div>`,"text/html").body.firstElementChild;if(!M)return"";const O=new Set(["P","BR","B","STRONG","I","EM","U","H2","H3","UL","OL","LI","A"]),I={A:new Set(["href","target","rel"])},N=P=>{!P||!P.childNodes||Array.from(P.childNodes).forEach(B=>{if(B.nodeType===Node.ELEMENT_NODE){const U=B;if(!O.has(U.tagName)){for(;U.firstChild;)P.insertBefore(U.firstChild,U);P.removeChild(U);return}if(Array.from(U.attributes).forEach(V=>{const j=I[U.tagName];(!j||!j.has(V.name.toLowerCase()))&&U.removeAttribute(V.name)}),U.tagName==="A"){const V=(U.getAttribute("href")||"").trim();/^(https?:|mailto:|#)/i.test(V)?(U.setAttribute("target","_blank"),U.setAttribute("rel","noopener noreferrer")):U.removeAttribute("href")}}N(B)})};return N(M),M.innerHTML.trim()},c=(v="")=>{const x=document.createElement("div");return x.innerHTML=v||"",(x.innerText||x.textContent||"").replace(/\r/g,"").trim()},p=(v="")=>D(v||"").replace(/\n/g,"<br>"),m=v=>{if(!v)return null;if(/^\d{4}-\d{2}-\d{2}$/.test(v))return new Date(`${v}T00:00:00`);const x=new Date(v);return Number.isNaN(x.getTime())?null:x},u=(v,x={day:"numeric",month:"short",year:"numeric"})=>{const A=m(v);return A?A.toLocaleDateString(void 0,x):"Date not set"},y=v=>{const[x,A]=String(v||s).split("-").map(Number);return!x||!A?new Date(i.getFullYear(),i.getMonth(),1):new Date(x,A-1,1)},h=v=>{const x=(v.attendeeIds||[]).map(A=>e.find(M=>M.id===A)?.name||e.find(M=>M.id===A)?.username||"").join(" ");return[v.title,v.date,v.content,x].join(" ").toLowerCase()},f=(v,x="")=>{const A=document.getElementById(v),M=A?A.innerHTML:"",O=l(M);let I=c(O);return!I&&x&&(I=(document.getElementById(x)?.value||"").trim()),{html:O,text:I}},S=(v="",x="")=>{const A=l(v||"");return A||D(x||"").replace(/\n/g,"<br>")};let _=new Set;window.app_toggleNewMinuteForm=()=>{const v=document.getElementById("new-minute-form");if(v&&(v.style.display=v.style.display==="none"?"block":"none",v.style.display==="block")){_=new Set,window.app_refreshAttendeeChips(),document.querySelectorAll('.attendee-grid input[type="checkbox"]').forEach(M=>M.checked=!1);const x=document.getElementById("action-items-container");x&&(x.innerHTML="",window.app_addActionItemRow());const A=document.getElementById("new-minute-content-editor");A&&(A.innerHTML="")}},window.app_refreshMinutesView=async()=>{const v=document.getElementById("page-content");v&&(v.innerHTML=await Ha(),window.setTimeout(()=>window.app_filterMinutes(o.searchQuery||""),0))},window.app_minutesExec=(v,x,A=null)=>{const M=document.getElementById(v);M&&(M.focus(),document.execCommand(x,!1,A))},window.app_minutesFormatBlock=(v,x)=>{window.app_minutesExec(v,"formatBlock",x)},window.app_filterAttendees=v=>{const x=v.toLowerCase();document.querySelectorAll(".attendee-item-modern").forEach(A=>{const M=(A.dataset.name||"").toLowerCase();A.style.display=M.includes(x)?"flex":"none"})},window.app_filterMinutes=v=>{o.searchQuery=v||"";const x=o.searchQuery.toLowerCase().trim();let A=0;document.querySelectorAll(".minute-card-modern").forEach(I=>{const N=(I.dataset.searchText||"").toLowerCase(),P=!x||N.includes(x);I.style.display=P?"flex":"none",P&&(A+=1)}),document.querySelectorAll(".minutes-calendar-entry").forEach(I=>{const N=(I.dataset.searchText||"").toLowerCase(),P=!x||N.includes(x);I.style.display=P?"flex":"none"}),document.querySelectorAll(".minutes-calendar-day").forEach(I=>{const N=Array.from(I.querySelectorAll(".minutes-calendar-entry")),P=N.some(U=>U.style.display!=="none"),B=I.querySelector(".minutes-calendar-count");I.classList.toggle("has-visible-meeting",P),B&&(B.textContent=P?`${N.filter(U=>U.style.display!=="none").length} meeting${N.filter(U=>U.style.display!=="none").length===1?"":"s"}`:""),P&&(A+=1)});const M=document.getElementById("minutes-list-empty-state");M&&(M.style.display=A===0?"block":"none");const O=document.getElementById("minutes-calendar-empty-state");O&&(O.style.display=A===0?"block":"none")},window.app_setMinutesView=v=>{o.viewMode=v==="calendar"?"calendar":"list",window.app_refreshMinutesView()},window.app_shiftMinutesMonth=v=>{const x=y(o.monthKey);x.setMonth(x.getMonth()+Number(v||0)),o.monthKey=`${x.getFullYear()}-${String(x.getMonth()+1).padStart(2,"0")}`,window.app_refreshMinutesView()},window.app_toggleAttendeePick=v=>{v.checked?_.add(v.value):_.delete(v.value),window.app_refreshAttendeeChips()},window.app_refreshAttendeeChips=()=>{const v=document.getElementById("minutes-attendee-chips");v&&(v.innerHTML=Array.from(_).map(x=>{const A=e.find(M=>M.id===x);return`
                <div class="chip-modern">
                    <span>${D(A?.name||A?.username||"Unknown")}</span>
                    <i class="fa-solid fa-circle-xmark" onclick="window.app_removeAttendee('${x}')"></i>
                </div>
            `}).join(""))},window.app_removeAttendee=v=>{_.delete(v);const x=document.querySelector(`.attendee-item-modern input[value="${v}"]`);x&&(x.checked=!1),window.app_refreshAttendeeChips()},window.app_addActionItemRow=()=>{const v=document.getElementById("action-items-container");if(!v)return;const x=document.createElement("div");x.className="action-item-row-card",x.innerHTML=`
            ...
            <div class="field-group">
                <select class="input-premium action-assignee">
                    ...
                    ${e.map(A=>`<option value="${A.id}">${D(A.name||A.username)}</option>`).join("")}
                </select>
            </div>
            <div class="field-group">
        ...
        `,v.appendChild(x)},window.app_submitNewMinutes=async()=>{const v=document.getElementById("new-minute-title").value.trim(),x=document.getElementById("new-minute-date").value,A=f("new-minute-content-editor","new-minute-content"),M=A.text,O=Array.from(_),I=Array.from(document.querySelectorAll(".action-item-row-card")).map(N=>({task:N.querySelector(".action-task").value.trim(),assignedTo:N.querySelector(".action-assignee").value,dueDate:N.querySelector(".action-due").value,status:"pending"})).filter(N=>N.task);if(!v||!M)return alert("Title and content are required.");try{await window.AppMinutes.addMinute({title:v,date:x,content:M,contentHtml:A.html,attendeeIds:O,actionItems:I}),alert("Meeting minutes recorded!"),window.app_refreshMinutesView()}catch(N){alert("Error saving: "+N.message)}},window.app_requestMinuteAccess=async v=>{try{await window.AppMinutes.requestAccess(v),alert("Access requested!"),window.app_refreshMinutesView()}catch(x){alert("Error: "+x.message)}},window.app_handleMinuteApproval=async v=>{if(confirm("Are you sure you want to approve these minutes? This will lock the record if you are the last attendee to sign."))try{await window.AppMinutes.approveMinute(v),alert("Minutes approved!"),window.app_openMinuteDetails(v),window.app_refreshMinutesView()}catch(x){alert("Error: "+x.message)}},window.app_handleActionItemStatus=async(v,x,A)=>{try{await window.AppMinutes.updateActionItemStatus(v,x,A),alert(`Task marked as ${A}!`),window.app_openMinuteDetails(v)}catch(M){alert("Error: "+M.message)}},window.app_handleAccessDecision=async(v,x,A)=>{try{await window.AppMinutes.handleAccessRequest(v,x,A),alert(`Request ${A}!`),window.app_openMinuteDetails(v)}catch(M){alert("Error: "+M.message)}},window.app_saveMinuteEdits=async v=>{try{const A=(await window.AppMinutes.getMinutes()).find(W=>W.id===v);if(!A)return alert("Minute not found.");const M=window.AppAuth.getUser(),O=A.createdBy===M.id,I=window.app_hasPerm("minutes","admin",M);if(!O&&!I)return alert("Only owner or admin can edit these minutes.");if(A.locked)return alert("This record is locked after final approvals.");const N=document.getElementById("minute-edit-title"),P=document.getElementById("minute-edit-date"),B=f("minute-edit-content-editor","minute-edit-content"),U=(N?.value||"").trim(),V=(P?.value||"").trim(),j=B.text;if(!U||!j)return alert("Title and content are required.");await window.AppMinutes.updateMinute(v,{title:U,date:V||A.date,content:j,contentHtml:B.html},"Edited meeting details"),alert("Minutes updated successfully."),window.app_openMinuteDetails(v),window.app_refreshMinutesView()}catch(x){alert("Error updating minutes: "+x.message)}},window.app_openMinuteDetails=async v=>{const A=(await window.AppMinutes.getMinutes()).find(q=>q.id===v);if(!A)return;if(!r(A))return alert("Access Restricted. Please request access from the list view.");const M=(A.attendeeIds||[]).includes(t.id),O=A.approvals&&A.approvals[t.id],I=A.createdBy===t.id,N=window.app_hasPerm("minutes","admin",t),P=(I||N)&&!A.locked,B=A.createdByName||e.find(q=>q.id===A.createdBy)?.name||"Unknown",U=A.lastEditedByName||B,V=A.lastEditedAt||A.createdAt,j=l(A.contentHtml||p(A.content||"")),W=(A.attendeeIds||[]).map(q=>{const X=e.find(ne=>ne.id===q),ee=A.approvals&&A.approvals[q];return`
                <div class="approval-chip ${ee?"approved":"pending"}">
                    <i class="fa-solid fa-${ee?"check-circle":"clock"}"></i>
                    ${D(X?.name||"Unknown")}
                </div>
            `}).join(""),J=(A.actionItems||[]).map((q,X)=>{const ee=e.find(ue=>ue.id===q.assignedTo),ne=q.assignedTo===t.id;return`
                <div class="detail-action-item">
                    <div class="action-status-dot ${q.status||"pending"}"></div>
                    <div class="action-main">
                        <strong>${D(q.task)}</strong>
                        <span class="action-meta">Assigned: ${D(ee?.name||"Unassigned")} | Due: ${q.dueDate||"N/A"}</span>
                    </div>
            ...
            `}).join(""),C=(A.accessRequests||[]).filter(q=>q.status==="pending").map(q=>`
            <div class="access-request-row">
                <span>${D(q.userName)}</span>
                <div class="req-btns">
        ...
        `).join(""),R=(A.auditLog||[]).slice().reverse().map(q=>`
            <div class="access-request-row" style="justify-content:space-between; align-items:flex-start;">
                <div style="display:flex; flex-direction:column; gap:0.2rem;">
                    <strong style="font-size:0.82rem;">${D(q.userName||"Unknown")}</strong>
                    <span style="font-size:0.75rem; color:#64748b;">${D(q.action||"Updated")}</span>
                </div>
                ...
                <div class="modal-content minutes-detail-wide">
                    <div class="modal-header">
                        <div>
                            ...
                            <h2 style="margin:0; color:#1e1b4b;">${D(A.title)}</h2>
                            <div style="font-size:0.78rem; color:#64748b; margin-top:0.35rem;">
                                Created by ${D(B)} on ${A.createdAt?new Date(A.createdAt).toLocaleString():"-"}
                            </div>
                            <div style="font-size:0.78rem; color:#64748b;">
                                Last edited by ${D(U)} on ${V?new Date(V).toLocaleString():"-"}
                            </div>
                        </div>
                        ...
                        <div class="detail-grid">
                            <div class="main-column">
                                <section>
                                    ...
                                    ${P?`
                                        <div style="display:grid; gap:0.6rem; margin-top:0.55rem;">
                                            <input id="minute-edit-title" class="input-premium" value="${Ie(A.title||"")}" />
                                            <input id="minute-edit-date" class="input-premium" type="date" value="${Ie(A.date||"")}" />
                                            <textarea id="minute-edit-content" class="textarea-premium" style="display:none;">${D(A.content||"")}</textarea>
                                    ...
                                    `:`<div class="content-text rich-minutes-content">${S(A.contentHtml,A.content)}</div>`}
                                </section>
                                ${J?`
                                <section>
                                ...
                                <section>
                                    ...
                                    <div class="access-requests-list" style="max-height:230px;">${R||'<p class="empty">No edit history yet.</p>'}</div>
                                </section>
                            </div>
                            <div class="side-column">
                                <section>
                                    ...
                                    ${M&&!O&&!A.locked?`<button class="action-btn wide" onclick="window.app_handleMinuteApproval('${A.id}')" style="margin-top:1rem;">Approve Minutes</button>`:""}
                                </section>
                                ${(I||N)&&C?`
                                <section class="owner-only">
                                    <label><i class="fa-solid fa-key"></i> Access Requests</label>
                                    <div class="access-requests-list">${C}</div>
                                </section>
                                `:""}
                            </div>
                        </div>
                    ...
                    <div class="modal-footer">
                        ...
                        ${P?`<button class="action-btn" onclick="window.app_saveMinuteEdits('${A.id}')">Save Changes</button>`:""}
                        ${I||N?`<button class="action-btn danger" onclick="window.app_deleteMinute('${A.id}')">Delete</button>`:""}
                    </div>
                </div>
            </div>
        `;if(!document.getElementById("modal-container")){const q=document.createElement("div");q.id="modal-container",document.body.appendChild(q)}document.getElementById("modal-container").innerHTML=G},window.app_deleteMinute=async v=>{if(confirm("Are you sure?"))try{await window.AppMinutes.deleteMinute(v),document.getElementById("minute-detail-modal")?.remove(),window.app_refreshMinutesView()}catch(x){alert("Error: "+x.message)}};const b=[...a].sort((v,x)=>{const A=m(v.date)?.getTime()||0;return(m(x.date)?.getTime()||0)-A}),$=y(o.monthKey),g=$.toLocaleDateString(void 0,{month:"long",year:"numeric"}),w=new Date($.getFullYear(),$.getMonth(),1),k=new Date(w);k.setDate(w.getDate()-w.getDay());const T=Array.from({length:42},(v,x)=>{const A=new Date(k);return A.setDate(k.getDate()+x),A}),E=b.reduce((v,x)=>{const A=m(x.date);if(!A)return v;const M=`${A.getFullYear()}-${String(A.getMonth()+1).padStart(2,"0")}-${String(A.getDate()).padStart(2,"0")}`;return v[M]||(v[M]=[]),v[M].push(x),v},{});return window.setTimeout(()=>window.app_filterMinutes(o.searchQuery||""),0),`
        <div class="minutes-container">
                ...
                <div class="field-group" style="margin-bottom: 2rem;">
                    ...
                    <div class="attendee-picker-container">
                        ...
                        <div class="attendee-grid">
                            ${e.map(v=>`
                                <label class="attendee-item-modern" data-name="${Ie(v.name||v.username)}">
                                    <input type="checkbox" value="${v.id}" onchange="window.app_toggleAttendeePick(this)">
                                    <span>${D(v.name||v.username)}</span>
                                </label>
                            `).join("")}
                        </div>
                    </div>
            ...
            <div class="minutes-list-header" style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 1.5rem; margin-top: 2rem;">
                ...
                <div style="position: relative; width: 300px;">
                    ...
                    <input type="text" placeholder="Search meetings..." value="${Ie(o.searchQuery||"")}" oninput="window.app_filterMinutes(this.value)" class="input-premium" style="padding-left: 2.75rem; width: 100%; padding-top: 0.6rem; padding-bottom: 0.6rem; font-size: 0.9rem;">
                </div>
            </div>
            ...
            ${o.viewMode==="calendar"?`
                <div class="minutes-calendar-shell">
                    <div class="minutes-calendar-toolbar">
                        <div>
                            <div class="minutes-calendar-month">${g}</div>
                    ...
                    <div class="minutes-calendar-grid">
                        ${["Sun","Mon","Tue","Wed","Thu","Fri","Sat"].map(v=>`<div class="minutes-calendar-weekday">${v}</div>`).join("")}
                        ${T.map(v=>{const x=`${v.getFullYear()}-${String(v.getMonth()+1).padStart(2,"0")}-${String(v.getDate()).padStart(2,"0")}`,A=E[x]||[],M=v.getMonth()===$.getMonth(),O=v.toDateString()===i.toDateString();return`
                                <div class="minutes-calendar-day ${M?"":"is-outside-month"} ${O?"is-today":""} ${A.length?"has-visible-meeting":""}">
                                    <div class="minutes-calendar-dayhead">
                                        <span class="minutes-calendar-date">${v.getDate()}</span>
                                        <span class="minutes-calendar-count">${A.length?`${A.length} meeting${A.length===1?"":"s"}`:""}</span>
                                    </div>
                                    <div class="minutes-calendar-items">
                                        ${A.map(I=>{const N=r(I),P=d(I);return`
                                                <div class="minutes-calendar-entry ${N?"clickable":""}" data-search-text="${Ie(h(I))}" ${N?`onclick="window.app_openMinuteDetails('${I.id}')"`:""}>
                                                    <div class="minutes-calendar-entry-title">${D(I.title)}</div>
                    ...
                    <div id="minutes-calendar-empty-state" class="minutes-no-results">No meetings match this search in ${g}.</div>
                </div>
            `:`
            <div class="minutes-list-container">
                ${b.length?b.map(v=>{const x=r(v),A=d(v);return`
                        <div class="minute-card-modern ${x?"clickable":""}" data-search-text="${Ie(h(v))}" ${x?`onclick="window.app_openMinuteDetails('${v.id}')"`:""}>
                            <div class="card-date-badge">${u(v.date)}</div>
                            
                            <div class="minute-card-status">
                                ${v.locked?'<span style="background:#dcfce7; color:#166534; padding:0.25rem 0.75rem; border-radius:999px; font-size:0.75rem; font-weight:700;"><i class="fa-solid fa-lock" style="margin-right:0.35rem;"></i>Locked</span>':'<span style="background:#fff7ed; color:#9a3412; padding:0.25rem 0.75rem; border-radius:999px; font-size:0.75rem; font-weight:700;">Open</span>'}
                            </div>

                            <h4 class="card-title-modern">${D(v.title)}</h4>
                            
                            <div class="card-metrics">
                                <div class="metric-item">
                                    <i class="fa-solid fa-users"></i>
                                    ${v.attendeeIds?.length||0} Attendees
                                </div>
                                <div class="metric-item">
                                    <i class="fa-solid fa-check-circle"></i>
                                    ${v.actionItems?.length||0} Tasks
                                </div>
                            </div>
    ...
    `}function Vn(a=[]){let e="";a&&a.length>0&&(e=`
            <div style="margin-bottom:1.5rem; padding-bottom:1.5rem; border-bottom:1px dashed #cbd5e1;">
                ...
                <span style="font-weight:600;">•</span> ${D(s.task)}
    ...
    <div class="modal-overlay" id="checkin-modal" style="display:flex;">
    ...
    </div>`}function Kn(){if(typeof window>"u")return;const a=new MutationObserver(t=>{t.forEach(()=>{const n=document.getElementById("checkout-modal"),i=document.getElementById("checkout-intro-panel");n&&i&&n.style.display!=="none"&&(localStorage.getItem("checkoutIntroSeen")||(i.style.display="block"))})}),e=()=>{const t=document.body;t&&a.observe(t,{attributes:!0,subtree:!0,attributeFilter:["style"]})};document.readyState==="loading"?document.addEventListener("DOMContentLoaded",e):e()}typeof window<"u"&&Kn();function Gn(){return`
     ...
     `}function Jn(){return window.AppAuth?.getUser()?`
        <!-- Check-Out Modal -->
    ...
    `:""}const gt=50,Xn=250;function qa(){const a=new Date,e=new Date;return e.setDate(a.getDate()-30),{startIso:e.toISOString().split("T")[0],endIso:a.toISOString().split("T")[0]}}function Se(){if(!window.app_teamActivitiesState){const a=qa();window.app_teamActivitiesState={startIso:a.startIso,endIso:a.endIso,staffIds:[],status:"all",type:"all",search:"",sortKey:"date-desc",page:1,pageSize:gt,columnVisibility:{type:!0,status:!0,sourceTime:!0},users:[],data:[],filtered:[],lastRefreshed:null}}return window.app_teamActivitiesState}function Qn(a){return(a||[]).map(e=>{const t=e.type||(e.workDescription?"attendance":"work"),n=e._displayDesc||e.workDescription||e.task||"Activity",i=e.checkOut||e._sortTime||"00:00",s=e.status||(t==="attendance"?"completed":""),o=window.AppCalendar?window.AppCalendar.getSmartTaskStatus(e.date,s):s||"to-be-started";return{date:e.date||"",staffName:e.staffName||e.userName||"Unknown Staff",type:t,description:n,status:o,sourceTime:i,userId:e.userId||e.user_id||"",planId:e.planId||e.id||"",taskIndex:Number.isInteger(e.taskIndex)?e.taskIndex:null,planScope:e.planScope||"personal",progressPercent:Number.isFinite(Number(e.progressPercent))?Number(e.progressPercent):null,progressStatus:e.progressStatus||"",progressNote:e.progressNote||""}})}function Zn(a){const e=String(a||"").toLowerCase();return["overdue","not-completed","to-be-started","in-process"].includes(e)}function ei(a){const e=new Date(a);return Number.isNaN(e.getTime())?new Date().toISOString().split("T")[0]:(e.setDate(e.getDate()+1),e.toISOString().split("T")[0])}function ti(a){const e=String(a||"").trim();if(!e||!/^\d{4}-\d{2}-\d{2}$/.test(e))return!1;const t=new Date(e);return!Number.isNaN(t.getTime())&&t.toISOString().startsWith(e)}function ai(a,e){return new Promise(t=>{if(!a){t(null);return}const n=document.getElementById("team-activities-postpone-popover");n&&n.remove();const i=document.createElement("div");i.id="team-activities-postpone-popover",i.className="team-activities-postpone-popover",i.innerHTML=`
        ...
        `,document.body.appendChild(i);const s=a.getBoundingClientRect(),o=s.bottom+window.scrollY+8,r=Math.min(s.left+window.scrollX,window.innerWidth-260);i.style.top=`${o}px`,i.style.left=`${r}px`;const d=i.querySelector(".team-activities-postpone-input");d&&d.focus();const l=p=>{document.removeEventListener("click",c,!0),i.remove(),t(p)},c=p=>{!i.contains(p.target)&&p.target!==a&&l(null)};document.addEventListener("click",c,!0),i.addEventListener("click",p=>{const m=p.target;if(m.closest("[data-postpone-cancel]")&&l(null),m.closest("[data-postpone-confirm]")){const u=d?d.value:"";l(u||null)}})})}function ni(a){const e=a.search.trim().toLowerCase(),t=new Set(a.staffIds||[]),n=a.status,i=a.type;let s=a.data.filter(o=>!(t.size&&!t.has(o.userId)||i!=="all"&&o.type!==i||n!=="all"&&String(o.status||"").toLowerCase()!==n||e&&!`${o.date} ${o.staffName} ${o.description} ${o.status} ${o.type}`.toLowerCase().includes(e)));return s=ii(s,a.sortKey),a.filtered=s,s}function ii(a,e){const t=[...a];return t.sort((n,i)=>{const s=new Date(i.date)-new Date(n.date),o=String(i.sourceTime||"").localeCompare(String(n.sourceTime||"")),r=String(n.staffName||"").localeCompare(String(i.staffName||""));return e==="date-asc"?new Date(n.date)-new Date(i.date)||o:e==="staff-asc"?r||s:e==="staff-desc"?-r||s:e==="status"?String(n.status||"").localeCompare(String(i.status||""))||s:e==="type"?String(n.type||"").localeCompare(String(i.type||""))||s:e==="time"?String(n.sourceTime||"").localeCompare(String(i.sourceTime||""))||s:s||o}),t}function si(a,e,t){const i=(Math.max(1,e)-1)*t;return a.slice(i,i+t)}function za(a){const e=a.filtered.length,t=new Set(a.filtered.map(s=>s.userId).filter(Boolean)),n=a.filtered.filter(s=>String(s.status).toLowerCase()==="completed").length,i=e-n;return`
    ...
    `}function ja(a){const e=a.users||[],t=new Set(a.staffIds||[]),n=t.size?`${t.size} selected`:"All staff",i=e.map(s=>`
    ...
    `}function Ya(a){const e=a.columnVisibility;return`
    ...
    `}function oi(a){const e=a.columnVisibility,t=si(a.filtered,a.page,a.pageSize);if(!t.length)return'<div class="team-activities-empty">No activities found for the selected filters.</div>';const n=`
        ...
        <th>Actions</th>
    `,i=window.AppAuth?.getUser?window.AppAuth.getUser()?.id:null,s=window.AppAuth?.getUser?window.AppAuth.getUser():null,o=!!(s&&(s.role==="Administrator"||s.isAdmin)),r=t.map(d=>{const l=String(d.status||"").toLowerCase().replace(/\s+/g,"-"),c=i&&d.userId&&i===d.userId,p=d.type==="work"&&d.planId&&Number.isInteger(d.taskIndex)&&(c||o),m=d.type==="work"&&(d.progressPercent!==null||d.progressStatus||d.progressNote),u=d.progressStatus?String(d.progressStatus).replace(/_/g," "):"",y=d.progressPercent!==null?`${d.progressPercent}%`:"",h=String(d.progressNote||"").trim(),f=h?` title="${D(h)}"`:"",S=m?`<div class="team-activities-progress"${f}>${D(y)}${y&&u?" • ":""}${D(u)}</div>`:"";return`
        <tr>
            <td>${D(d.date)}</td>
            <td>${D(d.staffName)}</td>
            ${e.type?`<td class="team-activities-type">${D(d.type)}</td>`:""}
            ${e.status?`<td><span class="team-activities-status status-${D(l)}">${D(d.status)}</span></td>`:""}
            <td class="team-activities-desc">${D(d.description)}${S}</td>
            ${e.sourceTime?`<td>${D(d.sourceTime||"--")}</td>`:""}
            <td>
                <div class="team-activities-row-actions">
                    <button class="team-activities-row-btn" data-view-date="${D(d.date)}" data-view-user="${D(d.userId)}">
                        <i class="fa-solid fa-eye"></i> View
                    </button>
                    ${d.type==="work"&&c&&Zn(d.status)&&d.planId&&Number.isInteger(d.taskIndex)?`
                        <button class="team-activities-row-btn warn" data-action="postpone" data-plan-id="${D(d.planId)}" data-task-index="${d.taskIndex}" data-plan-scope="${D(d.planScope)}" data-user-id="${D(d.userId)}" data-date="${D(d.date)}">
                            <i class="fa-solid fa-clock"></i> Postpone
                        </button>
                        <button class="team-activities-row-btn success" data-action="complete" data-plan-id="${D(d.planId)}" data-task-index="${d.taskIndex}" data-user-id="${D(d.userId)}">
                            <i class="fa-solid fa-check"></i> Complete
                        </button>
                    `:""}
                    ${p?`
                        <button class="team-activities-row-btn danger" data-action="remove" data-plan-id="${D(d.planId)}" data-task-index="${d.taskIndex}" data-user-id="${D(d.userId)}">
    ...
    `}function ri(a){const e=a.filtered.length,t=Math.max(1,Math.ceil(e/a.pageSize)),n=Math.min(a.page,t);return`
    ...
    `}function he(){const a=Se();ni(a);const e=Math.max(1,Math.ceil(a.filtered.length/a.pageSize));a.page>e&&(a.page=e);const t=document.getElementById("team-activities-summary"),n=document.getElementById("team-activities-table-wrap"),i=document.getElementById("team-activities-pagination-wrap"),s=document.getElementById("team-activities-last-updated"),o=document.getElementById("team-activities-columns-wrap"),r=document.getElementById("team-activities-staff-wrap");t&&(t.innerHTML=za(a)),n&&(n.innerHTML=oi(a)),i&&(i.innerHTML=ri(a)),o&&(o.innerHTML=Ya(a)),r&&(r.innerHTML=ja(a)),s&&a.lastRefreshed&&(s.textContent=new Date(a.lastRefreshed).toLocaleString())}async function Me(){const a=Se(),e=document.getElementById("team-activities-loading");e&&(e.style.display="block");try{const t=await window.AppAnalytics.getAllStaffActivities({mode:"range",startIso:a.startIso,endIso:a.endIso,scope:"all"});a.data=Qn(t),a.lastRefreshed=Date.now(),a.page=1}catch(t){console.error("Team Activities fetch failed",t)}finally{e&&(e.style.display="none")}he()}function pt(){const a=Se(),e=document.getElementById("team-activities-start"),t=document.getElementById("team-activities-end"),n=document.getElementById("team-activities-type"),i=document.getElementById("team-activities-status"),s=document.getElementById("team-activities-search"),o=document.getElementById("team-activities-page-size");e&&(a.startIso=e.value||a.startIso),t&&(a.endIso=t.value||a.endIso),n&&(a.type=n.value||"all"),i&&(a.status=i.value||"all"),s&&(a.search=s.value||""),o&&(a.pageSize=Number(o.value)||gt),a.page=1,he()}function di(){const a=Se();if(a.bound)return;a.bound=!0;let e=null;document.addEventListener("click",async t=>{const n=t.target,i=n.closest("[data-team-activities-staff-toggle]"),s=document.getElementById("team-activities-staff-panel"),o=n.closest("[data-team-activities-columns-toggle]"),r=document.getElementById("team-activities-columns-popover");i&&s?s.classList.toggle("open"):s&&!s.contains(n)&&s.classList.remove("open"),o&&r?r.classList.toggle("open"):r&&!r.contains(n)&&r.classList.remove("open");const d=n.closest(".team-activities-page-btn");if(d){const y=d.dataset.page,h=Math.max(1,Math.ceil(a.filtered.length/a.pageSize));y==="prev"&&(a.page=Math.max(1,a.page-1)),y==="next"&&(a.page=Math.min(h,a.page+1)),he()}const l=n.closest("[data-view-date]");if(l){const y=l.getAttribute("data-view-date"),h=l.getAttribute("data-view-user");window.app_openDayPlan&&window.app_openDayPlan(y,h||"")}const c=n.closest("[data-action]");if(c){const y=c.getAttribute("data-action");y==="complete"&&window.app_teamActivitiesCompleteTask&&await window.app_teamActivitiesCompleteTask(c),y==="postpone"&&window.app_teamActivitiesPostponeTask&&await window.app_teamActivitiesPostponeTask(c),y==="remove"&&window.app_teamActivitiesRemoveTask&&await window.app_teamActivitiesRemoveTask(c)}const p=n.closest("th[data-sort]");if(p){const y=p.dataset.sort;y&&(a.sortKey=y,he())}n.closest("[data-staff-select-all]")&&(a.staffIds=(a.users||[]).map(y=>y.id),he()),n.closest("[data-staff-clear]")&&(a.staffIds=[],he())}),document.addEventListener("change",t=>{const n=t.target;if(n.matches("#team-activities-start, #team-activities-end")?(pt(),Me()):n.matches("#team-activities-type, #team-activities-status, #team-activities-page-size")&&pt(),n.matches('#team-activities-columns-popover input[type="checkbox"]')){const i=n.getAttribute("data-column");i&&(a.columnVisibility[i]=n.checked),he()}if(n.matches('#team-activities-staff-panel input[type="checkbox"]')){const i=n.getAttribute("data-staff-id");if(!i)return;n.checked?a.staffIds.includes(i)||a.staffIds.push(i):a.staffIds=a.staffIds.filter(s=>s!==i),he()}}),document.addEventListener("input",t=>{t.target.matches("#team-activities-search")&&(e&&clearTimeout(e),e=setTimeout(()=>pt(),Xn))})}function li(a){const e=["Date","Staff","Type","Status","Description","Time"],t=a.map(n=>[n.date,n.staffName,n.type,n.status,n.description,n.sourceTime].map(i=>`"${String(i||"").replace(/"/g,'""')}"`).join(","));return[e.join(","),...t].join(`
`)}typeof window<"u"&&(window.app_initTeamActivities=async function(){const a=Se(),e=await window.AppAnalytics.getUsersCached();a.users=e||[],di(),he(),await Me()},window.app_teamActivitiesRefresh=async function(){pt(),await Me()},window.app_teamActivitiesResetFilters=function(){const a=Se(),e=qa();a.startIso=e.startIso,a.endIso=e.endIso,a.staffIds=[],a.status="all",a.type="all",a.search="",a.sortKey="date-desc",a.page=1,a.pageSize=gt;const t=document.getElementById("team-activities-start"),n=document.getElementById("team-activities-end"),i=document.getElementById("team-activities-type"),s=document.getElementById("team-activities-status"),o=document.getElementById("team-activities-search"),r=document.getElementById("team-activities-page-size");t&&(t.value=a.startIso),n&&(n.value=a.endIso),i&&(i.value="all"),s&&(s.value="all"),o&&(o.value=""),r&&(r.value=String(gt)),he(),Me()},window.app_teamActivitiesCopyCSV=async function(){const a=Se(),e=li(a.filtered);try{await navigator.clipboard.writeText(e),alert("Table copied to clipboard.")}catch(t){console.warn("Clipboard copy failed",t),alert("Copy failed. Please use Export Excel instead.")}},window.app_teamActivitiesExportXLSX=function(){const a=Se();window.AppReports?.exportTeamActivitiesXLSX?window.AppReports.exportTeamActivitiesXLSX(a.filtered,{start:a.startIso,end:a.endIso}):alert("Export module not available.")},window.app_teamActivitiesCompleteTask=async function(a){try{const e=window.AppAuth?.getUser?window.AppAuth.getUser()?.id:null,t=a.getAttribute("data-plan-id"),n=Number(a.getAttribute("data-task-index")),i=a.getAttribute("data-user-id")||"";if(!e||e!==i){alert("Only the assigned staff member can complete this task.");return}if(!t||!Number.isInteger(n)||!window.AppCalendar?.updateTaskStatus)return;a.disabled=!0,await window.AppCalendar.updateTaskStatus(t,n,"completed"),await Me(),window.app_showSyncToast&&window.app_showSyncToast("Task marked as completed.")}catch(e){console.error("Complete task failed",e),alert("Failed to complete task.")}},window.app_teamActivitiesPostponeTask=async function(a){try{const e=window.AppAuth?.getUser?window.AppAuth.getUser()?.id:null,t=a.getAttribute("data-plan-id"),n=Number(a.getAttribute("data-task-index")),i=a.getAttribute("data-plan-scope")||"personal",s=a.getAttribute("data-user-id")||"",o=a.getAttribute("data-date")||"";if(!e||e!==s){alert("Only the assigned staff member can postpone this task.");return}if(!t||!Number.isInteger(n)||!window.AppDB||!window.AppCalendar)return;a.disabled=!0;const r=await window.AppDB.get("work_plans",t);if(!r||!Array.isArray(r.plans)||!r.plans[n])throw new Error("Plan or task not found");const d=ei(o),l=await ai(a,d);if(!l){a.disabled=!1;return}const c=String(l).trim();if(!ti(c)){alert("Invalid date. Please use YYYY-MM-DD."),a.disabled=!1;return}const[p]=r.plans.splice(n,1);r.updatedAt=new Date().toISOString(),await window.AppDB.put("work_plans",r);const m=c,u=i||r.planScope||"personal",y=u==="annual"?"annual_shared":r.userId||s,h=window.AppCalendar.getWorkPlanId(m,y,u),f={...p,status:"",startDate:m,endDate:m};delete f.completedDate;const S=await window.AppDB.get("work_plans",h);if(S)S.plans=Array.isArray(S.plans)?S.plans:[],S.plans.push(f),S.updatedAt=new Date().toISOString(),await window.AppDB.put("work_plans",S);else{const _=u==="annual"?null:y;await window.AppCalendar.setWorkPlan(m,[f],_,{planScope:u})}await Me(),window.app_showSyncToast&&window.app_showSyncToast(`Task postponed to ${m}.`)}catch(e){console.error("Postpone task failed",e),alert("Failed to postpone task.")}},window.app_teamActivitiesRemoveTask=async function(a){try{const e=window.AppAuth?.getUser?window.AppAuth.getUser():null,t=e?.id||null,n=!!(e&&(e.role==="Administrator"||e.isAdmin)),i=a.getAttribute("data-plan-id"),s=Number(a.getAttribute("data-task-index")),o=a.getAttribute("data-user-id")||"";if(!i||!Number.isInteger(s)||!window.AppCalendar?.removeTask)return;if(!n&&(!t||t!==o)){alert("Only the assigned staff member or an admin can remove this task.");return}if(!window.appConfirm||!await window.appConfirm("Remove this task so it stops carrying forward?"))return;a.disabled=!0,await window.AppCalendar.removeTask(i,s),await Me(),window.app_showSyncToast&&window.app_showSyncToast("Task removed.")}catch(e){console.error("Remove task failed",e),alert("Failed to remove task.")}});async function ci(){const a=Se();return`
            ...
            <div class="team-activities-header">
                ...
                <div class="team-activities-actions">
                    ...
                    <div class="team-activities-columns">
                        ...
                        <div id="team-activities-columns-wrap">${Ya(a)}</div>
                    </div>
                </div>
            </div>
            <div class="team-activities-summary" id="team-activities-summary">${za(a)}</div>
...
`),c=`Attendance_Sheet_${new Date(t,e).toLocaleString("default",{month:"long"})}_${t}.csv`;return this.downloadFile(d,c,"text/csv"),!0}catch(s){console.error("Export Failed:",s),alert("Export Failed: "+s.message)}}async exportLeavesCSV(e){try{const t=["Applied On","Staff Name","FY","Type","From","To","Days/Hrs","Reason","Status","Admin Comment"],n=["appliedOn","userName","financialYear","type","startDate","endDate","daysCount","reason","status","adminComment"],i=e.map(r=>({...r,daysCount:r.type==="Short Leave"?`${r.durationHours||0}h`:r.daysCount})),s=this.convertToCSV(i,t,n),o=`Leave_Requests_${new Date().toISOString().split("T")[0]}.csv`;return this.downloadFile(s,o,"text/csv"),!0}catch(t){console.error("Leave Export Failed:",t),alert("Export Failed: "+t.message)}}async exportCalendarPlansCSV(e,t,n){try{const i=[],s=new Date(n,t+1,0).getDate(),o=new Date(n,t).toLocaleString("default",{month:"long"});for(let p=1;p<=s;p++){const m=`${n}-${String(t+1).padStart(2,"0")}-${String(p).padStart(2,"0")}`;e.leaves.forEach(u=>{m>=u.startDate&&m<=u.endDate&&i.push({date:m,category:"Leave",subject:`${u.userName||"Staff"} - ${u.type}`,details:u.reason||"No reason provided",staff:u.userName||"Staff"})}),e.events.forEach(u=>{u.date===m&&i.push({date:m,category:"Event",subject:u.title,details:u.type||"General Event",staff:"Organization"})}),e.workPlans.forEach(u=>{if(u.date===m){const y=Array.isArray(u.plans)?u.plans:[],h=y.length>0?y.map((f,S)=>{let _=`${S+1}. ${f.task}`;return f.subPlans&&f.subPlans.length>0&&(_+=` (Steps: ${f.subPlans.join(", ")})`),f.tags&&f.tags.length>0&&(_+=` [With: ${f.tags.map(b=>`@${b.name} (${b.status||"pending"})`).join(", ")}]`),_}).join(" | "):"Work Plan";i.push({date:m,category:"Work Plan",subject:"Daily Goals",details:h,staff:u.userName||"Staff"})}})}if(i.length===0)return alert("No plans found for the selected month."),!1;const r=["Date","Category","Subject","Details","Staff Member"],d=["date","category","subject","details","staff"],l=this.convertToCSV(i,r,d),c=`Team_Schedule_${o}_${n}.csv`;return this.downloadFile(l,c,"text/csv"),!0}catch(i){console.error("Calendar Export Failed:",i),alert("Failed to export calendar: "+i.message)}}async exportAnnualListViewCSV(e){try{const t=(e||[]).map(r=>({date:r.date||"",staffName:r.staffName||r.staff||"",assignedBy:r.assignedBy||"",assignedTo:r.assignedTo||"",selfAssigned:r.selfAssigned?"Yes":"No",dueDate:r.dueDate||"",status:r.statusLabel||r.status||"",comments:r.comments||"",tags:Array.isArray(r.tags)?r.tags.join(", "):r.tags||""})),n=["Date","Staff Name","Assigned By","Assigned To","Self Assigned","Due Date","Completion Status","Comments","Tags"],i=["date","staffName","assignedBy","assignedTo","selfAssigned","dueDate","status","comments","tags"],s=this.convertToCSV(t,n,i),o=`Annual_Plan_List_${new Date().toISOString().split("T")[0]}.csv`;return this.downloadFile(s,o,"text/csv"),!0}catch(t){throw console.error("List Export Failed:",t),new Error("Failed to export list: "+t.message)}}exportTeamActivitiesXLSX(e,t={}){try{if(typeof window>"u"||!window.XLSX)return alert("Excel export library not loaded."),!1;const n=(e||[]).map(p=>[p.date||"",p.staffName||"",p.type||"",p.status||"",p.description||"",p.sourceTime||""]),i=["Date","Staff","Type","Status","Description","Time"],s=window.XLSX.utils.aoa_to_sheet([i,...n]),o=window.XLSX.utils.book_new();window.XLSX.utils.book_append_sheet(o,s,"Team Activities");const r=(t.start||"").replace(/[^a-zA-Z0-9_-]/g,"_"),d=(t.end||"").replace(/[^a-zA-Z0-9_-]/g,"_"),c=`Team_Activities_${r&&d?`${r}_to_${d}`:r||d||"export"}.xlsx`;return window.XLSX.writeFile(o,c),!0}catch(n){return console.error("Team Activities Export Failed:",n),alert("Export Failed: "+n.message),!1}}}const bi=new vi;typeof window<"u"&&(window.AppReports=bi);class Si{constructor(){this.db=K,this.cache={},this.defaultPolicy={"Annual Leave":{total:10,minDays:3,accrual:"annual"},"Casual Leave":{total:6,maxDays:2,accrual:"monthly"},"Medical Leave":{total:6,certificateThreshold:2,accrual:"annual"},"Maternity Leave":{total:180,paid:!0,gender:"female"},"Paternity Leave":{total:10,paid:!0,gender:"male",minServiceYears:0},"Study Leave":{total:5,paid:!1,requireApproval:!0},"Compassionate Leave":{total:3,paid:!0}}}async getPolicy(){if(this.cache.policy)return this.cache.policy;try{if(window.AppFirestore){const e=await window.AppFirestore.collection("settings").doc("policies").get();e.exists?this.cache.policy={...this.defaultPolicy,...e.data()}:this.cache.policy=this.defaultPolicy}else this.cache.policy=this.defaultPolicy}catch(e){console.warn("Failed to fetch dynamic policy, using default.",e),this.cache.policy=this.defaultPolicy}return this.cache.policy}async updatePolicy(e){try{if(window.AppFirestore)return await window.AppFirestore.collection("settings").doc("policies").set(e,{merge:!0}),this.cache.policy=null,!0;throw new Error("Database not connected")}catch(t){throw console.error("Failed to update policy:",t),t}}async getFinancialYear(e=new Date){const t=e.getMonth(),n=e.getFullYear();return t<3?{label:`${n-1}-${n}`,start:new Date(n-1,3,1),end:new Date(n,2,31)}:{label:`${n}-${n+1}`,start:new Date(n,3,1),end:new Date(n+1,2,31)}}async getUserLeaves(e,t=null){t||(t=(await this.getFinancialYear()).label);try{if(this.db.queryMany&&L?.READ_OPT_FLAGS?.FF_READ_OPT_DB_QUERIES)return(await this.db.queryMany("leaves",[{field:"userId",operator:"==",value:e},{field:"financialYear",operator:"==",value:t}])).sort((s,o)=>new Date(o.startDate)-new Date(s.startDate))}catch(i){console.warn("Scoped getUserLeaves query failed, using fallback",i)}return(await this.db.getAll("leaves")).filter(i=>i.userId===e&&i.financialYear===t).sort((i,s)=>new Date(s.startDate)-new Date(i.startDate))}async getLeaveUsage(e,t,n){return(await this.getUserLeaves(e,n.label)).filter(o=>o.type===t&&(o.status==="Approved"||o.status==="Pending")).reduce((o,r)=>o+(parseFloat(r.daysCount)||0),0)}async getMonthlyShortLeaveUsage(e,t){const n=`${t.getFullYear()}-${String(t.getMonth()+1).padStart(2,"0")}`;let i=[];try{this.db.queryMany&&L?.READ_OPT_FLAGS?.FF_READ_OPT_DB_QUERIES&&(i=(await this.db.queryMany("leaves",[{field:"userId",operator:"==",value:e},{field:"type",operator:"==",value:"Short Leave"},{field:"startDate",operator:">=",value:`${n}-01`},{field:"startDate",operator:"<=",value:`${n}-31`}])).filter(o=>o.status==="Approved"||o.status==="Pending"))}catch(s){console.warn("Scoped short leave query failed, using fallback",s)}return i.length||(i=(await this.db.getAll("leaves")).filter(o=>o.userId===e&&o.type==="Short Leave"&&String(o.startDate||"").startsWith(n)&&(o.status==="Approved"||o.status==="Pending"))),i.reduce((s,o)=>s+(parseFloat(o.daysCount||o.durationHours)||0),0)}async getPendingLeaves(){try{let e=[];if(this.db.queryMany&&L?.READ_OPT_FLAGS?.FF_READ_OPT_DB_QUERIES?e=(await this.db.queryMany("leaves",[{field:"status",operator:"==",value:"Pending"}],{orderBy:[{field:"appliedOn",direction:"desc"}]})).sort((n,i)=>new Date(i.appliedOn)-new Date(n.appliedOn)):e=(await this.db.getAll("leaves")).filter(n=>n.status==="Pending").sort((n,i)=>new Date(i.appliedOn)-new Date(n.appliedOn)),e.length>0){const t=await this.db.getAll("users"),n={};t.forEach(i=>{n[i.id]=i.name}),e.forEach(i=>{!i.userName&&n[i.userId]&&(i.userName=n[i.userId])})}return e}catch(e){return console.warn("getPendingLeaves failed, using fallback",e),(await this.db.getAll("leaves").catch(()=>[])).filter(n=>n.status==="Pending").sort((n,i)=>new Date(i.appliedOn)-new Date(n.appliedOn))}}async requestLeave(e){const{userId:t,startDate:n,endDate:i,type:s,durationHours:o}=e,r=new Date(n),d=new Date(i);let l=Math.ceil((d-r)/(1e3*60*60*24))+1;if(l<=0&&s!=="Short Leave")throw new Error("Invalid date range");const c=await this.getFinancialYear(r),p=await this.getLeaveUsage(t,s,c),u=(await this.getPolicy())[s],y=[];if(s==="Half Day")l=.5,e.daysCount=.5;else if(s==="Short Leave"){const f=await this.getMonthlyShortLeaveUsage(t,r);let S=parseFloat(o||0);S>2&&y.push("Short Leave exceeds 2 hours (standard)."),f+S>4&&y.push(`Monthly Short Leave limit exceeded (${f+S}/4 hours).`),e.daysCount=S}else if(s==="Annual Leave")l<(u.minDays||1)&&y.push(`Annual Leave requested is less than required minimum (${u.minDays||1} days).`),p+l>u.total&&y.push(`Annual Leave balance exceeded (${p+l}/${u.total}).`);else if(s==="Casual Leave")l>u.maxDays&&y.push(`Casual Leave exceeds maximum allowed per request (${u.maxDays} days).`),p+l>u.total&&y.push(`Casual Leave balance exceeded (${p+l}/${u.total}).`);else if(s==="Medical Leave")p+l>u.total&&y.push(`Medical Leave balance exceeded (${p+l}/${u.total}).`),l>u.certificateThreshold&&(e.requireCertificate=!0);else if(s==="Paternity Leave"){const f=await this.db.get("users",t),S=new Date(f.joinDate),_=(r-S)/(1e3*60*60*24*365.25);u.minServiceYears&&_<u.minServiceYears&&y.push(`User has not completed ${u.minServiceYears} year(s) of service (required for Paternity Leave).`),l>u.total&&y.push(`Paternity Leave exceeds limit of ${u.total} days.`)}else["Study Leave","Compassionate Leave"].includes(s)&&u&&l>u.total&&y.push(`${s} exceeds limit of ${u.total} days.`);const h={id:"l"+Date.now(),...e,status:"Pending",appliedOn:new Date().toISOString(),financialYear:c.label,daysCount:l,policyWarnings:y};return await this.db.add("leaves",h),h}async updateLeaveStatus(e,t,n,i=""){const s=await this.db.get("leaves",e);if(!s)throw new Error("Leave not found");const o=n||window.AppAuth?.getUser?.()?.id||null;if(s.status=t,s.actionDate=new Date().toISOString(),s.adminComment=i,o?s.actionBy=o:delete s.actionBy,await this.db.put("leaves",s),t==="Approved"){const r=new Date(s.startDate),d=new Date(s.endDate);let l=new Date(r);for(;l<=d;){const c=l.toISOString().split("T")[0],p={id:"att_"+s.userId+"_"+c,user_id:s.userId,date:c,checkIn:"09:00",checkOut:"17:00",duration:"8h 0m",location:"On Leave",type:s.type,status:"in",synced:!1};await this.db.put("attendance",p),l.setDate(l.getDate()+1)}}return s}}const $e=new Si;typeof window<"u"&&(window.AppLeaves=$e);class ki{constructor(){this.db=K,this.cleanupFlag=L?.SIMULATION_POLICY?.LEGACY_DUMMY_CLEANUP?.FLAG_KEY||"legacy_dummy_cleanup_v1",this.simulationFlag="simulation_run_v2"}getCleanupPolicy(){const e=L?.SIMULATION_POLICY?.LEGACY_DUMMY_CLEANUP||{},t=new Set((e.TARGET_USER_IDS||[]).map(i=>String(i||"").trim()).filter(Boolean)),n=new Set((e.TARGET_USERNAMES||[]).map(i=>String(i||"").trim().toLowerCase()).filter(Boolean));return{enabled:e.ENABLED!==!1,targetIds:t,targetUsernames:n,auditCollection:String(e.AUDIT_COLLECTION||"system_audit_logs")}}async writeCleanupAudit(e,t={}){const n=this.getCleanupPolicy();try{await this.db.add(n.auditCollection,{type:e,module:"simulation",payload:t,createdAt:Date.now()})}catch(i){console.warn("Simulation audit log write failed:",i)}}async run(){const e=L&&L.READ_OPT_FLAGS||{},t=typeof window<"u"&&window.location&&window.location.hostname?window.location.hostname:"",n=t==="localhost"||t==="127.0.0.1";if(!(!e.ENABLE_SIMULATION_MODULE&&!n)){if(localStorage.getItem(this.cleanupFlag)||(await this.cleanupLegacyDummyData(),localStorage.setItem(this.cleanupFlag,"true")),localStorage.getItem(this.simulationFlag)){console.log("Simulation already ran. Use window.AppSimulation.forceRun() to force.");return}await this.forceRun(),localStorage.setItem(this.simulationFlag,"true")}}async cleanupLegacyDummyData(){const e=this.getCleanupPolicy();if(e.enabled){if(e.targetIds.size===0&&e.targetUsernames.size===0){await this.writeCleanupAudit("legacy_dummy_cleanup_skipped",{reason:"no_targets"});return}try{const n=(await this.db.getAll("users")).filter(m=>e.targetIds.has(m.id)||e.targetUsernames.has((m.username||"").trim().toLowerCase())),i=new Set(n.map(m=>m.id));if(i.size===0){await this.writeCleanupAudit("legacy_dummy_cleanup_skipped",{reason:"no_matches",configuredTargets:{ids:Array.from(e.targetIds),usernames:Array.from(e.targetUsernames)}});return}let s=0,o=0,r=0,d=0;const l=await this.db.getAll("attendance");for(const m of l){const u=m.user_id||m.userId;i.has(u)&&(await this.db.delete("attendance",m.id),s+=1)}const c=await this.db.getAll("leaves");for(const m of c){const u=m.userId||m.user_id;i.has(u)&&(await this.db.delete("leaves",m.id),o+=1)}const p=await this.db.getAll("work_plans");for(const m of p){const u=m.userId||m.user_id;i.has(u)&&(await this.db.delete("work_plans",m.id),r+=1)}for(const m of n)await this.db.delete("users",m.id),d+=1;await this.writeCleanupAudit("legacy_dummy_cleanup_completed",{matchedUserIds:Array.from(i),deleted:{attendance:s,leaves:o,workPlans:r,users:d}}),console.log("Legacy dummy users and linked records removed.",{users:d,attendance:s,leaves:o,workPlans:r})}catch(t){await this.writeCleanupAudit("legacy_dummy_cleanup_failed",{message:t?.message||String(t)}),console.warn("Legacy dummy cleanup failed:",t)}}}async forceRun(){console.log("Starting Office Scenario Simulation (V2)...");const e=new Date;if(window.AppCalendar){const t=new Date(e);t.setDate(t.getDate()+1),await window.AppCalendar.addEvent({title:"Office Picnic/Holiday",date:t.toISOString().split("T")[0],type:"holiday"})}console.log("Simulation Complete.")}}const da=new ki;typeof window<"u"&&(window.AppSimulation=da,setTimeout(()=>da.run(),2e3));const se="minutes";function Ee(){const a=window.AppAuth.getUser();if(!a||!a.id)throw new Error("User not authenticated");return a}function tt(a){return!!(window.app_hasPerm&&window.app_hasPerm("minutes","admin",a))}function Ai(a,e,t,n={}){const i=a&&a.createdBy===e.id,s=tt(e),o=n&&n.allowNonOwner===!0;if(!i&&!s&&!o)throw new Error("You do not have permission to edit these minutes.");if(a&&a.locked&&!(n&&n.allowOnLocked===!0))throw new Error("This record is locked.");return!t||!String(t).trim()?"Updated minutes":String(t).trim()}async function Di(a={}){try{const e=a.limit||150;return window.AppDB?.queryMany?await window.AppDB.queryMany(se,[],{orderBy:[{field:"date",direction:"desc"}],limit:e}):window.AppDB?.getAll?(await window.AppDB.getAll(se)).sort((i,s)=>String(s.date||"").localeCompare(String(i.date||""))).slice(0,e):(await window.AppFirestore.collection(se).orderBy("date","desc").limit(e).get()).docs.map(n=>({id:n.id,...n.data()}))}catch(e){throw console.error("Error fetching minutes:",e),e}}async function xi(a){try{const e=Ee(),t=new Date().toISOString(),n=e.name||e.username||"Unknown",i={...a,createdBy:e.id,createdByName:n,createdAt:t,lastEditedBy:e.id,lastEditedByName:n,lastEditedAt:t,auditLog:[{userId:e.id,userName:n,timestamp:t,action:"Created meeting minutes"}],approvals:{},locked:!1,restrictedFrom:[],allowedViewers:[],accessRequests:[]};return window.AppDB?await window.AppDB.add(se,i):(await window.AppFirestore.collection(se).add(i)).id}catch(e){throw console.error("Error adding minute:",e),e}}async function at(a,e,t,n={}){try{const i=Ee(),s=await(window.AppDB?window.AppDB.get(se,a):window.AppFirestore.collection(se).doc(a).get().then(p=>p.data()));if(!s)throw new Error("Minute not found");const o=Ai(s,i,t,n),r=new Date().toISOString(),d=i.name||i.username||"Unknown",l={userId:i.id,userName:d,timestamp:r,action:o},c={...s,...e,id:a,lastEditedBy:i.id,lastEditedByName:d,lastEditedAt:r,auditLog:[...s.auditLog||[],l]};return window.AppDB?await window.AppDB.put(se,c):await window.AppFirestore.collection(se).doc(a).update(c),!0}catch(i){throw console.error("Error updating minute:",i),i}}async function $i(a){try{const e=Ee(),t=await(window.AppDB?window.AppDB.get(se,a):window.AppFirestore.collection(se).doc(a).get().then(i=>i.data()));if(!t)throw new Error("Minute not found");const n=t.accessRequests||[];return n.some(i=>i.userId===e.id)?!0:(n.push({userId:e.id,userName:e.name||e.username||"Unknown",status:"pending",requestedAt:new Date().toISOString()}),await at(a,{accessRequests:n},`Requested access for ${e.name||e.username}`,{allowNonOwner:!0,allowOnLocked:!0}))}catch(e){throw console.error("Error requesting access:",e),e}}async function _i(a,e,t){try{const n=Ee(),i=await(window.AppDB?window.AppDB.get(se,a):window.AppFirestore.collection(se).doc(a).get().then(c=>c.data()));if(!i)throw new Error("Minute not found");const s=i.createdBy===n.id,o=tt(n);if(!s&&!o)throw new Error("Only owner or admin can review access requests.");const r=i.accessRequests||[],d=r.find(c=>c.userId===e);if(!d)return!0;d.status=t;const l=i.allowedViewers||[];return t==="approved"&&!l.includes(e)&&l.push(e),await at(a,{accessRequests:r,allowedViewers:l},`${String(t||"").toUpperCase()} access request for userId: ${e}`,{allowOnLocked:!0})}catch(n){throw console.error("Error handling access request:",n),n}}async function Ti(a,e,t){try{const n=Ee(),i=await(window.AppDB?window.AppDB.get(se,a):window.AppFirestore.collection(se).doc(a).get().then(l=>l.data()));if(!i||!i.actionItems)throw new Error("Minute or tasks not found");const s=i.actionItems[e];if(!s)throw new Error("Task not found");const o=i.createdBy===n.id,r=tt(n),d=s.assignedTo===n.id;if(!o&&!r&&!d)throw new Error("Only owner, admin, or assignee can update this task.");return s.status=t,t==="completed"&&(s.completedAt=new Date().toISOString()),await at(a,{actionItems:i.actionItems},`Updated Task: ${s.task} to ${t}`,{allowNonOwner:!0,allowOnLocked:!0})}catch(n){throw console.error("Error updating action item:",n),n}}async function Ii(a){try{const e=Ee(),t=await(window.AppDB?window.AppDB.get(se,a):window.AppFirestore.collection(se).doc(a).get().then(c=>c.data()));if(!t)throw new Error("Minute not found");const n=t.attendeeIds||[],i=n.includes(e.id),s=t.createdBy===e.id,o=tt(e);if(!i&&!s&&!o)throw new Error("Only attendees, owner, or admin can approve minutes.");const r=t.approvals||{};r[e.id]=new Date().toISOString();const d=n.length>0&&n.every(c=>r[c]),l={approvals:r};return d&&(l.locked=!0),await at(a,l,`${d?"FINAL APPROVAL & LOCK":"Signed"} by ${e.name||e.username}`,{allowNonOwner:!0,allowOnLocked:!0})}catch(e){throw console.error("Error approving minute:",e),e}}async function Mi(a){try{const e=Ee(),t=await(window.AppDB?window.AppDB.get(se,a):window.AppFirestore.collection(se).doc(a).get().then(s=>s.data()));if(!t)throw new Error("Minute not found");const n=t.createdBy===e.id,i=tt(e);if(!n&&!i)throw new Error("Only owner or admin can delete minutes.");return window.AppDB?await window.AppDB.delete(se,a):(await window.AppFirestore.collection(se).doc(a).delete(),!0)}catch(e){throw console.error("Error deleting minute:",e),e}}const Li={getMinutes:Di,addMinute:xi,updateMinute:at,approveMinute:Ii,deleteMinute:Mi,requestAccess:$i,handleAccessRequest:_i,updateActionItemStatus:Ti};typeof window<"u"&&(window.AppMinutes=Li);const Gt={async renderPolicyEditor(){const a=await $e.getPolicy();return`
        ...
        `},setupGlobalHandlers(){window.app_savePolicyChanges=async a=>{a.preventDefault();const e=new FormData(a.target),t=await $e.getPolicy(),n={};Object.keys(t).forEach(i=>{n[i]={...t[i]};const s=l=>{const c=e.get(l);return c!==""&&c!==null?parseInt(c):void 0},o=s(`${i}_total`);o!==void 0&&(n[i].total=o);const r=s(`${i}_min`);r!==void 0?n[i].minDays=r:delete n[i].minDays;const d=s(`${i}_max`);d!==void 0?n[i].maxDays=d:delete n[i].maxDays});try{await $e.updatePolicy(n);const i=a.target.querySelector("button"),s=i.innerHTML;i.innerHTML='<i class="fa-solid fa-check"></i> Saved!',i.style.background="#166534",setTimeout(()=>{i.innerHTML=s,i.style.background="",window.location.reload()},1e3)}catch(i){alert("Failed to update policy: "+i.message)}},window.app_approveLeaveWithWarning=async a=>{const e=await window.appPrompt("Reason for override:","",{title:"Leave Override",confirmText:"Approve With Reason",placeholder:"Enter reason"});if(e)try{await $e.updateLeaveStatus(a,"Approved",ae.getUser().id,`[Overridden] ${e}`),window.location.reload()}catch(t){alert(t.message)}}}};Gt.setupGlobalHandlers();typeof window<"u"&&(window.AppAdminPolicies=Gt);const Ei={currentYear:new Date().getFullYear(),holidayCache:null,baseline2025:[{name:"Republic Day",date:"2025-01-26",type:"National"},{name:"Maha Shivaratri",date:"2025-02-26",type:"Regional"},{name:"Holi",date:"2025-03-14",type:"Regional"},{name:"Id-ul-Fitr",date:"2025-03-31",type:"Regional"},{name:"Good Friday",date:"2025-04-18",type:"Regional"},{name:"Independence Day",date:"2025-08-15",type:"National"},{name:"Dussehra",date:"2025-10-02",type:"Regional"},{name:"Gandhi Jayanti",date:"2025-10-02",type:"National"},{name:"Diwali",date:"2025-10-20",type:"Regional"},{name:"Christmas",date:"2025-12-25",type:"Regional"}],async render(){const a=await $e.getPolicy(),e=ae.getUser(),t=await $e.getFinancialYear(),n=window.app_hasPerm("policies","admin",e);let i=0;try{const d=new Date,l=d.getDay(),c=d.getDate()-l+(l===0?-6:1),p=new Date(d.setDate(c));p.setHours(0,0,0,0);const m=p.toISOString().split("T")[0];i=(await K.getAll("attendance")).filter(h=>h.user_id===e.id&&h.date>=m).filter(h=>h.checkIn?h.lateCountable===!0?!0:ba.normalizeType(h.type)==="Late":!1).length}catch(d){console.warn("Error calc lates",d)}const s=Object.keys(a).map(async d=>{const l=await $e.getLeaveUsage(e.id,d,t);return{type:d,usage:l,total:a[d].total,icon:this.getIconForType(d),color:this.getColorForType(d)}}),o=await Promise.all(s),r=await this.renderHolidayTable(this.currentYear,n);return`
            ...
            `}};typeof window<"u"&&(window.AppPolicies=Ei);function Y(a,e={}){const t=document.createElement(a);if(e.id&&(t.id=e.id),e.className&&(t.className=e.className),e.textContent&&(t.textContent=e.textContent),e.innerHTML&&(t.innerHTML=e.innerHTML),e.attributes)for(const[n,i]of Object.entries(e.attributes))t.setAttribute(n,i);if(e.children)for(const n of e.children)t.appendChild(n);return t}function pe(a={}){const e=Y("button",{className:a.className,textContent:a.textContent,innerHTML:a.innerHTML,attributes:{type:"button",...a.attributes}});return a.onClick&&e.addEventListener("click",a.onClick),e}const Ae=a=>String(a??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;");function Ci(a,e){const t=document.createElement("div"),n=window.getComputedStyle(a);for(const l of n)t.style[l]=n[l];t.style.position="absolute",t.style.visibility="hidden",t.style.whiteSpace="pre-wrap",t.style.width=n.width,t.style.height="auto";const i=a.value.substring(0,e);t.textContent=i;const s=document.createElement("span");s.textContent=a.value.substring(e)||".",t.appendChild(s),document.body.appendChild(t);const{offsetLeft:o,offsetTop:r}=s,d=a.getBoundingClientRect();return document.body.removeChild(t),{top:d.top+r-a.scrollTop,left:d.left+o-a.scrollLeft}}function Pi(a,e,t){let n=document.getElementById("mention-dropdown");n?n.parentElement!==document.body&&document.body.appendChild(n):(n=Y("div",{id:"mention-dropdown",className:"mention-dropdown"}),document.body.appendChild(n));let i=0,s=[],o=-1;const r=()=>{n.style.display="none",o=-1},d=()=>{if(s.length===0)return r();n.innerHTML="",s.forEach((p,m)=>{const u=Y("div",{className:`mention-item ${m===i?"active":""}`,innerHTML:`
                ...
                `});u.addEventListener("click",()=>l(p)),n.appendChild(u)});const c=Ci(a,o);n.style.top=`${c.top+24}px`,n.style.left=`${c.left}px`,n.style.display="block"},l=c=>{const p=a.value,m=p.substring(0,o),u=p.substring(a.selectionStart);a.value=`${m}@${c.name} ${u}`,a.focus(),r(),t&&t()};a.addEventListener("input",()=>{const c=a.value,p=a.selectionStart,m=c.lastIndexOf("@",p-1);if(m!==-1&&(m===0||/\s/.test(c[m-1]))){const u=c.substring(m+1,p).toLowerCase();if(!/\s/.test(u)){o=m,s=e.filter(y=>y.name.toLowerCase().includes(u)).slice(0,8),i=0,d();return}}r(),t&&t()}),a.addEventListener("keydown",c=>{n.style.display==="block"&&(c.key==="ArrowDown"?(c.preventDefault(),i=(i+1)%s.length,d()):c.key==="ArrowUp"?(c.preventDefault(),i=(i-1+s.length)%s.length,d()):c.key==="Enter"||c.key==="Tab"?(c.preventDefault(),l(s[i])):c.key==="Escape"&&r())}),document.addEventListener("click",c=>{!n.contains(c.target)&&c.target!==a&&r()})}function Ni(a,e,t,n,i){const s=Y("h3",{textContent:"Plan Your Day"}),o=Y("p",{className:"day-plan-subline",textContent:`${a}${e?` - Editing for ${t}`:""}`}),r=n?pe({className:"day-plan-delete-btn",attributes:{title:"Delete plan"},innerHTML:'<i class="fa-solid fa-trash"></i>',onClick:()=>window.app_deleteDayPlan(a,i)}):null,d=pe({className:"day-plan-close-btn",attributes:{title:"Close"},innerHTML:'<i class="fa-solid fa-xmark"></i>',onClick:c=>c.currentTarget.closest(".day-plan-modal-overlay").remove()}),l=Y("div",{className:"day-plan-header-actions",children:[r,d].filter(Boolean)});return Y("div",{className:"day-plan-header",children:[Y("div",{className:"day-plan-headline",children:[s,o]}),l]})}function Bi(a,e,t,n,i,s,o,r,d,l){const c=Y("div",{className:"day-plan-scroll-area personal-plans-container",attributes:{"data-scope":"personal"}}),p=Y("div",{className:"day-plan-scroll-area others-plans-container",attributes:{"data-scope":"annual"}});i.forEach((S,_)=>{const b=Xe({plan:S,idx:_,allUsers:s,targetId:e,defaultScope:o,selectableCollaborators:r,isAdmin:d,currentUserId:l.id,isReference:S.isReference});(S.planScope||S._planScope||o)==="annual"||S.isReference?p.appendChild(b):c.appendChild(b)});const m=Y("div",{className:"day-plan-columns",children:[Y("div",{className:"day-plan-column",children:[Y("div",{className:"day-plan-column-head",children:[Y("h4",{className:"day-plan-column-title",textContent:"Self Plan"}),pe({className:"btn-premium-add",innerHTML:'<i class="fa-solid fa-plus-circle"></i> <span>Add Personal Plan (@)</span>',onClick:()=>Je({date:a,targetId:e,scope:"personal",allUsers:s,selectableCollaborators:r,isAdmin:d,container:c})})]}),c]}),Y("div",{className:"day-plan-column",children:[Y("div",{className:"day-plan-column-head",children:[Y("h4",{className:"day-plan-column-title",textContent:"Others' & Annual Plans"}),pe({className:"btn-premium-add",innerHTML:'<i class="fa-solid fa-plus-circle"></i> <span>Add Annual Plan (@)</span>',onClick:()=>Je({date:a,targetId:e,scope:"annual",allUsers:s,selectableCollaborators:r,isAdmin:d,container:p})})]}),p]})]}),u=pe({className:"day-plan-discard-btn",textContent:"Discard",onClick:S=>S.currentTarget.closest(".day-plan-modal-overlay").remove()}),y=pe({className:"day-plan-save-btn",innerHTML:'<i class="fa-solid fa-check-circle"></i> <span>Save Plan</span>',attributes:{type:"submit"}}),h=Y("div",{className:"day-plan-footer",children:[Y("div",{className:"day-plan-actions",children:[u,y]})]}),f=Y("form",{className:"day-plan-form",attributes:{"data-had-personal":t?"1":"0","data-had-annual":n?"1":"0","data-removed-tasks":"[]"},children:[m,h]});return f.addEventListener("submit",S=>window.app_saveDayPlan(S,a,e)),f}function Je(a){const{date:e,targetId:t,scope:n,allUsers:i,selectableCollaborators:s,isAdmin:o,container:r,existingBlock:d=null}=a,l=ae.getUser(),c=d?window.app_extractBlockData(d):{task:"",subPlans:[],tags:[],status:null,assignedTo:t,startDate:e,endDate:e,planScope:n,carryForwardRootId:"",isRemoved:!1},p=Y("div",{className:"plan-editor-overlay"}),m=Y("div",{className:"plan-editor-modal"}),u=Y("div",{className:"plan-editor-head",innerHTML:`<h4>${d?"Edit":"Add"} ${n==="annual"?"Annual":"Personal"} Plan <small style="font-weight:400; opacity:0.7; font-size:0.8em; margin-left:5px;">(Use @ to tag)</small></h4>`}),y=Y("div",{className:"plan-editor-body"}),h=Y("textarea",{className:"plan-editor-textarea",textContent:c.task,attributes:{placeholder:"What is the objective or task for today? Use @ to tag colleagues.",required:!0}}),f=Y("div",{className:"plan-editor-tags-container",attributes:{style:"display: none;"}}),S=()=>{const E=h.value,v=[];if(i.forEach(x=>{const A=`@${x.name}`;E.includes(A)&&!v.find(M=>M.id===x.id)&&v.push(x)}),v.length>0){f.style.display="block",f.innerHTML='<label class="plan-editor-tags-label">Tagged Collaborators:</label>';const x=Y("div",{className:"plan-editor-tags-wrapper"});v.forEach(A=>{const M=Y("span",{className:"day-plan-tag-pill",textContent:`@${A.name}`});x.appendChild(M)}),f.appendChild(x)}else f.style.display="none",f.innerHTML=""},_=Y("div",{className:"plan-editor-grid"}),b=Y("div",{className:"plan-editor-field"});b.innerHTML="<label>Status</label>";const $=Y("select",{className:"plan-editor-select"});$.innerHTML=`
    ...
    `,b.appendChild($);let g=null;if(o){const E=Y("div",{className:"plan-editor-field"});E.innerHTML="<label>Assign To</label>",g=Y("select",{className:"plan-editor-select"}),i.forEach(v=>{const x=Y("option",{textContent:v.name,attributes:{value:v.id,selected:v.id===c.assignedTo}});g.appendChild(x)}),E.appendChild(g),_.appendChild(E)}y.appendChild(h),y.appendChild(f),y.appendChild(_);const w=Y("div",{className:"plan-editor-footer"}),k=pe({className:"day-plan-discard-btn",textContent:"Cancel",onClick:()=>p.remove()}),T=pe({className:"day-plan-save-btn",textContent:d?"Update":"Add to List",onClick:()=>{const E=h.value.trim();if(!E)return alert("Please enter a task description");const v=[];i.forEach(M=>{E.includes(`@${M.name}`)&&!v.find(O=>O.id===M.id)&&v.push({id:M.id,name:M.name,status:"pending"})});const A={plan:{...c,task:E,status:$.value,assignedTo:g?g.value:c.assignedTo||t,tags:v.length>0?v:c.tags||[]},allUsers:i,targetId:t,selectableCollaborators:s,isAdmin:o,currentUserId:l.id};if(d){const M=Xe({...A,idx:Number.parseInt(d.getAttribute("data-index"))});d.replaceWith(M)}else{const M=Xe({...A,idx:r.querySelectorAll(".plan-block").length});r.appendChild(M)}p.remove()}});w.appendChild(k),w.appendChild(T),m.appendChild(u),m.appendChild(y),m.appendChild(w),p.appendChild(m),document.getElementById("modal-container").appendChild(p),h.focus(),Pi(h,i,S),S()}function Xe(a){const{plan:e={},idx:t=0,allUsers:n=[],targetId:i,defaultScope:s="personal",selectableCollaborators:o=[],isAdmin:r=!1,currentUserId:d="",isReference:l=!1}=a||{},c=String(e.task||""),p=e.assignedTo||i||d,m=e.startDate||"",u=e.endDate||"",y=String(e.planScope||e._planScope||s)==="annual"?"annual":"personal",h=l?e.userName?`${e.userName}'s Plan`:"Others Plan":y==="annual"?"Annual Plan":"Personal Plan",f=c.trim()?c.trim().length>120?`${c.trim().slice(0,120)}...`:c.trim():"New task",S=Y("div",{className:(l?"plan-block-ref":"plan-block")+(l?" is-reference-only":""),attributes:{"data-index":t}}),_=Y("div",{className:"dp-hidden-data",attributes:{style:"display:none;"}});_.innerHTML=`
        <textarea class="plan-task">${Ae(c)}</textarea>
        <select class="plan-status"><option value="${Ae(e.status||"")}" selected></option></select>
        <select class="plan-scope"><option value="${Ae(y)}" selected></option></select>
        <select class="plan-assignee"><option value="${Ae(p)}" selected></option></select>
        <input class="plan-start-date" value="${Ae(m)}">
        <input class="plan-end-date" value="${Ae(u)}">
        <input class="plan-root-id" value="${Ae(e.carryForwardRootId||"")}">
        <input class="plan-removed-flag" value="${e.isRemoved===!0?"1":"0"}">
    `,e.subPlans&&e.subPlans.forEach(w=>{const k=Y("input",{className:"sub-plan-input",attributes:{value:Ae(w)}});_.appendChild(k)}),e.tags&&e.tags.forEach(w=>{const k=Y("div",{className:"tag-chip",attributes:{"data-id":w.id,"data-name":w.name,"data-status":w.status||"pending"}});_.appendChild(k)}),S.appendChild(_);const b=Y("div",{className:"plan-block-header"}),$=Y("div",{className:"plan-block-title-group"});$.appendChild(Y("span",{className:"day-plan-index-badge",textContent:t+1})),$.appendChild(Y("span",{className:"plan-block-summary",textContent:f}));const g=Y("div",{className:"plan-block-actions"});if(g.appendChild(Y("span",{className:"day-plan-scope-pill",textContent:h})),l||(g.appendChild(pe({className:"day-plan-edit-btn",attributes:{title:"Edit plan"},innerHTML:'<i class="fa-solid fa-pen-to-square"></i>',onClick:()=>Je({date:m,targetId:i,scope:y,allUsers:n,selectableCollaborators:o,isAdmin:r,container:S.parentElement,existingBlock:S})})),t>0?g.appendChild(pe({className:"day-plan-remove-btn",attributes:{title:"Remove task"},innerHTML:'<i class="fa-solid fa-trash-can"></i>',onClick:()=>window.app_markTaskRemoved(S)})):g.appendChild(pe({className:"day-plan-remove-btn",attributes:{title:"Remove task"},innerHTML:'<i class="fa-solid fa-trash-can"></i>',onClick:()=>window.app_markTaskRemoved(S)}))),b.appendChild($),b.appendChild(g),S.appendChild(b),e.tags&&e.tags.length>0){const w=Y("div",{className:"plan-block-body"});e.tags.forEach(k=>{const T=Y("span",{className:"day-plan-tag-pill",textContent:`@${k.name}`});w.appendChild(T)}),S.appendChild(w)}return S}function Jt(a){if(!a)return null;const e=a.querySelector(".plan-task")?.value||"",t=a.querySelector(".plan-status")?.value||"",n=a.querySelector(".plan-scope")?.value||"personal",i=a.querySelector(".plan-assignee")?.value||"",s=a.querySelector(".plan-start-date")?.value||"",o=a.querySelector(".plan-end-date")?.value||"",r=a.querySelector(".plan-root-id")?.value||"",d=a.querySelector(".plan-removed-flag")?.value==="1",l=Array.from(a.querySelectorAll(".sub-plan-input")).map(p=>p.value),c=Array.from(a.querySelectorAll(".tag-chip")).map(p=>({id:p.dataset.id,name:p.dataset.name,status:p.dataset.status}));return{task:e,status:t,planScope:n,assignedTo:i,startDate:s,endDate:o,subPlans:l,tags:c,carryForwardRootId:r,isRemoved:d}}async function Wa(a,e=null,t=null){const n=ae.getUser(),i=String(e??"").trim(),s=!i||i==="undefined"||i==="null"?n.id:i,o=await K.getAll("users"),r=n.role==="Administrator"||n.isAdmin,d=s!==n.id,l=t==="annual"?"annual":"personal";window.app_currentDayPlanTargetId=s,De?.ensureCarryForwardForDate&&a<=De.getTodayKey()&&await De.ensureCarryForwardForDate(a,{userIds:[s]});const[c,p,m]=await Promise.all([De.getWorkPlan(s,a,{planScope:"personal"}),De.getWorkPlan(s,a,{planScope:"annual"}),K.queryMany("work_plans",[{field:"date",operator:"==",value:a}])]),u=!!(c||p),y=o.find(v=>v.id===s),h=y?y.name:"Staff",f=o.filter(v=>v.id!==s),S=(v,x,A=null)=>v?Array.isArray(v.plans)&&v.plans.length>0?v.plans.map(M=>({...M,planScope:x,userName:A||v.userName,isReference:!!A})).filter(M=>M.isRemoved!==!0):[]:[],_=(m||[]).filter(v=>v.id!==De.getWorkPlanId(a,s,"personal")&&v.id!==De.getWorkPlanId(a,s,"annual")),b=[];_.forEach(v=>{b.push(...S(v,v.planScope,v.userName))});const $=[...S(c,"personal"),...S(p,"annual"),...b];$.length===0&&$.push({task:"",subPlans:[],tags:[],status:null,assignedTo:s,startDate:a,endDate:a,planScope:l});const g=Y("div",{id:"day-plan-modal",className:"day-plan-modal-overlay"}),w=Y("div",{className:"day-plan-content"});w.appendChild(Ni(a,d,h,u,s)),w.appendChild(Bi(a,s,c,p,$,o,l,f,r,n)),g.appendChild(w);const k=document.getElementById("modal-container");if(!k)return;const T=document.getElementById("day-plan-modal");T&&T.remove(),k.appendChild(g);const E=document.getElementById("day-plan-modal");if(E){const x=Array.from(document.querySelectorAll(".modal-overlay, .modal")).filter(A=>A!==E).reduce((A,M)=>{const O=Number.parseInt(window.getComputedStyle(M).zIndex,10);return Number.isFinite(O)?Math.max(A,O):A},1e3);E.style.zIndex=String(x+2)}}async function Va(a=null){const e=document.getElementById("day-plan-modal");if(!e)return;const t=a||"personal",n=t==="annual"?e.querySelector(".others-plans-container"):e.querySelector(".personal-plans-container"),i=e.querySelector(".day-plan-headline p")?.textContent?.match(/\d{4}-\d{2}-\d{2}/),s=i?i[0]:new Date().toISOString().split("T")[0],o=await K.getAll("users"),r=ae.getUser(),d=window.app_currentDayPlanTargetId||r.id,l=r.role==="Administrator"||r.isAdmin,c=o.filter(p=>p.id!==d);Je({date:s,targetId:d,scope:t,allUsers:o,selectableCollaborators:c,isAdmin:l,container:n})}const Ui={openDayPlan:Wa,dayPlanRenderBlockV3:Xe,addPlanBlockUI:Va,openPlanEditor:Je,app_extractBlockData:Jt};window.AppDayPlan=Ui;window.app_openDayPlan=Wa;window.app_dayPlanRenderBlockV3=Xe;window.app_addPlanBlockUI=Va;window.app_extractBlockData=Jt;window.app_markTaskRemoved=function(a){if(!a)return;const e=a.closest(".day-plan-form"),t=Jt(a),n=t?.carryForwardRootId||"";if(e&&n){let i=[];try{i=JSON.parse(e.dataset.removedTasks||"[]")}catch{i=[]}const s=t?.planScope==="annual"?"annual":"personal";i.find(o=>o&&o.rootId===n&&o.scope===s)||(i.push({rootId:n,scope:s}),e.dataset.removedTasks=JSON.stringify(i))}a.remove()};const la={isWidgetMode:!1,syncInterval:null,init(){console.log("Widget Module Initialized"),new URLSearchParams(window.location.search).get("mode")==="widget"&&(this.isWidgetMode=!0),this.isWidgetMode&&this.enableWidgetMode()},toggle(){if(this.isWidgetMode)this.isWidgetMode=!1,window.opener||window.name==="CRWIWidget"?window.close():this.disableWidgetMode();else{const t=window.screen.width-320-20;window.open(window.location.origin+window.location.pathname+"?mode=widget#dashboard","CRWIWidget",`width=320,height=420,left=${t},top=40,menubar=no,toolbar=no,location=no,status=no,resizable=yes`)}},enableWidgetMode(){document.body.classList.add("widget-mode"),this.renderWidgetView(),this.startSync(),window.resizeTo&&window.resizeTo(320,420)},disableWidgetMode(){document.body.classList.remove("widget-mode");const a=document.getElementById("widget-view");a&&a.remove(),this.stopSync()},startSync(){this.syncInterval&&clearInterval(this.syncInterval),this.syncInterval=setInterval(()=>this.sync(),500)},stopSync(){this.syncInterval&&clearInterval(this.syncInterval)},sync(){if(!this.isWidgetMode)return;const a=document.getElementById("timer-display"),e=document.getElementById("timer-label"),t=document.querySelector(".check-in-widget .status-dot")||document.querySelector('.check-in-widget [style*="background: #10b981"]')||document.querySelector('.check-in-widget [style*="background: #94a3b8"]'),n=document.getElementById("attendance-btn"),i=document.getElementById("location-text"),s=document.getElementById("countdown-container"),o=document.getElementById("countdown-label"),r=document.getElementById("countdown-value"),d=document.getElementById("countdown-progress"),l=document.getElementById("overtime-container"),c=document.getElementById("overtime-value"),p=document.getElementById("widget-view");if(!p)return;const m=p.querySelector("#timer-display"),u=p.querySelector("#timer-label"),y=p.querySelector(".status-dot-indicator"),h=p.querySelector("#attendance-btn"),f=p.querySelector("#location-text"),S=p.querySelector("#countdown-container"),_=p.querySelector("#countdown-label"),b=p.querySelector("#countdown-value"),$=p.querySelector("#countdown-progress"),g=p.querySelector("#overtime-container"),w=p.querySelector("#overtime-value");a&&m&&(m.innerHTML=a.innerHTML,m.style.color=a.style.color),e&&u&&(u.innerHTML=e.innerHTML),t&&y&&(y.style.background=t.style.background||(t.classList.contains("online")?"#10b981":"#94a3b8")),s&&S&&(S.style.display=s.style.display,o&&_&&(_.innerHTML=o.innerHTML),r&&b&&(b.innerHTML=r.innerHTML),d&&$&&($.style.width=d.style.width)),l&&g&&(g.style.display=l.style.display,c&&w&&(w.innerHTML=c.innerHTML)),n&&h&&(h.innerHTML=n.innerHTML,h.className=n.className,h.disabled=n.disabled),i&&f&&(f.innerHTML=i.innerHTML)},handleWidgetAction(){if(window.opener&&!window.opener.closed)try{if(window.opener.focus(),window.opener.location.hash!=="#dashboard"&&(window.opener.location.hash="#dashboard"),window.opener.app_handleAttendance){window.opener.app_handleAttendance();return}}catch(t){console.warn("Could not communicate with main window:",t)}console.log("Opener lost or closed. Reopening main app...");const a=window.location.origin+window.location.pathname+"#dashboard",e=window.open(a,"CRWIMainApp");if(e){e.focus();const t=document.getElementById("attendance-btn");if(t){const n=t.innerHTML;t.innerHTML='<i class="fa-solid fa-arrow-up-right-from-square"></i> Opening App...',setTimeout(()=>{t.innerHTML=n},3e3)}}else alert("Please allow popups or open the main application window manually.")},renderWidgetView(){let a=document.getElementById("widget-view");a||(a=document.createElement("div"),a.id="widget-view",document.body.appendChild(a));const e=window.AppAuth&&window.AppAuth.getUser()||{name:"User",role:"Staff",avatar:"https://via.placeholder.com/48"};a.innerHTML=`
        ...
        `}};typeof window<"u"&&(window.Widget=la,la.init());var Et={buildId:"303d9ea-1774322695099",commitSha:"303d9eab244b0ba573be549a90e93fd904633b5a",builtAt:"2026-03-24T03:24:55.098Z"};let Ct=null,ye=[],xe=null,Pe=null,je=0,Qe=!1,Ye=null,Pt=!1,Ka=0,qt=null,ut=null,mt=null,zt=!1,We=null,Oe=null;const ft=Object.freeze(typeof Et=="object"&&Et?Et:{buildId:"local",commitSha:"",builtAt:""}),Oi="/version.json",Ri=6e4,jt="release_signal",ca="app_meta",Ga="app_last_seen_release_id",Z={active:!1,releaseId:"",buildId:"",commitSha:"",deployedAt:"",notes:"",source:"",popupDismissed:!1},Ja=3e4;window.app_annualYear=new Date().getFullYear();const Fi=()=>{try{return localStorage.getItem(Ga)||""}catch{return""}},Xa=a=>{try{localStorage.setItem(Ga,String(a||""))}catch{}},Qa=(a={},e="version")=>{const t=String(a.buildId||a.releaseId||a.commitSha||"").trim();return t?{releaseId:t,buildId:t,commitSha:String(a.commitSha||"").trim(),deployedAt:String(a.deployedAt||a.builtAt||"").trim(),notes:String(a.notes||"").trim(),source:String(e||a.source||"version").trim()}:null},nt=()=>({active:!!Z.active,releaseId:Z.releaseId||"",buildId:Z.buildId||"",commitSha:Z.commitSha||"",deployedAt:Z.deployedAt||"",notes:Z.notes||"",source:Z.source||"",popupDismissed:!!Z.popupDismissed,currentBuildId:ft.buildId||"",currentCommitSha:ft.commitSha||"",currentBuiltAt:ft.builtAt||""});window.app_getReleaseUpdateState=()=>nt();const Ze=()=>{const a=nt(),e=document.querySelector(".dashboard-refresh-link");e&&(a.active?(e.classList.add("is-update-pending"),e.setAttribute("title","Update available. Click to refresh into the new version."),e.textContent="System update available"):(e.classList.remove("is-update-pending"),e.setAttribute("title","Check for System Update (Ctrl+Shift+R)"),e.textContent="Check for System Update"))};window.app_applyUpdateCtaState=Ze;const Xt=()=>{Ze(),window.dispatchEvent&&window.dispatchEvent(new CustomEvent("app:update-state",{detail:nt()}))},Qt=(a=!1)=>{const e=Z.releaseId;Z.active=!1,Z.releaseId="",Z.buildId="",Z.commitSha="",Z.deployedAt="",Z.notes="",Z.source="",Z.popupDismissed=!1,a&&e&&Xa(e),Xt()};window.app_dismissReleaseUpdatePrompt=()=>{Z.active&&(Z.releaseId&&Xa(Z.releaseId),Z.popupDismissed=!0,document.getElementById("system-update-modal")?.remove(),Xt())};const Za=(a,e={})=>{const t=Qa(a,a?.source||"version");if(!t)return!1;if(t.buildId===ft.buildId)return Qt(!1),!1;const n=e.forcePopup===!0,i=Fi(),s=Z.active&&Z.releaseId===t.releaseId;return Z.active=!0,Z.releaseId=t.releaseId,Z.buildId=t.buildId,Z.commitSha=t.commitSha,Z.deployedAt=t.deployedAt,Z.notes=t.notes,Z.source=t.source,Z.popupDismissed=t.releaseId===i,s||window.app_showSyncToast("New version available."),window.dispatchEvent&&window.dispatchEvent(new CustomEvent("app:update-available",{detail:nt()})),Xt(),(n||!Z.popupDismissed)&&(Z.popupDismissed=!1,window.app_showSystemUpdatePopup()),!0},Hi=async({manual:a=!1}={})=>{try{const e=await fetch(`${Oi}?t=${Date.now()}`,{cache:"no-store",headers:{"cache-control":"no-cache"}});if(!e.ok)throw new Error(`Version check failed with ${e.status}`);const t=await e.json();return Qa(t,"version")}catch(e){return console.warn("Unable to fetch deployed version manifest:",e),a&&window.app_showSyncToast("Could not check for updates right now."),null}},et=async(a={})=>{if(Oe)return Oe;Oe=(async()=>{const e=await Hi({manual:a.manual===!0});return e?Za(e,{forcePopup:a.forcePopup===!0}):!1})();try{return await Oe}finally{Oe=null}},en=()=>{We||(We=setInterval(()=>{document.visibilityState==="visible"&&window.AppAuth?.getUser()&&et()},Ri),et())},qi=()=>{We&&(clearInterval(We),We=null)},zi=()=>{document.visibilityState==="visible"&&window.AppAuth?.getUser()&&et()},pa=()=>{window.AppAuth?.getUser()&&et()},ua=a=>{!a||a.id!==jt||a.active!==!1&&Za({...a,source:"release-signal"},{forcePopup:!0})},tn=()=>{if(!zt){if(zt=!0,window.AppDB&&typeof window.AppDB.listenDoc=="function"){ut=window.AppDB.listenDoc(ca,jt,a=>{a&&ua(a)});return}mt=setInterval(async()=>{try{const a=await window.AppDB.get(ca,jt);a&&ua(a)}catch{}},3e4)}},ji=()=>{typeof ut=="function"&&(ut(),ut=null),mt&&(clearInterval(mt),mt=null),zt=!1};window.app_checkForSystemUpdate=async()=>{if(Z.active)return window.app_showSystemUpdatePopup(),!0;const a=await et({manual:!0,forcePopup:!0});return a||window.app_showSyncToast("You are already using the latest version."),a};window.app_isAdminUser=(a=window.AppAuth?.getUser())=>a?a.isAdmin===!0:!1;window.app_canSeeAdminPanel=(a=window.AppAuth?.getUser())=>a?window.app_isAdminUser(a)?!0:a.permissions?Object.entries(a.permissions).some(([e,t])=>e!=="birthday"&&t==="admin"):!1:!1;window.app_hasPerm=(a,e="view",t=window.AppAuth?.getUser())=>{if(!t)return!1;if(t.isAdmin===!0)return!0;if(!t.permissions||!t.permissions[a])return!1;const n=t.permissions[a];return e==="view"?n==="view"||n==="admin":e==="admin"?n==="admin":!1};window.app_canManageAttendanceSheet=(a=window.AppAuth?.getUser())=>a?window.app_hasPerm("attendance","admin",a)||!!a.canManageAttendanceSheet:!1;window.app_canManageBirthdays=(a=window.AppAuth?.getUser())=>a?window.app_isAdminUser(a)||a.role==="Administrator"||!!a.canManageBirthdays||window.app_hasPerm("birthday","view",a):!1;window.app_canAdminBirthdays=(a=window.AppAuth?.getUser())=>a?window.app_isAdminUser(a)||a.role==="Administrator"||!!a.canManageBirthdays||window.app_hasPerm("birthday","admin",a):!1;window.app_getReadTelemetry=()=>!window.AppDB||!window.AppDB.getReadTelemetry?{}:window.AppDB.getReadTelemetry();window.app_resetReadTelemetry=()=>{!window.AppDB||!window.AppDB.clearReadTelemetry||window.AppDB.clearReadTelemetry()};window.app_getMyMessages=async()=>{const a=window.AppAuth.getUser();if(!a)return[];try{const[e,t]=await Promise.all([window.AppDB.query("staff_messages","toId","==",a.id),window.AppDB.query("staff_messages","fromId","==",a.id)]),n=new Map;return(e||[]).forEach(i=>n.set(i.id,i)),(t||[]).forEach(i=>n.set(i.id,i)),Array.from(n.values())}catch(e){return console.warn("Message fetch failed, falling back to getAll",e),window.AppDB.getAll("staff_messages")}};const te=document.getElementById("page-content"),dt=document.querySelector(".sidebar"),lt=document.querySelector(".mobile-header"),ct=document.querySelector(".mobile-nav");window.app_initTheme=()=>{const a=localStorage.getItem("theme")||"light";document.documentElement.setAttribute("data-theme",a),an(a)};window.app_toggleTheme=()=>{const e=document.documentElement.getAttribute("data-theme")==="dark"?"light":"dark";document.documentElement.setAttribute("data-theme",e),localStorage.setItem("theme",e),an(e)};function an(a){document.querySelectorAll(".theme-toggle i").forEach(e=>{a==="dark"?(e.classList.remove("fa-moon"),e.classList.add("fa-sun")):(e.classList.remove("fa-sun"),e.classList.add("fa-moon"))})}function Yi(){if(!("serviceWorker"in navigator))return;const a=async()=>{try{qt=await navigator.serviceWorker.register("/sw.js"),console.log("ServiceWorker registered")}catch(e){console.log("ServiceWorker registration failed: ",e)}};if(document.readyState==="complete"){a();return}window.addEventListener("load",()=>{a()},{once:!0})}const ma=(a=new Date)=>`${a.getFullYear()}-${String(a.getMonth()+1).padStart(2,"0")}-${String(a.getDate()).padStart(2,"0")}`;window.app_showAttendanceNotice=a=>{if(!a)return;const e=document.getElementById("page-content");if(!e)return;const t=document.getElementById("attendance-policy-notice");t&&t.remove();const n=document.createElement("div");n.id="attendance-policy-notice",n.style.background="#fff7ed",n.style.border="1px solid #fdba74",n.style.color="#9a3412",n.style.padding="0.85rem 1rem",n.style.borderRadius="10px",n.style.marginBottom="0.9rem",n.style.fontSize="0.9rem",n.style.fontWeight="600",n.innerHTML=`<i class="fa-solid fa-circle-info" style="margin-right:0.45rem;"></i>${a}`,e.prepend(n),setTimeout(()=>{const i=document.getElementById("attendance-policy-notice");i&&i.remove()},1e4)};window.app_promptMissedCheckoutReason=(a={})=>{const{logId:e,date:t}=a||{};if(!e||document.getElementById("missed-checkout-reason-modal"))return;const n=t?new Date(`${t}T00:00:00`).toLocaleDateString():"previous day",i=`
    ...
    `},Nt=()=>{const a=document.getElementById("page-content");if(!a)return;const e=String(window.location.hash||"").replace(/^#/,"")||"dashboard",t=a.querySelector("#page-usage-note");if(e==="dashboard"){t?.remove();return}const n=Vi(e);if(!n){t?.remove();return}t?.dataset.pageKey!==e&&(t?.remove(),a.insertAdjacentHTML("beforeend",n))},Ki=()=>{if(window.__appPageUsageNotesInitialized)return;window.__appPageUsageNotesInitialized=!0;const a=()=>{const e=document.getElementById("page-content");if(!e||e.__pageUsageObserverBound)return;new MutationObserver(()=>{if(e.dataset.applyingUsageNote!=="1"){e.dataset.applyingUsageNote="1";try{Nt()}finally{delete e.dataset.applyingUsageNote}}}).observe(e,{childList:!0}),e.__pageUsageObserverBound=!0,Nt()};document.readyState==="loading"?document.addEventListener("DOMContentLoaded",a,{once:!0}):a(),window.addEventListener("hashchange",()=>{requestAnimationFrame(()=>{Nt()})})},fa=()=>!Qe&&Date.now()>Ka,Yt=()=>{Ka=Date.now()+3500},Gi=a=>{const e=a.detail;if(!e)return;window.app_refreshNotificationBell&&window.app_refreshNotificationBell().catch(()=>{});const t=e.status||"out",n=Ye!==null&&t!==Ye,i=Ye===null&&t==="in";if(Ye=t,!(n||i)||Pt)return;const s=!window.location.hash||window.location.hash==="#dashboard",o=document.getElementById("checkout-modal"),r=!!(o&&o.style.display==="flex");if(t==="out"&&r&&(o.style.display="none"),!s){fa()&&window.app_showSyncToast("Status updated from another device.");return}Pt=!0,(async()=>{try{const d=document.getElementById("page-content");d&&(d.innerHTML=await F.renderDashboard(),window.setupDashboardEvents&&window.setupDashboardEvents()),fa()&&window.app_showSyncToast("Status updated from another device.")}catch(d){console.warn("Realtime dashboard sync failed:",d)}finally{Pt=!1}})()};function Wt(a){const e=document.querySelector(".sidebar"),t=document.getElementById("sidebar-overlay");e&&t&&(a?(e.classList.add("open"),t.classList.add("active")):(e.classList.remove("open"),t.classList.remove("active")))}function Ji(){if(window.location.search){const a=window.location.protocol+"//"+window.location.host+window.location.pathname+window.location.hash;window.history.replaceState({path:a},"",a),console.log("Address bar cleaned of query parameters.")}}window.app_toggleSidebar=(a=null)=>{const e=document.querySelector(".sidebar"),t=document.querySelector("#desktop-sidebar-toggle i");if(!e)return;(a!==null?a:!e.classList.contains("collapsed"))?(e.classList.add("collapsed"),t&&(t.classList.remove("fa-angles-left"),t.classList.add("fa-angles-right"))):(e.classList.remove("collapsed"),t&&(t.classList.remove("fa-angles-right"),t.classList.add("fa-angles-left")))};window.app_showModal=(a,e)=>{const t=document.getElementById("modal-container");if(!t)return;const n=document.getElementById(e);n&&n.remove(),t.insertAdjacentHTML("beforeend",a);const i=document.getElementById(e);if(i&&(i.classList.contains("modal-overlay")||i.classList.contains("modal"))){const o=Array.from(document.querySelectorAll(".modal-overlay, .modal")).filter(r=>r!==i).reduce((r,d)=>{const l=Number.parseInt(window.getComputedStyle(d).zIndex,10);return Number.isFinite(l)?Math.max(r,l):r},1e3);i.style.zIndex=String(o+2)}};const z=a=>String(a??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;"),Xi=a=>z(a).replace(/\n/g,"<br>"),Vt=a=>String(a?.status||"pending").toLowerCase(),Ve=a=>a?.type==="birthday-reminder"?a?.read!==!0:Vt(a)==="pending",Bt=a=>a?.type==="birthday-reminder"?"Birthday":a?.type==="minute-access-request"?"Minutes":String(a?.type||"").includes("missed-checkout")?"Attendance":a?.type==="task"?"Task":a?.type==="tag"||a?.type==="mention"?"Tag":a?.type==="reminder"?"Reminder":"Notification",Qi=a=>a?a.type==="minute-access-request"||String(a.type||"").includes("missed-checkout")?!0:a.type==="tag"||a.type==="mention":!1,ha=a=>String(a?.description||a?.message||a?.title||"").trim(),Zi=a=>{const e=a?.respondedAt||a?.taggedAt||a?.date,t=new Date(e).getTime();if(!t)return"Unknown time";const n=Math.max(0,Math.floor((Date.now()-t)/6e4)),i=n<1?"just now":n<60?`${n} mins ago`:n<1440?`${Math.floor(n/60)} hrs ago`:`${Math.floor(n/1440)} days ago`;return`${new Date(t).toLocaleString()} (${i})`};window.app_refreshNotificationBell=async()=>{const a=document.querySelectorAll(".top-notification-btn");if(!a.length)return;const e=window.AppAuth.getUser(),n=(Array.isArray(e?.notifications)?e.notifications:[]).filter(Ve).length;a.forEach(i=>{const s=i.querySelector(".top-notification-badge");if(!e){i.classList.remove("has-pending"),s&&(s.style.display="none");return}i.classList.toggle("has-pending",n>0),i.setAttribute("title",n>0?`${n} pending notification${n>1?"s":""}`:"Notification history"),s&&(n>0?(s.textContent=n>99?"99+":String(n),s.style.display=""):s.style.display="none")})};window.app_closeNotificationHistory=()=>{const a=document.getElementById("notification-history-modal"),e=document.getElementById("notif-drawer-backdrop");a&&a.classList.remove("notif-drawer-open"),e&&e.classList.remove("notif-drawer-backdrop-visible"),setTimeout(()=>document.getElementById("notif-drawer-root")?.remove(),320)};window.app_respondNotificationFromHistory=async(a,e,t)=>{const n=window.AppAuth.getUser();if(!n)return;const i=t==="approve"?"approve":"reject",s=await window.AppDB.get("users",n.id);if(!s||!Array.isArray(s.notifications)){alert("Notification not found.");return}let o=null,r=-1;if(Number.isInteger(a)&&a>=0&&s.notifications[a]&&(o=s.notifications[a],r=a),!o&&e&&(r=s.notifications.findIndex(d=>String(d.id)===String(e)),r>=0&&(o=s.notifications[r])),!o){alert("This notification is no longer available.");return}if(!Ve(o)){alert("This notification has already been responded."),await window.app_refreshNotificationBell();return}window.app_closeNotificationHistory();try{if(o.type==="minute-access-request"&&window.app_hasPerm("minutes","admin",n)){await window.app_reviewMinuteAccessFromNotification(r,o.id,i==="approve"?"approved":"rejected");return}if(o.type==="missed-checkout-reason"&&(n.isAdmin||n.role==="Administrator")){await window.app_reviewMissedCheckoutReasonFromNotification(r,o.id,i==="approve"?"approved":"rejected");return}const d=Number(o.taskIndex);if(o.planId&&Number.isInteger(d)&&d>=0){await window.app_handleTagResponse(o.planId,d,i==="approve"?"accepted":"rejected",r);return}if(o.id){await window.app_handleTagDecision(o.id,i==="approve"?"accepted":"rejected");return}alert("This notification cannot be approved or rejected from history.")}catch(d){console.error("Notification response error:",d),alert("Failed to process notification: "+d.message)}};window.app_openNotificationHistory=async()=>{const a=window.AppAuth.getUser();if(!a)return;const e=await window.AppDB.get("users",a.id).catch(()=>a),t=Array.isArray(e?.notifications)?e.notifications:[],n=Array.isArray(e?.tagHistory)?e.tagHistory:[],i=a.isAdmin||a.role==="Administrator",s=[...t.map((k,T)=>({...k,_source:"live",_index:T})),...n.map(k=>({...k,_source:"history",_index:-1}))],o=k=>new Date(k.respondedAt||k.taggedAt||k.date||0).getTime()||0,r=k=>String(k||"").trim().toLowerCase(),l=['<option value="all">All Sources</option>',...Array.from(new Set(s.map(k=>Bt(k)))).filter(Boolean).sort((k,T)=>k.localeCompare(T)).map(k=>`<option value="${z(k.toLowerCase())}">${z(k)}</option>`)].join(""),c={search:"",status:"all",source:"all",sort:"newest"},p=k=>{const T=Vt(k),E=T==="pending"&&k._source==="live",v=Bt(k),x=k.taggedByName||"System",A=k.title||`${v} from ${x}`,M=ha(k),O=JSON.stringify(String(k.id||"")),I={pending:{bg:"#fff7ed",border:"#fdba74",badge:"#f97316"},accepted:{bg:"#f0fdf4",border:"#86efac",badge:"#16a34a"},rejected:{bg:"#fef2f2",border:"#fca5a5",badge:"#dc2626"},default:{bg:"#f8fafc",border:"#e2e8f0",badge:"#6b7280"}},N=I[T]||I.default,P=E&&Qi(k)||i&&k.type==="minute-access-request"?`
        ...
        </div>`,h=document.createElement("div");h.id="notif-drawer-root",h.innerHTML=y,document.body.appendChild(h),requestAnimationFrame(()=>{const k=document.getElementById("notification-history-modal");k&&k.classList.add("notif-drawer-open");const T=document.getElementById("notif-drawer-backdrop");T&&T.classList.add("notif-drawer-backdrop-visible")});const f=document.getElementById("notif-drawer-list"),S=document.getElementById("notif-drawer-results"),_=document.getElementById("notif-drawer-search"),b=document.getElementById("notif-drawer-source"),$=document.getElementById("notif-drawer-sort"),g=document.getElementById("notif-drawer-status-tabs"),w=()=>{if(!f)return;const k=m();f.innerHTML=k.length?k.map(p).join(""):'<div class="notif-drawer-empty"><i class="fa-regular fa-bell-slash"></i><p>No notifications match your search/filter.</p></div>',S&&(S.textContent=`Showing ${k.length} of ${s.length}`)};_?.addEventListener("input",k=>{c.search=r(k.target.value),w()}),b?.addEventListener("change",k=>{c.source=r(k.target.value)||"all",w()}),$?.addEventListener("change",k=>{c.sort=r(k.target.value)||"newest",w()}),g?.addEventListener("click",k=>{const T=k.target.closest("[data-notif-status]");T&&(c.status=r(T.getAttribute("data-notif-status"))||"all",g.querySelectorAll(".notif-drawer-status-tab").forEach(E=>E.classList.remove("is-active")),T.classList.add("is-active"),w())}),w(),await window.app_refreshNotificationBell()};window.app_openBirthdayEditor=async a=>{const e=window.AppAuth?.getUser?.();if(!window.app_canAdminBirthdays(e)){alert("You do not have permission to manage birthdays.");return}const t=await window.AppDB.get("users",a);if(!t){alert("Staff member not found.");return}const n=`
    ...
    `:"",l=`
        ...
        </div>`;window.app_showModal(t,"birthday-external-modal")};window.app_submitExternalBirthdayPerson=async a=>{a.preventDefault();const e=window.AppAuth?.getUser?.();if(!window.app_canAdminBirthdays(e)){alert("You do not have permission to manage birthdays.");return}const t=new FormData(a.target),n=String(t.get("name")||"").trim();if(!n){alert("Please enter a name.");return}try{const i=Be(t),s={id:`birthday_person_${Date.now()}_${Math.random().toString(36).slice(2,7)}`,name:n,position:String(t.get("position")||"").trim(),location:String(t.get("location")||"").trim(),birthDay:i.birthDay,birthMonth:i.birthMonth,birthYear:i.birthYear,createdAt:new Date().toISOString(),updatedAt:new Date().toISOString(),createdById:e?.id||"",updatedById:e?.id||""};await window.AppDB.put("birthday_people",s),document.getElementById("birthday-external-modal")?.remove();const o=document.getElementById("page-content");o&&(window.location.hash.slice(1)||"dashboard")==="birthday-calendar"&&(o.innerHTML=await F.renderBirthdayCalendar()),window.app_showSyncToast(`Birthday person saved for ${n}.`)}catch(i){alert(`Failed to save birthday person: ${i.message}`)}};window.app_refreshBirthdayCalendar=async()=>{if((window.location.hash.slice(1)||"dashboard")!=="birthday-calendar")return;const a=document.getElementById("page-content");a&&(a.innerHTML=await F.renderBirthdayCalendar())};window.app_setBirthdayCalendarView=async a=>{const e=window.app_birthdayCalendarState||{};window.app_birthdayCalendarState={...e,view:String(a||"month").toLowerCase()==="year"?"year":"month"},await window.app_refreshBirthdayCalendar()};window.app_goToBirthdayCalendarMonth=async(a,e=null)=>{const t=Number(a||0);if(!t||t<1||t>12)return;const n=it(),i=window.app_birthdayCalendarState||{};window.app_birthdayCalendarState={...i,selectedMonth:t,selectedYear:Number(e||i.selectedYear||n.getFullYear()),view:"month"},await window.app_refreshBirthdayCalendar()};window.app_changeBirthdayCalendarMonth=async a=>{const e=Number(a||0);if(!e)return;const t=it(),n=window.app_birthdayCalendarState||{},i=Number(n.selectedMonth||t.getMonth()+1),s=Number(n.selectedYear||t.getFullYear()),o=new Date(s,i-1+e,1);window.app_birthdayCalendarState={...n,selectedMonth:o.getMonth()+1,selectedYear:o.getFullYear(),view:"month"},await window.app_refreshBirthdayCalendar()};window.app_syncBirthdayReminders=async()=>{const a=window.AppAuth?.getUser?.();if(!window.app_canManageBirthdays(a))return;const[e,t]=await Promise.all([window.AppDB.getAll("users").catch(()=>[]),window.AppDB.getAll("birthday_people",{silentPermissionDenied:!0}).catch(()=>[])]),n=[...Array.isArray(e)?e.map(d=>({...d,birthdaySource:"user"})):[],...Array.isArray(t)?t.map(d=>({...d,birthdaySource:"external"})):[]];if(!n.length)return;const i=it();i.setHours(0,0,0,0);const s=ge(i),o=e.filter(d=>window.app_canManageBirthdays(d));if(!o.length)return;let r=Array.isArray(a?.notifications)?[...a.notifications]:[];for(const d of n){const l=rn(d,i);if(!l)continue;const c=dn(l),p=ge(c);if(p!==s)continue;const m=ge(l);for(const u of o){const y=Array.isArray(u.notifications)?[...u.notifications]:[];y.some(f=>f?.type==="birthday-reminder"&&String(f.birthdayStaffId||"")===String(d.id||"")&&String(f.birthdaySource||"user")===String(d.birthdaySource||"user")&&String(f.birthdayDate||"")===m&&String(f.reminderDate||"")===p)||(y.unshift(ds(d,d.birthdaySource||"user",l,c)),await window.AppDB.put("users",{...u,notifications:y}),a&&String(a.id)===String(u.id)&&(r=y))}}a&&Array.isArray(r)&&(a.notifications=r)};window.app_maybeOpenBirthdayPopup=async()=>{const a=window.AppAuth?.getUser?.();if(!window.app_canManageBirthdays(a)||document.getElementById("birthday-reminder-modal"))return;const e=await window.AppDB.get("users",a.id).catch(()=>a),t=Array.isArray(e?.notifications)?e.notifications.filter(s=>s?.type==="birthday-reminder"&&s?.read!==!0):[];if(!t.length)return;const i=`
        <div class="modal-overlay" id="birthday-reminder-modal" style="display:flex;">
            <div class="modal-content" style="max-width:720px; border-radius:22px; padding:0; overflow:hidden;">
                <div style="padding:1.35rem 1.4rem; background:linear-gradient(135deg, #9a3412, #f97316); color:#fff;">
                    <div style="display:flex; justify-content:space-between; gap:1rem; align-items:flex-start;">
    ...
    `).join("")}
            ...
            `;(document.body||document.getElementById("modal-container")).insertAdjacentHTML("beforeend",m);const u=document.getElementById(d);if(!u){r(c?null:!1);return}u.style.zIndex="20000";const y=u.querySelector(".app-system-dialog-confirm"),h=u.querySelector(".app-system-dialog-cancel"),f=u.querySelector(".app-system-dialog-close"),S=c?u.querySelector(`#${l}`):null,_=b=>{u.remove(),r(b)};y?.addEventListener("click",()=>{_(c?S?S.value:"":!0)}),h?.addEventListener("click",()=>_(c?null:!1)),f?.addEventListener("click",()=>_(c?null:!1)),u.addEventListener("click",b=>{b.target===u&&_(c?null:!1)}),u.addEventListener("keydown",b=>{b.key==="Escape"&&_(c?null:!1),b.key==="Enter"&&(b.preventDefault(),_(c?S?S.value:"":!0))}),S?(S.focus(),S.select()):y?.focus()})};window.appAlert=(a,e="Notice")=>window.app_systemDialog({title:e,message:a,mode:"alert",confirmText:"OK"});window.appConfirm=(a,e="Please Confirm")=>window.app_systemDialog({title:e,message:a,mode:"confirm",confirmText:"Confirm",cancelText:"Cancel"});window.appPrompt=(a,e="",t={})=>window.app_systemDialog({title:t.title||"Enter Details",message:a,mode:"prompt",defaultValue:e,confirmText:t.confirmText||"Save",cancelText:t.cancelText||"Cancel",placeholder:t.placeholder||""});window.alert=a=>{window.appAlert(a)};window.app_openEventModal=()=>{window.app_showModal(`
        ...
        `,"event-modal")};window.app_submitEvent=async a=>{a.preventDefault();const e=document.getElementById("event-title").value,t=document.getElementById("event-date").value,n=document.getElementById("event-type").value;try{await window.AppCalendar.addEvent({title:e,date:t,type:n}),alert("Event added successfully!"),document.getElementById("event-modal")?.remove();const i=document.getElementById("page-content");i.innerHTML=await F.renderDashboard(),Te()}catch(i){alert("Error: "+i.message)}};const ya="work_plan_schema_v2_migrated",es=async()=>{try{if(!window.AppDB||typeof window.AppDB.getAll!="function"||typeof window.AppDB.put!="function"||localStorage.getItem(ya)==="true")return;const a=await window.AppDB.getAll("work_plans");let e=0;for(const t of a){if(!t||Array.isArray(t.plans))continue;const n=typeof t.plan=="string"?t.plan.trim():"";if(!n)continue;const i={...t,plans:[{task:n,subPlans:Array.isArray(t.subPlans)?t.subPlans:[],tags:Array.isArray(t.tags)?t.tags:[],status:t.status||null,completedDate:t.completedDate||null,startDate:t.startDate||t.date,endDate:t.endDate||t.startDate||t.date}]};delete i.plan,delete i.subPlans,delete i.tags,delete i.status,delete i.completedDate,delete i.startDate,delete i.endDate,await window.AppDB.put("work_plans",i),e+=1}localStorage.setItem(ya,"true"),e>0&&console.log(`Work plan schema migration complete. Updated: ${e}`)}catch(a){console.warn("Work plan schema migration failed:",a)}};async function ts(){window.app_initTheme(),Ki(),Ji(),window.addEventListener("app:user-sync",Gi),window.addEventListener("app:update-available",Ze),window.addEventListener("app:update-state",Ze),document.addEventListener("visibilitychange",zi),window.addEventListener("focus",pa),window.addEventListener("online",pa);try{await window.AppAuth.init();const e=window.AppAuth.getUser();e&&(Ye=e.status||"out",tn(),en()),Yi(),await es(),window.AppActivity&&window.AppActivity.initCommandListener()}catch(e){console.error("Initialization Failed:",e),te&&(te.innerHTML=`<div style="text-align:center; padding:2rem; color:red;">Failed to load application.<br><small>${e.message}</small></div>`)}document.addEventListener("click",e=>{e.target.id==="sidebar-toggle"||e.target.closest("#sidebar-toggle")?Wt(!0):e.target.id==="sidebar-overlay"&&Wt(!1)}),window.addEventListener("hashchange",ga),ga();const a=window.AppAuth.getUser();a&&window.AppTour&&window.AppTour.init(a)}async function ga(){const a=window.AppAuth.getUser(),e=window.location.hash.slice(1)||"dashboard";if(e!=="admin"&&ye&&ye.length>0&&(console.log("Cleaning up Admin Realtime Listener."),ye.forEach(l=>typeof l=="function"&&l()),ye=[]),e!=="minutes"&&typeof xe=="function"&&(console.log("Cleaning up Minutes Realtime Listener."),xe(),xe=null),!a){ji(),qi(),Qt(!1),dt&&(dt.style.display="none"),lt&&(lt.style.display="none"),ct&&(ct.style.display="none"),document.body.style.background="#f3f4f6",te&&(te.innerHTML=F.renderLogin()),window.app_refreshNotificationBell&&await window.app_refreshNotificationBell();return}tn(),en(),Wt(!1),dt&&(dt.style.display=""),lt&&(lt.style.display=""),ct&&(ct.style.display="");const t=document.querySelector(".sidebar-footer .user-mini-profile");t&&(t.innerHTML=`
            ...
            `);const n=window.app_hasPerm("attendance","view",a),i=window.app_hasPerm("reports","view",a),s=window.app_hasPerm("policies","view",a),o=window.app_canSeeAdminPanel(a),r=window.app_canManageBirthdays(a);document.querySelectorAll('a[data-page="admin"]').forEach(l=>{l.style.display=o?"flex":"none",o||l.style.setProperty("display","none","important")}),document.querySelectorAll('a[data-page="master-sheet"]').forEach(l=>{l.style.display=n?"flex":"none",n||l.style.setProperty("display","none","important")}),document.querySelectorAll('a[data-page="salary"]').forEach(l=>{l.style.display=i?"flex":"none",i||l.style.setProperty("display","none","important")}),document.querySelectorAll('a[data-page="policy-test"]').forEach(l=>{l.style.display=s?"flex":"none",s||l.style.setProperty("display","none","important")}),document.querySelectorAll('a[data-page="birthday-calendar"]').forEach(l=>{l.style.display=r?"flex":"none",r||l.style.setProperty("display","none","important")}),document.querySelectorAll(".nav-item, .mobile-nav-item").forEach(l=>{l.dataset.page===e?l.classList.add("active"):l.classList.remove("active")});try{const l=document.getElementById("modal-container");if(l&&!document.getElementById("checkout-modal")&&l.insertAdjacentHTML("beforeend",F.renderModals()),te&&(te.innerHTML='<div class="loading-spinner"></div>'),e==="dashboard")te.innerHTML=await F.renderDashboard(),Te();else if(e==="team-activities")te.innerHTML=await F.renderTeamActivitiesPage(),window.app_initTeamActivities&&await window.app_initTeamActivities();else if(e==="staff-directory")te.innerHTML=await F.renderStaffDirectoryPage();else if(e==="policies")window.AppPolicies&&typeof window.AppPolicies.render=="function"?te.innerHTML=await window.AppPolicies.render():te.innerHTML='<div style="padding:1rem; color:#b91c1c;">Policies module failed to load.</div>';else if(e==="annual-plan")te.innerHTML=await F.renderAnnualPlan();else if(e==="birthday-calendar"){if(!window.app_canManageBirthdays(a)){window.location.hash="dashboard";return}te.innerHTML=await F.renderBirthdayCalendar()}else if(e==="timesheet")te.innerHTML=await F.renderTimesheet();else if(e==="profile")te.innerHTML=await F.renderProfile();else if(e==="salary"){if(!window.app_hasPerm("reports","view",a)){window.location.hash="dashboard";return}te.innerHTML=await F.renderSalaryProcessing?await F.renderSalaryProcessing():await F.renderSalary()}else if(e==="policy-test"){if(!window.app_hasPerm("policies","view",a)){window.location.hash="dashboard";return}te.innerHTML=await F.renderPolicyTest()}else if(e==="master-sheet"){if(!(window.app_hasPerm("attendance","view",a)||window.app_canManageAttendanceSheet(a))){window.location.hash="dashboard";return}te.innerHTML=await F.renderMasterSheet()}else if(e==="minutes")te.innerHTML=await F.renderMinutes(),ns();else if(e==="admin"){if(!window.app_canSeeAdminPanel(a)){window.location.hash="dashboard";return}te.innerHTML=await F.renderAdmin(),window.AppAnalytics.initAdminCharts(),as()}await window.app_syncBirthdayReminders?.(),window.app_updateStaffNavIndicator&&await window.app_updateStaffNavIndicator(),window.app_refreshNotificationBell&&await window.app_refreshNotificationBell(),await window.app_maybeOpenBirthdayPopup?.()}catch(l){console.error("Render Error:",l),te.innerHTML=`<div style="text-align:center; color:red; padding:2rem;">Error loading page: ${l.message}</div>`}}function as(){ye.forEach(i=>typeof i=="function"&&i()),ye=[],console.log("Starting Admin Realtime Listeners (Users & Audits)...");let a=null;const e=()=>{a&&clearTimeout(a),a=setTimeout(async()=>{a=null,await t()},600)},t=async()=>{if(window.location.hash.slice(1)!=="admin")return;if(document.querySelector('.modal-overlay[style*="display: flex"], .modal[style*="display: flex"]'))console.log("Admin Update received but skipped because a modal is open.");else{console.log("Admin Data Update Received (Realtime) - Refreshing UI");const o=document.getElementById("page-content");if(o){const r=document.getElementById("audit-start")?.value,d=document.getElementById("audit-end")?.value;o.innerHTML=await F.renderAdmin(r,d),window.AppAnalytics&&window.AppAnalytics.initAdminCharts()}}};if((L&&L.READ_OPT_FLAGS||{}).FF_READ_OPT_TARGETED_REALTIME&&window.AppDB.listenQuery){ye.push(window.AppDB.listenQuery("users",[{field:"status",operator:"in",value:["in","out"]}],{limit:300},e));const i=new Date;i.setDate(i.getDate()-2),ye.push(window.AppDB.listenQuery("location_audits",[{field:"timestamp",operator:">=",value:i.getTime()}],{orderBy:[{field:"timestamp",direction:"desc"}],limit:300},e))}else ye.push(window.AppDB.listen("users",e)),ye.push(window.AppDB.listen("location_audits",e))}function ns(){if(!window.AppDB||!window.AppDB.listen)return;typeof xe=="function"&&(xe(),xe=null);const a=async()=>{if((window.location.hash.slice(1)||"dashboard")!=="minutes"||document.getElementById("minute-detail-modal"))return;const n=document.getElementById("page-content");n&&(n.innerHTML=await F.renderMinutes())};(L&&L.READ_OPT_FLAGS||{}).FF_READ_OPT_TARGETED_REALTIME&&window.AppDB.listenQuery?xe=window.AppDB.listenQuery("minutes",[],{orderBy:[{field:"date",direction:"desc"}],limit:150},a):xe=window.AppDB.listen("minutes",a)}function is(a=null,e=!1){Ct&&clearInterval(Ct),(async()=>{let n="out",i=null;if(a)n=a.status||"out",i=a.lastCheckIn||null;else{const m=await window.AppAttendance.getStatus();n=m.status,i=m.lastCheckIn}const s=document.getElementById("timer-display"),o=document.getElementById("countdown-container"),r=document.getElementById("overtime-container"),d=document.getElementById("countdown-value"),l=document.getElementById("countdown-progress"),c=document.getElementById("overtime-value"),p=document.getElementById("timer-label");if(n==="in"&&i){const m=new Date(i),u=new Date,y=`${m.getFullYear()}-${String(m.getMonth()+1).padStart(2,"0")}-${String(m.getDate()).padStart(2,"0")}`,h=`${u.getFullYear()}-${String(u.getMonth()+1).padStart(2,"0")}-${String(u.getDate()).padStart(2,"0")}`,f=y!==h,S=new Date(m);S.setHours(17,0,0,0);const _=m.getDay();_===6&&S.setHours(13,0,0,0),_===0&&S.setHours(17,0,0,0),Ct=setInterval(()=>{const b=Date.now(),$=b-i;if(s){let w=Math.floor($/36e5),k=Math.floor($/(1e3*60)%60),T=Math.floor($/1e3%60);w=w<10?"0"+w:w,k=k<10?"0"+k:k,T=T<10?"0"+T:T,s.textContent=`${w} : ${k} : ${T}`}if(f){o&&(o.style.display="none"),r&&(r.style.display="none"),s&&(s.style.color="#b45309"),p&&(p.textContent="Session Carryover (Please Check Out)",p.style.color="#b45309");return}const g=S.getTime()-b;if(g>0){o&&(o.style.display="block"),r&&(r.style.display="none"),p&&(p.textContent="Elapsed Time",p.style.color="#6b7280"),s&&(s.style.color="#1f2937");let w=Math.floor(g/(1e3*60*60)%24),k=Math.floor(g/(1e3*60)%60),T=Math.floor(g/1e3%60);w=w<10?"0"+w:w,k=k<10?"0"+k:k,T=T<10?"0"+T:T;const E=S.getTime()-i,v=E>0?Math.min(100,$/E*100):100;d&&(d.textContent=`${w}:${k}:${T}`),l&&(l.style.width=`${v}%`),l&&(l.style.background="var(--primary)")}else{o&&(o.style.display="none"),r&&(r.style.display="block");const w=Math.abs(b-S.getTime());let k=Math.floor(w/(1e3*60*60)),T=Math.floor(w/(1e3*60)%60),E=Math.floor(w/1e3%60);k=k<10?"0"+k:k,T=T<10?"0"+T:T,E=E<10?"0"+E:E,c&&(c.textContent=`+ ${k}:${T}:${E}`),s&&(s.style.color="#c2410c"),p&&(p.textContent="Total Elapsed (Overtime)",p.style.color="#c2410c")}},1e3),!e&&window.AppActivity&&window.AppActivity.start&&window.AppActivity.start()}else s&&(s.textContent="00 : 00 : 00",s.style.color=""),p&&(p.textContent="Elapsed Time",p.style.color=""),o&&(o.style.display="none"),r&&(r.style.display="none")})()}window.getLocation=function(){return new Promise((e,t)=>{(async()=>{const n=window.location&&window.location.hostname?window.location.hostname:"",i=n==="localhost"||n==="127.0.0.1"||n==="::1";if(!window.isSecureContext&&!i){t("Location requires HTTPS on mobile. Open this app using an HTTPS URL and allow location access.");return}const s=Date.now();if(Pe&&s-je<Ja){console.log("Using cached location (freshness: "+(s-je)+"ms)"),e(Pe);return}if(!navigator.geolocation){t("Geolocation is not supported by your browser.");return}try{if(navigator.permissions&&navigator.permissions.query){const r=await navigator.permissions.query({name:"geolocation"});if(r&&r.state==="denied"){t("Location permission is blocked. Enable location for this site in browser settings and try again.");return}}}catch{}const o=r=>new Promise((d,l)=>{navigator.geolocation.getCurrentPosition(d,l,r)});try{console.log("Requesting Location: High Accuracy (GPS)...");const r=await o({enableHighAccuracy:!0,timeout:1e4,maximumAge:5e3}),d={lat:r.coords.latitude,lng:r.coords.longitude};Pe=d,je=Date.now(),e(d)}catch(r){console.warn("High Accuracy Failed:",r.message);try{console.log("Requesting Location: Low Accuracy (Fallback)...");const d=await o({enableHighAccuracy:!1,timeout:15e3,maximumAge:1e4}),l={lat:d.coords.latitude,lng:d.coords.longitude};Pe=l,je=Date.now(),e(l)}catch(d){console.error("Low Accuracy Failed:",d.message);let l="Unable to retrieve location.";d.code===1?l="Location permission denied.":d.code===2?l="Location unavailable. Ensure GPS/Location Services are turned on.":d.code===3&&(l="Location request timed out. Move to open sky or better network and try again."),t(l)}}})().catch(n=>{t(n&&n.message?n.message:"Unable to retrieve location.")})})};const le=a=>/^\d{4}-\d{2}-\d{2}$/.test(String(a||"")),ss={january:0,february:1,march:2,april:3,may:4,june:5,july:6,august:7,september:8,october:9,november:10,december:11},os=(a="")=>{const e=String(a||"").trim();if(!e)return null;const t=e.match(/(\d{1,2})\s*-\s*(\d{1,2})\s+([A-Za-z]+)\s+(\d{4})/);if(!t)return null;const n=Number(t[1]),i=Number(t[2]),s=String(t[3]||"").toLowerCase(),o=Number(t[4]),r=ss[s];if(!Number.isInteger(n)||!Number.isInteger(i)||!Number.isInteger(r)||!Number.isInteger(o))return null;const d=new Date(o,r,n),l=new Date(o,r,i);if(Number.isNaN(d.getTime())||Number.isNaN(l.getTime()))return null;const c=`${d.getFullYear()}-${String(d.getMonth()+1).padStart(2,"0")}-${String(d.getDate()).padStart(2,"0")}`,p=`${l.getFullYear()}-${String(l.getMonth()+1).padStart(2,"0")}-${String(l.getDate()).padStart(2,"0")}`;return p<c?null:{startDate:c,endDate:p}},nn=(a,e,t=null)=>{const n=le(e)?String(e):null,i=a?.startDate,s=a?.endDate,o=!le(i)&&!le(s)?os(a?.task||""):null;let r=le(i)?String(i):o?.startDate||n,d=le(s)?String(s):o?.endDate||r||n;if((!le(i)||!le(s))&&a?.sourcePlanId&&t?.workPlans){const l=(t.workPlans||[]).find(m=>m.id===a.sourcePlanId),c=Number.isInteger(a.sourceTaskIndex)?a.sourceTaskIndex:Number(a.sourceTaskIndex),p=l&&Array.isArray(l.plans)&&Number.isInteger(c)?l.plans[c]:null;if(p){const m=le(p.startDate)?p.startDate:l.date||r,u=le(p.endDate)?p.endDate:p.startDate||l.date||d;le(i)||(r=m),le(s)||(d=u)}}return r&&d&&d<r?{startDate:r,endDate:r}:{startDate:r,endDate:d}},sn=(a,e,t,n=null)=>{const{startDate:i,endDate:s}=nn(a,e,n);return!i||!s?e===t:!(t<i||t>s||a?.completedDate&&a.completedDate<t)};window.app_getDayEvents=(a,e,t={})=>{const n=t.includeAuto!==!1,i=t.dedupe!==!1,s=t.userId||null;if(!e)return[];if(Array.isArray(e))return e.filter(l=>l.date===a);const o=new Date(a),r=[];if(n&&window.AppAnalytics){const l=window.AppAnalytics.getDayType(o);l==="Holiday"?r.push({title:"Company Holiday (Weekend)",type:"holiday",date:a}):l==="Half Day"&&r.push({title:"Half Working Day (Sat)",type:"event",date:a})}if((e.leaves||[]).forEach(l=>{a>=l.startDate&&a<=l.endDate&&r.push({title:`${l.userName||"Staff"} (Leave)`,type:"leave",userId:l.userId,date:a})}),(e.events||[]).forEach(l=>{l.date===a&&r.push({title:l.title,type:l.type||"event",date:a})}),(e.workPlans||[]).forEach(l=>{if(l.date>a)return;const p=(Array.isArray(l.plans)?l.plans:[]).filter(h=>sn(h,l.date,a,e));if(!p.length)return;const y=`${(l.planScope||"personal")==="annual"?"All Staff (Annual)":l.userName||"Staff"}: ${p.map(h=>h.task).join("; ")}`;r.push({title:y,type:"work",userId:l.userId,plans:p,date:a,planScope:l.planScope||"personal"})}),s){const l=[];r.forEach(c=>{if(c.type!=="work"){l.push(c);return}if((c.planScope||"").toLowerCase()==="annual"){l.push(c);return}if(c.userId===s){l.push(c);return}if(Array.isArray(c.plans)&&c.plans.some(m=>Array.isArray(m.tags)&&m.tags.some(u=>u.id===s&&u.status==="accepted"))){l.push(c);return}}),r.length=0,r.push(...l)}if(!i)return r;const d=new Set;return r.filter(l=>{const c=l.type||"event";if(c!=="holiday"&&c!=="event")return!0;const p=`${c}|${l.title||""}|${l.userId||""}|${l.date||a}`;return d.has(p)?!1:(d.add(p),!0)})};const Zt=(a,e)=>{const t=String(a??"").trim();return!t||t==="undefined"||t==="null"?e:t},Q=a=>String(a??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;"),ce=a=>String(a??"").replace(/\\/g,"\\\\").replace(/'/g,"\\'"),Dt=a=>{const e=String(a||"").trim();if(!e)return"";if(/^\d{4}-\d{2}-\d{2}$/.test(e))return e;const t=new Date(e);return Number.isNaN(t.getTime())?"":`${t.getFullYear()}-${String(t.getMonth()+1).padStart(2,"0")}-${String(t.getDate()).padStart(2,"0")}`},xt=(a,e)=>{const t=Dt(a);if(!t)return"NA";const n=t.replace(/-/g,""),i=String(e||"").replace(/[^a-zA-Z0-9]/g,"").toUpperCase().slice(-3)||"USR";return`EMP-${n}-${i}`},Ut=(a,e,t)=>{const n=String(a??"").trim();if(!n)return null;if(!/^\d+$/.test(n))throw new Error("Birthday fields must be numeric.");const i=Number(n);if(!Number.isInteger(i)||i<e||i>t)throw new Error(`Birthday value must be between ${e} and ${t}.`);return i},on=(a,e)=>new Date(a,e,0).getDate(),Be=a=>{const e=new Date().getFullYear()+1,t=Ut(a.get("birthDay"),1,31),n=Ut(a.get("birthMonth"),1,12),i=Ut(a.get("birthYear"),1900,e);if(t&&n){const o=on(i||2024,n);if(t>o)throw new Error(`Birthday day is not valid for month ${n}.`)}return{birthDay:t,birthMonth:n,birthYear:i}},wt=(a,e,t=null)=>{const n=Number(a||0),i=Number(e||0),s=Number(t||0),o=i>=1&&i<=12?new Date(2026,i-1,1).toLocaleString("en-US",{month:"long"}):"--",r=n?String(n).padStart(2,"0"):"--",d=s?` ${s}`:"";return`${r} ${o}${d}`.trim()},$t=(a="user")=>(String(a||"user").trim().toLowerCase()==="external"?"external":"user")==="external"?{source:"external",collection:"birthday_people",label:"Birthday Person",emptyMessage:"Birthday person not found.",roleLabel:"Position",deptLabel:"Location"}:{source:"user",collection:"users",label:"Staff",emptyMessage:"Staff member not found.",roleLabel:"Role",deptLabel:"Department"},rs=(a,e="user")=>$t(e).source==="external"?{title:a?.name||"Birthday Person",subtitle:`${a?.position||"Position not set"} • ${a?.location||"Location not set"}`}:{title:a?.name||"Staff",subtitle:`${a?.role||"Employee"} • ${a?.dept||"General"}`},ds=(a,e,t,n)=>{const i=$t(e),s=ge(t),o=ge(n),r=ln(t,n),d=i.source==="external",l=d?a?.position||"":a?.role||"",c=d?a?.location||"":a?.dept||"",p=d?"Birthday Person":"Staff";return{id:`birthday_${i.source}_${s}_${a.id}_${Date.now()}_${Math.random().toString(36).slice(2,6)}`,type:"birthday-reminder",title:`Upcoming Birthday: ${a.name||p}`,message:`${a.name||p} has a birthday on ${wt(a.birthDay,a.birthMonth)}.`,description:`${r}. ${l||(d?"Position not set":"Employee")} • ${c||(d?"Location not set":"General")}`,status:"pending",date:new Date().toISOString(),read:!1,taggedByName:"Birthday Calendar",birthdayStaffId:a.id,birthdayStaffName:a.name||p,birthdaySource:i.source,birthdayDate:s,reminderDate:o,birthdayDisplay:wt(a.birthDay,a.birthMonth,a.birthYear),birthdayReason:r,role:l,dept:c}},it=()=>window.AppDB&&typeof window.AppDB.getIstNow=="function"?window.AppDB.getIstNow():new Date,ge=a=>{const e=a instanceof Date?new Date(a):new Date(a);return`${e.getFullYear()}-${String(e.getMonth()+1).padStart(2,"0")}-${String(e.getDate()).padStart(2,"0")}`},rn=(a,e=it())=>{const t=Number(a?.birthDay||0),n=Number(a?.birthMonth||0);if(!t||!n)return null;const i=new Date(e),s=d=>{const l=on(d,n),c=Math.min(t,l);return new Date(d,n-1,c)};let o=s(i.getFullYear());o.setHours(0,0,0,0);const r=ge(i);return ge(o)<r&&(o=s(i.getFullYear()+1),o.setHours(0,0,0,0)),o},ls=a=>window.AppAnalytics?.getDayType?.(a)!=="Holiday",dn=a=>{const e=new Date(a);for(e.setHours(0,0,0,0),e.setDate(e.getDate()-1);!ls(e);)e.setDate(e.getDate()-1);return e},ln=(a,e)=>Math.round((a.getTime()-e.getTime())/864e5)<=1?"Birthday is tomorrow":"Birthday is on the next working day",Re=(a,e="NA")=>{if(a==null||a==="")return e;const t=a instanceof Date?a:new Date(a);return Number.isNaN(t.getTime())?e:t.toLocaleDateString("en-GB")},cs=(a,e="NA")=>{if(a==null||a==="")return e;const t=a instanceof Date?a:new Date(a);return Number.isNaN(t.getTime())?e:t.toLocaleString("en-GB")},ps=a=>`Rs ${Number(a||0).toLocaleString("en-IN")}`,us=(a="")=>{const e=String(a||"").replace(/\s+/g," ").trim();return e?e.length>72?`${e.slice(0,72)}...`:e:"New task"},ea=()=>`
        <div class="no-tags-placeholder day-plan-no-tags-placeholder">
            <p class="day-plan-no-tags-text">No collaborators yet</p>
        </div>
    `,cn=(a,e,t="pending")=>`
        <div class="tag-chip day-plan-tag-chip" data-id="${Q(a)}" data-name="${Q(e)}" data-status="${Q(t)}">
            <span class="day-plan-tag-main">@${Q(e)} <span class="day-plan-tag-pending">(${Q(t)})</span></span>
            <i class="fa-solid fa-times day-plan-remove-collab-btn" onclick="window.app_removeTagHint(this)"></i>
        </div>
    `;window.app_refreshPlanBlockSummary=a=>{if(!a)return;const e=a.querySelector(".plan-task"),t=a.querySelector(".day-plan-task-summary"),n=a.querySelector(".plan-scope"),i=a.querySelector(".day-plan-scope-pill"),s=us(e?e.value:"");t&&(t.textContent=s),i&&n&&(i.textContent=n.value==="annual"?"Annual Plan":"Personal Plan")};window.app_togglePlanBlockCollapse=a=>{const e=a.closest(".plan-block");if(!e)return;e.classList.toggle("is-collapsed");const t=e.classList.contains("is-collapsed"),n=a.querySelector("i");n&&(n.classList.toggle("fa-chevron-down",!t),n.classList.toggle("fa-chevron-up",t));const i=a.querySelector(".day-plan-collapse-label");i&&(i.textContent=t?"Expand":"Minimize"),window.app_refreshPlanBlockSummary(e)};window.app_toggleTaskCollaborator=(a,e,t)=>{const n=a.closest(".plan-block");if(!n)return;const i=n.querySelector(".tags-container");if(!i)return;const s=typeof CSS<"u"&&CSS.escape?CSS.escape(e):e.replace(/"/g,'\\"'),o=i.querySelector(`[data-id="${s}"]`);if(o)o.remove(),a.classList.remove("selected");else{const r=i.querySelector(".no-tags-placeholder");r&&r.remove(),i.insertAdjacentHTML("beforeend",cn(e,t,"pending")),a.classList.add("selected")}i.querySelectorAll(".tag-chip").length===0&&(i.innerHTML=ea())};window.app_getAnnualDayStaffPlans=a=>{const e=window._currentPlans||{},t=window._annualUserMap||{},i=(e.workPlans||[]).filter(r=>r.date<=a).map(r=>{const d=t[r.userId]||r.userName||"Staff",l=new Map,c=y=>String(y||"").toLowerCase().replace(/\d{1,2}\s*-\s*\d{1,2}\s+[a-z]+\s+\d{4}/g," ").replace(/\([^)]*\)/g," ").replace(/[^a-z\s]/g," ").split(/\s+/).filter(Boolean).slice(0,8).join(" "),p=(y,h="")=>{const f=String(y).trim();if(!f)return;const S=c(f)||f.toLowerCase().replace(/\s+/g," "),_=`${f}${h||""}`;if(!l.has(S)){l.set(S,_);return}(l.get(S)||"")===f&&_!==f&&l.set(S,_)},m=(Array.isArray(r.plans)?r.plans:[]).filter(y=>sn(y,r.date,a,e)).map(y=>{const{startDate:h,endDate:f}=nn(y,r.date,e),S=!!(h&&f&&h!==f),_=f===a,b=h===a,g=y.completedDate&&y.completedDate<f&&y.completedDate===a?" (Completed Early)":S&&_?" (Ends Today)":S&&b?" (Starts Today)":"";return p(y.task||"Planned task",g),""}).filter(Boolean),u=Array.from(l.values());return!u.length&&m.length?{name:d,tasks:m}:u.length?{name:d,tasks:u}:null}).filter(Boolean),s=r=>String(r||"").toLowerCase().replace(/\d{1,2}\s*-\s*\d{1,2}\s+[a-z]+\s+\d{4}/g," ").replace(/\([^)]*\)/g," ").replace(/[^a-z\s]/g," ").split(/\s+/).filter(Boolean).slice(0,8).join(" "),o=new Map;return i.forEach(r=>{const d=r.name||"Staff";o.has(d)||o.set(d,new Map);const l=o.get(d);(r.tasks||[]).forEach(c=>{const p=s(c)||String(c||"").toLowerCase();if(!l.has(p))l.set(p,c);else{const m=l.get(p)||"",u=String(c||"");m.length<u.length&&l.set(p,u)}})}),Array.from(o.entries()).map(([r,d])=>({name:r,tasks:Array.from(d.values())}))};window.app_showAnnualHoverPreview=(a,e)=>{const t="annual-hover-preview";document.getElementById(t)?.remove();const n=window.app_getAnnualDayStaffPlans(e),i=n.length?n.map(o=>`
        ...
        <div class="modal-content checkout-action-detail-content">
            ...
            <div class="checkout-task-panel-body">
                ...
                <div class="checkout-task-field">
                    <label>Note</label>
                    <textarea rows="2" data-progress-note placeholder="What changed? (optional)" oninput="window.app_updateCheckoutTaskNote('${ce(a)}', this.value)">${u}</textarea>
                </div>
                ...
                <div class="checkout-task-action-extra" data-action-panel-section="postpone" style="display:${e.action==="postpone"?"block":"none"};">
                    ...
                    <input type="date" data-action-field="postponeDate" value="${d}" onchange="window.app_updateCheckoutTaskActionMeta('${ce(a)}','postponeDate', this.value)">
                    <label>Reason</label>
                    <textarea rows="2" data-action-field="postponeReason" placeholder="Why postponed?" oninput="window.app_updateCheckoutTaskActionMeta('${ce(a)}','postponeReason', this.value)">${l}</textarea>
                </div>
...
Please enable location and try again.`)}})();else if(e==="edit-user-form")console.log("Routing to app_submitEditUser..."),window.app_submitEditUser(a);else if(e==="birthday-details-form")window.app_submitBirthdayDetails(a);else if(e==="birthday-external-form")window.app_submitExternalBirthdayPerson(a);else if(e.startsWith("birthday-month-form-")){const t=Number(e.replace("birthday-month-form-",""));window.app_submitBirthdayMonthForm(a,t)}else e==="notify-form"?vs(a):e==="leave-request-form"?ws(a):console.warn("Unhandled form submission ID:",e,"Target:",a.target)});async function ws(a){const e=new FormData(a.target),t=window.AppAuth.getUser(),n=e.get("startDate");let i=e.get("endDate");const s=e.get("type");s==="Half Day"&&(i=n),await window.AppLeaves.requestLeave({userId:t.id,userName:t.name,startDate:n,endDate:i,startTime:e.get("startTime")||"",endTime:e.get("endTime")||"",type:s,reason:e.get("reason"),durationHours:e.get("durationHours")||""}),alert("Leave requested successfully!"),document.getElementById("leave-modal").style.display="none",a.target.reset()}async function vs(a){a.preventDefault();const e=new FormData(a.target),t=e.get("toUserId"),n=e.get("reminderMessage")||"",i=e.get("reminderLink")||"",s=e.get("taskTitle")||"",o=e.get("taskDescription")||"",r=e.get("taskDueDate")||"";try{if(!n.trim()&&!s.trim()){alert("Please enter a reminder or a task.");return}const d=await window.AppDB.get("users",t);if(!d)throw new Error("User not found");const l=window.AppAuth.getUser(),c=new Date().toISOString();d.notifications||(d.notifications=[]),n.trim()&&(d.notifications.unshift({id:`rem_${Date.now()}`,type:"reminder",message:n.trim(),taggedById:l.id,taggedByName:l.name,taggedAt:c,status:"pending",date:c,read:!1}),await window.AppDB.add("staff_messages",{id:`msg_${Date.now()}_${Math.random().toString(36).slice(2,6)}`,type:"text",message:n.trim(),link:i.trim(),fromId:l.id,fromName:l.name,toId:t,toName:d.name,createdAt:c,read:!1})),s.trim()&&(d.notifications.unshift({id:`task_${Date.now()}`,type:"task",title:s.trim(),description:o.trim(),taggedById:l.id,taggedByName:l.name,taggedAt:c,status:"pending",dueDate:r||"",date:c,read:!1}),await window.AppDB.add("staff_messages",{id:`task_${Date.now()}_${Math.random().toString(36).slice(2,6)}`,type:"task",title:s.trim(),description:o.trim(),dueDate:r||"",status:"pending",fromId:l.id,fromName:l.name,toId:t,toName:d.name,createdAt:c,read:!1,history:[{action:"created",byId:l.id,byName:l.name,at:c}]})),await window.AppAuth.updateUser(d),alert("Notification sent!"),document.getElementById("notify-modal").style.display="none",window.app_updateStaffNavIndicator&&await window.app_updateStaffNavIndicator()}catch(d){alert("Failed to send: "+d.message)}}window.app_openStaffThread=async a=>{window.app_staffThreadId=a;const e=window.AppAuth.getUser();if(!e)return;const n=(await window.app_getMyMessages()).filter(s=>s.toId===e.id&&s.fromId===a&&!s.read);for(const s of n)s.read=!0,s.readAt=new Date().toISOString(),await window.AppDB.put("staff_messages",s);const i=document.getElementById("page-content");i&&(i.innerHTML=await F.renderStaffDirectoryPage()),window.app_updateStaffNavIndicator&&await window.app_updateStaffNavIndicator()};window.app_sendStaffText=async a=>{a.preventDefault();const e=window.AppAuth.getUser(),t=new FormData(a.target),n=t.get("toUserId"),i=(t.get("message")||"").trim(),s=(t.get("link")||"").trim();if(!i){alert("Please type a message.");return}const o=await window.AppDB.get("users",n);if(!o){alert("Staff member not found.");return}await window.AppDB.add("staff_messages",{id:`msg_${Date.now()}_${Math.random().toString(36).slice(2,6)}`,type:"text",message:i,link:s,fromId:e.id,fromName:e.name,toId:n,toName:o.name,createdAt:new Date().toISOString(),read:!1}),a.target.reset();const r=document.getElementById("staff-message-modal");r&&r.remove();const d=document.getElementById("page-content");d&&(d.innerHTML=await F.renderStaffDirectoryPage()),window.app_updateStaffNavIndicator&&await window.app_updateStaffNavIndicator()};window.app_sendStaffTask=async a=>{a.preventDefault();const e=window.AppAuth.getUser(),t=new FormData(a.target),n=t.get("toUserId"),i=(t.get("taskTitle")||"").trim(),s=(t.get("taskDescription")||"").trim(),o=(t.get("taskDueDate")||"").trim();if(!i){alert("Please provide a task title.");return}const r=await window.AppDB.get("users",n);if(!r){alert("Staff member not found.");return}await window.AppDB.add("staff_messages",{id:`task_${Date.now()}_${Math.random().toString(36).slice(2,6)}`,type:"task",title:i,description:s,dueDate:o,status:"pending",fromId:e.id,fromName:e.name,toId:n,toName:r.name,createdAt:new Date().toISOString(),read:!1,history:[{action:"created",byId:e.id,byName:e.name,at:new Date().toISOString()}]}),a.target.reset();const d=document.getElementById("staff-task-modal");d&&d.remove();const l=document.getElementById("page-content");l&&(l.innerHTML=await F.renderStaffDirectoryPage()),window.app_updateStaffNavIndicator&&await window.app_updateStaffNavIndicator()};window.app_openStaffMessageModal=(a,e)=>{if(!a){alert("Select a staff member first.");return}const n=`
        ...
        `;window.app_showModal(o,"cell-override-modal")};window.app_submitCellOverride=async(a,e,t,n)=>{if(!window.app_canManageAttendanceSheet()){alert("You do not have permission for this action.");return}a.preventDefault();const i=new FormData(a.target),s=i.get("checkIn"),o=i.get("checkOut"),r=ta(s,o);if(r==="Invalid"){alert("End time must be after Start time");return}const d=window.AppAttendance.buildDateTime(t,s),l=window.AppAttendance.buildDateTime(t,o),c=d&&l?l-d:0,p=window.AppAttendance.evaluateAttendanceStatus(d||new Date,c),m=i.get("isManualOverride")==="on",u=String(i.get("type")||"").trim(),y=m&&u?u:p.status,h=S=>{if(!S||S==="--")return"--";const[_,b]=S.split(":"),$=parseInt(_),g=$>=12?"PM":"AM",w=$%12||12;return`${String(w).padStart(2,"0")}:${b} ${g}`},f={date:t,checkIn:h(s),checkOut:h(o),duration:r,type:y,workDescription:i.get("description")||"Admin Override",location:"Office (Override)",durationMs:c,dayCredit:p.dayCredit,lateCountable:p.lateCountable,extraWorkedMs:p.extraWorkedMs||0,policyVersion:"v2",isManualOverride:m,entrySource:"admin_override",attendanceEligible:!0,autoCheckoutExtraApproved:i.get("autoCheckoutExtraApproved")==="on"};try{n?await window.AppAttendance.updateLog(n,f):await window.AppAttendance.addAdminLog(e,f),alert("Override successful."),document.getElementById("cell-override-modal")?.remove(),window.app_refreshMasterSheet()}catch(S){alert("Error: "+S.message)}};window.app_deleteCellLog=async(a,e)=>{if(!window.app_canManageAttendanceSheet()){alert("You do not have permission for this action.");return}if(await window.appConfirm("Delete this attendance record?"))try{await window.AppAttendance.deleteLog(a),document.getElementById("cell-override-modal")?.remove(),window.app_refreshMasterSheet()}catch(t){alert("Error: "+t.message)}};function bt(a){if(!a||a==="--"||a==="Active Now")return"09:00";const[e,t]=a.split(" ");let[n,i]=e.split(":"),s=parseInt(n);return t==="PM"&&s<12&&(s+=12),t==="AM"&&s===12&&(s=0),`${String(s).padStart(2,"0")}:${i}`}const bs=a=>{if(!a)return null;const e=String(a).trim();if(/^\d{4}-\d{2}-\d{2}$/.test(e))return e;const t=new Date(e);if(!Number.isNaN(t.getTime())){const i=t.getFullYear(),s=String(t.getMonth()+1).padStart(2,"0"),o=String(t.getDate()).padStart(2,"0");return`${i}-${s}-${o}`}const n=e.match(/^(\d{1,2})[-/](\d{1,2})[-/](\d{4})$/);if(n){const i=Number(n[1]),s=Number(n[2]),o=Number(n[3]);let r=i,d=s;return d>12&&i<=12&&(d=i,r=s),d<1||d>12||r<1||r>31?null:`${o}-${String(d).padStart(2,"0")}-${String(r).padStart(2,"0")}`}return null};window.app_runAttendancePolicyMigration=async()=>{if(!window.app_canManageAttendanceSheet()){alert("You do not have permission for this action.");return}if(await window.appConfirm("Recalculate historical attendance logs with the current policy? This updates stored status/credits for existing office logs.","Run Attendance Migration"))try{const e=await window.AppDB.getAll("attendance");let t=0,n=0,i=0;const s=new Set(["Work - Home","Training","On Duty","Holiday","National Holiday","Regional Holidays"]);let o=0,r=0;const d=new Map,l=new Map,c=h=>{const f=bs(h?.date),S=typeof h?.activityScore<"u"||typeof h?.locationMismatched<"u"||typeof h?.autoCheckout<"u"||!!h?.checkOutLocation||typeof h?.outLat<"u"||typeof h?.outLng<"u";let b=String(h?.entrySource||"").trim();b||(h?.isManualOverride||h?.location==="Office (Manual)"||h?.location==="Office (Override)"?b="admin_override":S?b="checkin_checkout":b="staff_manual_work");const $=h?.checkIn&&h?.checkOut&&h?.checkOut!=="Active Now"?bt(h.checkIn):null,g=h?.checkIn&&h?.checkOut&&h?.checkOut!=="Active Now"?bt(h.checkOut):null,w=f&&$?window.AppAttendance.buildDateTime(f,$):null,k=f&&g?window.AppAttendance.buildDateTime(f,g):null,T=!!(w&&k&&k>w),E=T?k-w:null,v=typeof h?.durationMs=="number"?h.durationMs:E,x=typeof v=="number"?Math.max(0,v)/(1e3*60*60):0;let A;return Object.prototype.hasOwnProperty.call(h||{},"attendanceEligible")?A=h.attendanceEligible===!0:b==="staff_manual_work"?A=x>=4:A=!0,{dateIso:f,inDt:w,outDt:k,validTimeRange:T,resolvedDurationMs:v,workedHours:x,inferredSource:b,inferredAttendanceEligible:A}},p=(h,f)=>{const S=window.AppAttendance.normalizeType(h?.type);let _=0;f.inferredSource==="staff_manual_work"?f.workedHours>=8?_=100:f.workedHours>=4&&(_=50):_=Number(window.AppAttendance.getDayCredit(S)||0)*100;let b=0;return b+=_,b+=Math.min(20,Math.floor(Math.max(0,f.workedHours||0))),f.inferredAttendanceEligible&&(b+=40),f.validTimeRange&&(b+=10),f.inferredSource==="checkin_checkout"?b+=8:f.inferredSource==="admin_override"?b+=6:b+=4,h?.isManualOverride&&(b+=4),(String(h?.type||"").includes("Leave")||h?.location==="On Leave")&&(b+=6),b+=Number(h?.id||0)/1e13,b};for(const h of e){if(!h||!h.id)continue;const f=c(h);d.set(h.id,f);const S=h.user_id||h.userId;if(!S||!f.dateIso)continue;const _=`${S}|${f.dateIso}`;l.has(_)||l.set(_,[]),l.get(_).push(h)}const m=new Map;for(const[h,f]of l.entries()){if(!f||f.length===0)continue;const S=f.slice().sort((_,b)=>{const $=d.get(_.id)||c(_),g=d.get(b.id)||c(b);return p(b,g)-p(_,$)});m.set(h,S[0]?.id)}for(const h of e){if(t++,!h||!h.id){i++;continue}const f=window.AppAttendance.normalizeType(h.type),S=d.get(h.id)||c(h),_=S.dateIso,b=S.inDt,$=S.outDt,g=S.resolvedDurationMs,w=S.workedHours,k=S.inferredSource;let T=S.inferredAttendanceEligible;const E=h.user_id||h.userId,v=E&&_?`${E}|${_}`:null,x=v?m.get(v):null,A=!!(x&&x!==h.id),O=!!(h.checkIn&&h.checkOut&&h.checkOut!=="Active Now")&&!!(b&&$&&$<=b),I=!!(h.autoCheckout&&String(h.missedCheckoutReasonStatus||"").toLowerCase()==="approved");let N=h.type,P=h.dayCredit,B=h.lateCountable,U=h.extraWorkedMs||0;if(A&&(T=!1,String(h.type||"").includes("Leave")||(N="Work Log"),P=0,B=!1,U=0,o++),O&&(T=!1,String(h.type||"").includes("Leave")||(N="Work Log"),P=0,B=!1,U=0,r++),I&&!A&&!O)N="Present",P=window.AppAttendance&&typeof window.AppAttendance.getDayCredit=="function"?window.AppAttendance.getDayCredit("Present"):1,B=!1,U=0;else if(k==="staff_manual_work"&&!A&&!O)w>=8?(N="Present",P=1):w>=4?(N="Half Day",P=.5):(N="Work Log",P=0),B=!1,U=0;else if(!h.isManualOverride&&T&&!(s.has(f)||String(f).includes("Leave")||f==="Office")&&b&&$&&$>b){const J=window.AppAttendance.evaluateAttendanceStatus(b,$-b);N=J.status,P=J.dayCredit,B=J.lateCountable,U=J.extraWorkedMs||0}const j={...h,entrySource:k,attendanceEligible:T,type:N,dayCredit:typeof P=="number"?P:0,lateCountable:B===!0,extraWorkedMs:U||0,durationMs:typeof g=="number"?g:null,missedCheckoutApprovedAsFullDay:I?!0:h.missedCheckoutApprovedAsFullDay,policyVersion:"v2"};if(!(h.entrySource!==j.entrySource||h.attendanceEligible!==j.attendanceEligible||h.type!==j.type||h.dayCredit!==j.dayCredit||h.lateCountable!==j.lateCountable||(h.extraWorkedMs||0)!==(j.extraWorkedMs||0)||h.durationMs!==j.durationMs||h.policyVersion!=="v2")){i++;continue}await window.AppDB.put("attendance",j),n++}alert(`Migration complete.
Scanned: ${t}
Updated: ${n}
Skipped: ${i}
Duplicates neutralized: ${o}
Invalid-time logs neutralized: ${r}`);const u=window.location.hash.slice(1),y=document.getElementById("page-content");if(!y)return;u==="policy-test"?y.innerHTML=await F.renderPolicyTest():u==="dashboard"?(y.innerHTML=await F.renderDashboard(),window.setupDashboardEvents&&window.setupDashboardEvents()):u==="salary"?(y.innerHTML=await F.renderSalaryProcessing(),window.app_recalculateAllSalaries&&window.app_recalculateAllSalaries()):u==="timesheet"&&(y.innerHTML=await F.renderTimesheet())}catch(e){console.error("Attendance migration failed:",e),alert("Migration failed: "+e.message)}};window.app_deleteUser=async a=>{if(await window.appConfirm("Are you sure you want to delete this user? This action cannot be undone."))try{await window.AppDB.delete("users",a),alert("User deleted successfully.");const e=document.getElementById("page-content");e&&(e.innerHTML=await F.renderAdmin())}catch(e){alert("Failed to delete user: "+e.message)}};window.app_recalculateRow=a=>{const e=parseFloat(a.querySelector(".base-salary-input").value)||0,t=e/22,n=parseFloat(a.querySelector(".unpaid-leaves-count").innerText)||0,i=parseFloat(a.querySelector(".late-count")?.innerText||"0")||0,s=Math.floor(i/(L.LATE_GRACE_COUNT||3))*(L.LATE_DEDUCTION_PER_BLOCK||.5),o=parseFloat(a.querySelector(".extra-work-hours")?.innerText||"0")||0,r=Math.floor(o/(L.EXTRA_HOURS_FOR_HALF_DAY_OFFSET||4))*(L.LATE_DEDUCTION_PER_BLOCK||.5),d=Math.max(0,s-r),l=n+d,c=parseFloat(document.getElementById("global-tds-percent").value)||0,p=a.querySelector(".tds-input");p&&!p.dataset.manual&&(p.value=c);const m=p?parseFloat(p.value)||0:c,u=Math.round(t*l),y=a.querySelector(".late-deduction-days"),h=a.querySelector(".late-deduction-raw"),f=a.querySelector(".penalty-offset-days"),S=a.querySelector(".deduction-days"),_=a.querySelector(".attendance-deduction-amount");h&&(h.innerText=s.toFixed(1)),f&&(f.innerText=r.toFixed(1)),y&&(y.innerText=d.toFixed(1)),S&&(S.innerText=l.toFixed(1)),_&&(_.innerText="-Rs "+u.toLocaleString()),a.querySelector(".deduction-amount").innerText="-Rs "+u.toLocaleString();const b=a.querySelector(".salary-input");b.dataset.manual||(b.value=Math.max(0,e-u));const $=parseFloat(b.value)||0,g=Math.round($*(m/100)),w=Math.max(0,$-g);a.querySelector(".tds-amount").innerText="Rs "+g.toLocaleString(),a.querySelector(".tds-amount").dataset.value=g,a.querySelector(".final-net-salary").innerText="Rs "+w.toLocaleString(),a.querySelector(".final-net-salary").dataset.value=w};const mn=a=>{const e=parseFloat(a.querySelector(".unpaid-leaves-count")?.innerText||"0")||0,t=parseFloat(a.querySelector(".late-count")?.innerText||"0")||0,n=parseFloat(a.querySelector(".extra-work-hours")?.innerText||"0")||0,i=Math.floor(t/(L.LATE_GRACE_COUNT||3))*(L.LATE_DEDUCTION_PER_BLOCK||.5),s=Math.floor(n/(L.EXTRA_HOURS_FOR_HALF_DAY_OFFSET||4))*(L.LATE_DEDUCTION_PER_BLOCK||.5),o=Math.max(0,i-s),r=e+o;return{unpaidLeaves:e,lateCount:t,extraWorkedHours:n,rawLateDeductionDays:i,penaltyOffsetDays:s,lateDeductionDays:o,deductionDays:r}};window.app_recalculateAllSalaries=()=>{document.querySelectorAll("tr[data-user-id]").forEach(a=>{window.app_recalculateRow(a)})};const Ot=(a,e=new Date)=>{if(/^\d{4}-\d{2}$/.test(String(a||"").trim())){const[t,n]=String(a).split("-").map(Number);if(Number.isFinite(t)&&Number.isFinite(n)&&n>=1&&n<=12)return{year:t,monthIndex:n-1}}return{year:e.getFullYear(),monthIndex:e.getMonth()}};window.app_toggleSalaryPeriodMode=function(){const a=document.getElementById("salary-period-mode")?.value||"single",e=document.getElementById("salary-period-single-wrap"),t=document.getElementById("salary-period-range-wrap");e&&(e.style.display=a==="range"?"none":"block"),t&&(t.style.display=a==="range"?"flex":"none")};window.app_getSalaryPayPeriodInfo=function(){const a=new Date;if((document.getElementById("salary-period-mode")?.value||"single")==="range"){const r=document.getElementById("salary-pay-period-from")?.value||"",d=document.getElementById("salary-pay-period-to")?.value||"";let l=Ot(r,a),c=Ot(d,a);const p=l.year*100+(l.monthIndex+1);if(c.year*100+(c.monthIndex+1)<p){const S=l;l=c,c=S}const u=new Date(l.year,l.monthIndex,1),y=new Date(c.year,c.monthIndex+1,0),h=`${l.year}-${String(l.monthIndex+1).padStart(2,"0")}`,f=`${c.year}-${String(c.monthIndex+1).padStart(2,"0")}`;return{mode:"range",startDate:u,endDate:y,startKey:h,endKey:f,key:`${h}_to_${f}`,label:`${u.toLocaleDateString("en-GB",{month:"long",year:"numeric"})} to ${y.toLocaleDateString("en-GB",{month:"long",year:"numeric"})}`}}const t=document.getElementById("salary-pay-period")?.value||"",n=Ot(t,a),i=new Date(n.year,n.monthIndex,1),s=new Date(n.year,n.monthIndex+1,0),o=`${n.year}-${String(n.monthIndex+1).padStart(2,"0")}`;return{mode:"single",startDate:i,endDate:s,startKey:o,endKey:o,key:o,label:i.toLocaleDateString("en-GB",{month:"long",year:"numeric"})}};window.app_saveAllSalaries=async()=>{const a=document.querySelectorAll("tr[data-user-id]"),e=[],t=[],n=window.app_getSalaryPayPeriodInfo(),i=n.key,s=document.getElementById("salary-pay-date")?.value||"",o=s?new Date(s).getTime():Date.now(),r=parseFloat(document.getElementById("global-tds-percent").value)||0;for(const d of a){const l=d.dataset.userId,c=d.querySelector(".base-salary-input").value,p=d.querySelector(".salary-input").value,m=d.querySelector(".comment-input").value,u=d.querySelector(".tds-input"),y=u?parseFloat(u.value)||0:r,h=d.querySelector(".tds-amount").dataset.value||0,f=d.querySelector(".final-net-salary").dataset.value||0,S=mn(d),_=S.unpaidLeaves,b=S.lateCount,$=S.extraWorkedHours,g=S.rawLateDeductionDays,w=S.penaltyOffsetDays,k=S.lateDeductionDays,T=S.deductionDays,E=Number(String(d.querySelector(".attendance-deduction-amount")?.innerText||"0").replace(/[^0-9.-]+/g,"")),v=String(d.querySelector(".employee-id-input")?.value||"").trim(),x=String(d.querySelector(".designation-input")?.value||"").trim(),A=String(d.querySelector(".department-input")?.value||"").trim(),M=String(d.querySelector(".join-date-input")?.value||"").trim(),O=M?v||xt(M,l):"NA",I=String(d.querySelector(".bank-name-input")?.value||"").trim(),N=String(d.querySelector(".bank-account-input")?.value||"").trim(),P=String(d.querySelector(".pan-input")?.value||"").trim(),B=String(d.querySelector(".uan-input")?.value||"").trim(),U=Number(d.querySelector(".other-allowances-input")?.value||0),V=Number(d.querySelector(".pf-input")?.value||0),j=Number(d.querySelector(".professional-tax-input")?.value||0),W=Number(d.querySelector(".loan-advance-input")?.value||0);if(d.querySelector(".comment-input").required&&!m){alert(`Please provide a comment for user ID: ${l} as the salary was adjusted.`);return}e.push({id:`salary_${l}_${i}`,userId:l,month:i,periodMode:n.mode,periodStart:n.startKey,periodEnd:n.endKey,periodLabel:n.label,payDate:o,baseAmount:Number(c),otherAllowances:U,providentFund:V,professionalTax:j,loanAdvance:W,employeeId:O,designation:x,department:A,joinDate:M||null,bankName:I,bankAccount:N,pan:P,uan:B,attendanceDeduction:E,deductions:Number(d.querySelector(".deduction-amount").innerText.replace(/[^0-9.-]+/g,"")),unpaidLeaves:_,lateCount:b,extraWorkedHours:$,lateDeductionRawDays:g,penaltyOffsetDays:w,lateDeductionDays:k,deductionDays:T,adjustedAmount:Number(p),tdsPercent:y,tdsAmount:Number(h),finalNet:Number(f),comment:m||"",processedAt:Date.now()}),t.push({id:l,baseSalary:Number(c),tdsPercent:y,employeeId:O,designation:x,dept:A,joinDate:M||null,bankName:I,bankAccount:N,pan:P,uan:B,otherAllowances:U,providentFund:V,professionalTax:j,loanAdvance:W})}try{for(const l of e)await window.AppDB.put("salaries",l);for(const l of t){const c=await window.AppDB.get("users",l.id);c&&(Object.assign(c,l),await window.AppDB.put("users",c))}alert("All records and TDS details saved successfully!");const d=document.getElementById("page-content");d.innerHTML=await F.renderSalaryProcessing()}catch(d){console.error("Salary Save Error:",d),alert("Failed to save records: "+d.message)}};window.app_exportSalaryCSV=()=>{const a=document.querySelectorAll("tr[data-user-id]");let e=`Staff Name,Emp ID,Designation,Department,Join Date,Bank Name,Bank Account,PAN,UAN,Base Salary,Other Allowances,PF,Professional Tax,Loan Advance,Present,Late,Unpaid Leaves,Extra Work Hours,Late Deduction Raw,Penalty Offset Days,Late Deduction Days,Total Deduction Days,Attendance Deduction,Total Deductions,Adjusted Salary,TDS (%),TDS Amount,Final Net,Comment
`;a.forEach(o=>{const r=o.querySelector('div[style*="font-weight: 600"]').innerText,d=o.querySelector(".base-salary-input").value,l=o.querySelector(".employee-id-input")?.value||"",c=o.querySelector(".designation-input")?.value||"",p=o.querySelector(".department-input")?.value||"",m=o.querySelector(".join-date-input")?.value||"",u=o.querySelector(".bank-name-input")?.value||"",y=o.querySelector(".bank-account-input")?.value||"",h=o.querySelector(".pan-input")?.value||"",f=o.querySelector(".uan-input")?.value||"",S=o.querySelector(".other-allowances-input")?.value||"0",_=o.querySelector(".pf-input")?.value||"0",b=o.querySelector(".professional-tax-input")?.value||"0",$=o.querySelector(".loan-advance-input")?.value||"0",g=o.querySelector(".present-count")?.innerText||"0",w=o.querySelector(".late-count")?.innerText||"0",k=o.querySelector(".unpaid-leaves-count")?.innerText||"0",T=o.querySelector(".extra-work-hours")?.innerText||"0",E=o.querySelector(".late-deduction-raw")?.innerText||"0",v=o.querySelector(".penalty-offset-days")?.innerText||"0",x=o.querySelector(".late-deduction-days")?.innerText||"0",A=o.querySelector(".deduction-days")?.innerText||"0",M=(o.querySelector(".attendance-deduction-amount")?.innerText||"").replace(/[^0-9.-]+/g,"")||"0",O=(o.querySelector(".deduction-amount").innerText||"").replace(/[^0-9.-]+/g,""),I=o.querySelector(".salary-input").value,N=parseFloat(document.getElementById("global-tds-percent").value)||0,P=o.querySelector(".tds-input"),B=P&&P.value!==""?P.value:N,U=(o.querySelector(".tds-amount").innerText||"").replace(/[^0-9.-]+/g,""),V=(o.querySelector(".final-net-salary").innerText||"").replace(/[^0-9.-]+/g,""),j=o.querySelector(".comment-input").value;e+=`"${r}","${l}","${c}","${p}","${m}","${u}","${y}","${h}","${f}",${d},${S},${_},${b},${$},${g},${w},${k},${T},${E},${v},${x},${A},${M},${O},${I},${B},${U},${V},"${j}"
`});const t=new Blob([e],{type:"text/csv"}),n=window.URL.createObjectURL(t),i=document.createElement("a"),s=window.app_getSalaryPayPeriodInfo();i.setAttribute("href",n),i.setAttribute("download",`Salaries_${s.key.replace(/[^a-zA-Z0-9_-]/g,"_")}.csv`),i.click()};const Rt=(a,e=4)=>{const t=String(a||"").trim();return t?t.length<=e?t:`${"*".repeat(Math.max(0,t.length-e))}${t.slice(-e)}`:"NA"},Ss=a=>{const e=Math.floor(Number(a)||0);if(e===0)return"Zero";const t=["","One","Two","Three","Four","Five","Six","Seven","Eight","Nine","Ten","Eleven","Twelve","Thirteen","Fourteen","Fifteen","Sixteen","Seventeen","Eighteen","Nineteen"],n=["","","Twenty","Thirty","Forty","Fifty","Sixty","Seventy","Eighty","Ninety"],i=m=>{if(m<20)return t[m];const u=Math.floor(m/10),y=m%10;return`${n[u]}${y?` ${t[y]}`:""}`.trim()},s=m=>{const u=Math.floor(m/100),y=m%100;return u?`${t[u]} Hundred${y?` ${i(y)}`:""}`.trim():i(y)};let o=e;const r=Math.floor(o/1e7);o%=1e7;const d=Math.floor(o/1e5);o%=1e5;const l=Math.floor(o/1e3);o%=1e3;const c=o,p=[];return r&&p.push(`${i(r)} Crore`),d&&p.push(`${i(d)} Lakh`),l&&p.push(`${i(l)} Thousand`),c&&p.push(s(c)),p.join(" ").trim()};window.app_printSalarySlip=function(){const a=document.getElementById("salary-slip-modal");if(!a)return;const e=a.querySelector(".salary-slip-print-root");e&&(document.body.classList.add("salary-slip-print-mode"),e.classList.add("print-active"),setTimeout(()=>{window.print(),setTimeout(()=>{e.classList.remove("print-active"),document.body.classList.remove("salary-slip-print-mode")},150)},60))};window.app_generateSalarySlip=async function(a){try{const e=document.querySelector(`tr[data-user-id="${a}"]`);if(!e){alert("Unable to locate salary row for this user.");return}const t=await window.AppDB.get("users",a);if(!t){alert("User details not found.");return}const n=new Date,i=window.app_getSalaryPayPeriodInfo(),s=i.label,o=Re(i.startDate),r=Re(i.endDate),d=document.getElementById("salary-pay-date")?.value||"",l=Re(d||n),c=cs(n),p=`CRWI-${i.key.replace(/[^a-zA-Z0-9]/g,"")}-${a}-${String(n.getTime()).slice(-5)}`,m=Number(e.querySelector(".base-salary-input")?.value||0),u=Number(e.querySelector(".salary-input")?.value||0),y=Number(e.querySelector(".tds-input")?.value||0),h=Number(e.querySelector(".tds-amount")?.dataset?.value||"0"),f=Number(e.querySelector(".final-net-salary")?.dataset?.value||"0"),S=Number(String(e.querySelector(".attendance-deduction-amount")?.innerText||"0").replace(/[^0-9.-]+/g,""))||0,_=mn(e),b=_.rawLateDeductionDays,$=_.penaltyOffsetDays,g=_.lateDeductionDays,w=_.deductionDays,k=_.unpaidLeaves,T=_.lateCount,E=String(e.querySelector(".comment-input")?.value||"").trim(),v=Number(e.querySelector(".other-allowances-input")?.value||t.otherAllowances||0),x=m+v,A=Number(e.querySelector(".loan-advance-input")?.value||t.loanAdvance||0),M=Number(e.querySelector(".pf-input")?.value||t.providentFund||0),O=Number(e.querySelector(".professional-tax-input")?.value||t.professionalTax||0),I=String(e.querySelector(".join-date-input")?.value||t.joinDate||"").trim(),N=String(e.querySelector(".employee-id-input")?.value||t.employeeId||"").trim(),P=I?N||xt(I,t.id):"NA",B=String(e.querySelector(".designation-input")?.value||t.designation||t.role||"").trim(),U=String(e.querySelector(".department-input")?.value||t.dept||t.department||"").trim(),V=String(e.querySelector(".join-date-input")?.value||t.joinDate||"").trim(),j=String(e.querySelector(".bank-name-input")?.value||t.bankName||"").trim(),W=String(e.querySelector(".bank-account-input")?.value||t.bankAccount||t.accountNumber||"").trim(),J=String(e.querySelector(".pan-input")?.value||t.pan||t.PAN||"").trim(),C=String(e.querySelector(".uan-input")?.value||t.uan||t.UAN||"").trim(),R=S+h+A+M+O,G=`${Ss(f)} Rupees Only`,q=[{label:"Attendance Deduction",amount:S,remarks:`Unpaid Leaves: ${k}, Late Count: ${T}, Late Raw: ${b.toFixed(1)}, Offset: ${$.toFixed(1)}, Late Deduction: ${g.toFixed(1)}, Total Deduction Days: ${w.toFixed(1)}`},{label:"TDS",amount:h,remarks:`Applied at ${y.toFixed(2)}%`},{label:"Provident Fund",amount:M,remarks:M?"Configured as per employee profile":"NA"},{label:"Professional Tax",amount:O,remarks:O?"Configured as per employee profile":"NA"},{label:"Loan / Advance",amount:A,remarks:A?"Recovered in this cycle":"Nil"}],X=ne=>ps(ne),ee=`
                        ...
                        <div class="salary-slip-paper">
                            ...
                            <div class="salary-slip-section">
                                ...
                                <div class="salary-slip-grid">
                                    ...
                                    <div><b>Date of Joining:</b> ${Re(V)}</div>
                                    <div><b>Bank Name:</b> ${j||"NA"}</div>
                                    <div><b>UAN:</b> ${Rt(C)}</div>
                                    <div><b>PAN:</b> ${Rt(J)}</div>
                                    <div><b>Bank A/C:</b> ${Rt(W)}</div>
                                </div>
                            </div>
                            ...
                            <div class="salary-slip-split">
                                <div class="salary-slip-section">
                                    ...
                                    <table class="salary-slip-table">
                                        <tr><td>Basic Salary</td><td>${X(m)}</td></tr>
                                        <tr><td>HRA</td><td>NA</td></tr>
                                        <tr><td>Conveyance Allowance</td><td>NA</td></tr>
                                        <tr><td>Special Allowance</td><td>NA</td></tr>
                                        <tr><td>Other Allowances</td><td>${X(v)}</td></tr>
                                        <tr class="total"><td>Gross Earnings</td><td>${X(x)}</td></tr>
                                    </table>
                                </div>
                                <div class="salary-slip-section">
                                    ...
                                    <table class="salary-slip-table">
                                        ...
                                        <tr class="total"><td>Total Deductions</td><td>${X(R)}</td></tr>
                                    </table>
                                </div>
                            </div>

                            <div class="salary-slip-net">
                                <div><b>Adjusted Salary:</b> ${X(u)}</div>
                                <div><b>Net Salary:</b> ${X(f)}</div>
...
`),o=new Blob([s],{type:"text/csv;charset=utf-8;"}),r=document.createElement("a"),d=URL.createObjectURL(o);r.setAttribute("href",d),r.setAttribute("download",`security_audits_${a||"export"}.csv`),r.style.visibility="hidden",document.body.appendChild(r),r.click(),document.body.removeChild(r)}catch(t){console.error("Export failed:",t),alert("Export failed: "+t.message)}};window.app_changeAnnualYear=a=>{window.app_annualYear=(window.app_annualYear||new Date().getFullYear())+a,window.app_renderAnnualPlanPage()};window.app_toggleAnnualLegendFilter=a=>{const e=window.app_annualLegendFilters||{leave:!0,event:!0,work:!0,overdue:!0,completed:!0};Object.prototype.hasOwnProperty.call(e,a)&&(e[a]=!e[a],window.app_annualLegendFilters=e,window.app_renderAnnualPlanPage())};window.app_showAnnualDayDetails=async a=>{if(!a)return;const e=window._currentPlans||await window.AppCalendar.getPlans(),t=window.app_annualLegendFilters||{leave:!0,event:!0,work:!0},n=window.AppAuth.getUser()||{},i=n.role==="Administrator"||n.isAdmin,s=(window.app_getDayEvents(a,e,{includeAuto:!1,userId:i?null:n.id})||[]).filter(d=>d.type==="leave"?!!t.leave:d.type==="work"?!!t.work:(d.type==="holiday",!!t.event)),o=s.length?s.map(d=>{const l=d.type||"event",c=l==="leave"?"background:#fee2e2;color:#991b1b;":l==="work"?"background:#e0e7ff;color:#3730a3;":l==="holiday"?"background:#f1f5f9;color:#334155;":"background:#dcfce7;color:#166534;",p=l==="work"&&Array.isArray(d.plans)&&d.plans.length?`<ul style="margin:0.5rem 0 0 1rem; padding:0; color:#475569; font-size:0.8rem;">
        ...
        `;window.app_showModal(d,a)};const ks=async a=>{if(!a?.waiting||!navigator.serviceWorker)return!1;const e=a.waiting;return new Promise(t=>{let n=!1;const i=r=>{n||(n=!0,navigator.serviceWorker.removeEventListener("controllerchange",s),clearTimeout(o),t(r))},s=()=>i(!0),o=setTimeout(()=>i(!1),3e3);navigator.serviceWorker.addEventListener("controllerchange",s,{once:!0}),e.postMessage({type:"SKIP_WAITING"})})};window.app_forceRefresh=async()=>{try{if(navigator.serviceWorker){const a=await navigator.serviceWorker.getRegistrations();qt?.update&&await qt.update();for(const e of a)await ks(e)}if(window.caches){const a=await caches.keys();await Promise.all(a.map(e=>caches.delete(e)))}}catch(a){console.warn("Force refresh cleanup failed:",a)}Qt(!0),window.location.reload()};ts();console.log("App.js Loaded & Globals Ready");
